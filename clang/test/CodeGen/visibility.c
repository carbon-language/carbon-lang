...
// CHECK-DEFAULT: @g_com = common dso_local global i32 0
...
// CHECK-DEFAULT-LABEL: define dso_local i32 @f_def()
...
// PR8457
// CHECK-DEFAULT-LABEL: define dso_local void @test1(
// CHECK-PROTECTED-LABEL: define dso_local void @test1(
// CHECK-HIDDEN-LABEL: define dso_local void @test1(
struct Test1 { int field; };
void  __attribute__((visibility("default"))) test1(struct Test1 *v) { }

// rdar://problem/8595231
// CHECK-DEFAULT-LABEL: define dso_local void @test2()
// CHECK-PROTECTED-LABEL: define dso_local void @test2()
// CHECK-HIDDEN-LABEL: define dso_local void @test2()
void test2(void);
