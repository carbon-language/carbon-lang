...
{
  // overload-warning@+2 {{call to undeclared function 'svsm4e'; ISO C99 and later do not support implicit function declarations}}
  // expected-warning@+1 {{call to undeclared function 'svsm4e_u32'; ISO C99 and later do not support implicit function declarations}}
