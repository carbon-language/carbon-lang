...
//
// CPP-CHECK-LABEL: @_Z33test_svldnt1sw_gather_u64base_s64u10__SVBool_tu12__SVUint64_t(
...
svint64_t test_svldnt1sw_gather_u64base_s64(svbool_t pg, svuint64_t bases) {
  // overload-warning@+2 {{call to undeclared function 'svldnt1sw_gather_s64'; ISO C99 and later do not support implicit function declarations}}
  // expected-warning@+1 {{call to undeclared function 'svldnt1sw_gather_u64base_s64'; ISO C99 and later do not support implicit function declarations}}
...
// CHECK-NEXT:    ret <vscale x 2 x i64> [[TMP2]]
//
// CPP-CHECK-LABEL: @_Z33test_svldnt1sw_gather_u64base_u64u10__SVBool_tu12__SVUint64_t(
// CPP-CHECK-NEXT:  entry:
// CPP-CHECK-NEXT:    [[TMP0:%.*]] = call <vscale x 2 x i1> @llvm.aarch64.sve.convert.from.svbool.nxv2i1(<vscale x 16 x i1> [[PG:%.*]])
// CPP-CHECK-NEXT:    [[TMP1:%.*]] = call <vscale x 2 x i32> @llvm.aarch64.sve.ldnt1.gather.scalar.offset.nxv2i32.nxv2i64(<vscale x 2 x i1> [[TMP0]], <vscale x 2 x i64> [[BASES:%.*]], i64 0)
// CPP-CHECK-NEXT:    [[TMP2:%.*]] = sext <vscale x 2 x i32> [[TMP1]] to <vscale x 2 x i64>
...
svuint64_t test_svldnt1sw_gather_u64base_u64(svbool_t pg, svuint64_t bases) {
  // overload-warning@+2 {{call to undeclared function 'svldnt1sw_gather_u64'; ISO C99 and later do not support implicit function declarations}}
  // expected-warning@+1 {{call to undeclared function 'svldnt1sw_gather_u64base_u64'; ISO C99 and later do not support implicit function declarations}}
...
svint64_t test_svldnt1sw_gather_s64offset_s64(svbool_t pg, const int32_t *base, svint64_t offsets) {
  // overload-warning@+2 {{call to undeclared function 'svldnt1sw_gather_offset_s64'; ISO C99 and later do not support implicit function declarations}}
  // expected-warning@+1 {{call to undeclared function 'svldnt1sw_gather_s64offset_s64'; ISO C99 and later do not support implicit function declarations}}
...
svuint64_t test_svldnt1sw_gather_s64offset_u64(svbool_t pg, const int32_t *base, svint64_t offsets) {
  // overload-warning@+2 {{call to undeclared function 'svldnt1sw_gather_offset_u64'; ISO C99 and later do not support implicit function declarations}}
  // expected-warning@+1 {{call to undeclared function 'svldnt1sw_gather_s64offset_u64'; ISO C99 and later do not support implicit function declarations}}
...
svint64_t test_svldnt1sw_gather_u64offset_s64(svbool_t pg, const int32_t *base, svuint64_t offsets) {
  // overload-warning@+2 {{call to undeclared function 'svldnt1sw_gather_offset_s64'; ISO C99 and later do not support implicit function declarations}}
  // expected-warning@+1 {{call to undeclared function 'svldnt1sw_gather_u64offset_s64'; ISO C99 and later do not support implicit function declarations}}
...
svuint64_t test_svldnt1sw_gather_u64offset_u64(svbool_t pg, const int32_t *base, svuint64_t offsets) {
  // overload-warning@+2 {{call to undeclared function 'svldnt1sw_gather_offset_u64'; ISO C99 and later do not support implicit function declarations}}
  // expected-warning@+1 {{call to undeclared function 'svldnt1sw_gather_u64offset_u64'; ISO C99 and later do not support implicit function declarations}}
...
svint64_t test_svldnt1sw_gather_u64base_offset_s64(svbool_t pg, svuint64_t bases, int64_t offset) {
  // overload-warning@+2 {{call to undeclared function 'svldnt1sw_gather_offset_s64'; ISO C99 and later do not support implicit function declarations}}
  // expected-warning@+1 {{call to undeclared function 'svldnt1sw_gather_u64base_offset_s64'; ISO C99 and later do not support implicit function declarations}}
...
svuint64_t test_svldnt1sw_gather_u64base_offset_u64(svbool_t pg, svuint64_t bases, int64_t offset) {
  // overload-warning@+2 {{call to undeclared function 'svldnt1sw_gather_offset_u64'; ISO C99 and later do not support implicit function declarations}}
  // expected-warning@+1 {{call to undeclared function 'svldnt1sw_gather_u64base_offset_u64'; ISO C99 and later do not support implicit function declarations}}
...
svint64_t test_svldnt1sw_gather_s64index_s64(svbool_t pg, const int32_t *base, svint64_t indices) {
  // overload-warning@+2 {{call to undeclared function 'svldnt1sw_gather_index_s64'; ISO C99 and later do not support implicit function declarations}}
  // expected-warning@+1 {{call to undeclared function 'svldnt1sw_gather_s64index_s64'; ISO C99 and later do not support implicit function declarations}}
...
svuint64_t test_svldnt1sw_gather_s64index_u64(svbool_t pg, const int32_t *base, svint64_t indices) {
  // overload-warning@+2 {{call to undeclared function 'svldnt1sw_gather_index_u64'; ISO C99 and later do not support implicit function declarations}}
  // expected-warning@+1 {{call to undeclared function 'svldnt1sw_gather_s64index_u64'; ISO C99 and later do not support implicit function declarations}}
...
svint64_t test_svldnt1sw_gather_u64index_s64(svbool_t pg, const int32_t *base, svuint64_t indices) {
  // overload-warning@+2 {{call to undeclared function 'svldnt1sw_gather_index_s64'; ISO C99 and later do not support implicit function declarations}}
  // expected-warning@+1 {{call to undeclared function 'svldnt1sw_gather_u64index_s64'; ISO C99 and later do not support implicit function declarations}}
...
svuint64_t test_svldnt1sw_gather_u64index_u64(svbool_t pg, const int32_t *base, svuint64_t indices) {
  // overload-warning@+2 {{call to undeclared function 'svldnt1sw_gather_index_u64'; ISO C99 and later do not support implicit function declarations}}
  // expected-warning@+1 {{call to undeclared function 'svldnt1sw_gather_u64index_u64'; ISO C99 and later do not support implicit function declarations}}
...
//
// CPP-CHECK-LABEL: @_Z39test_svldnt1sw_gather_u64base_index_s64u10__SVBool_tu12__SVUint64_tl(
// CPP-CHECK-NEXT:  entry:
// CPP-CHECK-NEXT:    [[TMP0:%.*]] = call <vscale x 2 x i1> @llvm.aarch64.sve.convert.from.svbool.nxv2i1(<vscale x 16 x i1> [[PG:%.*]])
...
svint64_t test_svldnt1sw_gather_u64base_index_s64(svbool_t pg, svuint64_t bases, int64_t index) {
  // overload-warning@+2 {{call to undeclared function 'svldnt1sw_gather_index_s64'; ISO C99 and later do not support implicit function declarations}}
  // expected-warning@+1 {{call to undeclared function 'svldnt1sw_gather_u64base_index_s64'; ISO C99 and later do not support implicit function declarations}}
...
// CHECK-NEXT:    ret <vscale x 2 x i64> [[TMP3]]
//
// CPP-CHECK-LABEL: @_Z39test_svldnt1sw_gather_u64base_index_u64u10__SVBool_tu12__SVUint64_tl(
// CPP-CHECK-NEXT:  entry:
// CPP-CHECK-NEXT:    [[TMP0:%.*]] = call <vscale x 2 x i1> @llvm.aarch64.sve.convert.from.svbool.nxv2i1(<vscale x 16 x i1> [[PG:%.*]])
// CPP-CHECK-NEXT:    [[TMP1:%.*]] = shl i64 [[INDEX:%.*]], 2
// CPP-CHECK-NEXT:    [[TMP2:%.*]] = call <vscale x 2 x i32> @llvm.aarch64.sve.ldnt1.gather.scalar.offset.nxv2i32.nxv2i64(<vscale x 2 x i1> [[TMP0]], <vscale x 2 x i64> [[BASES:%.*]], i64 [[TMP1]])
...
svuint64_t test_svldnt1sw_gather_u64base_index_u64(svbool_t pg, svuint64_t bases, int64_t index) {
  // overload-warning@+2 {{call to undeclared function 'svldnt1sw_gather_index_u64'; ISO C99 and later do not support implicit function declarations}}
  // expected-warning@+1 {{call to undeclared function 'svldnt1sw_gather_u64base_index_u64'; ISO C99 and later do not support implicit function declarations}}
