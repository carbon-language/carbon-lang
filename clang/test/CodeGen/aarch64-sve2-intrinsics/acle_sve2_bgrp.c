...
{
  // overload-warning@+2 {{call to undeclared function 'svbgrp'; ISO C99 and later do not support implicit function declarations}}
  // expected-warning@+1 {{call to undeclared function 'svbgrp_u8'; ISO C99 and later do not support implicit function declarations}}
...
{
  // overload-warning@+2 {{call to undeclared function 'svbgrp'; ISO C99 and later do not support implicit function declarations}}
  // expected-warning@+1 {{call to undeclared function 'svbgrp_u16'; ISO C99 and later do not support implicit function declarations}}
...
{
  // overload-warning@+2 {{call to undeclared function 'svbgrp'; ISO C99 and later do not support implicit function declarations}}
  // expected-warning@+1 {{call to undeclared function 'svbgrp_u32'; ISO C99 and later do not support implicit function declarations}}
...
{
  // overload-warning@+2 {{call to undeclared function 'svbgrp'; ISO C99 and later do not support implicit function declarations}}
  // expected-warning@+1 {{call to undeclared function 'svbgrp_u64'; ISO C99 and later do not support implicit function declarations}}
...
{
  // overload-warning@+2 {{call to undeclared function 'svbgrp'; ISO C99 and later do not support implicit function declarations}}
  // expected-warning@+1 {{call to undeclared function 'svbgrp_n_u8'; ISO C99 and later do not support implicit function declarations}}
...
{
  // overload-warning@+2 {{call to undeclared function 'svbgrp'; ISO C99 and later do not support implicit function declarations}}
  // expected-warning@+1 {{call to undeclared function 'svbgrp_n_u16'; ISO C99 and later do not support implicit function declarations}}
...
{
  // overload-warning@+2 {{call to undeclared function 'svbgrp'; ISO C99 and later do not support implicit function declarations}}
  // expected-warning@+1 {{call to undeclared function 'svbgrp_n_u32'; ISO C99 and later do not support implicit function declarations}}
...
{
  // overload-warning@+2 {{call to undeclared function 'svbgrp'; ISO C99 and later do not support implicit function declarations}}
  // expected-warning@+1 {{call to undeclared function 'svbgrp_n_u64'; ISO C99 and later do not support implicit function declarations}}
