...
svint16_t test_svmlslb_s16(svint16_t op1, svint8_t op2, svint8_t op3)
{
  ...
  // expected-warning@+1 {{implicit declaration of function 'svmlslb_s16'}}
...
svint32_t test_svmlslb_s32(svint32_t op1, svint16_t op2, svint16_t op3)
{
  ...
  // overload-warning@+2 {{implicit declaration of function 'svmlslb'}}
  // expected-warning@+1 {{implicit declaration of function 'svmlslb_s32'}}
...
svint64_t test_svmlslb_s64(svint64_t op1, svint32_t op2, svint32_t op3)
{
  ...
  // overload-warning@+2 {{implicit declaration of function 'svmlslb'}}
  // expected-warning@+1 {{implicit declaration of function 'svmlslb_s64'}}
...
svuint16_t test_svmlslb_u16(svuint16_t op1, svuint8_t op2, svuint8_t op3)
{
  ...
  // CHECK: ret <vscale x 8 x i16> %[[INTRINSIC]]
  // overload-warning@+2 {{implicit declaration of function 'svmlslb'}}
  // expected-warning@+1 {{implicit declaration of function 'svmlslb_u16'}}
...
svuint32_t test_svmlslb_u32(svuint32_t op1, svuint16_t op2, svuint16_t op3)
{
  ...
  // CHECK: ret <vscale x 4 x i32> %[[INTRINSIC]]
  // overload-warning@+2 {{implicit declaration of function 'svmlslb'}}
  // expected-warning@+1 {{implicit declaration of function 'svmlslb_u32'}}
...
svuint64_t test_svmlslb_u64(svuint64_t op1, svuint32_t op2, svuint32_t op3)
{
  ...
  // CHECK: ret <vscale x 2 x i64> %[[INTRINSIC]]
  // overload-warning@+2 {{implicit declaration of function 'svmlslb'}}
  // expected-warning@+1 {{implicit declaration of function 'svmlslb_u64'}}
...
svint16_t test_svmlslb_n_s16(svint16_t op1, svint8_t op2, int8_t op3)
{
  ...
  // CHECK: ret <vscale x 8 x i16> %[[INTRINSIC]]
  // overload-warning@+2 {{implicit declaration of function 'svmlslb'}}
  // expected-warning@+1 {{implicit declaration of function 'svmlslb_n_s16'}}
...
svint32_t test_svmlslb_n_s32(svint32_t op1, svint16_t op2, int16_t op3)
{
  ...
  // CHECK: ret <vscale x 4 x i32> %[[INTRINSIC]]
  // overload-warning@+2 {{implicit declaration of function 'svmlslb'}}
  // expected-warning@+1 {{implicit declaration of function 'svmlslb_n_s32'}}
...
svint64_t test_svmlslb_n_s64(svint64_t op1, svint32_t op2, int32_t op3)
{
  ...
  // CHECK: ret <vscale x 2 x i64> %[[INTRINSIC]]
  // overload-warning@+2 {{implicit declaration of function 'svmlslb'}}
  // expected-warning@+1 {{implicit declaration of function 'svmlslb_n_s64'}}
...
svuint16_t test_svmlslb_n_u16(svuint16_t op1, svuint8_t op2, uint8_t op3)
{
  ...
  // CHECK: ret <vscale x 8 x i16> %[[INTRINSIC]]
  // overload-warning@+2 {{implicit declaration of function 'svmlslb'}}
  // expected-warning@+1 {{implicit declaration of function 'svmlslb_n_u16'}}
...
svuint32_t test_svmlslb_n_u32(svuint32_t op1, svuint16_t op2, uint16_t op3)
{
  ...
  // CHECK: ret <vscale x 4 x i32> %[[INTRINSIC]]
  // overload-warning@+2 {{implicit declaration of function 'svmlslb'}}
  // expected-warning@+1 {{implicit declaration of function 'svmlslb_n_u32'}}
...
svuint64_t test_svmlslb_n_u64(svuint64_t op1, svuint32_t op2, uint32_t op3)
{
  ...
  // CHECK: ret <vscale x 2 x i64> %[[INTRINSIC]]
  // overload-warning@+2 {{implicit declaration of function 'svmlslb'}}
  // expected-warning@+1 {{implicit declaration of function 'svmlslb_n_u64'}}
...
svint32_t test_svmlslb_lane_s32(svint32_t op1, svint16_t op2, svint16_t op3)
{
  ...
  // expected-warning@+1 {{implicit declaration of function 'svmlslb_lane_s32'}}
...
svint64_t test_svmlslb_lane_s64(svint64_t op1, svint32_t op2, svint32_t op3)
{
  ...
  // CHECK: ret <vscale x 2 x i64> %[[INTRINSIC]]
  // overload-warning@+2 {{implicit declaration of function 'svmlslb_lane'}}
  // expected-warning@+1 {{implicit declaration of function 'svmlslb_lane_s64'}}
...
svuint32_t test_svmlslb_lane_u32(svuint32_t op1, svuint16_t op2, svuint16_t op3)
{
  ...
  // CHECK: ret <vscale x 4 x i32> %[[INTRINSIC]]
  // overload-warning@+2 {{implicit declaration of function 'svmlslb_lane'}}
  // expected-warning@+1 {{implicit declaration of function 'svmlslb_lane_u32'}}
