...
// CHECK: define dso_local void @_Z6alwaysv() #[[ALWAYSATTR:[0-9]+]] {
// CHECK: define dso_local void @_Z5neverv() #[[NEVERATTR:[0-9]+]] {
// CHECK: define dso_local void @_Z11alwaysNeverv() #[[NEVERATTR]] {
// CHECK: define dso_local void @_Z11neverAlwaysv() #[[ALWAYSATTR]] {
