...
// CHECK-ELFv1: define dso_local void @func_fab(%struct.fab* noalias sret %agg.result, i64 %x.coerce)
// CHECK-ELFv2: define dso_local [2 x float] @func_fab([2 x float] %x.coerce)
