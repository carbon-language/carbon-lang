...
// CHECK: define dso_local float @func_p1(float %x)
float func_p1(float x) { return x; }

// CHECK: define dso_local double @func_p2(double %x)
double func_p2(double x) { return x; }

// CHECK: define dso_local ppc_fp128 @func_p3(ppc_fp128 %x)
...
// CHECK-LE: define dso_local i32 @func_f1(float inreg %x.coerce)
// CHECK-BE: define dso_local void @func_f1(%struct.f1* noalias sret %agg.result, float inreg %x.coerce)
struct f1 func_f1(struct f1 x) { return x; }

// CHECK-LE: define dso_local i64 @func_f2(i64 %x.coerce)
// CHECK-BE: define dso_local void @func_f2(%struct.f2* noalias sret %agg.result, i64 %x.coerce)
struct f2 func_f2(struct f2 x) { return x; }

// CHECK-LE: define dso_local { i64, i64 } @func_f3([2 x i64] %x.coerce)
// CHECK-BE: define dso_local void @func_f3(%struct.f3* noalias sret %agg.result, [2 x i64] %x.coerce)
struct f3 func_f3(struct f3 x) { return x; }

// CHECK-LE: define dso_local { i64, i64 } @func_f4([2 x i64] %x.coerce)
// CHECK-BE: define dso_local void @func_f4(%struct.f4* noalias sret %agg.result, [2 x i64] %x.coerce)
struct f4 func_f4(struct f4 x) { return x; }

// CHECK: define dso_local void @func_f5(%struct.f5* noalias sret %agg.result, [3 x i64] %x.coerce)
struct f5 func_f5(struct f5 x) { return x; }

// CHECK: define dso_local void @func_f6(%struct.f6* noalias sret %agg.result, [3 x i64] %x.coerce)
struct f6 func_f6(struct f6 x) { return x; }

// CHECK: define dso_local void @func_f7(%struct.f7* noalias sret %agg.result, [4 x i64] %x.coerce)
struct f7 func_f7(struct f7 x) { return x; }

// CHECK: define dso_local void @func_f8(%struct.f8* noalias sret %agg.result, [4 x i64] %x.coerce)
...
// CHECK-LE: define dso_local i64 @func_fab(i64 %x.coerce)
// CHECK-BE: define dso_local void @func_fab(%struct.fab* noalias sret %agg.result, i64 %x.coerce)
struct fab func_fab(struct fab x) { return x; }

// CHECK-LE: define dso_local { i64, i64 } @func_fabc([2 x i64] %x.coerce)
// CHECK-BE: define dso_local void @func_fabc(%struct.fabc* noalias sret %agg.result, [2 x i64] %x.coerce)
struct fabc func_fabc(struct fabc x) { return x; }

// CHECK-LE: define dso_local { i64, i64 } @func_f2a2b([2 x i64] %x.coerce)
// CHECK-BE: define dso_local void @func_f2a2b(%struct.f2a2b* noalias sret %agg.result, [2 x i64] %x.coerce)
