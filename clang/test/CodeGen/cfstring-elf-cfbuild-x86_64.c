...
// CHECK-CF-IN-CF-DEFN: @__CFConstantStringClassReference = common dso_local global [32 x i64] zeroinitializer, align 16
// CHECK-CF: @__CFConstantStringClassReference = common dso_local global [1 x i64] zeroinitializer, align 8
