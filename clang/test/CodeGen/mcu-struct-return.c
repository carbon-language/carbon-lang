...
// CHECK: define dso_local void @foo2([[UNION2_TYPE]]* noalias sret %{{.+}})
// CHECK: define dso_local i32 @foo3()
// CHECK: define dso_local void @bar1()
// CHECK: define dso_local i32 @bar2()
// CHECK: define dso_local void @bar3()
