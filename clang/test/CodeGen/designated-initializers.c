...
// CHECK: @u = dso_local global %union.anon zeroinitializer
union { int i; float f; } u = { };

// CHECK: @u2 = dso_local global { i32, [4 x i8] } { i32 0, [4 x i8] undef }
union { int i; double f; } u2 = { };

// CHECK: @u3 = dso_local global  %union.anon.1 zeroinitializer
union { double f; int i; } u3 = { };

// CHECK: @b = dso_local global [2 x i32] [i32 0, i32 22]
int b[2] = {
  [1] = 22
};
...
struct ds ds2 = { { .b = 1 } };
struct ds ds3 = { .a = 0 };
// CHECK: @ds4 = dso_local global %struct.ds { %struct.anon.3 { %struct.anon zeroinitializer, i16 0, %struct.anon.2 { i16 1 } } }
struct ds ds4 = { .c = 1 };
struct ds ds5 = { { { .a = 0 } }, .b = 1 };
struct ds ds6 = { { .a = 0, .b = 1 } };
// CHECK: @ds7 = dso_local global %struct.ds { %struct.anon.3 { %struct.anon { i16 2 }, i16 3, %struct.anon.2 zeroinitializer } }
struct ds ds7 = {
  { {
      .a = 1
    } },
...
// CHECK: @lab = dso_local global { [4 x i8], i32 } { [4 x i8] undef, i32 123 }
...
// CHECK: @D = dso_local global %struct.Derived { %struct.Base { %struct.anon.4 { i32 42 } } }, align 4
