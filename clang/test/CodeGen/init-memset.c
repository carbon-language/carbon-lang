...
void test_small() {
  // CHECK-LABEL: define dso_local void @test_small()
  int a[] = {1, 2, 3, 4};
...
void test_small_same() {
  // CHECK-LABEL: define dso_local void @test_small_same()
  char a[] = {'a', 'a', 'a', 'a'};
  // CHECK: call void @llvm.memcpy.{{.*}}
  use(a);
}
...
void test_different() {
  // CHECK-LABEL: define dso_local void @test_different()
...
void test_all_a() {
  // CHECK-LABEL: define dso_local void @test_all_a()
...
void test_most_zeros() {
  // CHECK-LABEL: define dso_local void @test_most_zeros()
  int a[16] = {0, 0, 1};
  // CHECK: call void @llvm.memset.{{.*}}
  // CHECK: store i32 1
  use(a);
...
void test_most_a() {
  // CHECK-LABEL: define dso_local void @test_most_a()
...
void test_pointers() {
  // CHECK-LABEL: define dso_local void @test_pointers()
