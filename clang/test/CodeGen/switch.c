...
// CHECK-LABEL: define dso_local i32 @foo4t()
// CHECK: ret i32 376
// CHECK: }
int foo4t() {
  // 111 + 1 + 222 + 42 = 376
...
// CHECK-LABEL: define dso_local void @foo5()
// CHECK-NOT: switch
// CHECK: }
void foo5(){
    switch(0){
...
// CHECK-LABEL: define dso_local void @foo6()
// CHECK-NOT: switch
// CHECK: }
void foo6(){
    switch(0){
...
// CHECK-LABEL: define dso_local void @foo7()
// CHECK-NOT: switch
// CHECK: }
void foo7(){
    switch(0){
...
// CHECK-LABEL: define dso_local i32 @f8(
// CHECK: ret i32 3
// CHECK: }
int f8(unsigned x) {
  switch(x) {
...
//
// CHECK-LABEL: define dso_local i32 @f9()
// CHECK: ret i32 10
// CHECK: }
