...
// CHECK: define dso_local double @Vec3FTest
// CHECK: vaarg.in_reg:
...
// CHECK: define dso_local double @Vec4FTest
// CHECK: vaarg.in_reg:
...
// CHECK: define dso_local double @Vec2DTest
// CHECK: vaarg.in_reg:
...
// CHECK: define dso_local double @Vec2F1DTest
// CHECK: vaarg.in_reg:
...
// CHECK: define dso_local double @Vec1D2FTest
// CHECK: vaarg.in_reg:
...
// CHECK: define dso_local double @Vec1F1DTest
// CHECK: vaarg.in_reg:
...
// CHECK: define dso_local double @Vec1D1FTest
// CHECK: vaarg.in_reg:
