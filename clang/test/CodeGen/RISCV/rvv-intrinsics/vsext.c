...
// CHECK-RV64-NEXT:    ret <vscale x 1 x i16> [[TMP0]]
//
vint16mf4_t test_vsext_vf2_i16mf4_mt (vbool64_t mask, vint16mf4_t maskedoff, vint8mf8_t op1, size_t vl, uint8_t ta) {
  return vsext_vf2_i16mf4_mt(mask, maskedoff, op1, vl, VE_TAIL_AGNOSTIC);
}
...
// CHECK-RV64-NEXT:    ret <vscale x 2 x i16> [[TMP0]]
//
vint16mf2_t test_vsext_vf2_i16mf2_mt (vbool32_t mask, vint16mf2_t maskedoff, vint8mf4_t op1, size_t vl, uint8_t ta) {
  return vsext_vf2_i16mf2_mt(mask, maskedoff, op1, vl, VE_TAIL_AGNOSTIC);
}
...
// CHECK-RV64-NEXT:    ret <vscale x 4 x i16> [[TMP0]]
//
vint16m1_t test_vsext_vf2_i16m1_mt (vbool16_t mask, vint16m1_t maskedoff, vint8mf2_t op1, size_t vl, uint8_t ta) {
  return vsext_vf2_i16m1_mt(mask, maskedoff, op1, vl, VE_TAIL_AGNOSTIC);
}
...
// CHECK-RV64-NEXT:    ret <vscale x 8 x i16> [[TMP0]]
//
vint16m2_t test_vsext_vf2_i16m2_mt (vbool8_t mask, vint16m2_t maskedoff, vint8m1_t op1, size_t vl, uint8_t ta) {
  return vsext_vf2_i16m2_mt(mask, maskedoff, op1, vl, VE_TAIL_AGNOSTIC);
}
...
// CHECK-RV64-NEXT:    ret <vscale x 16 x i16> [[TMP0]]
//
vint16m4_t test_vsext_vf2_i16m4_mt (vbool4_t mask, vint16m4_t maskedoff, vint8m2_t op1, size_t vl, uint8_t ta) {
  return vsext_vf2_i16m4_mt(mask, maskedoff, op1, vl, VE_TAIL_AGNOSTIC);
}
...
// CHECK-RV64-NEXT:    ret <vscale x 32 x i16> [[TMP0]]
//
vint16m8_t test_vsext_vf2_i16m8_mt (vbool2_t mask, vint16m8_t maskedoff, vint8m4_t op1, size_t vl, uint8_t ta) {
  return vsext_vf2_i16m8_mt(mask, maskedoff, op1, vl, VE_TAIL_AGNOSTIC);
}
...
// CHECK-RV64-NEXT:    ret <vscale x 1 x i32> [[TMP0]]
//
vint32mf2_t test_vsext_vf4_i32mf2_mt (vbool64_t mask, vint32mf2_t maskedoff, vint8mf8_t op1, size_t vl, uint8_t ta) {
  return vsext_vf4_i32mf2_mt(mask, maskedoff, op1, vl, VE_TAIL_AGNOSTIC);
}
...
// CHECK-RV64-NEXT:    ret <vscale x 2 x i32> [[TMP0]]
//
vint32m1_t test_vsext_vf4_i32m1_mt (vbool32_t mask, vint32m1_t maskedoff, vint8mf4_t op1, size_t vl, uint8_t ta) {
  return vsext_vf4_i32m1_mt(mask, maskedoff, op1, vl, VE_TAIL_AGNOSTIC);
}
...
// CHECK-RV64-NEXT:    ret <vscale x 4 x i32> [[TMP0]]
//
vint32m2_t test_vsext_vf4_i32m2_mt (vbool16_t mask, vint32m2_t maskedoff, vint8mf2_t op1, size_t vl, uint8_t ta) {
  return vsext_vf4_i32m2_mt(mask, maskedoff, op1, vl, VE_TAIL_AGNOSTIC);
}
...
// CHECK-RV64-NEXT:    ret <vscale x 8 x i32> [[TMP0]]
//
vint32m4_t test_vsext_vf4_i32m4_mt (vbool8_t mask, vint32m4_t maskedoff, vint8m1_t op1, size_t vl, uint8_t ta) {
  return vsext_vf4_i32m4_mt(mask, maskedoff, op1, vl, VE_TAIL_AGNOSTIC);
}
...
// CHECK-RV64-NEXT:    ret <vscale x 16 x i32> [[TMP0]]
//
vint32m8_t test_vsext_vf4_i32m8_mt (vbool4_t mask, vint32m8_t maskedoff, vint8m2_t op1, size_t vl, uint8_t ta) {
  return vsext_vf4_i32m8_mt(mask, maskedoff, op1, vl, VE_TAIL_AGNOSTIC);
}
...
// CHECK-RV64-NEXT:    ret <vscale x 1 x i64> [[TMP0]]
//
vint64m1_t test_vsext_vf8_i64m1_mt (vbool64_t mask, vint64m1_t maskedoff, vint8mf8_t op1, size_t vl, uint8_t ta) {
  return vsext_vf8_i64m1_mt(mask, maskedoff, op1, vl, VE_TAIL_AGNOSTIC);
}
...
// CHECK-RV64-NEXT:    ret <vscale x 2 x i64> [[TMP0]]
//
vint64m2_t test_vsext_vf8_i64m2_mt (vbool32_t mask, vint64m2_t maskedoff, vint8mf4_t op1, size_t vl, uint8_t ta) {
  return vsext_vf8_i64m2_mt(mask, maskedoff, op1, vl, VE_TAIL_AGNOSTIC);
}
...
// CHECK-RV64-NEXT:    ret <vscale x 4 x i64> [[TMP0]]
//
vint64m4_t test_vsext_vf8_i64m4_mt (vbool16_t mask, vint64m4_t maskedoff, vint8mf2_t op1, size_t vl, uint8_t ta) {
  return vsext_vf8_i64m4_mt(mask, maskedoff, op1, vl, VE_TAIL_AGNOSTIC);
}
...
// CHECK-RV64-NEXT:    ret <vscale x 8 x i64> [[TMP0]]
//
vint64m8_t test_vsext_vf8_i64m8_mt (vbool8_t mask, vint64m8_t maskedoff, vint8m1_t op1, size_t vl, uint8_t ta) {
  return vsext_vf8_i64m8_mt(mask, maskedoff, op1, vl, VE_TAIL_AGNOSTIC);
}
...
// CHECK-RV64-NEXT:    ret <vscale x 1 x i32> [[TMP0]]
//
vint32mf2_t test_vsext_vf2_i32mf2_mt (vbool64_t mask, vint32mf2_t maskedoff, vint16mf4_t op1, size_t vl, uint8_t ta) {
  return vsext_vf2_i32mf2_mt(mask, maskedoff, op1, vl, VE_TAIL_AGNOSTIC);
}
...
// CHECK-RV64-NEXT:    ret <vscale x 2 x i32> [[TMP0]]
//
vint32m1_t test_vsext_vf2_i32m1_mt (vbool32_t mask, vint32m1_t maskedoff, vint16mf2_t op1, size_t vl, uint8_t ta) {
  return vsext_vf2_i32m1_mt(mask, maskedoff, op1, vl, VE_TAIL_AGNOSTIC);
}
...
// CHECK-RV64-NEXT:    ret <vscale x 4 x i32> [[TMP0]]
//
vint32m2_t test_vsext_vf2_i32m2_mt (vbool16_t mask, vint32m2_t maskedoff, vint16m1_t op1, size_t vl, uint8_t ta) {
  return vsext_vf2_i32m2_mt(mask, maskedoff, op1, vl, VE_TAIL_AGNOSTIC);
}
...
// CHECK-RV64-NEXT:    ret <vscale x 8 x i32> [[TMP0]]
//
vint32m4_t test_vsext_vf2_i32m4_mt (vbool8_t mask, vint32m4_t maskedoff, vint16m2_t op1, size_t vl, uint8_t ta) {
  return vsext_vf2_i32m4_mt(mask, maskedoff, op1, vl, VE_TAIL_AGNOSTIC);
}
...
// CHECK-RV64-NEXT:    ret <vscale x 16 x i32> [[TMP0]]
//
vint32m8_t test_vsext_vf2_i32m8_mt (vbool4_t mask, vint32m8_t maskedoff, vint16m4_t op1, size_t vl, uint8_t ta) {
  return vsext_vf2_i32m8_mt(mask, maskedoff, op1, vl, VE_TAIL_AGNOSTIC);
}
...
// CHECK-RV64-NEXT:    ret <vscale x 1 x i64> [[TMP0]]
//
vint64m1_t test_vsext_vf4_i64m1_mt (vbool64_t mask, vint64m1_t maskedoff, vint16mf4_t op1, size_t vl, uint8_t ta) {
  return vsext_vf4_i64m1_mt(mask, maskedoff, op1, vl, VE_TAIL_AGNOSTIC);
}
...
// CHECK-RV64-NEXT:    ret <vscale x 2 x i64> [[TMP0]]
//
vint64m2_t test_vsext_vf4_i64m2_mt (vbool32_t mask, vint64m2_t maskedoff, vint16mf2_t op1, size_t vl, uint8_t ta) {
  return vsext_vf4_i64m2_mt(mask, maskedoff, op1, vl, VE_TAIL_AGNOSTIC);
}
...
// CHECK-RV64-NEXT:    ret <vscale x 4 x i64> [[TMP0]]
//
vint64m4_t test_vsext_vf4_i64m4_mt (vbool16_t mask, vint64m4_t maskedoff, vint16m1_t op1, size_t vl, uint8_t ta) {
  return vsext_vf4_i64m4_mt(mask, maskedoff, op1, vl, VE_TAIL_AGNOSTIC);
}
...
// CHECK-RV64-NEXT:    ret <vscale x 8 x i64> [[TMP0]]
//
vint64m8_t test_vsext_vf4_i64m8_mt (vbool8_t mask, vint64m8_t maskedoff, vint16m2_t op1, size_t vl, uint8_t ta) {
  return vsext_vf4_i64m8_mt(mask, maskedoff, op1, vl, VE_TAIL_AGNOSTIC);
}
...
// CHECK-RV64-NEXT:    ret <vscale x 1 x i64> [[TMP0]]
//
vint64m1_t test_vsext_vf2_i64m1_mt (vbool64_t mask, vint64m1_t maskedoff, vint32mf2_t op1, size_t vl, uint8_t ta) {
  return vsext_vf2_i64m1_mt(mask, maskedoff, op1, vl, VE_TAIL_AGNOSTIC);
}
...
// CHECK-RV64-NEXT:    ret <vscale x 2 x i64> [[TMP0]]
//
vint64m2_t test_vsext_vf2_i64m2_mt (vbool32_t mask, vint64m2_t maskedoff, vint32m1_t op1, size_t vl, uint8_t ta) {
  return vsext_vf2_i64m2_mt(mask, maskedoff, op1, vl, VE_TAIL_AGNOSTIC);
}
...
// CHECK-RV64-NEXT:    ret <vscale x 4 x i64> [[TMP0]]
//
vint64m4_t test_vsext_vf2_i64m4_mt (vbool16_t mask, vint64m4_t maskedoff, vint32m2_t op1, size_t vl, uint8_t ta) {
  return vsext_vf2_i64m4_mt(mask, maskedoff, op1, vl, VE_TAIL_AGNOSTIC);
}
...
// CHECK-RV64-NEXT:    ret <vscale x 8 x i64> [[TMP0]]
//
vint64m8_t test_vsext_vf2_i64m8_mt (vbool8_t mask, vint64m8_t maskedoff, vint32m4_t op1, size_t vl, uint8_t ta) {
  return vsext_vf2_i64m8_mt(mask, maskedoff, op1, vl, VE_TAIL_AGNOSTIC);
}
