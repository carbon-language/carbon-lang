...
// CHECK-RV64-NEXT:    ret <vscale x 1 x i8> [[TMP0]]
//
vint8mf8_t test_vfncvt_x_f_w_i8mf8_mt (vbool64_t mask, vint8mf8_t maskedoff, vfloat16mf4_t src, size_t vl, uint8_t ta) {
  return vfncvt_x_f_w_i8mf8_mt(mask, maskedoff, src, vl, VE_TAIL_AGNOSTIC);
}
...
// CHECK-RV64-NEXT:    ret <vscale x 1 x i8> [[TMP0]]
//
vint8mf8_t test_vfncvt_rtz_x_f_w_i8mf8_mt (vbool64_t mask, vint8mf8_t maskedoff, vfloat16mf4_t src, size_t vl, uint8_t ta) {
  return vfncvt_rtz_x_f_w_i8mf8_mt(mask, maskedoff, src, vl, VE_TAIL_AGNOSTIC);
}
...
// CHECK-RV64-NEXT:    ret <vscale x 2 x i8> [[TMP0]]
//
vint8mf4_t test_vfncvt_x_f_w_i8mf4_mt (vbool32_t mask, vint8mf4_t maskedoff, vfloat16mf2_t src, size_t vl, uint8_t ta) {
  return vfncvt_x_f_w_i8mf4_mt(mask, maskedoff, src, vl, VE_TAIL_AGNOSTIC);
}
...
// CHECK-RV64-NEXT:    ret <vscale x 2 x i8> [[TMP0]]
//
vint8mf4_t test_vfncvt_rtz_x_f_w_i8mf4_mt (vbool32_t mask, vint8mf4_t maskedoff, vfloat16mf2_t src, size_t vl, uint8_t ta) {
  return vfncvt_rtz_x_f_w_i8mf4_mt(mask, maskedoff, src, vl, VE_TAIL_AGNOSTIC);
}
...
// CHECK-RV64-NEXT:    ret <vscale x 4 x i8> [[TMP0]]
//
vint8mf2_t test_vfncvt_x_f_w_i8mf2_mt (vbool16_t mask, vint8mf2_t maskedoff, vfloat16m1_t src, size_t vl, uint8_t ta) {
  return vfncvt_x_f_w_i8mf2_mt(mask, maskedoff, src, vl, VE_TAIL_AGNOSTIC);
}
...
// CHECK-RV64-NEXT:    ret <vscale x 4 x i8> [[TMP0]]
//
vint8mf2_t test_vfncvt_rtz_x_f_w_i8mf2_mt (vbool16_t mask, vint8mf2_t maskedoff, vfloat16m1_t src, size_t vl, uint8_t ta) {
  return vfncvt_rtz_x_f_w_i8mf2_mt(mask, maskedoff, src, vl, VE_TAIL_AGNOSTIC);
}
...
// CHECK-RV64-NEXT:    ret <vscale x 8 x i8> [[TMP0]]
//
vint8m1_t test_vfncvt_x_f_w_i8m1_mt (vbool8_t mask, vint8m1_t maskedoff, vfloat16m2_t src, size_t vl, uint8_t ta) {
  return vfncvt_x_f_w_i8m1_mt(mask, maskedoff, src, vl, VE_TAIL_AGNOSTIC);
}
...
// CHECK-RV64-NEXT:    ret <vscale x 8 x i8> [[TMP0]]
//
vint8m1_t test_vfncvt_rtz_x_f_w_i8m1_mt (vbool8_t mask, vint8m1_t maskedoff, vfloat16m2_t src, size_t vl, uint8_t ta) {
  return vfncvt_rtz_x_f_w_i8m1_mt(mask, maskedoff, src, vl, VE_TAIL_AGNOSTIC);
}
...
// CHECK-RV64-NEXT:    ret <vscale x 16 x i8> [[TMP0]]
//
vint8m2_t test_vfncvt_x_f_w_i8m2_mt (vbool4_t mask, vint8m2_t maskedoff, vfloat16m4_t src, size_t vl, uint8_t ta) {
  return vfncvt_x_f_w_i8m2_mt(mask, maskedoff, src, vl, VE_TAIL_AGNOSTIC);
}
...
// CHECK-RV64-NEXT:    ret <vscale x 16 x i8> [[TMP0]]
//
vint8m2_t test_vfncvt_rtz_x_f_w_i8m2_mt (vbool4_t mask, vint8m2_t maskedoff, vfloat16m4_t src, size_t vl, uint8_t ta) {
  return vfncvt_rtz_x_f_w_i8m2_mt(mask, maskedoff, src, vl, VE_TAIL_AGNOSTIC);
}
...
// CHECK-RV64-NEXT:    ret <vscale x 32 x i8> [[TMP0]]
//
vint8m4_t test_vfncvt_x_f_w_i8m4_mt (vbool2_t mask, vint8m4_t maskedoff, vfloat16m8_t src, size_t vl, uint8_t ta) {
  return vfncvt_x_f_w_i8m4_mt(mask, maskedoff, src, vl, VE_TAIL_AGNOSTIC);
}
...
// CHECK-RV64-NEXT:    ret <vscale x 32 x i8> [[TMP0]]
//
vint8m4_t test_vfncvt_rtz_x_f_w_i8m4_mt (vbool2_t mask, vint8m4_t maskedoff, vfloat16m8_t src, size_t vl, uint8_t ta) {
  return vfncvt_rtz_x_f_w_i8m4_mt(mask, maskedoff, src, vl, VE_TAIL_AGNOSTIC);
}
...
// CHECK-RV64-NEXT:    ret <vscale x 1 x i8> [[TMP0]]
//
vuint8mf8_t test_vfncvt_xu_f_w_u8mf8_mt (vbool64_t mask, vuint8mf8_t maskedoff, vfloat16mf4_t src, size_t vl, uint8_t ta) {
  return vfncvt_xu_f_w_u8mf8_mt(mask, maskedoff, src, vl, VE_TAIL_AGNOSTIC);
}
...
// CHECK-RV64-NEXT:    ret <vscale x 1 x i8> [[TMP0]]
//
vuint8mf8_t test_vfncvt_rtz_xu_f_w_u8mf8_mt (vbool64_t mask, vuint8mf8_t maskedoff, vfloat16mf4_t src, size_t vl, uint8_t ta) {
  return vfncvt_rtz_xu_f_w_u8mf8_mt(mask, maskedoff, src, vl, VE_TAIL_AGNOSTIC);
}
...
// CHECK-RV64-NEXT:    ret <vscale x 2 x i8> [[TMP0]]
//
vuint8mf4_t test_vfncvt_xu_f_w_u8mf4_mt (vbool32_t mask, vuint8mf4_t maskedoff, vfloat16mf2_t src, size_t vl, uint8_t ta) {
  return vfncvt_xu_f_w_u8mf4_mt(mask, maskedoff, src, vl, VE_TAIL_AGNOSTIC);
}
...
// CHECK-RV64-NEXT:    ret <vscale x 2 x i8> [[TMP0]]
//
vuint8mf4_t test_vfncvt_rtz_xu_f_w_u8mf4_mt (vbool32_t mask, vuint8mf4_t maskedoff, vfloat16mf2_t src, size_t vl, uint8_t ta) {
  return vfncvt_rtz_xu_f_w_u8mf4_mt(mask, maskedoff, src, vl, VE_TAIL_AGNOSTIC);
}
...
// CHECK-RV64-NEXT:    ret <vscale x 4 x i8> [[TMP0]]
//
vuint8mf2_t test_vfncvt_xu_f_w_u8mf2_mt (vbool16_t mask, vuint8mf2_t maskedoff, vfloat16m1_t src, size_t vl, uint8_t ta) {
  return vfncvt_xu_f_w_u8mf2_mt(mask, maskedoff, src, vl, VE_TAIL_AGNOSTIC);
}
...
// CHECK-RV64-NEXT:    ret <vscale x 4 x i8> [[TMP0]]
//
vuint8mf2_t test_vfncvt_rtz_xu_f_w_u8mf2_mt (vbool16_t mask, vuint8mf2_t maskedoff, vfloat16m1_t src, size_t vl, uint8_t ta) {
  return vfncvt_rtz_xu_f_w_u8mf2_mt(mask, maskedoff, src, vl, VE_TAIL_AGNOSTIC);
}
...
// CHECK-RV64-NEXT:    ret <vscale x 8 x i8> [[TMP0]]
//
vuint8m1_t test_vfncvt_xu_f_w_u8m1_mt (vbool8_t mask, vuint8m1_t maskedoff, vfloat16m2_t src, size_t vl, uint8_t ta) {
  return vfncvt_xu_f_w_u8m1_mt(mask, maskedoff, src, vl, VE_TAIL_AGNOSTIC);
}
...
// CHECK-RV64-NEXT:    ret <vscale x 8 x i8> [[TMP0]]
//
vuint8m1_t test_vfncvt_rtz_xu_f_w_u8m1_mt (vbool8_t mask, vuint8m1_t maskedoff, vfloat16m2_t src, size_t vl, uint8_t ta) {
  return vfncvt_rtz_xu_f_w_u8m1_mt(mask, maskedoff, src, vl, VE_TAIL_AGNOSTIC);
}
...
// CHECK-RV64-NEXT:    ret <vscale x 16 x i8> [[TMP0]]
//
vuint8m2_t test_vfncvt_xu_f_w_u8m2_mt (vbool4_t mask, vuint8m2_t maskedoff, vfloat16m4_t src, size_t vl, uint8_t ta) {
  return vfncvt_xu_f_w_u8m2_mt(mask, maskedoff, src, vl, VE_TAIL_AGNOSTIC);
}
...
// CHECK-RV64-NEXT:    ret <vscale x 16 x i8> [[TMP0]]
//
vuint8m2_t test_vfncvt_rtz_xu_f_w_u8m2_mt (vbool4_t mask, vuint8m2_t maskedoff, vfloat16m4_t src, size_t vl, uint8_t ta) {
  return vfncvt_rtz_xu_f_w_u8m2_mt(mask, maskedoff, src, vl, VE_TAIL_AGNOSTIC);
}
...
// CHECK-RV64-NEXT:    ret <vscale x 32 x i8> [[TMP0]]
//
vuint8m4_t test_vfncvt_xu_f_w_u8m4_mt (vbool2_t mask, vuint8m4_t maskedoff, vfloat16m8_t src, size_t vl, uint8_t ta) {
  return vfncvt_xu_f_w_u8m4_mt(mask, maskedoff, src, vl, VE_TAIL_AGNOSTIC);
}
...
// CHECK-RV64-NEXT:    ret <vscale x 32 x i8> [[TMP0]]
//
vuint8m4_t test_vfncvt_rtz_xu_f_w_u8m4_mt (vbool2_t mask, vuint8m4_t maskedoff, vfloat16m8_t src, size_t vl, uint8_t ta) {
  return vfncvt_rtz_xu_f_w_u8m4_mt(mask, maskedoff, src, vl, VE_TAIL_AGNOSTIC);
}
...
// CHECK-RV64-NEXT:    ret <vscale x 1 x i16> [[TMP0]]
//
vint16mf4_t test_vfncvt_x_f_w_i16mf4_mt (vbool64_t mask, vint16mf4_t maskedoff, vfloat32mf2_t src, size_t vl, uint8_t ta) {
  return vfncvt_x_f_w_i16mf4_mt(mask, maskedoff, src, vl, VE_TAIL_AGNOSTIC);
}
...
// CHECK-RV64-NEXT:    ret <vscale x 1 x i16> [[TMP0]]
//
vint16mf4_t test_vfncvt_rtz_x_f_w_i16mf4_mt (vbool64_t mask, vint16mf4_t maskedoff, vfloat32mf2_t src, size_t vl, uint8_t ta) {
  return vfncvt_rtz_x_f_w_i16mf4_mt(mask, maskedoff, src, vl, VE_TAIL_AGNOSTIC);
}
...
// CHECK-RV64-NEXT:    ret <vscale x 2 x i16> [[TMP0]]
//
vint16mf2_t test_vfncvt_x_f_w_i16mf2_mt (vbool32_t mask, vint16mf2_t maskedoff, vfloat32m1_t src, size_t vl, uint8_t ta) {
  return vfncvt_x_f_w_i16mf2_mt(mask, maskedoff, src, vl, VE_TAIL_AGNOSTIC);
}
...
// CHECK-RV64-NEXT:    ret <vscale x 2 x i16> [[TMP0]]
//
vint16mf2_t test_vfncvt_rtz_x_f_w_i16mf2_mt (vbool32_t mask, vint16mf2_t maskedoff, vfloat32m1_t src, size_t vl, uint8_t ta) {
  return vfncvt_rtz_x_f_w_i16mf2_mt(mask, maskedoff, src, vl, VE_TAIL_AGNOSTIC);
}
...
// CHECK-RV64-NEXT:    ret <vscale x 4 x i16> [[TMP0]]
//
vint16m1_t test_vfncvt_x_f_w_i16m1_mt (vbool16_t mask, vint16m1_t maskedoff, vfloat32m2_t src, size_t vl, uint8_t ta) {
  return vfncvt_x_f_w_i16m1_mt(mask, maskedoff, src, vl, VE_TAIL_AGNOSTIC);
}
...
// CHECK-RV64-NEXT:    ret <vscale x 4 x i16> [[TMP0]]
//
vint16m1_t test_vfncvt_rtz_x_f_w_i16m1_mt (vbool16_t mask, vint16m1_t maskedoff, vfloat32m2_t src, size_t vl, uint8_t ta) {
  return vfncvt_rtz_x_f_w_i16m1_mt(mask, maskedoff, src, vl, VE_TAIL_AGNOSTIC);
}
...
// CHECK-RV64-NEXT:    ret <vscale x 8 x i16> [[TMP0]]
//
vint16m2_t test_vfncvt_x_f_w_i16m2_mt (vbool8_t mask, vint16m2_t maskedoff, vfloat32m4_t src, size_t vl, uint8_t ta) {
  return vfncvt_x_f_w_i16m2_mt(mask, maskedoff, src, vl, VE_TAIL_AGNOSTIC);
}
...
// CHECK-RV64-NEXT:    ret <vscale x 8 x i16> [[TMP0]]
//
vint16m2_t test_vfncvt_rtz_x_f_w_i16m2_mt (vbool8_t mask, vint16m2_t maskedoff, vfloat32m4_t src, size_t vl, uint8_t ta) {
  return vfncvt_rtz_x_f_w_i16m2_mt(mask, maskedoff, src, vl, VE_TAIL_AGNOSTIC);
}
...
// CHECK-RV64-NEXT:    ret <vscale x 16 x i16> [[TMP0]]
//
vint16m4_t test_vfncvt_x_f_w_i16m4_mt (vbool4_t mask, vint16m4_t maskedoff, vfloat32m8_t src, size_t vl, uint8_t ta) {
  return vfncvt_x_f_w_i16m4_mt(mask, maskedoff, src, vl, VE_TAIL_AGNOSTIC);
}
...
// CHECK-RV64-NEXT:    ret <vscale x 16 x i16> [[TMP0]]
//
vint16m4_t test_vfncvt_rtz_x_f_w_i16m4_mt (vbool4_t mask, vint16m4_t maskedoff, vfloat32m8_t src, size_t vl, uint8_t ta) {
  return vfncvt_rtz_x_f_w_i16m4_mt(mask, maskedoff, src, vl, VE_TAIL_AGNOSTIC);
}
...
// CHECK-RV64-NEXT:    ret <vscale x 1 x i16> [[TMP0]]
//
vuint16mf4_t test_vfncvt_xu_f_w_u16mf4_mt (vbool64_t mask, vuint16mf4_t maskedoff, vfloat32mf2_t src, size_t vl, uint8_t ta) {
  return vfncvt_xu_f_w_u16mf4_mt(mask, maskedoff, src, vl, VE_TAIL_AGNOSTIC);
}
...
// CHECK-RV64-NEXT:    ret <vscale x 1 x i16> [[TMP0]]
//
vuint16mf4_t test_vfncvt_rtz_xu_f_w_u16mf4_mt (vbool64_t mask, vuint16mf4_t maskedoff, vfloat32mf2_t src, size_t vl, uint8_t ta) {
  return vfncvt_rtz_xu_f_w_u16mf4_mt(mask, maskedoff, src, vl, VE_TAIL_AGNOSTIC);
}
...
// CHECK-RV64-NEXT:    ret <vscale x 2 x i16> [[TMP0]]
//
vuint16mf2_t test_vfncvt_xu_f_w_u16mf2_mt (vbool32_t mask, vuint16mf2_t maskedoff, vfloat32m1_t src, size_t vl, uint8_t ta) {
  return vfncvt_xu_f_w_u16mf2_mt(mask, maskedoff, src, vl, VE_TAIL_AGNOSTIC);
}
...
// CHECK-RV64-NEXT:    ret <vscale x 2 x i16> [[TMP0]]
//
vuint16mf2_t test_vfncvt_rtz_xu_f_w_u16mf2_mt (vbool32_t mask, vuint16mf2_t maskedoff, vfloat32m1_t src, size_t vl, uint8_t ta) {
  return vfncvt_rtz_xu_f_w_u16mf2_mt(mask, maskedoff, src, vl, VE_TAIL_AGNOSTIC);
}
...
// CHECK-RV64-NEXT:    ret <vscale x 4 x i16> [[TMP0]]
//
vuint16m1_t test_vfncvt_xu_f_w_u16m1_mt (vbool16_t mask, vuint16m1_t maskedoff, vfloat32m2_t src, size_t vl, uint8_t ta) {
  return vfncvt_xu_f_w_u16m1_mt(mask, maskedoff, src, vl, VE_TAIL_AGNOSTIC);
}
...
// CHECK-RV64-NEXT:    ret <vscale x 4 x i16> [[TMP0]]
//
vuint16m1_t test_vfncvt_rtz_xu_f_w_u16m1_mt (vbool16_t mask, vuint16m1_t maskedoff, vfloat32m2_t src, size_t vl, uint8_t ta) {
  return vfncvt_rtz_xu_f_w_u16m1_mt(mask, maskedoff, src, vl, VE_TAIL_AGNOSTIC);
}
...
// CHECK-RV64-NEXT:    ret <vscale x 8 x i16> [[TMP0]]
//
vuint16m2_t test_vfncvt_xu_f_w_u16m2_mt (vbool8_t mask, vuint16m2_t maskedoff, vfloat32m4_t src, size_t vl, uint8_t ta) {
  return vfncvt_xu_f_w_u16m2_mt(mask, maskedoff, src, vl, VE_TAIL_AGNOSTIC);
}
...
// CHECK-RV64-NEXT:    ret <vscale x 8 x i16> [[TMP0]]
//
vuint16m2_t test_vfncvt_rtz_xu_f_w_u16m2_mt (vbool8_t mask, vuint16m2_t maskedoff, vfloat32m4_t src, size_t vl, uint8_t ta) {
  return vfncvt_rtz_xu_f_w_u16m2_mt(mask, maskedoff, src, vl, VE_TAIL_AGNOSTIC);
}
...
// CHECK-RV64-NEXT:    ret <vscale x 16 x i16> [[TMP0]]
//
vuint16m4_t test_vfncvt_xu_f_w_u16m4_mt (vbool4_t mask, vuint16m4_t maskedoff, vfloat32m8_t src, size_t vl, uint8_t ta) {
  return vfncvt_xu_f_w_u16m4_mt(mask, maskedoff, src, vl, VE_TAIL_AGNOSTIC);
}
...
// CHECK-RV64-NEXT:    ret <vscale x 16 x i16> [[TMP0]]
//
vuint16m4_t test_vfncvt_rtz_xu_f_w_u16m4_mt (vbool4_t mask, vuint16m4_t maskedoff, vfloat32m8_t src, size_t vl, uint8_t ta) {
  return vfncvt_rtz_xu_f_w_u16m4_mt(mask, maskedoff, src, vl, VE_TAIL_AGNOSTIC);
}
...
// CHECK-RV64-NEXT:    ret <vscale x 1 x half> [[TMP0]]
//
vfloat16mf4_t test_vfncvt_f_x_w_f16mf4_mt (vbool64_t mask, vfloat16mf4_t maskedoff, vint32mf2_t src, size_t vl, uint8_t ta) {
  return vfncvt_f_x_w_f16mf4_mt(mask, maskedoff, src, vl, VE_TAIL_AGNOSTIC);
}
...
// CHECK-RV64-NEXT:    ret <vscale x 2 x half> [[TMP0]]
//
vfloat16mf2_t test_vfncvt_f_x_w_f16mf2_mt (vbool32_t mask, vfloat16mf2_t maskedoff, vint32m1_t src, size_t vl, uint8_t ta) {
  return vfncvt_f_x_w_f16mf2_mt(mask, maskedoff, src, vl, VE_TAIL_AGNOSTIC);
}
...
// CHECK-RV64-NEXT:    ret <vscale x 4 x half> [[TMP0]]
//
vfloat16m1_t test_vfncvt_f_x_w_f16m1_mt (vbool16_t mask, vfloat16m1_t maskedoff, vint32m2_t src, size_t vl, uint8_t ta) {
  return vfncvt_f_x_w_f16m1_mt(mask, maskedoff, src, vl, VE_TAIL_AGNOSTIC);
}
...
// CHECK-RV64-NEXT:    ret <vscale x 8 x half> [[TMP0]]
//
vfloat16m2_t test_vfncvt_f_x_w_f16m2_mt (vbool8_t mask, vfloat16m2_t maskedoff, vint32m4_t src, size_t vl, uint8_t ta) {
  return vfncvt_f_x_w_f16m2_mt(mask, maskedoff, src, vl, VE_TAIL_AGNOSTIC);
}
...
// CHECK-RV64-NEXT:    ret <vscale x 16 x half> [[TMP0]]
//
vfloat16m4_t test_vfncvt_f_x_w_f16m4_mt (vbool4_t mask, vfloat16m4_t maskedoff, vint32m8_t src, size_t vl, uint8_t ta) {
  return vfncvt_f_x_w_f16m4_mt(mask, maskedoff, src, vl, VE_TAIL_AGNOSTIC);
}
...
// CHECK-RV64-NEXT:    ret <vscale x 1 x half> [[TMP0]]
//
vfloat16mf4_t test_vfncvt_f_xu_w_f16mf4_mt (vbool64_t mask, vfloat16mf4_t maskedoff, vuint32mf2_t src, size_t vl, uint8_t ta) {
  return vfncvt_f_xu_w_f16mf4_mt(mask, maskedoff, src, vl, VE_TAIL_AGNOSTIC);
}
...
// CHECK-RV64-NEXT:    ret <vscale x 2 x half> [[TMP0]]
//
vfloat16mf2_t test_vfncvt_f_xu_w_f16mf2_mt (vbool32_t mask, vfloat16mf2_t maskedoff, vuint32m1_t src, size_t vl, uint8_t ta) {
  return vfncvt_f_xu_w_f16mf2_mt(mask, maskedoff, src, vl, VE_TAIL_AGNOSTIC);
}
...
// CHECK-RV64-NEXT:    ret <vscale x 4 x half> [[TMP0]]
//
vfloat16m1_t test_vfncvt_f_xu_w_f16m1_mt (vbool16_t mask, vfloat16m1_t maskedoff, vuint32m2_t src, size_t vl, uint8_t ta) {
  return vfncvt_f_xu_w_f16m1_mt(mask, maskedoff, src, vl, VE_TAIL_AGNOSTIC);
}
...
// CHECK-RV64-NEXT:    ret <vscale x 8 x half> [[TMP0]]
//
vfloat16m2_t test_vfncvt_f_xu_w_f16m2_mt (vbool8_t mask, vfloat16m2_t maskedoff, vuint32m4_t src, size_t vl, uint8_t ta) {
  return vfncvt_f_xu_w_f16m2_mt(mask, maskedoff, src, vl, VE_TAIL_AGNOSTIC);
}
...
// CHECK-RV64-NEXT:    ret <vscale x 16 x half> [[TMP0]]
//
vfloat16m4_t test_vfncvt_f_xu_w_f16m4_mt (vbool4_t mask, vfloat16m4_t maskedoff, vuint32m8_t src, size_t vl, uint8_t ta) {
  return vfncvt_f_xu_w_f16m4_mt(mask, maskedoff, src, vl, VE_TAIL_AGNOSTIC);
}
...
// CHECK-RV64-NEXT:    ret <vscale x 1 x half> [[TMP0]]
//
vfloat16mf4_t test_vfncvt_f_f_w_f16mf4_mt (vbool64_t mask, vfloat16mf4_t maskedoff, vfloat32mf2_t src, size_t vl, uint8_t ta) {
  return vfncvt_f_f_w_f16mf4_mt(mask, maskedoff, src, vl, VE_TAIL_AGNOSTIC);
}
...
// CHECK-RV64-NEXT:    ret <vscale x 1 x half> [[TMP0]]
//
vfloat16mf4_t test_vfncvt_rod_f_f_w_f16mf4_mt (vbool64_t mask, vfloat16mf4_t maskedoff, vfloat32mf2_t src, size_t vl, uint8_t ta) {
  return vfncvt_rod_f_f_w_f16mf4_mt(mask, maskedoff, src, vl, VE_TAIL_AGNOSTIC);
}
...
// CHECK-RV64-NEXT:    ret <vscale x 2 x half> [[TMP0]]
//
vfloat16mf2_t test_vfncvt_f_f_w_f16mf2_mt (vbool32_t mask, vfloat16mf2_t maskedoff, vfloat32m1_t src, size_t vl, uint8_t ta) {
  return vfncvt_f_f_w_f16mf2_mt(mask, maskedoff, src, vl, VE_TAIL_AGNOSTIC);
}
...
// CHECK-RV64-NEXT:    ret <vscale x 2 x half> [[TMP0]]
//
vfloat16mf2_t test_vfncvt_rod_f_f_w_f16mf2_mt (vbool32_t mask, vfloat16mf2_t maskedoff, vfloat32m1_t src, size_t vl, uint8_t ta) {
  return vfncvt_rod_f_f_w_f16mf2_mt(mask, maskedoff, src, vl, VE_TAIL_AGNOSTIC);
}
...
// CHECK-RV64-NEXT:    ret <vscale x 4 x half> [[TMP0]]
//
vfloat16m1_t test_vfncvt_f_f_w_f16m1_mt (vbool16_t mask, vfloat16m1_t maskedoff, vfloat32m2_t src, size_t vl, uint8_t ta) {
  return vfncvt_f_f_w_f16m1_mt(mask, maskedoff, src, vl, VE_TAIL_AGNOSTIC);
}
...
// CHECK-RV64-NEXT:    ret <vscale x 4 x half> [[TMP0]]
//
vfloat16m1_t test_vfncvt_rod_f_f_w_f16m1_mt (vbool16_t mask, vfloat16m1_t maskedoff, vfloat32m2_t src, size_t vl, uint8_t ta) {
  return vfncvt_rod_f_f_w_f16m1_mt(mask, maskedoff, src, vl, VE_TAIL_AGNOSTIC);
}
...
// CHECK-RV64-NEXT:    ret <vscale x 8 x half> [[TMP0]]
//
vfloat16m2_t test_vfncvt_f_f_w_f16m2_mt (vbool8_t mask, vfloat16m2_t maskedoff, vfloat32m4_t src, size_t vl, uint8_t ta) {
  return vfncvt_f_f_w_f16m2_mt(mask, maskedoff, src, vl, VE_TAIL_AGNOSTIC);
}
...
// CHECK-RV64-NEXT:    ret <vscale x 8 x half> [[TMP0]]
//
vfloat16m2_t test_vfncvt_rod_f_f_w_f16m2_mt (vbool8_t mask, vfloat16m2_t maskedoff, vfloat32m4_t src, size_t vl, uint8_t ta) {
  return vfncvt_rod_f_f_w_f16m2_mt(mask, maskedoff, src, vl, VE_TAIL_AGNOSTIC);
}
...
// CHECK-RV64-NEXT:    ret <vscale x 16 x half> [[TMP0]]
//
vfloat16m4_t test_vfncvt_f_f_w_f16m4_mt (vbool4_t mask, vfloat16m4_t maskedoff, vfloat32m8_t src, size_t vl, uint8_t ta) {
  return vfncvt_f_f_w_f16m4_mt(mask, maskedoff, src, vl, VE_TAIL_AGNOSTIC);
}
...
// CHECK-RV64-NEXT:    ret <vscale x 16 x half> [[TMP0]]
//
vfloat16m4_t test_vfncvt_rod_f_f_w_f16m4_mt (vbool4_t mask, vfloat16m4_t maskedoff, vfloat32m8_t src, size_t vl, uint8_t ta) {
  return vfncvt_rod_f_f_w_f16m4_mt(mask, maskedoff, src, vl, VE_TAIL_AGNOSTIC);
}
...
// CHECK-RV64-NEXT:    ret <vscale x 1 x i32> [[TMP0]]
//
vint32mf2_t test_vfncvt_x_f_w_i32mf2_mt (vbool64_t mask, vint32mf2_t maskedoff, vfloat64m1_t src, size_t vl, uint8_t ta) {
  return vfncvt_x_f_w_i32mf2_mt(mask, maskedoff, src, vl, VE_TAIL_AGNOSTIC);
}
...
// CHECK-RV64-NEXT:    ret <vscale x 1 x i32> [[TMP0]]
//
vint32mf2_t test_vfncvt_rtz_x_f_w_i32mf2_mt (vbool64_t mask, vint32mf2_t maskedoff, vfloat64m1_t src, size_t vl, uint8_t ta) {
  return vfncvt_rtz_x_f_w_i32mf2_mt(mask, maskedoff, src, vl, VE_TAIL_AGNOSTIC);
}
...
// CHECK-RV64-NEXT:    ret <vscale x 2 x i32> [[TMP0]]
//
vint32m1_t test_vfncvt_x_f_w_i32m1_mt (vbool32_t mask, vint32m1_t maskedoff, vfloat64m2_t src, size_t vl, uint8_t ta) {
  return vfncvt_x_f_w_i32m1_mt(mask, maskedoff, src, vl, VE_TAIL_AGNOSTIC);
}
...
// CHECK-RV64-NEXT:    ret <vscale x 2 x i32> [[TMP0]]
//
vint32m1_t test_vfncvt_rtz_x_f_w_i32m1_mt (vbool32_t mask, vint32m1_t maskedoff, vfloat64m2_t src, size_t vl, uint8_t ta) {
  return vfncvt_rtz_x_f_w_i32m1_mt(mask, maskedoff, src, vl, VE_TAIL_AGNOSTIC);
}
...
// CHECK-RV64-NEXT:    ret <vscale x 4 x i32> [[TMP0]]
//
vint32m2_t test_vfncvt_x_f_w_i32m2_mt (vbool16_t mask, vint32m2_t maskedoff, vfloat64m4_t src, size_t vl, uint8_t ta) {
  return vfncvt_x_f_w_i32m2_mt(mask, maskedoff, src, vl, VE_TAIL_AGNOSTIC);
}
...
// CHECK-RV64-NEXT:    ret <vscale x 4 x i32> [[TMP0]]
//
vint32m2_t test_vfncvt_rtz_x_f_w_i32m2_mt (vbool16_t mask, vint32m2_t maskedoff, vfloat64m4_t src, size_t vl, uint8_t ta) {
  return vfncvt_rtz_x_f_w_i32m2_mt(mask, maskedoff, src, vl, VE_TAIL_AGNOSTIC);
}
...
// CHECK-RV64-NEXT:    ret <vscale x 8 x i32> [[TMP0]]
//
vint32m4_t test_vfncvt_x_f_w_i32m4_mt (vbool8_t mask, vint32m4_t maskedoff, vfloat64m8_t src, size_t vl, uint8_t ta) {
  return vfncvt_x_f_w_i32m4_mt(mask, maskedoff, src, vl, VE_TAIL_AGNOSTIC);
}
...
// CHECK-RV64-NEXT:    ret <vscale x 8 x i32> [[TMP0]]
//
vint32m4_t test_vfncvt_rtz_x_f_w_i32m4_mt (vbool8_t mask, vint32m4_t maskedoff, vfloat64m8_t src, size_t vl, uint8_t ta) {
  return vfncvt_rtz_x_f_w_i32m4_mt(mask, maskedoff, src, vl, VE_TAIL_AGNOSTIC);
}
...
// CHECK-RV64-NEXT:    ret <vscale x 1 x i32> [[TMP0]]
//
vuint32mf2_t test_vfncvt_xu_f_w_u32mf2_mt (vbool64_t mask, vuint32mf2_t maskedoff, vfloat64m1_t src, size_t vl, uint8_t ta) {
  return vfncvt_xu_f_w_u32mf2_mt(mask, maskedoff, src, vl, VE_TAIL_AGNOSTIC);
}
...
// CHECK-RV64-NEXT:    ret <vscale x 1 x i32> [[TMP0]]
//
vuint32mf2_t test_vfncvt_rtz_xu_f_w_u32mf2_mt (vbool64_t mask, vuint32mf2_t maskedoff, vfloat64m1_t src, size_t vl, uint8_t ta) {
  return vfncvt_rtz_xu_f_w_u32mf2_mt(mask, maskedoff, src, vl, VE_TAIL_AGNOSTIC);
}
...
// CHECK-RV64-NEXT:    ret <vscale x 2 x i32> [[TMP0]]
//
vuint32m1_t test_vfncvt_xu_f_w_u32m1_mt (vbool32_t mask, vuint32m1_t maskedoff, vfloat64m2_t src, size_t vl, uint8_t ta) {
  return vfncvt_xu_f_w_u32m1_mt(mask, maskedoff, src, vl, VE_TAIL_AGNOSTIC);
}
...
// CHECK-RV64-NEXT:    ret <vscale x 2 x i32> [[TMP0]]
//
vuint32m1_t test_vfncvt_rtz_xu_f_w_u32m1_mt (vbool32_t mask, vuint32m1_t maskedoff, vfloat64m2_t src, size_t vl, uint8_t ta) {
  return vfncvt_rtz_xu_f_w_u32m1_mt(mask, maskedoff, src, vl, VE_TAIL_AGNOSTIC);
}
...
// CHECK-RV64-NEXT:    ret <vscale x 4 x i32> [[TMP0]]
//
vuint32m2_t test_vfncvt_xu_f_w_u32m2_mt (vbool16_t mask, vuint32m2_t maskedoff, vfloat64m4_t src, size_t vl, uint8_t ta) {
  return vfncvt_xu_f_w_u32m2_mt(mask, maskedoff, src, vl, VE_TAIL_AGNOSTIC);
}
...
// CHECK-RV64-NEXT:    ret <vscale x 4 x i32> [[TMP0]]
//
vuint32m2_t test_vfncvt_rtz_xu_f_w_u32m2_mt (vbool16_t mask, vuint32m2_t maskedoff, vfloat64m4_t src, size_t vl, uint8_t ta) {
  return vfncvt_rtz_xu_f_w_u32m2_mt(mask, maskedoff, src, vl, VE_TAIL_AGNOSTIC);
}
...
// CHECK-RV64-NEXT:    ret <vscale x 8 x i32> [[TMP0]]
//
vuint32m4_t test_vfncvt_xu_f_w_u32m4_mt (vbool8_t mask, vuint32m4_t maskedoff, vfloat64m8_t src, size_t vl, uint8_t ta) {
  return vfncvt_xu_f_w_u32m4_mt(mask, maskedoff, src, vl, VE_TAIL_AGNOSTIC);
}
...
// CHECK-RV64-NEXT:    ret <vscale x 8 x i32> [[TMP0]]
//
vuint32m4_t test_vfncvt_rtz_xu_f_w_u32m4_mt (vbool8_t mask, vuint32m4_t maskedoff, vfloat64m8_t src, size_t vl, uint8_t ta) {
  return vfncvt_rtz_xu_f_w_u32m4_mt(mask, maskedoff, src, vl, VE_TAIL_AGNOSTIC);
}
...
// CHECK-RV64-NEXT:    ret <vscale x 1 x float> [[TMP0]]
//
vfloat32mf2_t test_vfncvt_f_x_w_f32mf2_mt (vbool64_t mask, vfloat32mf2_t maskedoff, vint64m1_t src, size_t vl, uint8_t ta) {
  return vfncvt_f_x_w_f32mf2_mt(mask, maskedoff, src, vl, VE_TAIL_AGNOSTIC);
}
...
// CHECK-RV64-NEXT:    ret <vscale x 2 x float> [[TMP0]]
//
vfloat32m1_t test_vfncvt_f_x_w_f32m1_mt (vbool32_t mask, vfloat32m1_t maskedoff, vint64m2_t src, size_t vl, uint8_t ta) {
  return vfncvt_f_x_w_f32m1_mt(mask, maskedoff, src, vl, VE_TAIL_AGNOSTIC);
}
...
// CHECK-RV64-NEXT:    ret <vscale x 4 x float> [[TMP0]]
//
vfloat32m2_t test_vfncvt_f_x_w_f32m2_mt (vbool16_t mask, vfloat32m2_t maskedoff, vint64m4_t src, size_t vl, uint8_t ta) {
  return vfncvt_f_x_w_f32m2_mt(mask, maskedoff, src, vl, VE_TAIL_AGNOSTIC);
}
...
// CHECK-RV64-NEXT:    ret <vscale x 8 x float> [[TMP0]]
//
vfloat32m4_t test_vfncvt_f_x_w_f32m4_mt (vbool8_t mask, vfloat32m4_t maskedoff, vint64m8_t src, size_t vl, uint8_t ta) {
  return vfncvt_f_x_w_f32m4_mt(mask, maskedoff, src, vl, VE_TAIL_AGNOSTIC);
}
...
// CHECK-RV64-NEXT:    ret <vscale x 1 x float> [[TMP0]]
//
vfloat32mf2_t test_vfncvt_f_xu_w_f32mf2_mt (vbool64_t mask, vfloat32mf2_t maskedoff, vuint64m1_t src, size_t vl, uint8_t ta) {
  return vfncvt_f_xu_w_f32mf2_mt(mask, maskedoff, src, vl, VE_TAIL_AGNOSTIC);
}
...
// CHECK-RV64-NEXT:    ret <vscale x 2 x float> [[TMP0]]
//
vfloat32m1_t test_vfncvt_f_xu_w_f32m1_mt (vbool32_t mask, vfloat32m1_t maskedoff, vuint64m2_t src, size_t vl, uint8_t ta) {
  return vfncvt_f_xu_w_f32m1_mt(mask, maskedoff, src, vl, VE_TAIL_AGNOSTIC);
}
...
// CHECK-RV64-NEXT:    ret <vscale x 4 x float> [[TMP0]]
//
vfloat32m2_t test_vfncvt_f_xu_w_f32m2_mt (vbool16_t mask, vfloat32m2_t maskedoff, vuint64m4_t src, size_t vl, uint8_t ta) {
  return vfncvt_f_xu_w_f32m2_mt(mask, maskedoff, src, vl, VE_TAIL_AGNOSTIC);
}
...
// CHECK-RV64-NEXT:    ret <vscale x 8 x float> [[TMP0]]
//
vfloat32m4_t test_vfncvt_f_xu_w_f32m4_mt (vbool8_t mask, vfloat32m4_t maskedoff, vuint64m8_t src, size_t vl, uint8_t ta) {
  return vfncvt_f_xu_w_f32m4_mt(mask, maskedoff, src, vl, VE_TAIL_AGNOSTIC);
}
...
// CHECK-RV64-NEXT:    ret <vscale x 1 x float> [[TMP0]]
//
vfloat32mf2_t test_vfncvt_f_f_w_f32mf2_mt (vbool64_t mask, vfloat32mf2_t maskedoff, vfloat64m1_t src, size_t vl, uint8_t ta) {
  return vfncvt_f_f_w_f32mf2_mt(mask, maskedoff, src, vl, VE_TAIL_AGNOSTIC);
}
...
// CHECK-RV64-NEXT:    ret <vscale x 1 x float> [[TMP0]]
//
vfloat32mf2_t test_vfncvt_rod_f_f_w_f32mf2_mt (vbool64_t mask, vfloat32mf2_t maskedoff, vfloat64m1_t src, size_t vl, uint8_t ta) {
  return vfncvt_rod_f_f_w_f32mf2_mt(mask, maskedoff, src, vl, VE_TAIL_AGNOSTIC);
}
...
// CHECK-RV64-NEXT:    ret <vscale x 2 x float> [[TMP0]]
//
vfloat32m1_t test_vfncvt_f_f_w_f32m1_mt (vbool32_t mask, vfloat32m1_t maskedoff, vfloat64m2_t src, size_t vl, uint8_t ta) {
  return vfncvt_f_f_w_f32m1_mt(mask, maskedoff, src, vl, VE_TAIL_AGNOSTIC);
}
...
// CHECK-RV64-NEXT:    ret <vscale x 2 x float> [[TMP0]]
//
vfloat32m1_t test_vfncvt_rod_f_f_w_f32m1_mt (vbool32_t mask, vfloat32m1_t maskedoff, vfloat64m2_t src, size_t vl, uint8_t ta) {
  return vfncvt_rod_f_f_w_f32m1_mt(mask, maskedoff, src, vl, VE_TAIL_AGNOSTIC);
}
...
// CHECK-RV64-NEXT:    ret <vscale x 4 x float> [[TMP0]]
//
vfloat32m2_t test_vfncvt_f_f_w_f32m2_mt (vbool16_t mask, vfloat32m2_t maskedoff, vfloat64m4_t src, size_t vl, uint8_t ta) {
  return vfncvt_f_f_w_f32m2_mt(mask, maskedoff, src, vl, VE_TAIL_AGNOSTIC);
}
...
// CHECK-RV64-NEXT:    ret <vscale x 4 x float> [[TMP0]]
//
vfloat32m2_t test_vfncvt_rod_f_f_w_f32m2_mt (vbool16_t mask, vfloat32m2_t maskedoff, vfloat64m4_t src, size_t vl, uint8_t ta) {
  return vfncvt_rod_f_f_w_f32m2_mt(mask, maskedoff, src, vl, VE_TAIL_AGNOSTIC);
}
...
// CHECK-RV64-NEXT:    ret <vscale x 8 x float> [[TMP0]]
//
vfloat32m4_t test_vfncvt_f_f_w_f32m4_mt (vbool8_t mask, vfloat32m4_t maskedoff, vfloat64m8_t src, size_t vl, uint8_t ta) {
  return vfncvt_f_f_w_f32m4_mt(mask, maskedoff, src, vl, VE_TAIL_AGNOSTIC);
}
...
// CHECK-RV64-NEXT:    ret <vscale x 8 x float> [[TMP0]]
//
vfloat32m4_t test_vfncvt_rod_f_f_w_f32m4_mt (vbool8_t mask, vfloat32m4_t maskedoff, vfloat64m8_t src, size_t vl, uint8_t ta) {
  return vfncvt_rod_f_f_w_f32m4_mt(mask, maskedoff, src, vl, VE_TAIL_AGNOSTIC);
}
