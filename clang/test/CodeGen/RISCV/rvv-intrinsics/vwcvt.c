...
// CHECK-RV64-LABEL: @test_vwcvt_x_x_v_i16mf4_mt(
// CHECK-RV64-NEXT:  entry:
// CHECK-RV64-NEXT:    [[TMP0:%.*]] = call <vscale x 1 x i16> @llvm.riscv.vwadd.mask.nxv1i16.nxv1i8.i8.i64(<vscale x 1 x i16> [[MASKEDOFF:%.*]], <vscale x 1 x i8> [[SRC:%.*]], i8 0, <vscale x 1 x i1> [[MASK:%.*]], i64 [[VL:%.*]], i64 1)
// CHECK-RV64-NEXT:    ret <vscale x 1 x i16> [[TMP0]]
//
vint16mf4_t test_vwcvt_x_x_v_i16mf4_mt (vbool64_t mask, vint16mf4_t maskedoff, vint8mf8_t src, size_t vl, uint8_t ta) {
  return vwcvt_x_x_v_i16mf4_mt(mask, maskedoff, src, vl, VE_TAIL_AGNOSTIC);
}

// CHECK-RV64-LABEL: @test_vwcvt_x_x_v_i16mf2_mt(
// CHECK-RV64-NEXT:  entry:
// CHECK-RV64-NEXT:    [[TMP0:%.*]] = call <vscale x 2 x i16> @llvm.riscv.vwadd.mask.nxv2i16.nxv2i8.i8.i64(<vscale x 2 x i16> [[MASKEDOFF:%.*]], <vscale x 2 x i8> [[SRC:%.*]], i8 0, <vscale x 2 x i1> [[MASK:%.*]], i64 [[VL:%.*]], i64 1)
// CHECK-RV64-NEXT:    ret <vscale x 2 x i16> [[TMP0]]
//
vint16mf2_t test_vwcvt_x_x_v_i16mf2_mt (vbool32_t mask, vint16mf2_t maskedoff, vint8mf4_t src, size_t vl, uint8_t ta) {
  return vwcvt_x_x_v_i16mf2_mt(mask, maskedoff, src, vl, VE_TAIL_AGNOSTIC);
}

// CHECK-RV64-LABEL: @test_vwcvt_x_x_v_i16m1_mt(
// CHECK-RV64-NEXT:  entry:
// CHECK-RV64-NEXT:    [[TMP0:%.*]] = call <vscale x 4 x i16> @llvm.riscv.vwadd.mask.nxv4i16.nxv4i8.i8.i64(<vscale x 4 x i16> [[MASKEDOFF:%.*]], <vscale x 4 x i8> [[SRC:%.*]], i8 0, <vscale x 4 x i1> [[MASK:%.*]], i64 [[VL:%.*]], i64 1)
// CHECK-RV64-NEXT:    ret <vscale x 4 x i16> [[TMP0]]
//
vint16m1_t test_vwcvt_x_x_v_i16m1_mt (vbool16_t mask, vint16m1_t maskedoff, vint8mf2_t src, size_t vl, uint8_t ta) {
  return vwcvt_x_x_v_i16m1_mt(mask, maskedoff, src, vl, VE_TAIL_AGNOSTIC);
}

// CHECK-RV64-LABEL: @test_vwcvt_x_x_v_i16m2_mt(
// CHECK-RV64-NEXT:  entry:
// CHECK-RV64-NEXT:    [[TMP0:%.*]] = call <vscale x 8 x i16> @llvm.riscv.vwadd.mask.nxv8i16.nxv8i8.i8.i64(<vscale x 8 x i16> [[MASKEDOFF:%.*]], <vscale x 8 x i8> [[SRC:%.*]], i8 0, <vscale x 8 x i1> [[MASK:%.*]], i64 [[VL:%.*]], i64 1)
// CHECK-RV64-NEXT:    ret <vscale x 8 x i16> [[TMP0]]
//
vint16m2_t test_vwcvt_x_x_v_i16m2_mt (vbool8_t mask, vint16m2_t maskedoff, vint8m1_t src, size_t vl, uint8_t ta) {
  return vwcvt_x_x_v_i16m2_mt(mask, maskedoff, src, vl, VE_TAIL_AGNOSTIC);
}

// CHECK-RV64-LABEL: @test_vwcvt_x_x_v_i16m4_mt(
// CHECK-RV64-NEXT:  entry:
// CHECK-RV64-NEXT:    [[TMP0:%.*]] = call <vscale x 16 x i16> @llvm.riscv.vwadd.mask.nxv16i16.nxv16i8.i8.i64(<vscale x 16 x i16> [[MASKEDOFF:%.*]], <vscale x 16 x i8> [[SRC:%.*]], i8 0, <vscale x 16 x i1> [[MASK:%.*]], i64 [[VL:%.*]], i64 1)
// CHECK-RV64-NEXT:    ret <vscale x 16 x i16> [[TMP0]]
//
vint16m4_t test_vwcvt_x_x_v_i16m4_mt (vbool4_t mask, vint16m4_t maskedoff, vint8m2_t src, size_t vl, uint8_t ta) {
  return vwcvt_x_x_v_i16m4_mt(mask, maskedoff, src, vl, VE_TAIL_AGNOSTIC);
}

// CHECK-RV64-LABEL: @test_vwcvt_x_x_v_i16m8_mt(
// CHECK-RV64-NEXT:  entry:
// CHECK-RV64-NEXT:    [[TMP0:%.*]] = call <vscale x 32 x i16> @llvm.riscv.vwadd.mask.nxv32i16.nxv32i8.i8.i64(<vscale x 32 x i16> [[MASKEDOFF:%.*]], <vscale x 32 x i8> [[SRC:%.*]], i8 0, <vscale x 32 x i1> [[MASK:%.*]], i64 [[VL:%.*]], i64 1)
// CHECK-RV64-NEXT:    ret <vscale x 32 x i16> [[TMP0]]
//
vint16m8_t test_vwcvt_x_x_v_i16m8_mt (vbool2_t mask, vint16m8_t maskedoff, vint8m4_t src, size_t vl, uint8_t ta) {
  return vwcvt_x_x_v_i16m8_mt(mask, maskedoff, src, vl, VE_TAIL_AGNOSTIC);
}

// CHECK-RV64-LABEL: @test_vwcvtu_x_x_v_u16mf4_mt(
// CHECK-RV64-NEXT:  entry:
// CHECK-RV64-NEXT:    [[TMP0:%.*]] = call <vscale x 1 x i16> @llvm.riscv.vwaddu.mask.nxv1i16.nxv1i8.i8.i64(<vscale x 1 x i16> [[MASKEDOFF:%.*]], <vscale x 1 x i8> [[SRC:%.*]], i8 0, <vscale x 1 x i1> [[MASK:%.*]], i64 [[VL:%.*]], i64 1)
// CHECK-RV64-NEXT:    ret <vscale x 1 x i16> [[TMP0]]
//
vuint16mf4_t test_vwcvtu_x_x_v_u16mf4_mt (vbool64_t mask, vuint16mf4_t maskedoff, vuint8mf8_t src, size_t vl, uint8_t ta) {
  return vwcvtu_x_x_v_u16mf4_mt(mask, maskedoff, src, vl, VE_TAIL_AGNOSTIC);
}

// CHECK-RV64-LABEL: @test_vwcvtu_x_x_v_u16mf2_mt(
// CHECK-RV64-NEXT:  entry:
// CHECK-RV64-NEXT:    [[TMP0:%.*]] = call <vscale x 2 x i16> @llvm.riscv.vwaddu.mask.nxv2i16.nxv2i8.i8.i64(<vscale x 2 x i16> [[MASKEDOFF:%.*]], <vscale x 2 x i8> [[SRC:%.*]], i8 0, <vscale x 2 x i1> [[MASK:%.*]], i64 [[VL:%.*]], i64 1)
// CHECK-RV64-NEXT:    ret <vscale x 2 x i16> [[TMP0]]
//
vuint16mf2_t test_vwcvtu_x_x_v_u16mf2_mt (vbool32_t mask, vuint16mf2_t maskedoff, vuint8mf4_t src, size_t vl, uint8_t ta) {
  return vwcvtu_x_x_v_u16mf2_mt(mask, maskedoff, src, vl, VE_TAIL_AGNOSTIC);
}

// CHECK-RV64-LABEL: @test_vwcvtu_x_x_v_u16m1_mt(
// CHECK-RV64-NEXT:  entry:
// CHECK-RV64-NEXT:    [[TMP0:%.*]] = call <vscale x 4 x i16> @llvm.riscv.vwaddu.mask.nxv4i16.nxv4i8.i8.i64(<vscale x 4 x i16> [[MASKEDOFF:%.*]], <vscale x 4 x i8> [[SRC:%.*]], i8 0, <vscale x 4 x i1> [[MASK:%.*]], i64 [[VL:%.*]], i64 1)
// CHECK-RV64-NEXT:    ret <vscale x 4 x i16> [[TMP0]]
//
vuint16m1_t test_vwcvtu_x_x_v_u16m1_mt (vbool16_t mask, vuint16m1_t maskedoff, vuint8mf2_t src, size_t vl, uint8_t ta) {
  return vwcvtu_x_x_v_u16m1_mt(mask, maskedoff, src, vl, VE_TAIL_AGNOSTIC);
}

// CHECK-RV64-LABEL: @test_vwcvtu_x_x_v_u16m2_mt(
// CHECK-RV64-NEXT:  entry:
// CHECK-RV64-NEXT:    [[TMP0:%.*]] = call <vscale x 8 x i16> @llvm.riscv.vwaddu.mask.nxv8i16.nxv8i8.i8.i64(<vscale x 8 x i16> [[MASKEDOFF:%.*]], <vscale x 8 x i8> [[SRC:%.*]], i8 0, <vscale x 8 x i1> [[MASK:%.*]], i64 [[VL:%.*]], i64 1)
// CHECK-RV64-NEXT:    ret <vscale x 8 x i16> [[TMP0]]
//
vuint16m2_t test_vwcvtu_x_x_v_u16m2_mt (vbool8_t mask, vuint16m2_t maskedoff, vuint8m1_t src, size_t vl, uint8_t ta) {
  return vwcvtu_x_x_v_u16m2_mt(mask, maskedoff, src, vl, VE_TAIL_AGNOSTIC);
}

// CHECK-RV64-LABEL: @test_vwcvtu_x_x_v_u16m4_mt(
// CHECK-RV64-NEXT:  entry:
// CHECK-RV64-NEXT:    [[TMP0:%.*]] = call <vscale x 16 x i16> @llvm.riscv.vwaddu.mask.nxv16i16.nxv16i8.i8.i64(<vscale x 16 x i16> [[MASKEDOFF:%.*]], <vscale x 16 x i8> [[SRC:%.*]], i8 0, <vscale x 16 x i1> [[MASK:%.*]], i64 [[VL:%.*]], i64 1)
// CHECK-RV64-NEXT:    ret <vscale x 16 x i16> [[TMP0]]
//
vuint16m4_t test_vwcvtu_x_x_v_u16m4_mt (vbool4_t mask, vuint16m4_t maskedoff, vuint8m2_t src, size_t vl, uint8_t ta) {
  return vwcvtu_x_x_v_u16m4_mt(mask, maskedoff, src, vl, VE_TAIL_AGNOSTIC);
}

// CHECK-RV64-LABEL: @test_vwcvtu_x_x_v_u16m8_mt(
// CHECK-RV64-NEXT:  entry:
// CHECK-RV64-NEXT:    [[TMP0:%.*]] = call <vscale x 32 x i16> @llvm.riscv.vwaddu.mask.nxv32i16.nxv32i8.i8.i64(<vscale x 32 x i16> [[MASKEDOFF:%.*]], <vscale x 32 x i8> [[SRC:%.*]], i8 0, <vscale x 32 x i1> [[MASK:%.*]], i64 [[VL:%.*]], i64 1)
// CHECK-RV64-NEXT:    ret <vscale x 32 x i16> [[TMP0]]
//
vuint16m8_t test_vwcvtu_x_x_v_u16m8_mt (vbool2_t mask, vuint16m8_t maskedoff, vuint8m4_t src, size_t vl, uint8_t ta) {
  return vwcvtu_x_x_v_u16m8_mt(mask, maskedoff, src, vl, VE_TAIL_AGNOSTIC);
}

// CHECK-RV64-LABEL: @test_vwcvt_x_x_v_i32mf2_mt(
// CHECK-RV64-NEXT:  entry:
// CHECK-RV64-NEXT:    [[TMP0:%.*]] = call <vscale x 1 x i32> @llvm.riscv.vwadd.mask.nxv1i32.nxv1i16.i16.i64(<vscale x 1 x i32> [[MASKEDOFF:%.*]], <vscale x 1 x i16> [[SRC:%.*]], i16 0, <vscale x 1 x i1> [[MASK:%.*]], i64 [[VL:%.*]], i64 1)
// CHECK-RV64-NEXT:    ret <vscale x 1 x i32> [[TMP0]]
//
vint32mf2_t test_vwcvt_x_x_v_i32mf2_mt (vbool64_t mask, vint32mf2_t maskedoff, vint16mf4_t src, size_t vl, uint8_t ta) {
  return vwcvt_x_x_v_i32mf2_mt(mask, maskedoff, src, vl, VE_TAIL_AGNOSTIC);
}

// CHECK-RV64-LABEL: @test_vwcvt_x_x_v_i32m1_mt(
// CHECK-RV64-NEXT:  entry:
// CHECK-RV64-NEXT:    [[TMP0:%.*]] = call <vscale x 2 x i32> @llvm.riscv.vwadd.mask.nxv2i32.nxv2i16.i16.i64(<vscale x 2 x i32> [[MASKEDOFF:%.*]], <vscale x 2 x i16> [[SRC:%.*]], i16 0, <vscale x 2 x i1> [[MASK:%.*]], i64 [[VL:%.*]], i64 1)
// CHECK-RV64-NEXT:    ret <vscale x 2 x i32> [[TMP0]]
//
vint32m1_t test_vwcvt_x_x_v_i32m1_mt (vbool32_t mask, vint32m1_t maskedoff, vint16mf2_t src, size_t vl, uint8_t ta) {
  return vwcvt_x_x_v_i32m1_mt(mask, maskedoff, src, vl, VE_TAIL_AGNOSTIC);
}

// CHECK-RV64-LABEL: @test_vwcvt_x_x_v_i32m2_mt(
// CHECK-RV64-NEXT:  entry:
// CHECK-RV64-NEXT:    [[TMP0:%.*]] = call <vscale x 4 x i32> @llvm.riscv.vwadd.mask.nxv4i32.nxv4i16.i16.i64(<vscale x 4 x i32> [[MASKEDOFF:%.*]], <vscale x 4 x i16> [[SRC:%.*]], i16 0, <vscale x 4 x i1> [[MASK:%.*]], i64 [[VL:%.*]], i64 1)
// CHECK-RV64-NEXT:    ret <vscale x 4 x i32> [[TMP0]]
//
vint32m2_t test_vwcvt_x_x_v_i32m2_mt (vbool16_t mask, vint32m2_t maskedoff, vint16m1_t src, size_t vl, uint8_t ta) {
  return vwcvt_x_x_v_i32m2_mt(mask, maskedoff, src, vl, VE_TAIL_AGNOSTIC);
}

// CHECK-RV64-LABEL: @test_vwcvt_x_x_v_i32m4_mt(
// CHECK-RV64-NEXT:  entry:
// CHECK-RV64-NEXT:    [[TMP0:%.*]] = call <vscale x 8 x i32> @llvm.riscv.vwadd.mask.nxv8i32.nxv8i16.i16.i64(<vscale x 8 x i32> [[MASKEDOFF:%.*]], <vscale x 8 x i16> [[SRC:%.*]], i16 0, <vscale x 8 x i1> [[MASK:%.*]], i64 [[VL:%.*]], i64 1)
// CHECK-RV64-NEXT:    ret <vscale x 8 x i32> [[TMP0]]
//
vint32m4_t test_vwcvt_x_x_v_i32m4_mt (vbool8_t mask, vint32m4_t maskedoff, vint16m2_t src, size_t vl, uint8_t ta) {
  return vwcvt_x_x_v_i32m4_mt(mask, maskedoff, src, vl, VE_TAIL_AGNOSTIC);
}

// CHECK-RV64-LABEL: @test_vwcvt_x_x_v_i32m8_mt(
// CHECK-RV64-NEXT:  entry:
// CHECK-RV64-NEXT:    [[TMP0:%.*]] = call <vscale x 16 x i32> @llvm.riscv.vwadd.mask.nxv16i32.nxv16i16.i16.i64(<vscale x 16 x i32> [[MASKEDOFF:%.*]], <vscale x 16 x i16> [[SRC:%.*]], i16 0, <vscale x 16 x i1> [[MASK:%.*]], i64 [[VL:%.*]], i64 1)
// CHECK-RV64-NEXT:    ret <vscale x 16 x i32> [[TMP0]]
//
vint32m8_t test_vwcvt_x_x_v_i32m8_mt (vbool4_t mask, vint32m8_t maskedoff, vint16m4_t src, size_t vl, uint8_t ta) {
  return vwcvt_x_x_v_i32m8_mt(mask, maskedoff, src, vl, VE_TAIL_AGNOSTIC);
}

// CHECK-RV64-LABEL: @test_vwcvtu_x_x_v_u32mf2_mt(
// CHECK-RV64-NEXT:  entry:
// CHECK-RV64-NEXT:    [[TMP0:%.*]] = call <vscale x 1 x i32> @llvm.riscv.vwaddu.mask.nxv1i32.nxv1i16.i16.i64(<vscale x 1 x i32> [[MASKEDOFF:%.*]], <vscale x 1 x i16> [[SRC:%.*]], i16 0, <vscale x 1 x i1> [[MASK:%.*]], i64 [[VL:%.*]], i64 1)
// CHECK-RV64-NEXT:    ret <vscale x 1 x i32> [[TMP0]]
//
vuint32mf2_t test_vwcvtu_x_x_v_u32mf2_mt (vbool64_t mask, vuint32mf2_t maskedoff, vuint16mf4_t src, size_t vl, uint8_t ta) {
  return vwcvtu_x_x_v_u32mf2_mt(mask, maskedoff, src, vl, VE_TAIL_AGNOSTIC);
}

// CHECK-RV64-LABEL: @test_vwcvtu_x_x_v_u32m1_mt(
// CHECK-RV64-NEXT:  entry:
// CHECK-RV64-NEXT:    [[TMP0:%.*]] = call <vscale x 2 x i32> @llvm.riscv.vwaddu.mask.nxv2i32.nxv2i16.i16.i64(<vscale x 2 x i32> [[MASKEDOFF:%.*]], <vscale x 2 x i16> [[SRC:%.*]], i16 0, <vscale x 2 x i1> [[MASK:%.*]], i64 [[VL:%.*]], i64 1)
// CHECK-RV64-NEXT:    ret <vscale x 2 x i32> [[TMP0]]
//
vuint32m1_t test_vwcvtu_x_x_v_u32m1_mt (vbool32_t mask, vuint32m1_t maskedoff, vuint16mf2_t src, size_t vl, uint8_t ta) {
  return vwcvtu_x_x_v_u32m1_mt(mask, maskedoff, src, vl, VE_TAIL_AGNOSTIC);
}

// CHECK-RV64-LABEL: @test_vwcvtu_x_x_v_u32m2_mt(
// CHECK-RV64-NEXT:  entry:
// CHECK-RV64-NEXT:    [[TMP0:%.*]] = call <vscale x 4 x i32> @llvm.riscv.vwaddu.mask.nxv4i32.nxv4i16.i16.i64(<vscale x 4 x i32> [[MASKEDOFF:%.*]], <vscale x 4 x i16> [[SRC:%.*]], i16 0, <vscale x 4 x i1> [[MASK:%.*]], i64 [[VL:%.*]], i64 1)
// CHECK-RV64-NEXT:    ret <vscale x 4 x i32> [[TMP0]]
//
vuint32m2_t test_vwcvtu_x_x_v_u32m2_mt (vbool16_t mask, vuint32m2_t maskedoff, vuint16m1_t src, size_t vl, uint8_t ta) {
  return vwcvtu_x_x_v_u32m2_mt(mask, maskedoff, src, vl, VE_TAIL_AGNOSTIC);
}

// CHECK-RV64-LABEL: @test_vwcvtu_x_x_v_u32m4_mt(
// CHECK-RV64-NEXT:  entry:
// CHECK-RV64-NEXT:    [[TMP0:%.*]] = call <vscale x 8 x i32> @llvm.riscv.vwaddu.mask.nxv8i32.nxv8i16.i16.i64(<vscale x 8 x i32> [[MASKEDOFF:%.*]], <vscale x 8 x i16> [[SRC:%.*]], i16 0, <vscale x 8 x i1> [[MASK:%.*]], i64 [[VL:%.*]], i64 1)
// CHECK-RV64-NEXT:    ret <vscale x 8 x i32> [[TMP0]]
//
vuint32m4_t test_vwcvtu_x_x_v_u32m4_mt (vbool8_t mask, vuint32m4_t maskedoff, vuint16m2_t src, size_t vl, uint8_t ta) {
  return vwcvtu_x_x_v_u32m4_mt(mask, maskedoff, src, vl, VE_TAIL_AGNOSTIC);
}

// CHECK-RV64-LABEL: @test_vwcvtu_x_x_v_u32m8_mt(
// CHECK-RV64-NEXT:  entry:
// CHECK-RV64-NEXT:    [[TMP0:%.*]] = call <vscale x 16 x i32> @llvm.riscv.vwaddu.mask.nxv16i32.nxv16i16.i16.i64(<vscale x 16 x i32> [[MASKEDOFF:%.*]], <vscale x 16 x i16> [[SRC:%.*]], i16 0, <vscale x 16 x i1> [[MASK:%.*]], i64 [[VL:%.*]], i64 1)
// CHECK-RV64-NEXT:    ret <vscale x 16 x i32> [[TMP0]]
//
vuint32m8_t test_vwcvtu_x_x_v_u32m8_mt (vbool4_t mask, vuint32m8_t maskedoff, vuint16m4_t src, size_t vl, uint8_t ta) {
  return vwcvtu_x_x_v_u32m8_mt(mask, maskedoff, src, vl, VE_TAIL_AGNOSTIC);
}

// CHECK-RV64-LABEL: @test_vwcvt_x_x_v_i64m1_mt(
// CHECK-RV64-NEXT:  entry:
// CHECK-RV64-NEXT:    [[TMP0:%.*]] = call <vscale x 1 x i64> @llvm.riscv.vwadd.mask.nxv1i64.nxv1i32.i32.i64(<vscale x 1 x i64> [[MASKEDOFF:%.*]], <vscale x 1 x i32> [[SRC:%.*]], i32 0, <vscale x 1 x i1> [[MASK:%.*]], i64 [[VL:%.*]], i64 1)
// CHECK-RV64-NEXT:    ret <vscale x 1 x i64> [[TMP0]]
//
vint64m1_t test_vwcvt_x_x_v_i64m1_mt (vbool64_t mask, vint64m1_t maskedoff, vint32mf2_t src, size_t vl, uint8_t ta) {
  return vwcvt_x_x_v_i64m1_mt(mask, maskedoff, src, vl, VE_TAIL_AGNOSTIC);
}

// CHECK-RV64-LABEL: @test_vwcvt_x_x_v_i64m2_mt(
// CHECK-RV64-NEXT:  entry:
// CHECK-RV64-NEXT:    [[TMP0:%.*]] = call <vscale x 2 x i64> @llvm.riscv.vwadd.mask.nxv2i64.nxv2i32.i32.i64(<vscale x 2 x i64> [[MASKEDOFF:%.*]], <vscale x 2 x i32> [[SRC:%.*]], i32 0, <vscale x 2 x i1> [[MASK:%.*]], i64 [[VL:%.*]], i64 1)
// CHECK-RV64-NEXT:    ret <vscale x 2 x i64> [[TMP0]]
//
vint64m2_t test_vwcvt_x_x_v_i64m2_mt (vbool32_t mask, vint64m2_t maskedoff, vint32m1_t src, size_t vl, uint8_t ta) {
  return vwcvt_x_x_v_i64m2_mt(mask, maskedoff, src, vl, VE_TAIL_AGNOSTIC);
}

// CHECK-RV64-LABEL: @test_vwcvt_x_x_v_i64m4_mt(
// CHECK-RV64-NEXT:  entry:
// CHECK-RV64-NEXT:    [[TMP0:%.*]] = call <vscale x 4 x i64> @llvm.riscv.vwadd.mask.nxv4i64.nxv4i32.i32.i64(<vscale x 4 x i64> [[MASKEDOFF:%.*]], <vscale x 4 x i32> [[SRC:%.*]], i32 0, <vscale x 4 x i1> [[MASK:%.*]], i64 [[VL:%.*]], i64 1)
// CHECK-RV64-NEXT:    ret <vscale x 4 x i64> [[TMP0]]
//
vint64m4_t test_vwcvt_x_x_v_i64m4_mt (vbool16_t mask, vint64m4_t maskedoff, vint32m2_t src, size_t vl, uint8_t ta) {
  return vwcvt_x_x_v_i64m4_mt(mask, maskedoff, src, vl, VE_TAIL_AGNOSTIC);
}

// CHECK-RV64-LABEL: @test_vwcvt_x_x_v_i64m8_mt(
// CHECK-RV64-NEXT:  entry:
// CHECK-RV64-NEXT:    [[TMP0:%.*]] = call <vscale x 8 x i64> @llvm.riscv.vwadd.mask.nxv8i64.nxv8i32.i32.i64(<vscale x 8 x i64> [[MASKEDOFF:%.*]], <vscale x 8 x i32> [[SRC:%.*]], i32 0, <vscale x 8 x i1> [[MASK:%.*]], i64 [[VL:%.*]], i64 1)
// CHECK-RV64-NEXT:    ret <vscale x 8 x i64> [[TMP0]]
//
vint64m8_t test_vwcvt_x_x_v_i64m8_mt (vbool8_t mask, vint64m8_t maskedoff, vint32m4_t src, size_t vl, uint8_t ta) {
  return vwcvt_x_x_v_i64m8_mt(mask, maskedoff, src, vl, VE_TAIL_AGNOSTIC);
}

// CHECK-RV64-LABEL: @test_vwcvtu_x_x_v_u64m1_mt(
// CHECK-RV64-NEXT:  entry:
// CHECK-RV64-NEXT:    [[TMP0:%.*]] = call <vscale x 1 x i64> @llvm.riscv.vwaddu.mask.nxv1i64.nxv1i32.i32.i64(<vscale x 1 x i64> [[MASKEDOFF:%.*]], <vscale x 1 x i32> [[SRC:%.*]], i32 0, <vscale x 1 x i1> [[MASK:%.*]], i64 [[VL:%.*]], i64 1)
// CHECK-RV64-NEXT:    ret <vscale x 1 x i64> [[TMP0]]
//
vuint64m1_t test_vwcvtu_x_x_v_u64m1_mt (vbool64_t mask, vuint64m1_t maskedoff, vuint32mf2_t src, size_t vl, uint8_t ta) {
  return vwcvtu_x_x_v_u64m1_mt(mask, maskedoff, src, vl, VE_TAIL_AGNOSTIC);
}

// CHECK-RV64-LABEL: @test_vwcvtu_x_x_v_u64m2_mt(
// CHECK-RV64-NEXT:  entry:
// CHECK-RV64-NEXT:    [[TMP0:%.*]] = call <vscale x 2 x i64> @llvm.riscv.vwaddu.mask.nxv2i64.nxv2i32.i32.i64(<vscale x 2 x i64> [[MASKEDOFF:%.*]], <vscale x 2 x i32> [[SRC:%.*]], i32 0, <vscale x 2 x i1> [[MASK:%.*]], i64 [[VL:%.*]], i64 1)
// CHECK-RV64-NEXT:    ret <vscale x 2 x i64> [[TMP0]]
//
vuint64m2_t test_vwcvtu_x_x_v_u64m2_mt (vbool32_t mask, vuint64m2_t maskedoff, vuint32m1_t src, size_t vl, uint8_t ta) {
  return vwcvtu_x_x_v_u64m2_mt(mask, maskedoff, src, vl, VE_TAIL_AGNOSTIC);
}

// CHECK-RV64-LABEL: @test_vwcvtu_x_x_v_u64m4_mt(
// CHECK-RV64-NEXT:  entry:
// CHECK-RV64-NEXT:    [[TMP0:%.*]] = call <vscale x 4 x i64> @llvm.riscv.vwaddu.mask.nxv4i64.nxv4i32.i32.i64(<vscale x 4 x i64> [[MASKEDOFF:%.*]], <vscale x 4 x i32> [[SRC:%.*]], i32 0, <vscale x 4 x i1> [[MASK:%.*]], i64 [[VL:%.*]], i64 1)
// CHECK-RV64-NEXT:    ret <vscale x 4 x i64> [[TMP0]]
//
vuint64m4_t test_vwcvtu_x_x_v_u64m4_mt (vbool16_t mask, vuint64m4_t maskedoff, vuint32m2_t src, size_t vl, uint8_t ta) {
  return vwcvtu_x_x_v_u64m4_mt(mask, maskedoff, src, vl, VE_TAIL_AGNOSTIC);
}

// CHECK-RV64-LABEL: @test_vwcvtu_x_x_v_u64m8_mt(
// CHECK-RV64-NEXT:  entry:
// CHECK-RV64-NEXT:    [[TMP0:%.*]] = call <vscale x 8 x i64> @llvm.riscv.vwaddu.mask.nxv8i64.nxv8i32.i32.i64(<vscale x 8 x i64> [[MASKEDOFF:%.*]], <vscale x 8 x i32> [[SRC:%.*]], i32 0, <vscale x 8 x i1> [[MASK:%.*]], i64 [[VL:%.*]], i64 1)
// CHECK-RV64-NEXT:    ret <vscale x 8 x i64> [[TMP0]]
//
vuint64m8_t test_vwcvtu_x_x_v_u64m8_mt (vbool8_t mask, vuint64m8_t maskedoff, vuint32m4_t src, size_t vl, uint8_t ta) {
  return vwcvtu_x_x_v_u64m8_mt(mask, maskedoff, src, vl, VE_TAIL_AGNOSTIC);
}
