...
// CHECK-RV64-LABEL: @test_vneg_v_i8mf8_mt(
// CHECK-RV64-NEXT:  entry:
// CHECK-RV64-NEXT:    [[TMP0:%.*]] = call <vscale x 1 x i8> @llvm.riscv.vrsub.mask.nxv1i8.i8.i64(<vscale x 1 x i8> [[MASKEDOFF:%.*]], <vscale x 1 x i8> [[OP1:%.*]], i8 0, <vscale x 1 x i1> [[MASK:%.*]], i64 [[VL:%.*]], i64 1)
// CHECK-RV64-NEXT:    ret <vscale x 1 x i8> [[TMP0]]
//
vint8mf8_t test_vneg_v_i8mf8_mt(vbool64_t mask, vint8mf8_t maskedoff, vint8mf8_t op1, size_t vl, size_t ta) {
  return vneg(mask, maskedoff, op1, vl, VE_TAIL_AGNOSTIC);
}

// CHECK-RV64-LABEL: @test_vneg_v_i8mf4_mt(
// CHECK-RV64-NEXT:  entry:
// CHECK-RV64-NEXT:    [[TMP0:%.*]] = call <vscale x 2 x i8> @llvm.riscv.vrsub.mask.nxv2i8.i8.i64(<vscale x 2 x i8> [[MASKEDOFF:%.*]], <vscale x 2 x i8> [[OP1:%.*]], i8 0, <vscale x 2 x i1> [[MASK:%.*]], i64 [[VL:%.*]], i64 1)
// CHECK-RV64-NEXT:    ret <vscale x 2 x i8> [[TMP0]]
//
vint8mf4_t test_vneg_v_i8mf4_mt(vbool32_t mask, vint8mf4_t maskedoff, vint8mf4_t op1, size_t vl, size_t ta) {
  return vneg(mask, maskedoff, op1, vl, VE_TAIL_AGNOSTIC);
}

// CHECK-RV64-LABEL: @test_vneg_v_i8mf2_mt(
// CHECK-RV64-NEXT:  entry:
// CHECK-RV64-NEXT:    [[TMP0:%.*]] = call <vscale x 4 x i8> @llvm.riscv.vrsub.mask.nxv4i8.i8.i64(<vscale x 4 x i8> [[MASKEDOFF:%.*]], <vscale x 4 x i8> [[OP1:%.*]], i8 0, <vscale x 4 x i1> [[MASK:%.*]], i64 [[VL:%.*]], i64 1)
// CHECK-RV64-NEXT:    ret <vscale x 4 x i8> [[TMP0]]
//
vint8mf2_t test_vneg_v_i8mf2_mt(vbool16_t mask, vint8mf2_t maskedoff, vint8mf2_t op1, size_t vl, size_t ta) {
  return vneg(mask, maskedoff, op1, vl, VE_TAIL_AGNOSTIC);
}

// CHECK-RV64-LABEL: @test_vneg_v_i8m1_mt(
// CHECK-RV64-NEXT:  entry:
// CHECK-RV64-NEXT:    [[TMP0:%.*]] = call <vscale x 8 x i8> @llvm.riscv.vrsub.mask.nxv8i8.i8.i64(<vscale x 8 x i8> [[MASKEDOFF:%.*]], <vscale x 8 x i8> [[OP1:%.*]], i8 0, <vscale x 8 x i1> [[MASK:%.*]], i64 [[VL:%.*]], i64 1)
// CHECK-RV64-NEXT:    ret <vscale x 8 x i8> [[TMP0]]
//
vint8m1_t test_vneg_v_i8m1_mt(vbool8_t mask, vint8m1_t maskedoff, vint8m1_t op1, size_t vl, size_t ta) {
  return vneg(mask, maskedoff, op1, vl, VE_TAIL_AGNOSTIC);
}

// CHECK-RV64-LABEL: @test_vneg_v_i8m2_mt(
// CHECK-RV64-NEXT:  entry:
// CHECK-RV64-NEXT:    [[TMP0:%.*]] = call <vscale x 16 x i8> @llvm.riscv.vrsub.mask.nxv16i8.i8.i64(<vscale x 16 x i8> [[MASKEDOFF:%.*]], <vscale x 16 x i8> [[OP1:%.*]], i8 0, <vscale x 16 x i1> [[MASK:%.*]], i64 [[VL:%.*]], i64 1)
// CHECK-RV64-NEXT:    ret <vscale x 16 x i8> [[TMP0]]
//
vint8m2_t test_vneg_v_i8m2_mt(vbool4_t mask, vint8m2_t maskedoff, vint8m2_t op1, size_t vl, size_t ta) {
  return vneg(mask, maskedoff, op1, vl, VE_TAIL_AGNOSTIC);
}

// CHECK-RV64-LABEL: @test_vneg_v_i8m4_mt(
// CHECK-RV64-NEXT:  entry:
// CHECK-RV64-NEXT:    [[TMP0:%.*]] = call <vscale x 32 x i8> @llvm.riscv.vrsub.mask.nxv32i8.i8.i64(<vscale x 32 x i8> [[MASKEDOFF:%.*]], <vscale x 32 x i8> [[OP1:%.*]], i8 0, <vscale x 32 x i1> [[MASK:%.*]], i64 [[VL:%.*]], i64 1)
// CHECK-RV64-NEXT:    ret <vscale x 32 x i8> [[TMP0]]
//
vint8m4_t test_vneg_v_i8m4_mt(vbool2_t mask, vint8m4_t maskedoff, vint8m4_t op1, size_t vl, size_t ta) {
  return vneg(mask, maskedoff, op1, vl, VE_TAIL_AGNOSTIC);
}

// CHECK-RV64-LABEL: @test_vneg_v_i8m8_mt(
// CHECK-RV64-NEXT:  entry:
// CHECK-RV64-NEXT:    [[TMP0:%.*]] = call <vscale x 64 x i8> @llvm.riscv.vrsub.mask.nxv64i8.i8.i64(<vscale x 64 x i8> [[MASKEDOFF:%.*]], <vscale x 64 x i8> [[OP1:%.*]], i8 0, <vscale x 64 x i1> [[MASK:%.*]], i64 [[VL:%.*]], i64 1)
// CHECK-RV64-NEXT:    ret <vscale x 64 x i8> [[TMP0]]
//
vint8m8_t test_vneg_v_i8m8_mt(vbool1_t mask, vint8m8_t maskedoff, vint8m8_t op1, size_t vl, size_t ta) {
  return vneg(mask, maskedoff, op1, vl, VE_TAIL_AGNOSTIC);
}

// CHECK-RV64-LABEL: @test_vneg_v_i16mf4_mt(
// CHECK-RV64-NEXT:  entry:
// CHECK-RV64-NEXT:    [[TMP0:%.*]] = call <vscale x 1 x i16> @llvm.riscv.vrsub.mask.nxv1i16.i16.i64(<vscale x 1 x i16> [[MASKEDOFF:%.*]], <vscale x 1 x i16> [[OP1:%.*]], i16 0, <vscale x 1 x i1> [[MASK:%.*]], i64 [[VL:%.*]], i64 1)
// CHECK-RV64-NEXT:    ret <vscale x 1 x i16> [[TMP0]]
//
vint16mf4_t test_vneg_v_i16mf4_mt(vbool64_t mask, vint16mf4_t maskedoff, vint16mf4_t op1, size_t vl, size_t ta) {
  return vneg(mask, maskedoff, op1, vl, VE_TAIL_AGNOSTIC);
}

// CHECK-RV64-LABEL: @test_vneg_v_i16mf2_mt(
// CHECK-RV64-NEXT:  entry:
// CHECK-RV64-NEXT:    [[TMP0:%.*]] = call <vscale x 2 x i16> @llvm.riscv.vrsub.mask.nxv2i16.i16.i64(<vscale x 2 x i16> [[MASKEDOFF:%.*]], <vscale x 2 x i16> [[OP1:%.*]], i16 0, <vscale x 2 x i1> [[MASK:%.*]], i64 [[VL:%.*]], i64 1)
// CHECK-RV64-NEXT:    ret <vscale x 2 x i16> [[TMP0]]
//
vint16mf2_t test_vneg_v_i16mf2_mt(vbool32_t mask, vint16mf2_t maskedoff, vint16mf2_t op1, size_t vl, size_t ta) {
  return vneg(mask, maskedoff, op1, vl, VE_TAIL_AGNOSTIC);
}

// CHECK-RV64-LABEL: @test_vneg_v_i16m1_mt(
// CHECK-RV64-NEXT:  entry:
// CHECK-RV64-NEXT:    [[TMP0:%.*]] = call <vscale x 4 x i16> @llvm.riscv.vrsub.mask.nxv4i16.i16.i64(<vscale x 4 x i16> [[MASKEDOFF:%.*]], <vscale x 4 x i16> [[OP1:%.*]], i16 0, <vscale x 4 x i1> [[MASK:%.*]], i64 [[VL:%.*]], i64 1)
// CHECK-RV64-NEXT:    ret <vscale x 4 x i16> [[TMP0]]
//
vint16m1_t test_vneg_v_i16m1_mt(vbool16_t mask, vint16m1_t maskedoff, vint16m1_t op1, size_t vl, size_t ta) {
  return vneg(mask, maskedoff, op1, vl, VE_TAIL_AGNOSTIC);
}

// CHECK-RV64-LABEL: @test_vneg_v_i16m2_mt(
// CHECK-RV64-NEXT:  entry:
// CHECK-RV64-NEXT:    [[TMP0:%.*]] = call <vscale x 8 x i16> @llvm.riscv.vrsub.mask.nxv8i16.i16.i64(<vscale x 8 x i16> [[MASKEDOFF:%.*]], <vscale x 8 x i16> [[OP1:%.*]], i16 0, <vscale x 8 x i1> [[MASK:%.*]], i64 [[VL:%.*]], i64 1)
// CHECK-RV64-NEXT:    ret <vscale x 8 x i16> [[TMP0]]
//
vint16m2_t test_vneg_v_i16m2_mt(vbool8_t mask, vint16m2_t maskedoff, vint16m2_t op1, size_t vl, size_t ta) {
  return vneg(mask, maskedoff, op1, vl, VE_TAIL_AGNOSTIC);
}

// CHECK-RV64-LABEL: @test_vneg_v_i16m4_mt(
// CHECK-RV64-NEXT:  entry:
// CHECK-RV64-NEXT:    [[TMP0:%.*]] = call <vscale x 16 x i16> @llvm.riscv.vrsub.mask.nxv16i16.i16.i64(<vscale x 16 x i16> [[MASKEDOFF:%.*]], <vscale x 16 x i16> [[OP1:%.*]], i16 0, <vscale x 16 x i1> [[MASK:%.*]], i64 [[VL:%.*]], i64 1)
// CHECK-RV64-NEXT:    ret <vscale x 16 x i16> [[TMP0]]
//
vint16m4_t test_vneg_v_i16m4_mt(vbool4_t mask, vint16m4_t maskedoff, vint16m4_t op1, size_t vl, size_t ta) {
  return vneg(mask, maskedoff, op1, vl, VE_TAIL_AGNOSTIC);
}

// CHECK-RV64-LABEL: @test_vneg_v_i16m8_mt(
// CHECK-RV64-NEXT:  entry:
// CHECK-RV64-NEXT:    [[TMP0:%.*]] = call <vscale x 32 x i16> @llvm.riscv.vrsub.mask.nxv32i16.i16.i64(<vscale x 32 x i16> [[MASKEDOFF:%.*]], <vscale x 32 x i16> [[OP1:%.*]], i16 0, <vscale x 32 x i1> [[MASK:%.*]], i64 [[VL:%.*]], i64 1)
// CHECK-RV64-NEXT:    ret <vscale x 32 x i16> [[TMP0]]
//
vint16m8_t test_vneg_v_i16m8_mt(vbool2_t mask, vint16m8_t maskedoff, vint16m8_t op1, size_t vl, size_t ta) {
  return vneg(mask, maskedoff, op1, vl, VE_TAIL_AGNOSTIC);
}

// CHECK-RV64-LABEL: @test_vneg_v_i32mf2_mt(
// CHECK-RV64-NEXT:  entry:
// CHECK-RV64-NEXT:    [[TMP0:%.*]] = call <vscale x 1 x i32> @llvm.riscv.vrsub.mask.nxv1i32.i32.i64(<vscale x 1 x i32> [[MASKEDOFF:%.*]], <vscale x 1 x i32> [[OP1:%.*]], i32 0, <vscale x 1 x i1> [[MASK:%.*]], i64 [[VL:%.*]], i64 1)
// CHECK-RV64-NEXT:    ret <vscale x 1 x i32> [[TMP0]]
//
vint32mf2_t test_vneg_v_i32mf2_mt(vbool64_t mask, vint32mf2_t maskedoff, vint32mf2_t op1, size_t vl, size_t ta) {
  return vneg(mask, maskedoff, op1, vl, VE_TAIL_AGNOSTIC);
}

// CHECK-RV64-LABEL: @test_vneg_v_i32m1_mt(
// CHECK-RV64-NEXT:  entry:
// CHECK-RV64-NEXT:    [[TMP0:%.*]] = call <vscale x 2 x i32> @llvm.riscv.vrsub.mask.nxv2i32.i32.i64(<vscale x 2 x i32> [[MASKEDOFF:%.*]], <vscale x 2 x i32> [[OP1:%.*]], i32 0, <vscale x 2 x i1> [[MASK:%.*]], i64 [[VL:%.*]], i64 1)
// CHECK-RV64-NEXT:    ret <vscale x 2 x i32> [[TMP0]]
//
vint32m1_t test_vneg_v_i32m1_mt(vbool32_t mask, vint32m1_t maskedoff, vint32m1_t op1, size_t vl, size_t ta) {
  return vneg(mask, maskedoff, op1, vl, VE_TAIL_AGNOSTIC);
}

// CHECK-RV64-LABEL: @test_vneg_v_i32m2_mt(
// CHECK-RV64-NEXT:  entry:
// CHECK-RV64-NEXT:    [[TMP0:%.*]] = call <vscale x 4 x i32> @llvm.riscv.vrsub.mask.nxv4i32.i32.i64(<vscale x 4 x i32> [[MASKEDOFF:%.*]], <vscale x 4 x i32> [[OP1:%.*]], i32 0, <vscale x 4 x i1> [[MASK:%.*]], i64 [[VL:%.*]], i64 1)
// CHECK-RV64-NEXT:    ret <vscale x 4 x i32> [[TMP0]]
//
vint32m2_t test_vneg_v_i32m2_mt(vbool16_t mask, vint32m2_t maskedoff, vint32m2_t op1, size_t vl, size_t ta) {
  return vneg(mask, maskedoff, op1, vl, VE_TAIL_AGNOSTIC);
}

// CHECK-RV64-LABEL: @test_vneg_v_i32m4_mt(
// CHECK-RV64-NEXT:  entry:
// CHECK-RV64-NEXT:    [[TMP0:%.*]] = call <vscale x 8 x i32> @llvm.riscv.vrsub.mask.nxv8i32.i32.i64(<vscale x 8 x i32> [[MASKEDOFF:%.*]], <vscale x 8 x i32> [[OP1:%.*]], i32 0, <vscale x 8 x i1> [[MASK:%.*]], i64 [[VL:%.*]], i64 1)
// CHECK-RV64-NEXT:    ret <vscale x 8 x i32> [[TMP0]]
//
vint32m4_t test_vneg_v_i32m4_mt(vbool8_t mask, vint32m4_t maskedoff, vint32m4_t op1, size_t vl, size_t ta) {
  return vneg(mask, maskedoff, op1, vl, VE_TAIL_AGNOSTIC);
}

// CHECK-RV64-LABEL: @test_vneg_v_i32m8_mt(
// CHECK-RV64-NEXT:  entry:
// CHECK-RV64-NEXT:    [[TMP0:%.*]] = call <vscale x 16 x i32> @llvm.riscv.vrsub.mask.nxv16i32.i32.i64(<vscale x 16 x i32> [[MASKEDOFF:%.*]], <vscale x 16 x i32> [[OP1:%.*]], i32 0, <vscale x 16 x i1> [[MASK:%.*]], i64 [[VL:%.*]], i64 1)
// CHECK-RV64-NEXT:    ret <vscale x 16 x i32> [[TMP0]]
//
vint32m8_t test_vneg_v_i32m8_mt(vbool4_t mask, vint32m8_t maskedoff, vint32m8_t op1, size_t vl, size_t ta) {
  return vneg(mask, maskedoff, op1, vl, VE_TAIL_AGNOSTIC);
}

// CHECK-RV64-LABEL: @test_vneg_v_i64m1_mt(
// CHECK-RV64-NEXT:  entry:
// CHECK-RV64-NEXT:    [[TMP0:%.*]] = call <vscale x 1 x i64> @llvm.riscv.vrsub.mask.nxv1i64.i64.i64(<vscale x 1 x i64> [[MASKEDOFF:%.*]], <vscale x 1 x i64> [[OP1:%.*]], i64 0, <vscale x 1 x i1> [[MASK:%.*]], i64 [[VL:%.*]], i64 1)
// CHECK-RV64-NEXT:    ret <vscale x 1 x i64> [[TMP0]]
//
vint64m1_t test_vneg_v_i64m1_mt(vbool64_t mask, vint64m1_t maskedoff, vint64m1_t op1, size_t vl, size_t ta) {
  return vneg(mask, maskedoff, op1, vl, VE_TAIL_AGNOSTIC);
}

// CHECK-RV64-LABEL: @test_vneg_v_i64m2_mt(
// CHECK-RV64-NEXT:  entry:
// CHECK-RV64-NEXT:    [[TMP0:%.*]] = call <vscale x 2 x i64> @llvm.riscv.vrsub.mask.nxv2i64.i64.i64(<vscale x 2 x i64> [[MASKEDOFF:%.*]], <vscale x 2 x i64> [[OP1:%.*]], i64 0, <vscale x 2 x i1> [[MASK:%.*]], i64 [[VL:%.*]], i64 1)
// CHECK-RV64-NEXT:    ret <vscale x 2 x i64> [[TMP0]]
//
vint64m2_t test_vneg_v_i64m2_mt(vbool32_t mask, vint64m2_t maskedoff, vint64m2_t op1, size_t vl, size_t ta) {
  return vneg(mask, maskedoff, op1, vl, VE_TAIL_AGNOSTIC);
}

// CHECK-RV64-LABEL: @test_vneg_v_i64m4_mt(
// CHECK-RV64-NEXT:  entry:
// CHECK-RV64-NEXT:    [[TMP0:%.*]] = call <vscale x 4 x i64> @llvm.riscv.vrsub.mask.nxv4i64.i64.i64(<vscale x 4 x i64> [[MASKEDOFF:%.*]], <vscale x 4 x i64> [[OP1:%.*]], i64 0, <vscale x 4 x i1> [[MASK:%.*]], i64 [[VL:%.*]], i64 1)
// CHECK-RV64-NEXT:    ret <vscale x 4 x i64> [[TMP0]]
//
vint64m4_t test_vneg_v_i64m4_mt(vbool16_t mask, vint64m4_t maskedoff, vint64m4_t op1, size_t vl, size_t ta) {
  return vneg(mask, maskedoff, op1, vl, VE_TAIL_AGNOSTIC);
}

// CHECK-RV64-LABEL: @test_vneg_v_i64m8_mt(
// CHECK-RV64-NEXT:  entry:
// CHECK-RV64-NEXT:    [[TMP0:%.*]] = call <vscale x 8 x i64> @llvm.riscv.vrsub.mask.nxv8i64.i64.i64(<vscale x 8 x i64> [[MASKEDOFF:%.*]], <vscale x 8 x i64> [[OP1:%.*]], i64 0, <vscale x 8 x i1> [[MASK:%.*]], i64 [[VL:%.*]], i64 1)
// CHECK-RV64-NEXT:    ret <vscale x 8 x i64> [[TMP0]]
//
vint64m8_t test_vneg_v_i64m8_mt(vbool8_t mask, vint64m8_t maskedoff, vint64m8_t op1, size_t vl, size_t ta) {
  return vneg(mask, maskedoff, op1, vl, VE_TAIL_AGNOSTIC);
}
