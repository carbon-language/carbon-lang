...
// CHECK-GLOBAL: @s0_align_x = dso_local global i32 4

// CHECK-GLOBAL: @s0_align_y = dso_local global i32 1

// CHECK-GLOBAL: @s0_align = dso_local global i32 4
int s0_align_x = __alignof(((struct s0*)0)->x);
int s0_align_y = __alignof(((struct s0*)0)->y);
int s0_align   = __alignof(struct s0);

// CHECK-FUNCTIONS-LABEL: define dso_local i32 @s0_load_x
...
// CHECK-GLOBAL: @s2_align_x = dso_local global i32 2
// CHECK-GLOBAL: @s2_align_y = dso_local global i32 2
// CHECK-GLOBAL: @s2_align = dso_local global i32 2
...
// CHECK-FUNCTIONS-LABEL: define dso_local i32 @s2_load_y
// CHECK-FUNCTIONS: [[s2_load_y:%.*]] = load i32, i32* {{.*}}, align 2
// CHECK-FUNCTIONS: ret i32 [[s2_load_y]]
int s2_load_y(struct s2 *a) { return a->y; }
// CHECK-FUNCTIONS-LABEL: define dso_local void @s2_copy
...
// CHECK-GLOBAL: @s3_1 = dso_local global i32 1
int s3_1 = __alignof(((struct s3*) 0)->anInt);
// CHECK-FUNCTIONS-LABEL: define dso_local i32 @test3(
