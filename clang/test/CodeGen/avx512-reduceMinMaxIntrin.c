...
// CHECK-NEXT:  entry:
// CHECK-NEXT:    [[__A_ADDR_I16_I:%.*]] = alloca <4 x double>, align 32
// CHECK-NEXT:    [[__B_ADDR_I17_I:%.*]] = alloca <4 x double>, align 32
// CHECK-NEXT:    [[__A_ADDR_I14_I:%.*]] = alloca <2 x double>, align 16
// CHECK-NEXT:    [[__B_ADDR_I15_I:%.*]] = alloca <2 x double>, align 16
...
// CHECK-NEXT:    [[SHUFFLE_I:%.*]] = shufflevector <8 x double> [[TMP1]], <8 x double> zeroinitializer, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
// CHECK-NEXT:    store <4 x double> [[SHUFFLE_I]], <4 x double>* [[TMP_I]], align 32
// CHECK-NEXT:    [[TMP2:%.*]] = load <4 x double>, <4 x double>* [[TMP_I]], align 32
// CHECK-NEXT:    store <4 x double> [[TMP2]], <4 x double>* [[__T1_I]], align 32
// CHECK-NEXT:    [[TMP3:%.*]] = load <8 x double>, <8 x double>* [[__V_ADDR_I]], align 64
// CHECK-NEXT:    [[SHUFFLE3_I:%.*]] = shufflevector <8 x double> [[TMP3]], <8 x double> zeroinitializer, <4 x i32> <i32 4, i32 5, i32 6, i32 7>
// CHECK-NEXT:    store <4 x double> [[SHUFFLE3_I]], <4 x double>* [[TMP1_I]], align 32
// CHECK-NEXT:    [[TMP4:%.*]] = load <4 x double>, <4 x double>* [[TMP1_I]], align 32
// CHECK-NEXT:    store <4 x double> [[TMP4]], <4 x double>* [[__T2_I]], align 32
// CHECK-NEXT:    [[TMP5:%.*]] = load <4 x double>, <4 x double>* [[__T1_I]], align 32
// CHECK-NEXT:    [[TMP6:%.*]] = load <4 x double>, <4 x double>* [[__T2_I]], align 32
// CHECK-NEXT:    store <4 x double> [[TMP5]], <4 x double>* [[__A_ADDR_I16_I]], align 32
// CHECK-NEXT:    store <4 x double> [[TMP6]], <4 x double>* [[__B_ADDR_I17_I]], align 32
// CHECK-NEXT:    [[TMP7:%.*]] = load <4 x double>, <4 x double>* [[__A_ADDR_I16_I]], align 32
// CHECK-NEXT:    [[TMP8:%.*]] = load <4 x double>, <4 x double>* [[__B_ADDR_I17_I]], align 32
// CHECK-NEXT:    [[TMP9:%.*]] = call <4 x double> @llvm.x86.avx.max.pd.256(<4 x double> [[TMP7]], <4 x double> [[TMP8]]) #2
// CHECK-NEXT:    store <4 x double> [[TMP9]], <4 x double>* [[__T3_I]], align 32
// CHECK-NEXT:    [[TMP10:%.*]] = load <4 x double>, <4 x double>* [[__T3_I]], align 32
// CHECK-NEXT:    [[SHUFFLE7_I:%.*]] = shufflevector <4 x double> [[TMP10]], <4 x double> zeroinitializer, <2 x i32> <i32 0, i32 1>
// CHECK-NEXT:    store <2 x double> [[SHUFFLE7_I]], <2 x double>* [[TMP5_I]], align 16
// CHECK-NEXT:    [[TMP11:%.*]] = load <2 x double>, <2 x double>* [[TMP5_I]], align 16
// CHECK-NEXT:    store <2 x double> [[TMP11]], <2 x double>* [[__T4_I]], align 16
// CHECK-NEXT:    [[TMP12:%.*]] = load <4 x double>, <4 x double>* [[__T3_I]], align 32
// CHECK-NEXT:    [[SHUFFLE10_I:%.*]] = shufflevector <4 x double> [[TMP12]], <4 x double> zeroinitializer, <2 x i32> <i32 2, i32 3>
// CHECK-NEXT:    store <2 x double> [[SHUFFLE10_I]], <2 x double>* [[TMP8_I]], align 16
// CHECK-NEXT:    [[TMP13:%.*]] = load <2 x double>, <2 x double>* [[TMP8_I]], align 16
// CHECK-NEXT:    store <2 x double> [[TMP13]], <2 x double>* [[__T5_I]], align 16
// CHECK-NEXT:    [[TMP14:%.*]] = load <2 x double>, <2 x double>* [[__T4_I]], align 16
// CHECK-NEXT:    [[TMP15:%.*]] = load <2 x double>, <2 x double>* [[__T5_I]], align 16
// CHECK-NEXT:    store <2 x double> [[TMP14]], <2 x double>* [[__A_ADDR_I14_I]], align 16
// CHECK-NEXT:    store <2 x double> [[TMP15]], <2 x double>* [[__B_ADDR_I15_I]], align 16
// CHECK-NEXT:    [[TMP16:%.*]] = load <2 x double>, <2 x double>* [[__A_ADDR_I14_I]], align 16
// CHECK-NEXT:    [[TMP17:%.*]] = load <2 x double>, <2 x double>* [[__B_ADDR_I15_I]], align 16
// CHECK-NEXT:    [[TMP18:%.*]] = call <2 x double> @llvm.x86.sse2.max.pd(<2 x double> [[TMP16]], <2 x double> [[TMP17]]) #2
...
// CHECK-NEXT:    [[TMP7:%.*]] = load <4 x double>, <4 x double>* [[__A_ADDR_I16_I]], align 32
// CHECK-NEXT:    [[TMP8:%.*]] = load <4 x double>, <4 x double>* [[__B_ADDR_I17_I]], align 32
// CHECK-NEXT:    [[TMP9:%.*]] = call <4 x double> @llvm.x86.avx.min.pd.256(<4 x double> [[TMP7]], <4 x double> [[TMP8]]) #2
// CHECK-NEXT:    store <4 x double> [[TMP9]], <4 x double>* [[__T3_I]], align 32
// CHECK-NEXT:    [[TMP10:%.*]] = load <4 x double>, <4 x double>* [[__T3_I]], align 32
// CHECK-NEXT:    [[SHUFFLE7_I:%.*]] = shufflevector <4 x double> [[TMP10]], <4 x double> zeroinitializer, <2 x i32> <i32 0, i32 1>
// CHECK-NEXT:    store <2 x double> [[SHUFFLE7_I]], <2 x double>* [[TMP5_I]], align 16
...
// CHECK-NEXT:    [[TMP16:%.*]] = load <2 x double>, <2 x double>* [[__A_ADDR_I14_I]], align 16
// CHECK-NEXT:    [[TMP17:%.*]] = load <2 x double>, <2 x double>* [[__B_ADDR_I15_I]], align 16
// CHECK-NEXT:    [[TMP18:%.*]] = call <2 x double> @llvm.x86.sse2.min.pd(<2 x double> [[TMP16]], <2 x double> [[TMP17]]) #2
// CHECK-NEXT:    store <2 x double> [[TMP18]], <2 x double>* [[__T6_I]], align 16
// CHECK-NEXT:    [[TMP19:%.*]] = load <2 x double>, <2 x double>* [[__T6_I]], align 16
// CHECK-NEXT:    [[TMP20:%.*]] = load <2 x double>, <2 x double>* [[__T6_I]], align 16
// CHECK-NEXT:    [[SHUFFLE12_I:%.*]] = shufflevector <2 x double> [[TMP19]], <2 x double> [[TMP20]], <2 x i32> <i32 1, i32 0>
...
// CHECK-NEXT:    [[__A_ADDR_I18_I:%.*]] = alloca <4 x double>, align 32
// CHECK-NEXT:    [[__B_ADDR_I19_I:%.*]] = alloca <4 x double>, align 32
// CHECK-NEXT:    [[__A_ADDR_I16_I:%.*]] = alloca <2 x double>, align 16
// CHECK-NEXT:    [[__B_ADDR_I17_I:%.*]] = alloca <2 x double>, align 16
...
// CHECK-NEXT:    [[TMP_I:%.*]] = alloca <4 x double>, align 32
// CHECK-NEXT:    [[__T2_I:%.*]] = alloca <4 x double>, align 32
// CHECK-NEXT:    [[TMP3_I:%.*]] = alloca <4 x double>, align 32
// CHECK-NEXT:    [[__T3_I:%.*]] = alloca <4 x double>, align 32
// CHECK-NEXT:    [[__T4_I:%.*]] = alloca <2 x double>, align 16
// CHECK-NEXT:    [[TMP7_I:%.*]] = alloca <2 x double>, align 16
// CHECK-NEXT:    [[__T5_I:%.*]] = alloca <2 x double>, align 16
// CHECK-NEXT:    [[TMP10_I:%.*]] = alloca <2 x double>, align 16
// CHECK-NEXT:    [[__T6_I:%.*]] = alloca <2 x double>, align 16
// CHECK-NEXT:    [[__T7_I:%.*]] = alloca <2 x double>, align 16
// CHECK-NEXT:    [[__T8_I:%.*]] = alloca <2 x double>, align 16
// CHECK-NEXT:    [[__M_ADDR:%.*]] = alloca i8, align 1
...
// CHECK-NEXT:    [[SHUFFLE_I:%.*]] = shufflevector <8 x double> [[TMP18]], <8 x double> zeroinitializer, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
// CHECK-NEXT:    store <4 x double> [[SHUFFLE_I]], <4 x double>* [[TMP_I]], align 32
// CHECK-NEXT:    [[TMP19:%.*]] = load <4 x double>, <4 x double>* [[TMP_I]], align 32
// CHECK-NEXT:    store <4 x double> [[TMP19]], <4 x double>* [[__T1_I]], align 32
// CHECK-NEXT:    [[TMP20:%.*]] = load <8 x double>, <8 x double>* [[__V_ADDR_I]], align 64
// CHECK-NEXT:    [[SHUFFLE5_I:%.*]] = shufflevector <8 x double> [[TMP20]], <8 x double> zeroinitializer, <4 x i32> <i32 4, i32 5, i32 6, i32 7>
// CHECK-NEXT:    store <4 x double> [[SHUFFLE5_I]], <4 x double>* [[TMP3_I]], align 32
// CHECK-NEXT:    [[TMP21:%.*]] = load <4 x double>, <4 x double>* [[TMP3_I]], align 32
// CHECK-NEXT:    store <4 x double> [[TMP21]], <4 x double>* [[__T2_I]], align 32
// CHECK-NEXT:    [[TMP22:%.*]] = load <4 x double>, <4 x double>* [[__T1_I]], align 32
// CHECK-NEXT:    [[TMP23:%.*]] = load <4 x double>, <4 x double>* [[__T2_I]], align 32
// CHECK-NEXT:    store <4 x double> [[TMP22]], <4 x double>* [[__A_ADDR_I18_I]], align 32
// CHECK-NEXT:    store <4 x double> [[TMP23]], <4 x double>* [[__B_ADDR_I19_I]], align 32
// CHECK-NEXT:    [[TMP24:%.*]] = load <4 x double>, <4 x double>* [[__A_ADDR_I18_I]], align 32
// CHECK-NEXT:    [[TMP25:%.*]] = load <4 x double>, <4 x double>* [[__B_ADDR_I19_I]], align 32
// CHECK-NEXT:    [[TMP26:%.*]] = call <4 x double> @llvm.x86.avx.max.pd.256(<4 x double> [[TMP24]], <4 x double> [[TMP25]]) #2
// CHECK-NEXT:    store <4 x double> [[TMP26]], <4 x double>* [[__T3_I]], align 32
// CHECK-NEXT:    [[TMP27:%.*]] = load <4 x double>, <4 x double>* [[__T3_I]], align 32
// CHECK-NEXT:    [[SHUFFLE9_I:%.*]] = shufflevector <4 x double> [[TMP27]], <4 x double> zeroinitializer, <2 x i32> <i32 0, i32 1>
// CHECK-NEXT:    store <2 x double> [[SHUFFLE9_I]], <2 x double>* [[TMP7_I]], align 16
// CHECK-NEXT:    [[TMP28:%.*]] = load <2 x double>, <2 x double>* [[TMP7_I]], align 16
// CHECK-NEXT:    store <2 x double> [[TMP28]], <2 x double>* [[__T4_I]], align 16
// CHECK-NEXT:    [[TMP29:%.*]] = load <4 x double>, <4 x double>* [[__T3_I]], align 32
// CHECK-NEXT:    [[SHUFFLE12_I:%.*]] = shufflevector <4 x double> [[TMP29]], <4 x double> zeroinitializer, <2 x i32> <i32 2, i32 3>
// CHECK-NEXT:    store <2 x double> [[SHUFFLE12_I]], <2 x double>* [[TMP10_I]], align 16
...
// CHECK-NEXT:    [[TMP24:%.*]] = load <4 x double>, <4 x double>* [[__A_ADDR_I18_I]], align 32
// CHECK-NEXT:    [[TMP25:%.*]] = load <4 x double>, <4 x double>* [[__B_ADDR_I19_I]], align 32
// CHECK-NEXT:    [[TMP26:%.*]] = call <4 x double> @llvm.x86.avx.min.pd.256(<4 x double> [[TMP24]], <4 x double> [[TMP25]]) #2
// CHECK-NEXT:    store <4 x double> [[TMP26]], <4 x double>* [[__T3_I]], align 32
// CHECK-NEXT:    [[TMP27:%.*]] = load <4 x double>, <4 x double>* [[__T3_I]], align 32
// CHECK-NEXT:    [[SHUFFLE9_I:%.*]] = shufflevector <4 x double> [[TMP27]], <4 x double> zeroinitializer, <2 x i32> <i32 0, i32 1>
// CHECK-NEXT:    store <2 x double> [[SHUFFLE9_I]], <2 x double>* [[TMP7_I]], align 16
...
// CHECK-NEXT:    [[__V1_ADDR_I18_I:%.*]] = alloca <2 x i64>, align 16
// CHECK-NEXT:    [[__V2_ADDR_I19_I:%.*]] = alloca <2 x i64>, align 16
// CHECK-NEXT:    [[__V1_ADDR_I16_I:%.*]] = alloca <2 x i64>, align 16
// CHECK-NEXT:    [[__V2_ADDR_I17_I:%.*]] = alloca <2 x i64>, align 16
...
// CHECK-NEXT:    store <8 x i64> [[TMP0]], <8 x i64>* [[__V_ADDR_I]], align 64
// CHECK-NEXT:    [[TMP1:%.*]] = load <8 x i64>, <8 x i64>* [[__V_ADDR_I]], align 64
// CHECK-NEXT:    [[SHUFFLE_I:%.*]] = shufflevector <8 x i64> [[TMP1]], <8 x i64> zeroinitializer, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
// CHECK-NEXT:    store <4 x i64> [[SHUFFLE_I]], <4 x i64>* [[TMP_I]], align 32
// CHECK-NEXT:    [[TMP2:%.*]] = load <4 x i64>, <4 x i64>* [[TMP_I]], align 32
// CHECK-NEXT:    store <4 x i64> [[TMP2]], <4 x i64>* [[__T1_I]], align 32
// CHECK-NEXT:    [[TMP3:%.*]] = load <8 x i64>, <8 x i64>* [[__V_ADDR_I]], align 64
// CHECK-NEXT:    [[SHUFFLE3_I:%.*]] = shufflevector <8 x i64> [[TMP3]], <8 x i64> zeroinitializer, <4 x i32> <i32 4, i32 5, i32 6, i32 7>
// CHECK-NEXT:    store <4 x i64> [[SHUFFLE3_I]], <4 x i64>* [[TMP1_I]], align 32
// CHECK-NEXT:    [[TMP4:%.*]] = load <4 x i64>, <4 x i64>* [[TMP1_I]], align 32
// CHECK-NEXT:    store <4 x i64> [[TMP4]], <4 x i64>* [[__T2_I]], align 32
// CHECK-NEXT:    [[TMP5:%.*]] = load <4 x i64>, <4 x i64>* [[__T1_I]], align 32
// CHECK-NEXT:    [[TMP6:%.*]] = load <4 x i64>, <4 x i64>* [[__T2_I]], align 32
// CHECK-NEXT:    store <4 x i64> [[TMP5]], <4 x i64>* [[__A_ADDR_I_I]], align 32
// CHECK-NEXT:    store <4 x i64> [[TMP6]], <4 x i64>* [[__B_ADDR_I_I]], align 32
// CHECK-NEXT:    [[TMP7:%.*]] = load <4 x i64>, <4 x i64>* [[__A_ADDR_I_I]], align 32
// CHECK-NEXT:    [[TMP8:%.*]] = bitcast <4 x i64> [[TMP7]] to <8 x i32>
// CHECK-NEXT:    [[TMP9:%.*]] = load <4 x i64>, <4 x i64>* [[__B_ADDR_I_I]], align 32
// CHECK-NEXT:    [[TMP10:%.*]] = bitcast <4 x i64> [[TMP9]] to <8 x i32>
// CHECK-NEXT:    [[TMP11:%.*]] = icmp sgt <8 x i32> [[TMP8]], [[TMP10]]
// CHECK-NEXT:    [[TMP12:%.*]] = select <8 x i1> [[TMP11]], <8 x i32> [[TMP8]], <8 x i32> [[TMP10]]
// CHECK-NEXT:    [[TMP13:%.*]] = bitcast <8 x i32> [[TMP12]] to <4 x i64>
// CHECK-NEXT:    store <4 x i64> [[TMP13]], <4 x i64>* [[__T3_I]], align 32
// CHECK-NEXT:    [[TMP14:%.*]] = load <4 x i64>, <4 x i64>* [[__T3_I]], align 32
// CHECK-NEXT:    [[SHUFFLE7_I:%.*]] = shufflevector <4 x i64> [[TMP14]], <4 x i64> zeroinitializer, <2 x i32> <i32 0, i32 1>
// CHECK-NEXT:    store <2 x i64> [[SHUFFLE7_I]], <2 x i64>* [[TMP5_I]], align 16
// CHECK-NEXT:    [[TMP15:%.*]] = load <2 x i64>, <2 x i64>* [[TMP5_I]], align 16
// CHECK-NEXT:    store <2 x i64> [[TMP15]], <2 x i64>* [[__T4_I]], align 16
// CHECK-NEXT:    [[TMP16:%.*]] = load <4 x i64>, <4 x i64>* [[__T3_I]], align 32
// CHECK-NEXT:    [[SHUFFLE10_I:%.*]] = shufflevector <4 x i64> [[TMP16]], <4 x i64> zeroinitializer, <2 x i32> <i32 2, i32 3>
// CHECK-NEXT:    store <2 x i64> [[SHUFFLE10_I]], <2 x i64>* [[TMP8_I]], align 16
// CHECK-NEXT:    [[TMP17:%.*]] = load <2 x i64>, <2 x i64>* [[TMP8_I]], align 16
// CHECK-NEXT:    store <2 x i64> [[TMP17]], <2 x i64>* [[__T5_I]], align 16
// CHECK-NEXT:    [[TMP18:%.*]] = load <2 x i64>, <2 x i64>* [[__T4_I]], align 16
// CHECK-NEXT:    [[TMP19:%.*]] = load <2 x i64>, <2 x i64>* [[__T5_I]], align 16
// CHECK-NEXT:    store <2 x i64> [[TMP18]], <2 x i64>* [[__V1_ADDR_I18_I]], align 16
// CHECK-NEXT:    store <2 x i64> [[TMP19]], <2 x i64>* [[__V2_ADDR_I19_I]], align 16
// CHECK-NEXT:    [[TMP20:%.*]] = load <2 x i64>, <2 x i64>* [[__V1_ADDR_I18_I]], align 16
// CHECK-NEXT:    [[TMP21:%.*]] = bitcast <2 x i64> [[TMP20]] to <4 x i32>
// CHECK-NEXT:    [[TMP22:%.*]] = load <2 x i64>, <2 x i64>* [[__V2_ADDR_I19_I]], align 16
// CHECK-NEXT:    [[TMP23:%.*]] = bitcast <2 x i64> [[TMP22]] to <4 x i32>
// CHECK-NEXT:    [[TMP24:%.*]] = icmp sgt <4 x i32> [[TMP21]], [[TMP23]]
// CHECK-NEXT:    [[TMP25:%.*]] = select <4 x i1> [[TMP24]], <4 x i32> [[TMP21]], <4 x i32> [[TMP23]]
// CHECK-NEXT:    [[TMP26:%.*]] = bitcast <4 x i32> [[TMP25]] to <2 x i64>
// CHECK-NEXT:    store <2 x i64> [[TMP26]], <2 x i64>* [[__T6_I]], align 16
// CHECK-NEXT:    [[TMP27:%.*]] = load <2 x i64>, <2 x i64>* [[__T6_I]], align 16
// CHECK-NEXT:    [[TMP28:%.*]] = bitcast <2 x i64> [[TMP27]] to <4 x i32>
// CHECK-NEXT:    [[TMP29:%.*]] = load <2 x i64>, <2 x i64>* [[__T6_I]], align 16
// CHECK-NEXT:    [[TMP30:%.*]] = bitcast <2 x i64> [[TMP29]] to <4 x i32>
// CHECK-NEXT:    [[SHUFFLE12_I:%.*]] = shufflevector <4 x i32> [[TMP28]], <4 x i32> [[TMP30]], <4 x i32> <i32 2, i32 3, i32 0, i32 1>
// CHECK-NEXT:    [[TMP31:%.*]] = bitcast <4 x i32> [[SHUFFLE12_I]] to <2 x i64>
// CHECK-NEXT:    store <2 x i64> [[TMP31]], <2 x i64>* [[__T7_I]], align 16
// CHECK-NEXT:    [[TMP32:%.*]] = load <2 x i64>, <2 x i64>* [[__T6_I]], align 16
// CHECK-NEXT:    [[TMP33:%.*]] = load <2 x i64>, <2 x i64>* [[__T7_I]], align 16
// CHECK-NEXT:    store <2 x i64> [[TMP32]], <2 x i64>* [[__V1_ADDR_I16_I]], align 16
// CHECK-NEXT:    store <2 x i64> [[TMP33]], <2 x i64>* [[__V2_ADDR_I17_I]], align 16
// CHECK-NEXT:    [[TMP34:%.*]] = load <2 x i64>, <2 x i64>* [[__V1_ADDR_I16_I]], align 16
// CHECK-NEXT:    [[TMP35:%.*]] = bitcast <2 x i64> [[TMP34]] to <4 x i32>
// CHECK-NEXT:    [[TMP36:%.*]] = load <2 x i64>, <2 x i64>* [[__V2_ADDR_I17_I]], align 16
// CHECK-NEXT:    [[TMP37:%.*]] = bitcast <2 x i64> [[TMP36]] to <4 x i32>
// CHECK-NEXT:    [[TMP38:%.*]] = icmp sgt <4 x i32> [[TMP35]], [[TMP37]]
// CHECK-NEXT:    [[TMP39:%.*]] = select <4 x i1> [[TMP38]], <4 x i32> [[TMP35]], <4 x i32> [[TMP37]]
// CHECK-NEXT:    [[TMP40:%.*]] = bitcast <4 x i32> [[TMP39]] to <2 x i64>
// CHECK-NEXT:    store <2 x i64> [[TMP40]], <2 x i64>* [[__T8_I]], align 16
// CHECK-NEXT:    [[TMP41:%.*]] = load <2 x i64>, <2 x i64>* [[__T8_I]], align 16
// CHECK-NEXT:    [[TMP42:%.*]] = bitcast <2 x i64> [[TMP41]] to <4 x i32>
// CHECK-NEXT:    [[TMP43:%.*]] = load <2 x i64>, <2 x i64>* [[__T8_I]], align 16
// CHECK-NEXT:    [[TMP44:%.*]] = bitcast <2 x i64> [[TMP43]] to <4 x i32>
// CHECK-NEXT:    [[SHUFFLE14_I:%.*]] = shufflevector <4 x i32> [[TMP42]], <4 x i32> [[TMP44]], <4 x i32> <i32 1, i32 0, i32 3, i32 2>
// CHECK-NEXT:    [[TMP45:%.*]] = bitcast <4 x i32> [[SHUFFLE14_I]] to <2 x i64>
// CHECK-NEXT:    store <2 x i64> [[TMP45]], <2 x i64>* [[__T9_I]], align 16
// CHECK-NEXT:    [[TMP46:%.*]] = load <2 x i64>, <2 x i64>* [[__T8_I]], align 16
// CHECK-NEXT:    [[TMP47:%.*]] = load <2 x i64>, <2 x i64>* [[__T9_I]], align 16
// CHECK-NEXT:    store <2 x i64> [[TMP46]], <2 x i64>* [[__V1_ADDR_I_I]], align 16
// CHECK-NEXT:    store <2 x i64> [[TMP47]], <2 x i64>* [[__V2_ADDR_I_I]], align 16
// CHECK-NEXT:    [[TMP48:%.*]] = load <2 x i64>, <2 x i64>* [[__V1_ADDR_I_I]], align 16
// CHECK-NEXT:    [[TMP49:%.*]] = bitcast <2 x i64> [[TMP48]] to <4 x i32>
// CHECK-NEXT:    [[TMP50:%.*]] = load <2 x i64>, <2 x i64>* [[__V2_ADDR_I_I]], align 16
...
// CHECK-NEXT:    [[TMP9:%.*]] = load <4 x i64>, <4 x i64>* [[__B_ADDR_I_I]], align 32
// CHECK-NEXT:    [[TMP10:%.*]] = bitcast <4 x i64> [[TMP9]] to <8 x i32>
// CHECK-NEXT:    [[TMP11:%.*]] = icmp ugt <8 x i32> [[TMP8]], [[TMP10]]
// CHECK-NEXT:    [[TMP12:%.*]] = select <8 x i1> [[TMP11]], <8 x i32> [[TMP8]], <8 x i32> [[TMP10]]
// CHECK-NEXT:    [[TMP13:%.*]] = bitcast <8 x i32> [[TMP12]] to <4 x i64>
// CHECK-NEXT:    store <4 x i64> [[TMP13]], <4 x i64>* [[__T3_I]], align 32
// CHECK-NEXT:    [[TMP14:%.*]] = load <4 x i64>, <4 x i64>* [[__T3_I]], align 32
...
// CHECK-NEXT:    [[TMP22:%.*]] = load <2 x i64>, <2 x i64>* [[__V2_ADDR_I19_I]], align 16
// CHECK-NEXT:    [[TMP23:%.*]] = bitcast <2 x i64> [[TMP22]] to <4 x i32>
// CHECK-NEXT:    [[TMP24:%.*]] = icmp ugt <4 x i32> [[TMP21]], [[TMP23]]
// CHECK-NEXT:    [[TMP25:%.*]] = select <4 x i1> [[TMP24]], <4 x i32> [[TMP21]], <4 x i32> [[TMP23]]
// CHECK-NEXT:    [[TMP26:%.*]] = bitcast <4 x i32> [[TMP25]] to <2 x i64>
// CHECK-NEXT:    store <2 x i64> [[TMP26]], <2 x i64>* [[__T6_I]], align 16
// CHECK-NEXT:    [[TMP27:%.*]] = load <2 x i64>, <2 x i64>* [[__T6_I]], align 16
...
// CHECK-NEXT:    [[TMP36:%.*]] = load <2 x i64>, <2 x i64>* [[__V2_ADDR_I17_I]], align 16
// CHECK-NEXT:    [[TMP37:%.*]] = bitcast <2 x i64> [[TMP36]] to <4 x i32>
// CHECK-NEXT:    [[TMP38:%.*]] = icmp ugt <4 x i32> [[TMP35]], [[TMP37]]
// CHECK-NEXT:    [[TMP39:%.*]] = select <4 x i1> [[TMP38]], <4 x i32> [[TMP35]], <4 x i32> [[TMP37]]
// CHECK-NEXT:    [[TMP40:%.*]] = bitcast <4 x i32> [[TMP39]] to <2 x i64>
// CHECK-NEXT:    store <2 x i64> [[TMP40]], <2 x i64>* [[__T8_I]], align 16
// CHECK-NEXT:    [[TMP41:%.*]] = load <2 x i64>, <2 x i64>* [[__T8_I]], align 16
...
// CHECK-NEXT:  entry:
// CHECK-NEXT:    [[__A_ADDR_I20_I:%.*]] = alloca <8 x float>, align 32
// CHECK-NEXT:    [[__B_ADDR_I21_I:%.*]] = alloca <8 x float>, align 32
// CHECK-NEXT:    [[__A_ADDR_I18_I:%.*]] = alloca <4 x float>, align 16
// CHECK-NEXT:    [[__B_ADDR_I19_I:%.*]] = alloca <4 x float>, align 16
// CHECK-NEXT:    [[__A_ADDR_I16_I:%.*]] = alloca <4 x float>, align 16
// CHECK-NEXT:    [[__B_ADDR_I17_I:%.*]] = alloca <4 x float>, align 16
...
// CHECK-NEXT:    [[TMP5_I:%.*]] = alloca <4 x float>, align 16
// CHECK-NEXT:    [[__T5_I:%.*]] = alloca <4 x float>, align 16
// CHECK-NEXT:    [[TMP8_I:%.*]] = alloca <4 x float>, align 16
...
// CHECK-NEXT:    [[SHUFFLE_I:%.*]] = shufflevector <8 x double> [[TMP2]], <8 x double> zeroinitializer, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
// CHECK-NEXT:    store <4 x double> [[SHUFFLE_I]], <4 x double>* [[TMP_I]], align 32
// CHECK-NEXT:    [[TMP3:%.*]] = load <4 x double>, <4 x double>* [[TMP_I]], align 32
// CHECK-NEXT:    [[TMP4:%.*]] = bitcast <4 x double> [[TMP3]] to <8 x float>
// CHECK-NEXT:    store <8 x float> [[TMP4]], <8 x float>* [[__T1_I]], align 32
// CHECK-NEXT:    [[TMP5:%.*]] = load <16 x float>, <16 x float>* [[__V_ADDR_I]], align 64
// CHECK-NEXT:    [[TMP6:%.*]] = bitcast <16 x float> [[TMP5]] to <8 x double>
// CHECK-NEXT:    [[SHUFFLE3_I:%.*]] = shufflevector <8 x double> [[TMP6]], <8 x double> zeroinitializer, <4 x i32> <i32 4, i32 5, i32 6, i32 7>
// CHECK-NEXT:    store <4 x double> [[SHUFFLE3_I]], <4 x double>* [[TMP1_I]], align 32
// CHECK-NEXT:    [[TMP7:%.*]] = load <4 x double>, <4 x double>* [[TMP1_I]], align 32
// CHECK-NEXT:    [[TMP8:%.*]] = bitcast <4 x double> [[TMP7]] to <8 x float>
// CHECK-NEXT:    store <8 x float> [[TMP8]], <8 x float>* [[__T2_I]], align 32
// CHECK-NEXT:    [[TMP9:%.*]] = load <8 x float>, <8 x float>* [[__T1_I]], align 32
// CHECK-NEXT:    [[TMP10:%.*]] = load <8 x float>, <8 x float>* [[__T2_I]], align 32
// CHECK-NEXT:    store <8 x float> [[TMP9]], <8 x float>* [[__A_ADDR_I20_I]], align 32
// CHECK-NEXT:    store <8 x float> [[TMP10]], <8 x float>* [[__B_ADDR_I21_I]], align 32
// CHECK-NEXT:    [[TMP11:%.*]] = load <8 x float>, <8 x float>* [[__A_ADDR_I20_I]], align 32
// CHECK-NEXT:    [[TMP12:%.*]] = load <8 x float>, <8 x float>* [[__B_ADDR_I21_I]], align 32
// CHECK-NEXT:    [[TMP13:%.*]] = call <8 x float> @llvm.x86.avx.max.ps.256(<8 x float> [[TMP11]], <8 x float> [[TMP12]]) #2
// CHECK-NEXT:    store <8 x float> [[TMP13]], <8 x float>* [[__T3_I]], align 32
// CHECK-NEXT:    [[TMP14:%.*]] = load <8 x float>, <8 x float>* [[__T3_I]], align 32
// CHECK-NEXT:    [[SHUFFLE7_I:%.*]] = shufflevector <8 x float> [[TMP14]], <8 x float> zeroinitializer, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
// CHECK-NEXT:    store <4 x float> [[SHUFFLE7_I]], <4 x float>* [[TMP5_I]], align 16
// CHECK-NEXT:    [[TMP15:%.*]] = load <4 x float>, <4 x float>* [[TMP5_I]], align 16
// CHECK-NEXT:    store <4 x float> [[TMP15]], <4 x float>* [[__T4_I]], align 16
// CHECK-NEXT:    [[TMP16:%.*]] = load <8 x float>, <8 x float>* [[__T3_I]], align 32
// CHECK-NEXT:    [[SHUFFLE10_I:%.*]] = shufflevector <8 x float> [[TMP16]], <8 x float> zeroinitializer, <4 x i32> <i32 4, i32 5, i32 6, i32 7>
// CHECK-NEXT:    store <4 x float> [[SHUFFLE10_I]], <4 x float>* [[TMP8_I]], align 16
// CHECK-NEXT:    [[TMP17:%.*]] = load <4 x float>, <4 x float>* [[TMP8_I]], align 16
// CHECK-NEXT:    store <4 x float> [[TMP17]], <4 x float>* [[__T5_I]], align 16
// CHECK-NEXT:    [[TMP18:%.*]] = load <4 x float>, <4 x float>* [[__T4_I]], align 16
// CHECK-NEXT:    [[TMP19:%.*]] = load <4 x float>, <4 x float>* [[__T5_I]], align 16
// CHECK-NEXT:    store <4 x float> [[TMP18]], <4 x float>* [[__A_ADDR_I18_I]], align 16
// CHECK-NEXT:    store <4 x float> [[TMP19]], <4 x float>* [[__B_ADDR_I19_I]], align 16
// CHECK-NEXT:    [[TMP20:%.*]] = load <4 x float>, <4 x float>* [[__A_ADDR_I18_I]], align 16
// CHECK-NEXT:    [[TMP21:%.*]] = load <4 x float>, <4 x float>* [[__B_ADDR_I19_I]], align 16
// CHECK-NEXT:    [[TMP22:%.*]] = call <4 x float> @llvm.x86.sse.max.ps(<4 x float> [[TMP20]], <4 x float> [[TMP21]]) #2
// CHECK-NEXT:    store <4 x float> [[TMP22]], <4 x float>* [[__T6_I]], align 16
// CHECK-NEXT:    [[TMP23:%.*]] = load <4 x float>, <4 x float>* [[__T6_I]], align 16
// CHECK-NEXT:    [[TMP24:%.*]] = load <4 x float>, <4 x float>* [[__T6_I]], align 16
// CHECK-NEXT:    [[SHUFFLE12_I:%.*]] = shufflevector <4 x float> [[TMP23]], <4 x float> [[TMP24]], <4 x i32> <i32 2, i32 3, i32 0, i32 1>
// CHECK-NEXT:    store <4 x float> [[SHUFFLE12_I]], <4 x float>* [[__T7_I]], align 16
// CHECK-NEXT:    [[TMP25:%.*]] = load <4 x float>, <4 x float>* [[__T6_I]], align 16
// CHECK-NEXT:    [[TMP26:%.*]] = load <4 x float>, <4 x float>* [[__T7_I]], align 16
// CHECK-NEXT:    store <4 x float> [[TMP25]], <4 x float>* [[__A_ADDR_I16_I]], align 16
// CHECK-NEXT:    store <4 x float> [[TMP26]], <4 x float>* [[__B_ADDR_I17_I]], align 16
...
// CHECK-NEXT:    [[TMP9:%.*]] = load <4 x i64>, <4 x i64>* [[__B_ADDR_I_I]], align 32
// CHECK-NEXT:    [[TMP10:%.*]] = bitcast <4 x i64> [[TMP9]] to <8 x i32>
// CHECK-NEXT:    [[TMP11:%.*]] = icmp slt <8 x i32> [[TMP8]], [[TMP10]]
// CHECK-NEXT:    [[TMP12:%.*]] = select <8 x i1> [[TMP11]], <8 x i32> [[TMP8]], <8 x i32> [[TMP10]]
// CHECK-NEXT:    [[TMP13:%.*]] = bitcast <8 x i32> [[TMP12]] to <4 x i64>
// CHECK-NEXT:    store <4 x i64> [[TMP13]], <4 x i64>* [[__T3_I]], align 32
// CHECK-NEXT:    [[TMP14:%.*]] = load <4 x i64>, <4 x i64>* [[__T3_I]], align 32
...
// CHECK-NEXT:    [[TMP22:%.*]] = load <2 x i64>, <2 x i64>* [[__V2_ADDR_I19_I]], align 16
// CHECK-NEXT:    [[TMP23:%.*]] = bitcast <2 x i64> [[TMP22]] to <4 x i32>
// CHECK-NEXT:    [[TMP24:%.*]] = icmp slt <4 x i32> [[TMP21]], [[TMP23]]
// CHECK-NEXT:    [[TMP25:%.*]] = select <4 x i1> [[TMP24]], <4 x i32> [[TMP21]], <4 x i32> [[TMP23]]
// CHECK-NEXT:    [[TMP26:%.*]] = bitcast <4 x i32> [[TMP25]] to <2 x i64>
// CHECK-NEXT:    store <2 x i64> [[TMP26]], <2 x i64>* [[__T6_I]], align 16
// CHECK-NEXT:    [[TMP27:%.*]] = load <2 x i64>, <2 x i64>* [[__T6_I]], align 16
...
// CHECK-NEXT:    [[TMP36:%.*]] = load <2 x i64>, <2 x i64>* [[__V2_ADDR_I17_I]], align 16
// CHECK-NEXT:    [[TMP37:%.*]] = bitcast <2 x i64> [[TMP36]] to <4 x i32>
// CHECK-NEXT:    [[TMP38:%.*]] = icmp slt <4 x i32> [[TMP35]], [[TMP37]]
// CHECK-NEXT:    [[TMP39:%.*]] = select <4 x i1> [[TMP38]], <4 x i32> [[TMP35]], <4 x i32> [[TMP37]]
// CHECK-NEXT:    [[TMP40:%.*]] = bitcast <4 x i32> [[TMP39]] to <2 x i64>
// CHECK-NEXT:    store <2 x i64> [[TMP40]], <2 x i64>* [[__T8_I]], align 16
// CHECK-NEXT:    [[TMP41:%.*]] = load <2 x i64>, <2 x i64>* [[__T8_I]], align 16
...
// CHECK-NEXT:    [[TMP22:%.*]] = load <2 x i64>, <2 x i64>* [[__V2_ADDR_I19_I]], align 16
// CHECK-NEXT:    [[TMP23:%.*]] = bitcast <2 x i64> [[TMP22]] to <4 x i32>
// CHECK-NEXT:    [[TMP24:%.*]] = icmp ult <4 x i32> [[TMP21]], [[TMP23]]
// CHECK-NEXT:    [[TMP25:%.*]] = select <4 x i1> [[TMP24]], <4 x i32> [[TMP21]], <4 x i32> [[TMP23]]
// CHECK-NEXT:    [[TMP26:%.*]] = bitcast <4 x i32> [[TMP25]] to <2 x i64>
// CHECK-NEXT:    store <2 x i64> [[TMP26]], <2 x i64>* [[__T6_I]], align 16
// CHECK-NEXT:    [[TMP27:%.*]] = load <2 x i64>, <2 x i64>* [[__T6_I]], align 16
...
// CHECK-NEXT:    [[TMP36:%.*]] = load <2 x i64>, <2 x i64>* [[__V2_ADDR_I17_I]], align 16
// CHECK-NEXT:    [[TMP37:%.*]] = bitcast <2 x i64> [[TMP36]] to <4 x i32>
// CHECK-NEXT:    [[TMP38:%.*]] = icmp ult <4 x i32> [[TMP35]], [[TMP37]]
// CHECK-NEXT:    [[TMP39:%.*]] = select <4 x i1> [[TMP38]], <4 x i32> [[TMP35]], <4 x i32> [[TMP37]]
// CHECK-NEXT:    [[TMP40:%.*]] = bitcast <4 x i32> [[TMP39]] to <2 x i64>
// CHECK-NEXT:    store <2 x i64> [[TMP40]], <2 x i64>* [[__T8_I]], align 16
// CHECK-NEXT:    [[TMP41:%.*]] = load <2 x i64>, <2 x i64>* [[__T8_I]], align 16
...
// CHECK-NEXT:    [[TMP11:%.*]] = load <8 x float>, <8 x float>* [[__A_ADDR_I20_I]], align 32
// CHECK-NEXT:    [[TMP12:%.*]] = load <8 x float>, <8 x float>* [[__B_ADDR_I21_I]], align 32
// CHECK-NEXT:    [[TMP13:%.*]] = call <8 x float> @llvm.x86.avx.min.ps.256(<8 x float> [[TMP11]], <8 x float> [[TMP12]]) #2
// CHECK-NEXT:    store <8 x float> [[TMP13]], <8 x float>* [[__T3_I]], align 32
// CHECK-NEXT:    [[TMP14:%.*]] = load <8 x float>, <8 x float>* [[__T3_I]], align 32
// CHECK-NEXT:    [[SHUFFLE7_I:%.*]] = shufflevector <8 x float> [[TMP14]], <8 x float> zeroinitializer, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
// CHECK-NEXT:    store <4 x float> [[SHUFFLE7_I]], <4 x float>* [[TMP5_I]], align 16
...
// CHECK-NEXT:    [[TMP20:%.*]] = load <4 x float>, <4 x float>* [[__A_ADDR_I18_I]], align 16
// CHECK-NEXT:    [[TMP21:%.*]] = load <4 x float>, <4 x float>* [[__B_ADDR_I19_I]], align 16
// CHECK-NEXT:    [[TMP22:%.*]] = call <4 x float> @llvm.x86.sse.min.ps(<4 x float> [[TMP20]], <4 x float> [[TMP21]]) #2
// CHECK-NEXT:    store <4 x float> [[TMP22]], <4 x float>* [[__T6_I]], align 16
// CHECK-NEXT:    [[TMP23:%.*]] = load <4 x float>, <4 x float>* [[__T6_I]], align 16
// CHECK-NEXT:    [[TMP24:%.*]] = load <4 x float>, <4 x float>* [[__T6_I]], align 16
// CHECK-NEXT:    [[SHUFFLE12_I:%.*]] = shufflevector <4 x float> [[TMP23]], <4 x float> [[TMP24]], <4 x i32> <i32 2, i32 3, i32 0, i32 1>
...
// CHECK-NEXT:  entry:
// CHECK-NEXT:    [[__W2_ADDR_I_I:%.*]] = alloca <8 x i64>, align 64
// CHECK-NEXT:    [[__U_ADDR_I_I:%.*]] = alloca i16, align 2
// CHECK-NEXT:    [[__A_ADDR_I_I:%.*]] = alloca <8 x i64>, align 64
// CHECK-NEXT:    [[__A2_ADDR_I_I:%.*]] = alloca <4 x i64>, align 32
// CHECK-NEXT:    [[__B_ADDR_I_I:%.*]] = alloca <4 x i64>, align 32
// CHECK-NEXT:    [[__V1_ADDR_I20_I:%.*]] = alloca <2 x i64>, align 16
// CHECK-NEXT:    [[__V2_ADDR_I21_I:%.*]] = alloca <2 x i64>, align 16
// CHECK-NEXT:    [[__V1_ADDR_I18_I:%.*]] = alloca <2 x i64>, align 16
// CHECK-NEXT:    [[__V2_ADDR_I19_I:%.*]] = alloca <2 x i64>, align 16
// CHECK-NEXT:    [[__V1_ADDR_I_I:%.*]] = alloca <2 x i64>, align 16
// CHECK-NEXT:    [[__V2_ADDR_I_I:%.*]] = alloca <2 x i64>, align 16
...
// CHECK-NEXT:    [[TMP_I:%.*]] = alloca <4 x i64>, align 32
// CHECK-NEXT:    [[__T2_I:%.*]] = alloca <4 x i64>, align 32
// CHECK-NEXT:    [[TMP3_I:%.*]] = alloca <4 x i64>, align 32
// CHECK-NEXT:    [[__T3_I:%.*]] = alloca <4 x i64>, align 32
// CHECK-NEXT:    [[__T4_I:%.*]] = alloca <2 x i64>, align 16
// CHECK-NEXT:    [[TMP7_I:%.*]] = alloca <2 x i64>, align 16
// CHECK-NEXT:    [[__T5_I:%.*]] = alloca <2 x i64>, align 16
// CHECK-NEXT:    [[TMP10_I:%.*]] = alloca <2 x i64>, align 16
// CHECK-NEXT:    [[__T6_I:%.*]] = alloca <2 x i64>, align 16
// CHECK-NEXT:    [[__T7_I:%.*]] = alloca <2 x i64>, align 16
// CHECK-NEXT:    [[__T8_I:%.*]] = alloca <2 x i64>, align 16
// CHECK-NEXT:    [[__T9_I:%.*]] = alloca <2 x i64>, align 16
...
// CHECK-NEXT:    store <8 x i64> [[TMP19]], <8 x i64>* [[__W2_ADDR_I_I]], align 64
...
// CHECK-NEXT:    [[TMP25:%.*]] = load <8 x i64>, <8 x i64>* [[__W2_ADDR_I_I]], align 64
...
// CHECK-NEXT:    [[SHUFFLE_I:%.*]] = shufflevector <8 x i64> [[TMP30]], <8 x i64> zeroinitializer, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
// CHECK-NEXT:    store <4 x i64> [[SHUFFLE_I]], <4 x i64>* [[TMP_I]], align 32
// CHECK-NEXT:    [[TMP31:%.*]] = load <4 x i64>, <4 x i64>* [[TMP_I]], align 32
// CHECK-NEXT:    store <4 x i64> [[TMP31]], <4 x i64>* [[__T1_I]], align 32
// CHECK-NEXT:    [[TMP32:%.*]] = load <8 x i64>, <8 x i64>* [[__V_ADDR_I]], align 64
// CHECK-NEXT:    [[SHUFFLE5_I:%.*]] = shufflevector <8 x i64> [[TMP32]], <8 x i64> zeroinitializer, <4 x i32> <i32 4, i32 5, i32 6, i32 7>
// CHECK-NEXT:    store <4 x i64> [[SHUFFLE5_I]], <4 x i64>* [[TMP3_I]], align 32
// CHECK-NEXT:    [[TMP33:%.*]] = load <4 x i64>, <4 x i64>* [[TMP3_I]], align 32
// CHECK-NEXT:    store <4 x i64> [[TMP33]], <4 x i64>* [[__T2_I]], align 32
// CHECK-NEXT:    [[TMP34:%.*]] = load <4 x i64>, <4 x i64>* [[__T1_I]], align 32
// CHECK-NEXT:    [[TMP35:%.*]] = load <4 x i64>, <4 x i64>* [[__T2_I]], align 32
// CHECK-NEXT:    store <4 x i64> [[TMP34]], <4 x i64>* [[__A2_ADDR_I_I]], align 32
// CHECK-NEXT:    store <4 x i64> [[TMP35]], <4 x i64>* [[__B_ADDR_I_I]], align 32
// CHECK-NEXT:    [[TMP36:%.*]] = load <4 x i64>, <4 x i64>* [[__A2_ADDR_I_I]], align 32
// CHECK-NEXT:    [[TMP37:%.*]] = bitcast <4 x i64> [[TMP36]] to <8 x i32>
// CHECK-NEXT:    [[TMP38:%.*]] = load <4 x i64>, <4 x i64>* [[__B_ADDR_I_I]], align 32
// CHECK-NEXT:    [[TMP39:%.*]] = bitcast <4 x i64> [[TMP38]] to <8 x i32>
// CHECK-NEXT:    [[TMP40:%.*]] = icmp sgt <8 x i32> [[TMP37]], [[TMP39]]
// CHECK-NEXT:    [[TMP41:%.*]] = select <8 x i1> [[TMP40]], <8 x i32> [[TMP37]], <8 x i32> [[TMP39]]
// CHECK-NEXT:    [[TMP42:%.*]] = bitcast <8 x i32> [[TMP41]] to <4 x i64>
// CHECK-NEXT:    store <4 x i64> [[TMP42]], <4 x i64>* [[__T3_I]], align 32
// CHECK-NEXT:    [[TMP43:%.*]] = load <4 x i64>, <4 x i64>* [[__T3_I]], align 32
// CHECK-NEXT:    [[SHUFFLE9_I:%.*]] = shufflevector <4 x i64> [[TMP43]], <4 x i64> zeroinitializer, <2 x i32> <i32 0, i32 1>
// CHECK-NEXT:    store <2 x i64> [[SHUFFLE9_I]], <2 x i64>* [[TMP7_I]], align 16
// CHECK-NEXT:    [[TMP44:%.*]] = load <2 x i64>, <2 x i64>* [[TMP7_I]], align 16
// CHECK-NEXT:    store <2 x i64> [[TMP44]], <2 x i64>* [[__T4_I]], align 16
// CHECK-NEXT:    [[TMP45:%.*]] = load <4 x i64>, <4 x i64>* [[__T3_I]], align 32
// CHECK-NEXT:    [[SHUFFLE12_I:%.*]] = shufflevector <4 x i64> [[TMP45]], <4 x i64> zeroinitializer, <2 x i32> <i32 2, i32 3>
// CHECK-NEXT:    store <2 x i64> [[SHUFFLE12_I]], <2 x i64>* [[TMP10_I]], align 16
// CHECK-NEXT:    [[TMP46:%.*]] = load <2 x i64>, <2 x i64>* [[TMP10_I]], align 16
// CHECK-NEXT:    store <2 x i64> [[TMP46]], <2 x i64>* [[__T5_I]], align 16
// CHECK-NEXT:    [[TMP47:%.*]] = load <2 x i64>, <2 x i64>* [[__T4_I]], align 16
// CHECK-NEXT:    [[TMP48:%.*]] = load <2 x i64>, <2 x i64>* [[__T5_I]], align 16
// CHECK-NEXT:    store <2 x i64> [[TMP47]], <2 x i64>* [[__V1_ADDR_I20_I]], align 16
// CHECK-NEXT:    store <2 x i64> [[TMP48]], <2 x i64>* [[__V2_ADDR_I21_I]], align 16
// CHECK-NEXT:    [[TMP49:%.*]] = load <2 x i64>, <2 x i64>* [[__V1_ADDR_I20_I]], align 16
// CHECK-NEXT:    [[TMP50:%.*]] = bitcast <2 x i64> [[TMP49]] to <4 x i32>
// CHECK-NEXT:    [[TMP51:%.*]] = load <2 x i64>, <2 x i64>* [[__V2_ADDR_I21_I]], align 16
// CHECK-NEXT:    [[TMP52:%.*]] = bitcast <2 x i64> [[TMP51]] to <4 x i32>
// CHECK-NEXT:    [[TMP53:%.*]] = icmp sgt <4 x i32> [[TMP50]], [[TMP52]]
// CHECK-NEXT:    [[TMP54:%.*]] = select <4 x i1> [[TMP53]], <4 x i32> [[TMP50]], <4 x i32> [[TMP52]]
// CHECK-NEXT:    [[TMP55:%.*]] = bitcast <4 x i32> [[TMP54]] to <2 x i64>
// CHECK-NEXT:    store <2 x i64> [[TMP55]], <2 x i64>* [[__T6_I]], align 16
// CHECK-NEXT:    [[TMP56:%.*]] = load <2 x i64>, <2 x i64>* [[__T6_I]], align 16
// CHECK-NEXT:    [[TMP57:%.*]] = bitcast <2 x i64> [[TMP56]] to <4 x i32>
// CHECK-NEXT:    [[TMP58:%.*]] = load <2 x i64>, <2 x i64>* [[__T6_I]], align 16
// CHECK-NEXT:    [[TMP59:%.*]] = bitcast <2 x i64> [[TMP58]] to <4 x i32>
// CHECK-NEXT:    [[SHUFFLE14_I:%.*]] = shufflevector <4 x i32> [[TMP57]], <4 x i32> [[TMP59]], <4 x i32> <i32 2, i32 3, i32 0, i32 1>
// CHECK-NEXT:    [[TMP60:%.*]] = bitcast <4 x i32> [[SHUFFLE14_I]] to <2 x i64>
// CHECK-NEXT:    store <2 x i64> [[TMP60]], <2 x i64>* [[__T7_I]], align 16
// CHECK-NEXT:    [[TMP61:%.*]] = load <2 x i64>, <2 x i64>* [[__T6_I]], align 16
// CHECK-NEXT:    [[TMP62:%.*]] = load <2 x i64>, <2 x i64>* [[__T7_I]], align 16
// CHECK-NEXT:    store <2 x i64> [[TMP61]], <2 x i64>* [[__V1_ADDR_I18_I]], align 16
// CHECK-NEXT:    store <2 x i64> [[TMP62]], <2 x i64>* [[__V2_ADDR_I19_I]], align 16
// CHECK-NEXT:    [[TMP63:%.*]] = load <2 x i64>, <2 x i64>* [[__V1_ADDR_I18_I]], align 16
// CHECK-NEXT:    [[TMP64:%.*]] = bitcast <2 x i64> [[TMP63]] to <4 x i32>
// CHECK-NEXT:    [[TMP65:%.*]] = load <2 x i64>, <2 x i64>* [[__V2_ADDR_I19_I]], align 16
// CHECK-NEXT:    [[TMP66:%.*]] = bitcast <2 x i64> [[TMP65]] to <4 x i32>
// CHECK-NEXT:    [[TMP67:%.*]] = icmp sgt <4 x i32> [[TMP64]], [[TMP66]]
// CHECK-NEXT:    [[TMP68:%.*]] = select <4 x i1> [[TMP67]], <4 x i32> [[TMP64]], <4 x i32> [[TMP66]]
// CHECK-NEXT:    [[TMP69:%.*]] = bitcast <4 x i32> [[TMP68]] to <2 x i64>
// CHECK-NEXT:    store <2 x i64> [[TMP69]], <2 x i64>* [[__T8_I]], align 16
// CHECK-NEXT:    [[TMP70:%.*]] = load <2 x i64>, <2 x i64>* [[__T8_I]], align 16
// CHECK-NEXT:    [[TMP71:%.*]] = bitcast <2 x i64> [[TMP70]] to <4 x i32>
// CHECK-NEXT:    [[TMP72:%.*]] = load <2 x i64>, <2 x i64>* [[__T8_I]], align 16
// CHECK-NEXT:    [[TMP73:%.*]] = bitcast <2 x i64> [[TMP72]] to <4 x i32>
...
// CHECK-NEXT:    [[__A_ADDR_I_I:%.*]] = alloca <4 x i64>, align 32
// CHECK-NEXT:    [[__B_ADDR_I_I:%.*]] = alloca <4 x i64>, align 32
// CHECK-NEXT:    [[__V1_ADDR_I19_I:%.*]] = alloca <2 x i64>, align 16
// CHECK-NEXT:    [[__V2_ADDR_I20_I:%.*]] = alloca <2 x i64>, align 16
// CHECK-NEXT:    [[__V1_ADDR_I17_I:%.*]] = alloca <2 x i64>, align 16
// CHECK-NEXT:    [[__V2_ADDR_I18_I:%.*]] = alloca <2 x i64>, align 16
// CHECK-NEXT:    [[__V1_ADDR_I_I:%.*]] = alloca <2 x i64>, align 16
// CHECK-NEXT:    [[__V2_ADDR_I_I:%.*]] = alloca <2 x i64>, align 16
// CHECK-NEXT:    [[DOTCOMPOUNDLITERAL_I_I_I:%.*]] = alloca <8 x i64>, align 64
// CHECK-NEXT:    [[__U_ADDR_I_I:%.*]] = alloca i16, align 2
...
// CHECK-NEXT:    [[TMP_I:%.*]] = alloca <4 x i64>, align 32
// CHECK-NEXT:    [[__T2_I:%.*]] = alloca <4 x i64>, align 32
// CHECK-NEXT:    [[TMP2_I:%.*]] = alloca <4 x i64>, align 32
// CHECK-NEXT:    [[__T3_I:%.*]] = alloca <4 x i64>, align 32
// CHECK-NEXT:    [[__T4_I:%.*]] = alloca <2 x i64>, align 16
// CHECK-NEXT:    [[TMP6_I:%.*]] = alloca <2 x i64>, align 16
// CHECK-NEXT:    [[__T5_I:%.*]] = alloca <2 x i64>, align 16
// CHECK-NEXT:    [[TMP9_I:%.*]] = alloca <2 x i64>, align 16
// CHECK-NEXT:    [[__T6_I:%.*]] = alloca <2 x i64>, align 16
// CHECK-NEXT:    [[__T7_I:%.*]] = alloca <2 x i64>, align 16
// CHECK-NEXT:    [[__T8_I:%.*]] = alloca <2 x i64>, align 16
// CHECK-NEXT:    [[__T9_I:%.*]] = alloca <2 x i64>, align 16
...
// CHECK-NEXT:    store <8 x i64> [[TMP3]], <8 x i64>* [[__A2_ADDR_I_I]], align 64
// CHECK-NEXT:    [[TMP4:%.*]] = load i16, i16* [[__U_ADDR_I_I]], align 2
// CHECK-NEXT:    [[TMP5:%.*]] = load <8 x i64>, <8 x i64>* [[__A2_ADDR_I_I]], align 64
...
// CHECK-NEXT:    [[TMP12:%.*]] = load <8 x i64>, <8 x i64>* [[__V_ADDR_I]], align 64
// CHECK-NEXT:    [[SHUFFLE_I:%.*]] = shufflevector <8 x i64> [[TMP12]], <8 x i64> zeroinitializer, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
// CHECK-NEXT:    store <4 x i64> [[SHUFFLE_I]], <4 x i64>* [[TMP_I]], align 32
// CHECK-NEXT:    [[TMP13:%.*]] = load <4 x i64>, <4 x i64>* [[TMP_I]], align 32
// CHECK-NEXT:    store <4 x i64> [[TMP13]], <4 x i64>* [[__T1_I]], align 32
// CHECK-NEXT:    [[TMP14:%.*]] = load <8 x i64>, <8 x i64>* [[__V_ADDR_I]], align 64
// CHECK-NEXT:    [[SHUFFLE4_I:%.*]] = shufflevector <8 x i64> [[TMP14]], <8 x i64> zeroinitializer, <4 x i32> <i32 4, i32 5, i32 6, i32 7>
// CHECK-NEXT:    store <4 x i64> [[SHUFFLE4_I]], <4 x i64>* [[TMP2_I]], align 32
// CHECK-NEXT:    [[TMP15:%.*]] = load <4 x i64>, <4 x i64>* [[TMP2_I]], align 32
// CHECK-NEXT:    store <4 x i64> [[TMP15]], <4 x i64>* [[__T2_I]], align 32
// CHECK-NEXT:    [[TMP16:%.*]] = load <4 x i64>, <4 x i64>* [[__T1_I]], align 32
// CHECK-NEXT:    [[TMP17:%.*]] = load <4 x i64>, <4 x i64>* [[__T2_I]], align 32
// CHECK-NEXT:    store <4 x i64> [[TMP16]], <4 x i64>* [[__A_ADDR_I_I]], align 32
// CHECK-NEXT:    store <4 x i64> [[TMP17]], <4 x i64>* [[__B_ADDR_I_I]], align 32
// CHECK-NEXT:    [[TMP18:%.*]] = load <4 x i64>, <4 x i64>* [[__A_ADDR_I_I]], align 32
// CHECK-NEXT:    [[TMP19:%.*]] = bitcast <4 x i64> [[TMP18]] to <8 x i32>
// CHECK-NEXT:    [[TMP20:%.*]] = load <4 x i64>, <4 x i64>* [[__B_ADDR_I_I]], align 32
// CHECK-NEXT:    [[TMP21:%.*]] = bitcast <4 x i64> [[TMP20]] to <8 x i32>
// CHECK-NEXT:    [[TMP22:%.*]] = icmp ugt <8 x i32> [[TMP19]], [[TMP21]]
// CHECK-NEXT:    [[TMP23:%.*]] = select <8 x i1> [[TMP22]], <8 x i32> [[TMP19]], <8 x i32> [[TMP21]]
// CHECK-NEXT:    [[TMP24:%.*]] = bitcast <8 x i32> [[TMP23]] to <4 x i64>
// CHECK-NEXT:    store <4 x i64> [[TMP24]], <4 x i64>* [[__T3_I]], align 32
// CHECK-NEXT:    [[TMP25:%.*]] = load <4 x i64>, <4 x i64>* [[__T3_I]], align 32
// CHECK-NEXT:    [[SHUFFLE8_I:%.*]] = shufflevector <4 x i64> [[TMP25]], <4 x i64> zeroinitializer, <2 x i32> <i32 0, i32 1>
// CHECK-NEXT:    store <2 x i64> [[SHUFFLE8_I]], <2 x i64>* [[TMP6_I]], align 16
// CHECK-NEXT:    [[TMP26:%.*]] = load <2 x i64>, <2 x i64>* [[TMP6_I]], align 16
// CHECK-NEXT:    store <2 x i64> [[TMP26]], <2 x i64>* [[__T4_I]], align 16
// CHECK-NEXT:    [[TMP27:%.*]] = load <4 x i64>, <4 x i64>* [[__T3_I]], align 32
// CHECK-NEXT:    [[SHUFFLE11_I:%.*]] = shufflevector <4 x i64> [[TMP27]], <4 x i64> zeroinitializer, <2 x i32> <i32 2, i32 3>
// CHECK-NEXT:    store <2 x i64> [[SHUFFLE11_I]], <2 x i64>* [[TMP9_I]], align 16
// CHECK-NEXT:    [[TMP28:%.*]] = load <2 x i64>, <2 x i64>* [[TMP9_I]], align 16
// CHECK-NEXT:    store <2 x i64> [[TMP28]], <2 x i64>* [[__T5_I]], align 16
// CHECK-NEXT:    [[TMP29:%.*]] = load <2 x i64>, <2 x i64>* [[__T4_I]], align 16
// CHECK-NEXT:    [[TMP30:%.*]] = load <2 x i64>, <2 x i64>* [[__T5_I]], align 16
// CHECK-NEXT:    store <2 x i64> [[TMP29]], <2 x i64>* [[__V1_ADDR_I19_I]], align 16
// CHECK-NEXT:    store <2 x i64> [[TMP30]], <2 x i64>* [[__V2_ADDR_I20_I]], align 16
// CHECK-NEXT:    [[TMP31:%.*]] = load <2 x i64>, <2 x i64>* [[__V1_ADDR_I19_I]], align 16
// CHECK-NEXT:    [[TMP32:%.*]] = bitcast <2 x i64> [[TMP31]] to <4 x i32>
// CHECK-NEXT:    [[TMP33:%.*]] = load <2 x i64>, <2 x i64>* [[__V2_ADDR_I20_I]], align 16
// CHECK-NEXT:    [[TMP34:%.*]] = bitcast <2 x i64> [[TMP33]] to <4 x i32>
// CHECK-NEXT:    [[TMP35:%.*]] = icmp ugt <4 x i32> [[TMP32]], [[TMP34]]
// CHECK-NEXT:    [[TMP36:%.*]] = select <4 x i1> [[TMP35]], <4 x i32> [[TMP32]], <4 x i32> [[TMP34]]
// CHECK-NEXT:    [[TMP37:%.*]] = bitcast <4 x i32> [[TMP36]] to <2 x i64>
// CHECK-NEXT:    store <2 x i64> [[TMP37]], <2 x i64>* [[__T6_I]], align 16
// CHECK-NEXT:    [[TMP38:%.*]] = load <2 x i64>, <2 x i64>* [[__T6_I]], align 16
// CHECK-NEXT:    [[TMP39:%.*]] = bitcast <2 x i64> [[TMP38]] to <4 x i32>
// CHECK-NEXT:    [[TMP40:%.*]] = load <2 x i64>, <2 x i64>* [[__T6_I]], align 16
// CHECK-NEXT:    [[TMP41:%.*]] = bitcast <2 x i64> [[TMP40]] to <4 x i32>
// CHECK-NEXT:    [[SHUFFLE13_I:%.*]] = shufflevector <4 x i32> [[TMP39]], <4 x i32> [[TMP41]], <4 x i32> <i32 2, i32 3, i32 0, i32 1>
// CHECK-NEXT:    [[TMP42:%.*]] = bitcast <4 x i32> [[SHUFFLE13_I]] to <2 x i64>
// CHECK-NEXT:    store <2 x i64> [[TMP42]], <2 x i64>* [[__T7_I]], align 16
// CHECK-NEXT:    [[TMP43:%.*]] = load <2 x i64>, <2 x i64>* [[__T6_I]], align 16
// CHECK-NEXT:    [[TMP44:%.*]] = load <2 x i64>, <2 x i64>* [[__T7_I]], align 16
// CHECK-NEXT:    store <2 x i64> [[TMP43]], <2 x i64>* [[__V1_ADDR_I17_I]], align 16
// CHECK-NEXT:    store <2 x i64> [[TMP44]], <2 x i64>* [[__V2_ADDR_I18_I]], align 16
// CHECK-NEXT:    [[TMP45:%.*]] = load <2 x i64>, <2 x i64>* [[__V1_ADDR_I17_I]], align 16
// CHECK-NEXT:    [[TMP46:%.*]] = bitcast <2 x i64> [[TMP45]] to <4 x i32>
// CHECK-NEXT:    [[TMP47:%.*]] = load <2 x i64>, <2 x i64>* [[__V2_ADDR_I18_I]], align 16
// CHECK-NEXT:    [[TMP48:%.*]] = bitcast <2 x i64> [[TMP47]] to <4 x i32>
// CHECK-NEXT:    [[TMP49:%.*]] = icmp ugt <4 x i32> [[TMP46]], [[TMP48]]
// CHECK-NEXT:    [[TMP50:%.*]] = select <4 x i1> [[TMP49]], <4 x i32> [[TMP46]], <4 x i32> [[TMP48]]
// CHECK-NEXT:    [[TMP51:%.*]] = bitcast <4 x i32> [[TMP50]] to <2 x i64>
// CHECK-NEXT:    store <2 x i64> [[TMP51]], <2 x i64>* [[__T8_I]], align 16
// CHECK-NEXT:    [[TMP52:%.*]] = load <2 x i64>, <2 x i64>* [[__T8_I]], align 16
// CHECK-NEXT:    [[TMP53:%.*]] = bitcast <2 x i64> [[TMP52]] to <4 x i32>
// CHECK-NEXT:    [[TMP54:%.*]] = load <2 x i64>, <2 x i64>* [[__T8_I]], align 16
// CHECK-NEXT:    [[TMP55:%.*]] = bitcast <2 x i64> [[TMP54]] to <4 x i32>
// CHECK-NEXT:    [[SHUFFLE15_I:%.*]] = shufflevector <4 x i32> [[TMP53]], <4 x i32> [[TMP55]], <4 x i32> <i32 1, i32 0, i32 3, i32 2>
// CHECK-NEXT:    [[TMP56:%.*]] = bitcast <4 x i32> [[SHUFFLE15_I]] to <2 x i64>
// CHECK-NEXT:    store <2 x i64> [[TMP56]], <2 x i64>* [[__T9_I]], align 16
// CHECK-NEXT:    [[TMP57:%.*]] = load <2 x i64>, <2 x i64>* [[__T8_I]], align 16
// CHECK-NEXT:    [[TMP58:%.*]] = load <2 x i64>, <2 x i64>* [[__T9_I]], align 16
// CHECK-NEXT:    store <2 x i64> [[TMP57]], <2 x i64>* [[__V1_ADDR_I_I]], align 16
// CHECK-NEXT:    store <2 x i64> [[TMP58]], <2 x i64>* [[__V2_ADDR_I_I]], align 16
// CHECK-NEXT:    [[TMP59:%.*]] = load <2 x i64>, <2 x i64>* [[__V1_ADDR_I_I]], align 16
// CHECK-NEXT:    [[TMP60:%.*]] = bitcast <2 x i64> [[TMP59]] to <4 x i32>
// CHECK-NEXT:    [[TMP61:%.*]] = load <2 x i64>, <2 x i64>* [[__V2_ADDR_I_I]], align 16
// CHECK-NEXT:    [[TMP62:%.*]] = bitcast <2 x i64> [[TMP61]] to <4 x i32>
// CHECK-NEXT:    [[TMP63:%.*]] = icmp ugt <4 x i32> [[TMP60]], [[TMP62]]
// CHECK-NEXT:    [[TMP64:%.*]] = select <4 x i1> [[TMP63]], <4 x i32> [[TMP60]], <4 x i32> [[TMP62]]
// CHECK-NEXT:    [[TMP65:%.*]] = bitcast <4 x i32> [[TMP64]] to <2 x i64>
// CHECK-NEXT:    store <4 x i32> [[TMP64]], <4 x i32>* [[__T10_I]], align 16
// CHECK-NEXT:    [[TMP66:%.*]] = load <4 x i32>, <4 x i32>* [[__T10_I]], align 16
// CHECK-NEXT:    [[VECEXT_I:%.*]] = extractelement <4 x i32> [[TMP66]], i32 0
// CHECK-NEXT:    ret i32 [[VECEXT_I]]
...
// CHECK-NEXT:    [[__A_ADDR_I22_I:%.*]] = alloca <8 x float>, align 32
// CHECK-NEXT:    [[__B_ADDR_I23_I:%.*]] = alloca <8 x float>, align 32
// CHECK-NEXT:    [[__A_ADDR_I20_I:%.*]] = alloca <4 x float>, align 16
// CHECK-NEXT:    [[__B_ADDR_I21_I:%.*]] = alloca <4 x float>, align 16
// CHECK-NEXT:    [[__A_ADDR_I18_I:%.*]] = alloca <4 x float>, align 16
// CHECK-NEXT:    [[__B_ADDR_I19_I:%.*]] = alloca <4 x float>, align 16
...
// CHECK-NEXT:    [[__T3_I:%.*]] = alloca <8 x float>, align 32
// CHECK-NEXT:    [[__T4_I:%.*]] = alloca <4 x float>, align 16
// CHECK-NEXT:    [[TMP7_I:%.*]] = alloca <4 x float>, align 16
// CHECK-NEXT:    [[__T5_I:%.*]] = alloca <4 x float>, align 16
// CHECK-NEXT:    [[TMP10_I:%.*]] = alloca <4 x float>, align 16
// CHECK-NEXT:    [[__T6_I:%.*]] = alloca <4 x float>, align 16
// CHECK-NEXT:    [[__T7_I:%.*]] = alloca <4 x float>, align 16
// CHECK-NEXT:    [[__T8_I:%.*]] = alloca <4 x float>, align 16
// CHECK-NEXT:    [[__T9_I:%.*]] = alloca <4 x float>, align 16
...
// CHECK-NEXT:    [[SHUFFLE_I:%.*]] = shufflevector <8 x double> [[TMP27]], <8 x double> zeroinitializer, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
// CHECK-NEXT:    store <4 x double> [[SHUFFLE_I]], <4 x double>* [[TMP_I]], align 32
// CHECK-NEXT:    [[TMP28:%.*]] = load <4 x double>, <4 x double>* [[TMP_I]], align 32
// CHECK-NEXT:    [[TMP29:%.*]] = bitcast <4 x double> [[TMP28]] to <8 x float>
// CHECK-NEXT:    store <8 x float> [[TMP29]], <8 x float>* [[__T1_I]], align 32
// CHECK-NEXT:    [[TMP30:%.*]] = load <16 x float>, <16 x float>* [[__V_ADDR_I]], align 64
// CHECK-NEXT:    [[TMP31:%.*]] = bitcast <16 x float> [[TMP30]] to <8 x double>
// CHECK-NEXT:    [[SHUFFLE5_I:%.*]] = shufflevector <8 x double> [[TMP31]], <8 x double> zeroinitializer, <4 x i32> <i32 4, i32 5, i32 6, i32 7>
// CHECK-NEXT:    store <4 x double> [[SHUFFLE5_I]], <4 x double>* [[TMP3_I]], align 32
// CHECK-NEXT:    [[TMP32:%.*]] = load <4 x double>, <4 x double>* [[TMP3_I]], align 32
// CHECK-NEXT:    [[TMP33:%.*]] = bitcast <4 x double> [[TMP32]] to <8 x float>
// CHECK-NEXT:    store <8 x float> [[TMP33]], <8 x float>* [[__T2_I]], align 32
// CHECK-NEXT:    [[TMP34:%.*]] = load <8 x float>, <8 x float>* [[__T1_I]], align 32
// CHECK-NEXT:    [[TMP35:%.*]] = load <8 x float>, <8 x float>* [[__T2_I]], align 32
// CHECK-NEXT:    store <8 x float> [[TMP34]], <8 x float>* [[__A_ADDR_I22_I]], align 32
// CHECK-NEXT:    store <8 x float> [[TMP35]], <8 x float>* [[__B_ADDR_I23_I]], align 32
// CHECK-NEXT:    [[TMP36:%.*]] = load <8 x float>, <8 x float>* [[__A_ADDR_I22_I]], align 32
// CHECK-NEXT:    [[TMP37:%.*]] = load <8 x float>, <8 x float>* [[__B_ADDR_I23_I]], align 32
// CHECK-NEXT:    [[TMP38:%.*]] = call <8 x float> @llvm.x86.avx.max.ps.256(<8 x float> [[TMP36]], <8 x float> [[TMP37]]) #2
// CHECK-NEXT:    store <8 x float> [[TMP38]], <8 x float>* [[__T3_I]], align 32
// CHECK-NEXT:    [[TMP39:%.*]] = load <8 x float>, <8 x float>* [[__T3_I]], align 32
// CHECK-NEXT:    [[SHUFFLE9_I:%.*]] = shufflevector <8 x float> [[TMP39]], <8 x float> zeroinitializer, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
// CHECK-NEXT:    store <4 x float> [[SHUFFLE9_I]], <4 x float>* [[TMP7_I]], align 16
// CHECK-NEXT:    [[TMP40:%.*]] = load <4 x float>, <4 x float>* [[TMP7_I]], align 16
// CHECK-NEXT:    store <4 x float> [[TMP40]], <4 x float>* [[__T4_I]], align 16
// CHECK-NEXT:    [[TMP41:%.*]] = load <8 x float>, <8 x float>* [[__T3_I]], align 32
// CHECK-NEXT:    [[SHUFFLE12_I:%.*]] = shufflevector <8 x float> [[TMP41]], <8 x float> zeroinitializer, <4 x i32> <i32 4, i32 5, i32 6, i32 7>
// CHECK-NEXT:    store <4 x float> [[SHUFFLE12_I]], <4 x float>* [[TMP10_I]], align 16
// CHECK-NEXT:    [[TMP42:%.*]] = load <4 x float>, <4 x float>* [[TMP10_I]], align 16
// CHECK-NEXT:    store <4 x float> [[TMP42]], <4 x float>* [[__T5_I]], align 16
// CHECK-NEXT:    [[TMP43:%.*]] = load <4 x float>, <4 x float>* [[__T4_I]], align 16
// CHECK-NEXT:    [[TMP44:%.*]] = load <4 x float>, <4 x float>* [[__T5_I]], align 16
// CHECK-NEXT:    store <4 x float> [[TMP43]], <4 x float>* [[__A_ADDR_I20_I]], align 16
// CHECK-NEXT:    store <4 x float> [[TMP44]], <4 x float>* [[__B_ADDR_I21_I]], align 16
// CHECK-NEXT:    [[TMP45:%.*]] = load <4 x float>, <4 x float>* [[__A_ADDR_I20_I]], align 16
// CHECK-NEXT:    [[TMP46:%.*]] = load <4 x float>, <4 x float>* [[__B_ADDR_I21_I]], align 16
// CHECK-NEXT:    [[TMP47:%.*]] = call <4 x float> @llvm.x86.sse.max.ps(<4 x float> [[TMP45]], <4 x float> [[TMP46]]) #2
...
// CHECK-NEXT:    [[TMP38:%.*]] = load <4 x i64>, <4 x i64>* [[__B_ADDR_I_I]], align 32
// CHECK-NEXT:    [[TMP39:%.*]] = bitcast <4 x i64> [[TMP38]] to <8 x i32>
// CHECK-NEXT:    [[TMP40:%.*]] = icmp slt <8 x i32> [[TMP37]], [[TMP39]]
// CHECK-NEXT:    [[TMP41:%.*]] = select <8 x i1> [[TMP40]], <8 x i32> [[TMP37]], <8 x i32> [[TMP39]]
// CHECK-NEXT:    [[TMP42:%.*]] = bitcast <8 x i32> [[TMP41]] to <4 x i64>
// CHECK-NEXT:    store <4 x i64> [[TMP42]], <4 x i64>* [[__T3_I]], align 32
// CHECK-NEXT:    [[TMP43:%.*]] = load <4 x i64>, <4 x i64>* [[__T3_I]], align 32
...
// CHECK-NEXT:    [[TMP51:%.*]] = load <2 x i64>, <2 x i64>* [[__V2_ADDR_I21_I]], align 16
// CHECK-NEXT:    [[TMP52:%.*]] = bitcast <2 x i64> [[TMP51]] to <4 x i32>
// CHECK-NEXT:    [[TMP53:%.*]] = icmp slt <4 x i32> [[TMP50]], [[TMP52]]
// CHECK-NEXT:    [[TMP54:%.*]] = select <4 x i1> [[TMP53]], <4 x i32> [[TMP50]], <4 x i32> [[TMP52]]
// CHECK-NEXT:    [[TMP55:%.*]] = bitcast <4 x i32> [[TMP54]] to <2 x i64>
// CHECK-NEXT:    store <2 x i64> [[TMP55]], <2 x i64>* [[__T6_I]], align 16
// CHECK-NEXT:    [[TMP56:%.*]] = load <2 x i64>, <2 x i64>* [[__T6_I]], align 16
...
// CHECK-NEXT:    [[TMP65:%.*]] = load <2 x i64>, <2 x i64>* [[__V2_ADDR_I19_I]], align 16
// CHECK-NEXT:    [[TMP66:%.*]] = bitcast <2 x i64> [[TMP65]] to <4 x i32>
// CHECK-NEXT:    [[TMP67:%.*]] = icmp slt <4 x i32> [[TMP64]], [[TMP66]]
// CHECK-NEXT:    [[TMP68:%.*]] = select <4 x i1> [[TMP67]], <4 x i32> [[TMP64]], <4 x i32> [[TMP66]]
// CHECK-NEXT:    [[TMP69:%.*]] = bitcast <4 x i32> [[TMP68]] to <2 x i64>
// CHECK-NEXT:    store <2 x i64> [[TMP69]], <2 x i64>* [[__T8_I]], align 16
// CHECK-NEXT:    [[TMP70:%.*]] = load <2 x i64>, <2 x i64>* [[__T8_I]], align 16
...
// CHECK-NEXT:    [[TMP38:%.*]] = load <4 x i64>, <4 x i64>* [[__B_ADDR_I_I]], align 32
// CHECK-NEXT:    [[TMP39:%.*]] = bitcast <4 x i64> [[TMP38]] to <8 x i32>
// CHECK-NEXT:    [[TMP40:%.*]] = icmp ult <8 x i32> [[TMP37]], [[TMP39]]
// CHECK-NEXT:    [[TMP41:%.*]] = select <8 x i1> [[TMP40]], <8 x i32> [[TMP37]], <8 x i32> [[TMP39]]
// CHECK-NEXT:    [[TMP42:%.*]] = bitcast <8 x i32> [[TMP41]] to <4 x i64>
// CHECK-NEXT:    store <4 x i64> [[TMP42]], <4 x i64>* [[__T3_I]], align 32
// CHECK-NEXT:    [[TMP43:%.*]] = load <4 x i64>, <4 x i64>* [[__T3_I]], align 32
...
// CHECK-NEXT:    [[TMP51:%.*]] = load <2 x i64>, <2 x i64>* [[__V2_ADDR_I21_I]], align 16
// CHECK-NEXT:    [[TMP52:%.*]] = bitcast <2 x i64> [[TMP51]] to <4 x i32>
// CHECK-NEXT:    [[TMP53:%.*]] = icmp ult <4 x i32> [[TMP50]], [[TMP52]]
// CHECK-NEXT:    [[TMP54:%.*]] = select <4 x i1> [[TMP53]], <4 x i32> [[TMP50]], <4 x i32> [[TMP52]]
// CHECK-NEXT:    [[TMP55:%.*]] = bitcast <4 x i32> [[TMP54]] to <2 x i64>
// CHECK-NEXT:    store <2 x i64> [[TMP55]], <2 x i64>* [[__T6_I]], align 16
// CHECK-NEXT:    [[TMP56:%.*]] = load <2 x i64>, <2 x i64>* [[__T6_I]], align 16
...
// CHECK-NEXT:    [[TMP65:%.*]] = load <2 x i64>, <2 x i64>* [[__V2_ADDR_I19_I]], align 16
// CHECK-NEXT:    [[TMP66:%.*]] = bitcast <2 x i64> [[TMP65]] to <4 x i32>
// CHECK-NEXT:    [[TMP67:%.*]] = icmp ult <4 x i32> [[TMP64]], [[TMP66]]
// CHECK-NEXT:    [[TMP68:%.*]] = select <4 x i1> [[TMP67]], <4 x i32> [[TMP64]], <4 x i32> [[TMP66]]
// CHECK-NEXT:    [[TMP69:%.*]] = bitcast <4 x i32> [[TMP68]] to <2 x i64>
// CHECK-NEXT:    store <2 x i64> [[TMP69]], <2 x i64>* [[__T8_I]], align 16
// CHECK-NEXT:    [[TMP70:%.*]] = load <2 x i64>, <2 x i64>* [[__T8_I]], align 16
...
// CHECK-NEXT:    [[TMP36:%.*]] = load <8 x float>, <8 x float>* [[__A_ADDR_I22_I]], align 32
// CHECK-NEXT:    [[TMP37:%.*]] = load <8 x float>, <8 x float>* [[__B_ADDR_I23_I]], align 32
// CHECK-NEXT:    [[TMP38:%.*]] = call <8 x float> @llvm.x86.avx.min.ps.256(<8 x float> [[TMP36]], <8 x float> [[TMP37]]) #2
// CHECK-NEXT:    store <8 x float> [[TMP38]], <8 x float>* [[__T3_I]], align 32
// CHECK-NEXT:    [[TMP39:%.*]] = load <8 x float>, <8 x float>* [[__T3_I]], align 32
// CHECK-NEXT:    [[SHUFFLE9_I:%.*]] = shufflevector <8 x float> [[TMP39]], <8 x float> zeroinitializer, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
// CHECK-NEXT:    store <4 x float> [[SHUFFLE9_I]], <4 x float>* [[TMP7_I]], align 16
...
// CHECK-NEXT:    [[TMP45:%.*]] = load <4 x float>, <4 x float>* [[__A_ADDR_I20_I]], align 16
// CHECK-NEXT:    [[TMP46:%.*]] = load <4 x float>, <4 x float>* [[__B_ADDR_I21_I]], align 16
// CHECK-NEXT:    [[TMP47:%.*]] = call <4 x float> @llvm.x86.sse.min.ps(<4 x float> [[TMP45]], <4 x float> [[TMP46]]) #2
// CHECK-NEXT:    store <4 x float> [[TMP47]], <4 x float>* [[__T6_I]], align 16
// CHECK-NEXT:    [[TMP48:%.*]] = load <4 x float>, <4 x float>* [[__T6_I]], align 16
// CHECK-NEXT:    [[TMP49:%.*]] = load <4 x float>, <4 x float>* [[__T6_I]], align 16
// CHECK-NEXT:    [[SHUFFLE14_I:%.*]] = shufflevector <4 x float> [[TMP48]], <4 x float> [[TMP49]], <4 x i32> <i32 2, i32 3, i32 0, i32 1>
