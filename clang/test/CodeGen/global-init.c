...
int a;
int a = 242;
// CHECK: @a = dso_local global i32 242
...
// PR6766
// CHECK: @l = dso_local global %struct.K { [6 x i32] [i32 102, i32 111, i32 111, i32 0, i32 0, i32 0], i32 1 }
...
// CHECK: @yuv_types = dso_local global [4 x [6 x i8]] {{\[}}[6 x i8] c"4:0:0\00", [6 x i8] c"4:2:0\00", [6 x i8] c"4:2:2\00", [6 x i8] c"4:4:4\00"]
...
// rdar://7119244
// CHECK: @b = dso_local global i32 0, section "foo"
