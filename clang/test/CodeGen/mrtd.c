...
// CHECK: define dso_local x86_stdcallcc void @foo(i32 %arg) [[NUW:#[0-9]+]]
void foo(int arg) {
...
void qux(int arg, ...) { }
// CHECK: define dso_local void @qux(i32 %arg, ...)

void quux(int a1, int a2, int a3) {
  qux(a1, a2, a3);
}
// CHECK-LABEL: define dso_local x86_stdcallcc void @quux
