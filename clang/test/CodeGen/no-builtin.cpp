...
// CHECK-LABEL: define linkonce_odr dso_local i32 @_ZNK1A3fooEv(%struct.A* %this) unnamed_addr #0 comdat align 2
// CHECK-LABEL: define linkonce_odr dso_local i32 @_ZNK1B3fooEv(%struct.B* %this) unnamed_addr #5 comdat align 2
