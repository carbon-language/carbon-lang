...
// CHECK-DAG: @foo = common dso_local addrspace(1) global i32 0
int foo;

// CHECK-DAG: @ban = common dso_local addrspace(1) global [10 x i32] zeroinitializer
int ban[10];

// CHECK-DAG: @A = common dso_local addrspace(1) global i32* null
// CHECK-DAG: @B = common dso_local addrspace(1) global i32* null
int *A;
int *B;

// COM-LABEL: define dso_local i32 @test1()
// CHECK: load i32, i32* addrspacecast{{[^@]+}} @foo
int test1() { return foo; }

// COM-LABEL: define dso_local i32 @test2(i32 %i)
// COM: %[[addr:.*]] = getelementptr
// CHECK: load i32, i32* %[[addr]]
// CHECK-NEXT: ret i32
int test2(int i) { return ban[i]; }

// COM-LABEL: define dso_local void @test3()
...
// CHECK-LABEL: define dso_local void @test4(i32* %a)
