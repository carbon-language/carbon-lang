...
// CLANG10ABI128: define dso_local <2 x i64> @test_v16u128(<2 x i64> %{{.*}}, <2 x i64> %{{.*}})
// CLANG9ABI128: define {{(dso_local )?}}<2 x i64> @test_v16u128(<2 x i64> %{{.*}}, <1 x i128> %{{.*}})
  return a + (v16u64)b;
}
...
// MEM256ALIGN32: define dso_local <4 x i64> @test_v32u128(<4 x i64>* byval(<4 x i64>) align 32 %{{.*}}, <2 x i128>* byval(<2 x i128>) align 32 %{{.*}})
// CLANG10ABI256: define dso_local <4 x i64> @test_v32u128(<4 x i64> %{{.*}}, <2 x i128>* byval(<2 x i128>) align 32 %{{.*}})
// CLANG9ABI256: define {{(dso_local )?}}<4 x i64> @test_v32u128(<4 x i64> %{{.*}}, <2 x i128> %{{.*}})
  return a + (v32u64)b;
}
...
// MEM512ALIGN64: define dso_local <8 x i64> @test_v64u128(<8 x i64>* byval(<8 x i64>) align 64 %{{.*}}, <4 x i128>* byval(<4 x i128>) align 64 %{{.*}})
// CLANG10ABI512: define dso_local <8 x i64> @test_v64u128(<8 x i64> %{{.*}}, <4 x i128>* byval(<4 x i128>) align 64 %{{.*}})
// CLANG9ABI512: define {{(dso_local )?}}<8 x i64> @test_v64u128(<8 x i64> %{{.*}}, <4 x i128> %{{.*}})
  return a + (v64u64)b;
}
