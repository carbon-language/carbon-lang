...
// SVR4-CHECK: va_list_size = dso_local global i32 12, align 4
int long_double_size = sizeof(long double);
// SVR4-CHECK: long_double_size = dso_local global i32 8, align 4
int double_size = sizeof(double);
// SVR4-CHECK: double_size = dso_local global i32 8, align 4
