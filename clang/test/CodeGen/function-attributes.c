...
// CHECK: define dso_local signext i8 @f0(i32 %x) [[NUW:#[0-9]+]]
// CHECK: define dso_local zeroext i8 @f1(i32 %x) [[NUW]]
// CHECK: define dso_local void @f2(i8 signext %x) [[NUW]]
// CHECK: define dso_local void @f3(i8 zeroext %x) [[NUW]]
// CHECK: define dso_local signext i16 @f4(i32 %x) [[NUW]]
// CHECK: define dso_local zeroext i16 @f5(i32 %x) [[NUW]]
// CHECK: define dso_local void @f6(i16 signext %x) [[NUW]]
// CHECK: define dso_local void @f7(i16 zeroext %x) [[NUW]]
...
// CHECK: define dso_local void @f13() [[NUW_OS_RN:#[0-9]+]]
