...
// N64-LABEL: define dso_local void @foo1(i32 signext %a0, i64 %0, double inreg %a1.coerce0, i64 inreg %a1.coerce1, i64 inreg %a1.coerce2, i64 inreg %a1.coerce3, double inreg %a2.coerce0, i64 inreg %a2.coerce1, i64 inreg %a2.coerce2, i64 inreg %a2.coerce3, i32 signext %b, i64 %1, double inreg %a3.coerce0, i64 inreg %a3.coerce1, i64 inreg %a3.coerce2, i64 inreg %a3.coerce3)
...
//
// N64-LABEL: define dso_local void @foo3(i32 signext %a0, i64 %0, fp128 %a1)
...
//
// N64-LABEL: define dso_local void @foo5(%struct.S0* noalias sret %agg.result, i64 %0, fp128 %a0)
...
//
// O32-LABEL: define dso_local void @foo7(float %a0, double %a1)
...
// O32-LABEL: define dso_local void @foo9()
