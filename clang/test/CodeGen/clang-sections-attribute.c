...
// CHECK: @ext_const = dso_local constant i32 1, section ".ext_const_attr", align 4{{$}}
// CHECK: @int_const = internal constant i32 1, section ".int_const_attr", align 4{{$}}
// CHECK: @ext_var = dso_local global i32 1, section ".ext_var_attr", align 4{{$}}
// CHECK: @int_var = internal global i32 1, section ".int_var_attr", align 4{{$}}
// CHECK: @ext_zvar = dso_local global i32 0, section ".ext_zvar_attr", align 4{{$}}
// CHECK: @int_zvar = internal global i32 0, section ".int_zvar_attr", align 4{{$}}
// CHECK: define dso_local void @ext_fun() #0 section ".ext_fun_attr"
// CHECK: define dso_local void @ext_fun2() #0 section ".ext_fun2_attr"
