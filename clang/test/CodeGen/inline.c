...
// CHECK1-LABEL: define dso_local i32 @foo()
// CHECK1-LABEL: define dso_local i32 @bar()
// CHECK1-LABEL: define dso_local void @unreferenced1()
// CHECK1-NOT: unreferenced2
// CHECK1-LABEL: define dso_local void @gnu_inline()
// CHECK1-LABEL: define dso_local i32 @test1
// CHECK1-LABEL: define dso_local i32 @test2
// CHECK1-LABEL: define dso_local void @test3()
// CHECK1-LABEL: define available_externally i32 @test4
// CHECK1-LABEL: define available_externally i32 @test5
// CHECK1-LABEL: define dso_local i32 @test6
// CHECK1-LABEL: define dso_local void @test7
// CHECK1: define dso_local i{{..}} @strlcpy
// CHECK1-NOT: test9
// CHECK1-LABEL: define dso_local void @testA
// CHECK1-LABEL: define dso_local void @testB
// CHECK1-LABEL: define dso_local void @testC
...
// CHECK2-LABEL: define dso_local i32 @ei()
// CHECK2-LABEL: define dso_local i32 @bar()
// CHECK2-NOT: unreferenced1
// CHECK2-LABEL: define dso_local void @unreferenced2()
// CHECK2-LABEL: define dso_local void @gnu_inline()
// CHECK2-LABEL: define dso_local i32 @test1
// CHECK2-LABEL: define dso_local i32 @test2
// CHECK2-LABEL: define dso_local void @test3
// CHECK2-LABEL: define available_externally i32 @test4
// CHECK2-LABEL: define available_externally i32 @test5
// CHECK2-LABEL: define dso_local i32 @test6
// CHECK2-LABEL: define dso_local void @test7
// CHECK2: define available_externally i{{..}} @strlcpy
// CHECK2-LABEL: define dso_local void @test9
// CHECK2-LABEL: define dso_local void @testA
// CHECK2-LABEL: define dso_local void @testB
// CHECK2-LABEL: define dso_local void @testC
...
// CHECK3-LABEL: define dso_local i32 @_Z3barv()
// CHECK3-LABEL: define linkonce_odr dso_local i32 @_Z3foov()
...
// CHECK3-LABEL: define linkonce_odr dso_local i32 @_Z2eiv()
