...
void test_I() {
// CHECK-LABEL: define dso_local void @test_I()
...
void test_J() {
// CHECK-LABEL: define dso_local void @test_J()
// CHECK: call void asm sideeffect "", "J"(i32 0)
  asm volatile ("" :: "J"(0));
}

void test_K() {
// CHECK-LABEL: define dso_local void @test_K()
...
double d;
void test_f() {
// CHECK-LABEL: define dso_local void @test_f()
...
void test_A(int *p) {
// CHECK-LABEL: define dso_local void @test_A(i32* %p)
