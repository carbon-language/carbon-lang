...
// CHECK:       define dso_local [[INT:i.*]] @test0() [[TF:#[0-9]+]] {
// CHECK-NOEXC: define dso_local [[INT:i.*]] @test0() [[NUW:#[0-9]+]] {
int test0(void) {
  return opaque();
}

// <rdar://problem/8087431>: locally infer nounwind at -O0
// CHECK:       define dso_local [[INT:i.*]] @test1() [[NUW:#[0-9]+]] {
// CHECK-NOEXC: define dso_local [[INT:i.*]] @test1() [[NUW]] {
int test1(void) {
  return 0;
}

// <rdar://problem/8283071>: not for weak functions
// CHECK:       define weak dso_local [[INT:i.*]] @test2() [[TF]] {
// CHECK-NOEXC: define weak dso_local [[INT:i.*]] @test2() [[NUW]] {
