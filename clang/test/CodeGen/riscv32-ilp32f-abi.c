...
// CHECK: define dso_local void @f_fpr_tracking(double %a, double %b, double %c, double %d, i8 %e)
...
// CHECK: define dso_local void @f_double_s_arg(i64 %a.coerce)
void f_double_s_arg(struct double_s a) {}

// CHECK: define dso_local i64 @f_ret_double_s()
...
// CHECK: define dso_local void @f_double_double_s_arg(%struct.double_double_s* %a)
void f_double_double_s_arg(struct double_double_s a) {}

// CHECK: define dso_local void @f_ret_double_double_s(%struct.double_double_s* noalias sret %agg.result)
...
// CHECK: define dso_local void @f_int_double_s_arg(%struct.int_double_s* %a)
void f_int_double_s_arg(struct int_double_s a) {}

// CHECK: define dso_local void @f_ret_int_double_s(%struct.int_double_s* noalias sret %agg.result)
