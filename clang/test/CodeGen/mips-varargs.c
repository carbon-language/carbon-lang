...
// O32-LABEL: define dso_local i32 @test_i32(i8*{{.*}} %fmt, ...)
// N32-LABEL: define dso_local signext i32 @test_i32(i8*{{.*}} %fmt, ...)
// N64-LABEL: define dso_local signext i32 @test_i32(i8*{{.*}} %fmt, ...)
//
...
// ALL-LABEL: define dso_local i64 @test_i64(i8*{{.*}} %fmt, ...)
//
...
// ALL-LABEL: define dso_local i8* @test_ptr(i8*{{.*}} %fmt, ...)
//
// ALL:   %va = alloca i8*, align [[$PTRALIGN]]
...
// O32-LABEL: define dso_local i32 @test_v4i32(i8*{{.*}} %fmt, ...)
// N32-LABEL: define dso_local signext i32 @test_v4i32(i8*{{.*}} %fmt, ...)
// N64-LABEL: define dso_local signext i32 @test_v4i32(i8*{{.*}} %fmt, ...)
//
// ALL:   %va = alloca i8*, align [[$PTRALIGN]]
