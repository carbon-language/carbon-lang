...
// rdar://8403108
// CHECK-LABEL: define dso_local void @f_8403108
...
// CHECK-LABEL: define dso_local double @test_PR8567
...
// CHECK: define dso_local void @test8(i32* dereferenceable(12) %a)

void test9(int n, int a[static n]) { }
// NULL-INVALID: define dso_local void @test9(i32 %n, i32* nonnull %a)
// NULL-VALID: define dso_local void @test9(i32 %n, i32* %a)
