...
// CHECK:   10: A([B9.9]) (CXXFunctionalCastExpr, ConstructorConversion, class A)
// CHECK:   11: [B9.10] (ImplicitCastExpr, NoOp, const class A)
// CHECK:   12: [B9.11]
...
// CHECK:   10: A([B6.9]) (CXXFunctionalCastExpr, ConstructorConversion, class A)
// CHECK:   11: [B6.10] (ImplicitCastExpr, NoOp, const class A)
// CHECK:   12: [B6.11]
...
// CHECK:   10: A([B12.9]) (CXXFunctionalCastExpr, ConstructorConversion, class A)
// CHECK:   11: [B12.10] (ImplicitCastExpr, NoOp, const class A)
// CHECK:   12: [B12.11]
