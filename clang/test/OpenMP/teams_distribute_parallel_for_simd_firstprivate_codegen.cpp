...
// CHECK9-NEXT:    [[TMP19:%.*]] = load i32, i32* [[G]], align 4
// CHECK9-NEXT:    store i32 [[TMP19]], i32* [[TMP18]], align 4
// CHECK9-NEXT:    [[TMP20:%.*]] = getelementptr inbounds [[STRUCT_ANON_0]], %struct.anon.0* [[OMP_OUTLINED_ARG_AGG_]], i32 0, i32 1
// CHECK9-NEXT:    [[TMP21:%.*]] = load i32, i32* @g, align 4
// CHECK9-NEXT:    store i32 [[TMP21]], i32* [[TMP20]], align 4
// CHECK9-NEXT:    [[TMP22:%.*]] = getelementptr inbounds [[STRUCT_ANON_0]], %struct.anon.0* [[OMP_OUTLINED_ARG_AGG_]], i32 0, i32 2
// CHECK9-NEXT:    [[TMP23:%.*]] = load i32, i32* [[SIVAR]], align 4
// CHECK9-NEXT:    store i32 [[TMP23]], i32* [[TMP22]], align 4
// CHECK9-NEXT:    call void (%struct.ident_t*, i32, void (i32*, i32*, ...)*, ...) @__kmpc_fork_call(%struct.ident_t* @[[GLOB3]], i32 3, void (i32*, i32*, ...)* bitcast (void (i32*, i32*, i64, i64, %struct.anon.0*)* @.omp_outlined..3 to void (i32*, i32*, ...)*), i64 [[TMP15]], i64 [[TMP17]], %struct.anon.0* [[OMP_OUTLINED_ARG_AGG_]])
// CHECK9-NEXT:    br label [[OMP_INNER_FOR_INC:%.*]]
// CHECK9:       omp.inner.for.inc:
// CHECK9-NEXT:    [[TMP24:%.*]] = load i32, i32* [[DOTOMP_IV]], align 4
// CHECK9-NEXT:    [[TMP25:%.*]] = load i32, i32* [[DOTOMP_STRIDE]], align 4
// CHECK9-NEXT:    [[ADD:%.*]] = add nsw i32 [[TMP24]], [[TMP25]]
...
// CHECK9-NEXT:    [[TMP17:%.*]] = load i32*, i32** [[TMP]], align 8
// CHECK9-NEXT:    store volatile i32 1, i32* [[TMP17]], align 4
// CHECK9-NEXT:    store i32 2, i32* [[SIVAR]], align 4
// CHECK9-NEXT:    [[TMP18:%.*]] = getelementptr inbounds [[CLASS_ANON_1]], %class.anon.1* [[REF_TMP]], i32 0, i32 0
// CHECK9-NEXT:    store i32* [[G]], i32** [[TMP18]], align 8
// CHECK9-NEXT:    [[TMP19:%.*]] = getelementptr inbounds [[CLASS_ANON_1]], %class.anon.1* [[REF_TMP]], i32 0, i32 1
// CHECK9-NEXT:    [[TMP20:%.*]] = load i32*, i32** [[TMP]], align 8
// CHECK9-NEXT:    store i32* [[TMP20]], i32** [[TMP19]], align 8
// CHECK9-NEXT:    [[TMP21:%.*]] = getelementptr inbounds [[CLASS_ANON_1]], %class.anon.1* [[REF_TMP]], i32 0, i32 2
// CHECK9-NEXT:    store i32* [[SIVAR]], i32** [[TMP21]], align 8
...
// CHECK9-NEXT:    [[ADD4:%.*]] = add nsw i32 [[TMP22]], 1
...
// CHECK10-NEXT:    [[TMP19:%.*]] = load i32, i32* [[G]], align 4
// CHECK10-NEXT:    store i32 [[TMP19]], i32* [[TMP18]], align 4
// CHECK10-NEXT:    [[TMP20:%.*]] = getelementptr inbounds [[STRUCT_ANON_0]], %struct.anon.0* [[OMP_OUTLINED_ARG_AGG_]], i32 0, i32 1
// CHECK10-NEXT:    [[TMP21:%.*]] = load i32, i32* @g, align 4
// CHECK10-NEXT:    store i32 [[TMP21]], i32* [[TMP20]], align 4
// CHECK10-NEXT:    [[TMP22:%.*]] = getelementptr inbounds [[STRUCT_ANON_0]], %struct.anon.0* [[OMP_OUTLINED_ARG_AGG_]], i32 0, i32 2
// CHECK10-NEXT:    [[TMP23:%.*]] = load i32, i32* [[SIVAR]], align 4
// CHECK10-NEXT:    store i32 [[TMP23]], i32* [[TMP22]], align 4
// CHECK10-NEXT:    call void (%struct.ident_t*, i32, void (i32*, i32*, ...)*, ...) @__kmpc_fork_call(%struct.ident_t* @[[GLOB3]], i32 3, void (i32*, i32*, ...)* bitcast (void (i32*, i32*, i64, i64, %struct.anon.0*)* @.omp_outlined..3 to void (i32*, i32*, ...)*), i64 [[TMP15]], i64 [[TMP17]], %struct.anon.0* [[OMP_OUTLINED_ARG_AGG_]])
...
// CHECK10-NEXT:    [[TMP17:%.*]] = load i32*, i32** [[TMP]], align 8
// CHECK10-NEXT:    store volatile i32 1, i32* [[TMP17]], align 4
// CHECK10-NEXT:    store i32 2, i32* [[SIVAR]], align 4
// CHECK10-NEXT:    [[TMP18:%.*]] = getelementptr inbounds [[CLASS_ANON_1]], %class.anon.1* [[REF_TMP]], i32 0, i32 0
// CHECK10-NEXT:    store i32* [[G]], i32** [[TMP18]], align 8
// CHECK10-NEXT:    [[TMP19:%.*]] = getelementptr inbounds [[CLASS_ANON_1]], %class.anon.1* [[REF_TMP]], i32 0, i32 1
// CHECK10-NEXT:    [[TMP20:%.*]] = load i32*, i32** [[TMP]], align 8
// CHECK10-NEXT:    store i32* [[TMP20]], i32** [[TMP19]], align 8
// CHECK10-NEXT:    [[TMP21:%.*]] = getelementptr inbounds [[CLASS_ANON_1]], %class.anon.1* [[REF_TMP]], i32 0, i32 2
// CHECK10-NEXT:    store i32* [[SIVAR]], i32** [[TMP21]], align 8
...
// CHECK10-NEXT:    [[ADD4:%.*]] = add nsw i32 [[TMP22]], 1
