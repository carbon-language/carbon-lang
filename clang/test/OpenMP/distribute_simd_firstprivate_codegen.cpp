...
// CHECK1-NEXT:    [[TMP23:%.*]] = load double, double* [[G]], align 8
// CHECK1-NEXT:    [[ADD5:%.*]] = fadd double [[TMP23]], 1.000000e+00
// CHECK1-NEXT:    store double [[ADD5]], double* [[G]], align 8
// CHECK1-NEXT:    [[TMP24:%.*]] = load double*, double** [[_TMP3]], align 8
// CHECK1-NEXT:    [[TMP25:%.*]] = load volatile double, double* [[TMP24]], align 8
// CHECK1-NEXT:    [[ADD6:%.*]] = fadd double [[TMP25]], 1.000000e+00
// CHECK1-NEXT:    store volatile double [[ADD6]], double* [[TMP24]], align 8
// CHECK1-NEXT:    [[TMP26:%.*]] = load i32, i32* [[SVAR]], align 4
// CHECK1-NEXT:    [[ADD7:%.*]] = add nsw i32 [[TMP26]], 3
// CHECK1-NEXT:    store i32 [[ADD7]], i32* [[SVAR]], align 4
// CHECK1-NEXT:    [[TMP27:%.*]] = load float, float* [[SFVAR]], align 4
...
// CHECK2-NEXT:    [[TMP23:%.*]] = load double, double* [[G]], align 8
// CHECK2-NEXT:    [[ADD5:%.*]] = fadd double [[TMP23]], 1.000000e+00
// CHECK2-NEXT:    store double [[ADD5]], double* [[G]], align 8
// CHECK2-NEXT:    [[TMP24:%.*]] = load double*, double** [[_TMP3]], align 8
// CHECK2-NEXT:    [[TMP25:%.*]] = load volatile double, double* [[TMP24]], align 8
// CHECK2-NEXT:    [[ADD6:%.*]] = fadd double [[TMP25]], 1.000000e+00
// CHECK2-NEXT:    store volatile double [[ADD6]], double* [[TMP24]], align 8
// CHECK2-NEXT:    [[TMP26:%.*]] = load i32, i32* [[SVAR]], align 4
// CHECK2-NEXT:    [[ADD7:%.*]] = add nsw i32 [[TMP26]], 3
// CHECK2-NEXT:    store i32 [[ADD7]], i32* [[SVAR]], align 4
// CHECK2-NEXT:    [[TMP27:%.*]] = load float, float* [[SFVAR]], align 4
...
// CHECK3-NEXT:    [[TMP24:%.*]] = load double*, double** [[_TMP3]], align 4
// CHECK3-NEXT:    [[TMP25:%.*]] = load volatile double, double* [[TMP24]], align 4
// CHECK3-NEXT:    [[ADD6:%.*]] = fadd double [[TMP25]], 1.000000e+00
// CHECK3-NEXT:    store volatile double [[ADD6]], double* [[TMP24]], align 4
// CHECK3-NEXT:    [[TMP26:%.*]] = load i32, i32* [[SVAR]], align 4
// CHECK3-NEXT:    [[ADD7:%.*]] = add nsw i32 [[TMP26]], 3
// CHECK3-NEXT:    store i32 [[ADD7]], i32* [[SVAR]], align 4
// CHECK3-NEXT:    [[TMP27:%.*]] = load float, float* [[SFVAR]], align 4
...
// CHECK4-NEXT:    [[TMP23:%.*]] = load double, double* [[G]], align 8
// CHECK4-NEXT:    [[ADD5:%.*]] = fadd double [[TMP23]], 1.000000e+00
// CHECK4-NEXT:    store double [[ADD5]], double* [[G]], align 8
// CHECK4-NEXT:    [[TMP24:%.*]] = load double*, double** [[_TMP3]], align 4
// CHECK4-NEXT:    [[TMP25:%.*]] = load volatile double, double* [[TMP24]], align 4
// CHECK4-NEXT:    [[ADD6:%.*]] = fadd double [[TMP25]], 1.000000e+00
// CHECK4-NEXT:    store volatile double [[ADD6]], double* [[TMP24]], align 4
// CHECK4-NEXT:    [[TMP26:%.*]] = load i32, i32* [[SVAR]], align 4
// CHECK4-NEXT:    [[ADD7:%.*]] = add nsw i32 [[TMP26]], 3
// CHECK4-NEXT:    store i32 [[ADD7]], i32* [[SVAR]], align 4
// CHECK4-NEXT:    [[TMP27:%.*]] = load float, float* [[SFVAR]], align 4
...
// CHECK9-NEXT:    [[TMP32:%.*]] = load i32, i32* [[I]], align 4
...
// CHECK9-NEXT:    store i32 [[TMP31]], i32* [[ARRAYIDX]], align 4
// CHECK9-NEXT:    [[TMP33:%.*]] = load %struct.S*, %struct.S** [[_TMP4]], align 8
// CHECK9-NEXT:    [[TMP34:%.*]] = load i32, i32* [[I]], align 4
...
// CHECK9-NEXT:    [[ADD:%.*]] = add nsw i32 0, [[MUL]]
// CHECK9-NEXT:    store i32 [[ADD]], i32* [[I]], align 4
// CHECK9-NEXT:    [[TMP28:%.*]] = load i32, i32* [[T_VAR]], align 4
// CHECK9-NEXT:    [[TMP29:%.*]] = load i32, i32* [[I]], align 4
// CHECK9-NEXT:    [[IDXPROM:%.*]] = sext i32 [[TMP29]] to i64
// CHECK9-NEXT:    [[ARRAYIDX:%.*]] = getelementptr inbounds [2 x i32], [2 x i32]* [[VEC]], i64 0, i64 [[IDXPROM]]
// CHECK9-NEXT:    store i32 [[TMP28]], i32* [[ARRAYIDX]], align 4
// CHECK9-NEXT:    [[TMP30:%.*]] = load %struct.S.0*, %struct.S.0** [[_TMP4]], align 8
// CHECK9-NEXT:    [[TMP31:%.*]] = load i32, i32* [[I]], align 4
...
// CHECK10-NEXT:    [[TMP32:%.*]] = load i32, i32* [[I]], align 4
...
// CHECK10-NEXT:    store i32 [[TMP31]], i32* [[ARRAYIDX]], align 4
// CHECK10-NEXT:    [[TMP33:%.*]] = load %struct.S*, %struct.S** [[_TMP4]], align 8
// CHECK10-NEXT:    [[TMP34:%.*]] = load i32, i32* [[I]], align 4
...
// CHECK10-NEXT:    [[ADD:%.*]] = add nsw i32 0, [[MUL]]
// CHECK10-NEXT:    store i32 [[ADD]], i32* [[I]], align 4
// CHECK10-NEXT:    [[TMP28:%.*]] = load i32, i32* [[T_VAR]], align 4
// CHECK10-NEXT:    [[TMP29:%.*]] = load i32, i32* [[I]], align 4
// CHECK10-NEXT:    [[IDXPROM:%.*]] = sext i32 [[TMP29]] to i64
// CHECK10-NEXT:    [[ARRAYIDX:%.*]] = getelementptr inbounds [2 x i32], [2 x i32]* [[VEC]], i64 0, i64 [[IDXPROM]]
// CHECK10-NEXT:    store i32 [[TMP28]], i32* [[ARRAYIDX]], align 4
// CHECK10-NEXT:    [[TMP30:%.*]] = load %struct.S.0*, %struct.S.0** [[_TMP4]], align 8
// CHECK10-NEXT:    [[TMP31:%.*]] = load i32, i32* [[I]], align 4
...
// CHECK11-NEXT:    [[TMP32:%.*]] = load i32, i32* [[I]], align 4
// CHECK11-NEXT:    [[ARRAYIDX:%.*]] = getelementptr inbounds [2 x i32], [2 x i32]* [[VEC]], i32 0, i32 [[TMP32]]
// CHECK11-NEXT:    store i32 [[TMP31]], i32* [[ARRAYIDX]], align 4
// CHECK11-NEXT:    [[TMP33:%.*]] = load %struct.S*, %struct.S** [[_TMP4]], align 4
// CHECK11-NEXT:    [[TMP34:%.*]] = load i32, i32* [[I]], align 4
...
// CHECK11-NEXT:    [[ADD:%.*]] = add nsw i32 0, [[MUL]]
// CHECK11-NEXT:    store i32 [[ADD]], i32* [[I]], align 4
// CHECK11-NEXT:    [[TMP28:%.*]] = load i32, i32* [[T_VAR]], align 4
...
// CHECK11-NEXT:    store i32 [[TMP28]], i32* [[ARRAYIDX]], align 4
// CHECK11-NEXT:    [[TMP30:%.*]] = load %struct.S.0*, %struct.S.0** [[_TMP4]], align 4
// CHECK11-NEXT:    [[TMP31:%.*]] = load i32, i32* [[I]], align 4
...
// CHECK12-NEXT:    [[TMP32:%.*]] = load i32, i32* [[I]], align 4
// CHECK12-NEXT:    [[ARRAYIDX:%.*]] = getelementptr inbounds [2 x i32], [2 x i32]* [[VEC]], i32 0, i32 [[TMP32]]
// CHECK12-NEXT:    store i32 [[TMP31]], i32* [[ARRAYIDX]], align 4
// CHECK12-NEXT:    [[TMP33:%.*]] = load %struct.S*, %struct.S** [[_TMP4]], align 4
// CHECK12-NEXT:    [[TMP34:%.*]] = load i32, i32* [[I]], align 4
...
// CHECK12-NEXT:    [[ADD:%.*]] = add nsw i32 0, [[MUL]]
// CHECK12-NEXT:    store i32 [[ADD]], i32* [[I]], align 4
// CHECK12-NEXT:    [[TMP28:%.*]] = load i32, i32* [[T_VAR]], align 4
...
// CHECK12-NEXT:    store i32 [[TMP28]], i32* [[ARRAYIDX]], align 4
// CHECK12-NEXT:    [[TMP30:%.*]] = load %struct.S.0*, %struct.S.0** [[_TMP4]], align 4
// CHECK12-NEXT:    [[TMP31:%.*]] = load i32, i32* [[I]], align 4
