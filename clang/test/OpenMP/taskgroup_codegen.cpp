...
// DEBUG1-SAME: (i32* noalias [[DOTGLOBAL_TID_:%.*]], i32* noalias [[DOTBOUND_TID_:%.*]], %struct.anon* noalias [[__CONTEXT:%.*]]) #[[ATTR7:[0-9]+]] personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) !dbg [[DBG23:![0-9]+]] {
// DEBUG1-NEXT:  entry:
...
// DEBUG1-NEXT:    [[TMP4:%.*]] = extractvalue { i8*, i32 } [[TMP3]], 0, !dbg [[DBG28]]
// DEBUG1-NEXT:    store i8* [[TMP4]], i8** [[EXN_SLOT]], align 8, !dbg [[DBG28]]
// DEBUG1-NEXT:    [[TMP5:%.*]] = extractvalue { i8*, i32 } [[TMP3]], 1, !dbg [[DBG28]]
// DEBUG1-NEXT:    store i32 [[TMP5]], i32* [[EHSELECTOR_SLOT]], align 4, !dbg [[DBG28]]
// DEBUG1-NEXT:    call void @__kmpc_end_taskgroup(%struct.ident_t* @[[GLOB5]], i32 [[TMP2]]), !dbg [[DBG26]]
