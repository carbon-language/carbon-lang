...
// CHECK1-NEXT:    store i8* [[TMP18]], i8** [[EXN_SLOT]], align 8
// CHECK1-NEXT:    [[TMP19:%.*]] = extractvalue { i8*, i32 } [[TMP17]], 1
// CHECK1-NEXT:    store i32 [[TMP19]], i32* [[EHSELECTOR_SLOT]], align 4
// CHECK1-NEXT:    call void @_ZN1SD1Ev(%struct.S* nonnull align 8 dereferenceable(24) [[REF_TMP]]) #[[ATTR6]]
...
// CHECK2-NEXT:    call void @__clang_call_terminate(i8* [[TMP17]]) #[[ATTR10:[0-9]+]]
...
// CHECK2-NEXT:    catch i8* null
// CHECK2-NEXT:    [[TMP17:%.*]] = extractvalue { i8*, i32 } [[TMP16]], 0
// CHECK2-NEXT:    call void @__clang_call_terminate(i8* [[TMP17]]) #[[ATTR10]]
// CHECK2-NEXT:    unreachable
//
//
...
// CHECK2-NEXT:    store i8* [[TMP18]], i8** [[EXN_SLOT]], align 8
// CHECK2-NEXT:    [[TMP19:%.*]] = extractvalue { i8*, i32 } [[TMP17]], 1
// CHECK2-NEXT:    store i32 [[TMP19]], i32* [[EHSELECTOR_SLOT]], align 4
// CHECK2-NEXT:    call void @_ZN1SD1Ev(%struct.S* nonnull align 8 dereferenceable(24) [[REF_TMP]]) #[[ATTR6]]
...
// CHECK5-NEXT:    store i8* [[TMP18]], i8** [[EXN_SLOT]], align 8
// CHECK5-NEXT:    [[TMP19:%.*]] = extractvalue { i8*, i32 } [[TMP17]], 1
// CHECK5-NEXT:    store i32 [[TMP19]], i32* [[EHSELECTOR_SLOT]], align 4
// CHECK5-NEXT:    call void @_ZN1SD1Ev(%struct.S* nonnull align 8 dereferenceable(24) [[REF_TMP]]) #[[ATTR6]]
...
// CHECK6-NEXT:    call void @__clang_call_terminate(i8* [[TMP17]]) #[[ATTR10:[0-9]+]]
...
// CHECK6-NEXT:    catch i8* null
// CHECK6-NEXT:    [[TMP17:%.*]] = extractvalue { i8*, i32 } [[TMP16]], 0
// CHECK6-NEXT:    call void @__clang_call_terminate(i8* [[TMP17]]) #[[ATTR10]]
// CHECK6-NEXT:    unreachable
//
//
...
// CHECK6-NEXT:    store i8* [[TMP18]], i8** [[EXN_SLOT]], align 8
// CHECK6-NEXT:    [[TMP19:%.*]] = extractvalue { i8*, i32 } [[TMP17]], 1
// CHECK6-NEXT:    store i32 [[TMP19]], i32* [[EHSELECTOR_SLOT]], align 4
// CHECK6-NEXT:    call void @_ZN1SD1Ev(%struct.S* nonnull align 8 dereferenceable(24) [[REF_TMP]]) #[[ATTR6]]
...
// CHECK9-NEXT:    store i8* [[TMP18]], i8** [[EXN_SLOT]], align 8
// CHECK9-NEXT:    [[TMP19:%.*]] = extractvalue { i8*, i32 } [[TMP17]], 1
// CHECK9-NEXT:    store i32 [[TMP19]], i32* [[EHSELECTOR_SLOT]], align 4
// CHECK9-NEXT:    call void @_ZN1SD1Ev(%struct.S* nonnull align 8 dereferenceable(24) [[REF_TMP]]) #[[ATTR6]]
...
// CHECK10-NEXT:    call void @__clang_call_terminate(i8* [[TMP17]]) #[[ATTR10:[0-9]+]]
...
// CHECK10-NEXT:    catch i8* null
// CHECK10-NEXT:    [[TMP17:%.*]] = extractvalue { i8*, i32 } [[TMP16]], 0
// CHECK10-NEXT:    call void @__clang_call_terminate(i8* [[TMP17]]) #[[ATTR10]]
// CHECK10-NEXT:    unreachable
//
//
...
// CHECK10-NEXT:    store i64* [[DOTCAPTURED_OMP_PREVIOUS_UB]], i64** [[TMP13]], align 8
// CHECK10-NEXT:    call void (%struct.ident_t*, i32, void (i32*, i32*, ...)*, ...) @__kmpc_fork_call(%struct.ident_t* @[[GLOB3]], i32 1, void (i32*, i32*, ...)* bitcast (void (i32*, i32*, %struct.anon.6*)* @.omp_outlined..7 to void (i32*, i32*, ...)*), %struct.anon.6* [[OMP_OUTLINED_ARG_AGG_]])
// CHECK10-NEXT:    br label [[OMP_INNER_FOR_INC:%.*]]
// CHECK10:       omp.inner.for.inc:
// CHECK10-NEXT:    [[TMP14:%.*]] = load i32, i32* [[DOTOMP_IV]], align 4
// CHECK10-NEXT:    [[TMP15:%.*]] = load i32, i32* [[DOTOMP_STRIDE]], align 4
...
// CHECK10-NEXT:    store i8* [[TMP18]], i8** [[EXN_SLOT]], align 8
// CHECK10-NEXT:    [[TMP19:%.*]] = extractvalue { i8*, i32 } [[TMP17]], 1
// CHECK10-NEXT:    store i32 [[TMP19]], i32* [[EHSELECTOR_SLOT]], align 4
// CHECK10-NEXT:    call void @_ZN1SD1Ev(%struct.S* nonnull align 8 dereferenceable(24) [[REF_TMP]]) #[[ATTR6]]
...
// CHECK13-NEXT:    store i8* [[TMP18]], i8** [[EXN_SLOT]], align 8
// CHECK13-NEXT:    [[TMP19:%.*]] = extractvalue { i8*, i32 } [[TMP17]], 1
// CHECK13-NEXT:    store i32 [[TMP19]], i32* [[EHSELECTOR_SLOT]], align 4
// CHECK13-NEXT:    call void @_ZN1SD1Ev(%struct.S* nonnull align 8 dereferenceable(24) [[REF_TMP]]) #[[ATTR6]]
...
// CHECK14-NEXT:    call void @__clang_call_terminate(i8* [[TMP17]]) #[[ATTR10:[0-9]+]]
...
// CHECK14-NEXT:    store i64 [[TMP13]], i64* [[DOTCAPTURED_OMP_PREVIOUS_LB]], align 8
// CHECK14-NEXT:    [[TMP14:%.*]] = load i32, i32* [[DOTOMP_COMB_UB]], align 4
// CHECK14-NEXT:    [[TMP15:%.*]] = zext i32 [[TMP14]] to i64
// CHECK14-NEXT:    store i64 [[TMP15]], i64* [[DOTCAPTURED_OMP_PREVIOUS_UB]], align 8
// CHECK14-NEXT:    [[TMP16:%.*]] = getelementptr inbounds [[STRUCT_ANON_2]], %struct.anon.2* [[OMP_OUTLINED_ARG_AGG_]], i32 0, i32 0
// CHECK14-NEXT:    store i64* [[DOTCAPTURED_OMP_PREVIOUS_LB]], i64** [[TMP16]], align 8
// CHECK14-NEXT:    [[TMP17:%.*]] = getelementptr inbounds [[STRUCT_ANON_2]], %struct.anon.2* [[OMP_OUTLINED_ARG_AGG_]], i32 0, i32 1
// CHECK14-NEXT:    store i64* [[DOTCAPTURED_OMP_PREVIOUS_UB]], i64** [[TMP17]], align 8
// CHECK14-NEXT:    call void (%struct.ident_t*, i32, void (i32*, i32*, ...)*, ...) @__kmpc_fork_call(%struct.ident_t* @[[GLOB3]], i32 1, void (i32*, i32*, ...)* bitcast (void (i32*, i32*, %struct.anon.2*)* @.omp_outlined..3 to void (i32*, i32*, ...)*), %struct.anon.2* [[OMP_OUTLINED_ARG_AGG_]])
// CHECK14-NEXT:    br label [[OMP_INNER_FOR_INC:%.*]]
// CHECK14:       omp.inner.for.inc:
...
// CHECK14-NEXT:    catch i8* null
// CHECK14-NEXT:    [[TMP17:%.*]] = extractvalue { i8*, i32 } [[TMP16]], 0
// CHECK14-NEXT:    call void @__clang_call_terminate(i8* [[TMP17]]) #[[ATTR10]]
// CHECK14-NEXT:    unreachable
//
//
...
// CHECK14-NEXT:    store i64* [[DOTCAPTURED_OMP_PREVIOUS_UB]], i64** [[TMP13]], align 8
// CHECK14-NEXT:    call void (%struct.ident_t*, i32, void (i32*, i32*, ...)*, ...) @__kmpc_fork_call(%struct.ident_t* @[[GLOB3]], i32 1, void (i32*, i32*, ...)* bitcast (void (i32*, i32*, %struct.anon.6*)* @.omp_outlined..7 to void (i32*, i32*, ...)*), %struct.anon.6* [[OMP_OUTLINED_ARG_AGG_]])
// CHECK14-NEXT:    br label [[OMP_INNER_FOR_INC:%.*]]
// CHECK14:       omp.inner.for.inc:
// CHECK14-NEXT:    [[TMP14:%.*]] = load i32, i32* [[DOTOMP_IV]], align 4
// CHECK14-NEXT:    [[TMP15:%.*]] = load i32, i32* [[DOTOMP_STRIDE]], align 4
...
// CHECK14-NEXT:    store i8* [[TMP18]], i8** [[EXN_SLOT]], align 8
// CHECK14-NEXT:    [[TMP19:%.*]] = extractvalue { i8*, i32 } [[TMP17]], 1
// CHECK14-NEXT:    store i32 [[TMP19]], i32* [[EHSELECTOR_SLOT]], align 4
// CHECK14-NEXT:    call void @_ZN1SD1Ev(%struct.S* nonnull align 8 dereferenceable(24) [[REF_TMP]]) #[[ATTR6]]
