...
// CHECK1-NEXT:    call void @__clang_call_terminate(i8* [[TMP13]]) #[[ATTR10:[0-9]+]]
...
// CHECK1-NEXT:    catch i8* null
// CHECK1-NEXT:    [[TMP13:%.*]] = extractvalue { i8*, i32 } [[TMP12]], 0
// CHECK1-NEXT:    call void @__clang_call_terminate(i8* [[TMP13]]) #[[ATTR10]]
// CHECK1-NEXT:    unreachable
//
//
...
// CHECK1-NEXT:    call void @__clang_call_terminate(i8* [[TMP19]]) #[[ATTR10]]
// CHECK1-NEXT:    unreachable
...
// CHECK2-NEXT:    call void @__clang_call_terminate(i8* [[TMP13]]) #[[ATTR10:[0-9]+]]
...
// CHECK2-NEXT:    catch i8* null
// CHECK2-NEXT:    [[TMP13:%.*]] = extractvalue { i8*, i32 } [[TMP12]], 0
// CHECK2-NEXT:    call void @__clang_call_terminate(i8* [[TMP13]]) #[[ATTR10]]
// CHECK2-NEXT:    unreachable
//
//
...
// CHECK2-NEXT:    call void @__clang_call_terminate(i8* [[TMP19]]) #[[ATTR10]]
// CHECK2-NEXT:    unreachable
...
// CHECK5-NEXT:    call void @__clang_call_terminate(i8* [[TMP13]]) #[[ATTR10:[0-9]+]]
...
// CHECK5-NEXT:    catch i8* null
// CHECK5-NEXT:    [[TMP13:%.*]] = extractvalue { i8*, i32 } [[TMP12]], 0
// CHECK5-NEXT:    call void @__clang_call_terminate(i8* [[TMP13]]) #[[ATTR10]]
// CHECK5-NEXT:    unreachable
//
//
...
// CHECK5-NEXT:    call void @__clang_call_terminate(i8* [[TMP19]]) #[[ATTR10]]
// CHECK5-NEXT:    unreachable
...
// CHECK6-NEXT:    call void @__clang_call_terminate(i8* [[TMP13]]) #[[ATTR10:[0-9]+]]
...
// CHECK6-NEXT:    catch i8* null
// CHECK6-NEXT:    [[TMP13:%.*]] = extractvalue { i8*, i32 } [[TMP12]], 0
// CHECK6-NEXT:    call void @__clang_call_terminate(i8* [[TMP13]]) #[[ATTR10]]
// CHECK6-NEXT:    unreachable
//
//
...
// CHECK6-NEXT:    call void @__clang_call_terminate(i8* [[TMP19]]) #[[ATTR10]]
// CHECK6-NEXT:    unreachable
...
// CHECK9-NEXT:    [[TMP13:%.*]] = extractvalue { i8*, i32 } [[TMP12]], 0
// CHECK9-NEXT:    call void @__clang_call_terminate(i8* [[TMP13]]) #[[ATTR10:[0-9]+]]
...
// CHECK9-NEXT:    catch i8* null
// CHECK9-NEXT:    [[TMP13:%.*]] = extractvalue { i8*, i32 } [[TMP12]], 0
// CHECK9-NEXT:    call void @__clang_call_terminate(i8* [[TMP13]]) #[[ATTR10]]
// CHECK9-NEXT:    unreachable
//
//
...
// CHECK9-NEXT:    call void @__clang_call_terminate(i8* [[TMP19]]) #[[ATTR10]]
// CHECK9-NEXT:    unreachable
...
// CHECK10-NEXT:    [[TMP12:%.*]] = landingpad { i8*, i32 }
// CHECK10-NEXT:    catch i8* null
// CHECK10-NEXT:    [[TMP13:%.*]] = extractvalue { i8*, i32 } [[TMP12]], 0
// CHECK10-NEXT:    call void @__clang_call_terminate(i8* [[TMP13]]) #[[ATTR10:[0-9]+]]
...
// CHECK10-NEXT:    catch i8* null
// CHECK10-NEXT:    [[TMP13:%.*]] = extractvalue { i8*, i32 } [[TMP12]], 0
// CHECK10-NEXT:    call void @__clang_call_terminate(i8* [[TMP13]]) #[[ATTR10]]
// CHECK10-NEXT:    unreachable
//
//
...
// CHECK10-NEXT:    call void @__clang_call_terminate(i8* [[TMP19]]) #[[ATTR10]]
// CHECK10-NEXT:    unreachable
...
// CHECK13-NEXT:    [[TMP12:%.*]] = landingpad { i8*, i32 }
// CHECK13-NEXT:    catch i8* null
// CHECK13-NEXT:    [[TMP13:%.*]] = extractvalue { i8*, i32 } [[TMP12]], 0
// CHECK13-NEXT:    call void @__clang_call_terminate(i8* [[TMP13]]) #[[ATTR10:[0-9]+]]
...
// CHECK13-NEXT:    catch i8* null
// CHECK13-NEXT:    [[TMP13:%.*]] = extractvalue { i8*, i32 } [[TMP12]], 0
// CHECK13-NEXT:    call void @__clang_call_terminate(i8* [[TMP13]]) #[[ATTR10]]
// CHECK13-NEXT:    unreachable
//
//
...
// CHECK13-NEXT:    call void @__clang_call_terminate(i8* [[TMP19]]) #[[ATTR10]]
// CHECK13-NEXT:    unreachable
...
// CHECK14-NEXT:    [[TMP12:%.*]] = landingpad { i8*, i32 }
// CHECK14-NEXT:    catch i8* null
// CHECK14-NEXT:    [[TMP13:%.*]] = extractvalue { i8*, i32 } [[TMP12]], 0
// CHECK14-NEXT:    call void @__clang_call_terminate(i8* [[TMP13]]) #[[ATTR10:[0-9]+]]
...
// CHECK14-NEXT:    catch i8* null
// CHECK14-NEXT:    [[TMP13:%.*]] = extractvalue { i8*, i32 } [[TMP12]], 0
// CHECK14-NEXT:    call void @__clang_call_terminate(i8* [[TMP13]]) #[[ATTR10]]
// CHECK14-NEXT:    unreachable
//
//
...
// CHECK14-NEXT:    call void @__clang_call_terminate(i8* [[TMP19]]) #[[ATTR10]]
// CHECK14-NEXT:    unreachable
