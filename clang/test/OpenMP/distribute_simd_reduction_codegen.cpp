...
// CHECK2:       .omp.final.done:
// CHECK2-NEXT:    [[TMP16:%.*]] = load i32, i32* [[TMP2]], align 4
// CHECK2-NEXT:    [[TMP17:%.*]] = load i32, i32* [[T_VAR]], align 4
// CHECK2-NEXT:    [[ADD4:%.*]] = add nsw i32 [[TMP16]], [[TMP17]]
// CHECK2-NEXT:    store i32 [[ADD4]], i32* [[TMP2]], align 4
// CHECK2-NEXT:    ret void
//
...
// CHECK4:       .omp.final.done:
// CHECK4-NEXT:    [[TMP16:%.*]] = load i32, i32* [[TMP2]], align 4
// CHECK4-NEXT:    [[TMP17:%.*]] = load i32, i32* [[T_VAR]], align 4
// CHECK4-NEXT:    [[ADD4:%.*]] = add nsw i32 [[TMP16]], [[TMP17]]
// CHECK4-NEXT:    store i32 [[ADD4]], i32* [[TMP2]], align 4
// CHECK4-NEXT:    ret void
//
...
// CHECK10-NEXT:    [[TMP17:%.*]] = load i32, i32* [[TMP2]], align 4
// CHECK10-NEXT:    [[TMP18:%.*]] = load i32, i32* [[SIVAR]], align 4
// CHECK10-NEXT:    [[ADD4:%.*]] = add nsw i32 [[TMP17]], [[TMP18]]
