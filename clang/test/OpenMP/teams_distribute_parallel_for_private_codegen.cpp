...
// CHECK9-NEXT:    call void (%struct.ident_t*, i32, void (i32*, i32*, ...)*, ...) @__kmpc_fork_call(%struct.ident_t* @[[GLOB3]], i32 3, void (i32*, i32*, ...)* bitcast (void (i32*, i32*, i64, i64, %struct.anon.0*)* @.omp_outlined..3 to void (i32*, i32*, ...)*), i64 [[TMP9]], i64 [[TMP11]], %struct.anon.0* [[OMP_OUTLINED_ARG_AGG_]])
...
// CHECK9-SAME: (i32* noalias [[DOTGLOBAL_TID_:%.*]], i32* noalias [[DOTBOUND_TID_:%.*]], i64 [[DOTPREVIOUS_LB_:%.*]], i64 [[DOTPREVIOUS_UB_:%.*]], %struct.anon.0* noalias [[__CONTEXT:%.*]]) #[[ATTR5]] {
// CHECK9-NEXT:  entry:
// CHECK9-NEXT:    [[DOTGLOBAL_TID__ADDR:%.*]] = alloca i32*, align 8
// CHECK9-NEXT:    [[DOTBOUND_TID__ADDR:%.*]] = alloca i32*, align 8
...
// CHECK9-NEXT:    [[TMP11:%.*]] = load i32*, i32** [[_TMP3]], align 8
// CHECK9-NEXT:    store volatile i32 1, i32* [[TMP11]], align 4
// CHECK9-NEXT:    store i32 2, i32* [[SIVAR]], align 4
// CHECK9-NEXT:    [[TMP12:%.*]] = getelementptr inbounds [[CLASS_ANON_1]], %class.anon.1* [[REF_TMP]], i32 0, i32 0
// CHECK9-NEXT:    store i32* [[G]], i32** [[TMP12]], align 8
// CHECK9-NEXT:    [[TMP13:%.*]] = getelementptr inbounds [[CLASS_ANON_1]], %class.anon.1* [[REF_TMP]], i32 0, i32 1
// CHECK9-NEXT:    [[TMP14:%.*]] = load i32*, i32** [[_TMP3]], align 8
// CHECK9-NEXT:    store i32* [[TMP14]], i32** [[TMP13]], align 8
// CHECK9-NEXT:    [[TMP15:%.*]] = getelementptr inbounds [[CLASS_ANON_1]], %class.anon.1* [[REF_TMP]], i32 0, i32 2
// CHECK9-NEXT:    store i32* [[SIVAR]], i32** [[TMP15]], align 8
...
// CHECK9-NEXT:    [[ADD5:%.*]] = add nsw i32 [[TMP16]], 1
...
// CHECK10-NEXT:    call void (%struct.ident_t*, i32, void (i32*, i32*, ...)*, ...) @__kmpc_fork_call(%struct.ident_t* @[[GLOB3]], i32 3, void (i32*, i32*, ...)* bitcast (void (i32*, i32*, i64, i64, %struct.anon.0*)* @.omp_outlined..3 to void (i32*, i32*, ...)*), i64 [[TMP9]], i64 [[TMP11]], %struct.anon.0* [[OMP_OUTLINED_ARG_AGG_]])
...
// CHECK10-SAME: (i32* noalias [[DOTGLOBAL_TID_:%.*]], i32* noalias [[DOTBOUND_TID_:%.*]], i64 [[DOTPREVIOUS_LB_:%.*]], i64 [[DOTPREVIOUS_UB_:%.*]], %struct.anon.0* noalias [[__CONTEXT:%.*]]) #[[ATTR5]] {
// CHECK10-NEXT:  entry:
// CHECK10-NEXT:    [[DOTGLOBAL_TID__ADDR:%.*]] = alloca i32*, align 8
// CHECK10-NEXT:    [[DOTBOUND_TID__ADDR:%.*]] = alloca i32*, align 8
...
// CHECK10-NEXT:    [[TMP11:%.*]] = load i32*, i32** [[_TMP3]], align 8
// CHECK10-NEXT:    store volatile i32 1, i32* [[TMP11]], align 4
// CHECK10-NEXT:    store i32 2, i32* [[SIVAR]], align 4
// CHECK10-NEXT:    [[TMP12:%.*]] = getelementptr inbounds [[CLASS_ANON_1]], %class.anon.1* [[REF_TMP]], i32 0, i32 0
// CHECK10-NEXT:    store i32* [[G]], i32** [[TMP12]], align 8
// CHECK10-NEXT:    [[TMP13:%.*]] = getelementptr inbounds [[CLASS_ANON_1]], %class.anon.1* [[REF_TMP]], i32 0, i32 1
// CHECK10-NEXT:    [[TMP14:%.*]] = load i32*, i32** [[_TMP3]], align 8
// CHECK10-NEXT:    store i32* [[TMP14]], i32** [[TMP13]], align 8
// CHECK10-NEXT:    [[TMP15:%.*]] = getelementptr inbounds [[CLASS_ANON_1]], %class.anon.1* [[REF_TMP]], i32 0, i32 2
// CHECK10-NEXT:    store i32* [[SIVAR]], i32** [[TMP15]], align 8
...
// CHECK10-NEXT:    [[ADD5:%.*]] = add nsw i32 [[TMP16]], 1
