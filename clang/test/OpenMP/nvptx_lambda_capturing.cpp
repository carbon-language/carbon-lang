...
// CHECK2-NEXT:    call void @__kmpc_free_shared(i8* [[TMP18]])
// CHECK2-NEXT:    call void @__kmpc_target_deinit(%struct.ident_t* @[[GLOB1]], i1 true, i1 true)
// CHECK2-NEXT:    ret void
// CHECK2:       worker.exit:
// CHECK2-NEXT:    ret void
...
// CHECK3-NEXT:    call void @__kmpc_free_shared(i8* [[TMP18]])
...
// CHECK4-NEXT:    call void @__kmpc_free_shared(i8* [[TMP18]])
...
// CHECK4-NEXT:    call void @__kmpc_free_shared(i8* [[TMP8]])
// CHECK4-NEXT:    call void @__kmpc_target_deinit(%struct.ident_t* @[[GLOB1]], i1 true, i1 true)
// CHECK4-NEXT:    ret void
// CHECK4:       worker.exit:
// CHECK4-NEXT:    ret void
...
// CHECK4-NEXT:    call void @__kmpc_free_shared(i8* [[TMP6]])
// CHECK4-NEXT:    call void @__kmpc_target_deinit(%struct.ident_t* @[[GLOB1]], i1 true, i1 true)
// CHECK4-NEXT:    ret void
// CHECK4:       worker.exit:
// CHECK4-NEXT:    ret void
