...
// CHECK9-NEXT:    [[SUB6:%.*]] = sub nsw i32 [[TMP33]], 0
...
// CHECK9-NEXT:    [[SUB8:%.*]] = sub nsw i32 [[TMP29]], 0
...
// CHECK9:       .omp.final.then:
// CHECK9-NEXT:    [[TMP47:%.*]] = load i32, i32* [[DOTCAPTURE_EXPR_1]], align 4
// CHECK9-NEXT:    [[SUB15:%.*]] = sub nsw i32 [[TMP47]], 0
...
// CHECK9-NEXT:    [[SUB9:%.*]] = sub nsw i32 [[TMP31]], 0
...
// CHECK10-NEXT:    [[SUB6:%.*]] = sub nsw i32 [[TMP33]], 0
...
// CHECK10-NEXT:    [[SUB8:%.*]] = sub nsw i32 [[TMP29]], 0
...
// CHECK10:       .omp.final.then:
// CHECK10-NEXT:    [[TMP47:%.*]] = load i32, i32* [[DOTCAPTURE_EXPR_1]], align 4
// CHECK10-NEXT:    [[SUB15:%.*]] = sub nsw i32 [[TMP47]], 0
...
// CHECK10-NEXT:    [[SUB9:%.*]] = sub nsw i32 [[TMP31]], 0
...
// CHECK11-NEXT:    [[SUB6:%.*]] = sub nsw i32 [[TMP31]], 0
...
// CHECK11:       .omp.final.then:
// CHECK11-NEXT:    [[TMP45:%.*]] = load i32, i32* [[DOTCAPTURE_EXPR_1]], align 4
// CHECK11-NEXT:    [[SUB15:%.*]] = sub nsw i32 [[TMP45]], 0
...
// CHECK11-NEXT:    br i1 [[TMP30]], label [[DOTOMP_FINAL_THEN:%.*]], label [[DOTOMP_FINAL_DONE:%.*]]
// CHECK11:       .omp.final.then:
// CHECK11-NEXT:    [[TMP31:%.*]] = load i32, i32* [[DOTCAPTURE_EXPR_1]], align 4
// CHECK11-NEXT:    [[SUB8:%.*]] = sub nsw i32 [[TMP31]], 0
...
// CHECK11-NEXT:    br i1 [[TMP27]], label [[DOTOMP_FINAL_THEN:%.*]], label [[DOTOMP_FINAL_DONE:%.*]]
// CHECK11:       .omp.final.then:
// CHECK11-NEXT:    store i32 10, i32* [[I]], align 4
// CHECK11-NEXT:    br label [[DOTOMP_FINAL_DONE]]
// CHECK11:       .omp.final.done:
...
// CHECK12-NEXT:    [[SUB6:%.*]] = sub nsw i32 [[TMP31]], 0
...
// CHECK12-NEXT:    [[TMP43:%.*]] = load i32, i32* [[DOTOMP_IS_LAST]], align 4
// CHECK12-NEXT:    [[TMP44:%.*]] = icmp ne i32 [[TMP43]], 0
// CHECK12-NEXT:    br i1 [[TMP44]], label [[DOTOMP_FINAL_THEN:%.*]], label [[DOTOMP_FINAL_DONE:%.*]]
// CHECK12:       .omp.final.then:
// CHECK12-NEXT:    [[TMP45:%.*]] = load i32, i32* [[DOTCAPTURE_EXPR_1]], align 4
// CHECK12-NEXT:    [[SUB15:%.*]] = sub nsw i32 [[TMP45]], 0
...
// CHECK12-NEXT:    br i1 [[TMP30]], label [[DOTOMP_FINAL_THEN:%.*]], label [[DOTOMP_FINAL_DONE:%.*]]
// CHECK12:       .omp.final.then:
// CHECK12-NEXT:    [[TMP31:%.*]] = load i32, i32* [[DOTCAPTURE_EXPR_1]], align 4
// CHECK12-NEXT:    [[SUB8:%.*]] = sub nsw i32 [[TMP31]], 0
...
// CHECK12-NEXT:    br i1 [[TMP27]], label [[DOTOMP_FINAL_THEN:%.*]], label [[DOTOMP_FINAL_DONE:%.*]]
// CHECK12:       .omp.final.then:
// CHECK12-NEXT:    store i32 10, i32* [[I]], align 4
// CHECK12-NEXT:    br label [[DOTOMP_FINAL_DONE]]
// CHECK12:       .omp.final.done:
