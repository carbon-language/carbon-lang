...
// CHECK4-NEXT:    [[TMP37:%.*]] = getelementptr inbounds [1 x i8*], [1 x i8*]* [[CAPTURED_VARS_ADDRS]], i64 0, i64 0
// CHECK4-NEXT:    [[TMP38:%.*]] = call i8* @__kmpc_alloc_shared(i64 56)
// CHECK4-NEXT:    [[TMP39:%.*]] = load [[STRUCT_ANON_0]], %struct.anon.0* [[OMP_OUTLINED_ARG_AGG_]], align 8
// CHECK4-NEXT:    [[TMP40:%.*]] = bitcast i8* [[TMP38]] to %struct.anon.0*
// CHECK4-NEXT:    store [[STRUCT_ANON_0]] [[TMP39]], %struct.anon.0* [[TMP40]], align 8
// CHECK4-NEXT:    store i8* [[TMP38]], i8** [[TMP37]], align 8
// CHECK4-NEXT:    [[TMP41:%.*]] = load i32, i32* [[TMP6]], align 4
// CHECK4-NEXT:    [[TOBOOL:%.*]] = icmp ne i32 [[TMP41]], 0
// CHECK4-NEXT:    [[TMP42:%.*]] = zext i1 [[TOBOOL]] to i32
// CHECK4-NEXT:    [[TMP43:%.*]] = load i32*, i32** [[DOTGLOBAL_TID__ADDR]], align 8
// CHECK4-NEXT:    [[TMP44:%.*]] = load i32, i32* [[TMP43]], align 4
// CHECK4-NEXT:    [[TMP45:%.*]] = bitcast [1 x i8*]* [[CAPTURED_VARS_ADDRS]] to i8**
// CHECK4-NEXT:    call void @__kmpc_parallel_51(%struct.ident_t* @[[GLOB4]], i32 [[TMP44]], i32 [[TMP42]], i32 -1, i32 -1, i8* bitcast (void (i32*, i32*, %struct.anon.0*)* @__omp_outlined__1 to i8*), i8* null, i8** [[TMP45]], i64 1)
...
// CHECK4-NEXT:    call void @__kmpc_for_static_fini(%struct.ident_t* @[[GLOB2]], i32 [[TMP58]])
...
// CHECK4-NEXT:    [[CALL:%.*]] = call i32 @_Z3fooPi(i32* [[I4]]) #[[ATTR6:[0-9]+]]
// CHECK4-NEXT:    [[CALL7:%.*]] = call i32 @_Z3fooPi(i32* [[TMP8]]) #[[ATTR6]]
...
// CHECK4-NEXT:    [[CALL9:%.*]] = call i32 @_Z3fooPi(i32* [[ARRAYIDX]]) #[[ATTR6]]
...
// CHECK4-NEXT:    [[CALL13:%.*]] = call i32 @_Z3fooPi(i32* [[ARRAYIDX12]]) #[[ATTR6]]
...
// CHECK4-NEXT:    [[CALL17:%.*]] = call i32 @_Z3fooPi(i32* [[ARRAYIDX16]]) #[[ATTR6]]
...
// CHECK4-NEXT:    call void @__kmpc_for_static_fini(%struct.ident_t* @[[GLOB2]], i32 [[TMP35]])
...
// CHECK5-NEXT:    [[TMP35:%.*]] = getelementptr inbounds [1 x i8*], [1 x i8*]* [[CAPTURED_VARS_ADDRS]], i32 0, i32 0
// CHECK5-NEXT:    [[TMP36:%.*]] = call i8* @__kmpc_alloc_shared(i32 28)
// CHECK5-NEXT:    [[TMP37:%.*]] = load [[STRUCT_ANON_0]], %struct.anon.0* [[OMP_OUTLINED_ARG_AGG_]], align 4
// CHECK5-NEXT:    [[TMP38:%.*]] = bitcast i8* [[TMP36]] to %struct.anon.0*
// CHECK5-NEXT:    store [[STRUCT_ANON_0]] [[TMP37]], %struct.anon.0* [[TMP38]], align 4
// CHECK5-NEXT:    store i8* [[TMP36]], i8** [[TMP35]], align 4
// CHECK5-NEXT:    [[TMP39:%.*]] = load i32, i32* [[TMP6]], align 4
// CHECK5-NEXT:    [[TOBOOL:%.*]] = icmp ne i32 [[TMP39]], 0
// CHECK5-NEXT:    [[TMP40:%.*]] = zext i1 [[TOBOOL]] to i32
// CHECK5-NEXT:    [[TMP41:%.*]] = load i32*, i32** [[DOTGLOBAL_TID__ADDR]], align 4
// CHECK5-NEXT:    [[TMP42:%.*]] = load i32, i32* [[TMP41]], align 4
// CHECK5-NEXT:    [[TMP43:%.*]] = bitcast [1 x i8*]* [[CAPTURED_VARS_ADDRS]] to i8**
// CHECK5-NEXT:    call void @__kmpc_parallel_51(%struct.ident_t* @[[GLOB4]], i32 [[TMP42]], i32 [[TMP40]], i32 -1, i32 -1, i8* bitcast (void (i32*, i32*, %struct.anon.0*)* @__omp_outlined__1 to i8*), i8* null, i8** [[TMP43]], i32 1)
...
// CHECK5-NEXT:    call void @__kmpc_for_static_fini(%struct.ident_t* @[[GLOB2]], i32 [[TMP56]])
...
// CHECK5-NEXT:    [[CALL:%.*]] = call i32 @_Z3fooPi(i32* [[I3]]) #[[ATTR6:[0-9]+]]
// CHECK5-NEXT:    [[CALL5:%.*]] = call i32 @_Z3fooPi(i32* [[TMP8]]) #[[ATTR6]]
...
// CHECK5-NEXT:    [[CALL7:%.*]] = call i32 @_Z3fooPi(i32* [[ARRAYIDX]]) #[[ATTR6]]
...
// CHECK5-NEXT:    [[CALL10:%.*]] = call i32 @_Z3fooPi(i32* [[ARRAYIDX9]]) #[[ATTR6]]
...
// CHECK5-NEXT:    [[CALL13:%.*]] = call i32 @_Z3fooPi(i32* [[ARRAYIDX12]]) #[[ATTR6]]
...
// CHECK5-NEXT:    call void @__kmpc_for_static_fini(%struct.ident_t* @[[GLOB2]], i32 [[TMP35]])
...
// CHECK6-NEXT:    store i32 [[TMP26]], i32* [[DOTCAPTURED_OMP_PREVIOUS_LB]], align 4
// CHECK6-NEXT:    [[TMP27:%.*]] = load i32, i32* [[DOTOMP_COMB_UB]], align 4
// CHECK6-NEXT:    store i32 [[TMP27]], i32* [[DOTCAPTURED_OMP_PREVIOUS_UB]], align 4
// CHECK6-NEXT:    [[TMP28:%.*]] = getelementptr inbounds [[STRUCT_ANON_0]], %struct.anon.0* [[OMP_OUTLINED_ARG_AGG_]], i32 0, i32 0
// CHECK6-NEXT:    store i32* [[DOTCAPTURED_OMP_PREVIOUS_LB]], i32** [[TMP28]], align 4
// CHECK6-NEXT:    [[TMP29:%.*]] = getelementptr inbounds [[STRUCT_ANON_0]], %struct.anon.0* [[OMP_OUTLINED_ARG_AGG_]], i32 0, i32 1
// CHECK6-NEXT:    store i32* [[DOTCAPTURED_OMP_PREVIOUS_UB]], i32** [[TMP29]], align 4
// CHECK6-NEXT:    [[TMP30:%.*]] = getelementptr inbounds [[STRUCT_ANON_0]], %struct.anon.0* [[OMP_OUTLINED_ARG_AGG_]], i32 0, i32 2
// CHECK6-NEXT:    store i32* [[ARGC]], i32** [[TMP30]], align 4
// CHECK6-NEXT:    [[TMP31:%.*]] = getelementptr inbounds [[STRUCT_ANON_0]], %struct.anon.0* [[OMP_OUTLINED_ARG_AGG_]], i32 0, i32 3
// CHECK6-NEXT:    store i32* [[TMP6]], i32** [[TMP31]], align 4
// CHECK6-NEXT:    [[TMP32:%.*]] = getelementptr inbounds [[STRUCT_ANON_0]], %struct.anon.0* [[OMP_OUTLINED_ARG_AGG_]], i32 0, i32 4
// CHECK6-NEXT:    store [10 x i32]* [[B]], [10 x i32]** [[TMP32]], align 4
// CHECK6-NEXT:    [[TMP33:%.*]] = getelementptr inbounds [[STRUCT_ANON_0]], %struct.anon.0* [[OMP_OUTLINED_ARG_AGG_]], i32 0, i32 5
// CHECK6-NEXT:    store [10 x i32]* [[C_ON_STACK]], [10 x i32]** [[TMP33]], align 4
// CHECK6-NEXT:    [[TMP34:%.*]] = getelementptr inbounds [[STRUCT_ANON_0]], %struct.anon.0* [[OMP_OUTLINED_ARG_AGG_]], i32 0, i32 6
// CHECK6-NEXT:    store [10 x i32]* [[TMP10]], [10 x i32]** [[TMP34]], align 4
// CHECK6-NEXT:    [[TMP35:%.*]] = getelementptr inbounds [1 x i8*], [1 x i8*]* [[CAPTURED_VARS_ADDRS]], i32 0, i32 0
// CHECK6-NEXT:    [[TMP36:%.*]] = call i8* @__kmpc_alloc_shared(i32 28)
// CHECK6-NEXT:    [[TMP37:%.*]] = load [[STRUCT_ANON_0]], %struct.anon.0* [[OMP_OUTLINED_ARG_AGG_]], align 4
// CHECK6-NEXT:    [[TMP38:%.*]] = bitcast i8* [[TMP36]] to %struct.anon.0*
// CHECK6-NEXT:    store [[STRUCT_ANON_0]] [[TMP37]], %struct.anon.0* [[TMP38]], align 4
// CHECK6-NEXT:    store i8* [[TMP36]], i8** [[TMP35]], align 4
// CHECK6-NEXT:    [[TMP39:%.*]] = load i32, i32* [[TMP6]], align 4
// CHECK6-NEXT:    [[TOBOOL:%.*]] = icmp ne i32 [[TMP39]], 0
// CHECK6-NEXT:    [[TMP40:%.*]] = zext i1 [[TOBOOL]] to i32
// CHECK6-NEXT:    [[TMP41:%.*]] = load i32*, i32** [[DOTGLOBAL_TID__ADDR]], align 4
// CHECK6-NEXT:    [[TMP42:%.*]] = load i32, i32* [[TMP41]], align 4
// CHECK6-NEXT:    [[TMP43:%.*]] = bitcast [1 x i8*]* [[CAPTURED_VARS_ADDRS]] to i8**
// CHECK6-NEXT:    call void @__kmpc_parallel_51(%struct.ident_t* @[[GLOB4]], i32 [[TMP42]], i32 [[TMP40]], i32 -1, i32 -1, i8* bitcast (void (i32*, i32*, %struct.anon.0*)* @__omp_outlined__1 to i8*), i8* null, i8** [[TMP43]], i32 1)
// CHECK6-NEXT:    call void @__kmpc_free_shared(i8* [[TMP36]], i32 28)
// CHECK6-NEXT:    br label [[OMP_INNER_FOR_INC:%.*]]
// CHECK6:       omp.inner.for.inc:
// CHECK6-NEXT:    [[TMP44:%.*]] = load i32, i32* [[DOTOMP_IV]], align 4
// CHECK6-NEXT:    [[TMP45:%.*]] = load i32, i32* [[DOTOMP_STRIDE]], align 4
// CHECK6-NEXT:    [[ADD6:%.*]] = add nsw i32 [[TMP44]], [[TMP45]]
// CHECK6-NEXT:    store i32 [[ADD6]], i32* [[DOTOMP_IV]], align 4
// CHECK6-NEXT:    [[TMP46:%.*]] = load i32, i32* [[DOTOMP_COMB_LB]], align 4
// CHECK6-NEXT:    [[TMP47:%.*]] = load i32, i32* [[DOTOMP_STRIDE]], align 4
// CHECK6-NEXT:    [[ADD7:%.*]] = add nsw i32 [[TMP46]], [[TMP47]]
...
// CHECK6-NEXT:    [[ADD8:%.*]] = add nsw i32 [[TMP48]], [[TMP49]]
// CHECK6-NEXT:    store i32 [[ADD8]], i32* [[DOTOMP_COMB_UB]], align 4
// CHECK6-NEXT:    [[TMP50:%.*]] = load i32, i32* [[DOTOMP_COMB_UB]], align 4
// CHECK6-NEXT:    [[TMP51:%.*]] = load i32, i32* [[DOTCAPTURE_EXPR_1]], align 4
// CHECK6-NEXT:    [[CMP9:%.*]] = icmp sgt i32 [[TMP50]], [[TMP51]]
// CHECK6-NEXT:    br i1 [[CMP9]], label [[COND_TRUE10:%.*]], label [[COND_FALSE11:%.*]]
// CHECK6:       cond.true10:
// CHECK6-NEXT:    [[TMP52:%.*]] = load i32, i32* [[DOTCAPTURE_EXPR_1]], align 4
// CHECK6-NEXT:    br label [[COND_END12:%.*]]
// CHECK6:       cond.false11:
// CHECK6-NEXT:    [[TMP53:%.*]] = load i32, i32* [[DOTOMP_COMB_UB]], align 4
// CHECK6-NEXT:    br label [[COND_END12]]
// CHECK6:       cond.end12:
// CHECK6-NEXT:    [[COND13:%.*]] = phi i32 [ [[TMP52]], [[COND_TRUE10]] ], [ [[TMP53]], [[COND_FALSE11]] ]
// CHECK6-NEXT:    store i32 [[COND13]], i32* [[DOTOMP_COMB_UB]], align 4
// CHECK6-NEXT:    [[TMP54:%.*]] = load i32, i32* [[DOTOMP_COMB_LB]], align 4
// CHECK6-NEXT:    store i32 [[TMP54]], i32* [[DOTOMP_IV]], align 4
// CHECK6-NEXT:    br label [[OMP_INNER_FOR_COND]]
// CHECK6:       omp.inner.for.end:
// CHECK6-NEXT:    br label [[OMP_LOOP_EXIT:%.*]]
// CHECK6:       omp.loop.exit:
// CHECK6-NEXT:    [[TMP55:%.*]] = load i32*, i32** [[DOTGLOBAL_TID__ADDR]], align 4
// CHECK6-NEXT:    [[TMP56:%.*]] = load i32, i32* [[TMP55]], align 4
// CHECK6-NEXT:    call void @__kmpc_for_static_fini(%struct.ident_t* @[[GLOB2]], i32 [[TMP56]])
// CHECK6-NEXT:    [[TMP57:%.*]] = load i32, i32* [[DOTOMP_IS_LAST]], align 4
// CHECK6-NEXT:    [[TMP58:%.*]] = icmp ne i32 [[TMP57]], 0
// CHECK6-NEXT:    br i1 [[TMP58]], label [[DOTOMP_LASTPRIVATE_THEN:%.*]], label [[DOTOMP_LASTPRIVATE_DONE:%.*]]
// CHECK6:       .omp.lastprivate.then:
// CHECK6-NEXT:    [[TMP59:%.*]] = bitcast [10 x i32]* [[TMP4]] to i8*
// CHECK6-NEXT:    [[TMP60:%.*]] = bitcast [10 x i32]* [[C_ON_STACK]] to i8*
// CHECK6-NEXT:    call void @llvm.memcpy.p0i8.p0i8.i32(i8* align 4 [[TMP59]], i8* align 4 [[TMP60]], i32 40, i1 false)
...
// CHECK6-NEXT:    [[TMP10:%.*]] = load [10 x i32]*, [10 x i32]** [[TMP9]], align 4
// CHECK6-NEXT:    [[TMP11:%.*]] = getelementptr inbounds [[STRUCT_ANON_0]], %struct.anon.0* [[TMP0]], i32 0, i32 5
// CHECK6-NEXT:    [[TMP12:%.*]] = load [10 x i32]*, [10 x i32]** [[TMP11]], align 4
// CHECK6-NEXT:    [[TMP13:%.*]] = getelementptr inbounds [[STRUCT_ANON_0]], %struct.anon.0* [[TMP0]], i32 0, i32 6
// CHECK6-NEXT:    [[TMP14:%.*]] = load [10 x i32]*, [10 x i32]** [[TMP13]], align 4
// CHECK6-NEXT:    [[TMP15:%.*]] = load i32, i32* [[TMP6]], align 4
// CHECK6-NEXT:    store i32 [[TMP15]], i32* [[DOTCAPTURE_EXPR_]], align 4
// CHECK6-NEXT:    [[TMP16:%.*]] = load i32, i32* [[DOTCAPTURE_EXPR_]], align 4
// CHECK6-NEXT:    [[SUB:%.*]] = sub nsw i32 [[TMP16]], 0
// CHECK6-NEXT:    [[DIV:%.*]] = sdiv i32 [[SUB]], 1
// CHECK6-NEXT:    [[SUB2:%.*]] = sub nsw i32 [[DIV]], 1
// CHECK6-NEXT:    store i32 [[SUB2]], i32* [[DOTCAPTURE_EXPR_1]], align 4
// CHECK6-NEXT:    store i32 0, i32* [[I]], align 4
// CHECK6-NEXT:    [[TMP17:%.*]] = load i32, i32* [[DOTCAPTURE_EXPR_]], align 4
// CHECK6-NEXT:    [[CMP:%.*]] = icmp slt i32 0, [[TMP17]]
// CHECK6-NEXT:    br i1 [[CMP]], label [[OMP_PRECOND_THEN:%.*]], label [[OMP_PRECOND_END:%.*]]
// CHECK6:       omp.precond.then:
// CHECK6-NEXT:    store i32 0, i32* [[DOTOMP_LB]], align 4
// CHECK6-NEXT:    [[TMP18:%.*]] = load i32, i32* [[DOTCAPTURE_EXPR_1]], align 4
// CHECK6-NEXT:    store i32 [[TMP18]], i32* [[DOTOMP_UB]], align 4
// CHECK6-NEXT:    [[TMP19:%.*]] = load i32, i32* [[TMP2]], align 4
// CHECK6-NEXT:    [[TMP20:%.*]] = load i32, i32* [[TMP4]], align 4
// CHECK6-NEXT:    store i32 [[TMP19]], i32* [[DOTOMP_LB]], align 4
// CHECK6-NEXT:    store i32 [[TMP20]], i32* [[DOTOMP_UB]], align 4
// CHECK6-NEXT:    store i32 1, i32* [[DOTOMP_STRIDE]], align 4
// CHECK6-NEXT:    store i32 0, i32* [[DOTOMP_IS_LAST]], align 4
// CHECK6-NEXT:    [[TMP21:%.*]] = bitcast [10 x i32]* [[B]] to i8*
// CHECK6-NEXT:    [[TMP22:%.*]] = bitcast [10 x i32]* [[TMP10]] to i8*
// CHECK6-NEXT:    call void @llvm.memcpy.p0i8.p0i8.i32(i8* align 4 [[TMP21]], i8* align 4 [[TMP22]], i32 40, i1 false)
// CHECK6-NEXT:    [[TMP23:%.*]] = load i32*, i32** [[DOTGLOBAL_TID__ADDR]], align 4
// CHECK6-NEXT:    [[TMP24:%.*]] = load i32, i32* [[TMP23]], align 4
// CHECK6-NEXT:    call void @__kmpc_for_static_init_4(%struct.ident_t* @[[GLOB3:[0-9]+]], i32 [[TMP24]], i32 33, i32* [[DOTOMP_IS_LAST]], i32* [[DOTOMP_LB]], i32* [[DOTOMP_UB]], i32* [[DOTOMP_STRIDE]], i32 1, i32 1)
// CHECK6-NEXT:    [[TMP25:%.*]] = load i32, i32* [[DOTOMP_LB]], align 4
// CHECK6-NEXT:    store i32 [[TMP25]], i32* [[DOTOMP_IV]], align 4
// CHECK6-NEXT:    br label [[OMP_INNER_FOR_COND:%.*]]
// CHECK6:       omp.inner.for.cond:
// CHECK6-NEXT:    [[TMP26:%.*]] = load i32, i32* [[DOTOMP_IV]], align 4
// CHECK6-NEXT:    [[TMP27:%.*]] = load i32, i32* [[TMP4]], align 4
// CHECK6-NEXT:    [[CMP4:%.*]] = icmp ule i32 [[TMP26]], [[TMP27]]
// CHECK6-NEXT:    br i1 [[CMP4]], label [[OMP_INNER_FOR_BODY:%.*]], label [[OMP_INNER_FOR_END:%.*]]
// CHECK6:       omp.inner.for.body:
// CHECK6-NEXT:    [[TMP28:%.*]] = load i32, i32* [[DOTOMP_IV]], align 4
// CHECK6-NEXT:    [[MUL:%.*]] = mul nsw i32 [[TMP28]], 1
// CHECK6-NEXT:    [[ADD:%.*]] = add nsw i32 0, [[MUL]]
// CHECK6-NEXT:    store i32 [[ADD]], i32* [[I3]], align 4
// CHECK6-NEXT:    [[CALL:%.*]] = call i32 @_Z3fooPi(i32* [[I3]]) #[[ATTR6:[0-9]+]]
// CHECK6-NEXT:    [[CALL5:%.*]] = call i32 @_Z3fooPi(i32* [[TMP8]]) #[[ATTR6]]
// CHECK6-NEXT:    [[ADD6:%.*]] = add nsw i32 [[CALL]], [[CALL5]]
// CHECK6-NEXT:    [[TMP29:%.*]] = load i32, i32* [[I3]], align 4
// CHECK6-NEXT:    [[ARRAYIDX:%.*]] = getelementptr inbounds [10 x i32], [10 x i32]* [[B]], i32 0, i32 [[TMP29]]
// CHECK6-NEXT:    [[CALL7:%.*]] = call i32 @_Z3fooPi(i32* [[ARRAYIDX]]) #[[ATTR6]]
// CHECK6-NEXT:    [[ADD8:%.*]] = add nsw i32 [[ADD6]], [[CALL7]]
// CHECK6-NEXT:    [[TMP30:%.*]] = load i32, i32* [[I3]], align 4
// CHECK6-NEXT:    [[ARRAYIDX9:%.*]] = getelementptr inbounds [10 x i32], [10 x i32]* [[C]], i32 0, i32 [[TMP30]]
// CHECK6-NEXT:    [[CALL10:%.*]] = call i32 @_Z3fooPi(i32* [[ARRAYIDX9]]) #[[ATTR6]]
// CHECK6-NEXT:    [[ADD11:%.*]] = add nsw i32 [[ADD8]], [[CALL10]]
// CHECK6-NEXT:    [[TMP31:%.*]] = load i32, i32* [[I3]], align 4
// CHECK6-NEXT:    [[ARRAYIDX12:%.*]] = getelementptr inbounds [10 x i32], [10 x i32]* [[TMP14]], i32 0, i32 [[TMP31]]
// CHECK6-NEXT:    [[CALL13:%.*]] = call i32 @_Z3fooPi(i32* [[ARRAYIDX12]]) #[[ATTR6]]
// CHECK6-NEXT:    [[ADD14:%.*]] = add nsw i32 [[ADD11]], [[CALL13]]
// CHECK6-NEXT:    store i32 [[ADD14]], i32* [[TMP8]], align 4
...
// CHECK6-NEXT:    [[ADD15:%.*]] = add nsw i32 [[TMP32]], [[TMP33]]
// CHECK6-NEXT:    store i32 [[ADD15]], i32* [[DOTOMP_IV]], align 4
// CHECK6-NEXT:    br label [[OMP_INNER_FOR_COND]]
// CHECK6:       omp.inner.for.end:
// CHECK6-NEXT:    br label [[OMP_LOOP_EXIT:%.*]]
// CHECK6:       omp.loop.exit:
// CHECK6-NEXT:    [[TMP34:%.*]] = load i32*, i32** [[DOTGLOBAL_TID__ADDR]], align 4
// CHECK6-NEXT:    [[TMP35:%.*]] = load i32, i32* [[TMP34]], align 4
// CHECK6-NEXT:    call void @__kmpc_for_static_fini(%struct.ident_t* @[[GLOB2]], i32 [[TMP35]])
// CHECK6-NEXT:    [[TMP36:%.*]] = load i32, i32* [[DOTOMP_IS_LAST]], align 4
// CHECK6-NEXT:    [[TMP37:%.*]] = icmp ne i32 [[TMP36]], 0
// CHECK6-NEXT:    br i1 [[TMP37]], label [[DOTOMP_LASTPRIVATE_THEN:%.*]], label [[DOTOMP_LASTPRIVATE_DONE:%.*]]
// CHECK6:       .omp.lastprivate.then:
// CHECK6-NEXT:    [[TMP38:%.*]] = bitcast [10 x i32]* [[TMP12]] to i8*
// CHECK6-NEXT:    [[TMP39:%.*]] = bitcast [10 x i32]* [[C]] to i8*
// CHECK6-NEXT:    call void @llvm.memcpy.p0i8.p0i8.i32(i8* align 4 [[TMP38]], i8* align 4 [[TMP39]], i32 40, i1 false)
// CHECK6-NEXT:    br label [[DOTOMP_LASTPRIVATE_DONE]]
// CHECK6:       .omp.lastprivate.done:
// CHECK6-NEXT:    br label [[OMP_PRECOND_END]]
// CHECK6:       omp.precond.end:
