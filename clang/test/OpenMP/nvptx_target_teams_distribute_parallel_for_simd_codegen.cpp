...
// CHECK1-NEXT:    call void @__kmpc_free_shared(i8* [[TMP34]]), !llvm.access.group !12
...
// CHECK1-NEXT:    call void @__kmpc_free_shared(i8* [[L1]])
// CHECK1-NEXT:    ret void
//
//
...
// CHECK1-NEXT:    call void @__kmpc_free_shared(i8* [[TMP30]]), !llvm.access.group !19
// CHECK1-NEXT:    br label [[OMP_INNER_FOR_INC:%.*]]
// CHECK1:       omp.inner.for.inc:
...
// CHECK1-NEXT:    call void @__kmpc_free_shared(i8* [[TMP19]]), !llvm.access.group !25
// CHECK1-NEXT:    br label [[OMP_INNER_FOR_INC:%.*]]
// CHECK1:       omp.inner.for.inc:
...
// CHECK1-NEXT:    call void @__kmpc_free_shared(i8* [[TMP23]]), !llvm.access.group !31
// CHECK1-NEXT:    br label [[OMP_INNER_FOR_INC:%.*]]
// CHECK1:       omp.inner.for.inc:
...
// CHECK2-NEXT:    call void @__kmpc_free_shared(i8* [[TMP32]]), !llvm.access.group !12
...
// CHECK2-NEXT:    call void @__kmpc_free_shared(i8* [[TMP28]]), !llvm.access.group !19
// CHECK2-NEXT:    br label [[OMP_INNER_FOR_INC:%.*]]
// CHECK2:       omp.inner.for.inc:
...
// CHECK2-NEXT:    call void @__kmpc_free_shared(i8* [[TMP17]]), !llvm.access.group !25
// CHECK2-NEXT:    br label [[OMP_INNER_FOR_INC:%.*]]
// CHECK2:       omp.inner.for.inc:
...
// CHECK2-NEXT:    call void @__kmpc_free_shared(i8* [[TMP21]]), !llvm.access.group !31
// CHECK2-NEXT:    br label [[OMP_INNER_FOR_INC:%.*]]
// CHECK2:       omp.inner.for.inc:
...
// CHECK3-NEXT:    call void @__kmpc_free_shared(i8* [[TMP32]]), !llvm.access.group !12
...
// CHECK3-NEXT:    call void @__kmpc_free_shared(i8* [[TMP28]]), !llvm.access.group !19
// CHECK3-NEXT:    br label [[OMP_INNER_FOR_INC:%.*]]
// CHECK3:       omp.inner.for.inc:
...
// CHECK3-NEXT:    call void @__kmpc_free_shared(i8* [[TMP17]]), !llvm.access.group !25
// CHECK3-NEXT:    br label [[OMP_INNER_FOR_INC:%.*]]
// CHECK3:       omp.inner.for.inc:
...
// CHECK3-NEXT:    call void @__kmpc_free_shared(i8* [[TMP21]]), !llvm.access.group !31
// CHECK3-NEXT:    br label [[OMP_INNER_FOR_INC:%.*]]
// CHECK3:       omp.inner.for.inc:
