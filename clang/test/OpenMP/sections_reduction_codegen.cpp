...
// CHECK1-NEXT:    [[ATOMIC_TEMP22:%.*]] = alloca float, align 4
// CHECK1-NEXT:    [[_TMP23:%.*]] = alloca float, align 4
...
// CHECK1-NEXT:    [[CALL:%.*]] = call nonnull align 4 dereferenceable(4) %struct.S* @_ZN1SIfEanERKS0_(%struct.S* nonnull align 4 dereferenceable(4) [[TMP4]], %struct.S* nonnull align 4 dereferenceable(4) [[VAR]])
...
// CHECK1-NEXT:    [[CALL5:%.*]] = call float @_ZN1SIfEcvfEv(%struct.S* nonnull align 4 dereferenceable(4) [[TMP6]])
// CHECK1-NEXT:    [[TOBOOL:%.*]] = fcmp une float [[CALL5]], 0.000000e+00
// CHECK1-NEXT:    br i1 [[TOBOOL]], label [[LAND_RHS:%.*]], label [[LAND_END:%.*]]
// CHECK1:       land.rhs:
// CHECK1-NEXT:    [[CALL6:%.*]] = call float @_ZN1SIfEcvfEv(%struct.S* nonnull align 4 dereferenceable(4) [[VAR1]])
...
// CHECK1-NEXT:    call void @_ZN1SIfEC1Ef(%struct.S* nonnull align 4 dereferenceable(4) [[REF_TMP]], float [[CONV8]])
...
// CHECK1-NEXT:    [[TMP51:%.*]] = bitcast float* [[TMP2]] to i32*
// CHECK1-NEXT:    [[ATOMIC_LOAD:%.*]] = load atomic i32, i32* [[TMP51]] monotonic, align 4
// CHECK1-NEXT:    br label [[ATOMIC_CONT:%.*]]
// CHECK1:       atomic_cont:
// CHECK1-NEXT:    [[TMP52:%.*]] = phi i32 [ [[ATOMIC_LOAD]], [[DOTOMP_REDUCTION_CASE2]] ], [ [[TMP60:%.*]], [[ATOMIC_CONT]] ]
...
// CHECK1-NEXT:    [[TMP56:%.*]] = load float, float* [[T_VAR]], align 4
// CHECK1-NEXT:    [[ADD10:%.*]] = fadd float [[TMP55]], [[TMP56]]
// CHECK1-NEXT:    store float [[ADD10]], float* [[ATOMIC_TEMP]], align 4
// CHECK1-NEXT:    [[TMP57:%.*]] = load i32, i32* [[TMP53]], align 4
// CHECK1-NEXT:    [[TMP58:%.*]] = bitcast float* [[TMP2]] to i32*
// CHECK1-NEXT:    [[TMP59:%.*]] = cmpxchg i32* [[TMP58]], i32 [[TMP52]], i32 [[TMP57]] monotonic monotonic, align 4
// CHECK1-NEXT:    [[TMP60]] = extractvalue { i32, i1 } [[TMP59]], 0
// CHECK1-NEXT:    [[TMP61:%.*]] = extractvalue { i32, i1 } [[TMP59]], 1
// CHECK1-NEXT:    br i1 [[TMP61]], label [[ATOMIC_EXIT:%.*]], label [[ATOMIC_CONT]]
// CHECK1:       atomic_exit:
// CHECK1-NEXT:    call void @__kmpc_critical(%struct.ident_t* @[[GLOB3]], i32 [[TMP14]], [8 x i32]* @.gomp_critical_user_.atomic_reduction.var)
// CHECK1-NEXT:    [[CALL11:%.*]] = call nonnull align 4 dereferenceable(4) %struct.S* @_ZN1SIfEanERKS0_(%struct.S* nonnull align 4 dereferenceable(4) [[TMP4]], %struct.S* nonnull align 4 dereferenceable(4) [[VAR]])
// CHECK1-NEXT:    [[TMP62:%.*]] = bitcast %struct.S* [[TMP4]] to i8*
// CHECK1-NEXT:    [[TMP63:%.*]] = bitcast %struct.S* [[CALL11]] to i8*
// CHECK1-NEXT:    call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 4 [[TMP62]], i8* align 4 [[TMP63]], i64 4, i1 false)
...
// CHECK1-NEXT:    call void @__kmpc_critical(%struct.ident_t* @[[GLOB3]], i32 [[TMP14]], [8 x i32]* @.gomp_critical_user_.atomic_reduction.var)
// CHECK1-NEXT:    [[CALL13:%.*]] = call float @_ZN1SIfEcvfEv(%struct.S* nonnull align 4 dereferenceable(4) [[TMP6]])
// CHECK1-NEXT:    [[TOBOOL14:%.*]] = fcmp une float [[CALL13]], 0.000000e+00
// CHECK1-NEXT:    br i1 [[TOBOOL14]], label [[LAND_RHS15:%.*]], label [[LAND_END18:%.*]]
// CHECK1:       land.rhs15:
// CHECK1-NEXT:    [[CALL16:%.*]] = call float @_ZN1SIfEcvfEv(%struct.S* nonnull align 4 dereferenceable(4) [[VAR1]])
// CHECK1-NEXT:    [[TOBOOL17:%.*]] = fcmp une float [[CALL16]], 0.000000e+00
// CHECK1-NEXT:    br label [[LAND_END18]]
// CHECK1:       land.end18:
// CHECK1-NEXT:    [[TMP64:%.*]] = phi i1 [ false, [[ATOMIC_EXIT]] ], [ [[TOBOOL17]], [[LAND_RHS15]] ]
// CHECK1-NEXT:    [[CONV19:%.*]] = uitofp i1 [[TMP64]] to float
// CHECK1-NEXT:    call void @_ZN1SIfEC1Ef(%struct.S* nonnull align 4 dereferenceable(4) [[REF_TMP12]], float [[CONV19]])
// CHECK1-NEXT:    [[TMP65:%.*]] = bitcast %struct.S* [[TMP6]] to i8*
// CHECK1-NEXT:    [[TMP66:%.*]] = bitcast %struct.S* [[REF_TMP12]] to i8*
// CHECK1-NEXT:    call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 4 [[TMP65]], i8* align 4 [[TMP66]], i64 4, i1 false)
// CHECK1-NEXT:    call void @_ZN1SIfED1Ev(%struct.S* nonnull align 4 dereferenceable(4) [[REF_TMP12]]) #[[ATTR4]]
// CHECK1-NEXT:    call void @__kmpc_end_critical(%struct.ident_t* @[[GLOB3]], i32 [[TMP14]], [8 x i32]* @.gomp_critical_user_.atomic_reduction.var)
// CHECK1-NEXT:    [[TMP67:%.*]] = load float, float* [[T_VAR1]], align 4
// CHECK1-NEXT:    [[TMP68:%.*]] = bitcast float* [[TMP8]] to i32*
// CHECK1-NEXT:    [[ATOMIC_LOAD20:%.*]] = load atomic i32, i32* [[TMP68]] monotonic, align 4
// CHECK1-NEXT:    br label [[ATOMIC_CONT21:%.*]]
// CHECK1:       atomic_cont21:
// CHECK1-NEXT:    [[TMP69:%.*]] = phi i32 [ [[ATOMIC_LOAD20]], [[LAND_END18]] ], [ [[TMP79:%.*]], [[COND_END27:%.*]] ]
// CHECK1-NEXT:    [[TMP70:%.*]] = bitcast float* [[ATOMIC_TEMP22]] to i32*
// CHECK1-NEXT:    [[TMP71:%.*]] = bitcast i32 [[TMP69]] to float
// CHECK1-NEXT:    store float [[TMP71]], float* [[_TMP23]], align 4
// CHECK1-NEXT:    [[TMP72:%.*]] = load float, float* [[_TMP23]], align 4
// CHECK1-NEXT:    [[TMP73:%.*]] = load float, float* [[T_VAR1]], align 4
// CHECK1-NEXT:    [[CMP24:%.*]] = fcmp olt float [[TMP72]], [[TMP73]]
// CHECK1-NEXT:    br i1 [[CMP24]], label [[COND_TRUE25:%.*]], label [[COND_FALSE26:%.*]]
// CHECK1:       cond.true25:
// CHECK1-NEXT:    [[TMP74:%.*]] = load float, float* [[_TMP23]], align 4
// CHECK1-NEXT:    br label [[COND_END27]]
// CHECK1:       cond.false26:
// CHECK1-NEXT:    [[TMP75:%.*]] = load float, float* [[T_VAR1]], align 4
// CHECK1-NEXT:    br label [[COND_END27]]
// CHECK1:       cond.end27:
// CHECK1-NEXT:    [[COND28:%.*]] = phi float [ [[TMP74]], [[COND_TRUE25]] ], [ [[TMP75]], [[COND_FALSE26]] ]
// CHECK1-NEXT:    store float [[COND28]], float* [[ATOMIC_TEMP22]], align 4
// CHECK1-NEXT:    [[TMP76:%.*]] = load i32, i32* [[TMP70]], align 4
// CHECK1-NEXT:    [[TMP77:%.*]] = bitcast float* [[TMP8]] to i32*
// CHECK1-NEXT:    [[TMP78:%.*]] = cmpxchg i32* [[TMP77]], i32 [[TMP69]], i32 [[TMP76]] monotonic monotonic, align 4
// CHECK1-NEXT:    [[TMP79]] = extractvalue { i32, i1 } [[TMP78]], 0
// CHECK1-NEXT:    [[TMP80:%.*]] = extractvalue { i32, i1 } [[TMP78]], 1
// CHECK1-NEXT:    br i1 [[TMP80]], label [[ATOMIC_EXIT29:%.*]], label [[ATOMIC_CONT21]]
// CHECK1:       atomic_exit29:
// CHECK1-NEXT:    call void @__kmpc_end_reduce(%struct.ident_t* @[[GLOB2]], i32 [[TMP14]], [8 x i32]* @.gomp_critical_user_.reduction.var)
// CHECK1-NEXT:    br label [[DOTOMP_REDUCTION_DEFAULT]]
// CHECK1:       .omp.reduction.default:
// CHECK1-NEXT:    call void @_ZN1SIfED1Ev(%struct.S* nonnull align 4 dereferenceable(4) [[VAR1]]) #[[ATTR4]]
// CHECK1-NEXT:    call void @_ZN1SIfED1Ev(%struct.S* nonnull align 4 dereferenceable(4) [[VAR]]) #[[ATTR4]]
...
// CHECK1-NEXT:    [[CALL:%.*]] = call nonnull align 4 dereferenceable(4) %struct.S.0* @_ZN1SIiEanERKS0_(%struct.S.0* nonnull align 4 dereferenceable(4) [[TMP4]], %struct.S.0* nonnull align 4 dereferenceable(4) [[VAR]])
...
// CHECK1-NEXT:    [[CALL3:%.*]] = call i32 @_ZN1SIiEcviEv(%struct.S.0* nonnull align 4 dereferenceable(4) [[TMP6]])
// CHECK1-NEXT:    [[TOBOOL:%.*]] = icmp ne i32 [[CALL3]], 0
// CHECK1-NEXT:    br i1 [[TOBOOL]], label [[LAND_RHS:%.*]], label [[LAND_END:%.*]]
// CHECK1:       land.rhs:
// CHECK1-NEXT:    [[CALL4:%.*]] = call i32 @_ZN1SIiEcviEv(%struct.S.0* nonnull align 4 dereferenceable(4) [[VAR1]])
...
// CHECK1-NEXT:    call void @__kmpc_critical(%struct.ident_t* @[[GLOB3]], i32 [[TMP14]], [8 x i32]* @.gomp_critical_user_.atomic_reduction.var)
// CHECK1-NEXT:    [[CALL7:%.*]] = call nonnull align 4 dereferenceable(4) %struct.S.0* @_ZN1SIiEanERKS0_(%struct.S.0* nonnull align 4 dereferenceable(4) [[TMP4]], %struct.S.0* nonnull align 4 dereferenceable(4) [[VAR]])
...
// CHECK1-NEXT:    call void @__kmpc_end_critical(%struct.ident_t* @[[GLOB3]], i32 [[TMP14]], [8 x i32]* @.gomp_critical_user_.atomic_reduction.var)
// CHECK1-NEXT:    call void @__kmpc_critical(%struct.ident_t* @[[GLOB3]], i32 [[TMP14]], [8 x i32]* @.gomp_critical_user_.atomic_reduction.var)
// CHECK1-NEXT:    [[CALL9:%.*]] = call i32 @_ZN1SIiEcviEv(%struct.S.0* nonnull align 4 dereferenceable(4) [[TMP6]])
// CHECK1-NEXT:    [[TOBOOL10:%.*]] = icmp ne i32 [[CALL9]], 0
// CHECK1-NEXT:    br i1 [[TOBOOL10]], label [[LAND_RHS11:%.*]], label [[LAND_END14:%.*]]
// CHECK1:       land.rhs11:
// CHECK1-NEXT:    [[CALL12:%.*]] = call i32 @_ZN1SIiEcviEv(%struct.S.0* nonnull align 4 dereferenceable(4) [[VAR1]])
...
// CHECK1-NEXT:    call void @_ZN1SIiEC1Ei(%struct.S.0* nonnull align 4 dereferenceable(4) [[REF_TMP8]], i32 [[CONV15]])
...
// CHECK1-NEXT:    call void @_ZN1SIiED1Ev(%struct.S.0* nonnull align 4 dereferenceable(4) [[REF_TMP8]]) #[[ATTR4]]
// CHECK1-NEXT:    call void @__kmpc_end_critical(%struct.ident_t* @[[GLOB3]], i32 [[TMP14]], [8 x i32]* @.gomp_critical_user_.atomic_reduction.var)
...
// CHECK2-NEXT:    [[TMP6:%.*]] = getelementptr inbounds [[STRUCT_ANON]], %struct.anon* [[OMP_OUTLINED_ARG_AGG_]], i32 0, i32 5
// CHECK2-NEXT:    store [2 x %struct.S]* [[S_ARR]], [2 x %struct.S]** [[TMP6]], align 8
...
// CHECK2-NEXT:    [[TMP7:%.*]] = getelementptr inbounds [[STRUCT_S]], %struct.S* [[ARRAY_BEGIN]], i64 2
...
// CHECK2-NEXT:    [[ATOMIC_TEMP22:%.*]] = alloca float, align 4
// CHECK2-NEXT:    [[_TMP23:%.*]] = alloca float, align 4
...
// CHECK2-NEXT:    call void @__kmpc_for_static_init_4(%struct.ident_t* @[[GLOB1:[0-9]+]], i32 [[TMP14]], i32 34, i32* [[DOTOMP_SECTIONS_IL_]], i32* [[DOTOMP_SECTIONS_LB_]], i32* [[DOTOMP_SECTIONS_UB_]], i32* [[DOTOMP_SECTIONS_ST_]], i32 1, i32 1)
// CHECK2-NEXT:    [[TMP15:%.*]] = load i32, i32* [[DOTOMP_SECTIONS_UB_]], align 4
// CHECK2-NEXT:    [[TMP16:%.*]] = icmp slt i32 [[TMP15]], 0
// CHECK2-NEXT:    [[TMP17:%.*]] = select i1 [[TMP16]], i32 [[TMP15]], i32 0
// CHECK2-NEXT:    store i32 [[TMP17]], i32* [[DOTOMP_SECTIONS_UB_]], align 4
// CHECK2-NEXT:    [[TMP18:%.*]] = load i32, i32* [[DOTOMP_SECTIONS_LB_]], align 4
// CHECK2-NEXT:    store i32 [[TMP18]], i32* [[DOTOMP_SECTIONS_IV_]], align 4
// CHECK2-NEXT:    br label [[OMP_INNER_FOR_COND:%.*]]
// CHECK2:       omp.inner.for.cond:
// CHECK2-NEXT:    [[TMP19:%.*]] = load i32, i32* [[DOTOMP_SECTIONS_IV_]], align 4
// CHECK2-NEXT:    [[TMP20:%.*]] = load i32, i32* [[DOTOMP_SECTIONS_UB_]], align 4
// CHECK2-NEXT:    [[CMP:%.*]] = icmp sle i32 [[TMP19]], [[TMP20]]
...
// CHECK2-NEXT:    switch i32 [[TMP21]], label [[DOTOMP_SECTIONS_EXIT:%.*]] [
// CHECK2-NEXT:    i32 0, label [[DOTOMP_SECTIONS_CASE:%.*]]
// CHECK2-NEXT:    ]
// CHECK2:       .omp.sections.case:
// CHECK2-NEXT:    [[TMP22:%.*]] = load float, float* [[T_VAR]], align 4
// CHECK2-NEXT:    [[CONV:%.*]] = fptosi float [[TMP22]] to i32
// CHECK2-NEXT:    [[ARRAYIDX:%.*]] = getelementptr inbounds [2 x i32], [2 x i32]* [[TMP10]], i64 0, i64 0
// CHECK2-NEXT:    store i32 [[CONV]], i32* [[ARRAYIDX]], align 4
// CHECK2-NEXT:    [[ARRAYIDX1:%.*]] = getelementptr inbounds [2 x %struct.S], [2 x %struct.S]* [[TMP12]], i64 0, i64 0
// CHECK2-NEXT:    [[TMP23:%.*]] = bitcast %struct.S* [[ARRAYIDX1]] to i8*
// CHECK2-NEXT:    [[TMP24:%.*]] = bitcast %struct.S* [[VAR]] to i8*
// CHECK2-NEXT:    call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 4 [[TMP23]], i8* align 4 [[TMP24]], i64 4, i1 false)
// CHECK2-NEXT:    [[TMP25:%.*]] = load float, float* [[T_VAR1]], align 4
// CHECK2-NEXT:    [[CONV2:%.*]] = fptosi float [[TMP25]] to i32
// CHECK2-NEXT:    [[ARRAYIDX3:%.*]] = getelementptr inbounds [2 x i32], [2 x i32]* [[TMP10]], i64 0, i64 1
// CHECK2-NEXT:    store i32 [[CONV2]], i32* [[ARRAYIDX3]], align 4
// CHECK2-NEXT:    [[ARRAYIDX4:%.*]] = getelementptr inbounds [2 x %struct.S], [2 x %struct.S]* [[TMP12]], i64 0, i64 1
// CHECK2-NEXT:    [[TMP26:%.*]] = bitcast %struct.S* [[ARRAYIDX4]] to i8*
// CHECK2-NEXT:    [[TMP27:%.*]] = bitcast %struct.S* [[VAR1]] to i8*
...
// CHECK2-NEXT:    [[TMP28:%.*]] = load i32, i32* [[DOTOMP_SECTIONS_IV_]], align 4
// CHECK2-NEXT:    [[INC:%.*]] = add nsw i32 [[TMP28]], 1
...
// CHECK2-NEXT:    [[TMP29:%.*]] = getelementptr inbounds [4 x i8*], [4 x i8*]* [[DOTOMP_REDUCTION_RED_LIST]], i64 0, i64 0
// CHECK2-NEXT:    [[TMP30:%.*]] = bitcast float* [[T_VAR]] to i8*
// CHECK2-NEXT:    store i8* [[TMP30]], i8** [[TMP29]], align 8
// CHECK2-NEXT:    [[TMP31:%.*]] = getelementptr inbounds [4 x i8*], [4 x i8*]* [[DOTOMP_REDUCTION_RED_LIST]], i64 0, i64 1
// CHECK2-NEXT:    [[TMP32:%.*]] = bitcast %struct.S* [[VAR]] to i8*
// CHECK2-NEXT:    store i8* [[TMP32]], i8** [[TMP31]], align 8
// CHECK2-NEXT:    [[TMP33:%.*]] = getelementptr inbounds [4 x i8*], [4 x i8*]* [[DOTOMP_REDUCTION_RED_LIST]], i64 0, i64 2
// CHECK2-NEXT:    [[TMP34:%.*]] = bitcast %struct.S* [[VAR1]] to i8*
// CHECK2-NEXT:    store i8* [[TMP34]], i8** [[TMP33]], align 8
// CHECK2-NEXT:    [[TMP35:%.*]] = getelementptr inbounds [4 x i8*], [4 x i8*]* [[DOTOMP_REDUCTION_RED_LIST]], i64 0, i64 3
// CHECK2-NEXT:    [[TMP36:%.*]] = bitcast float* [[T_VAR1]] to i8*
// CHECK2-NEXT:    store i8* [[TMP36]], i8** [[TMP35]], align 8
// CHECK2-NEXT:    [[TMP37:%.*]] = bitcast [4 x i8*]* [[DOTOMP_REDUCTION_RED_LIST]] to i8*
// CHECK2-NEXT:    [[TMP38:%.*]] = call i32 @__kmpc_reduce(%struct.ident_t* @[[GLOB2:[0-9]+]], i32 [[TMP14]], i32 4, i64 32, i8* [[TMP37]], void (i8*, i8*)* @.omp.reduction.reduction_func, [8 x i32]* @.gomp_critical_user_.reduction.var)
...
// CHECK2-NEXT:    [[TMP39:%.*]] = load float, float* [[TMP2]], align 4
// CHECK2-NEXT:    [[TMP40:%.*]] = load float, float* [[T_VAR]], align 4
// CHECK2-NEXT:    [[ADD:%.*]] = fadd float [[TMP39]], [[TMP40]]
// CHECK2-NEXT:    store float [[ADD]], float* [[TMP2]], align 4
// CHECK2-NEXT:    [[CALL:%.*]] = call nonnull align 4 dereferenceable(4) %struct.S* @_ZN1SIfEanERKS0_(%struct.S* nonnull align 4 dereferenceable(4) [[TMP4]], %struct.S* nonnull align 4 dereferenceable(4) [[VAR]])
// CHECK2-NEXT:    [[TMP41:%.*]] = bitcast %struct.S* [[TMP4]] to i8*
// CHECK2-NEXT:    [[TMP42:%.*]] = bitcast %struct.S* [[CALL]] to i8*
// CHECK2-NEXT:    call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 4 [[TMP41]], i8* align 4 [[TMP42]], i64 4, i1 false)
// CHECK2-NEXT:    [[CALL5:%.*]] = call float @_ZN1SIfEcvfEv(%struct.S* nonnull align 4 dereferenceable(4) [[TMP6]])
// CHECK2-NEXT:    [[TOBOOL:%.*]] = fcmp une float [[CALL5]], 0.000000e+00
// CHECK2-NEXT:    br i1 [[TOBOOL]], label [[LAND_RHS:%.*]], label [[LAND_END:%.*]]
// CHECK2:       land.rhs:
// CHECK2-NEXT:    [[CALL6:%.*]] = call float @_ZN1SIfEcvfEv(%struct.S* nonnull align 4 dereferenceable(4) [[VAR1]])
// CHECK2-NEXT:    [[TOBOOL7:%.*]] = fcmp une float [[CALL6]], 0.000000e+00
// CHECK2-NEXT:    br label [[LAND_END]]
// CHECK2:       land.end:
// CHECK2-NEXT:    [[TMP43:%.*]] = phi i1 [ false, [[DOTOMP_REDUCTION_CASE1]] ], [ [[TOBOOL7]], [[LAND_RHS]] ]
// CHECK2-NEXT:    [[CONV8:%.*]] = uitofp i1 [[TMP43]] to float
// CHECK2-NEXT:    call void @_ZN1SIfEC1Ef(%struct.S* nonnull align 4 dereferenceable(4) [[REF_TMP]], float [[CONV8]])
// CHECK2-NEXT:    [[TMP44:%.*]] = bitcast %struct.S* [[TMP6]] to i8*
// CHECK2-NEXT:    [[TMP45:%.*]] = bitcast %struct.S* [[REF_TMP]] to i8*
...
// CHECK2-NEXT:    [[TMP46:%.*]] = load float, float* [[TMP8]], align 4
// CHECK2-NEXT:    [[TMP47:%.*]] = load float, float* [[T_VAR1]], align 4
// CHECK2-NEXT:    [[CMP9:%.*]] = fcmp olt float [[TMP46]], [[TMP47]]
// CHECK2-NEXT:    br i1 [[CMP9]], label [[COND_TRUE:%.*]], label [[COND_FALSE:%.*]]
// CHECK2:       cond.true:
// CHECK2-NEXT:    [[TMP48:%.*]] = load float, float* [[TMP8]], align 4
// CHECK2-NEXT:    br label [[COND_END:%.*]]
// CHECK2:       cond.false:
// CHECK2-NEXT:    [[TMP49:%.*]] = load float, float* [[T_VAR1]], align 4
// CHECK2-NEXT:    br label [[COND_END]]
// CHECK2:       cond.end:
// CHECK2-NEXT:    [[COND:%.*]] = phi float [ [[TMP48]], [[COND_TRUE]] ], [ [[TMP49]], [[COND_FALSE]] ]
// CHECK2-NEXT:    store float [[COND]], float* [[TMP8]], align 4
// CHECK2-NEXT:    call void @__kmpc_end_reduce(%struct.ident_t* @[[GLOB2]], i32 [[TMP14]], [8 x i32]* @.gomp_critical_user_.reduction.var)
// CHECK2-NEXT:    br label [[DOTOMP_REDUCTION_DEFAULT]]
// CHECK2:       .omp.reduction.case2:
// CHECK2-NEXT:    [[TMP50:%.*]] = load float, float* [[T_VAR]], align 4
// CHECK2-NEXT:    [[TMP51:%.*]] = bitcast float* [[TMP2]] to i32*
// CHECK2-NEXT:    [[ATOMIC_LOAD:%.*]] = load atomic i32, i32* [[TMP51]] monotonic, align 4
// CHECK2-NEXT:    br label [[ATOMIC_CONT:%.*]]
// CHECK2:       atomic_cont:
// CHECK2-NEXT:    [[TMP52:%.*]] = phi i32 [ [[ATOMIC_LOAD]], [[DOTOMP_REDUCTION_CASE2]] ], [ [[TMP60:%.*]], [[ATOMIC_CONT]] ]
...
// CHECK2-NEXT:    [[TMP56:%.*]] = load float, float* [[T_VAR]], align 4
// CHECK2-NEXT:    [[ADD10:%.*]] = fadd float [[TMP55]], [[TMP56]]
// CHECK2-NEXT:    store float [[ADD10]], float* [[ATOMIC_TEMP]], align 4
// CHECK2-NEXT:    [[TMP57:%.*]] = load i32, i32* [[TMP53]], align 4
// CHECK2-NEXT:    [[TMP58:%.*]] = bitcast float* [[TMP2]] to i32*
// CHECK2-NEXT:    [[TMP59:%.*]] = cmpxchg i32* [[TMP58]], i32 [[TMP52]], i32 [[TMP57]] monotonic monotonic, align 4
// CHECK2-NEXT:    [[TMP60]] = extractvalue { i32, i1 } [[TMP59]], 0
// CHECK2-NEXT:    [[TMP61:%.*]] = extractvalue { i32, i1 } [[TMP59]], 1
// CHECK2-NEXT:    br i1 [[TMP61]], label [[ATOMIC_EXIT:%.*]], label [[ATOMIC_CONT]]
// CHECK2:       atomic_exit:
// CHECK2-NEXT:    call void @__kmpc_critical(%struct.ident_t* @[[GLOB3]], i32 [[TMP14]], [8 x i32]* @.gomp_critical_user_.atomic_reduction.var)
// CHECK2-NEXT:    [[CALL11:%.*]] = call nonnull align 4 dereferenceable(4) %struct.S* @_ZN1SIfEanERKS0_(%struct.S* nonnull align 4 dereferenceable(4) [[TMP4]], %struct.S* nonnull align 4 dereferenceable(4) [[VAR]])
// CHECK2-NEXT:    [[TMP62:%.*]] = bitcast %struct.S* [[TMP4]] to i8*
// CHECK2-NEXT:    [[TMP63:%.*]] = bitcast %struct.S* [[CALL11]] to i8*
// CHECK2-NEXT:    call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 4 [[TMP62]], i8* align 4 [[TMP63]], i64 4, i1 false)
// CHECK2-NEXT:    call void @__kmpc_end_critical(%struct.ident_t* @[[GLOB3]], i32 [[TMP14]], [8 x i32]* @.gomp_critical_user_.atomic_reduction.var)
// CHECK2-NEXT:    call void @__kmpc_critical(%struct.ident_t* @[[GLOB3]], i32 [[TMP14]], [8 x i32]* @.gomp_critical_user_.atomic_reduction.var)
// CHECK2-NEXT:    [[CALL13:%.*]] = call float @_ZN1SIfEcvfEv(%struct.S* nonnull align 4 dereferenceable(4) [[TMP6]])
// CHECK2-NEXT:    [[TOBOOL14:%.*]] = fcmp une float [[CALL13]], 0.000000e+00
// CHECK2-NEXT:    br i1 [[TOBOOL14]], label [[LAND_RHS15:%.*]], label [[LAND_END18:%.*]]
// CHECK2:       land.rhs15:
// CHECK2-NEXT:    [[CALL16:%.*]] = call float @_ZN1SIfEcvfEv(%struct.S* nonnull align 4 dereferenceable(4) [[VAR1]])
// CHECK2-NEXT:    [[TOBOOL17:%.*]] = fcmp une float [[CALL16]], 0.000000e+00
// CHECK2-NEXT:    br label [[LAND_END18]]
// CHECK2:       land.end18:
// CHECK2-NEXT:    [[TMP64:%.*]] = phi i1 [ false, [[ATOMIC_EXIT]] ], [ [[TOBOOL17]], [[LAND_RHS15]] ]
// CHECK2-NEXT:    [[CONV19:%.*]] = uitofp i1 [[TMP64]] to float
// CHECK2-NEXT:    call void @_ZN1SIfEC1Ef(%struct.S* nonnull align 4 dereferenceable(4) [[REF_TMP12]], float [[CONV19]])
// CHECK2-NEXT:    [[TMP65:%.*]] = bitcast %struct.S* [[TMP6]] to i8*
// CHECK2-NEXT:    [[TMP66:%.*]] = bitcast %struct.S* [[REF_TMP12]] to i8*
// CHECK2-NEXT:    call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 4 [[TMP65]], i8* align 4 [[TMP66]], i64 4, i1 false)
// CHECK2-NEXT:    call void @_ZN1SIfED1Ev(%struct.S* nonnull align 4 dereferenceable(4) [[REF_TMP12]]) #[[ATTR4]]
// CHECK2-NEXT:    call void @__kmpc_end_critical(%struct.ident_t* @[[GLOB3]], i32 [[TMP14]], [8 x i32]* @.gomp_critical_user_.atomic_reduction.var)
// CHECK2-NEXT:    [[TMP67:%.*]] = load float, float* [[T_VAR1]], align 4
// CHECK2-NEXT:    [[TMP68:%.*]] = bitcast float* [[TMP8]] to i32*
// CHECK2-NEXT:    [[ATOMIC_LOAD20:%.*]] = load atomic i32, i32* [[TMP68]] monotonic, align 4
// CHECK2-NEXT:    br label [[ATOMIC_CONT21:%.*]]
// CHECK2:       atomic_cont21:
// CHECK2-NEXT:    [[TMP69:%.*]] = phi i32 [ [[ATOMIC_LOAD20]], [[LAND_END18]] ], [ [[TMP79:%.*]], [[COND_END27:%.*]] ]
// CHECK2-NEXT:    [[TMP70:%.*]] = bitcast float* [[ATOMIC_TEMP22]] to i32*
// CHECK2-NEXT:    [[TMP71:%.*]] = bitcast i32 [[TMP69]] to float
// CHECK2-NEXT:    store float [[TMP71]], float* [[_TMP23]], align 4
// CHECK2-NEXT:    [[TMP72:%.*]] = load float, float* [[_TMP23]], align 4
// CHECK2-NEXT:    [[TMP73:%.*]] = load float, float* [[T_VAR1]], align 4
// CHECK2-NEXT:    [[CMP24:%.*]] = fcmp olt float [[TMP72]], [[TMP73]]
// CHECK2-NEXT:    br i1 [[CMP24]], label [[COND_TRUE25:%.*]], label [[COND_FALSE26:%.*]]
// CHECK2:       cond.true25:
// CHECK2-NEXT:    [[TMP74:%.*]] = load float, float* [[_TMP23]], align 4
// CHECK2-NEXT:    br label [[COND_END27]]
// CHECK2:       cond.false26:
// CHECK2-NEXT:    [[TMP75:%.*]] = load float, float* [[T_VAR1]], align 4
// CHECK2-NEXT:    br label [[COND_END27]]
// CHECK2:       cond.end27:
// CHECK2-NEXT:    [[COND28:%.*]] = phi float [ [[TMP74]], [[COND_TRUE25]] ], [ [[TMP75]], [[COND_FALSE26]] ]
// CHECK2-NEXT:    store float [[COND28]], float* [[ATOMIC_TEMP22]], align 4
// CHECK2-NEXT:    [[TMP76:%.*]] = load i32, i32* [[TMP70]], align 4
// CHECK2-NEXT:    [[TMP77:%.*]] = bitcast float* [[TMP8]] to i32*
// CHECK2-NEXT:    [[TMP78:%.*]] = cmpxchg i32* [[TMP77]], i32 [[TMP69]], i32 [[TMP76]] monotonic monotonic, align 4
// CHECK2-NEXT:    [[TMP79]] = extractvalue { i32, i1 } [[TMP78]], 0
// CHECK2-NEXT:    [[TMP80:%.*]] = extractvalue { i32, i1 } [[TMP78]], 1
// CHECK2-NEXT:    br i1 [[TMP80]], label [[ATOMIC_EXIT29:%.*]], label [[ATOMIC_CONT21]]
// CHECK2:       atomic_exit29:
// CHECK2-NEXT:    call void @__kmpc_end_reduce(%struct.ident_t* @[[GLOB2]], i32 [[TMP14]], [8 x i32]* @.gomp_critical_user_.reduction.var)
// CHECK2-NEXT:    br label [[DOTOMP_REDUCTION_DEFAULT]]
// CHECK2:       .omp.reduction.default:
// CHECK2-NEXT:    call void @_ZN1SIfED1Ev(%struct.S* nonnull align 4 dereferenceable(4) [[VAR1]]) #[[ATTR4]]
// CHECK2-NEXT:    call void @_ZN1SIfED1Ev(%struct.S* nonnull align 4 dereferenceable(4) [[VAR]]) #[[ATTR4]]
...
// CHECK2-NEXT:    store %struct.S.0* [[VAR]], %struct.S.0** [[TMP2]], align 8
// CHECK2-NEXT:    [[TMP3:%.*]] = getelementptr inbounds [[STRUCT_ANON_1]], %struct.anon.1* [[OMP_OUTLINED_ARG_AGG_]], i32 0, i32 2
// CHECK2-NEXT:    store %struct.S.0* [[VAR1]], %struct.S.0** [[TMP3]], align 8
// CHECK2-NEXT:    [[TMP4:%.*]] = getelementptr inbounds [[STRUCT_ANON_1]], %struct.anon.1* [[OMP_OUTLINED_ARG_AGG_]], i32 0, i32 3
// CHECK2-NEXT:    store i32* [[T_VAR1]], i32** [[TMP4]], align 8
// CHECK2-NEXT:    [[TMP5:%.*]] = getelementptr inbounds [[STRUCT_ANON_1]], %struct.anon.1* [[OMP_OUTLINED_ARG_AGG_]], i32 0, i32 4
// CHECK2-NEXT:    store [2 x i32]* [[VEC]], [2 x i32]** [[TMP5]], align 8
// CHECK2-NEXT:    [[TMP6:%.*]] = getelementptr inbounds [[STRUCT_ANON_1]], %struct.anon.1* [[OMP_OUTLINED_ARG_AGG_]], i32 0, i32 5
// CHECK2-NEXT:    store [2 x %struct.S.0]* [[S_ARR]], [2 x %struct.S.0]** [[TMP6]], align 8
...
// CHECK2-NEXT:    [[TMP7:%.*]] = getelementptr inbounds [[STRUCT_S_0]], %struct.S.0* [[ARRAY_BEGIN]], i64 2
// CHECK2-NEXT:    br label [[ARRAYDESTROY_BODY:%.*]]
// CHECK2:       arraydestroy.body:
// CHECK2-NEXT:    [[ARRAYDESTROY_ELEMENTPAST:%.*]] = phi %struct.S.0* [ [[TMP7]], [[ENTRY:%.*]] ], [ [[ARRAYDESTROY_ELEMENT:%.*]], [[ARRAYDESTROY_BODY]] ]
...
// CHECK2-NEXT:    [[REF_TMP8:%.*]] = alloca [[STRUCT_S_0]], align 4
// CHECK2-NEXT:    store i32* [[DOTGLOBAL_TID_]], i32** [[DOTGLOBAL_TID__ADDR]], align 8
// CHECK2-NEXT:    store i32* [[DOTBOUND_TID_]], i32** [[DOTBOUND_TID__ADDR]], align 8
...
// CHECK2-NEXT:    [[TMP12:%.*]] = load [2 x %struct.S.0]*, [2 x %struct.S.0]** [[TMP11]], align 8
// CHECK2-NEXT:    store i32 0, i32* [[DOTOMP_SECTIONS_LB_]], align 4
...
// CHECK2-NEXT:    [[TMP13:%.*]] = load i32*, i32** [[DOTGLOBAL_TID__ADDR]], align 8
// CHECK2-NEXT:    [[TMP14:%.*]] = load i32, i32* [[TMP13]], align 4
// CHECK2-NEXT:    call void @__kmpc_for_static_init_4(%struct.ident_t* @[[GLOB1]], i32 [[TMP14]], i32 34, i32* [[DOTOMP_SECTIONS_IL_]], i32* [[DOTOMP_SECTIONS_LB_]], i32* [[DOTOMP_SECTIONS_UB_]], i32* [[DOTOMP_SECTIONS_ST_]], i32 1, i32 1)
// CHECK2-NEXT:    [[TMP15:%.*]] = load i32, i32* [[DOTOMP_SECTIONS_UB_]], align 4
...
// CHECK2-NEXT:    [[ARRAYIDX2:%.*]] = getelementptr inbounds [2 x %struct.S.0], [2 x %struct.S.0]* [[TMP12]], i64 0, i64 0
// CHECK2-NEXT:    [[TMP23:%.*]] = bitcast %struct.S.0* [[ARRAYIDX2]] to i8*
// CHECK2-NEXT:    [[TMP24:%.*]] = bitcast %struct.S.0* [[VAR]] to i8*
// CHECK2-NEXT:    call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 4 [[TMP23]], i8* align 4 [[TMP24]], i64 4, i1 false)
// CHECK2-NEXT:    br label [[DOTOMP_SECTIONS_EXIT]]
// CHECK2:       .omp.sections.exit:
// CHECK2-NEXT:    br label [[OMP_INNER_FOR_INC:%.*]]
// CHECK2:       omp.inner.for.inc:
// CHECK2-NEXT:    [[TMP25:%.*]] = load i32, i32* [[DOTOMP_SECTIONS_IV_]], align 4
...
// CHECK2-NEXT:    [[TMP27:%.*]] = bitcast i32* [[T_VAR]] to i8*
...
// CHECK2-NEXT:    [[TMP29:%.*]] = bitcast %struct.S.0* [[VAR]] to i8*
...
// CHECK2-NEXT:    [[TMP31:%.*]] = bitcast %struct.S.0* [[VAR1]] to i8*
...
// CHECK2-NEXT:    [[TMP33:%.*]] = bitcast i32* [[T_VAR1]] to i8*
// CHECK2-NEXT:    store i8* [[TMP33]], i8** [[TMP32]], align 8
// CHECK2-NEXT:    [[TMP34:%.*]] = bitcast [4 x i8*]* [[DOTOMP_REDUCTION_RED_LIST]] to i8*
// CHECK2-NEXT:    [[TMP35:%.*]] = call i32 @__kmpc_reduce_nowait(%struct.ident_t* @[[GLOB2]], i32 [[TMP14]], i32 4, i64 32, i8* [[TMP34]], void (i8*, i8*)* @.omp.reduction.reduction_func.2, [8 x i32]* @.gomp_critical_user_.reduction.var)
// CHECK2-NEXT:    switch i32 [[TMP35]], label [[DOTOMP_REDUCTION_DEFAULT:%.*]] [
// CHECK2-NEXT:    i32 1, label [[DOTOMP_REDUCTION_CASE1:%.*]]
// CHECK2-NEXT:    i32 2, label [[DOTOMP_REDUCTION_CASE2:%.*]]
// CHECK2-NEXT:    ]
// CHECK2:       .omp.reduction.case1:
// CHECK2-NEXT:    [[TMP36:%.*]] = load i32, i32* [[TMP2]], align 4
// CHECK2-NEXT:    [[TMP37:%.*]] = load i32, i32* [[T_VAR]], align 4
// CHECK2-NEXT:    [[ADD:%.*]] = add nsw i32 [[TMP36]], [[TMP37]]
// CHECK2-NEXT:    store i32 [[ADD]], i32* [[TMP2]], align 4
// CHECK2-NEXT:    [[CALL:%.*]] = call nonnull align 4 dereferenceable(4) %struct.S.0* @_ZN1SIiEanERKS0_(%struct.S.0* nonnull align 4 dereferenceable(4) [[TMP4]], %struct.S.0* nonnull align 4 dereferenceable(4) [[VAR]])
// CHECK2-NEXT:    [[TMP38:%.*]] = bitcast %struct.S.0* [[TMP4]] to i8*
// CHECK2-NEXT:    [[TMP39:%.*]] = bitcast %struct.S.0* [[CALL]] to i8*
// CHECK2-NEXT:    call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 4 [[TMP38]], i8* align 4 [[TMP39]], i64 4, i1 false)
// CHECK2-NEXT:    [[CALL3:%.*]] = call i32 @_ZN1SIiEcviEv(%struct.S.0* nonnull align 4 dereferenceable(4) [[TMP6]])
// CHECK2-NEXT:    [[TOBOOL:%.*]] = icmp ne i32 [[CALL3]], 0
// CHECK2-NEXT:    br i1 [[TOBOOL]], label [[LAND_RHS:%.*]], label [[LAND_END:%.*]]
// CHECK2:       land.rhs:
// CHECK2-NEXT:    [[CALL4:%.*]] = call i32 @_ZN1SIiEcviEv(%struct.S.0* nonnull align 4 dereferenceable(4) [[VAR1]])
// CHECK2-NEXT:    [[TOBOOL5:%.*]] = icmp ne i32 [[CALL4]], 0
// CHECK2-NEXT:    br label [[LAND_END]]
// CHECK2:       land.end:
// CHECK2-NEXT:    [[TMP40:%.*]] = phi i1 [ false, [[DOTOMP_REDUCTION_CASE1]] ], [ [[TOBOOL5]], [[LAND_RHS]] ]
// CHECK2-NEXT:    [[CONV:%.*]] = zext i1 [[TMP40]] to i32
// CHECK2-NEXT:    call void @_ZN1SIiEC1Ei(%struct.S.0* nonnull align 4 dereferenceable(4) [[REF_TMP]], i32 [[CONV]])
// CHECK2-NEXT:    [[TMP41:%.*]] = bitcast %struct.S.0* [[TMP6]] to i8*
// CHECK2-NEXT:    [[TMP42:%.*]] = bitcast %struct.S.0* [[REF_TMP]] to i8*
// CHECK2-NEXT:    call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 4 [[TMP41]], i8* align 4 [[TMP42]], i64 4, i1 false)
// CHECK2-NEXT:    call void @_ZN1SIiED1Ev(%struct.S.0* nonnull align 4 dereferenceable(4) [[REF_TMP]]) #[[ATTR4]]
// CHECK2-NEXT:    [[TMP43:%.*]] = load i32, i32* [[TMP8]], align 4
// CHECK2-NEXT:    [[TMP44:%.*]] = load i32, i32* [[T_VAR1]], align 4
// CHECK2-NEXT:    [[CMP6:%.*]] = icmp slt i32 [[TMP43]], [[TMP44]]
// CHECK2-NEXT:    br i1 [[CMP6]], label [[COND_TRUE:%.*]], label [[COND_FALSE:%.*]]
// CHECK2:       cond.true:
// CHECK2-NEXT:    [[TMP45:%.*]] = load i32, i32* [[TMP8]], align 4
// CHECK2-NEXT:    br label [[COND_END:%.*]]
// CHECK2:       cond.false:
// CHECK2-NEXT:    [[TMP46:%.*]] = load i32, i32* [[T_VAR1]], align 4
// CHECK2-NEXT:    br label [[COND_END]]
// CHECK2:       cond.end:
// CHECK2-NEXT:    [[COND:%.*]] = phi i32 [ [[TMP45]], [[COND_TRUE]] ], [ [[TMP46]], [[COND_FALSE]] ]
// CHECK2-NEXT:    store i32 [[COND]], i32* [[TMP8]], align 4
// CHECK2-NEXT:    call void @__kmpc_end_reduce_nowait(%struct.ident_t* @[[GLOB2]], i32 [[TMP14]], [8 x i32]* @.gomp_critical_user_.reduction.var)
// CHECK2-NEXT:    br label [[DOTOMP_REDUCTION_DEFAULT]]
// CHECK2:       .omp.reduction.case2:
// CHECK2-NEXT:    [[TMP47:%.*]] = load i32, i32* [[T_VAR]], align 4
// CHECK2-NEXT:    [[TMP48:%.*]] = atomicrmw add i32* [[TMP2]], i32 [[TMP47]] monotonic, align 4
// CHECK2-NEXT:    call void @__kmpc_critical(%struct.ident_t* @[[GLOB3]], i32 [[TMP14]], [8 x i32]* @.gomp_critical_user_.atomic_reduction.var)
// CHECK2-NEXT:    [[CALL7:%.*]] = call nonnull align 4 dereferenceable(4) %struct.S.0* @_ZN1SIiEanERKS0_(%struct.S.0* nonnull align 4 dereferenceable(4) [[TMP4]], %struct.S.0* nonnull align 4 dereferenceable(4) [[VAR]])
// CHECK2-NEXT:    [[TMP49:%.*]] = bitcast %struct.S.0* [[TMP4]] to i8*
// CHECK2-NEXT:    [[TMP50:%.*]] = bitcast %struct.S.0* [[CALL7]] to i8*
// CHECK2-NEXT:    call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 4 [[TMP49]], i8* align 4 [[TMP50]], i64 4, i1 false)
// CHECK2-NEXT:    call void @__kmpc_end_critical(%struct.ident_t* @[[GLOB3]], i32 [[TMP14]], [8 x i32]* @.gomp_critical_user_.atomic_reduction.var)
// CHECK2-NEXT:    call void @__kmpc_critical(%struct.ident_t* @[[GLOB3]], i32 [[TMP14]], [8 x i32]* @.gomp_critical_user_.atomic_reduction.var)
// CHECK2-NEXT:    [[CALL9:%.*]] = call i32 @_ZN1SIiEcviEv(%struct.S.0* nonnull align 4 dereferenceable(4) [[TMP6]])
// CHECK2-NEXT:    [[TOBOOL10:%.*]] = icmp ne i32 [[CALL9]], 0
// CHECK2-NEXT:    br i1 [[TOBOOL10]], label [[LAND_RHS11:%.*]], label [[LAND_END14:%.*]]
// CHECK2:       land.rhs11:
// CHECK2-NEXT:    [[CALL12:%.*]] = call i32 @_ZN1SIiEcviEv(%struct.S.0* nonnull align 4 dereferenceable(4) [[VAR1]])
// CHECK2-NEXT:    [[TOBOOL13:%.*]] = icmp ne i32 [[CALL12]], 0
// CHECK2-NEXT:    br label [[LAND_END14]]
// CHECK2:       land.end14:
// CHECK2-NEXT:    [[TMP51:%.*]] = phi i1 [ false, [[DOTOMP_REDUCTION_CASE2]] ], [ [[TOBOOL13]], [[LAND_RHS11]] ]
// CHECK2-NEXT:    [[CONV15:%.*]] = zext i1 [[TMP51]] to i32
// CHECK2-NEXT:    call void @_ZN1SIiEC1Ei(%struct.S.0* nonnull align 4 dereferenceable(4) [[REF_TMP8]], i32 [[CONV15]])
// CHECK2-NEXT:    [[TMP52:%.*]] = bitcast %struct.S.0* [[TMP6]] to i8*
// CHECK2-NEXT:    [[TMP53:%.*]] = bitcast %struct.S.0* [[REF_TMP8]] to i8*
// CHECK2-NEXT:    call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 4 [[TMP52]], i8* align 4 [[TMP53]], i64 4, i1 false)
// CHECK2-NEXT:    call void @_ZN1SIiED1Ev(%struct.S.0* nonnull align 4 dereferenceable(4) [[REF_TMP8]]) #[[ATTR4]]
// CHECK2-NEXT:    call void @__kmpc_end_critical(%struct.ident_t* @[[GLOB3]], i32 [[TMP14]], [8 x i32]* @.gomp_critical_user_.atomic_reduction.var)
// CHECK2-NEXT:    [[TMP54:%.*]] = load i32, i32* [[T_VAR1]], align 4
// CHECK2-NEXT:    [[TMP55:%.*]] = atomicrmw min i32* [[TMP8]], i32 [[TMP54]] monotonic, align 4
// CHECK2-NEXT:    br label [[DOTOMP_REDUCTION_DEFAULT]]
// CHECK2:       .omp.reduction.default:
// CHECK2-NEXT:    call void @_ZN1SIiED1Ev(%struct.S.0* nonnull align 4 dereferenceable(4) [[VAR1]]) #[[ATTR4]]
// CHECK2-NEXT:    call void @_ZN1SIiED1Ev(%struct.S.0* nonnull align 4 dereferenceable(4) [[VAR]]) #[[ATTR4]]
...
// CHECK3:       atomic_cont:
// CHECK3-NEXT:    [[TMP19:%.*]] = phi i64 [ [[ATOMIC_LOAD]], [[DOTOMP_REDUCTION_CASE2]] ], [ [[TMP26:%.*]], [[ATOMIC_CONT]] ]
// CHECK3-NEXT:    [[TMP20:%.*]] = bitcast double* [[ATOMIC_TEMP]] to i64*
// CHECK3-NEXT:    [[TMP21:%.*]] = bitcast i64 [[TMP19]] to double
// CHECK3-NEXT:    store double [[TMP21]], double* [[TMP]], align 8
// CHECK3-NEXT:    [[TMP22:%.*]] = load double, double* [[TMP]], align 8
// CHECK3-NEXT:    [[TMP23:%.*]] = load double, double* [[G]], align 8
// CHECK3-NEXT:    [[ADD2:%.*]] = fadd double [[TMP22]], [[TMP23]]
// CHECK3-NEXT:    store double [[ADD2]], double* [[ATOMIC_TEMP]], align 8
// CHECK3-NEXT:    [[TMP24:%.*]] = load i64, i64* [[TMP20]], align 8
// CHECK3-NEXT:    [[TMP25:%.*]] = cmpxchg i64* bitcast (double* @g to i64*), i64 [[TMP19]], i64 [[TMP24]] monotonic monotonic, align 8
// CHECK3-NEXT:    [[TMP26]] = extractvalue { i64, i1 } [[TMP25]], 0
// CHECK3-NEXT:    [[TMP27:%.*]] = extractvalue { i64, i1 } [[TMP25]], 1
// CHECK3-NEXT:    br i1 [[TMP27]], label [[ATOMIC_EXIT:%.*]], label [[ATOMIC_CONT]]
// CHECK3:       atomic_exit:
// CHECK3-NEXT:    call void @__kmpc_end_reduce(%struct.ident_t* @[[GLOB2]], i32 [[TMP2]], [8 x i32]* @.gomp_critical_user_.reduction.var)
// CHECK3-NEXT:    br label [[DOTOMP_REDUCTION_DEFAULT]]
...
// CHECK4:       atomic_cont:
// CHECK4-NEXT:    [[TMP24:%.*]] = phi i64 [ [[ATOMIC_LOAD]], [[DOTOMP_REDUCTION_CASE2]] ], [ [[TMP31:%.*]], [[ATOMIC_CONT]] ]
// CHECK4-NEXT:    [[TMP25:%.*]] = bitcast double* [[ATOMIC_TEMP]] to i64*
// CHECK4-NEXT:    [[TMP26:%.*]] = bitcast i64 [[TMP24]] to double
// CHECK4-NEXT:    store double [[TMP26]], double* [[TMP]], align 8
// CHECK4-NEXT:    [[TMP27:%.*]] = load double, double* [[TMP]], align 8
// CHECK4-NEXT:    [[TMP28:%.*]] = load double, double* [[G]], align 8
// CHECK4-NEXT:    [[ADD2:%.*]] = fadd double [[TMP27]], [[TMP28]]
// CHECK4-NEXT:    store double [[ADD2]], double* [[ATOMIC_TEMP]], align 8
// CHECK4-NEXT:    [[TMP29:%.*]] = load i64, i64* [[TMP25]], align 8
// CHECK4-NEXT:    [[TMP30:%.*]] = cmpxchg i64* bitcast (double* @g to i64*), i64 [[TMP24]], i64 [[TMP29]] monotonic monotonic, align 8
// CHECK4-NEXT:    [[TMP31]] = extractvalue { i64, i1 } [[TMP30]], 0
// CHECK4-NEXT:    [[TMP32:%.*]] = extractvalue { i64, i1 } [[TMP30]], 1
