...
// CHECK9-NEXT:    [[ADD:%.*]] = add nsw i32 [[TMP27]], [[TMP28]]
...
// CHECK9-NEXT:    store i32* [[TMP2]], i32** [[TMP27]], align 8
...
// CHECK9-NEXT:    store i32* [[TMP6]], i32** [[TMP29]], align 8
...
// CHECK9-NEXT:    store i32 [[TMP31]], i32* [[TMP30]], align 8
...
// CHECK9-NEXT:    [[ADD9:%.*]] = add nsw i32 [[TMP36]], [[TMP37]]
...
// CHECK9-NEXT:    [[CMP10:%.*]] = icmp sgt i32 [[TMP38]], [[TMP39]]
...
// CHECK9-NEXT:    br label [[COND_END13]]
// CHECK9:       cond.end13:
// CHECK9-NEXT:    [[COND14:%.*]] = phi i32 [ [[TMP40]], [[COND_TRUE11]] ], [ [[TMP41]], [[COND_FALSE12]] ]
// CHECK9-NEXT:    store i32 [[COND14]], i32* [[DOTOMP_COMB_UB]], align 4
// CHECK9-NEXT:    [[TMP42:%.*]] = load i32, i32* [[DOTOMP_COMB_LB]], align 4
// CHECK9-NEXT:    store i32 [[TMP42]], i32* [[DOTOMP_IV]], align 4
// CHECK9-NEXT:    br label [[OMP_INNER_FOR_COND]]
// CHECK9:       omp.inner.for.end:
// CHECK9-NEXT:    br label [[OMP_LOOP_EXIT:%.*]]
// CHECK9:       omp.loop.exit:
...
// CHECK10-NEXT:    store i32* [[TMP2]], i32** [[TMP27]], align 8
...
// CHECK10-NEXT:    store i32* [[TMP6]], i32** [[TMP29]], align 8
...
// CHECK10-NEXT:    [[ADD9:%.*]] = add nsw i32 [[TMP36]], [[TMP37]]
...
// CHECK10-NEXT:    [[CMP10:%.*]] = icmp sgt i32 [[TMP38]], [[TMP39]]
...
// CHECK10-NEXT:    br label [[COND_END13]]
// CHECK10:       cond.end13:
// CHECK10-NEXT:    [[COND14:%.*]] = phi i32 [ [[TMP40]], [[COND_TRUE11]] ], [ [[TMP41]], [[COND_FALSE12]] ]
// CHECK10-NEXT:    store i32 [[COND14]], i32* [[DOTOMP_COMB_UB]], align 4
// CHECK10-NEXT:    [[TMP42:%.*]] = load i32, i32* [[DOTOMP_COMB_LB]], align 4
// CHECK10-NEXT:    store i32 [[TMP42]], i32* [[DOTOMP_IV]], align 4
// CHECK10-NEXT:    br label [[OMP_INNER_FOR_COND]]
// CHECK10:       omp.inner.for.end:
// CHECK10-NEXT:    br label [[OMP_LOOP_EXIT:%.*]]
// CHECK10:       omp.loop.exit:
...
// CHECK11-NEXT:    store i32* [[TMP2]], i32** [[TMP22]], align 4
...
// CHECK11-NEXT:    store i32* [[TMP6]], i32** [[TMP24]], align 4
...
// CHECK11-NEXT:    [[ADD:%.*]] = add nsw i32 [[TMP25]], [[TMP26]]
...
// CHECK11-NEXT:    store i32* [[TMP2]], i32** [[TMP25]], align 4
...
// CHECK11-NEXT:    store i32* [[TMP6]], i32** [[TMP27]], align 4
...
// CHECK11-NEXT:    [[ADD7:%.*]] = add nsw i32 [[TMP30]], [[TMP31]]
...
// CHECK11-NEXT:    [[ADD8:%.*]] = add nsw i32 [[TMP32]], [[TMP33]]
// CHECK11-NEXT:    store i32 [[ADD8]], i32* [[DOTOMP_COMB_LB]], align 4
// CHECK11-NEXT:    [[TMP34:%.*]] = load i32, i32* [[DOTOMP_COMB_UB]], align 4
// CHECK11-NEXT:    [[TMP35:%.*]] = load i32, i32* [[DOTOMP_STRIDE]], align 4
// CHECK11-NEXT:    [[ADD9:%.*]] = add nsw i32 [[TMP34]], [[TMP35]]
...
// CHECK11-NEXT:    [[CMP10:%.*]] = icmp sgt i32 [[TMP36]], [[TMP37]]
...
// CHECK11-NEXT:    br label [[COND_END13]]
// CHECK11:       cond.end13:
// CHECK11-NEXT:    [[COND14:%.*]] = phi i32 [ [[TMP38]], [[COND_TRUE11]] ], [ [[TMP39]], [[COND_FALSE12]] ]
// CHECK11-NEXT:    store i32 [[COND14]], i32* [[DOTOMP_COMB_UB]], align 4
// CHECK11-NEXT:    [[TMP40:%.*]] = load i32, i32* [[DOTOMP_COMB_LB]], align 4
// CHECK11-NEXT:    store i32 [[TMP40]], i32* [[DOTOMP_IV]], align 4
// CHECK11-NEXT:    br label [[OMP_INNER_FOR_COND]]
// CHECK11:       omp.inner.for.end:
// CHECK11-NEXT:    br label [[OMP_LOOP_EXIT:%.*]]
// CHECK11:       omp.loop.exit:
...
// CHECK12-NEXT:    store i32* [[TMP2]], i32** [[TMP22]], align 4
...
// CHECK12-NEXT:    store i32* [[TMP6]], i32** [[TMP24]], align 4
...
// CHECK12-NEXT:    [[ADD:%.*]] = add nsw i32 [[TMP25]], [[TMP26]]
...
// CHECK12-NEXT:    store i32* [[TMP2]], i32** [[TMP25]], align 4
...
// CHECK12-NEXT:    store i32* [[TMP6]], i32** [[TMP27]], align 4
...
// CHECK12-NEXT:    [[ADD7:%.*]] = add nsw i32 [[TMP30]], [[TMP31]]
...
// CHECK12-NEXT:    [[ADD8:%.*]] = add nsw i32 [[TMP32]], [[TMP33]]
// CHECK12-NEXT:    store i32 [[ADD8]], i32* [[DOTOMP_COMB_LB]], align 4
// CHECK12-NEXT:    [[TMP34:%.*]] = load i32, i32* [[DOTOMP_COMB_UB]], align 4
// CHECK12-NEXT:    [[TMP35:%.*]] = load i32, i32* [[DOTOMP_STRIDE]], align 4
// CHECK12-NEXT:    [[ADD9:%.*]] = add nsw i32 [[TMP34]], [[TMP35]]
...
// CHECK12-NEXT:    [[CMP10:%.*]] = icmp sgt i32 [[TMP36]], [[TMP37]]
...
// CHECK12-NEXT:    br label [[COND_END13]]
// CHECK12:       cond.end13:
// CHECK12-NEXT:    [[COND14:%.*]] = phi i32 [ [[TMP38]], [[COND_TRUE11]] ], [ [[TMP39]], [[COND_FALSE12]] ]
// CHECK12-NEXT:    store i32 [[COND14]], i32* [[DOTOMP_COMB_UB]], align 4
// CHECK12-NEXT:    [[TMP40:%.*]] = load i32, i32* [[DOTOMP_COMB_LB]], align 4
// CHECK12-NEXT:    store i32 [[TMP40]], i32* [[DOTOMP_IV]], align 4
// CHECK12-NEXT:    br label [[OMP_INNER_FOR_COND]]
// CHECK12:       omp.inner.for.end:
// CHECK12-NEXT:    br label [[OMP_LOOP_EXIT:%.*]]
// CHECK12:       omp.loop.exit:
// CHECK12-NEXT:    [[TMP41:%.*]] = load i32*, i32** [[DOTGLOBAL_TID__ADDR]], align 4
// CHECK12-NEXT:    [[TMP42:%.*]] = load i32, i32* [[TMP41]], align 4
// CHECK12-NEXT:    call void @__kmpc_for_static_fini(%struct.ident_t* @[[GLOB1]], i32 [[TMP42]])
// CHECK12-NEXT:    br label [[OMP_PRECOND_END]]
// CHECK12:       omp.precond.end:
// CHECK12-NEXT:    ret void
//
