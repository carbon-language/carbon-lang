...
// CHECK1-NEXT:    [[TMP68:%.*]] = getelementptr inbounds [[STRUCT_ANON_0]], %struct.anon.0* [[OMP_OUTLINED_ARG_AGG_]], i32 0, i32 1
// CHECK1-NEXT:    [[TMP69:%.*]] = load i8**, i8*** [[TMP]], align 8
// CHECK1-NEXT:    store i8** [[TMP69]], i8*** [[TMP68]], align 8
// CHECK1-NEXT:    call void (%struct.ident_t*, i32, void (i32*, i32*, ...)*, ...) @__kmpc_fork_call(%struct.ident_t* @[[GLOB1]], i32 3, void (i32*, i32*, ...)* bitcast (void (i32*, i32*, i64, i64, %struct.anon.0*)* @.omp_outlined..3 to void (i32*, i32*, ...)*), i64 [[TMP65]], i64 [[TMP66]], %struct.anon.0* [[OMP_OUTLINED_ARG_AGG_]])
// CHECK1-NEXT:    br label [[OMP_INNER_FOR_INC:%.*]]
// CHECK1:       omp.inner.for.inc:
// CHECK1-NEXT:    [[TMP70:%.*]] = load i64, i64* [[DOTOMP_IV]], align 8
// CHECK1-NEXT:    [[TMP71:%.*]] = load i64, i64* [[DOTOMP_STRIDE]], align 8
// CHECK1-NEXT:    [[ADD:%.*]] = add nsw i64 [[TMP70]], [[TMP71]]
// CHECK1-NEXT:    store i64 [[ADD]], i64* [[DOTOMP_IV]], align 8
// CHECK1-NEXT:    br label [[OMP_INNER_FOR_COND]]
// CHECK1:       omp.inner.for.end:
// CHECK1-NEXT:    br label [[OMP_LOOP_EXIT:%.*]]
// CHECK1:       omp.loop.exit:
// CHECK1-NEXT:    [[TMP72:%.*]] = load i32*, i32** [[DOTGLOBAL_TID__ADDR]], align 8
// CHECK1-NEXT:    [[TMP73:%.*]] = load i32, i32* [[TMP72]], align 4
// CHECK1-NEXT:    call void @__kmpc_for_static_fini(%struct.ident_t* @[[GLOB2]], i32 [[TMP73]])
// CHECK1-NEXT:    [[TMP74:%.*]] = load i32*, i32** [[DOTGLOBAL_TID__ADDR]], align 8
// CHECK1-NEXT:    [[TMP75:%.*]] = load i32, i32* [[TMP74]], align 4
// CHECK1-NEXT:    call void @__kmpc_task_reduction_modifier_fini(%struct.ident_t* @[[GLOB1]], i32 [[TMP75]], i32 1)
// CHECK1-NEXT:    [[TMP76:%.*]] = getelementptr inbounds [3 x i8*], [3 x i8*]* [[DOTOMP_REDUCTION_RED_LIST]], i64 0, i64 0
// CHECK1-NEXT:    [[TMP77:%.*]] = bitcast i32* [[ARGC]] to i8*
// CHECK1-NEXT:    store i8* [[TMP77]], i8** [[TMP76]], align 8
// CHECK1-NEXT:    [[TMP78:%.*]] = getelementptr inbounds [3 x i8*], [3 x i8*]* [[DOTOMP_REDUCTION_RED_LIST]], i64 0, i64 1
// CHECK1-NEXT:    store i8* [[VLA]], i8** [[TMP78]], align 8
// CHECK1-NEXT:    [[TMP79:%.*]] = getelementptr inbounds [3 x i8*], [3 x i8*]* [[DOTOMP_REDUCTION_RED_LIST]], i64 0, i64 2
// CHECK1-NEXT:    [[TMP80:%.*]] = inttoptr i64 [[TMP14]] to i8*
...
// CHECK1-NEXT:    [[TMP83:%.*]] = bitcast [3 x i8*]* [[DOTOMP_REDUCTION_RED_LIST]] to i8*
// CHECK1-NEXT:    [[TMP84:%.*]] = call i32 @__kmpc_reduce_nowait(%struct.ident_t* @[[GLOB4:[0-9]+]], i32 [[TMP82]], i32 2, i64 24, i8* [[TMP83]], void (i8*, i8*)* @.omp.reduction.reduction_func.9, [8 x i32]* @.gomp_critical_user_.reduction.var)
// CHECK1-NEXT:    switch i32 [[TMP84]], label [[DOTOMP_REDUCTION_DEFAULT:%.*]] [
// CHECK1-NEXT:    i32 1, label [[DOTOMP_REDUCTION_CASE1:%.*]]
// CHECK1-NEXT:    i32 2, label [[DOTOMP_REDUCTION_CASE2:%.*]]
// CHECK1-NEXT:    ]
// CHECK1:       .omp.reduction.case1:
// CHECK1-NEXT:    [[TMP85:%.*]] = load i32, i32* [[TMP2]], align 4
// CHECK1-NEXT:    [[TMP86:%.*]] = load i32, i32* [[ARGC]], align 4
// CHECK1-NEXT:    [[ADD13:%.*]] = add nsw i32 [[TMP85]], [[TMP86]]
// CHECK1-NEXT:    store i32 [[ADD13]], i32* [[TMP2]], align 4
// CHECK1-NEXT:    [[TMP87:%.*]] = getelementptr i8, i8* [[ARRAYIDX1]], i64 [[TMP14]]
// CHECK1-NEXT:    [[OMP_ARRAYCPY_ISEMPTY:%.*]] = icmp eq i8* [[ARRAYIDX1]], [[TMP87]]
...
// CHECK1-NEXT:    [[TMP88:%.*]] = load i8, i8* [[OMP_ARRAYCPY_DESTELEMENTPAST14]], align 1
// CHECK1-NEXT:    [[CONV:%.*]] = sext i8 [[TMP88]] to i32
// CHECK1-NEXT:    [[TMP89:%.*]] = load i8, i8* [[OMP_ARRAYCPY_SRCELEMENTPAST]], align 1
// CHECK1-NEXT:    [[CONV15:%.*]] = sext i8 [[TMP89]] to i32
...
// CHECK1-NEXT:    [[OMP_ARRAYCPY_DONE19:%.*]] = icmp eq i8* [[OMP_ARRAYCPY_DEST_ELEMENT18]], [[TMP87]]
// CHECK1-NEXT:    br i1 [[OMP_ARRAYCPY_DONE19]], label [[OMP_ARRAYCPY_DONE20]], label [[OMP_ARRAYCPY_BODY]]
// CHECK1:       omp.arraycpy.done20:
// CHECK1-NEXT:    call void @__kmpc_end_reduce_nowait(%struct.ident_t* @[[GLOB4]], i32 [[TMP82]], [8 x i32]* @.gomp_critical_user_.reduction.var)
// CHECK1-NEXT:    br label [[DOTOMP_REDUCTION_DEFAULT]]
// CHECK1:       .omp.reduction.case2:
// CHECK1-NEXT:    [[TMP90:%.*]] = load i32, i32* [[ARGC]], align 4
// CHECK1-NEXT:    [[TMP91:%.*]] = atomicrmw add i32* [[TMP2]], i32 [[TMP90]] monotonic, align 4
// CHECK1-NEXT:    [[TMP92:%.*]] = getelementptr i8, i8* [[ARRAYIDX1]], i64 [[TMP14]]
// CHECK1-NEXT:    [[OMP_ARRAYCPY_ISEMPTY21:%.*]] = icmp eq i8* [[ARRAYIDX1]], [[TMP92]]
...
// CHECK1-NEXT:    [[TMP93:%.*]] = load i8, i8* [[OMP_ARRAYCPY_SRCELEMENTPAST23]], align 1
// CHECK1-NEXT:    [[CONV25:%.*]] = sext i8 [[TMP93]] to i32
...
// CHECK1:       atomic_cont:
// CHECK1-NEXT:    [[TMP94:%.*]] = phi i8 [ [[ATOMIC_LOAD]], [[OMP_ARRAYCPY_BODY22]] ], [ [[TMP99:%.*]], [[ATOMIC_CONT]] ]
// CHECK1-NEXT:    store i8 [[TMP94]], i8* [[_TMP26]], align 1
// CHECK1-NEXT:    [[TMP95:%.*]] = load i8, i8* [[_TMP26]], align 1
// CHECK1-NEXT:    [[CONV27:%.*]] = sext i8 [[TMP95]] to i32
// CHECK1-NEXT:    [[TMP96:%.*]] = load i8, i8* [[OMP_ARRAYCPY_SRCELEMENTPAST23]], align 1
// CHECK1-NEXT:    [[CONV28:%.*]] = sext i8 [[TMP96]] to i32
...
// CHECK1-NEXT:    [[TMP97:%.*]] = load i8, i8* [[ATOMIC_TEMP]], align 1
// CHECK1-NEXT:    [[TMP98:%.*]] = cmpxchg i8* [[OMP_ARRAYCPY_DESTELEMENTPAST24]], i8 [[TMP94]], i8 [[TMP97]] monotonic monotonic, align 1
// CHECK1-NEXT:    [[TMP99]] = extractvalue { i8, i1 } [[TMP98]], 0
// CHECK1-NEXT:    [[TMP100:%.*]] = extractvalue { i8, i1 } [[TMP98]], 1
// CHECK1-NEXT:    br i1 [[TMP100]], label [[ATOMIC_EXIT]], label [[ATOMIC_CONT]]
// CHECK1:       atomic_exit:
...
// CHECK1-NEXT:    [[OMP_ARRAYCPY_DONE33:%.*]] = icmp eq i8* [[OMP_ARRAYCPY_DEST_ELEMENT31]], [[TMP92]]
// CHECK1-NEXT:    br i1 [[OMP_ARRAYCPY_DONE33]], label [[OMP_ARRAYCPY_DONE34]], label [[OMP_ARRAYCPY_BODY22]]
// CHECK1:       omp.arraycpy.done34:
// CHECK1-NEXT:    br label [[DOTOMP_REDUCTION_DEFAULT]]
// CHECK1:       .omp.reduction.default:
// CHECK1-NEXT:    [[TMP101:%.*]] = load i8*, i8** [[SAVED_STACK]], align 8
// CHECK1-NEXT:    call void @llvm.stackrestore(i8* [[TMP101]])
// CHECK1-NEXT:    ret void
//
//
...
// CHECK1-SAME: (i32* noalias [[DOTGLOBAL_TID_:%.*]], i32* noalias [[DOTBOUND_TID_:%.*]], i64 [[DOTPREVIOUS_LB_:%.*]], i64 [[DOTPREVIOUS_UB_:%.*]], %struct.anon.0* noalias [[__CONTEXT:%.*]]) #[[ATTR1]] {
// CHECK1-NEXT:  entry:
// CHECK1-NEXT:    [[DOTGLOBAL_TID__ADDR:%.*]] = alloca i32*, align 8
// CHECK1-NEXT:    [[DOTBOUND_TID__ADDR:%.*]] = alloca i32*, align 8
...
// CHECK1-NEXT:    store i64 [[TMP4]], i64* [[DOTOMP_LB]], align 8
// CHECK1-NEXT:    store i64 [[TMP5]], i64* [[DOTOMP_UB]], align 8
// CHECK1-NEXT:    store i64 1, i64* [[DOTOMP_STRIDE]], align 8
// CHECK1-NEXT:    store i32 0, i32* [[DOTOMP_IS_LAST]], align 4
// CHECK1-NEXT:    store i32 0, i32* [[ARGC]], align 4
// CHECK1-NEXT:    [[TMP6:%.*]] = load i8**, i8*** [[TMP3]], align 8
// CHECK1-NEXT:    [[ARRAYIDX:%.*]] = getelementptr inbounds i8*, i8** [[TMP6]], i64 0
// CHECK1-NEXT:    [[TMP7:%.*]] = load i8*, i8** [[ARRAYIDX]], align 8
// CHECK1-NEXT:    [[ARRAYIDX1:%.*]] = getelementptr inbounds i8, i8* [[TMP7]], i64 0
// CHECK1-NEXT:    [[TMP8:%.*]] = load i32, i32* [[TMP2]], align 4
// CHECK1-NEXT:    [[TMP9:%.*]] = sext i32 [[TMP8]] to i64
// CHECK1-NEXT:    [[LB_ADD_LEN:%.*]] = add nsw i64 -1, [[TMP9]]
// CHECK1-NEXT:    [[TMP10:%.*]] = load i8**, i8*** [[TMP3]], align 8
// CHECK1-NEXT:    [[ARRAYIDX2:%.*]] = getelementptr inbounds i8*, i8** [[TMP10]], i64 9
// CHECK1-NEXT:    [[TMP11:%.*]] = load i8*, i8** [[ARRAYIDX2]], align 8
// CHECK1-NEXT:    [[ARRAYIDX3:%.*]] = getelementptr inbounds i8, i8* [[TMP11]], i64 [[LB_ADD_LEN]]
// CHECK1-NEXT:    [[TMP12:%.*]] = ptrtoint i8* [[ARRAYIDX3]] to i64
// CHECK1-NEXT:    [[TMP13:%.*]] = ptrtoint i8* [[ARRAYIDX1]] to i64
// CHECK1-NEXT:    [[TMP14:%.*]] = sub i64 [[TMP12]], [[TMP13]]
// CHECK1-NEXT:    [[TMP15:%.*]] = sdiv exact i64 [[TMP14]], ptrtoint (i8* getelementptr (i8, i8* null, i32 1) to i64)
// CHECK1-NEXT:    [[TMP16:%.*]] = add nuw i64 [[TMP15]], 1
// CHECK1-NEXT:    [[TMP17:%.*]] = mul nuw i64 [[TMP16]], ptrtoint (i8* getelementptr (i8, i8* null, i32 1) to i64)
// CHECK1-NEXT:    [[TMP18:%.*]] = call i8* @llvm.stacksave()
// CHECK1-NEXT:    store i8* [[TMP18]], i8** [[SAVED_STACK]], align 8
// CHECK1-NEXT:    [[VLA:%.*]] = alloca i8, i64 [[TMP16]], align 16
// CHECK1-NEXT:    store i64 [[TMP16]], i64* [[__VLA_EXPR0]], align 8
// CHECK1-NEXT:    [[TMP19:%.*]] = getelementptr i8, i8* [[VLA]], i64 [[TMP16]]
// CHECK1-NEXT:    [[OMP_ARRAYINIT_ISEMPTY:%.*]] = icmp eq i8* [[VLA]], [[TMP19]]
// CHECK1-NEXT:    br i1 [[OMP_ARRAYINIT_ISEMPTY]], label [[OMP_ARRAYINIT_DONE:%.*]], label [[OMP_ARRAYINIT_BODY:%.*]]
// CHECK1:       omp.arrayinit.body:
// CHECK1-NEXT:    [[OMP_ARRAYCPY_DESTELEMENTPAST:%.*]] = phi i8* [ [[VLA]], [[ENTRY:%.*]] ], [ [[OMP_ARRAYCPY_DEST_ELEMENT:%.*]], [[OMP_ARRAYINIT_BODY]] ]
// CHECK1-NEXT:    store i8 0, i8* [[OMP_ARRAYCPY_DESTELEMENTPAST]], align 1
// CHECK1-NEXT:    [[OMP_ARRAYCPY_DEST_ELEMENT]] = getelementptr i8, i8* [[OMP_ARRAYCPY_DESTELEMENTPAST]], i32 1
// CHECK1-NEXT:    [[OMP_ARRAYCPY_DONE:%.*]] = icmp eq i8* [[OMP_ARRAYCPY_DEST_ELEMENT]], [[TMP19]]
// CHECK1-NEXT:    br i1 [[OMP_ARRAYCPY_DONE]], label [[OMP_ARRAYINIT_DONE]], label [[OMP_ARRAYINIT_BODY]]
// CHECK1:       omp.arrayinit.done:
// CHECK1-NEXT:    [[TMP20:%.*]] = load i8**, i8*** [[TMP3]], align 8
// CHECK1-NEXT:    [[TMP21:%.*]] = load i8*, i8** [[TMP20]], align 8
// CHECK1-NEXT:    [[TMP22:%.*]] = ptrtoint i8* [[TMP21]] to i64
// CHECK1-NEXT:    [[TMP23:%.*]] = ptrtoint i8* [[ARRAYIDX1]] to i64
// CHECK1-NEXT:    [[TMP24:%.*]] = sub i64 [[TMP22]], [[TMP23]]
// CHECK1-NEXT:    [[TMP25:%.*]] = sdiv exact i64 [[TMP24]], ptrtoint (i8* getelementptr (i8, i8* null, i32 1) to i64)
// CHECK1-NEXT:    [[TMP26:%.*]] = getelementptr i8, i8* [[VLA]], i64 [[TMP25]]
// CHECK1-NEXT:    store i8** [[_TMP5]], i8*** [[_TMP4]], align 8
// CHECK1-NEXT:    store i8* [[TMP26]], i8** [[_TMP5]], align 8
...
// CHECK1-NEXT:    [[TMP27:%.*]] = getelementptr inbounds [[STRUCT_KMP_TASKRED_INPUT_T_1:%.*]], %struct.kmp_taskred_input_t.1* [[DOTRD_INPUT_GEP_]], i32 0, i32 0
// CHECK1-NEXT:    [[TMP28:%.*]] = bitcast i32* [[ARGC]] to i8*
// CHECK1-NEXT:    store i8* [[TMP28]], i8** [[TMP27]], align 8
// CHECK1-NEXT:    [[TMP29:%.*]] = getelementptr inbounds [[STRUCT_KMP_TASKRED_INPUT_T_1]], %struct.kmp_taskred_input_t.1* [[DOTRD_INPUT_GEP_]], i32 0, i32 1
// CHECK1-NEXT:    [[TMP30:%.*]] = bitcast i32* [[TMP2]] to i8*
// CHECK1-NEXT:    store i8* [[TMP30]], i8** [[TMP29]], align 8
// CHECK1-NEXT:    [[TMP31:%.*]] = getelementptr inbounds [[STRUCT_KMP_TASKRED_INPUT_T_1]], %struct.kmp_taskred_input_t.1* [[DOTRD_INPUT_GEP_]], i32 0, i32 2
// CHECK1-NEXT:    store i64 4, i64* [[TMP31]], align 8
// CHECK1-NEXT:    [[TMP32:%.*]] = getelementptr inbounds [[STRUCT_KMP_TASKRED_INPUT_T_1]], %struct.kmp_taskred_input_t.1* [[DOTRD_INPUT_GEP_]], i32 0, i32 3
// CHECK1-NEXT:    store i8* bitcast (void (i8*, i8*)* @.red_init..4 to i8*), i8** [[TMP32]], align 8
// CHECK1-NEXT:    [[TMP33:%.*]] = getelementptr inbounds [[STRUCT_KMP_TASKRED_INPUT_T_1]], %struct.kmp_taskred_input_t.1* [[DOTRD_INPUT_GEP_]], i32 0, i32 4
// CHECK1-NEXT:    store i8* null, i8** [[TMP33]], align 8
// CHECK1-NEXT:    [[TMP34:%.*]] = getelementptr inbounds [[STRUCT_KMP_TASKRED_INPUT_T_1]], %struct.kmp_taskred_input_t.1* [[DOTRD_INPUT_GEP_]], i32 0, i32 5
// CHECK1-NEXT:    store i8* bitcast (void (i8*, i8*)* @.red_comb..5 to i8*), i8** [[TMP34]], align 8
// CHECK1-NEXT:    [[TMP35:%.*]] = getelementptr inbounds [[STRUCT_KMP_TASKRED_INPUT_T_1]], %struct.kmp_taskred_input_t.1* [[DOTRD_INPUT_GEP_]], i32 0, i32 6
// CHECK1-NEXT:    [[TMP36:%.*]] = bitcast i32* [[TMP35]] to i8*
// CHECK1-NEXT:    call void @llvm.memset.p0i8.i64(i8* align 8 [[TMP36]], i8 0, i64 4, i1 false)
...
// CHECK1-NEXT:    [[TMP37:%.*]] = getelementptr inbounds [[STRUCT_KMP_TASKRED_INPUT_T_1]], %struct.kmp_taskred_input_t.1* [[DOTRD_INPUT_GEP_6]], i32 0, i32 0
// CHECK1-NEXT:    [[TMP38:%.*]] = load i8**, i8*** [[TMP3]], align 8
// CHECK1-NEXT:    [[ARRAYIDX7:%.*]] = getelementptr inbounds i8*, i8** [[TMP38]], i64 0
// CHECK1-NEXT:    [[TMP39:%.*]] = load i8*, i8** [[ARRAYIDX7]], align 8
// CHECK1-NEXT:    [[ARRAYIDX8:%.*]] = getelementptr inbounds i8, i8* [[TMP39]], i64 0
// CHECK1-NEXT:    [[TMP40:%.*]] = load i32, i32* [[TMP2]], align 4
// CHECK1-NEXT:    [[TMP41:%.*]] = sext i32 [[TMP40]] to i64
// CHECK1-NEXT:    [[LB_ADD_LEN9:%.*]] = add nsw i64 -1, [[TMP41]]
// CHECK1-NEXT:    [[TMP42:%.*]] = load i8**, i8*** [[TMP3]], align 8
// CHECK1-NEXT:    [[ARRAYIDX10:%.*]] = getelementptr inbounds i8*, i8** [[TMP42]], i64 9
// CHECK1-NEXT:    [[TMP43:%.*]] = load i8*, i8** [[ARRAYIDX10]], align 8
// CHECK1-NEXT:    [[ARRAYIDX11:%.*]] = getelementptr inbounds i8, i8* [[TMP43]], i64 [[LB_ADD_LEN9]]
// CHECK1-NEXT:    store i8* [[VLA]], i8** [[TMP37]], align 8
// CHECK1-NEXT:    [[TMP44:%.*]] = getelementptr inbounds [[STRUCT_KMP_TASKRED_INPUT_T_1]], %struct.kmp_taskred_input_t.1* [[DOTRD_INPUT_GEP_6]], i32 0, i32 1
// CHECK1-NEXT:    store i8* [[ARRAYIDX8]], i8** [[TMP44]], align 8
// CHECK1-NEXT:    [[TMP45:%.*]] = ptrtoint i8* [[ARRAYIDX11]] to i64
// CHECK1-NEXT:    [[TMP46:%.*]] = ptrtoint i8* [[ARRAYIDX8]] to i64
// CHECK1-NEXT:    [[TMP47:%.*]] = sub i64 [[TMP45]], [[TMP46]]
// CHECK1-NEXT:    [[TMP48:%.*]] = sdiv exact i64 [[TMP47]], ptrtoint (i8* getelementptr (i8, i8* null, i32 1) to i64)
// CHECK1-NEXT:    [[TMP49:%.*]] = add nuw i64 [[TMP48]], 1
// CHECK1-NEXT:    [[TMP50:%.*]] = mul nuw i64 [[TMP49]], ptrtoint (i8* getelementptr (i8, i8* null, i32 1) to i64)
// CHECK1-NEXT:    [[TMP51:%.*]] = getelementptr inbounds [[STRUCT_KMP_TASKRED_INPUT_T_1]], %struct.kmp_taskred_input_t.1* [[DOTRD_INPUT_GEP_6]], i32 0, i32 2
// CHECK1-NEXT:    store i64 [[TMP50]], i64* [[TMP51]], align 8
// CHECK1-NEXT:    [[TMP52:%.*]] = getelementptr inbounds [[STRUCT_KMP_TASKRED_INPUT_T_1]], %struct.kmp_taskred_input_t.1* [[DOTRD_INPUT_GEP_6]], i32 0, i32 3
// CHECK1-NEXT:    store i8* bitcast (void (i8*, i8*)* @.red_init..6 to i8*), i8** [[TMP52]], align 8
// CHECK1-NEXT:    [[TMP53:%.*]] = getelementptr inbounds [[STRUCT_KMP_TASKRED_INPUT_T_1]], %struct.kmp_taskred_input_t.1* [[DOTRD_INPUT_GEP_6]], i32 0, i32 4
// CHECK1-NEXT:    store i8* null, i8** [[TMP53]], align 8
// CHECK1-NEXT:    [[TMP54:%.*]] = getelementptr inbounds [[STRUCT_KMP_TASKRED_INPUT_T_1]], %struct.kmp_taskred_input_t.1* [[DOTRD_INPUT_GEP_6]], i32 0, i32 5
// CHECK1-NEXT:    store i8* bitcast (void (i8*, i8*)* @.red_comb..7 to i8*), i8** [[TMP54]], align 8
// CHECK1-NEXT:    [[TMP55:%.*]] = getelementptr inbounds [[STRUCT_KMP_TASKRED_INPUT_T_1]], %struct.kmp_taskred_input_t.1* [[DOTRD_INPUT_GEP_6]], i32 0, i32 6
// CHECK1-NEXT:    store i32 1, i32* [[TMP55]], align 8
// CHECK1-NEXT:    [[TMP56:%.*]] = load i32*, i32** [[DOTGLOBAL_TID__ADDR]], align 8
// CHECK1-NEXT:    [[TMP57:%.*]] = load i32, i32* [[TMP56]], align 4
// CHECK1-NEXT:    [[TMP58:%.*]] = bitcast [2 x %struct.kmp_taskred_input_t.1]* [[DOTRD_INPUT_]] to i8*
// CHECK1-NEXT:    [[TMP59:%.*]] = call i8* @__kmpc_taskred_modifier_init(%struct.ident_t* @[[GLOB1]], i32 [[TMP57]], i32 1, i32 2, i8* [[TMP58]])
// CHECK1-NEXT:    store i8* [[TMP59]], i8** [[DOTTASK_RED_]], align 8
// CHECK1-NEXT:    [[TMP60:%.*]] = load i32*, i32** [[DOTGLOBAL_TID__ADDR]], align 8
// CHECK1-NEXT:    [[TMP61:%.*]] = load i32, i32* [[TMP60]], align 4
// CHECK1-NEXT:    call void @__kmpc_for_static_init_8(%struct.ident_t* @[[GLOB3:[0-9]+]], i32 [[TMP61]], i32 34, i32* [[DOTOMP_IS_LAST]], i64* [[DOTOMP_LB]], i64* [[DOTOMP_UB]], i64* [[DOTOMP_STRIDE]], i64 1, i64 1)
// CHECK1-NEXT:    [[TMP62:%.*]] = load i64, i64* [[DOTOMP_UB]], align 8
// CHECK1-NEXT:    [[CMP:%.*]] = icmp sgt i64 [[TMP62]], 9
// CHECK1-NEXT:    br i1 [[CMP]], label [[COND_TRUE:%.*]], label [[COND_FALSE:%.*]]
// CHECK1:       cond.true:
// CHECK1-NEXT:    br label [[COND_END:%.*]]
// CHECK1:       cond.false:
...
// CHECK1-NEXT:    br label [[COND_END]]
// CHECK1:       cond.end:
// CHECK1-NEXT:    [[COND:%.*]] = phi i64 [ 9, [[COND_TRUE]] ], [ [[TMP63]], [[COND_FALSE]] ]
// CHECK1-NEXT:    store i64 [[COND]], i64* [[DOTOMP_UB]], align 8
// CHECK1-NEXT:    [[TMP64:%.*]] = load i64, i64* [[DOTOMP_LB]], align 8
// CHECK1-NEXT:    store i64 [[TMP64]], i64* [[DOTOMP_IV]], align 8
// CHECK1-NEXT:    br label [[OMP_INNER_FOR_COND:%.*]]
// CHECK1:       omp.inner.for.cond:
// CHECK1-NEXT:    [[TMP65:%.*]] = load i64, i64* [[DOTOMP_IV]], align 8
// CHECK1-NEXT:    [[TMP66:%.*]] = load i64, i64* [[DOTOMP_UB]], align 8
// CHECK1-NEXT:    [[CMP12:%.*]] = icmp sle i64 [[TMP65]], [[TMP66]]
// CHECK1-NEXT:    br i1 [[CMP12]], label [[OMP_INNER_FOR_BODY:%.*]], label [[OMP_INNER_FOR_COND_CLEANUP:%.*]]
// CHECK1:       omp.inner.for.cond.cleanup:
// CHECK1-NEXT:    br label [[OMP_INNER_FOR_END:%.*]]
// CHECK1:       omp.inner.for.body:
// CHECK1-NEXT:    [[TMP67:%.*]] = load i64, i64* [[DOTOMP_IV]], align 8
// CHECK1-NEXT:    [[MUL:%.*]] = mul nsw i64 [[TMP67]], 1
// CHECK1-NEXT:    [[ADD:%.*]] = add nsw i64 0, [[MUL]]
// CHECK1-NEXT:    store i64 [[ADD]], i64* [[I]], align 8
// CHECK1-NEXT:    [[TMP68:%.*]] = getelementptr inbounds [[STRUCT_ANON_2]], %struct.anon.2* [[AGG_CAPTURED]], i32 0, i32 0
// CHECK1-NEXT:    store i8** [[DOTTASK_RED_]], i8*** [[TMP68]], align 8
// CHECK1-NEXT:    [[TMP69:%.*]] = getelementptr inbounds [[STRUCT_ANON_2]], %struct.anon.2* [[AGG_CAPTURED]], i32 0, i32 1
// CHECK1-NEXT:    store i32* [[ARGC]], i32** [[TMP69]], align 8
// CHECK1-NEXT:    [[TMP70:%.*]] = getelementptr inbounds [[STRUCT_ANON_2]], %struct.anon.2* [[AGG_CAPTURED]], i32 0, i32 2
// CHECK1-NEXT:    [[TMP71:%.*]] = load i8**, i8*** [[_TMP4]], align 8
// CHECK1-NEXT:    store i8** [[TMP71]], i8*** [[TMP70]], align 8
// CHECK1-NEXT:    [[TMP72:%.*]] = load i32*, i32** [[DOTGLOBAL_TID__ADDR]], align 8
// CHECK1-NEXT:    [[TMP73:%.*]] = load i32, i32* [[TMP72]], align 4
// CHECK1-NEXT:    [[TMP74:%.*]] = call i8* @__kmpc_omp_task_alloc(%struct.ident_t* @[[GLOB1]], i32 [[TMP73]], i32 1, i64 48, i64 24, i32 (i32, i8*)* bitcast (i32 (i32, %struct.kmp_task_t_with_privates*)* @.omp_task_entry. to i32 (i32, i8*)*))
// CHECK1-NEXT:    [[TMP75:%.*]] = bitcast i8* [[TMP74]] to %struct.kmp_task_t_with_privates*
// CHECK1-NEXT:    [[TMP76:%.*]] = getelementptr inbounds [[STRUCT_KMP_TASK_T_WITH_PRIVATES:%.*]], %struct.kmp_task_t_with_privates* [[TMP75]], i32 0, i32 0
// CHECK1-NEXT:    [[TMP77:%.*]] = getelementptr inbounds [[STRUCT_KMP_TASK_T:%.*]], %struct.kmp_task_t* [[TMP76]], i32 0, i32 0
// CHECK1-NEXT:    [[TMP78:%.*]] = load i8*, i8** [[TMP77]], align 8
// CHECK1-NEXT:    [[TMP79:%.*]] = bitcast %struct.anon.2* [[AGG_CAPTURED]] to i8*
// CHECK1-NEXT:    call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 8 [[TMP78]], i8* align 8 [[TMP79]], i64 24, i1 false)
// CHECK1-NEXT:    [[TMP80:%.*]] = getelementptr inbounds [[STRUCT_KMP_TASK_T_WITH_PRIVATES]], %struct.kmp_task_t_with_privates* [[TMP75]], i32 0, i32 1
// CHECK1-NEXT:    [[TMP81:%.*]] = getelementptr inbounds [[STRUCT__KMP_PRIVATES_T:%.*]], %struct..kmp_privates.t* [[TMP80]], i32 0, i32 0
// CHECK1-NEXT:    [[TMP82:%.*]] = load i8*, i8** [[DOTTASK_RED_]], align 8
...
// CHECK1-NEXT:    [[TMP85:%.*]] = call i32 @__kmpc_omp_task(%struct.ident_t* @[[GLOB1]], i32 [[TMP84]], i8* [[TMP74]])
// CHECK1-NEXT:    br label [[OMP_BODY_CONTINUE:%.*]]
// CHECK1:       omp.body.continue:
// CHECK1-NEXT:    br label [[OMP_INNER_FOR_INC:%.*]]
// CHECK1:       omp.inner.for.inc:
// CHECK1-NEXT:    [[TMP86:%.*]] = load i64, i64* [[DOTOMP_IV]], align 8
// CHECK1-NEXT:    [[ADD13:%.*]] = add nsw i64 [[TMP86]], 1
...
// CHECK1-NEXT:    call void @__kmpc_for_static_fini(%struct.ident_t* @[[GLOB2]], i32 [[TMP88]])
// CHECK1-NEXT:    [[TMP89:%.*]] = load i32*, i32** [[DOTGLOBAL_TID__ADDR]], align 8
// CHECK1-NEXT:    [[TMP90:%.*]] = load i32, i32* [[TMP89]], align 4
// CHECK1-NEXT:    call void @__kmpc_task_reduction_modifier_fini(%struct.ident_t* @[[GLOB1]], i32 [[TMP90]], i32 1)
// CHECK1-NEXT:    [[TMP91:%.*]] = getelementptr inbounds [3 x i8*], [3 x i8*]* [[DOTOMP_REDUCTION_RED_LIST]], i64 0, i64 0
// CHECK1-NEXT:    [[TMP92:%.*]] = bitcast i32* [[ARGC]] to i8*
// CHECK1-NEXT:    store i8* [[TMP92]], i8** [[TMP91]], align 8
// CHECK1-NEXT:    [[TMP93:%.*]] = getelementptr inbounds [3 x i8*], [3 x i8*]* [[DOTOMP_REDUCTION_RED_LIST]], i64 0, i64 1
// CHECK1-NEXT:    store i8* [[VLA]], i8** [[TMP93]], align 8
// CHECK1-NEXT:    [[TMP94:%.*]] = getelementptr inbounds [3 x i8*], [3 x i8*]* [[DOTOMP_REDUCTION_RED_LIST]], i64 0, i64 2
// CHECK1-NEXT:    [[TMP95:%.*]] = inttoptr i64 [[TMP16]] to i8*
// CHECK1-NEXT:    store i8* [[TMP95]], i8** [[TMP94]], align 8
// CHECK1-NEXT:    [[TMP96:%.*]] = load i32*, i32** [[DOTGLOBAL_TID__ADDR]], align 8
// CHECK1-NEXT:    [[TMP97:%.*]] = load i32, i32* [[TMP96]], align 4
// CHECK1-NEXT:    [[TMP98:%.*]] = bitcast [3 x i8*]* [[DOTOMP_REDUCTION_RED_LIST]] to i8*
// CHECK1-NEXT:    [[TMP99:%.*]] = call i32 @__kmpc_reduce_nowait(%struct.ident_t* @[[GLOB4]], i32 [[TMP97]], i32 2, i64 24, i8* [[TMP98]], void (i8*, i8*)* @.omp.reduction.reduction_func, [8 x i32]* @.gomp_critical_user_.reduction.var)
// CHECK1-NEXT:    switch i32 [[TMP99]], label [[DOTOMP_REDUCTION_DEFAULT:%.*]] [
// CHECK1-NEXT:    i32 1, label [[DOTOMP_REDUCTION_CASE1:%.*]]
// CHECK1-NEXT:    i32 2, label [[DOTOMP_REDUCTION_CASE2:%.*]]
// CHECK1-NEXT:    ]
// CHECK1:       .omp.reduction.case1:
// CHECK1-NEXT:    [[TMP100:%.*]] = load i32, i32* [[TMP2]], align 4
// CHECK1-NEXT:    [[TMP101:%.*]] = load i32, i32* [[ARGC]], align 4
// CHECK1-NEXT:    [[ADD14:%.*]] = add nsw i32 [[TMP100]], [[TMP101]]
// CHECK1-NEXT:    store i32 [[ADD14]], i32* [[TMP2]], align 4
// CHECK1-NEXT:    [[TMP102:%.*]] = getelementptr i8, i8* [[ARRAYIDX1]], i64 [[TMP16]]
// CHECK1-NEXT:    [[OMP_ARRAYCPY_ISEMPTY:%.*]] = icmp eq i8* [[ARRAYIDX1]], [[TMP102]]
...
// CHECK1-NEXT:    [[TMP103:%.*]] = load i8, i8* [[OMP_ARRAYCPY_DESTELEMENTPAST15]], align 1
// CHECK1-NEXT:    [[CONV:%.*]] = sext i8 [[TMP103]] to i32
// CHECK1-NEXT:    [[TMP104:%.*]] = load i8, i8* [[OMP_ARRAYCPY_SRCELEMENTPAST]], align 1
// CHECK1-NEXT:    [[CONV16:%.*]] = sext i8 [[TMP104]] to i32
...
// CHECK1-NEXT:    [[OMP_ARRAYCPY_SRC_ELEMENT]] = getelementptr i8, i8* [[OMP_ARRAYCPY_SRCELEMENTPAST]], i32 1
// CHECK1-NEXT:    [[OMP_ARRAYCPY_DONE20:%.*]] = icmp eq i8* [[OMP_ARRAYCPY_DEST_ELEMENT19]], [[TMP102]]
// CHECK1-NEXT:    br i1 [[OMP_ARRAYCPY_DONE20]], label [[OMP_ARRAYCPY_DONE21]], label [[OMP_ARRAYCPY_BODY]]
// CHECK1:       omp.arraycpy.done21:
// CHECK1-NEXT:    call void @__kmpc_end_reduce_nowait(%struct.ident_t* @[[GLOB4]], i32 [[TMP97]], [8 x i32]* @.gomp_critical_user_.reduction.var)
// CHECK1-NEXT:    br label [[DOTOMP_REDUCTION_DEFAULT]]
// CHECK1:       .omp.reduction.case2:
// CHECK1-NEXT:    [[TMP105:%.*]] = load i32, i32* [[ARGC]], align 4
// CHECK1-NEXT:    [[TMP106:%.*]] = atomicrmw add i32* [[TMP2]], i32 [[TMP105]] monotonic, align 4
// CHECK1-NEXT:    [[TMP107:%.*]] = getelementptr i8, i8* [[ARRAYIDX1]], i64 [[TMP16]]
// CHECK1-NEXT:    [[OMP_ARRAYCPY_ISEMPTY22:%.*]] = icmp eq i8* [[ARRAYIDX1]], [[TMP107]]
...
// CHECK1-NEXT:    [[TMP108:%.*]] = load i8, i8* [[OMP_ARRAYCPY_SRCELEMENTPAST24]], align 1
...
// CHECK1-NEXT:    br label [[ATOMIC_CONT:%.*]]
// CHECK1:       atomic_cont:
// CHECK1-NEXT:    [[TMP109:%.*]] = phi i8 [ [[ATOMIC_LOAD]], [[OMP_ARRAYCPY_BODY23]] ], [ [[TMP114:%.*]], [[ATOMIC_CONT]] ]
// CHECK1-NEXT:    store i8 [[TMP109]], i8* [[_TMP27]], align 1
// CHECK1-NEXT:    [[TMP110:%.*]] = load i8, i8* [[_TMP27]], align 1
// CHECK1-NEXT:    [[CONV28:%.*]] = sext i8 [[TMP110]] to i32
// CHECK1-NEXT:    [[TMP111:%.*]] = load i8, i8* [[OMP_ARRAYCPY_SRCELEMENTPAST24]], align 1
// CHECK1-NEXT:    [[CONV29:%.*]] = sext i8 [[TMP111]] to i32
...
// CHECK1-NEXT:    [[TMP112:%.*]] = load i8, i8* [[ATOMIC_TEMP]], align 1
// CHECK1-NEXT:    [[TMP113:%.*]] = cmpxchg i8* [[OMP_ARRAYCPY_DESTELEMENTPAST25]], i8 [[TMP109]], i8 [[TMP112]] monotonic monotonic, align 1
// CHECK1-NEXT:    [[TMP114]] = extractvalue { i8, i1 } [[TMP113]], 0
// CHECK1-NEXT:    [[TMP115:%.*]] = extractvalue { i8, i1 } [[TMP113]], 1
// CHECK1-NEXT:    br i1 [[TMP115]], label [[ATOMIC_EXIT]], label [[ATOMIC_CONT]]
// CHECK1:       atomic_exit:
...
// CHECK1-NEXT:    [[OMP_ARRAYCPY_DONE34:%.*]] = icmp eq i8* [[OMP_ARRAYCPY_DEST_ELEMENT32]], [[TMP107]]
// CHECK1-NEXT:    br i1 [[OMP_ARRAYCPY_DONE34]], label [[OMP_ARRAYCPY_DONE35]], label [[OMP_ARRAYCPY_BODY23]]
// CHECK1:       omp.arraycpy.done35:
// CHECK1-NEXT:    br label [[DOTOMP_REDUCTION_DEFAULT]]
// CHECK1:       .omp.reduction.default:
// CHECK1-NEXT:    [[TMP116:%.*]] = load i8*, i8** [[SAVED_STACK]], align 8
// CHECK1-NEXT:    call void @llvm.stackrestore(i8* [[TMP116]])
// CHECK1-NEXT:    ret void
//
//
...
// CHECK2-NEXT:    store i32* [[ARGC]], i32** [[TMP67]], align 8
// CHECK2-NEXT:    [[TMP68:%.*]] = getelementptr inbounds [[STRUCT_ANON_0]], %struct.anon.0* [[OMP_OUTLINED_ARG_AGG_]], i32 0, i32 1
// CHECK2-NEXT:    [[TMP69:%.*]] = load i8**, i8*** [[TMP]], align 8
// CHECK2-NEXT:    store i8** [[TMP69]], i8*** [[TMP68]], align 8
// CHECK2-NEXT:    call void (%struct.ident_t*, i32, void (i32*, i32*, ...)*, ...) @__kmpc_fork_call(%struct.ident_t* @[[GLOB1]], i32 3, void (i32*, i32*, ...)* bitcast (void (i32*, i32*, i64, i64, %struct.anon.0*)* @.omp_outlined..3 to void (i32*, i32*, ...)*), i64 [[TMP65]], i64 [[TMP66]], %struct.anon.0* [[OMP_OUTLINED_ARG_AGG_]])
// CHECK2-NEXT:    br label [[OMP_INNER_FOR_INC:%.*]]
// CHECK2:       omp.inner.for.inc:
// CHECK2-NEXT:    [[TMP70:%.*]] = load i64, i64* [[DOTOMP_IV]], align 8
// CHECK2-NEXT:    [[TMP71:%.*]] = load i64, i64* [[DOTOMP_STRIDE]], align 8
// CHECK2-NEXT:    [[ADD:%.*]] = add nsw i64 [[TMP70]], [[TMP71]]
// CHECK2-NEXT:    store i64 [[ADD]], i64* [[DOTOMP_IV]], align 8
// CHECK2-NEXT:    br label [[OMP_INNER_FOR_COND]]
// CHECK2:       omp.inner.for.end:
// CHECK2-NEXT:    br label [[OMP_LOOP_EXIT:%.*]]
// CHECK2:       omp.loop.exit:
// CHECK2-NEXT:    [[TMP72:%.*]] = load i32*, i32** [[DOTGLOBAL_TID__ADDR]], align 8
// CHECK2-NEXT:    [[TMP73:%.*]] = load i32, i32* [[TMP72]], align 4
// CHECK2-NEXT:    call void @__kmpc_for_static_fini(%struct.ident_t* @[[GLOB2]], i32 [[TMP73]])
// CHECK2-NEXT:    [[TMP74:%.*]] = load i32*, i32** [[DOTGLOBAL_TID__ADDR]], align 8
// CHECK2-NEXT:    [[TMP75:%.*]] = load i32, i32* [[TMP74]], align 4
// CHECK2-NEXT:    call void @__kmpc_task_reduction_modifier_fini(%struct.ident_t* @[[GLOB1]], i32 [[TMP75]], i32 1)
// CHECK2-NEXT:    [[TMP76:%.*]] = getelementptr inbounds [3 x i8*], [3 x i8*]* [[DOTOMP_REDUCTION_RED_LIST]], i64 0, i64 0
// CHECK2-NEXT:    [[TMP77:%.*]] = bitcast i32* [[ARGC]] to i8*
// CHECK2-NEXT:    store i8* [[TMP77]], i8** [[TMP76]], align 8
// CHECK2-NEXT:    [[TMP78:%.*]] = getelementptr inbounds [3 x i8*], [3 x i8*]* [[DOTOMP_REDUCTION_RED_LIST]], i64 0, i64 1
// CHECK2-NEXT:    store i8* [[VLA]], i8** [[TMP78]], align 8
// CHECK2-NEXT:    [[TMP79:%.*]] = getelementptr inbounds [3 x i8*], [3 x i8*]* [[DOTOMP_REDUCTION_RED_LIST]], i64 0, i64 2
// CHECK2-NEXT:    [[TMP80:%.*]] = inttoptr i64 [[TMP14]] to i8*
...
// CHECK2-NEXT:    [[TMP83:%.*]] = bitcast [3 x i8*]* [[DOTOMP_REDUCTION_RED_LIST]] to i8*
// CHECK2-NEXT:    [[TMP84:%.*]] = call i32 @__kmpc_reduce_nowait(%struct.ident_t* @[[GLOB4:[0-9]+]], i32 [[TMP82]], i32 2, i64 24, i8* [[TMP83]], void (i8*, i8*)* @.omp.reduction.reduction_func.9, [8 x i32]* @.gomp_critical_user_.reduction.var)
// CHECK2-NEXT:    switch i32 [[TMP84]], label [[DOTOMP_REDUCTION_DEFAULT:%.*]] [
// CHECK2-NEXT:    i32 1, label [[DOTOMP_REDUCTION_CASE1:%.*]]
// CHECK2-NEXT:    i32 2, label [[DOTOMP_REDUCTION_CASE2:%.*]]
// CHECK2-NEXT:    ]
// CHECK2:       .omp.reduction.case1:
// CHECK2-NEXT:    [[TMP85:%.*]] = load i32, i32* [[TMP2]], align 4
// CHECK2-NEXT:    [[TMP86:%.*]] = load i32, i32* [[ARGC]], align 4
// CHECK2-NEXT:    [[ADD13:%.*]] = add nsw i32 [[TMP85]], [[TMP86]]
// CHECK2-NEXT:    store i32 [[ADD13]], i32* [[TMP2]], align 4
// CHECK2-NEXT:    [[TMP87:%.*]] = getelementptr i8, i8* [[ARRAYIDX1]], i64 [[TMP14]]
// CHECK2-NEXT:    [[OMP_ARRAYCPY_ISEMPTY:%.*]] = icmp eq i8* [[ARRAYIDX1]], [[TMP87]]
...
// CHECK2-NEXT:    [[TMP88:%.*]] = load i8, i8* [[OMP_ARRAYCPY_DESTELEMENTPAST14]], align 1
// CHECK2-NEXT:    [[CONV:%.*]] = sext i8 [[TMP88]] to i32
// CHECK2-NEXT:    [[TMP89:%.*]] = load i8, i8* [[OMP_ARRAYCPY_SRCELEMENTPAST]], align 1
// CHECK2-NEXT:    [[CONV15:%.*]] = sext i8 [[TMP89]] to i32
...
// CHECK2-NEXT:    [[OMP_ARRAYCPY_DONE19:%.*]] = icmp eq i8* [[OMP_ARRAYCPY_DEST_ELEMENT18]], [[TMP87]]
// CHECK2-NEXT:    br i1 [[OMP_ARRAYCPY_DONE19]], label [[OMP_ARRAYCPY_DONE20]], label [[OMP_ARRAYCPY_BODY]]
// CHECK2:       omp.arraycpy.done20:
// CHECK2-NEXT:    call void @__kmpc_end_reduce_nowait(%struct.ident_t* @[[GLOB4]], i32 [[TMP82]], [8 x i32]* @.gomp_critical_user_.reduction.var)
// CHECK2-NEXT:    br label [[DOTOMP_REDUCTION_DEFAULT]]
// CHECK2:       .omp.reduction.case2:
// CHECK2-NEXT:    [[TMP90:%.*]] = load i32, i32* [[ARGC]], align 4
// CHECK2-NEXT:    [[TMP91:%.*]] = atomicrmw add i32* [[TMP2]], i32 [[TMP90]] monotonic, align 4
// CHECK2-NEXT:    [[TMP92:%.*]] = getelementptr i8, i8* [[ARRAYIDX1]], i64 [[TMP14]]
// CHECK2-NEXT:    [[OMP_ARRAYCPY_ISEMPTY21:%.*]] = icmp eq i8* [[ARRAYIDX1]], [[TMP92]]
...
// CHECK2-NEXT:    [[TMP93:%.*]] = load i8, i8* [[OMP_ARRAYCPY_SRCELEMENTPAST23]], align 1
// CHECK2-NEXT:    [[CONV25:%.*]] = sext i8 [[TMP93]] to i32
...
// CHECK2:       atomic_cont:
// CHECK2-NEXT:    [[TMP94:%.*]] = phi i8 [ [[ATOMIC_LOAD]], [[OMP_ARRAYCPY_BODY22]] ], [ [[TMP99:%.*]], [[ATOMIC_CONT]] ]
// CHECK2-NEXT:    store i8 [[TMP94]], i8* [[_TMP26]], align 1
// CHECK2-NEXT:    [[TMP95:%.*]] = load i8, i8* [[_TMP26]], align 1
// CHECK2-NEXT:    [[CONV27:%.*]] = sext i8 [[TMP95]] to i32
// CHECK2-NEXT:    [[TMP96:%.*]] = load i8, i8* [[OMP_ARRAYCPY_SRCELEMENTPAST23]], align 1
// CHECK2-NEXT:    [[CONV28:%.*]] = sext i8 [[TMP96]] to i32
...
// CHECK2-NEXT:    [[TMP97:%.*]] = load i8, i8* [[ATOMIC_TEMP]], align 1
// CHECK2-NEXT:    [[TMP98:%.*]] = cmpxchg i8* [[OMP_ARRAYCPY_DESTELEMENTPAST24]], i8 [[TMP94]], i8 [[TMP97]] monotonic monotonic, align 1
// CHECK2-NEXT:    [[TMP99]] = extractvalue { i8, i1 } [[TMP98]], 0
// CHECK2-NEXT:    [[TMP100:%.*]] = extractvalue { i8, i1 } [[TMP98]], 1
// CHECK2-NEXT:    br i1 [[TMP100]], label [[ATOMIC_EXIT]], label [[ATOMIC_CONT]]
// CHECK2:       atomic_exit:
...
// CHECK2-NEXT:    [[OMP_ARRAYCPY_DONE33:%.*]] = icmp eq i8* [[OMP_ARRAYCPY_DEST_ELEMENT31]], [[TMP92]]
...
// CHECK2-NEXT:    [[TMP101:%.*]] = load i8*, i8** [[SAVED_STACK]], align 8
// CHECK2-NEXT:    call void @llvm.stackrestore(i8* [[TMP101]])
// CHECK2-NEXT:    ret void
//
//
...
// CHECK2-SAME: (i32* noalias [[DOTGLOBAL_TID_:%.*]], i32* noalias [[DOTBOUND_TID_:%.*]], i64 [[DOTPREVIOUS_LB_:%.*]], i64 [[DOTPREVIOUS_UB_:%.*]], %struct.anon.0* noalias [[__CONTEXT:%.*]]) #[[ATTR1]] {
// CHECK2-NEXT:  entry:
// CHECK2-NEXT:    [[DOTGLOBAL_TID__ADDR:%.*]] = alloca i32*, align 8
// CHECK2-NEXT:    [[DOTBOUND_TID__ADDR:%.*]] = alloca i32*, align 8
...
// CHECK2-NEXT:    store i64 [[TMP4]], i64* [[DOTOMP_LB]], align 8
// CHECK2-NEXT:    store i64 [[TMP5]], i64* [[DOTOMP_UB]], align 8
// CHECK2-NEXT:    store i64 1, i64* [[DOTOMP_STRIDE]], align 8
// CHECK2-NEXT:    store i32 0, i32* [[DOTOMP_IS_LAST]], align 4
// CHECK2-NEXT:    store i32 0, i32* [[ARGC]], align 4
// CHECK2-NEXT:    [[TMP6:%.*]] = load i8**, i8*** [[TMP3]], align 8
// CHECK2-NEXT:    [[ARRAYIDX:%.*]] = getelementptr inbounds i8*, i8** [[TMP6]], i64 0
// CHECK2-NEXT:    [[TMP7:%.*]] = load i8*, i8** [[ARRAYIDX]], align 8
// CHECK2-NEXT:    [[ARRAYIDX1:%.*]] = getelementptr inbounds i8, i8* [[TMP7]], i64 0
// CHECK2-NEXT:    [[TMP8:%.*]] = load i32, i32* [[TMP2]], align 4
// CHECK2-NEXT:    [[TMP9:%.*]] = sext i32 [[TMP8]] to i64
// CHECK2-NEXT:    [[LB_ADD_LEN:%.*]] = add nsw i64 -1, [[TMP9]]
// CHECK2-NEXT:    [[TMP10:%.*]] = load i8**, i8*** [[TMP3]], align 8
// CHECK2-NEXT:    [[ARRAYIDX2:%.*]] = getelementptr inbounds i8*, i8** [[TMP10]], i64 9
// CHECK2-NEXT:    [[TMP11:%.*]] = load i8*, i8** [[ARRAYIDX2]], align 8
// CHECK2-NEXT:    [[ARRAYIDX3:%.*]] = getelementptr inbounds i8, i8* [[TMP11]], i64 [[LB_ADD_LEN]]
// CHECK2-NEXT:    [[TMP12:%.*]] = ptrtoint i8* [[ARRAYIDX3]] to i64
// CHECK2-NEXT:    [[TMP13:%.*]] = ptrtoint i8* [[ARRAYIDX1]] to i64
// CHECK2-NEXT:    [[TMP14:%.*]] = sub i64 [[TMP12]], [[TMP13]]
// CHECK2-NEXT:    [[TMP15:%.*]] = sdiv exact i64 [[TMP14]], ptrtoint (i8* getelementptr (i8, i8* null, i32 1) to i64)
// CHECK2-NEXT:    [[TMP16:%.*]] = add nuw i64 [[TMP15]], 1
// CHECK2-NEXT:    [[TMP17:%.*]] = mul nuw i64 [[TMP16]], ptrtoint (i8* getelementptr (i8, i8* null, i32 1) to i64)
// CHECK2-NEXT:    [[TMP18:%.*]] = call i8* @llvm.stacksave()
// CHECK2-NEXT:    store i8* [[TMP18]], i8** [[SAVED_STACK]], align 8
// CHECK2-NEXT:    [[VLA:%.*]] = alloca i8, i64 [[TMP16]], align 16
// CHECK2-NEXT:    store i64 [[TMP16]], i64* [[__VLA_EXPR0]], align 8
// CHECK2-NEXT:    [[TMP19:%.*]] = getelementptr i8, i8* [[VLA]], i64 [[TMP16]]
// CHECK2-NEXT:    [[OMP_ARRAYINIT_ISEMPTY:%.*]] = icmp eq i8* [[VLA]], [[TMP19]]
// CHECK2-NEXT:    br i1 [[OMP_ARRAYINIT_ISEMPTY]], label [[OMP_ARRAYINIT_DONE:%.*]], label [[OMP_ARRAYINIT_BODY:%.*]]
// CHECK2:       omp.arrayinit.body:
// CHECK2-NEXT:    [[OMP_ARRAYCPY_DESTELEMENTPAST:%.*]] = phi i8* [ [[VLA]], [[ENTRY:%.*]] ], [ [[OMP_ARRAYCPY_DEST_ELEMENT:%.*]], [[OMP_ARRAYINIT_BODY]] ]
// CHECK2-NEXT:    store i8 0, i8* [[OMP_ARRAYCPY_DESTELEMENTPAST]], align 1
// CHECK2-NEXT:    [[OMP_ARRAYCPY_DEST_ELEMENT]] = getelementptr i8, i8* [[OMP_ARRAYCPY_DESTELEMENTPAST]], i32 1
// CHECK2-NEXT:    [[OMP_ARRAYCPY_DONE:%.*]] = icmp eq i8* [[OMP_ARRAYCPY_DEST_ELEMENT]], [[TMP19]]
// CHECK2-NEXT:    br i1 [[OMP_ARRAYCPY_DONE]], label [[OMP_ARRAYINIT_DONE]], label [[OMP_ARRAYINIT_BODY]]
// CHECK2:       omp.arrayinit.done:
// CHECK2-NEXT:    [[TMP20:%.*]] = load i8**, i8*** [[TMP3]], align 8
// CHECK2-NEXT:    [[TMP21:%.*]] = load i8*, i8** [[TMP20]], align 8
// CHECK2-NEXT:    [[TMP22:%.*]] = ptrtoint i8* [[TMP21]] to i64
// CHECK2-NEXT:    [[TMP23:%.*]] = ptrtoint i8* [[ARRAYIDX1]] to i64
// CHECK2-NEXT:    [[TMP24:%.*]] = sub i64 [[TMP22]], [[TMP23]]
// CHECK2-NEXT:    [[TMP25:%.*]] = sdiv exact i64 [[TMP24]], ptrtoint (i8* getelementptr (i8, i8* null, i32 1) to i64)
// CHECK2-NEXT:    [[TMP26:%.*]] = getelementptr i8, i8* [[VLA]], i64 [[TMP25]]
// CHECK2-NEXT:    store i8** [[_TMP5]], i8*** [[_TMP4]], align 8
// CHECK2-NEXT:    store i8* [[TMP26]], i8** [[_TMP5]], align 8
...
// CHECK2-NEXT:    [[TMP27:%.*]] = getelementptr inbounds [[STRUCT_KMP_TASKRED_INPUT_T_1:%.*]], %struct.kmp_taskred_input_t.1* [[DOTRD_INPUT_GEP_]], i32 0, i32 0
// CHECK2-NEXT:    [[TMP28:%.*]] = bitcast i32* [[ARGC]] to i8*
// CHECK2-NEXT:    store i8* [[TMP28]], i8** [[TMP27]], align 8
// CHECK2-NEXT:    [[TMP29:%.*]] = getelementptr inbounds [[STRUCT_KMP_TASKRED_INPUT_T_1]], %struct.kmp_taskred_input_t.1* [[DOTRD_INPUT_GEP_]], i32 0, i32 1
// CHECK2-NEXT:    [[TMP30:%.*]] = bitcast i32* [[TMP2]] to i8*
// CHECK2-NEXT:    store i8* [[TMP30]], i8** [[TMP29]], align 8
// CHECK2-NEXT:    [[TMP31:%.*]] = getelementptr inbounds [[STRUCT_KMP_TASKRED_INPUT_T_1]], %struct.kmp_taskred_input_t.1* [[DOTRD_INPUT_GEP_]], i32 0, i32 2
// CHECK2-NEXT:    store i64 4, i64* [[TMP31]], align 8
// CHECK2-NEXT:    [[TMP32:%.*]] = getelementptr inbounds [[STRUCT_KMP_TASKRED_INPUT_T_1]], %struct.kmp_taskred_input_t.1* [[DOTRD_INPUT_GEP_]], i32 0, i32 3
// CHECK2-NEXT:    store i8* bitcast (void (i8*, i8*)* @.red_init..4 to i8*), i8** [[TMP32]], align 8
// CHECK2-NEXT:    [[TMP33:%.*]] = getelementptr inbounds [[STRUCT_KMP_TASKRED_INPUT_T_1]], %struct.kmp_taskred_input_t.1* [[DOTRD_INPUT_GEP_]], i32 0, i32 4
// CHECK2-NEXT:    store i8* null, i8** [[TMP33]], align 8
// CHECK2-NEXT:    [[TMP34:%.*]] = getelementptr inbounds [[STRUCT_KMP_TASKRED_INPUT_T_1]], %struct.kmp_taskred_input_t.1* [[DOTRD_INPUT_GEP_]], i32 0, i32 5
// CHECK2-NEXT:    store i8* bitcast (void (i8*, i8*)* @.red_comb..5 to i8*), i8** [[TMP34]], align 8
// CHECK2-NEXT:    [[TMP35:%.*]] = getelementptr inbounds [[STRUCT_KMP_TASKRED_INPUT_T_1]], %struct.kmp_taskred_input_t.1* [[DOTRD_INPUT_GEP_]], i32 0, i32 6
// CHECK2-NEXT:    [[TMP36:%.*]] = bitcast i32* [[TMP35]] to i8*
// CHECK2-NEXT:    call void @llvm.memset.p0i8.i64(i8* align 8 [[TMP36]], i8 0, i64 4, i1 false)
...
// CHECK2-NEXT:    [[TMP37:%.*]] = getelementptr inbounds [[STRUCT_KMP_TASKRED_INPUT_T_1]], %struct.kmp_taskred_input_t.1* [[DOTRD_INPUT_GEP_6]], i32 0, i32 0
// CHECK2-NEXT:    [[TMP38:%.*]] = load i8**, i8*** [[TMP3]], align 8
// CHECK2-NEXT:    [[ARRAYIDX7:%.*]] = getelementptr inbounds i8*, i8** [[TMP38]], i64 0
// CHECK2-NEXT:    [[TMP39:%.*]] = load i8*, i8** [[ARRAYIDX7]], align 8
// CHECK2-NEXT:    [[ARRAYIDX8:%.*]] = getelementptr inbounds i8, i8* [[TMP39]], i64 0
// CHECK2-NEXT:    [[TMP40:%.*]] = load i32, i32* [[TMP2]], align 4
// CHECK2-NEXT:    [[TMP41:%.*]] = sext i32 [[TMP40]] to i64
// CHECK2-NEXT:    [[LB_ADD_LEN9:%.*]] = add nsw i64 -1, [[TMP41]]
// CHECK2-NEXT:    [[TMP42:%.*]] = load i8**, i8*** [[TMP3]], align 8
// CHECK2-NEXT:    [[ARRAYIDX10:%.*]] = getelementptr inbounds i8*, i8** [[TMP42]], i64 9
// CHECK2-NEXT:    [[TMP43:%.*]] = load i8*, i8** [[ARRAYIDX10]], align 8
// CHECK2-NEXT:    [[ARRAYIDX11:%.*]] = getelementptr inbounds i8, i8* [[TMP43]], i64 [[LB_ADD_LEN9]]
// CHECK2-NEXT:    store i8* [[VLA]], i8** [[TMP37]], align 8
// CHECK2-NEXT:    [[TMP44:%.*]] = getelementptr inbounds [[STRUCT_KMP_TASKRED_INPUT_T_1]], %struct.kmp_taskred_input_t.1* [[DOTRD_INPUT_GEP_6]], i32 0, i32 1
// CHECK2-NEXT:    store i8* [[ARRAYIDX8]], i8** [[TMP44]], align 8
// CHECK2-NEXT:    [[TMP45:%.*]] = ptrtoint i8* [[ARRAYIDX11]] to i64
// CHECK2-NEXT:    [[TMP46:%.*]] = ptrtoint i8* [[ARRAYIDX8]] to i64
// CHECK2-NEXT:    [[TMP47:%.*]] = sub i64 [[TMP45]], [[TMP46]]
// CHECK2-NEXT:    [[TMP48:%.*]] = sdiv exact i64 [[TMP47]], ptrtoint (i8* getelementptr (i8, i8* null, i32 1) to i64)
// CHECK2-NEXT:    [[TMP49:%.*]] = add nuw i64 [[TMP48]], 1
// CHECK2-NEXT:    [[TMP50:%.*]] = mul nuw i64 [[TMP49]], ptrtoint (i8* getelementptr (i8, i8* null, i32 1) to i64)
// CHECK2-NEXT:    [[TMP51:%.*]] = getelementptr inbounds [[STRUCT_KMP_TASKRED_INPUT_T_1]], %struct.kmp_taskred_input_t.1* [[DOTRD_INPUT_GEP_6]], i32 0, i32 2
// CHECK2-NEXT:    store i64 [[TMP50]], i64* [[TMP51]], align 8
// CHECK2-NEXT:    [[TMP52:%.*]] = getelementptr inbounds [[STRUCT_KMP_TASKRED_INPUT_T_1]], %struct.kmp_taskred_input_t.1* [[DOTRD_INPUT_GEP_6]], i32 0, i32 3
// CHECK2-NEXT:    store i8* bitcast (void (i8*, i8*)* @.red_init..6 to i8*), i8** [[TMP52]], align 8
// CHECK2-NEXT:    [[TMP53:%.*]] = getelementptr inbounds [[STRUCT_KMP_TASKRED_INPUT_T_1]], %struct.kmp_taskred_input_t.1* [[DOTRD_INPUT_GEP_6]], i32 0, i32 4
// CHECK2-NEXT:    store i8* null, i8** [[TMP53]], align 8
// CHECK2-NEXT:    [[TMP54:%.*]] = getelementptr inbounds [[STRUCT_KMP_TASKRED_INPUT_T_1]], %struct.kmp_taskred_input_t.1* [[DOTRD_INPUT_GEP_6]], i32 0, i32 5
// CHECK2-NEXT:    store i8* bitcast (void (i8*, i8*)* @.red_comb..7 to i8*), i8** [[TMP54]], align 8
// CHECK2-NEXT:    [[TMP55:%.*]] = getelementptr inbounds [[STRUCT_KMP_TASKRED_INPUT_T_1]], %struct.kmp_taskred_input_t.1* [[DOTRD_INPUT_GEP_6]], i32 0, i32 6
// CHECK2-NEXT:    store i32 1, i32* [[TMP55]], align 8
// CHECK2-NEXT:    [[TMP56:%.*]] = load i32*, i32** [[DOTGLOBAL_TID__ADDR]], align 8
// CHECK2-NEXT:    [[TMP57:%.*]] = load i32, i32* [[TMP56]], align 4
// CHECK2-NEXT:    [[TMP58:%.*]] = bitcast [2 x %struct.kmp_taskred_input_t.1]* [[DOTRD_INPUT_]] to i8*
// CHECK2-NEXT:    [[TMP59:%.*]] = call i8* @__kmpc_taskred_modifier_init(%struct.ident_t* @[[GLOB1]], i32 [[TMP57]], i32 1, i32 2, i8* [[TMP58]])
// CHECK2-NEXT:    store i8* [[TMP59]], i8** [[DOTTASK_RED_]], align 8
// CHECK2-NEXT:    [[TMP60:%.*]] = load i32*, i32** [[DOTGLOBAL_TID__ADDR]], align 8
// CHECK2-NEXT:    [[TMP61:%.*]] = load i32, i32* [[TMP60]], align 4
// CHECK2-NEXT:    call void @__kmpc_for_static_init_8(%struct.ident_t* @[[GLOB3:[0-9]+]], i32 [[TMP61]], i32 34, i32* [[DOTOMP_IS_LAST]], i64* [[DOTOMP_LB]], i64* [[DOTOMP_UB]], i64* [[DOTOMP_STRIDE]], i64 1, i64 1)
// CHECK2-NEXT:    [[TMP62:%.*]] = load i64, i64* [[DOTOMP_UB]], align 8
// CHECK2-NEXT:    [[CMP:%.*]] = icmp sgt i64 [[TMP62]], 9
// CHECK2-NEXT:    br i1 [[CMP]], label [[COND_TRUE:%.*]], label [[COND_FALSE:%.*]]
// CHECK2:       cond.true:
// CHECK2-NEXT:    br label [[COND_END:%.*]]
// CHECK2:       cond.false:
// CHECK2-NEXT:    [[TMP63:%.*]] = load i64, i64* [[DOTOMP_UB]], align 8
// CHECK2-NEXT:    br label [[COND_END]]
// CHECK2:       cond.end:
// CHECK2-NEXT:    [[COND:%.*]] = phi i64 [ 9, [[COND_TRUE]] ], [ [[TMP63]], [[COND_FALSE]] ]
// CHECK2-NEXT:    store i64 [[COND]], i64* [[DOTOMP_UB]], align 8
// CHECK2-NEXT:    [[TMP64:%.*]] = load i64, i64* [[DOTOMP_LB]], align 8
// CHECK2-NEXT:    store i64 [[TMP64]], i64* [[DOTOMP_IV]], align 8
// CHECK2-NEXT:    br label [[OMP_INNER_FOR_COND:%.*]]
// CHECK2:       omp.inner.for.cond:
// CHECK2-NEXT:    [[TMP65:%.*]] = load i64, i64* [[DOTOMP_IV]], align 8
// CHECK2-NEXT:    [[TMP66:%.*]] = load i64, i64* [[DOTOMP_UB]], align 8
// CHECK2-NEXT:    [[CMP12:%.*]] = icmp sle i64 [[TMP65]], [[TMP66]]
...
// CHECK2:       omp.inner.for.body:
// CHECK2-NEXT:    [[TMP67:%.*]] = load i64, i64* [[DOTOMP_IV]], align 8
// CHECK2-NEXT:    [[MUL:%.*]] = mul nsw i64 [[TMP67]], 1
// CHECK2-NEXT:    [[ADD:%.*]] = add nsw i64 0, [[MUL]]
// CHECK2-NEXT:    store i64 [[ADD]], i64* [[I]], align 8
// CHECK2-NEXT:    [[TMP68:%.*]] = getelementptr inbounds [[STRUCT_ANON_2]], %struct.anon.2* [[AGG_CAPTURED]], i32 0, i32 0
// CHECK2-NEXT:    store i8** [[DOTTASK_RED_]], i8*** [[TMP68]], align 8
// CHECK2-NEXT:    [[TMP69:%.*]] = getelementptr inbounds [[STRUCT_ANON_2]], %struct.anon.2* [[AGG_CAPTURED]], i32 0, i32 1
// CHECK2-NEXT:    store i32* [[ARGC]], i32** [[TMP69]], align 8
// CHECK2-NEXT:    [[TMP70:%.*]] = getelementptr inbounds [[STRUCT_ANON_2]], %struct.anon.2* [[AGG_CAPTURED]], i32 0, i32 2
// CHECK2-NEXT:    [[TMP71:%.*]] = load i8**, i8*** [[_TMP4]], align 8
// CHECK2-NEXT:    store i8** [[TMP71]], i8*** [[TMP70]], align 8
// CHECK2-NEXT:    [[TMP72:%.*]] = load i32*, i32** [[DOTGLOBAL_TID__ADDR]], align 8
// CHECK2-NEXT:    [[TMP73:%.*]] = load i32, i32* [[TMP72]], align 4
// CHECK2-NEXT:    [[TMP74:%.*]] = call i8* @__kmpc_omp_task_alloc(%struct.ident_t* @[[GLOB1]], i32 [[TMP73]], i32 1, i64 48, i64 24, i32 (i32, i8*)* bitcast (i32 (i32, %struct.kmp_task_t_with_privates*)* @.omp_task_entry. to i32 (i32, i8*)*))
// CHECK2-NEXT:    [[TMP75:%.*]] = bitcast i8* [[TMP74]] to %struct.kmp_task_t_with_privates*
// CHECK2-NEXT:    [[TMP76:%.*]] = getelementptr inbounds [[STRUCT_KMP_TASK_T_WITH_PRIVATES:%.*]], %struct.kmp_task_t_with_privates* [[TMP75]], i32 0, i32 0
// CHECK2-NEXT:    [[TMP77:%.*]] = getelementptr inbounds [[STRUCT_KMP_TASK_T:%.*]], %struct.kmp_task_t* [[TMP76]], i32 0, i32 0
// CHECK2-NEXT:    [[TMP78:%.*]] = load i8*, i8** [[TMP77]], align 8
// CHECK2-NEXT:    [[TMP79:%.*]] = bitcast %struct.anon.2* [[AGG_CAPTURED]] to i8*
// CHECK2-NEXT:    call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 8 [[TMP78]], i8* align 8 [[TMP79]], i64 24, i1 false)
// CHECK2-NEXT:    [[TMP80:%.*]] = getelementptr inbounds [[STRUCT_KMP_TASK_T_WITH_PRIVATES]], %struct.kmp_task_t_with_privates* [[TMP75]], i32 0, i32 1
// CHECK2-NEXT:    [[TMP81:%.*]] = getelementptr inbounds [[STRUCT__KMP_PRIVATES_T:%.*]], %struct..kmp_privates.t* [[TMP80]], i32 0, i32 0
// CHECK2-NEXT:    [[TMP82:%.*]] = load i8*, i8** [[DOTTASK_RED_]], align 8
...
// CHECK2-NEXT:    [[TMP85:%.*]] = call i32 @__kmpc_omp_task(%struct.ident_t* @[[GLOB1]], i32 [[TMP84]], i8* [[TMP74]])
// CHECK2-NEXT:    br label [[OMP_BODY_CONTINUE:%.*]]
// CHECK2:       omp.body.continue:
// CHECK2-NEXT:    br label [[OMP_INNER_FOR_INC:%.*]]
// CHECK2:       omp.inner.for.inc:
// CHECK2-NEXT:    [[TMP86:%.*]] = load i64, i64* [[DOTOMP_IV]], align 8
// CHECK2-NEXT:    [[ADD13:%.*]] = add nsw i64 [[TMP86]], 1
...
// CHECK2-NEXT:    call void @__kmpc_for_static_fini(%struct.ident_t* @[[GLOB2]], i32 [[TMP88]])
// CHECK2-NEXT:    [[TMP89:%.*]] = load i32*, i32** [[DOTGLOBAL_TID__ADDR]], align 8
// CHECK2-NEXT:    [[TMP90:%.*]] = load i32, i32* [[TMP89]], align 4
// CHECK2-NEXT:    call void @__kmpc_task_reduction_modifier_fini(%struct.ident_t* @[[GLOB1]], i32 [[TMP90]], i32 1)
// CHECK2-NEXT:    [[TMP91:%.*]] = getelementptr inbounds [3 x i8*], [3 x i8*]* [[DOTOMP_REDUCTION_RED_LIST]], i64 0, i64 0
// CHECK2-NEXT:    [[TMP92:%.*]] = bitcast i32* [[ARGC]] to i8*
// CHECK2-NEXT:    store i8* [[TMP92]], i8** [[TMP91]], align 8
// CHECK2-NEXT:    [[TMP93:%.*]] = getelementptr inbounds [3 x i8*], [3 x i8*]* [[DOTOMP_REDUCTION_RED_LIST]], i64 0, i64 1
// CHECK2-NEXT:    store i8* [[VLA]], i8** [[TMP93]], align 8
// CHECK2-NEXT:    [[TMP94:%.*]] = getelementptr inbounds [3 x i8*], [3 x i8*]* [[DOTOMP_REDUCTION_RED_LIST]], i64 0, i64 2
// CHECK2-NEXT:    [[TMP95:%.*]] = inttoptr i64 [[TMP16]] to i8*
// CHECK2-NEXT:    store i8* [[TMP95]], i8** [[TMP94]], align 8
// CHECK2-NEXT:    [[TMP96:%.*]] = load i32*, i32** [[DOTGLOBAL_TID__ADDR]], align 8
// CHECK2-NEXT:    [[TMP97:%.*]] = load i32, i32* [[TMP96]], align 4
// CHECK2-NEXT:    [[TMP98:%.*]] = bitcast [3 x i8*]* [[DOTOMP_REDUCTION_RED_LIST]] to i8*
// CHECK2-NEXT:    [[TMP99:%.*]] = call i32 @__kmpc_reduce_nowait(%struct.ident_t* @[[GLOB4]], i32 [[TMP97]], i32 2, i64 24, i8* [[TMP98]], void (i8*, i8*)* @.omp.reduction.reduction_func, [8 x i32]* @.gomp_critical_user_.reduction.var)
// CHECK2-NEXT:    switch i32 [[TMP99]], label [[DOTOMP_REDUCTION_DEFAULT:%.*]] [
// CHECK2-NEXT:    i32 1, label [[DOTOMP_REDUCTION_CASE1:%.*]]
// CHECK2-NEXT:    i32 2, label [[DOTOMP_REDUCTION_CASE2:%.*]]
// CHECK2-NEXT:    ]
// CHECK2:       .omp.reduction.case1:
// CHECK2-NEXT:    [[TMP100:%.*]] = load i32, i32* [[TMP2]], align 4
// CHECK2-NEXT:    [[TMP101:%.*]] = load i32, i32* [[ARGC]], align 4
// CHECK2-NEXT:    [[ADD14:%.*]] = add nsw i32 [[TMP100]], [[TMP101]]
// CHECK2-NEXT:    store i32 [[ADD14]], i32* [[TMP2]], align 4
// CHECK2-NEXT:    [[TMP102:%.*]] = getelementptr i8, i8* [[ARRAYIDX1]], i64 [[TMP16]]
// CHECK2-NEXT:    [[OMP_ARRAYCPY_ISEMPTY:%.*]] = icmp eq i8* [[ARRAYIDX1]], [[TMP102]]
...
// CHECK2-NEXT:    [[TMP103:%.*]] = load i8, i8* [[OMP_ARRAYCPY_DESTELEMENTPAST15]], align 1
// CHECK2-NEXT:    [[CONV:%.*]] = sext i8 [[TMP103]] to i32
// CHECK2-NEXT:    [[TMP104:%.*]] = load i8, i8* [[OMP_ARRAYCPY_SRCELEMENTPAST]], align 1
// CHECK2-NEXT:    [[CONV16:%.*]] = sext i8 [[TMP104]] to i32
...
// CHECK2-NEXT:    [[OMP_ARRAYCPY_SRC_ELEMENT]] = getelementptr i8, i8* [[OMP_ARRAYCPY_SRCELEMENTPAST]], i32 1
// CHECK2-NEXT:    [[OMP_ARRAYCPY_DONE20:%.*]] = icmp eq i8* [[OMP_ARRAYCPY_DEST_ELEMENT19]], [[TMP102]]
// CHECK2-NEXT:    br i1 [[OMP_ARRAYCPY_DONE20]], label [[OMP_ARRAYCPY_DONE21]], label [[OMP_ARRAYCPY_BODY]]
// CHECK2:       omp.arraycpy.done21:
// CHECK2-NEXT:    call void @__kmpc_end_reduce_nowait(%struct.ident_t* @[[GLOB4]], i32 [[TMP97]], [8 x i32]* @.gomp_critical_user_.reduction.var)
// CHECK2-NEXT:    br label [[DOTOMP_REDUCTION_DEFAULT]]
// CHECK2:       .omp.reduction.case2:
// CHECK2-NEXT:    [[TMP105:%.*]] = load i32, i32* [[ARGC]], align 4
// CHECK2-NEXT:    [[TMP106:%.*]] = atomicrmw add i32* [[TMP2]], i32 [[TMP105]] monotonic, align 4
// CHECK2-NEXT:    [[TMP107:%.*]] = getelementptr i8, i8* [[ARRAYIDX1]], i64 [[TMP16]]
// CHECK2-NEXT:    [[OMP_ARRAYCPY_ISEMPTY22:%.*]] = icmp eq i8* [[ARRAYIDX1]], [[TMP107]]
...
// CHECK2-NEXT:    [[TMP108:%.*]] = load i8, i8* [[OMP_ARRAYCPY_SRCELEMENTPAST24]], align 1
...
// CHECK2-NEXT:    br label [[ATOMIC_CONT:%.*]]
// CHECK2:       atomic_cont:
// CHECK2-NEXT:    [[TMP109:%.*]] = phi i8 [ [[ATOMIC_LOAD]], [[OMP_ARRAYCPY_BODY23]] ], [ [[TMP114:%.*]], [[ATOMIC_CONT]] ]
// CHECK2-NEXT:    store i8 [[TMP109]], i8* [[_TMP27]], align 1
// CHECK2-NEXT:    [[TMP110:%.*]] = load i8, i8* [[_TMP27]], align 1
// CHECK2-NEXT:    [[CONV28:%.*]] = sext i8 [[TMP110]] to i32
// CHECK2-NEXT:    [[TMP111:%.*]] = load i8, i8* [[OMP_ARRAYCPY_SRCELEMENTPAST24]], align 1
// CHECK2-NEXT:    [[CONV29:%.*]] = sext i8 [[TMP111]] to i32
...
// CHECK2-NEXT:    [[TMP112:%.*]] = load i8, i8* [[ATOMIC_TEMP]], align 1
// CHECK2-NEXT:    [[TMP113:%.*]] = cmpxchg i8* [[OMP_ARRAYCPY_DESTELEMENTPAST25]], i8 [[TMP109]], i8 [[TMP112]] monotonic monotonic, align 1
// CHECK2-NEXT:    [[TMP114]] = extractvalue { i8, i1 } [[TMP113]], 0
// CHECK2-NEXT:    [[TMP115:%.*]] = extractvalue { i8, i1 } [[TMP113]], 1
// CHECK2-NEXT:    br i1 [[TMP115]], label [[ATOMIC_EXIT]], label [[ATOMIC_CONT]]
// CHECK2:       atomic_exit:
...
// CHECK2-NEXT:    [[OMP_ARRAYCPY_DONE34:%.*]] = icmp eq i8* [[OMP_ARRAYCPY_DEST_ELEMENT32]], [[TMP107]]
// CHECK2-NEXT:    br i1 [[OMP_ARRAYCPY_DONE34]], label [[OMP_ARRAYCPY_DONE35]], label [[OMP_ARRAYCPY_BODY23]]
// CHECK2:       omp.arraycpy.done35:
// CHECK2-NEXT:    br label [[DOTOMP_REDUCTION_DEFAULT]]
// CHECK2:       .omp.reduction.default:
// CHECK2-NEXT:    [[TMP116:%.*]] = load i8*, i8** [[SAVED_STACK]], align 8
// CHECK2-NEXT:    call void @llvm.stackrestore(i8* [[TMP116]])
// CHECK2-NEXT:    ret void
//
//
