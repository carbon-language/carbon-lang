...
// CHECK1-NEXT:    [[TMP18:%.*]] = load double*, double** [[_TMP2]], align 8
// CHECK1-NEXT:    store volatile double 1.000000e+00, double* [[TMP18]], align 8
...
// CHECK2-NEXT:    [[TMP18:%.*]] = load double*, double** [[_TMP2]], align 8
// CHECK2-NEXT:    store volatile double 1.000000e+00, double* [[TMP18]], align 8
...
// CHECK3-NEXT:    [[TMP18:%.*]] = load double*, double** [[_TMP2]], align 4
// CHECK3-NEXT:    store volatile double 1.000000e+00, double* [[TMP18]], align 4
...
// CHECK4-NEXT:    [[TMP18:%.*]] = load double*, double** [[_TMP2]], align 4
// CHECK4-NEXT:    store volatile double 1.000000e+00, double* [[TMP18]], align 4
...
// CHECK9-NEXT:    [[TMP20:%.*]] = load i32, i32* [[T_VAR]], align 4
// CHECK9-NEXT:    [[TMP21:%.*]] = load i32, i32* [[I]], align 4
...
// CHECK9-NEXT:    store i32 [[TMP20]], i32* [[ARRAYIDX]], align 4
// CHECK9-NEXT:    [[TMP22:%.*]] = load %struct.S*, %struct.S** [[_TMP2]], align 8
...
// CHECK9-NEXT:    [[ADD:%.*]] = add nsw i32 0, [[MUL]]
// CHECK9-NEXT:    store i32 [[ADD]], i32* [[I]], align 4
// CHECK9-NEXT:    [[TMP18:%.*]] = load i32, i32* [[T_VAR]], align 4
// CHECK9-NEXT:    [[TMP19:%.*]] = load i32, i32* [[I]], align 4
// CHECK9-NEXT:    [[IDXPROM:%.*]] = sext i32 [[TMP19]] to i64
// CHECK9-NEXT:    [[ARRAYIDX:%.*]] = getelementptr inbounds [2 x i32], [2 x i32]* [[VEC]], i64 0, i64 [[IDXPROM]]
// CHECK9-NEXT:    store i32 [[TMP18]], i32* [[ARRAYIDX]], align 4
// CHECK9-NEXT:    [[TMP20:%.*]] = load %struct.S.0*, %struct.S.0** [[_TMP2]], align 8
// CHECK9-NEXT:    [[TMP21:%.*]] = load i32, i32* [[I]], align 4
...
// CHECK10-NEXT:    [[TMP20:%.*]] = load i32, i32* [[T_VAR]], align 4
// CHECK10-NEXT:    [[TMP21:%.*]] = load i32, i32* [[I]], align 4
...
// CHECK10-NEXT:    store i32 [[TMP20]], i32* [[ARRAYIDX]], align 4
// CHECK10-NEXT:    [[TMP22:%.*]] = load %struct.S*, %struct.S** [[_TMP2]], align 8
...
// CHECK10-NEXT:    call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 4 [[TMP24]], i8* align 4 [[TMP25]], i64 4, i1 false)
...
// CHECK10-NEXT:    [[ADD:%.*]] = add nsw i32 0, [[MUL]]
// CHECK10-NEXT:    store i32 [[ADD]], i32* [[I]], align 4
// CHECK10-NEXT:    [[TMP18:%.*]] = load i32, i32* [[T_VAR]], align 4
// CHECK10-NEXT:    [[TMP19:%.*]] = load i32, i32* [[I]], align 4
// CHECK10-NEXT:    [[IDXPROM:%.*]] = sext i32 [[TMP19]] to i64
// CHECK10-NEXT:    [[ARRAYIDX:%.*]] = getelementptr inbounds [2 x i32], [2 x i32]* [[VEC]], i64 0, i64 [[IDXPROM]]
// CHECK10-NEXT:    store i32 [[TMP18]], i32* [[ARRAYIDX]], align 4
// CHECK10-NEXT:    [[TMP20:%.*]] = load %struct.S.0*, %struct.S.0** [[_TMP2]], align 8
// CHECK10-NEXT:    [[TMP21:%.*]] = load i32, i32* [[I]], align 4
...
// CHECK10-NEXT:    call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 4 [[TMP22]], i8* align 4 [[TMP23]], i64 4, i1 false)
// CHECK10-NEXT:    br label [[OMP_BODY_CONTINUE:%.*]]
// CHECK10:       omp.body.continue:
// CHECK10-NEXT:    br label [[OMP_INNER_FOR_INC:%.*]]
// CHECK10:       omp.inner.for.inc:
...
// CHECK11-NEXT:    [[TMP20:%.*]] = load i32, i32* [[T_VAR]], align 4
// CHECK11-NEXT:    [[TMP21:%.*]] = load i32, i32* [[I]], align 4
// CHECK11-NEXT:    [[ARRAYIDX:%.*]] = getelementptr inbounds [2 x i32], [2 x i32]* [[VEC]], i32 0, i32 [[TMP21]]
// CHECK11-NEXT:    store i32 [[TMP20]], i32* [[ARRAYIDX]], align 4
// CHECK11-NEXT:    [[TMP22:%.*]] = load %struct.S*, %struct.S** [[_TMP2]], align 4
...
// CHECK11-NEXT:    [[ADD:%.*]] = add nsw i32 0, [[MUL]]
// CHECK11-NEXT:    store i32 [[ADD]], i32* [[I]], align 4
// CHECK11-NEXT:    [[TMP18:%.*]] = load i32, i32* [[T_VAR]], align 4
...
// CHECK11-NEXT:    store i32 [[TMP18]], i32* [[ARRAYIDX]], align 4
// CHECK11-NEXT:    [[TMP20:%.*]] = load %struct.S.0*, %struct.S.0** [[_TMP2]], align 4
// CHECK11-NEXT:    [[TMP21:%.*]] = load i32, i32* [[I]], align 4
...
// CHECK12-NEXT:    [[TMP20:%.*]] = load i32, i32* [[T_VAR]], align 4
// CHECK12-NEXT:    [[TMP21:%.*]] = load i32, i32* [[I]], align 4
// CHECK12-NEXT:    [[ARRAYIDX:%.*]] = getelementptr inbounds [2 x i32], [2 x i32]* [[VEC]], i32 0, i32 [[TMP21]]
// CHECK12-NEXT:    store i32 [[TMP20]], i32* [[ARRAYIDX]], align 4
// CHECK12-NEXT:    [[TMP22:%.*]] = load %struct.S*, %struct.S** [[_TMP2]], align 4
// CHECK12-NEXT:    [[TMP23:%.*]] = load i32, i32* [[I]], align 4
...
// CHECK12-NEXT:    call void @llvm.memcpy.p0i8.p0i8.i32(i8* align 4 [[TMP24]], i8* align 4 [[TMP25]], i32 4, i1 false)
...
// CHECK12-NEXT:    [[ADD:%.*]] = add nsw i32 0, [[MUL]]
// CHECK12-NEXT:    store i32 [[ADD]], i32* [[I]], align 4
// CHECK12-NEXT:    [[TMP18:%.*]] = load i32, i32* [[T_VAR]], align 4
...
// CHECK12-NEXT:    store i32 [[TMP18]], i32* [[ARRAYIDX]], align 4
// CHECK12-NEXT:    [[TMP20:%.*]] = load %struct.S.0*, %struct.S.0** [[_TMP2]], align 4
// CHECK12-NEXT:    [[TMP21:%.*]] = load i32, i32* [[I]], align 4
...
// CHECK12-NEXT:    call void @llvm.memcpy.p0i8.p0i8.i32(i8* align 4 [[TMP22]], i8* align 4 [[TMP23]], i32 4, i1 false)
// CHECK12-NEXT:    br label [[OMP_BODY_CONTINUE:%.*]]
// CHECK12:       omp.body.continue:
// CHECK12-NEXT:    br label [[OMP_INNER_FOR_INC:%.*]]
// CHECK12:       omp.inner.for.inc:
