...
// CHECK2-NEXT:    [[TMP27:%.*]] = load double, double* [[G2]], align 8
// CHECK2-NEXT:    store volatile double [[TMP27]], double* [[G]], align 8
// CHECK2-NEXT:    [[TMP28:%.*]] = load double*, double** [[_TMP4]], align 8
// CHECK2-NEXT:    [[TMP29:%.*]] = load double, double* [[TMP28]], align 8
// CHECK2-NEXT:    store volatile double [[TMP29]], double* [[TMP9]], align 8
// CHECK2-NEXT:    [[TMP30:%.*]] = load i32, i32* [[SVAR5]], align 4
// CHECK2-NEXT:    store i32 [[TMP30]], i32* [[SVAR]], align 4
// CHECK2-NEXT:    [[TMP31:%.*]] = load float, float* [[SFVAR6]], align 4
// CHECK2-NEXT:    store float [[TMP31]], float* [[SFVAR]], align 4
...
// CHECK4-NEXT:    [[TMP30:%.*]] = load i32, i32* [[SVAR3]], align 4
// CHECK4-NEXT:    store i32 [[TMP30]], i32* [[SVAR]], align 4
// CHECK4-NEXT:    [[TMP31:%.*]] = load float, float* [[SFVAR4]], align 4
// CHECK4-NEXT:    store float [[TMP31]], float* [[SFVAR]], align 4
...
// CHECK10-NEXT:    [[TMP35:%.*]] = getelementptr [[STRUCT_S]], %struct.S* [[ARRAY_BEGIN9]], i64 2
// CHECK10-NEXT:    [[OMP_ARRAYCPY_ISEMPTY:%.*]] = icmp eq %struct.S* [[ARRAY_BEGIN9]], [[TMP35]]
...
// CHECK10-NEXT:    [[TMP38:%.*]] = load %struct.S*, %struct.S** [[_TMP3]], align 8
...
// CHECK10-NEXT:    [[TMP41:%.*]] = load i32, i32* [[SVAR4]], align 4
// CHECK10-NEXT:    store i32 [[TMP41]], i32* [[SVAR]], align 4
...
// CHECK10-NEXT:    [[TMP42:%.*]] = getelementptr inbounds [[STRUCT_S]], %struct.S* [[ARRAY_BEGIN11]], i64 2
// CHECK10-NEXT:    br label [[ARRAYDESTROY_BODY:%.*]]
// CHECK10:       arraydestroy.body:
...
// CHECK10:       .omp.lastprivate.then:
// CHECK10-NEXT:    [[TMP29:%.*]] = load i32, i32* [[T_VAR2]], align 4
// CHECK10-NEXT:    store i32 [[TMP29]], i32* [[T_VAR]], align 4
...
// CHECK10-NEXT:    [[TMP33:%.*]] = getelementptr [[STRUCT_S_0]], %struct.S.0* [[ARRAY_BEGIN8]], i64 2
// CHECK10-NEXT:    [[OMP_ARRAYCPY_ISEMPTY:%.*]] = icmp eq %struct.S.0* [[ARRAY_BEGIN8]], [[TMP33]]
...
// CHECK10-NEXT:    [[TMP36:%.*]] = load %struct.S.0*, %struct.S.0** [[_TMP3]], align 8
...
// CHECK10-NEXT:    [[TMP39:%.*]] = getelementptr inbounds [[STRUCT_S_0]], %struct.S.0* [[ARRAY_BEGIN10]], i64 2
// CHECK10-NEXT:    br label [[ARRAYDESTROY_BODY:%.*]]
// CHECK10:       arraydestroy.body:
...
// CHECK12-NEXT:    [[TMP35:%.*]] = getelementptr [[STRUCT_S]], %struct.S* [[ARRAY_BEGIN8]], i32 2
// CHECK12-NEXT:    [[OMP_ARRAYCPY_ISEMPTY:%.*]] = icmp eq %struct.S* [[ARRAY_BEGIN8]], [[TMP35]]
...
// CHECK12-NEXT:    [[TMP38:%.*]] = load %struct.S*, %struct.S** [[_TMP3]], align 4
...
// CHECK12-NEXT:    [[TMP41:%.*]] = load i32, i32* [[SVAR4]], align 4
// CHECK12-NEXT:    store i32 [[TMP41]], i32* [[SVAR]], align 4
...
// CHECK12-NEXT:    [[TMP42:%.*]] = getelementptr inbounds [[STRUCT_S]], %struct.S* [[ARRAY_BEGIN10]], i32 2
// CHECK12-NEXT:    br label [[ARRAYDESTROY_BODY:%.*]]
// CHECK12:       arraydestroy.body:
...
// CHECK12-NEXT:    store i32 [[TMP29]], i32* [[T_VAR]], align 4
...
// CHECK12-NEXT:    [[TMP33:%.*]] = getelementptr [[STRUCT_S_0]], %struct.S.0* [[ARRAY_BEGIN7]], i32 2
// CHECK12-NEXT:    [[OMP_ARRAYCPY_ISEMPTY:%.*]] = icmp eq %struct.S.0* [[ARRAY_BEGIN7]], [[TMP33]]
...
// CHECK12-NEXT:    [[TMP36:%.*]] = load %struct.S.0*, %struct.S.0** [[_TMP3]], align 4
...
// CHECK12-NEXT:    [[TMP39:%.*]] = getelementptr inbounds [[STRUCT_S_0]], %struct.S.0* [[ARRAY_BEGIN9]], i32 2
// CHECK12-NEXT:    br label [[ARRAYDESTROY_BODY:%.*]]
// CHECK12:       arraydestroy.body:
