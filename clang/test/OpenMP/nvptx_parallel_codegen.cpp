...
// CHECK1-NEXT:    call void @__kmpc_free_shared(i8* [[TMP3]])
...
// CHECK1-NEXT:    call void @__kmpc_free_shared(i8* [[TMP13]])
...
// CHECK1-NEXT:    call void @__kmpc_free_shared(i8* [[TMP4]])
...
// CHECK1-NEXT:    [[TMP3:%.*]] = call i32 @__kmpc_warp_active_thread_mask()
...
// CHECK1-NEXT:    call void @__kmpc_syncwarp(i32 [[TMP3]])
...
// CHECK2-NEXT:    call void @__kmpc_free_shared(i8* [[TMP3]])
...
// CHECK2-NEXT:    call void @__kmpc_free_shared(i8* [[TMP13]])
...
// CHECK2-NEXT:    call void @__kmpc_free_shared(i8* [[TMP4]])
...
// CHECK2-NEXT:    call void @__kmpc_free_shared(i8* [[TMP5]])
...
// CHECK2-NEXT:    [[TMP2:%.*]] = load i32*, i32** [[TMP1]], align 4
// CHECK2-NEXT:    [[TMP3:%.*]] = call i32 @__kmpc_warp_active_thread_mask()
...
// CHECK2-NEXT:    call void @__kmpc_syncwarp(i32 [[TMP3]])
