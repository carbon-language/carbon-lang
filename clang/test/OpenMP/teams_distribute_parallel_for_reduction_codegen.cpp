...
// CHECK1-NEXT:    store i32* [[SIVAR]], i32** [[TMP16]], align 8
...
// CHECK1-NEXT:    store i32* [[T_VAR]], i32** [[TMP16]], align 8
...
// CHECK2-NEXT:    store i32* [[SIVAR]], i32** [[TMP16]], align 8
...
// CHECK2-NEXT:    store i32* [[T_VAR]], i32** [[TMP16]], align 8
...
// CHECK3-NEXT:    store i32* [[SIVAR]], i32** [[TMP14]], align 4
...
// CHECK3-NEXT:    store i32* [[T_VAR]], i32** [[TMP14]], align 4
...
// CHECK4-NEXT:    store i32* [[SIVAR]], i32** [[TMP14]], align 4
...
// CHECK4-NEXT:    store i32* [[T_VAR]], i32** [[TMP14]], align 4
...
// CHECK9-NEXT:    call void (%struct.ident_t*, i32, void (i32*, i32*, ...)*, ...) @__kmpc_fork_teams(%struct.ident_t* @[[GLOB4:[0-9]+]], i32 1, void (i32*, i32*, ...)* bitcast (void (i32*, i32*, %struct.anon*)* @.omp_outlined. to void (i32*, i32*, ...)*), %struct.anon* [[OMP_OUTLINED_ARG_AGG_]])
...
// CHECK9-NEXT:    [[TMP15:%.*]] = getelementptr inbounds [[STRUCT_ANON_0]], %struct.anon.0* [[OMP_OUTLINED_ARG_AGG_]], i32 0, i32 1
// CHECK9-NEXT:    store i64* [[DOTCAPTURED_OMP_PREVIOUS_UB]], i64** [[TMP15]], align 8
// CHECK9-NEXT:    [[TMP16:%.*]] = getelementptr inbounds [[STRUCT_ANON_0]], %struct.anon.0* [[OMP_OUTLINED_ARG_AGG_]], i32 0, i32 2
// CHECK9-NEXT:    store i32* [[SIVAR]], i32** [[TMP16]], align 8
...
// CHECK9-NEXT:    [[TMP20:%.*]] = bitcast i32* [[SIVAR]] to i8*
// CHECK9-NEXT:    store i8* [[TMP20]], i8** [[TMP19]], align 8
// CHECK9-NEXT:    [[TMP21:%.*]] = bitcast [1 x i8*]* [[DOTOMP_REDUCTION_RED_LIST]] to i8*
// CHECK9-NEXT:    [[TMP22:%.*]] = call i32 @__kmpc_reduce_nowait(%struct.ident_t* @[[GLOB3:[0-9]+]], i32 [[TMP4]], i32 1, i64 8, i8* [[TMP21]], void (i8*, i8*)* @.omp.reduction.reduction_func.2, [8 x i32]* @.gomp_critical_user_.reduction.var)
...
// CHECK9-NEXT:    [[TMP23:%.*]] = load i32, i32* [[TMP2]], align 4
// CHECK9-NEXT:    [[TMP24:%.*]] = load i32, i32* [[SIVAR]], align 4
// CHECK9-NEXT:    [[ADD2:%.*]] = add nsw i32 [[TMP23]], [[TMP24]]
// CHECK9-NEXT:    store i32 [[ADD2]], i32* [[TMP2]], align 4
...
// CHECK9-NEXT:    [[TMP26:%.*]] = atomicrmw add i32* [[TMP2]], i32 [[TMP25]] monotonic, align 4
// CHECK9-NEXT:    br label [[DOTOMP_REDUCTION_DEFAULT]]
...
// CHECK9-NEXT:    [[CMP:%.*]] = icmp sgt i32 [[TMP11]], 1
// CHECK9-NEXT:    br i1 [[CMP]], label [[COND_TRUE:%.*]], label [[COND_FALSE:%.*]]
// CHECK9:       cond.true:
// CHECK9-NEXT:    br label [[COND_END:%.*]]
// CHECK9:       cond.false:
...
// CHECK9-NEXT:    br label [[COND_END]]
// CHECK9:       cond.end:
// CHECK9-NEXT:    [[COND:%.*]] = phi i32 [ 1, [[COND_TRUE]] ], [ [[TMP12]], [[COND_FALSE]] ]
...
// CHECK9-NEXT:    [[ADD3:%.*]] = add nsw i32 [[TMP18]], [[TMP17]]
// CHECK9-NEXT:    store i32 [[ADD3]], i32* [[SIVAR]], align 4
// CHECK9-NEXT:    [[TMP19:%.*]] = getelementptr inbounds [[CLASS_ANON_1]], %class.anon.1* [[REF_TMP]], i32 0, i32 0
// CHECK9-NEXT:    store i32* [[SIVAR]], i32** [[TMP19]], align 8
// CHECK9-NEXT:    call void @"_ZZZ4mainENK3$_0clEvENKUlvE_clEv"(%class.anon.1* nonnull align 8 dereferenceable(8) [[REF_TMP]])
// CHECK9-NEXT:    br label [[OMP_BODY_CONTINUE:%.*]]
// CHECK9:       omp.body.continue:
// CHECK9-NEXT:    br label [[OMP_INNER_FOR_INC:%.*]]
// CHECK9:       omp.inner.for.inc:
// CHECK9-NEXT:    [[TMP20:%.*]] = load i32, i32* [[DOTOMP_IV]], align 4
// CHECK9-NEXT:    [[ADD4:%.*]] = add nsw i32 [[TMP20]], 1
...
// CHECK9-NEXT:    [[TMP21:%.*]] = getelementptr inbounds [1 x i8*], [1 x i8*]* [[DOTOMP_REDUCTION_RED_LIST]], i64 0, i64 0
// CHECK9-NEXT:    [[TMP22:%.*]] = bitcast i32* [[SIVAR]] to i8*
// CHECK9-NEXT:    store i8* [[TMP22]], i8** [[TMP21]], align 8
// CHECK9-NEXT:    [[TMP23:%.*]] = bitcast [1 x i8*]* [[DOTOMP_REDUCTION_RED_LIST]] to i8*
// CHECK9-NEXT:    [[TMP24:%.*]] = call i32 @__kmpc_reduce_nowait(%struct.ident_t* @[[GLOB3]], i32 [[TMP10]], i32 1, i64 8, i8* [[TMP23]], void (i8*, i8*)* @.omp.reduction.reduction_func, [8 x i32]* @.gomp_critical_user_.reduction.var)
// CHECK9-NEXT:    switch i32 [[TMP24]], label [[DOTOMP_REDUCTION_DEFAULT:%.*]] [
// CHECK9-NEXT:    i32 1, label [[DOTOMP_REDUCTION_CASE1:%.*]]
// CHECK9-NEXT:    i32 2, label [[DOTOMP_REDUCTION_CASE2:%.*]]
// CHECK9-NEXT:    ]
// CHECK9:       .omp.reduction.case1:
// CHECK9-NEXT:    [[TMP25:%.*]] = load i32, i32* [[TMP6]], align 4
// CHECK9-NEXT:    [[TMP26:%.*]] = load i32, i32* [[SIVAR]], align 4
// CHECK9-NEXT:    [[ADD5:%.*]] = add nsw i32 [[TMP25]], [[TMP26]]
// CHECK9-NEXT:    store i32 [[ADD5]], i32* [[TMP6]], align 4
// CHECK9-NEXT:    call void @__kmpc_end_reduce_nowait(%struct.ident_t* @[[GLOB3]], i32 [[TMP10]], [8 x i32]* @.gomp_critical_user_.reduction.var)
// CHECK9-NEXT:    br label [[DOTOMP_REDUCTION_DEFAULT]]
// CHECK9:       .omp.reduction.case2:
// CHECK9-NEXT:    [[TMP27:%.*]] = load i32, i32* [[SIVAR]], align 4
// CHECK9-NEXT:    [[TMP28:%.*]] = atomicrmw add i32* [[TMP6]], i32 [[TMP27]] monotonic, align 4
// CHECK9-NEXT:    br label [[DOTOMP_REDUCTION_DEFAULT]]
// CHECK9:       .omp.reduction.default:
// CHECK9-NEXT:    ret void
//
...
// CHECK10-NEXT:    call void (%struct.ident_t*, i32, void (i32*, i32*, ...)*, ...) @__kmpc_fork_teams(%struct.ident_t* @[[GLOB4:[0-9]+]], i32 1, void (i32*, i32*, ...)* bitcast (void (i32*, i32*, %struct.anon*)* @.omp_outlined. to void (i32*, i32*, ...)*), %struct.anon* [[OMP_OUTLINED_ARG_AGG_]])
...
// CHECK10-NEXT:    call void @__kmpc_for_static_init_4(%struct.ident_t* @[[GLOB1:[0-9]+]], i32 [[TMP4]], i32 92, i32* [[DOTOMP_IS_LAST]], i32* [[DOTOMP_COMB_LB]], i32* [[DOTOMP_COMB_UB]], i32* [[DOTOMP_STRIDE]], i32 1, i32 1)
...
// CHECK10-NEXT:    [[TMP14:%.*]] = getelementptr inbounds [[STRUCT_ANON_0]], %struct.anon.0* [[OMP_OUTLINED_ARG_AGG_]], i32 0, i32 0
// CHECK10-NEXT:    store i64* [[DOTCAPTURED_OMP_PREVIOUS_LB]], i64** [[TMP14]], align 8
// CHECK10-NEXT:    [[TMP15:%.*]] = getelementptr inbounds [[STRUCT_ANON_0]], %struct.anon.0* [[OMP_OUTLINED_ARG_AGG_]], i32 0, i32 1
// CHECK10-NEXT:    store i64* [[DOTCAPTURED_OMP_PREVIOUS_UB]], i64** [[TMP15]], align 8
// CHECK10-NEXT:    [[TMP16:%.*]] = getelementptr inbounds [[STRUCT_ANON_0]], %struct.anon.0* [[OMP_OUTLINED_ARG_AGG_]], i32 0, i32 2
// CHECK10-NEXT:    store i32* [[SIVAR]], i32** [[TMP16]], align 8
...
// CHECK10-NEXT:    [[TMP20:%.*]] = bitcast i32* [[SIVAR]] to i8*
// CHECK10-NEXT:    store i8* [[TMP20]], i8** [[TMP19]], align 8
// CHECK10-NEXT:    [[TMP21:%.*]] = bitcast [1 x i8*]* [[DOTOMP_REDUCTION_RED_LIST]] to i8*
// CHECK10-NEXT:    [[TMP22:%.*]] = call i32 @__kmpc_reduce_nowait(%struct.ident_t* @[[GLOB3:[0-9]+]], i32 [[TMP4]], i32 1, i64 8, i8* [[TMP21]], void (i8*, i8*)* @.omp.reduction.reduction_func.2, [8 x i32]* @.gomp_critical_user_.reduction.var)
...
// CHECK10-NEXT:    [[TMP23:%.*]] = load i32, i32* [[TMP2]], align 4
// CHECK10-NEXT:    [[TMP24:%.*]] = load i32, i32* [[SIVAR]], align 4
// CHECK10-NEXT:    [[ADD2:%.*]] = add nsw i32 [[TMP23]], [[TMP24]]
// CHECK10-NEXT:    store i32 [[ADD2]], i32* [[TMP2]], align 4
...
// CHECK10-NEXT:    [[TMP26:%.*]] = atomicrmw add i32* [[TMP2]], i32 [[TMP25]] monotonic, align 4
// CHECK10-NEXT:    br label [[DOTOMP_REDUCTION_DEFAULT]]
...
// CHECK10-NEXT:    [[CMP:%.*]] = icmp sgt i32 [[TMP11]], 1
// CHECK10-NEXT:    br i1 [[CMP]], label [[COND_TRUE:%.*]], label [[COND_FALSE:%.*]]
// CHECK10:       cond.true:
// CHECK10-NEXT:    br label [[COND_END:%.*]]
// CHECK10:       cond.false:
...
// CHECK10-NEXT:    br label [[COND_END]]
// CHECK10:       cond.end:
// CHECK10-NEXT:    [[COND:%.*]] = phi i32 [ 1, [[COND_TRUE]] ], [ [[TMP12]], [[COND_FALSE]] ]
...
// CHECK10-NEXT:    [[TMP18:%.*]] = load i32, i32* [[SIVAR]], align 4
// CHECK10-NEXT:    [[ADD3:%.*]] = add nsw i32 [[TMP18]], [[TMP17]]
// CHECK10-NEXT:    store i32 [[ADD3]], i32* [[SIVAR]], align 4
// CHECK10-NEXT:    [[TMP19:%.*]] = getelementptr inbounds [[CLASS_ANON_1]], %class.anon.1* [[REF_TMP]], i32 0, i32 0
// CHECK10-NEXT:    store i32* [[SIVAR]], i32** [[TMP19]], align 8
// CHECK10-NEXT:    call void @"_ZZZ4mainENK3$_0clEvENKUlvE_clEv"(%class.anon.1* nonnull align 8 dereferenceable(8) [[REF_TMP]])
// CHECK10-NEXT:    br label [[OMP_BODY_CONTINUE:%.*]]
// CHECK10:       omp.body.continue:
// CHECK10-NEXT:    br label [[OMP_INNER_FOR_INC:%.*]]
// CHECK10:       omp.inner.for.inc:
// CHECK10-NEXT:    [[TMP20:%.*]] = load i32, i32* [[DOTOMP_IV]], align 4
// CHECK10-NEXT:    [[ADD4:%.*]] = add nsw i32 [[TMP20]], 1
...
// CHECK10-NEXT:    [[TMP21:%.*]] = getelementptr inbounds [1 x i8*], [1 x i8*]* [[DOTOMP_REDUCTION_RED_LIST]], i64 0, i64 0
// CHECK10-NEXT:    [[TMP22:%.*]] = bitcast i32* [[SIVAR]] to i8*
// CHECK10-NEXT:    store i8* [[TMP22]], i8** [[TMP21]], align 8
// CHECK10-NEXT:    [[TMP23:%.*]] = bitcast [1 x i8*]* [[DOTOMP_REDUCTION_RED_LIST]] to i8*
// CHECK10-NEXT:    [[TMP24:%.*]] = call i32 @__kmpc_reduce_nowait(%struct.ident_t* @[[GLOB3]], i32 [[TMP10]], i32 1, i64 8, i8* [[TMP23]], void (i8*, i8*)* @.omp.reduction.reduction_func, [8 x i32]* @.gomp_critical_user_.reduction.var)
// CHECK10-NEXT:    switch i32 [[TMP24]], label [[DOTOMP_REDUCTION_DEFAULT:%.*]] [
// CHECK10-NEXT:    i32 1, label [[DOTOMP_REDUCTION_CASE1:%.*]]
// CHECK10-NEXT:    i32 2, label [[DOTOMP_REDUCTION_CASE2:%.*]]
// CHECK10-NEXT:    ]
// CHECK10:       .omp.reduction.case1:
// CHECK10-NEXT:    [[TMP25:%.*]] = load i32, i32* [[TMP6]], align 4
// CHECK10-NEXT:    [[TMP26:%.*]] = load i32, i32* [[SIVAR]], align 4
// CHECK10-NEXT:    [[ADD5:%.*]] = add nsw i32 [[TMP25]], [[TMP26]]
// CHECK10-NEXT:    store i32 [[ADD5]], i32* [[TMP6]], align 4
// CHECK10-NEXT:    call void @__kmpc_end_reduce_nowait(%struct.ident_t* @[[GLOB3]], i32 [[TMP10]], [8 x i32]* @.gomp_critical_user_.reduction.var)
// CHECK10-NEXT:    br label [[DOTOMP_REDUCTION_DEFAULT]]
// CHECK10:       .omp.reduction.case2:
// CHECK10-NEXT:    [[TMP27:%.*]] = load i32, i32* [[SIVAR]], align 4
// CHECK10-NEXT:    [[TMP28:%.*]] = atomicrmw add i32* [[TMP6]], i32 [[TMP27]] monotonic, align 4
// CHECK10-NEXT:    br label [[DOTOMP_REDUCTION_DEFAULT]]
// CHECK10:       .omp.reduction.default:
// CHECK10-NEXT:    ret void
//
