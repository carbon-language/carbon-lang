...
// CHECK9-NEXT:    call void (%struct.ident_t*, i32, void (i32*, i32*, ...)*, ...) @__kmpc_fork_call(%struct.ident_t* @[[GLOB4]], i32 3, void (i32*, i32*, ...)* bitcast (void (i32*, i32*, i64, i64, %struct.anon.0*)* @.omp_outlined..1 to void (i32*, i32*, ...)*), i64 [[TMP11]], i64 [[TMP13]], %struct.anon.0* [[OMP_OUTLINED_ARG_AGG_]])
...
// CHECK9-NEXT:    [[TMP20:%.*]] = call i32 @__kmpc_reduce_nowait(%struct.ident_t* @[[GLOB3:[0-9]+]], i32 [[TMP4]], i32 1, i64 8, i8* [[TMP19]], void (i8*, i8*)* @.omp.reduction.reduction_func.2, [8 x i32]* @.gomp_critical_user_.reduction.var)
...
// CHECK9-NEXT:    call void @__kmpc_for_static_init_4(%struct.ident_t* @[[GLOB2:[0-9]+]], i32 [[TMP6]], i32 34, i32* [[DOTOMP_IS_LAST]], i32* [[DOTOMP_LB]], i32* [[DOTOMP_UB]], i32* [[DOTOMP_STRIDE]], i32 1, i32 1)
...
// CHECK9-NEXT:    [[TMP14:%.*]] = load i32, i32* [[SIVAR]], align 4
// CHECK9-NEXT:    [[ADD3:%.*]] = add nsw i32 [[TMP14]], [[TMP13]]
// CHECK9-NEXT:    store i32 [[ADD3]], i32* [[SIVAR]], align 4
// CHECK9-NEXT:    [[TMP15:%.*]] = getelementptr inbounds [[CLASS_ANON_1]], %class.anon.1* [[REF_TMP]], i32 0, i32 0
...
// CHECK9-NEXT:    [[ADD4:%.*]] = add nsw i32 [[TMP16]], 1
...
// CHECK9-NEXT:    store i8* [[TMP18]], i8** [[TMP17]], align 8
// CHECK9-NEXT:    [[TMP19:%.*]] = bitcast [1 x i8*]* [[DOTOMP_REDUCTION_RED_LIST]] to i8*
// CHECK9-NEXT:    [[TMP20:%.*]] = call i32 @__kmpc_reduce_nowait(%struct.ident_t* @[[GLOB3]], i32 [[TMP6]], i32 1, i64 8, i8* [[TMP19]], void (i8*, i8*)* @.omp.reduction.reduction_func, [8 x i32]* @.gomp_critical_user_.reduction.var)
// CHECK9-NEXT:    switch i32 [[TMP20]], label [[DOTOMP_REDUCTION_DEFAULT:%.*]] [
// CHECK9-NEXT:    i32 1, label [[DOTOMP_REDUCTION_CASE1:%.*]]
// CHECK9-NEXT:    i32 2, label [[DOTOMP_REDUCTION_CASE2:%.*]]
// CHECK9-NEXT:    ]
...
// CHECK9-NEXT:    [[TMP21:%.*]] = load i32, i32* [[TMP2]], align 4
// CHECK9-NEXT:    [[TMP22:%.*]] = load i32, i32* [[SIVAR]], align 4
// CHECK9-NEXT:    [[ADD5:%.*]] = add nsw i32 [[TMP21]], [[TMP22]]
// CHECK9-NEXT:    store i32 [[ADD5]], i32* [[TMP2]], align 4
// CHECK9-NEXT:    call void @__kmpc_end_reduce_nowait(%struct.ident_t* @[[GLOB3]], i32 [[TMP6]], [8 x i32]* @.gomp_critical_user_.reduction.var)
// CHECK9-NEXT:    br label [[DOTOMP_REDUCTION_DEFAULT]]
// CHECK9:       .omp.reduction.case2:
// CHECK9-NEXT:    [[TMP23:%.*]] = load i32, i32* [[SIVAR]], align 4
// CHECK9-NEXT:    [[TMP24:%.*]] = atomicrmw add i32* [[TMP2]], i32 [[TMP23]] monotonic, align 4
...
// CHECK10-NEXT:    call void (%struct.ident_t*, i32, void (i32*, i32*, ...)*, ...) @__kmpc_fork_call(%struct.ident_t* @[[GLOB4]], i32 3, void (i32*, i32*, ...)* bitcast (void (i32*, i32*, i64, i64, %struct.anon.0*)* @.omp_outlined..1 to void (i32*, i32*, ...)*), i64 [[TMP11]], i64 [[TMP13]], %struct.anon.0* [[OMP_OUTLINED_ARG_AGG_]])
...
// CHECK10-NEXT:    [[TMP20:%.*]] = call i32 @__kmpc_reduce_nowait(%struct.ident_t* @[[GLOB3:[0-9]+]], i32 [[TMP4]], i32 1, i64 8, i8* [[TMP19]], void (i8*, i8*)* @.omp.reduction.reduction_func.2, [8 x i32]* @.gomp_critical_user_.reduction.var)
...
// CHECK10-NEXT:    call void @__kmpc_for_static_init_4(%struct.ident_t* @[[GLOB2:[0-9]+]], i32 [[TMP6]], i32 34, i32* [[DOTOMP_IS_LAST]], i32* [[DOTOMP_LB]], i32* [[DOTOMP_UB]], i32* [[DOTOMP_STRIDE]], i32 1, i32 1)
...
// CHECK10-NEXT:    [[TMP14:%.*]] = load i32, i32* [[SIVAR]], align 4
// CHECK10-NEXT:    [[ADD3:%.*]] = add nsw i32 [[TMP14]], [[TMP13]]
// CHECK10-NEXT:    store i32 [[ADD3]], i32* [[SIVAR]], align 4
// CHECK10-NEXT:    [[TMP15:%.*]] = getelementptr inbounds [[CLASS_ANON_1]], %class.anon.1* [[REF_TMP]], i32 0, i32 0
...
// CHECK10-NEXT:    [[ADD4:%.*]] = add nsw i32 [[TMP16]], 1
...
// CHECK10-NEXT:    store i8* [[TMP18]], i8** [[TMP17]], align 8
// CHECK10-NEXT:    [[TMP19:%.*]] = bitcast [1 x i8*]* [[DOTOMP_REDUCTION_RED_LIST]] to i8*
// CHECK10-NEXT:    [[TMP20:%.*]] = call i32 @__kmpc_reduce_nowait(%struct.ident_t* @[[GLOB3]], i32 [[TMP6]], i32 1, i64 8, i8* [[TMP19]], void (i8*, i8*)* @.omp.reduction.reduction_func, [8 x i32]* @.gomp_critical_user_.reduction.var)
// CHECK10-NEXT:    switch i32 [[TMP20]], label [[DOTOMP_REDUCTION_DEFAULT:%.*]] [
// CHECK10-NEXT:    i32 1, label [[DOTOMP_REDUCTION_CASE1:%.*]]
// CHECK10-NEXT:    i32 2, label [[DOTOMP_REDUCTION_CASE2:%.*]]
// CHECK10-NEXT:    ]
...
// CHECK10-NEXT:    [[TMP21:%.*]] = load i32, i32* [[TMP2]], align 4
// CHECK10-NEXT:    [[TMP22:%.*]] = load i32, i32* [[SIVAR]], align 4
// CHECK10-NEXT:    [[ADD5:%.*]] = add nsw i32 [[TMP21]], [[TMP22]]
// CHECK10-NEXT:    store i32 [[ADD5]], i32* [[TMP2]], align 4
// CHECK10-NEXT:    call void @__kmpc_end_reduce_nowait(%struct.ident_t* @[[GLOB3]], i32 [[TMP6]], [8 x i32]* @.gomp_critical_user_.reduction.var)
// CHECK10-NEXT:    br label [[DOTOMP_REDUCTION_DEFAULT]]
// CHECK10:       .omp.reduction.case2:
// CHECK10-NEXT:    [[TMP23:%.*]] = load i32, i32* [[SIVAR]], align 4
// CHECK10-NEXT:    [[TMP24:%.*]] = atomicrmw add i32* [[TMP2]], i32 [[TMP23]] monotonic, align 4
