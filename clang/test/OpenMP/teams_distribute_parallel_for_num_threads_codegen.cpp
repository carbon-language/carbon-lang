...
// CHECK1-NEXT:    [[TMP12:%.*]] = landingpad { i8*, i32 }
// CHECK1-NEXT:    catch i8* null
// CHECK1-NEXT:    [[TMP13:%.*]] = extractvalue { i8*, i32 } [[TMP12]], 0
// CHECK1-NEXT:    call void @__clang_call_terminate(i8* [[TMP13]]) #[[ATTR9:[0-9]+]]
...
// CHECK1-NEXT:    catch i8* null
// CHECK1-NEXT:    [[TMP13:%.*]] = extractvalue { i8*, i32 } [[TMP12]], 0
// CHECK1-NEXT:    call void @__clang_call_terminate(i8* [[TMP13]]) #[[ATTR9]]
// CHECK1-NEXT:    unreachable
//
//
...
// CHECK2-NEXT:    [[TMP12:%.*]] = landingpad { i8*, i32 }
// CHECK2-NEXT:    catch i8* null
// CHECK2-NEXT:    [[TMP13:%.*]] = extractvalue { i8*, i32 } [[TMP12]], 0
// CHECK2-NEXT:    call void @__clang_call_terminate(i8* [[TMP13]]) #[[ATTR9:[0-9]+]]
...
// CHECK2-NEXT:    catch i8* null
// CHECK2-NEXT:    [[TMP13:%.*]] = extractvalue { i8*, i32 } [[TMP12]], 0
// CHECK2-NEXT:    call void @__clang_call_terminate(i8* [[TMP13]]) #[[ATTR9]]
// CHECK2-NEXT:    unreachable
//
//
...
// CHECK5-NEXT:    [[TMP12:%.*]] = landingpad { i8*, i32 }
// CHECK5-NEXT:    catch i8* null
// CHECK5-NEXT:    [[TMP13:%.*]] = extractvalue { i8*, i32 } [[TMP12]], 0
// CHECK5-NEXT:    call void @__clang_call_terminate(i8* [[TMP13]]) #[[ATTR9:[0-9]+]]
...
// CHECK5-NEXT:    catch i8* null
// CHECK5-NEXT:    [[TMP13:%.*]] = extractvalue { i8*, i32 } [[TMP12]], 0
// CHECK5-NEXT:    call void @__clang_call_terminate(i8* [[TMP13]]) #[[ATTR9]]
// CHECK5-NEXT:    unreachable
//
//
...
// CHECK6-NEXT:    [[TMP12:%.*]] = landingpad { i8*, i32 }
// CHECK6-NEXT:    catch i8* null
// CHECK6-NEXT:    [[TMP13:%.*]] = extractvalue { i8*, i32 } [[TMP12]], 0
// CHECK6-NEXT:    call void @__clang_call_terminate(i8* [[TMP13]]) #[[ATTR9:[0-9]+]]
...
// CHECK6-NEXT:    catch i8* null
// CHECK6-NEXT:    [[TMP13:%.*]] = extractvalue { i8*, i32 } [[TMP12]], 0
// CHECK6-NEXT:    call void @__clang_call_terminate(i8* [[TMP13]]) #[[ATTR9]]
// CHECK6-NEXT:    unreachable
//
//
