...
// CHECK1-NEXT:    [[TMP19:%.*]] = load double*, double** [[_TMP3]], align 8
// CHECK1-NEXT:    store volatile double 1.000000e+00, double* [[TMP19]], align 8
...
// CHECK2-NEXT:    [[TMP19:%.*]] = load double*, double** [[_TMP3]], align 8
// CHECK2-NEXT:    store volatile double 1.000000e+00, double* [[TMP19]], align 8
...
// CHECK3-NEXT:    [[TMP19:%.*]] = load double*, double** [[_TMP3]], align 4
// CHECK3-NEXT:    store volatile double 1.000000e+00, double* [[TMP19]], align 4
...
// CHECK4-NEXT:    [[TMP19:%.*]] = load double*, double** [[_TMP3]], align 4
// CHECK4-NEXT:    store volatile double 1.000000e+00, double* [[TMP19]], align 4
...
// CHECK9-NEXT:    [[TMP21:%.*]] = load i32, i32* [[T_VAR]], align 4
...
// CHECK9-NEXT:    store i32 [[TMP21]], i32* [[ARRAYIDX]], align 4
// CHECK9-NEXT:    [[TMP23:%.*]] = load %struct.S*, %struct.S** [[_TMP3]], align 8
...
// CHECK9-NEXT:    call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 4 [[TMP25]], i8* align 4 [[TMP26]], i64 4, i1 false)
...
// CHECK9-NEXT:    [[ADD:%.*]] = add nsw i32 0, [[MUL]]
// CHECK9-NEXT:    store i32 [[ADD]], i32* [[I]], align 4
// CHECK9-NEXT:    [[TMP19:%.*]] = load i32, i32* [[T_VAR]], align 4
...
// CHECK9-NEXT:    [[TMP21:%.*]] = load %struct.S.0*, %struct.S.0** [[_TMP3]], align 8
// CHECK9-NEXT:    [[TMP22:%.*]] = load i32, i32* [[I]], align 4
...
// CHECK9-NEXT:    call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 4 [[TMP23]], i8* align 4 [[TMP24]], i64 4, i1 false)
// CHECK9-NEXT:    br label [[OMP_BODY_CONTINUE:%.*]]
// CHECK9:       omp.body.continue:
// CHECK9-NEXT:    br label [[OMP_INNER_FOR_INC:%.*]]
// CHECK9:       omp.inner.for.inc:
...
// CHECK10-NEXT:    [[TMP21:%.*]] = load i32, i32* [[T_VAR]], align 4
...
// CHECK10-NEXT:    store i32 [[TMP21]], i32* [[ARRAYIDX]], align 4
// CHECK10-NEXT:    [[TMP23:%.*]] = load %struct.S*, %struct.S** [[_TMP3]], align 8
...
// CHECK10-NEXT:    call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 4 [[TMP25]], i8* align 4 [[TMP26]], i64 4, i1 false)
...
// CHECK10-NEXT:    [[ADD:%.*]] = add nsw i32 0, [[MUL]]
// CHECK10-NEXT:    store i32 [[ADD]], i32* [[I]], align 4
// CHECK10-NEXT:    [[TMP19:%.*]] = load i32, i32* [[T_VAR]], align 4
...
// CHECK10-NEXT:    [[TMP21:%.*]] = load %struct.S.0*, %struct.S.0** [[_TMP3]], align 8
// CHECK10-NEXT:    [[TMP22:%.*]] = load i32, i32* [[I]], align 4
...
// CHECK10-NEXT:    call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 4 [[TMP23]], i8* align 4 [[TMP24]], i64 4, i1 false)
// CHECK10-NEXT:    br label [[OMP_BODY_CONTINUE:%.*]]
// CHECK10:       omp.body.continue:
// CHECK10-NEXT:    br label [[OMP_INNER_FOR_INC:%.*]]
// CHECK10:       omp.inner.for.inc:
...
// CHECK11-NEXT:    [[TMP21:%.*]] = load i32, i32* [[T_VAR]], align 4
...
// CHECK11-NEXT:    store i32 [[TMP21]], i32* [[ARRAYIDX]], align 4
// CHECK11-NEXT:    [[TMP23:%.*]] = load %struct.S*, %struct.S** [[_TMP3]], align 4
...
// CHECK11-NEXT:    call void @llvm.memcpy.p0i8.p0i8.i32(i8* align 4 [[TMP25]], i8* align 4 [[TMP26]], i32 4, i1 false)
...
// CHECK11-NEXT:    [[ADD:%.*]] = add nsw i32 0, [[MUL]]
// CHECK11-NEXT:    store i32 [[ADD]], i32* [[I]], align 4
// CHECK11-NEXT:    [[TMP19:%.*]] = load i32, i32* [[T_VAR]], align 4
// CHECK11-NEXT:    [[TMP20:%.*]] = load i32, i32* [[I]], align 4
...
// CHECK11-NEXT:    [[TMP21:%.*]] = load %struct.S.0*, %struct.S.0** [[_TMP3]], align 4
// CHECK11-NEXT:    [[TMP22:%.*]] = load i32, i32* [[I]], align 4
...
// CHECK11-NEXT:    call void @llvm.memcpy.p0i8.p0i8.i32(i8* align 4 [[TMP23]], i8* align 4 [[TMP24]], i32 4, i1 false)
// CHECK11-NEXT:    br label [[OMP_BODY_CONTINUE:%.*]]
// CHECK11:       omp.body.continue:
// CHECK11-NEXT:    br label [[OMP_INNER_FOR_INC:%.*]]
// CHECK11:       omp.inner.for.inc:
...
// CHECK12-NEXT:    [[TMP21:%.*]] = load i32, i32* [[T_VAR]], align 4
...
// CHECK12-NEXT:    store i32 [[TMP21]], i32* [[ARRAYIDX]], align 4
// CHECK12-NEXT:    [[TMP23:%.*]] = load %struct.S*, %struct.S** [[_TMP3]], align 4
...
// CHECK12-NEXT:    call void @llvm.memcpy.p0i8.p0i8.i32(i8* align 4 [[TMP25]], i8* align 4 [[TMP26]], i32 4, i1 false)
...
// CHECK12-NEXT:    [[ADD:%.*]] = add nsw i32 0, [[MUL]]
// CHECK12-NEXT:    store i32 [[ADD]], i32* [[I]], align 4
// CHECK12-NEXT:    [[TMP19:%.*]] = load i32, i32* [[T_VAR]], align 4
// CHECK12-NEXT:    [[TMP20:%.*]] = load i32, i32* [[I]], align 4
// CHECK12-NEXT:    [[ARRAYIDX:%.*]] = getelementptr inbounds [2 x i32], [2 x i32]* [[VEC]], i32 0, i32 [[TMP20]]
// CHECK12-NEXT:    store i32 [[TMP19]], i32* [[ARRAYIDX]], align 4
// CHECK12-NEXT:    [[TMP21:%.*]] = load %struct.S.0*, %struct.S.0** [[_TMP3]], align 4
// CHECK12-NEXT:    [[TMP22:%.*]] = load i32, i32* [[I]], align 4
...
// CHECK12-NEXT:    call void @llvm.memcpy.p0i8.p0i8.i32(i8* align 4 [[TMP23]], i8* align 4 [[TMP24]], i32 4, i1 false)
// CHECK12-NEXT:    br label [[OMP_BODY_CONTINUE:%.*]]
// CHECK12:       omp.body.continue:
// CHECK12-NEXT:    br label [[OMP_INNER_FOR_INC:%.*]]
// CHECK12:       omp.inner.for.inc:
