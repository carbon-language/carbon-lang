...
// CHECK2-NEXT:    [[TMP4:%.*]] = call i8* @__kmpc_threadprivate_cached(%struct.ident_t* @[[GLOB1]], i32 [[TMP2]], i8* bitcast (i64* @reduction_size.d_2147347808.artificial. to i8*), i64 8, i8*** @reduction_size.d_2147347808.artificial..cache.)
...
// CHECK2-NEXT:    store i8* [[TMP0]], i8** [[DOTADDR]], align 8
// CHECK2-NEXT:    store i8* [[TMP1]], i8** [[DOTADDR1]], align 8
// CHECK2-NEXT:    [[TMP3:%.*]] = call i8* @__kmpc_threadprivate_cached(%struct.ident_t* @[[GLOB1]], i32 [[TMP2]], i8* bitcast (i64* @reduction_size.d_2147347808.artificial. to i8*), i64 8, i8*** @reduction_size.d_2147347808.artificial..cache.)
...
// CHECK2-NEXT:    [[TMP40:%.*]] = call i8* @__kmpc_threadprivate_cached(%struct.ident_t* @[[GLOB1]], i32 [[TMP33]], i8* bitcast (i64* @reduction_size.d_2147347808.artificial. to i8*), i64 8, i8*** @reduction_size.d_2147347808.artificial..cache.) #[[ATTR3]]
