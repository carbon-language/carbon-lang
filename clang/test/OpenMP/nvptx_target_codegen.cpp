...
int foo(int n) {
  ...
  // CHECK-LABEL: define {{.*}}void {{@__omp_offloading_.+foo.+l159}}_worker()
  // CHECK: br label {{%?}}[[AWAIT_WORK:.+]]
  //
  // CHECK: [[AWAIT_WORK]]
  // CHECK: call void @llvm.nvvm.barrier0()
  ...
  // CHECK: define {{.*}}void [[T3:@__omp_offloading_.+foo.+l159]](i[[SZ:32|64]] [[ARG1:%.+]])
  ...
  // CHECK-LABEL: define {{.*}}void {{@__omp_offloading_.+foo.+l263}}_worker()
  // CHECK: br label {{%?}}[[AWAIT_WORK:.+]]
  //
  // CHECK: [[AWAIT_WORK]]
  // CHECK: call void @llvm.nvvm.barrier0()
  ...
  // CHECK: define {{.*}}void [[T4:@__omp_offloading_.+foo.+l263]](i[[SZ]]
...
int bar(int n){
  ...
  // CHECK-LABEL: define {{.*}}void {{@__omp_offloading_.+static.+l300}}_worker()
  // CHECK: br label {{%?}}[[AWAIT_WORK:.+]]
  //
  // CHECK: [[AWAIT_WORK]]
  // CHECK: call void @llvm.nvvm.barrier0()
  ...
  // CHECK: define {{.*}}void [[T5:@__omp_offloading_.+static.+l300]](i[[SZ]]
  // Create local storage for each capture.
  // CHECK:  [[LOCAL_A:%.+]] = alloca i[[SZ]]
  ...
  // CHECK-LABEL: define {{.*}}void {{@__omp_offloading_.+S1.+l318}}_worker()
  // CHECK: br label {{%?}}[[AWAIT_WORK:.+]]
  //
  // CHECK: [[AWAIT_WORK]]
  // CHECK: call void @llvm.nvvm.barrier0()
  ...
  // CHECK: define {{.*}}void [[T6:@__omp_offloading_.+S1.+l318]](
  // Create local storage for each capture.
  ...
  // CHECK-LABEL: define {{.*}}void {{@__omp_offloading_.+template.+l283}}_worker()
  // CHECK: br label {{%?}}[[AWAIT_WORK:.+]]
  //
  // CHECK: [[AWAIT_WORK]]
  // CHECK: call void @llvm.nvvm.barrier0()
  ...
  // CHECK: define {{.*}}void [[T7:@__omp_offloading_.+template.+l283]](i[[SZ]]
  // Create local storage for each capture.
  // CHECK:  [[LOCAL_A:%.+]] = alloca i[[SZ]]
  // CHECK:  [[LOCAL_AA:%.+]] = alloca i[[SZ]]
  // CHECK:  [[LOCAL_B:%.+]] = alloca [10 x i32]*
