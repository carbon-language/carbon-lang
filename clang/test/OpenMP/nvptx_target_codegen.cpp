...
// CHECK1-NEXT:    call void @__kmpc_free_shared(i8* [[TMP6]])
...
// CHECK1-NEXT:    call void @__omp_outlined__1(i32* [[DOTADDR1]], i32* [[DOTZERO_ADDR]], %struct.anon.0* [[TMP5]]) #[[ATTR1:[0-9]+]]
// CHECK1-NEXT:    ret void
//
//
...
// CHECK2-NEXT:    call void @__kmpc_free_shared(i8* [[TMP6]])
...
// CHECK2-NEXT:    call void @__omp_outlined__1(i32* [[DOTADDR1]], i32* [[DOTZERO_ADDR]], %struct.anon.0* [[TMP5]]) #[[ATTR1:[0-9]+]]
// CHECK2-NEXT:    ret void
//
//
...
// CHECK3-NEXT:    call void @__kmpc_free_shared(i8* [[TMP6]])
...
// CHECK3-NEXT:    call void @__omp_outlined__1(i32* [[DOTADDR1]], i32* [[DOTZERO_ADDR]], %struct.anon.0* [[TMP5]]) #[[ATTR1:[0-9]+]]
// CHECK3-NEXT:    ret void
//
