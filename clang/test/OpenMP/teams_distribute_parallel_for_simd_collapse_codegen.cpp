...
// CHECK9-NEXT:    [[TMP34:%.*]] = load i64, i64* [[DOTOMP_IV]], align 8
// CHECK9-NEXT:    [[TMP35:%.*]] = load i64, i64* [[DOTOMP_STRIDE]], align 8
// CHECK9-NEXT:    [[ADD:%.*]] = add nsw i64 [[TMP34]], [[TMP35]]
...
// CHECK9-NEXT:    [[TMP40:%.*]] = load i32, i32* [[DOTCAPTURE_EXPR_]], align 4
// CHECK9-NEXT:    [[SUB13:%.*]] = sub nsw i32 [[TMP40]], 0
...
// CHECK9-NEXT:    [[TMP41:%.*]] = load i32, i32* [[DOTCAPTURE_EXPR_2]], align 4
// CHECK9-NEXT:    [[SUB17:%.*]] = sub nsw i32 [[TMP41]], 0
...
// CHECK9-NEXT:    [[TMP41:%.*]] = load i32, i32* [[DOTOMP_IS_LAST]], align 4
// CHECK9-NEXT:    [[TMP42:%.*]] = icmp ne i32 [[TMP41]], 0
// CHECK9-NEXT:    br i1 [[TMP42]], label [[DOTOMP_FINAL_THEN:%.*]], label [[DOTOMP_FINAL_DONE:%.*]]
// CHECK9:       .omp.final.then:
// CHECK9-NEXT:    [[TMP43:%.*]] = load i32, i32* [[DOTCAPTURE_EXPR_]], align 4
// CHECK9-NEXT:    [[SUB37:%.*]] = sub nsw i32 [[TMP43]], 0
...
// CHECK9-NEXT:    [[SUB41:%.*]] = sub nsw i32 [[TMP44]], 0
...
// CHECK10-NEXT:    [[TMP34:%.*]] = load i64, i64* [[DOTOMP_IV]], align 8
// CHECK10-NEXT:    [[TMP35:%.*]] = load i64, i64* [[DOTOMP_STRIDE]], align 8
// CHECK10-NEXT:    [[ADD:%.*]] = add nsw i64 [[TMP34]], [[TMP35]]
...
// CHECK10-NEXT:    [[TMP40:%.*]] = load i32, i32* [[DOTCAPTURE_EXPR_]], align 4
// CHECK10-NEXT:    [[SUB13:%.*]] = sub nsw i32 [[TMP40]], 0
...
// CHECK10-NEXT:    [[TMP41:%.*]] = load i32, i32* [[DOTCAPTURE_EXPR_2]], align 4
// CHECK10-NEXT:    [[SUB17:%.*]] = sub nsw i32 [[TMP41]], 0
...
// CHECK10-NEXT:    [[TMP41:%.*]] = load i32, i32* [[DOTOMP_IS_LAST]], align 4
// CHECK10-NEXT:    [[TMP42:%.*]] = icmp ne i32 [[TMP41]], 0
// CHECK10-NEXT:    br i1 [[TMP42]], label [[DOTOMP_FINAL_THEN:%.*]], label [[DOTOMP_FINAL_DONE:%.*]]
// CHECK10:       .omp.final.then:
// CHECK10-NEXT:    [[TMP43:%.*]] = load i32, i32* [[DOTCAPTURE_EXPR_]], align 4
// CHECK10-NEXT:    [[SUB37:%.*]] = sub nsw i32 [[TMP43]], 0
...
// CHECK10-NEXT:    [[TMP44:%.*]] = load i32, i32* [[DOTCAPTURE_EXPR_2]], align 4
// CHECK10-NEXT:    [[SUB41:%.*]] = sub nsw i32 [[TMP44]], 0
...
// CHECK11-NEXT:    [[TMP37:%.*]] = load i64, i64* [[DOTOMP_STRIDE]], align 8
// CHECK11-NEXT:    [[ADD:%.*]] = add nsw i64 [[TMP36]], [[TMP37]]
...
// CHECK11-NEXT:    [[TMP38:%.*]] = load i32*, i32** [[DOTGLOBAL_TID__ADDR]], align 4
// CHECK11-NEXT:    [[TMP39:%.*]] = load i32, i32* [[TMP38]], align 4
// CHECK11-NEXT:    call void @__kmpc_for_static_fini(%struct.ident_t* @[[GLOB1]], i32 [[TMP39]])
// CHECK11-NEXT:    [[TMP40:%.*]] = load i32, i32* [[DOTOMP_IS_LAST]], align 4
// CHECK11-NEXT:    [[TMP41:%.*]] = icmp ne i32 [[TMP40]], 0
// CHECK11-NEXT:    br i1 [[TMP41]], label [[DOTOMP_FINAL_THEN:%.*]], label [[DOTOMP_FINAL_DONE:%.*]]
// CHECK11:       .omp.final.then:
// CHECK11-NEXT:    [[TMP42:%.*]] = load i32, i32* [[DOTCAPTURE_EXPR_]], align 4
// CHECK11-NEXT:    [[SUB13:%.*]] = sub nsw i32 [[TMP42]], 0
...
// CHECK11-NEXT:    [[SUB17:%.*]] = sub nsw i32 [[TMP43]], 0
...
// CHECK11-NEXT:    [[TMP41:%.*]] = load i32, i32* [[DOTOMP_IS_LAST]], align 4
// CHECK11-NEXT:    [[TMP42:%.*]] = icmp ne i32 [[TMP41]], 0
// CHECK11-NEXT:    br i1 [[TMP42]], label [[DOTOMP_FINAL_THEN:%.*]], label [[DOTOMP_FINAL_DONE:%.*]]
// CHECK11:       .omp.final.then:
// CHECK11-NEXT:    [[TMP43:%.*]] = load i32, i32* [[DOTCAPTURE_EXPR_]], align 4
// CHECK11-NEXT:    [[SUB38:%.*]] = sub nsw i32 [[TMP43]], 0
...
// CHECK11-NEXT:    [[SUB42:%.*]] = sub nsw i32 [[TMP44]], 0
...
// CHECK12-NEXT:    [[TMP37:%.*]] = load i64, i64* [[DOTOMP_STRIDE]], align 8
// CHECK12-NEXT:    [[ADD:%.*]] = add nsw i64 [[TMP36]], [[TMP37]]
...
// CHECK12-NEXT:    [[TMP38:%.*]] = load i32*, i32** [[DOTGLOBAL_TID__ADDR]], align 4
// CHECK12-NEXT:    [[TMP39:%.*]] = load i32, i32* [[TMP38]], align 4
// CHECK12-NEXT:    call void @__kmpc_for_static_fini(%struct.ident_t* @[[GLOB1]], i32 [[TMP39]])
// CHECK12-NEXT:    [[TMP40:%.*]] = load i32, i32* [[DOTOMP_IS_LAST]], align 4
// CHECK12-NEXT:    [[TMP41:%.*]] = icmp ne i32 [[TMP40]], 0
// CHECK12-NEXT:    br i1 [[TMP41]], label [[DOTOMP_FINAL_THEN:%.*]], label [[DOTOMP_FINAL_DONE:%.*]]
// CHECK12:       .omp.final.then:
// CHECK12-NEXT:    [[TMP42:%.*]] = load i32, i32* [[DOTCAPTURE_EXPR_]], align 4
// CHECK12-NEXT:    [[SUB13:%.*]] = sub nsw i32 [[TMP42]], 0
...
// CHECK12-NEXT:    [[SUB17:%.*]] = sub nsw i32 [[TMP43]], 0
...
// CHECK12-NEXT:    [[TMP41:%.*]] = load i32, i32* [[DOTOMP_IS_LAST]], align 4
// CHECK12-NEXT:    [[TMP42:%.*]] = icmp ne i32 [[TMP41]], 0
// CHECK12-NEXT:    br i1 [[TMP42]], label [[DOTOMP_FINAL_THEN:%.*]], label [[DOTOMP_FINAL_DONE:%.*]]
// CHECK12:       .omp.final.then:
// CHECK12-NEXT:    [[TMP43:%.*]] = load i32, i32* [[DOTCAPTURE_EXPR_]], align 4
// CHECK12-NEXT:    [[SUB38:%.*]] = sub nsw i32 [[TMP43]], 0
...
// CHECK12-NEXT:    [[SUB42:%.*]] = sub nsw i32 [[TMP44]], 0
...
// CHECK12-NEXT:    [[TMP18:%.*]] = load i32, i32* [[DOTOMP_IS_LAST]], align 4
// CHECK12-NEXT:    [[TMP19:%.*]] = icmp ne i32 [[TMP18]], 0
// CHECK12-NEXT:    br i1 [[TMP19]], label [[DOTOMP_FINAL_THEN:%.*]], label [[DOTOMP_FINAL_DONE:%.*]]
// CHECK12:       .omp.final.then:
// CHECK12-NEXT:    store i32 10, i32* [[I]], align 4
// CHECK12-NEXT:    store i32 2, i32* [[J]], align 4
// CHECK12-NEXT:    br label [[DOTOMP_FINAL_DONE]]
