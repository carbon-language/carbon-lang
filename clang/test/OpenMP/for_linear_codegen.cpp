...
// CHECK1-NEXT:    [[TMP22:%.*]] = bitcast i64* [[DOTLVAR__ADDR]] to i8*
// CHECK1-NEXT:    call void @__kmpc_free(i32 [[TMP8]], i8* [[TMP22]], i8* inttoptr (i64 5 to i8*))
// CHECK1-NEXT:    [[TMP23:%.*]] = load i32, i32* [[DOTOMP_IS_LAST]], align 4
// CHECK1-NEXT:    [[TMP24:%.*]] = icmp ne i32 [[TMP23]], 0
// CHECK1-NEXT:    br i1 [[TMP24]], label [[DOTOMP_LINEAR_PU:%.*]], label [[DOTOMP_LINEAR_PU_DONE:%.*]]
// CHECK1:       .omp.linear.pu:
// CHECK1-NEXT:    [[TMP25:%.*]] = load float*, float** [[DOTLINEAR_START]], align 8
// CHECK1-NEXT:    [[ADD_PTR9:%.*]] = getelementptr inbounds float, float* [[TMP25]], i64 6
// CHECK1-NEXT:    store float* [[ADD_PTR9]], float** [[TMP2]], align 8
// CHECK1-NEXT:    [[TMP26:%.*]] = load i64, i64* [[DOTLINEAR_START1]], align 8
// CHECK1-NEXT:    [[ADD10:%.*]] = add nsw i64 [[TMP26]], 6
...
// CHECK1-NEXT:    [[TMP34:%.*]] = load i32, i32* [[DOTLINEAR_START]], align 4
// CHECK1-NEXT:    [[ADD21:%.*]] = add nsw i32 [[TMP34]], 2
// CHECK1-NEXT:    [[TMP35:%.*]] = load i32*, i32** [[_TMP20]], align 8
// CHECK1-NEXT:    store i32 [[ADD21]], i32* [[TMP35]], align 4
// CHECK1-NEXT:    [[TMP36:%.*]] = load i32, i32* [[DOTLINEAR_START5]], align 4
// CHECK1-NEXT:    [[ADD22:%.*]] = add nsw i32 [[TMP36]], 2
// CHECK1-NEXT:    store i32 [[ADD22]], i32* [[B]], align 4
// CHECK1-NEXT:    [[TMP37:%.*]] = load i32*, i32** [[_TMP3]], align 8
// CHECK1-NEXT:    store i32* [[TMP37]], i32** [[_TMP23]], align 8
// CHECK1-NEXT:    [[TMP38:%.*]] = load i32, i32* [[DOTLINEAR_START6]], align 4
// CHECK1-NEXT:    [[ADD24:%.*]] = add nsw i32 [[TMP38]], 2
// CHECK1-NEXT:    [[TMP39:%.*]] = load i32*, i32** [[_TMP23]], align 8
// CHECK1-NEXT:    store i32 [[ADD24]], i32* [[TMP39]], align 4
// CHECK1-NEXT:    [[TMP40:%.*]] = load i32, i32* [[B]], align 4
// CHECK1-NEXT:    [[B25:%.*]] = getelementptr inbounds [[STRUCT_SS]], %struct.SS* [[TMP2]], i32 0, i32 1
...
// CHECK1:       .omp.linear.pu:
// CHECK1-NEXT:    [[TMP27:%.*]] = load i32*, i32** [[DOTLINEAR_START]], align 8
// CHECK1-NEXT:    [[ADD_PTR10:%.*]] = getelementptr inbounds i32, i32* [[TMP27]], i64 2
// CHECK1-NEXT:    store i32* [[ADD_PTR10]], i32** [[TMP2]], align 8
// CHECK1-NEXT:    [[TMP28:%.*]] = load i32*, i32** [[_TMP1]], align 8
// CHECK1-NEXT:    store i32* [[TMP28]], i32** [[_TMP11]], align 8
// CHECK1-NEXT:    [[TMP29:%.*]] = load i32, i32* [[DOTLINEAR_START3]], align 4
// CHECK1-NEXT:    [[ADD12:%.*]] = add nsw i32 [[TMP29]], 2
// CHECK1-NEXT:    [[TMP30:%.*]] = load i32*, i32** [[_TMP11]], align 8
// CHECK1-NEXT:    store i32 [[ADD12]], i32* [[TMP30]], align 4
// CHECK1-NEXT:    br label [[DOTOMP_LINEAR_PU_DONE]]
// CHECK1:       .omp.linear.pu.done:
// CHECK1-NEXT:    call void @__kmpc_barrier(%struct.ident_t* @[[GLOB1]], i32 [[TMP10]])
// CHECK1-NEXT:    ret void
...
// CHECK1-NEXT:    store i32 [[ADD10]], i32* [[TMP23]], align 4
// CHECK1-NEXT:    br label [[DOTOMP_LINEAR_PU_DONE]]
// CHECK1:       .omp.linear.pu.done:
// CHECK1-NEXT:    call void @__kmpc_barrier(%struct.ident_t* @[[GLOB1]], i32 [[TMP7]])
// CHECK1-NEXT:    ret void
...
// CHECK2-NEXT:    [[DOTLVAR__VOID_ADDR:%.*]] = call i8* @__kmpc_alloc(i32 [[TMP8]], i64 8, i8* inttoptr (i64 5 to i8*))
...
// CHECK2-NEXT:    store i64 [[ADD5]], i64* [[DOTLVAR__ADDR]], align 8
...
// CHECK2-NEXT:    [[TMP20:%.*]] = load i64, i64* [[DOTLVAR__ADDR]], align 8
// CHECK2-NEXT:    [[ADD7:%.*]] = add nsw i64 [[TMP20]], 3
// CHECK2-NEXT:    store i64 [[ADD7]], i64* [[DOTLVAR__ADDR]], align 8
...
// CHECK2-NEXT:    [[TMP22:%.*]] = bitcast i64* [[DOTLVAR__ADDR]] to i8*
// CHECK2-NEXT:    call void @__kmpc_free(i32 [[TMP8]], i8* [[TMP22]], i8* inttoptr (i64 5 to i8*))
// CHECK2-NEXT:    [[TMP23:%.*]] = load i32, i32* [[DOTOMP_IS_LAST]], align 4
// CHECK2-NEXT:    [[TMP24:%.*]] = icmp ne i32 [[TMP23]], 0
// CHECK2-NEXT:    br i1 [[TMP24]], label [[DOTOMP_LINEAR_PU:%.*]], label [[DOTOMP_LINEAR_PU_DONE:%.*]]
// CHECK2:       .omp.linear.pu:
// CHECK2-NEXT:    [[TMP25:%.*]] = load float*, float** [[DOTLINEAR_START]], align 8
// CHECK2-NEXT:    [[ADD_PTR9:%.*]] = getelementptr inbounds float, float* [[TMP25]], i64 6
// CHECK2-NEXT:    store float* [[ADD_PTR9]], float** [[TMP2]], align 8
// CHECK2-NEXT:    [[TMP26:%.*]] = load i64, i64* [[DOTLINEAR_START1]], align 8
// CHECK2-NEXT:    [[ADD10:%.*]] = add nsw i64 [[TMP26]], 6
...
// CHECK2-NEXT:    [[F:%.*]] = getelementptr inbounds [[STRUCT_S_1]], %struct.S.1* [[TEST]], i32 0, i32 0
// CHECK2-NEXT:    store i32* [[F]], i32** [[PVAR]], align 8
// CHECK2-NEXT:    [[F1:%.*]] = getelementptr inbounds [[STRUCT_S_1]], %struct.S.1* [[TEST]], i32 0, i32 0
...
// CHECK2-NEXT:    [[TMP2:%.*]] = load i32*, i32** [[LVAR]], align 8
...
// CHECK2-NEXT:    [[A1:%.*]] = getelementptr inbounds [[STRUCT_SS:%.*]], %struct.SS* [[TMP2]], i32 0, i32 0
// CHECK2-NEXT:    store i32* [[A1]], i32** [[A]], align 8
// CHECK2-NEXT:    [[C2:%.*]] = getelementptr inbounds [[STRUCT_SS]], %struct.SS* [[TMP2]], i32 0, i32 2
// CHECK2-NEXT:    [[TMP3:%.*]] = load i32*, i32** [[C2]], align 8
...
// CHECK2-NEXT:    store i32* [[TMP5]], i32** [[_TMP3]], align 8
// CHECK2-NEXT:    [[TMP6:%.*]] = load i32*, i32** [[TMP]], align 8
// CHECK2-NEXT:    [[TMP7:%.*]] = load i32, i32* [[TMP6]], align 4
// CHECK2-NEXT:    store i32 [[TMP7]], i32* [[DOTLINEAR_START]], align 4
// CHECK2-NEXT:    [[TMP8:%.*]] = load i32, i32* [[B]], align 4
// CHECK2-NEXT:    store i32 [[TMP8]], i32* [[DOTLINEAR_START5]], align 4
// CHECK2-NEXT:    [[TMP9:%.*]] = load i32*, i32** [[_TMP3]], align 8
// CHECK2-NEXT:    [[TMP10:%.*]] = load i32, i32* [[TMP9]], align 4
// CHECK2-NEXT:    store i32 [[TMP10]], i32* [[DOTLINEAR_START6]], align 4
// CHECK2-NEXT:    store i32 0, i32* [[DOTOMP_LB]], align 4
// CHECK2-NEXT:    store i32 1, i32* [[DOTOMP_UB]], align 4
// CHECK2-NEXT:    store i32 1, i32* [[DOTOMP_STRIDE]], align 4
// CHECK2-NEXT:    store i32 0, i32* [[DOTOMP_IS_LAST]], align 4
...
// CHECK2-NEXT:    call void @__kmpc_barrier(%struct.ident_t* @[[GLOB1]], i32 [[TMP12]])
...
// CHECK2-NEXT:    [[ADD:%.*]] = add nsw i32 0, [[MUL]]
// CHECK2-NEXT:    store i32 [[ADD]], i32* [[I]], align 4
// CHECK2-NEXT:    [[TMP19:%.*]] = load i32, i32* [[DOTLINEAR_START]], align 4
// CHECK2-NEXT:    [[TMP20:%.*]] = load i32, i32* [[DOTOMP_IV]], align 4
// CHECK2-NEXT:    [[MUL13:%.*]] = mul nsw i32 [[TMP20]], 1
// CHECK2-NEXT:    [[ADD14:%.*]] = add nsw i32 [[TMP19]], [[MUL13]]
// CHECK2-NEXT:    store i32 [[ADD14]], i32* [[A7]], align 4
// CHECK2-NEXT:    [[TMP21:%.*]] = load i32, i32* [[DOTLINEAR_START5]], align 4
// CHECK2-NEXT:    [[TMP22:%.*]] = load i32, i32* [[DOTOMP_IV]], align 4
// CHECK2-NEXT:    [[MUL15:%.*]] = mul nsw i32 [[TMP22]], 1
// CHECK2-NEXT:    [[ADD16:%.*]] = add nsw i32 [[TMP21]], [[MUL15]]
// CHECK2-NEXT:    store i32 [[ADD16]], i32* [[B9]], align 4
// CHECK2-NEXT:    [[TMP23:%.*]] = load i32, i32* [[DOTLINEAR_START6]], align 4
// CHECK2-NEXT:    [[TMP24:%.*]] = load i32, i32* [[DOTOMP_IV]], align 4
// CHECK2-NEXT:    [[MUL17:%.*]] = mul nsw i32 [[TMP24]], 1
// CHECK2-NEXT:    [[ADD18:%.*]] = add nsw i32 [[TMP23]], [[MUL17]]
// CHECK2-NEXT:    store i32 [[ADD18]], i32* [[C10]], align 4
// CHECK2-NEXT:    [[TMP25:%.*]] = load i32*, i32** [[_TMP8]], align 8
// CHECK2-NEXT:    [[TMP26:%.*]] = load i32, i32* [[TMP25]], align 4
// CHECK2-NEXT:    [[INC:%.*]] = add nsw i32 [[TMP26]], 1
// CHECK2-NEXT:    store i32 [[INC]], i32* [[TMP25]], align 4
// CHECK2-NEXT:    [[TMP27:%.*]] = load i32, i32* [[B9]], align 4
// CHECK2-NEXT:    [[DEC:%.*]] = add nsw i32 [[TMP27]], -1
// CHECK2-NEXT:    store i32 [[DEC]], i32* [[B9]], align 4
// CHECK2-NEXT:    [[TMP28:%.*]] = load i32*, i32** [[_TMP11]], align 8
// CHECK2-NEXT:    [[TMP29:%.*]] = load i32, i32* [[TMP28]], align 4
// CHECK2-NEXT:    [[DIV:%.*]] = sdiv i32 [[TMP29]], 1
// CHECK2-NEXT:    store i32 [[DIV]], i32* [[TMP28]], align 4
// CHECK2-NEXT:    br label [[OMP_BODY_CONTINUE:%.*]]
// CHECK2:       omp.body.continue:
// CHECK2-NEXT:    br label [[OMP_INNER_FOR_INC:%.*]]
// CHECK2:       omp.inner.for.inc:
// CHECK2-NEXT:    [[TMP30:%.*]] = load i32, i32* [[DOTOMP_IV]], align 4
// CHECK2-NEXT:    [[ADD19:%.*]] = add nsw i32 [[TMP30]], 1
...
// CHECK2-NEXT:    br i1 [[TMP32]], label [[DOTOMP_LINEAR_PU:%.*]], label [[DOTOMP_LINEAR_PU_DONE:%.*]]
// CHECK2:       .omp.linear.pu:
// CHECK2-NEXT:    [[TMP33:%.*]] = load i32*, i32** [[TMP]], align 8
// CHECK2-NEXT:    store i32* [[TMP33]], i32** [[_TMP20]], align 8
// CHECK2-NEXT:    [[TMP34:%.*]] = load i32, i32* [[DOTLINEAR_START]], align 4
// CHECK2-NEXT:    [[ADD21:%.*]] = add nsw i32 [[TMP34]], 2
// CHECK2-NEXT:    [[TMP35:%.*]] = load i32*, i32** [[_TMP20]], align 8
// CHECK2-NEXT:    store i32 [[ADD21]], i32* [[TMP35]], align 4
// CHECK2-NEXT:    [[TMP36:%.*]] = load i32, i32* [[DOTLINEAR_START5]], align 4
// CHECK2-NEXT:    [[ADD22:%.*]] = add nsw i32 [[TMP36]], 2
// CHECK2-NEXT:    store i32 [[ADD22]], i32* [[B]], align 4
// CHECK2-NEXT:    [[TMP37:%.*]] = load i32*, i32** [[_TMP3]], align 8
// CHECK2-NEXT:    store i32* [[TMP37]], i32** [[_TMP23]], align 8
// CHECK2-NEXT:    [[TMP38:%.*]] = load i32, i32* [[DOTLINEAR_START6]], align 4
// CHECK2-NEXT:    [[ADD24:%.*]] = add nsw i32 [[TMP38]], 2
// CHECK2-NEXT:    [[TMP39:%.*]] = load i32*, i32** [[_TMP23]], align 8
// CHECK2-NEXT:    store i32 [[ADD24]], i32* [[TMP39]], align 4
// CHECK2-NEXT:    [[TMP40:%.*]] = load i32, i32* [[B]], align 4
// CHECK2-NEXT:    [[B25:%.*]] = getelementptr inbounds [[STRUCT_SS]], %struct.SS* [[TMP2]], i32 0, i32 1
// CHECK2-NEXT:    [[TMP41:%.*]] = trunc i32 [[TMP40]] to i8
// CHECK2-NEXT:    [[BF_LOAD:%.*]] = load i8, i8* [[B25]], align 4
// CHECK2-NEXT:    [[BF_VALUE:%.*]] = and i8 [[TMP41]], 15
// CHECK2-NEXT:    [[BF_CLEAR:%.*]] = and i8 [[BF_LOAD]], -16
...
// CHECK2-NEXT:    store i32* [[TMP5]], i32** [[_TMP1]], align 8
// CHECK2-NEXT:    [[TMP6:%.*]] = load i32*, i32** [[TMP2]], align 8
// CHECK2-NEXT:    store i32* [[TMP6]], i32** [[DOTLINEAR_START]], align 8
// CHECK2-NEXT:    [[TMP7:%.*]] = load i32*, i32** [[_TMP1]], align 8
// CHECK2-NEXT:    [[TMP8:%.*]] = load i32, i32* [[TMP7]], align 4
// CHECK2-NEXT:    store i32 [[TMP8]], i32* [[DOTLINEAR_START3]], align 4
// CHECK2-NEXT:    store i32 0, i32* [[DOTOMP_LB]], align 4
// CHECK2-NEXT:    store i32 1, i32* [[DOTOMP_UB]], align 4
// CHECK2-NEXT:    store i32 1, i32* [[DOTOMP_STRIDE]], align 4
// CHECK2-NEXT:    store i32 0, i32* [[DOTOMP_IS_LAST]], align 4
...
// CHECK2-NEXT:    store i32* [[LVAR]], i32** [[_TMP4]], align 8
...
// CHECK2-NEXT:    [[ADD:%.*]] = add nsw i32 0, [[MUL]]
// CHECK2-NEXT:    store i32 [[ADD]], i32* [[I]], align 4
// CHECK2-NEXT:    [[TMP17:%.*]] = load i32*, i32** [[DOTLINEAR_START]], align 8
// CHECK2-NEXT:    [[TMP18:%.*]] = load i32, i32* [[DOTOMP_IV]], align 4
// CHECK2-NEXT:    [[MUL6:%.*]] = mul nsw i32 [[TMP18]], 1
// CHECK2-NEXT:    [[IDX_EXT:%.*]] = sext i32 [[MUL6]] to i64
// CHECK2-NEXT:    [[ADD_PTR:%.*]] = getelementptr inbounds i32, i32* [[TMP17]], i64 [[IDX_EXT]]
// CHECK2-NEXT:    store i32* [[ADD_PTR]], i32** [[PVAR]], align 8
// CHECK2-NEXT:    [[TMP19:%.*]] = load i32, i32* [[DOTLINEAR_START3]], align 4
// CHECK2-NEXT:    [[TMP20:%.*]] = load i32, i32* [[DOTOMP_IV]], align 4
// CHECK2-NEXT:    [[MUL7:%.*]] = mul nsw i32 [[TMP20]], 1
// CHECK2-NEXT:    [[ADD8:%.*]] = add nsw i32 [[TMP19]], [[MUL7]]
// CHECK2-NEXT:    store i32 [[ADD8]], i32* [[LVAR]], align 4
// CHECK2-NEXT:    [[TMP21:%.*]] = load i32*, i32** [[PVAR]], align 8
// CHECK2-NEXT:    [[INCDEC_PTR:%.*]] = getelementptr inbounds i32, i32* [[TMP21]], i32 1
// CHECK2-NEXT:    store i32* [[INCDEC_PTR]], i32** [[PVAR]], align 8
// CHECK2-NEXT:    [[TMP22:%.*]] = load i32*, i32** [[_TMP4]], align 8
// CHECK2-NEXT:    [[TMP23:%.*]] = load i32, i32* [[TMP22]], align 4
// CHECK2-NEXT:    [[INC:%.*]] = add nsw i32 [[TMP23]], 1
// CHECK2-NEXT:    store i32 [[INC]], i32* [[TMP22]], align 4
// CHECK2-NEXT:    br label [[OMP_BODY_CONTINUE:%.*]]
// CHECK2:       omp.body.continue:
// CHECK2-NEXT:    br label [[OMP_INNER_FOR_INC:%.*]]
// CHECK2:       omp.inner.for.inc:
// CHECK2-NEXT:    [[TMP24:%.*]] = load i32, i32* [[DOTOMP_IV]], align 4
// CHECK2-NEXT:    [[ADD9:%.*]] = add nsw i32 [[TMP24]], 1
...
// CHECK2-NEXT:    br i1 [[TMP26]], label [[DOTOMP_LINEAR_PU:%.*]], label [[DOTOMP_LINEAR_PU_DONE:%.*]]
// CHECK2:       .omp.linear.pu:
// CHECK2-NEXT:    [[TMP27:%.*]] = load i32*, i32** [[DOTLINEAR_START]], align 8
// CHECK2-NEXT:    [[ADD_PTR10:%.*]] = getelementptr inbounds i32, i32* [[TMP27]], i64 2
// CHECK2-NEXT:    store i32* [[ADD_PTR10]], i32** [[TMP2]], align 8
// CHECK2-NEXT:    [[TMP28:%.*]] = load i32*, i32** [[_TMP1]], align 8
// CHECK2-NEXT:    store i32* [[TMP28]], i32** [[_TMP11]], align 8
// CHECK2-NEXT:    [[TMP29:%.*]] = load i32, i32* [[DOTLINEAR_START3]], align 4
// CHECK2-NEXT:    [[ADD12:%.*]] = add nsw i32 [[TMP29]], 2
// CHECK2-NEXT:    [[TMP30:%.*]] = load i32*, i32** [[_TMP11]], align 8
// CHECK2-NEXT:    store i32 [[ADD12]], i32* [[TMP30]], align 4
// CHECK2-NEXT:    br label [[DOTOMP_LINEAR_PU_DONE]]
// CHECK2:       .omp.linear.pu.done:
// CHECK2-NEXT:    call void @__kmpc_barrier(%struct.ident_t* @[[GLOB1]], i32 [[TMP10]])
// CHECK2-NEXT:    ret void
...
// CHECK2-NEXT:    call void (%struct.ident_t*, i32, void (i32*, i32*, ...)*, ...) @__kmpc_fork_call(%struct.ident_t* @[[GLOB3]], i32 1, void (i32*, i32*, ...)* bitcast (void (i32*, i32*, %struct.anon.3*)* @.omp_outlined..3 to void (i32*, i32*, ...)*), %struct.anon.3* [[OMP_OUTLINED_ARG_AGG_]])
// CHECK2-NEXT:    ret void
//
//
...
// CHECK2-NEXT:    [[TMP12:%.*]] = load i32, i32* [[DOTOMP_UB]], align 4
// CHECK2-NEXT:    [[CMP5:%.*]] = icmp sle i32 [[TMP11]], [[TMP12]]
// CHECK2-NEXT:    br i1 [[CMP5]], label [[OMP_INNER_FOR_BODY:%.*]], label [[OMP_INNER_FOR_END:%.*]]
// CHECK2:       omp.inner.for.body:
...
// CHECK2-NEXT:    [[ADD:%.*]] = add nsw i32 0, [[MUL]]
// CHECK2-NEXT:    store i32 [[ADD]], i32* [[I]], align 4
// CHECK2-NEXT:    [[TMP14:%.*]] = load i32, i32* [[DOTLINEAR_START]], align 4
...
// CHECK2-NEXT:    store i32 [[INC]], i32* [[TMP16]], align 4
// CHECK2-NEXT:    br label [[OMP_BODY_CONTINUE:%.*]]
// CHECK2:       omp.body.continue:
// CHECK2-NEXT:    br label [[OMP_INNER_FOR_INC:%.*]]
// CHECK2:       omp.inner.for.inc:
...
// CHECK2:       .omp.linear.pu:
// CHECK2-NEXT:    [[TMP21:%.*]] = load i32*, i32** [[TMP]], align 8
// CHECK2-NEXT:    store i32* [[TMP21]], i32** [[_TMP9]], align 8
// CHECK2-NEXT:    [[TMP22:%.*]] = load i32, i32* [[DOTLINEAR_START]], align 4
// CHECK2-NEXT:    [[ADD10:%.*]] = add nsw i32 [[TMP22]], 2
// CHECK2-NEXT:    [[TMP23:%.*]] = load i32*, i32** [[_TMP9]], align 8
// CHECK2-NEXT:    store i32 [[ADD10]], i32* [[TMP23]], align 4
// CHECK2-NEXT:    br label [[DOTOMP_LINEAR_PU_DONE]]
// CHECK2:       .omp.linear.pu.done:
// CHECK2-NEXT:    call void @__kmpc_barrier(%struct.ident_t* @[[GLOB1]], i32 [[TMP7]])
// CHECK2-NEXT:    ret void
...
// CHECK3-NEXT:    [[TMP35:%.*]] = load i32, i32* [[DOTLINEAR_START]], align 4
// CHECK3-NEXT:    [[ADD21:%.*]] = add nsw i32 [[TMP35]], 2
// CHECK3-NEXT:    [[TMP36:%.*]] = load i32*, i32** [[_TMP20]], align 8
// CHECK3-NEXT:    store i32 [[ADD21]], i32* [[TMP36]], align 4
// CHECK3-NEXT:    [[TMP37:%.*]] = load i32, i32* [[DOTLINEAR_START5]], align 4
// CHECK3-NEXT:    [[ADD22:%.*]] = add nsw i32 [[TMP37]], 2
// CHECK3-NEXT:    store i32 [[ADD22]], i32* [[B]], align 4
// CHECK3-NEXT:    [[TMP38:%.*]] = load i32*, i32** [[_TMP3]], align 8
// CHECK3-NEXT:    store i32* [[TMP38]], i32** [[_TMP23]], align 8
// CHECK3-NEXT:    [[TMP39:%.*]] = load i32, i32* [[DOTLINEAR_START6]], align 4
// CHECK3-NEXT:    [[ADD24:%.*]] = add nsw i32 [[TMP39]], 2
// CHECK3-NEXT:    [[TMP40:%.*]] = load i32*, i32** [[_TMP23]], align 8
// CHECK3-NEXT:    store i32 [[ADD24]], i32* [[TMP40]], align 4
// CHECK3-NEXT:    [[TMP41:%.*]] = load i32, i32* [[B]], align 4
// CHECK3-NEXT:    [[B25:%.*]] = getelementptr inbounds [[STRUCT_SS]], %struct.SS* [[TMP2]], i32 0, i32 1
...
// CHECK3-NEXT:    [[TMP39:%.*]] = load i32, i32* [[DOTLINEAR_START]], align 4
// CHECK3-NEXT:    [[ADD18:%.*]] = add nsw i32 [[TMP39]], 2
// CHECK3-NEXT:    [[TMP40:%.*]] = load i32*, i32** [[_TMP17]], align 8
// CHECK3-NEXT:    store i32 [[ADD18]], i32* [[TMP40]], align 4
// CHECK3-NEXT:    [[TMP41:%.*]] = load i32, i32* [[DOTLINEAR_START5]], align 4
// CHECK3-NEXT:    [[ADD19:%.*]] = add nsw i32 [[TMP41]], 2
// CHECK3-NEXT:    store i32 [[ADD19]], i32* [[TMP6]], align 4
// CHECK3-NEXT:    [[TMP42:%.*]] = load i32*, i32** [[_TMP3]], align 8
// CHECK3-NEXT:    store i32* [[TMP42]], i32** [[_TMP20]], align 8
// CHECK3-NEXT:    [[TMP43:%.*]] = load i32, i32* [[DOTLINEAR_START6]], align 4
// CHECK3-NEXT:    [[ADD21:%.*]] = add nsw i32 [[TMP43]], 2
// CHECK3-NEXT:    [[TMP44:%.*]] = load i32*, i32** [[_TMP20]], align 8
// CHECK3-NEXT:    store i32 [[ADD21]], i32* [[TMP44]], align 4
// CHECK3-NEXT:    br label [[DOTOMP_LINEAR_PU_DONE]]
// CHECK3:       .omp.linear.pu.done:
// CHECK3-NEXT:    call void @__kmpc_barrier(%struct.ident_t* @[[GLOB1]], i32 [[TMP17]])
// CHECK3-NEXT:    ret void
...
// CHECK3:       .omp.linear.pu:
// CHECK3-NEXT:    [[TMP25:%.*]] = load i32, i32* [[DOTLINEAR_START]], align 4
// CHECK3-NEXT:    [[ADD12:%.*]] = add nsw i32 [[TMP25]], 10
// CHECK3-NEXT:    store i32 [[ADD12]], i32* @g, align 4
// CHECK3-NEXT:    [[TMP26:%.*]] = load i32*, i32** @g1, align 8
// CHECK3-NEXT:    store i32* [[TMP26]], i32** [[_TMP13]], align 8
// CHECK3-NEXT:    [[TMP27:%.*]] = load i32, i32* [[DOTLINEAR_START2]], align 4
// CHECK3-NEXT:    [[ADD14:%.*]] = add nsw i32 [[TMP27]], 10
// CHECK3-NEXT:    [[TMP28:%.*]] = load i32*, i32** [[_TMP13]], align 8
// CHECK3-NEXT:    store volatile i32 [[ADD14]], i32* [[TMP28]], align 4
// CHECK3-NEXT:    br label [[DOTOMP_LINEAR_PU_DONE]]
// CHECK3:       .omp.linear.pu.done:
// CHECK3-NEXT:    call void @__kmpc_barrier(%struct.ident_t* @[[GLOB1]], i32 [[TMP5]])
// CHECK3-NEXT:    ret void
...
// CHECK4-NEXT:    [[TMP30:%.*]] = load i32, i32* [[DOTLINEAR_START]], align 4
// CHECK4-NEXT:    [[ADD13:%.*]] = add nsw i32 [[TMP30]], 10
// CHECK4-NEXT:    store i32 [[ADD13]], i32* @g, align 4
// CHECK4-NEXT:    [[TMP31:%.*]] = load i32*, i32** @g1, align 8
// CHECK4-NEXT:    store i32* [[TMP31]], i32** [[_TMP14]], align 8
// CHECK4-NEXT:    [[TMP32:%.*]] = load i32, i32* [[DOTLINEAR_START2]], align 4
// CHECK4-NEXT:    [[ADD15:%.*]] = add nsw i32 [[TMP32]], 10
// CHECK4-NEXT:    [[TMP33:%.*]] = load i32*, i32** [[_TMP14]], align 8
// CHECK4-NEXT:    store volatile i32 [[ADD15]], i32* [[TMP33]], align 4
...
// CHECK4-NEXT:    call void [[TMP32]](i8* [[TMP30]])
// CHECK4-NEXT:    br label [[OMP_BODY_CONTINUE:%.*]]
// CHECK4:       omp.body.continue:
// CHECK4-NEXT:    br label [[OMP_INNER_FOR_INC:%.*]]
// CHECK4:       omp.inner.for.inc:
...
// CHECK4-NEXT:    [[TMP37:%.*]] = load i32, i32* [[DOTLINEAR_START]], align 4
// CHECK4-NEXT:    [[ADD23:%.*]] = add nsw i32 [[TMP37]], 2
// CHECK4-NEXT:    [[TMP38:%.*]] = load i32*, i32** [[_TMP22]], align 8
// CHECK4-NEXT:    store i32 [[ADD23]], i32* [[TMP38]], align 4
// CHECK4-NEXT:    [[TMP39:%.*]] = load i32, i32* [[DOTLINEAR_START5]], align 4
// CHECK4-NEXT:    [[ADD24:%.*]] = add nsw i32 [[TMP39]], 2
// CHECK4-NEXT:    store i32 [[ADD24]], i32* [[B]], align 4
// CHECK4-NEXT:    [[TMP40:%.*]] = load i32*, i32** [[_TMP3]], align 8
// CHECK4-NEXT:    store i32* [[TMP40]], i32** [[_TMP25]], align 8
// CHECK4-NEXT:    [[TMP41:%.*]] = load i32, i32* [[DOTLINEAR_START6]], align 4
// CHECK4-NEXT:    [[ADD26:%.*]] = add nsw i32 [[TMP41]], 2
// CHECK4-NEXT:    [[TMP42:%.*]] = load i32*, i32** [[_TMP25]], align 8
// CHECK4-NEXT:    store i32 [[ADD26]], i32* [[TMP42]], align 4
// CHECK4-NEXT:    [[TMP43:%.*]] = load i32, i32* [[B]], align 4
// CHECK4-NEXT:    [[B27:%.*]] = getelementptr inbounds [[STRUCT_SS]], %struct.SS* [[TMP2]], i32 0, i32 1
...
// CHECK4-NEXT:    [[TMP39:%.*]] = load i32, i32* [[DOTLINEAR_START]], align 4
// CHECK4-NEXT:    [[ADD18:%.*]] = add nsw i32 [[TMP39]], 2
// CHECK4-NEXT:    [[TMP40:%.*]] = load i32*, i32** [[_TMP17]], align 8
// CHECK4-NEXT:    store i32 [[ADD18]], i32* [[TMP40]], align 4
// CHECK4-NEXT:    [[TMP41:%.*]] = load i32, i32* [[DOTLINEAR_START5]], align 4
// CHECK4-NEXT:    [[ADD19:%.*]] = add nsw i32 [[TMP41]], 2
// CHECK4-NEXT:    store i32 [[ADD19]], i32* [[TMP6]], align 4
// CHECK4-NEXT:    [[TMP42:%.*]] = load i32*, i32** [[_TMP3]], align 8
// CHECK4-NEXT:    store i32* [[TMP42]], i32** [[_TMP20]], align 8
// CHECK4-NEXT:    [[TMP43:%.*]] = load i32, i32* [[DOTLINEAR_START6]], align 4
// CHECK4-NEXT:    [[ADD21:%.*]] = add nsw i32 [[TMP43]], 2
// CHECK4-NEXT:    [[C22:%.*]] = getelementptr inbounds [[STRUCT_SS:%.*]], %struct.SS* [[TMP2]], i32 0, i32 2
// CHECK4-NEXT:    [[TMP44:%.*]] = load i32*, i32** [[C22]], align 8
// CHECK4-NEXT:    store i32 [[ADD21]], i32* [[TMP44]], align 4
// CHECK4-NEXT:    br label [[DOTOMP_LINEAR_PU_DONE]]
// CHECK4:       .omp.linear.pu.done:
// CHECK4-NEXT:    call void @__kmpc_barrier(%struct.ident_t* @[[GLOB1]], i32 [[TMP17]])
// CHECK4-NEXT:    ret void
