...
// CHECK-DAG:      define dso_local void @_ZN4Base9no_args_1EPFvvE({{[^!]*!callback}} ![[cid0:[0-9]+]]
__attribute__((callback(1))) void
Base::no_args_1(void (*callback)(void)) {
}

// CHECK-DAG:      define dso_local void @_ZN4Base9no_args_2EPFvvES1_({{[^!]*!callback}} ![[cid1:[0-9]+]]
__attribute__((callback(2))) void Base::no_args_2(void (*callback1)(void), void (*callback2)(void)) {
}
// CHECK-DAG:      define dso_local void @_ZN4Base9no_args_3EPFvvES1_({{[^!]*!callback}} ![[cid1]]
__attribute__((callback(callback2))) void Base::no_args_3(void (*callback1)(void), void (*callback2)(void)) {
}

// CHECK-DAG:      define dso_local void @_ZN4Base17this_unknown_thisEPFvPS_S0_S0_E({{[^!]*!callback}} ![[cid2:[0-9]+]]
...
// CHECK-DAG:      define dso_local void @_ZN9Derived_19virtual_1EPFvvE({{[^!]*!callback}} ![[cid0]]
...
// CHECK-DAG: define dso_local void @_ZN9Derived_29virtual_1EPFvvE
// CHECK-NOT: !callback
