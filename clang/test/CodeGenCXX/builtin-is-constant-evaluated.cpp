...
// CHECK-FN-CG-LABEL: define dso_local zeroext i1 @_Z3foov()
// CHECK-FN-CG: ret i1 false
bool foo() {
  return __builtin_is_constant_evaluated();
}

// CHECK-FN-CG-LABEL: define linkonce_odr dso_local i32 @_Z1fv()
constexpr int f() {
...
// CHECK-STATIC-DAG: @p = dso_local global i32 26,
CONSTINIT int p = f(); // f().m == 13; initialized to 26
// CHECK-STATIC-DAG: @p2 = dso_local global i32 26,
...
// CHECK-STATIC-DAG: @b = dso_local global i32 2,
...
// CHECK-ARR-LABEL: define dso_local void @_Z13test_arr_exprv
void test_arr_expr() {
...
// CHECK-ARR-LABEL: define dso_local void @_Z17test_new_arr_exprv
...
// CHECK-FOLD-LABEL: define dso_local void @_Z21test_ir_constant_foldv()
...
// CHECK-STATIC-DAG: @ir = dso_local constant i32* @i_constant,
int i_constant;
int i_not_constant;
