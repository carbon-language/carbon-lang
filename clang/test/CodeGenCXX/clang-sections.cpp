...
//CHECK: @a = dso_local global i32 0, align 4 #0
//CHECK: @b = dso_local global i32 1, align 4 #0
//CHECK: @c = dso_local global [4 x i32] zeroinitializer, align 4 #0
//CHECK: @d = dso_local global [5 x i16] zeroinitializer, align 2 #0
//CHECK: @e = dso_local global [6 x i16] [i16 0, i16 0, i16 1, i16 0, i16 0, i16 0], align 2 #0
//CHECK: @f = dso_local constant i32 2, align 4 #0

//CHECK: @h = dso_local global i32 0, align 4 #1
//CHECK: @i = dso_local global i32 0, align 4 #2
//CHECK: @j = dso_local constant i32 4, align 4 #2
//CHECK: @k = dso_local global i32 0, align 4 #2
//CHECK: @_ZZ3gooE7lstat_h = internal global i32 0, align 4 #2
//CHECK: @_ZL1g = internal global [2 x i32] zeroinitializer, align 4 #0

//CHECK: @l = dso_local global i32 5, align 4 #3
//CHECK: @m = dso_local constant i32 6, align 4 #3

//CHECK: @n = dso_local global i32 0, align 4
//CHECK: @o = dso_local global i32 6, align 4
//CHECK: @p = dso_local constant i32 7, align 4
//CHECK: @_ZL5fptrs = internal constant [2 x i32 ()*] [i32 ()* @foo, i32 ()* @goo], align 4 #3

//CHECK: define dso_local i32 @foo() #5 {
//CHECK: define dso_local i32 @goo() #6 {
//CHECK: declare i32 @zoo(i32*, i32*) #7
//CHECK: define dso_local i32 @hoo() #8 {
