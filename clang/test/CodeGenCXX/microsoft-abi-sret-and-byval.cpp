...
// LINUX-LABEL: define dso_local void @_Z12small_returnv(%struct.Small* noalias sret %agg.result)
...
// LINUX-LABEL: define dso_local void @_Z13medium_returnv(%struct.Medium* noalias sret %agg.result)
...
// LINUX-LABEL: define dso_local void @_Z20small_non_pod_returnv(%struct.SmallCpp11NotCpp03Pod* noalias sret %agg.result)
...
// LINUX-LABEL: define dso_local void @_Z22small_with_ctor_returnv(%struct.SmallWithCtor* noalias sret %agg.result)
...
// LINUX-LABEL: define dso_local void @_Z25small_with_vftable_returnv(%struct.SmallWithVftable* noalias sret %agg.result)
...
// LINUX-LABEL: define dso_local void @_Z28medium_with_copy_ctor_returnv(%struct.MediumWithCopyCtor* noalias sret %agg.result)
...
// LINUX-LABEL: define dso_local void @_Z10big_returnv(%struct.Big* noalias sret %agg.result)
...
// LINUX-LABEL: define dso_local void @_Z9small_arg5Small(i32 %s.0)
...
// LINUX-LABEL: define dso_local void @_Z10medium_arg6Medium(i32 %s.0, i32 %s.1)
...
// LINUX-LABEL: define dso_local void @_Z17base_no_byval_arg11BaseNoByval(%struct.BaseNoByval* byval(%struct.BaseNoByval) align 4 %s)
...
// LINUX-LABEL: define dso_local void @_Z19small_arg_with_ctor13SmallWithCtor(%struct.SmallWithCtor* byval(%struct.SmallWithCtor) align 4 %s)
...
// LINUX-LABEL: define dso_local void @_Z13multibyte_arg9Multibyte(%struct.Multibyte* byval(%struct.Multibyte) align 4 %s)
...
// LINUX-LABEL: define dso_local void @_Z10packed_arg6Packed(%struct.Packed* byval(%struct.Packed) align 4 %s)
...
// LINUX-LABEL: define dso_local void @_Z22small_arg_with_vftable16SmallWithVftable(%struct.SmallWithVftable* %s)
...
// LINUX-LABEL: define dso_local void @_Z25medium_arg_with_copy_ctor18MediumWithCopyCtor(%struct.MediumWithCopyCtor* %s)
...
void big_arg(Big s) {}
// LINUX-LABEL: define dso_local void @_Z7big_arg3Big(%struct.Big* byval(%struct.Big) align 4 %s)
...
// LINUX-LABEL: define dso_local void @_Z15takes_ref_field8RefField(%struct.RefField* byval(%struct.RefField) align 4 %s)
...
// LINUX-LABEL: define dso_local void @_Z14pass_ref_fieldv()
