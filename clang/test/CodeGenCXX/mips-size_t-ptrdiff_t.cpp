...
// O32-LABEL: define dso_local i32* @_Z10alloc_longv()
// O32: call i8* @_Znwj(i32 signext 4)

// N32-LABEL: define dso_local i32* @_Z10alloc_longv()
// N32: call i8* @_Znwj(i32 signext 4)

// N64-LABEL: define dso_local i64* @_Z10alloc_longv()
...
// N64-LABEL: define dso_local i64* @_Z16alloc_long_arrayv()
