...
// CHECK: @_ZDC2a12a2E = dso_local global {{.*}} zeroinitializer, align 4
auto [a1, a2] = make<A>();
// CHECK: @_ZDC2b12b2E = dso_local global {{.*}} zeroinitializer, align 1
// CHECK: @b1 = dso_local global {{.*}}* null, align 8
// CHECK: @_ZGR2b1_ = internal global {{.*}} zeroinitializer, align 1
// CHECK: @b2 = dso_local global i32* null, align 8
// CHECK: @_ZGR2b2_ = internal global i32 0, align 4
auto [b1, b2] = make<B>();
// CHECK: @_ZDC2c12c2E = dso_local global [2 x i32]* null, align 8
auto &[c1, c2] = make<C>();
// CHECK: @_ZDC2d12d2E = dso_local global <2 x i32> zeroinitializer, align 8
auto [d1, d2] = make<D>();
// CHECK: @_ZDC2e12e2E = dso_local global { i32, i32 } zeroinitializer, align 4
auto [e1, e2] = make<E>();
...
// CHECK: define dso_local i32 @_Z12test_globalsv()
int test_globals() {
...
// CHECK: define dso_local i32 @_Z11test_localsv()
int test_locals() {
  auto [b1, b2] = make<B>();
...
// CHECK: define dso_local void @_Z13test_bitfieldR1A(
