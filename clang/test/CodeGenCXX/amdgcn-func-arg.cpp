...
// CHECK-LABEL: define dso_local void @_Z22func_with_indirect_arg1A(%class.A addrspace(5)* %a)
...
// CHECK: define dso_local void @_Z24test_indirect_arg_globalv()
// CHECK:  %agg.tmp = alloca %class.A, align 4, addrspace(5)
...
// CHECK-LABEL: define dso_local void @_Z19func_with_byval_arg1B(%class.B addrspace(5)* byval(%class.B) align 4 %b)
