...
namespace Elision {
  ...
  // CHECK: define void @_ZN7Elision5test2Ev([[A]]* sret noalias
  A test2() {
  ...
  // CHECK: define void @_ZN7Elision5test3EiNS_1AE([[A]]* sret noalias
  A test3(int v, A x) {
    if (v < 5)
  ...
  // CHECK: define void @_ZN7Elision5test5Ev([[A]]* sret noalias
  struct B { A a; B(); };
  A test5() {
