...
// CHECK: @global_one = dso_local global i32 [[@LINE+1]], align 4
int global_one = __builtin_LINE();
// CHECK-NEXT: @global_two = dso_local global i32 [[@LINE+1]], align 4
...
// CHECK-LABEL: define dso_local void @_ZN11InClassInit10test_classEv()
...
// CHECK-LABEL: define dso_local void @_ZN11InClassInitC2E4Tag4i(%struct.InClassInit* %this, i32 %arg)
...
// CHECK-LABEL: define dso_local void @_Z13get_line_testv()
void get_line_test() {
