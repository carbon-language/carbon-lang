...
namespace Test1 {
  ...
  // CHECK-LABEL: define dso_local i32 @_ZN5Test11fEPNS_1AE
  int f(A *a) {
...
namespace Test2 {
  ...
  // CHECK-LABEL: define dso_local i32 @_ZN5Test21fEPNS_1AE
  int f(A *a) {
...
namespace Test2a {
  ...
  // CHECK-LABEL: define dso_local i32 @_ZN6Test2a1fEPNS_1AE
  int f(A *a) {
...
namespace Test3 {
  ...
  // CHECK-LABEL: define dso_local i32 @_ZN5Test31fEPNS_1BE
  int f(B *b) {
    // CHECK: call i32 @_ZN5Test31A1fEv
    return b->f();
  }

  // CHECK-LABEL: define dso_local i32 @_ZN5Test31fERNS_1BE
  int f(B &b) {
    // CHECK: call i32 @_ZN5Test31A1fEv
    return b.f();
  }

  // CHECK-LABEL: define dso_local i32 @_ZN5Test31fEPv
  int f(void *v) {
    // CHECK: call i32 @_ZN5Test31A1fEv
...
namespace Test4 {
  ...
  // CHECK-LABEL: define dso_local void @_ZN5Test41fEPNS_1BE
  void f(B* d) {
...
namespace Test5 {
  ...
  // CHECK-LABEL: define dso_local void @_ZN5Test51fEPNS_1CE
  void f(C* d) {
  ...
  // CHECK-LABEL: define dso_local void @_ZN5Test53fopEPNS_1CE
  void fop(C* d) {
    // FIXME: It should be possible to devirtualize this case, but that is
    // not implemented yet.
    // CHECK: getelementptr
...
namespace Test6 {
  ...
  // CHECK-LABEL: define dso_local void @_ZN5Test61fEPNS_1DE
  void f(D* d) {
...
namespace Test7 {
  ...
  // CHECK-LABEL: define dso_local i32 @_ZN5Test71fEPNS_3zedE
  int f(zed *z) {
    // CHECK: alloca
    // CHECK-NEXT: store
    // CHECK-NEXT: load
...
namespace Test8 {
  ...
  struct C final : A, B {  };
  // CHECK-LABEL: define dso_local i32 @_ZN5Test84testEPNS_1CE
  int test(C *c) {
    // CHECK: %[[THIS:.*]] = phi
...
namespace Test10 {
  ...
  // CHECK-LABEL: define dso_local i32 @_ZN6Test101fEPNS_1BE
  int f(B *b) {
...
namespace Test11 {
  ...
  // CHECK-LABEL: define linkonce_odr dso_local void @_ZN6Test111SIiE4foo1Ev(
  ...
  // CHECK: define linkonce_odr dso_local void @_ZN6Test111SIiE7DerivedclEv(
  // CHECK: define linkonce_odr dso_local zeroext i1 @_ZN6Test111SIiE7DerivedeqERKNS_4BaseE(
  // CHECK: define linkonce_odr dso_local zeroext i1 @_ZN6Test111SIiE7DerivedntEv(
  // CHECK: define linkonce_odr dso_local dereferenceable(4) %"class.Test11::Base"* @_ZN6Test111SIiE7DerivedixEi(
  class Base {
  public:
