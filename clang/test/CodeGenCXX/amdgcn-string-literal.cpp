...
// CHECK: @g_str = dso_local addrspace(1) global i8* addrspacecast (i8 addrspace(4)* getelementptr inbounds ([6 x i8], [6 x i8] addrspace(4)* @.str, i32 0, i32 0) to i8*), align 8
// CHECK: @g_array = dso_local addrspace(1) global [8 x i8] c"g_array\00", align 1
...
// CHECK-LABEL: define dso_local void @_Z1ev
void e() {
  g("string literal");
  g("string literal");
}
