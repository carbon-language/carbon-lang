// RUN: %clang_cc1 %s -triple=x86_64-pc-linuxs -emit-llvm -std=c++98 -o - -fsemantic-interposition | FileCheck -check-prefix=CHECK -check-prefix=CHECK98 %s
// RUN: %clang_cc1 %s -triple=x86_64-pc-linuxs -emit-llvm -std=c++11 -o - -fsemantic-interposition | FileCheck -check-prefix=CHECK -check-prefix=CHECK11 %s

// CHECK: @_ZZ1hvE1i = internal global i32 0, align 4
// CHECK: @base_req = dso_local global [4 x i8] c"foo\00", align 1
// CHECK: @base_req_uchar = dso_local global [4 x i8] c"bar\00", align 1

// CHECK: @_ZZN5test31BC1EvE1u = internal global { i8, [3 x i8] } { i8 97, [3 x i8] undef }, align 4

// CHECK: @_ZZ2h2vE1i = linkonce_odr dso_local global i32 0, comdat, align 4
...
namespace test2 {
  ...
  // CHECK-LABEL: define dso_local void @_ZN5test21BC2Ev
  ...
  // CHECK-LABEL: define dso_local void @_ZN5test21BC1Ev
  // CHECK:   load atomic i8, i8* bitcast (i64* @_ZGVZN5test21BC1EvE1x to i8*) acquire,
  // CHECK:   call i32 @__cxa_guard_acquire(i64* @_ZGVZN5test21BC1EvE1x)
  // CHECK:   [[T0:%.*]] = call i32 @_ZN5test23fooEv()
  // CHECK:   store i32 [[T0]], i32* @_ZZN5test21BC1EvE1x,
  ...
  // CHECK-LABEL: define dso_local void @_ZN5test21BD2Ev(
  ...
  // CHECK-LABEL: define dso_local void @_ZN5test21BD1Ev(
...
namespace test3 {
  ...
  // CHECK-LABEL: define dso_local void @_ZN5test31BC2Ev(
  // CHECK-LABEL: define dso_local void @_ZN5test31BC1Ev(
}
...
// CHECK: define linkonce_odr dso_local dereferenceable(8) %"struct.test4::HasVTable"* @_ZN5test414useStaticLocalEv()
