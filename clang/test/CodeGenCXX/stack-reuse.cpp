...
// CHECK-LABEL: define dso_local void @large_rvoed_unnamed_temporary_object
// CHECK: call void @llvm.lifetime.start
...
// CHECK-LABEL: define dso_local void @small_rvoed_named_temporary_object
// CHECK: call void @llvm.lifetime.start
// CHECK: call void @_Z9foo_smallv
// CHECK: call void @llvm.lifetime.end
// CHECK: call void @llvm.lifetime.start
...
// CHECK-LABEL: define dso_local void @small_auto_object
// CHECK: call void @llvm.lifetime.start
...
// CHECK-LABEL: define dso_local i32 @large_combiner_test
