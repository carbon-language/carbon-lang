...
namespace N0 {
  ...
  unsigned read00(S* s) {
    // CHECK-X86-64-LABEL: define dso_local i32 @_ZN2N06read00
    ...
    // CHECK-PPC64-LABEL: define dso_local zeroext i32 @_ZN2N06read00
  ...
  unsigned read01(S* s) {
    // CHECK-X86-64-LABEL: define dso_local i32 @_ZN2N06read01
    // CHECK-X86-64:   %[[ptr:.*]]   = bitcast %{{.*}}* %{{.*}} to i64*
    // CHECK-X86-64:   %[[val:.*]]   = load i64, i64* %[[ptr]]
    ...
    // CHECK-X86-64:   %[[trunc:.*]] = trunc i64 %[[and]] to i32
    // CHECK-X86-64:                   ret i32 %[[trunc]]
    // CHECK-PPC64-LABEL: define dso_local zeroext i32 @_ZN2N06read01
    // CHECK-PPC64:   %[[ptr:.*]]   = bitcast %{{.*}}* %{{.*}} to i64*
    // CHECK-PPC64:   %[[val:.*]]   = load i64, i64* %[[ptr]]
  ...
  unsigned read20(S* s) {
    // CHECK-X86-64-LABEL: define dso_local i32 @_ZN2N06read20
    // CHECK-X86-64:   %[[ptr:.*]]   = bitcast %{{.*}}* %{{.*}} to i64*
    // CHECK-X86-64:   %[[val:.*]]   = load i64, i64* %[[ptr]]
    ...
    // CHECK-X86-64:   %[[trunc:.*]] = trunc i64 %[[and]] to i32
    // CHECK-X86-64:                   ret i32 %[[trunc]]
    // CHECK-PPC64-LABEL: define dso_local zeroext i32 @_ZN2N06read20
    // CHECK-PPC64:   %[[ptr:.*]]   = bitcast %{{.*}}* %{{.*}} to i64*
    // CHECK-PPC64:   %[[val:.*]]   = load i64, i64* %[[ptr]]
  ...
  unsigned read21(S* s) {
    // CHECK-X86-64-LABEL: define dso_local i32 @_ZN2N06read21
    // CHECK-X86-64:   %[[ptr:.*]]   = bitcast %{{.*}}* %{{.*}} to i64*
    // CHECK-X86-64:   %[[val:.*]]   = load i64, i64* %[[ptr]]
    ...
    // CHECK-X86-64:   %[[trunc:.*]] = trunc i64 %[[and]] to i32
    // CHECK-X86-64:                   ret i32 %[[trunc]]
    // CHECK-PPC64-LABEL: define dso_local zeroext i32 @_ZN2N06read21
    // CHECK-PPC64:   %[[ptr:.*]]   = bitcast %{{.*}}* %{{.*}} to i64*
    // CHECK-PPC64:   %[[val:.*]]   = load i64, i64* %[[ptr]]
  ...
  unsigned read30(S* s) {
    // CHECK-X86-64-LABEL: define dso_local i32 @_ZN2N06read30
    // CHECK-X86-64:   %[[ptr:.*]]   = bitcast %{{.*}}* %{{.*}} to i64*
    // CHECK-X86-64:   %[[val:.*]]   = load i64, i64* %[[ptr]]
    ...
    // CHECK-X86-64:   %[[trunc:.*]] = trunc i64 %[[and]] to i32
    // CHECK-X86-64:                   ret i32 %[[trunc]]
    // CHECK-PPC64-LABEL: define dso_local zeroext i32 @_ZN2N06read30
    // CHECK-PPC64:   %[[ptr:.*]]   = bitcast %{{.*}}* %{{.*}} to i64*
    // CHECK-PPC64:   %[[val:.*]]   = load i64, i64* %[[ptr]]
  ...
  unsigned read31(S* s) {
    // CHECK-X86-64-LABEL: define dso_local i32 @_ZN2N06read31
    // CHECK-X86-64:   %[[ptr:.*]]   = bitcast %{{.*}}* %{{.*}} to i64*
    // CHECK-X86-64:   %[[val:.*]]   = load i64, i64* %[[ptr]]
    ...
    // CHECK-X86-64:   %[[trunc:.*]] = trunc i64 %[[and]] to i32
    // CHECK-X86-64:                   ret i32 %[[trunc]]
    // CHECK-PPC64-LABEL: define dso_local zeroext i32 @_ZN2N06read31
    // CHECK-PPC64:   %[[ptr:.*]]   = bitcast %{{.*}}* %{{.*}} to i64*
    // CHECK-PPC64:   %[[val:.*]]   = load i64, i64* %[[ptr]]
  ...
  unsigned read70(S* s) {
    // CHECK-X86-64-LABEL: define dso_local i32 @_ZN2N06read70
    // CHECK-X86-64:   %[[ptr:.*]]   = bitcast %{{.*}}* %{{.*}} to i64*
    // CHECK-X86-64:   %[[val:.*]]   = load i64, i64* %[[ptr]]
    ...
    // CHECK-X86-64:   %[[trunc:.*]] = trunc i64 %[[and]] to i32
    // CHECK-X86-64:                   ret i32 %[[trunc]]
    // CHECK-PPC64-LABEL: define dso_local zeroext i32 @_ZN2N06read70
    // CHECK-PPC64:   %[[ptr:.*]]   = bitcast %{{.*}}* %{{.*}} to i64*
    // CHECK-PPC64:   %[[val:.*]]   = load i64, i64* %[[ptr]]
  ...
  unsigned read71(S* s) {
    // CHECK-X86-64-LABEL: define dso_local i32 @_ZN2N06read71
    // CHECK-X86-64:   %[[ptr:.*]]   = bitcast %{{.*}}* %{{.*}} to i64*
    // CHECK-X86-64:   %[[val:.*]]   = load i64, i64* %[[ptr]]
    // CHECK-X86-64:   %[[shr:.*]]   = lshr i64 %[[val]], 62
    // CHECK-X86-64:   %[[trunc:.*]] = trunc i64 %[[shr]] to i32
    // CHECK-X86-64:                   ret i32 %[[trunc]]
    // CHECK-PPC64-LABEL: define dso_local zeroext i32 @_ZN2N06read71
    // CHECK-PPC64:   %[[ptr:.*]]   = bitcast %{{.*}}* %{{.*}} to i64*
    // CHECK-PPC64:   %[[val:.*]]   = load i64, i64* %[[ptr]]
...
namespace N1 {
  ...
  unsigned read(S* s) {
    // CHECK-X86-64-LABEL: define dso_local i32 @_ZN2N14read
    ...
    // CHECK-PPC64-LABEL: define dso_local zeroext i32 @_ZN2N14read
  ...
  void write(S* s, unsigned x) {
    // CHECK-X86-64-LABEL: define dso_local void @_ZN2N15write
    // CHECK-X86-64:   %[[ptr:.*]]     = getelementptr inbounds %{{.*}}, %{{.*}}* %{{.*}}, i32 0, i32 1
    ...
    // CHECK-PPC64-LABEL: define dso_local void @_ZN2N15write
    // CHECK-PPC64:   %[[ptr:.*]]     = getelementptr inbounds %{{.*}}, %{{.*}}* %{{.*}}, i32 0, i32 1
...
namespace N2 {
  ...
  unsigned read(S* s) {
    // CHECK-X86-64-LABEL: define dso_local i32 @_ZN2N24read
    ...
    // CHECK-PPC64-LABEL: define dso_local zeroext i32 @_ZN2N24read
  ...
  void write(S* s, unsigned x) {
    // CHECK-X86-64-LABEL: define dso_local void @_ZN2N25write
    // CHECK-X86-64:   %[[ptr:.*]]     = bitcast %{{.*}}* %{{.*}} to i32*
    ...
    // CHECK-PPC64-LABEL: define dso_local void @_ZN2N25write
    // CHECK-PPC64:   %[[ptr:.*]]     = bitcast %{{.*}}* %{{.*}} to i32*
...
namespace N3 {
  ...
  unsigned read(S* s) {
    // CHECK-X86-64-LABEL: define dso_local i32 @_ZN2N34read
    // CHECK-X86-64:   %[[ptr:.*]] = bitcast %{{.*}}* %{{.*}} to i32*
    // CHECK-X86-64:   %[[val:.*]] = load i32, i32* %[[ptr]]
    // CHECK-X86-64:   %[[and:.*]] = and i32 %[[val]], 16777215
    // CHECK-X86-64:                 ret i32 %[[and]]
    // CHECK-PPC64-LABEL: define dso_local zeroext i32 @_ZN2N34read
    // CHECK-PPC64:   %[[ptr:.*]] = bitcast %{{.*}}* %{{.*}} to i32*
    // CHECK-PPC64:   %[[val:.*]] = load i32, i32* %[[ptr]]
    // CHECK-PPC64:   %[[shr:.*]] = lshr i32 %[[val]], 8
    // CHECK-PPC64:                 ret i32 %[[shr]]
  ...
  void write(S* s, unsigned x) {
    // CHECK-X86-64-LABEL: define dso_local void @_ZN2N35write
    // CHECK-X86-64:   %[[ptr:.*]]     = bitcast %{{.*}}* %{{.*}} to i32*
    // CHECK-X86-64:   %[[old:.*]]     = load i32, i32* %[[ptr]]
    // CHECK-X86-64:   %[[x_and:.*]]   = and i32 %{{.*}}, 16777215
    // CHECK-X86-64:   %[[old_and:.*]] = and i32 %[[old]], -16777216
    // CHECK-X86-64:   %[[new:.*]]     = or i32 %[[old_and]], %[[x_and]]
    // CHECK-X86-64:                     store i32 %[[new]], i32* %[[ptr]]
    // CHECK-PPC64-LABEL: define dso_local void @_ZN2N35write
    // CHECK-PPC64:   %[[ptr:.*]]     = bitcast %{{.*}}* %{{.*}} to i32*
    // CHECK-PPC64:   %[[old:.*]]     = load i32, i32* %[[ptr]]
    // CHECK-PPC64:   %[[x_and:.*]]   = and i32 %{{.*}}, 16777215
    // CHECK-PPC64:   %[[x_shl:.*]]   = shl i32 %[[x_and]], 8
...
namespace N4 {
  ...
  unsigned read(Base* s) {
    ...
    //
    // CHECK-X86-64-LABEL: define dso_local i32 @_ZN2N44read
    ...
    // CHECK-X86-64:                 ret i32 %[[ext]]
    // CHECK-PPC64-LABEL: define dso_local zeroext i32 @_ZN2N44read
  ...
  void write(Base* s, unsigned x) {
    // CHECK-X86-64-LABEL: define dso_local void @_ZN2N45write
    // CHECK-X86-64:   %[[gep:.*]] = getelementptr inbounds {{.*}}, {{.*}}* %{{.*}}, i32 0, i32 1
    // CHECK-X86-64:   %[[ptr:.*]] = bitcast [3 x i8]* %[[gep]] to i24*
    // CHECK-X86-64:   %[[new:.*]] = trunc i32 %{{.*}} to i24
    // CHECK-X86-64:                 store i24 %[[new]], i24* %[[ptr]]
    // CHECK-PPC64-LABEL: define dso_local void @_ZN2N45write
    // CHECK-PPC64:   %[[gep:.*]] = getelementptr inbounds {{.*}}, {{.*}}* %{{.*}}, i32 0, i32 1
    // CHECK-PPC64:   %[[ptr:.*]] = bitcast [3 x i8]* %[[gep]] to i24*
...
namespace N5 {
  ...
  unsigned read(U* u) {
    // CHECK-X86-64-LABEL: define dso_local i32 @_ZN2N54read
    // CHECK-X86-64:   %[[ptr:.*]] = bitcast %{{.*}}* %{{.*}} to i32*
    // CHECK-X86-64:   %[[val:.*]] = load i32, i32* %[[ptr]]
    // CHECK-X86-64:   %[[and:.*]] = and i32 %[[val]], 16777215
    // CHECK-X86-64:                 ret i32 %[[and]]
    // CHECK-PPC64-LABEL: define dso_local zeroext i32 @_ZN2N54read
    // CHECK-PPC64:   %[[ptr:.*]] = bitcast %{{.*}}* %{{.*}} to i32*
    // CHECK-PPC64:   %[[val:.*]] = load i32, i32* %[[ptr]]
    // CHECK-PPC64:   %[[shr:.*]] = lshr i32 %[[val]], 8
    // CHECK-PPC64:                 ret i32 %[[shr]]
  ...
  void write(U* u, unsigned x) {
    // CHECK-X86-64-LABEL: define dso_local void @_ZN2N55write
    // CHECK-X86-64:   %[[ptr:.*]]     = bitcast %{{.*}}* %{{.*}} to i32*
    // CHECK-X86-64:   %[[old:.*]]     = load i32, i32* %[[ptr]]
    // CHECK-X86-64:   %[[x_and:.*]]   = and i32 %{{.*}}, 16777215
    // CHECK-X86-64:   %[[old_and:.*]] = and i32 %[[old]], -16777216
    // CHECK-X86-64:   %[[new:.*]]     = or i32 %[[old_and]], %[[x_and]]
    // CHECK-X86-64:                     store i32 %[[new]], i32* %[[ptr]]
    // CHECK-PPC64-LABEL: define dso_local void @_ZN2N55write
    // CHECK-PPC64:   %[[ptr:.*]]     = bitcast %{{.*}}* %{{.*}} to i32*
    // CHECK-PPC64:   %[[old:.*]]     = load i32, i32* %[[ptr]]
    // CHECK-PPC64:   %[[x_and:.*]]   = and i32 %{{.*}}, 16777215
    // CHECK-PPC64:   %[[x_shl:.*]]   = shl i32 %[[x_and]], 8
...
namespace N6 {
  ...
  unsigned read(S* s) {
    // CHECK-X86-64-LABEL: define dso_local i32 @_ZN2N64read
    ...
    // CHECK-PPC64-LABEL: define dso_local zeroext i32 @_ZN2N64read
  ...
  void write(S* s, unsigned x) {
    // CHECK-X86-64-LABEL: define dso_local void @_ZN2N65write
    // CHECK-X86-64:   %[[ptr1:.*]] = bitcast {{.*}}* %{{.*}} to i24*
    ...
    // CHECK-PPC64-LABEL: define dso_local void @_ZN2N65write
    // CHECK-PPC64:   %[[ptr1:.*]] = bitcast {{.*}}* %{{.*}} to i24*
...
namespace N7 {
  ...
  unsigned read(B2* s) {
    ...
    // instrumented by ThreadSanitizer.
    //
    // CHECK-X86-64-LABEL: define dso_local i32 @_ZN2N74read
    // CHECK-X86-64:   %[[gep:.*]] = getelementptr inbounds {{.*}}, {{.*}}* %{{.*}}, i32 0, i32 1
    // CHECK-X86-64:   %[[ptr:.*]] = bitcast [3 x i8]* %[[gep]] to i24*
    // CHECK-X86-64:   %[[val:.*]] = load i24, i24* %[[ptr]]
    // CHECK-X86-64:   %[[ext:.*]] = zext i24 %[[val]] to i32
    // CHECK-X86-64:                 ret i32 %[[ext]]
    // CHECK-PPC64-LABEL: define dso_local zeroext i32 @_ZN2N74read
    // CHECK-PPC64:   %[[gep:.*]] = getelementptr inbounds {{.*}}, {{.*}}* %{{.*}}, i32 0, i32 1
    // CHECK-PPC64:   %[[ptr:.*]] = bitcast [3 x i8]* %[[gep]] to i24*
    // CHECK-PPC64:   %[[val:.*]] = load i24, i24* %[[ptr]]
    // CHECK-PPC64:   %[[ext:.*]] = zext i24 %[[val]] to i32
  ...
  void write(B2* s, unsigned x) {
    // CHECK-X86-64-LABEL: define dso_local void @_ZN2N75write
    // CHECK-X86-64:   %[[gep:.*]] = getelementptr inbounds {{.*}}, {{.*}}* %{{.*}}, i32 0, i32 1
    // CHECK-X86-64:   %[[ptr:.*]] = bitcast [3 x i8]* %[[gep]] to i24*
    // CHECK-X86-64:   %[[new:.*]] = trunc i32 %{{.*}} to i24
    // CHECK-X86-64:                 store i24 %[[new]], i24* %[[ptr]]
    // CHECK-PPC64-LABEL: define dso_local void @_ZN2N75write
    // CHECK-PPC64:   %[[gep:.*]] = getelementptr inbounds {{.*}}, {{.*}}* %{{.*}}, i32 0, i32 1
    // CHECK-PPC64:   %[[ptr:.*]] = bitcast [3 x i8]* %[[gep]] to i24*
    // CHECK-PPC64:   %[[new:.*]] = trunc i32 %{{.*}} to i24
    // CHECK-PPC64:                 store i24 %[[new]], i24* %[[ptr]]
