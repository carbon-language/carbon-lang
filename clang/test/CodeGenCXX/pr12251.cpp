...
// CHECK-LABEL: define dso_local zeroext i1 @_Z1fPb
...
// NO-STRICT-ENUMS-LABEL: define dso_local zeroext i1 @_Z1fPb
...
// CHECK-LABEL: define dso_local i32 @_Z2g1P2e1
// CHECK: ret i32 0
...
// CHECK-LABEL: define dso_local i32 @_Z2g2P2e2
// CHECK: ret i32 0
...
// CHECK-LABEL: define dso_local i32 @_Z2g3P2e3
...
// CHECK-LABEL: define dso_local i32 @_Z2g4P2e4
...
// CHECK-LABEL: define dso_local i32 @_Z2g5P2e5
...
// CHECK-LABEL: define dso_local i32 @_Z2g6P2e6
...
// CHECK-LABEL: define dso_local i32 @_Z2g7P2e7
// CHECK: load i32, i32* %x, align 4, !range [[RANGE_i32_m16_16]]
...
// CHECK-LABEL: define dso_local i32 @_Z2g8P2e8
// CHECK: load i32, i32* %x, align 4, !range [[RANGE_i32_m32_32:![^ ]*]]
...
// CHECK-LABEL: define dso_local i32 @_Z2g9P2e9
// CHECK: load i32, i32* %x, align 4, !range [[RANGE_i32_0_32]]
...
// CHECK-LABEL: define dso_local i32 @_Z3g10P3e10
...
// CHECK-LABEL: define dso_local i64 @_Z3g11P3e11
...
// CHECK-LABEL: define dso_local i64 @_Z3g12P3e12
...
// CHECK-LABEL: define dso_local signext i8 @_Z3g13P3e13
...
// CHECK-LABEL: define dso_local i32 @_Z3g14P3e14
...
// CHECK-LABEL: define dso_local i32 @_Z3g15P3e15
// CHECK: load i32, i32* %x, align 4
// CHECK-NOT: range
// CHECK: ret
...
// CHECK-LABEL: define dso_local i32 @_Z3g16P3e16
// CHECK: load i32, i32* %x, align 4
// CHECK-NOT: range
// CHECK: ret
