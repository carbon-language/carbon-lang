...
namespace Test1 {
  ...
  // CHECK-LABEL: define dso_local void @_ZN5Test13fooEPNS_1BE
  void foo(B *b) {
    // CHECK: call void @_ZN5Test11BD1Ev
    delete b;
  }
  // CHECK-LABEL: define dso_local void @_ZN5Test14foo2EPNS_1CE
  void foo2(C *c) {
    // CHECK: call void @_ZN5Test11CD1Ev
    delete c;
  }
  // CHECK-LABEL: define dso_local void @_ZN5Test14evilEPNS_1DE
  void evil(D *p) {
