...
// CHECK-LABEL: define dso_local void @_Z2fni
void fn(int n) {
...
// CHECK-LABEL: define dso_local void @_Z11const_exactv
void const_exact() {
...
// CHECK-LABEL: define dso_local void @_Z15string_nonconsti
...
// CHECK-LABEL: define dso_local void @_Z12string_exactv
void string_exact() {
  // CHECK-NOT: icmp
...
// CHECK-LABEL: define dso_local void @_Z17string_sufficientv
...
// CHECK-LABEL: define dso_local void @_Z10aggr_exactv
void aggr_exact() {
  // CHECK-NOT: icmp
...
// CHECK-LABEL: define dso_local void @_Z15aggr_sufficienti
...
// SIO-LABEL: define dso_local void @_Z14constexpr_testv
void constexpr_test() {
  // SIO: call i8* @_Zna{{.}}(i32 4)
  new int[0+1]{0};
}

// CHECK-LABEL: define dso_local void @_Z13unknown_boundv
void unknown_bound() {
...
// CHECK-LABEL: define dso_local void @_Z20unknown_bound_stringv
