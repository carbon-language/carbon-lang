...
// CHECK-LABEL: define dso_local void @_Z5func1Pi(i32* %x)
void func1(int *x) {
...
// CHECK-LABEL: define dso_local void @_Z5func4i
void func4(int x) {
...
// CHECK-LABEL: define dso_local void @_Z5func5v
void func5() {
  return;
  int x = 0;
}

// CHECK-LABEL: define dso_local void @_Z5func6v
void func6() {
  return;
  int x;
}

// CHECK-LABEL: define dso_local void @_Z5func7v
extern void use(int *);
void func7() {
  goto later;
  int x;
