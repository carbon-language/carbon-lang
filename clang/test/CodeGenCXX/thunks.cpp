...
// CHECK-LABEL: define dso_local void @_ZThn8_N5Test11C1fEv(
...
// CHECK-LABEL: define dso_local void @_ZTv0_n24_N5Test21B1fEv(
// CHECK-DBG-NOT: dbg.declare
// CHECK: ret void
void B::f() { }
...
// CHECK: define dso_local %{{.*}}* @_ZTch0_v0_n24_N5Test31B1fEv(
...
namespace Test6 {
  ...
  // CHECK-LABEL: define dso_local void @_ZThn16_N5Test66Thunks1fEv
	// CHECK-DBG-NOT: dbg.declare
  // CHECK-NOT: memcpy
...
namespace Test7 {
  ...
  // CHECK-LABEL: define dso_local void @_ZThn8_N5Test71D3bazENS_1XERS1_CfNS_5SmallERS4_NS_5LargeE(
  // CHECK-DBG-NOT: dbg.declare
  // CHECK-NOT: memcpy
  // CHECK: ret void
  void testD() { D d; }
...
namespace Test8 {
  ...
  // CHECK: define dso_local void @_ZN5Test81C6helperENS_6NonPODE([[NONPODTYPE:%.*]]*
  void C::helper(NonPOD var) {}

  // CHECK-LABEL: define dso_local void @_ZThn8_N5Test81C3barENS_6NonPODE(
  // CHECK-DBG-NOT: dbg.declare
...
namespace Test14 {
  ...
  // CHECK: define dso_local void @_ZThn8_N6Test141C1fEv({{.*}}) unnamed_addr [[NUW:#[0-9]+]]
  // CHECK-DBG-NOT: dbg.declare
  // CHECK: ret void
}
...
D::~D() {}
// CHECK: define linkonce_odr dso_local void @_ZThn8_N6Test161C3fooEv({{.*}}) {{.*}} comdat
// CHECK-DBG-NOT: dbg.declare
// CHECK: ret void
}
...
// This is from Test5:
// CHECK-NONOPT-LABEL: define linkonce_odr dso_local void @_ZTv0_n24_N5Test51B1fEv

// This is from Test10:
// CHECK-NONOPT-LABEL: define linkonce_odr dso_local void @_ZN6Test101C3fooEv
// CHECK-NONOPT-LABEL: define linkonce_odr dso_local void @_ZThn8_N6Test101C3fooEv
...
// This is from Test5:
// CHECK-OPT-LABEL: define linkonce_odr dso_local void @_ZTv0_n24_N5Test51B1fEv

// This is from Test10:
// CHECK-OPT-LABEL: define linkonce_odr dso_local void @_ZN6Test101C3fooEv
// CHECK-OPT-LABEL: define linkonce_odr dso_local void @_ZThn8_N6Test101C3fooEv
