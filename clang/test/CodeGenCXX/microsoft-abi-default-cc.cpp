...
void __cdecl foo();
void __cdecl foo() {}
// GCABI-LABEL: define dso_local void @_Z3foov()
// MSABI: define dso_local void @"?foo@@YAXXZ"

void __cdecl bar();
void bar();
void bar() {}
// GCABI-LABEL: define dso_local void @_Z3barv()
...
void A::qux() {}
// GCABI-LABEL: define dso_local void @_ZN1A3quxEv
// MSABI: define dso_local x86_thiscallcc void @"?qux@A@@QAEXXZ"

void __cdecl static_baz() {}
// GCABI-LABEL: define dso_local void @_Z10static_bazv
// MSABI: define dso_local void @"?static_baz@@YAXXZ"
void static_qux() {}
// GCABI-LABEL: define dso_local void @_Z10static_quxv
