...
// CHECK-LABEL: define dso_local void @_Z3t11i
struct B { int a; };
...
// CHECK-LABEL: define dso_local void @_Z3t12v
void t12() {
  // CHECK: call i8* @_Znam
  // CHECK-NOT: br
  (void)new Empty[10];
...
// Zero-initialization
// CHECK-LABEL: define dso_local void @_Z3t13i
void t13(int n) {
  // CHECK: call i8* @_Znwm
...
namespace test15 {
  ...
  // CHECK-LABEL:    define dso_local void @_ZN6test156test0bEPv(
  // CHECK:      [[P0:%.*]] = load i8*, i8**
  ...
  // CHECK-LABEL:    define dso_local void @_ZN6test156test1aEPv(
  // CHECK:      [[P:%.*]] = load i8*, i8**
  // CHECK-NOT:  icmp eq i8* [[P]], null
  // CHECK-NOT:  br i1
  ...
  // CHECK-LABEL:    define dso_local void @_ZN6test156test1bEPv(
  // CHECK:      [[P0:%.*]] = load i8*, i8**
  ...
  // CHECK-LABEL:    define dso_local void @_ZN6test155test2EPvi(
...
namespace PR10197 {
  // CHECK-LABEL: define weak_odr dso_local void @_ZN7PR101971fIiEEvv()
  template<typename T>
  void f() {
...
namespace PR11523 {
  ...
  // CHECK-LABEL: define dso_local i64* @_ZN7PR115231fEv
  // CHECK: store i64 -1
...
namespace PR13380 {
  ...
  // CHECK-LABEL: define dso_local i8* @_ZN7PR133801fEv
  // CHECK: call i8* @_Znam(
...
namespace N3664 {
  ...
  // CHECK-LABEL: define dso_local void @_ZN5N36641fEv
  void f() {
  ...
  // CHECK-LABEL: define dso_local void @_ZN5N36641gEv
  void g() {
...
namespace builtins {
  // CHECK-LABEL: define dso_local void @_ZN8builtins1fEv
  void f() {
    // CHECK: call i8* @_Znwm(i64 4) [[ATTR_BUILTIN_NEW]]
    // CHECK: call void @_ZdlPv({{.*}}) [[ATTR_BUILTIN_DELETE]]
