...
// CHECK-LABEL: define dso_local void @_ZN7trivial3barEv()
...
// CHECK-LABEL: define dso_local void @_ZN12default_ctor3barEv()
...
// CHECK-LABEL: define dso_local void @_ZN11all_deleted3barEv()
// CHECK: call void @_Z{{.*}}C1Ev(
// CHECK-NOT: call
...
// CHECK-LABEL: define dso_local void @_ZN18implicitly_deleted3barEv()
// CHECK: call void @_Z{{.*}}C1Ev(
// CHECK-NOT: call
...
// CHECK-LABEL: define dso_local void @_ZN14move_defaulted3barEv()
// CHECK: call void @_Z{{.*}}C1Ev(
// CHECK: load i8*, i8**
...
// CHECK-LABEL: define dso_local void @_ZN17trivial_defaulted3barEv()
// CHECK: call void @_Z{{.*}}C1Ev(
// CHECK: load i8*, i8**
...
// NEWABI-LABEL: define dso_local i8* @_ZN15definition_only3fooENS_1AE(%"struct.definition_only::A"*
// OLDABI-LABEL: define dso_local i8* @_ZN15definition_only3fooENS_1AE(i8*
...
// NEWABI-LABEL: define dso_local i8* @_ZN17deleted_by_member3fooENS_1AE(%"struct.deleted_by_member::A"*
// OLDABI-LABEL: define dso_local i8* @_ZN17deleted_by_member3fooENS_1AE(i8*
...
void *foo(A a) { return a.p; }
// NEWABI-LABEL: define dso_local i8* @_ZN15deleted_by_base3fooENS_1AE(%"struct.deleted_by_base::A"*
// OLDABI-LABEL: define dso_local i8* @_ZN15deleted_by_base3fooENS_1AE(i8*
...
void *foo(A a) { return a.b.p; }
// NEWABI-LABEL: define dso_local i8* @_ZN22deleted_by_member_copy3fooENS_1AE(%"struct.deleted_by_member_copy::A"*
// OLDABI-LABEL: define dso_local i8* @_ZN22deleted_by_member_copy3fooENS_1AE(i8*
...
void *foo(A a) { return a.p; }
// NEWABI-LABEL: define dso_local i8* @_ZN20deleted_by_base_copy3fooENS_1AE(%"struct.deleted_by_base_copy::A"*
// OLDABI-LABEL: define dso_local i8* @_ZN20deleted_by_base_copy3fooENS_1AE(i8*
...
// NEWABI-LABEL: define dso_local i8* @_ZN15explicit_delete3fooENS_1AE(%"struct.explicit_delete::A"*
// OLDABI-LABEL: define dso_local i8* @_ZN15explicit_delete3fooENS_1AE(i8*
