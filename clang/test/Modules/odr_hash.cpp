...
// TODO: Error here
// expected-err or@first.h:* {{'S16' has different definitions in different modules; definition in module 'first' is here}}
// expected-no te@second.h:* {{definition in module 'second' is here}}
#endif
