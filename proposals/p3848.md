...
be restricted to only non-public interfaces. This alternative was considered by
way of a leads question
([#3860](https://github.com/carbon-language/carbon-lang/issues/3860)) and was
decided against.
...
concerns of the current solution.
