...
This proposal moves Carbon further toward
[Code that is easy to read, understand, and write](/docs/project/goals.md#code-that-is-easy-to-read-understand-and-write)
by ensuring that code works as it is written. We have eliminated a soundness
issue where different libraries had a different view of what `impl` to use for a
given type, and we have ensured that generic bindings always have a value that
can be made more specific when they are used.
