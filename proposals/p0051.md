...
-   We expect platform support priorities to differ between C and C++ and
    Carbon. This is a conflict with Carbon's #6 priority, which focuses support
    on modern over legacy platforms.
