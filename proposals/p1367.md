...
executable semantics team, a toolchain team, etc, with each owning their own
...
It's mainly because of the relatively inflexibility of CODEOWNERS that we aren't
doing this.
