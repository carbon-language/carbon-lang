...
FIXME: ideas around how to approach explaining or teaching it

FIXME: this is a relatively small change in practice from where Carbon's design
already is today, and we can and should still be open to more significant
changes if this problem ends up being severe and needing it.
