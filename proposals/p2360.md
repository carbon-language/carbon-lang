...
decision. Because such a named constraint `MyVersionOfType` is equivalent to
`Type`, that is, because they are the same kind, a value `T:! MyVersionOfType`
is a type under this proposal.
