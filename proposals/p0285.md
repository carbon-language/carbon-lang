...
accepting alternatives that skew from C++ syntax if they are sufficiently
better; the priority is to _avoid debate_ and produce a trivial proposal. Where
an alternative would trigger debate, it should be examined by an advocate in a
focused proposal.
