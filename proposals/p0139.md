...
This proposal does not permit accessing a union member that isn't live. This is
unlike C++, which permits assigning to an active member as a way of making it
active, and permits reading from inactive members when they're part of a common
initial sequence, as well as in a much broader but more nebulous set of
