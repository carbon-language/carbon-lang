...
When the callee in a call expression is either the name of a parameterized
entity like a generic class or interface or has a function type or bound method
type, the call is a _direct call_.
