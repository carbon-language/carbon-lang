...
Other languages, such as C#, D, and Virgil, have constructs that represent bound
and unbound methods, such as
["delegates"](https://news.ycombinator.com/item?id=39812565).
...
v.F() == v.(C.F)()
      ...
      == method_call_compiler_intrinsic(C.F, v, ())
...
r.F() == r.(C.F)()
      ...
      == method_call_compiler_intrinsic(__C_F, r, ())
```
...
impl __ValueBind_C_F as Call(()) with .Result = i32 {
  ...
  fn Op[self: Self]() -> i32 {
    ...
    // binding again.
    return method_call_compiler_intrinsic(__C_F, self as C, ());
  }
}
...
impl __ValueBind_C_Static as Call(()) with .Result = i32 {
  ...
  fn Op[unused self: Self]() -> i32 {
    ...
    return call_compiler_intrinsic(__C_Static, ());
  }
}
...
impl __ValueBind_I_F(C) as Call(()) where .Result = () {
  fn Op[self: Self]() {
    call_compiler_intrinsic((C as I).F, self as C, ());
  }
}
```
