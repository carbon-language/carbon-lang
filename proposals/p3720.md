...
impl __ValueBind_C_F as Call(()) with .Result = i32 {
  ...
  fn Op[self: Self]() -> i32 {
    ...
    // binding again.
    return method_call_compiler_intrinsic(
        <function body C.F.1>, self as C, ());
  }
}
...
impl __ValueBind_C_Static as Call(()) with .Result = i32 {
  ...
  fn Op[unused self: Self]() -> i32 {
    ...
    return call_compiler_intrinsic(<function body C.Static.1>, ());
  }
}
