...
scrutinee, somewhat as if the mutable storage is first initialized from the
...
_proper-pattern_ ::= _callee-expression_ _tuple-pattern_ _proper-pattern_ ::=
_designator_ _tuple-pattern_?
