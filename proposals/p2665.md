...
it harder to assess. However, there are observable ways the behavior can lead to
small mistakes; these may may often be caught by the compiler, but will
sometimes be missed. For example:
