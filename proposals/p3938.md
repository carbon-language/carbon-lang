...
`export name` directives are normal code and cannot be intermingled with any `import` directives, including `export import` directives.
...
```
import library "foo";
// Invalid: comes before an import.
export FooType;
...
// Invalid: comes after a declaration.
export import library "wiz";
```
