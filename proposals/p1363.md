...
-   A fairly small number of committers (initially the current set) can
    merge PRs.
...
-   We will have a sudden influx of community members, and all of them trying to
    figure out how to collaborate and communicate effectively. This will even
...
-   It will be tempting for the Carbon Leads to attempt to drive these
    responses, in turns starving other parts of the project.
