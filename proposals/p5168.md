...
| `interface Y {   require Self impls Z; } impl C as Y { ... }` | open question
[\#4579](https://github.com/carbon-language/carbon-lang/issues/4579) | open
question [\#4579](https://github.com/carbon-language/carbon-lang/issues/4579) |
| | `fn F[T:! I](x: T);` | `I` declared | | `F`, `I` | | `fn F[T:! I](x: T) {`
... `}` | `I` complete | `F` complete | | |
`interface I; class C; class D(T:! I); fn F(x: D(C));` | `C impls I` | | `I`,
`C`?, `D` | | `interface I; class D(T:! I); fn F[U:! type](x: D(U));` | |
`U impls I` (implied constraint) | `I`, `D`, `F` |
