...
-   An _implied constraint_ is a condition that must hold if a type is used in a
    ...
    -   Implied constraints are also a tool we can choose to use to say that a
        requirement on a parameter can be enforced at a later point. For
        example, a symbolic type parameter could have a constraint that it impls
        `A`, and we might add an implied constraint that it also impls `B`
        without first determining whether implementing `A` implies it also
        implements `B`. Callers would have to provide arguments that satisfy the
        additional requirement if it turns out that `A` alone is not sufficient.
...
<table>
  <tr>
   ...
   <td><strong>prereq</strong>
   </td>
   <td><strong>provides</strong>
   </td>
   <td><strong>complete by <a href="https://en.wikipedia.org/wiki/End-of-file">EOF</a></strong>
   </td>
  </tr>
  <tr>
   <td><code>impl C as Y;</code>
   </td>
   <td><code>Y</code> complete
   </td>
   <td><code>C impls Y</code>
   </td>
   <td>
   </td>
  </tr>
  <tr>
   <td><code>impl C as Y {</code> ... <code>}</code>
   </td>
   <td><code>Y</code> complete
   </td>
   <td><code>C impls Y</code>
  ...
  <tr>
   <td><code>interface I;</code>
   </td>
   <td>
   </td>
   <td><code>I</code> declared
   </td>
   <td><code>I</code>
   </td>
  </tr>
  <tr>
   <td><code>interface Y {</code>
<p>
<code>  require Self impls Z;</code>
<p>
<code>}</code>
   </td>
   <td><code>Z</code> declared
   </td>
   <td><code>Y</code> complete
   </td>
   <td><code>Z</code>
...
<code>}</code>
<p>
<code>impl C as Y { ... }</code>
   </td>
   <td>open question <a href="https://github.com/carbon-language/carbon-lang/issues/4579">#4579</a>
   </td>
   <td>open question <a href="https://github.com/carbon-language/carbon-lang/issues/4579">#4579</a>
   </td>
   <td>
  ...
  <tr>
   <td><code>fn F[T:! I](x: T);</code>
   </td>
   <td><code>I</code> declared
   </td>
   <td>
   </td>
   <td><code>F</code>, <code>I</code>
   </td>
  </tr>
  <tr>
   <td><code>fn F[T:! I](x: T) {</code> ... <code>}</code>
   </td>
   <td><code>I</code> complete
   </td>
   <td><code>F</code> complete
   </td>
   <td>
   </td>
  </tr>
...
<code>class C;</code>
<p>
<code>class D(T:! I);</code>
<p>
<code>fn F(x: D(C));</code>
   </td>
   <td><code>C impls I</code>
   </td>
   <td>
   </td>
   <td><code>I</code>, <code>C</code>?, <code>D</code>
   </td>
  </tr>
  <tr>
   <td><code>interface I;</code>
...
<code>class D(T:! I);</code>
<p>
<code>fn F[U:! type](x: D(U));</code>
   </td>
   <td>
   </td>
   <td><code>U impls I</code> (implied constraint)
   </td>
   <td><code>I</code>, <code>D</code>, <code>F</code>
   </td>
  </tr>
</table>
...
<table>
  ...
  <tr>
   ...
   <td><code>Y</code> identified
   </td>
   <td><code>C impls Y</code>
   </td>
   <td><code>Y</code>, <code>impl C as Y</code>
   </td>
  </tr>
  <tr>
   <td><code>impl C as Y {</code> ... <code>}</code>
...
<code>}</code>
   ...
   <td><code>Z</code> identified
   </td>
   <td>for any symbolic type <code>T</code>,
<p>
<code>T impls Y</code> implies
<p>
<code>T impls Z</code>;<code> \
Y</code> complete
   </td>
   <td><code>Z</code>
   </td>
...
<code>}</code>
<p>
<code>impl C as Y {</code> ... <code>}</code>
   </td>
   <td><code>X impls Z</code>
   </td>
   <td><code>X impls Y</code>
   </td>
   <td>
   </td>
  </tr>
...
### An <code>impl</code> implements a single interface
...
### Associated constants may be assigned in the body of an <code>impl</code> definition
...
-   Associated constant assignments should be encouraged to be placed in the
    ...
    -   The syntax for specifying the value of an associated constant in an
        ...
        for [#5028](https://github.com/carbon-language/carbon-lang/issues/5028).
...
### An <code>impl</code> may be forward declared without the interface being complete
...
-   Possible support for implementing multiple interfaces with a single impl
    ...
    the right of `as`, as in [the
    considered
    alternative]((#allow-implementing-multiple-interfaces-with-a-single-impl-declaration).
...
<p id="gdcalert1" ><span style="color: red; font-weight: bold">>>>>>  gd2md-html alert: undefined internal link (link text: "2025-02-07"). Did you generate a TOC with blue links? </span><br>(<a href="#">Back to top</a>)(<a href="#gdcalert2">Next alert</a>)<br><span style="color: red; font-weight: bold">>>>>> </span></p>
...
<p id="gdcalert2" ><span style="color: red; font-weight: bold">>>>>>  gd2md-html alert: undefined internal link (link text: "2025-03-04"). Did you generate a TOC with blue links? </span><br>(<a href="#">Back to top</a>)(<a href="#gdcalert3">Next alert</a>)<br><span style="color: red; font-weight: bold">>>>>> </span></p>
...
<p id="gdcalert3" ><span style="color: red; font-weight: bold">>>>>>  gd2md-html alert: undefined internal link (link text: "2025-03-05"). Did you generate a TOC with blue links? </span><br>(<a href="#">Back to top</a>)(<a href="#gdcalert4">Next alert</a>)<br><span style="color: red; font-weight: bold">>>>>> </span></p>
...
<p id="gdcalert4" ><span style="color: red; font-weight: bold">>>>>>  gd2md-html alert: undefined internal link (link text: "2025-03-06"). Did you generate a TOC with blue links? </span><br>(<a href="#">Back to top</a>)(<a href="#gdcalert5">Next alert</a>)<br><span style="color: red; font-weight: bold">>>>>> </span></p>
...
<p id="gdcalert5" ><span style="color: red; font-weight: bold">>>>>>  gd2md-html alert: undefined internal link (link text: "2025-03-13"). Did you generate a TOC with blue links? </span><br>(<a href="#">Back to top</a>)(<a href="#gdcalert6">Next alert</a>)<br><span style="color: red; font-weight: bold">>>>>> </span></p>
...
<p id="gdcalert6" ><span style="color: red; font-weight: bold">>>>>>  gd2md-html alert: undefined internal link (link text: "2025-03-18"). Did you generate a TOC with blue links? </span><br>(<a href="#">Back to top</a>)(<a href="#gdcalert7">Next alert</a>)<br><span style="color: red; font-weight: bold">>>>>> </span></p>
...
<p id="gdcalert7" ><span style="color: red; font-weight: bold">>>>>>  gd2md-html alert: undefined internal link (link text: "2025-03-20"). Did you generate a TOC with blue links? </span><br>(<a href="#">Back to top</a>)(<a href="#gdcalert8">Next alert</a>)<br><span style="color: red; font-weight: bold">>>>>> </span></p>
...
### Allow implementing multiple interfaces with a single <code>impl</code> declaration
...
### An <code>impl</code> of an interface also implements the interfaces it extends
...
-   Perhaps an interface may only be extended by a single interface (though this
    precluded motivating use cases for extends like the subtyping relationships
    between different kinds of graphs used in
