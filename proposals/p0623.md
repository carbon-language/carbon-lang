...
-   Developers are known to make mistakes adding statements to conditionals
    ...
    -   It's possible that, over time, adding braces to add debug statements
        ...
        -   This could be addressed by style guides and automated formatting
            that inserts or removes braces as appropriate, cleaning up after
            temporary edits. However, that is extra work.
