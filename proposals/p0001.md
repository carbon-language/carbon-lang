...
- Some individuals may refuse to use Google Docs over privacy concerns.
  - We've considered creating a GSuite domain for Carbon documentation to help
    address this. However, it may not address everyone's concerns.
...
- Proposals would need to be tracked separately per-repo.
  - This could also end up being a pro if we get a bunch of different repos, as
    ...
    really a con while we're a small project.
