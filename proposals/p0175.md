...
Carbon's interoperability should be comparable to Java/Kotlin or
...
and types to C/C++. This should help avoid requiring Carbon generate
...
may choose a rule that conflicts with how C++ does reference lifetime extension
of temporaries. This could affect idiomatic use of C++ APIs, turning code that
would be safe in C++ into unsafe Carbon code, requiring developers to learn new
coding patterns.
