...
shortcuts in the SemIR model for common cases with an option to disable them for
...
SemIR and the design, and there exist reasonable mitigations such as an option to
...
design itself that can result in an overall superior tradeoff. It would also
