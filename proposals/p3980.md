...
-   Leads consider it acceptable to support (2) separate from (1), and don't see
    a problem with making (1) optional to achieve this (in other words, making
    the `extern library "<owning_library>"` declaration optional).
