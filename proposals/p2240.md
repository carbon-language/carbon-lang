...
-   [Details](#details)
    ...
    -   [Typechecking](#typechecking)
        ...
        -   [Array type deduction](#array-type-deduction)
-   [Rationale](#rationale)
...
map argument expressions to parameters is ${2n \choose n}$ for n variadic
...
Carbon does not yet support deducing a single parameter from multiple arguments,
as in
...
So for consistency, we do not support deducing the element type of an array.
