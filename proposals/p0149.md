...
-   **Dates and times**:
    [2017-04-15 3:45 PM](https://developers.google.com/style/dates-times).
-   **Lists**:
...
-   **Punctuation**:
    ...
    -   Parentheses: [avoid](https://developers.google.com/style/parentheses).
    -   Semicolons:
...
-   **Dates and times**:
    [2/16/16 3:45 PM](https://docs.microsoft.com/en-us/style-guide/a-z-word-list-term-collections/term-collections/date-time-terms).
-   **Lists**:
...
> may be that Microsoft has noteworthy guidance for more terms than Google.
