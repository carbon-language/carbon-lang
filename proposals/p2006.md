...
This interop is based on the fact that these constructs in C++ can bind to
`const`-declared objects which strongly pressure code to be compatible even with
Carbon's more restrictive value expression semantics.
