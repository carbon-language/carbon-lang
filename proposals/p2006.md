...
R-values are formed by literal expressions (`42`), expressions that
evaluate to a R-value `1 + 2`, names introduced by readonly patterns, and the
conversion of a L-value into a R-value.
