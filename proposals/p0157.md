...
storage buffer large enough to hold the argument values of the alternatives.
This implementation will be hidden, of course, and the compiler may be able to
generate better code, but we will design this feature to support at least that
