...
-   [That Carbon supports writing performance-critical software](/docs/project/goals.md#performance-critical-software).
    ...
    for multiple and virtual inheritance, and avoiding redundantly setting the
    vptr when constructing objects.
-   [That Carbon has practical safety and testing mechanisms](/docs/project/goals.md#practical-safety-and-testing-mechanisms).
    This proposal addresses safety concerns with non-virtual destructors and
    [slicing](https://en.wikipedia.org/wiki/Object_slicing) through the use of
...
-   Classes are not in general safe for derivation unless they are explicitly
    designed to be. One example is types designed to be extended will typically
...
that approach to work with inheritance using the base facet. This approach has
some benefits:
