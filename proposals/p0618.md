...
-   Beyond simple inconsistency, the overlap of `:` in this syntax with
    ...
    languages.
-   Does not end up having a consistent syntax for using colons for marking
    labelled parameters and arguments, such as how Swift does.
    -   We would likely not use colon syntax, regardless of the decision here.
