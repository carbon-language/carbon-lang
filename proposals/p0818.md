...
is it doesn't let you put constraints on types that never get a name, such as
in
...
problem is that there is no way to know how many equality constraints need to
