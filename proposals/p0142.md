...
Arguments in favor of requiring pre-normalized inputs (as proposed):
...
-   GCC already diagnoses identifiers that are not in NFC, and WG21 is in the
    ...
    environments should be expected to increasingly accommodate production of
    text in NFC.

Arguments in favor of performing noralization ourselves (alternative):
