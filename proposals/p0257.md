...
completely formed or completely unformed. Allowing mixing of formed and
unformed members in an object introduces significant
...
An alternative approach to [declaring `returned` variables]() is to extend the
