...
-   Makes some idiomatic patterns in C++ either invalid or inefficient. Consider
    ...
    significant, we may revisit this rule to carve out enough of a facility
    for this <something> pattern. That might either be the narrow specially-named operation
