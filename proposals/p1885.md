...
The limitation of this approach is the need to interoperate with the C++ iterator model. This
...
These two options could allow interoperability with a compatible C++ type, either
...
immutable interfaces. A single interface would force developers
