...
-   [Alternatives considered](#alternatives-considered)
    -   [Provide an additional operator for unsafe conversions](#provide-an-additional-operator-for-unsafe-conversions)
...
### Provide an additional operator for unsafe conversions
...
This alternative is not rejected by this proposal, but its consideration has
...
-   Hides the difference between safe and predictable conversions and
