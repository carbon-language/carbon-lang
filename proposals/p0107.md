...
preference for few child namespaces, whereas this alternative benefits when
`namespace` is specified more often.
...
any file in a library, using the same kind of API markup.
