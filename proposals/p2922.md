...
promise). While this restriction was understandably motivated, it isn't a
restriction that we can effectively uphold going forward. For example, it would
prevent informing the conduct team of people banned because of bad-faith
reports. We understand that reports are sensitive, but will need to rely on the
careful selection of conduct team members and their keeping the report
...
-   Personal experience of marginalization in tech communities (e.g. based on
    ability/disability, race/ethnicity, gender identity, lifestyle, first
    language, etc.)
...
to be effective as a member of the Conduct team.
...
Instead, our goal is to set clear expectations on the narrow and limited ways in
which it is ever appropriate for this information to be used. Misusing conduct
reports, much like other abuses of the Code of Conduct's process, is itself a
