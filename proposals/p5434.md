...
is placed in the outermost position, minimizing the number of returns. So
`fn F() -> (i32, i32)` means `fn F() -> var (i32, i32)` not
...
Mutation of objects with a non-copy-value representation in an active `let`
