...
> without sufficient motivation, and even having that choice does add some
...
> varying locals to go through let var for orthogonality aids readability enough
> to offset the verbosity cost of added keywords on a reasonably common pattern.
>
...
> would either have no effect beyond verbosity, or if it did have effect, it
