...
The end of the file is also considered to constitute whitespace.
...
-- commenting out larger passages of documentation, -- commenting out
work-in-progress code during development, and -- performing test case reduction
when isolating compiler bugs.
