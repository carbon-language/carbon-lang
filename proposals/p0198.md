...
The decision to not support trailing and intra-line comments is
**experimental** and should be revisited if we find there is a need for such
comments in the context of the complete language design.
