...
This proposal provides no mechanism to directly include trailing whitespace in a
raw block string literal. If trailing whitespace is desired, the string can be
converted to a non-raw literal, or post-processing steps can be used to form the
