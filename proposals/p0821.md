...
-   Make variables that form [L-Values](TODO) and mutable storage explicit and
    available even as function parameters.
...
This _immutable view_ `id` in `SomeFunction` can be thought of as requiring that
