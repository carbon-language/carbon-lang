...
-   [Alternatives considered](#alternatives-considered)
    -   [No conditional operator](#no-conditional-operator)
...
-   [Code that is easy to read, understand, and write](/docs/project/goals.md#code-that-is-easy-to-read-understand-and-write)
    -   Including such an operator is expected to improve ergonomics.
...
We could provide no conditional operator, and instead ask people to use a
...
-   The `:` token is already in use in name binding; using it as part of a
    conditional operator would be confusing.
