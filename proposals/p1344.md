...
This makes it very easy to prune any trees from the history, replaying the
history left and resulting in a clean and clear result.
...
and have a minimal history of the repository we are actually using.
