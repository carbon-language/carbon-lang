...
#ifndef CARBON_TOOLCHAIN_LOWER_COALESCE_H_
#define CARBON_TOOLCHAIN_LOWER_COALESCE_H_
...
class CoalesceSpecifics {
 public:
  ...
  explicit CoalesceSpecifics(llvm::raw_ostream* vlog_stream,
...
#endif  // CARBON_TOOLCHAIN_LOWER_COALESCE_H_
