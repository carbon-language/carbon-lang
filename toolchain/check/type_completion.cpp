  ...
  template <typename InstT>
    requires(
        InstT::Kind.template IsAnyOf<
            ...
            SemIR::CharType, SemIR::CharLiteralType, SemIR::ErrorInst,
            SemIR::FacetType, SemIR::FloatType, SemIR::IntType,
            SemIR::IntLiteralType, SemIR::LegacyFloatType, SemIR::NamespaceType,
            SemIR::PatternType, SemIR::PointerType, SemIR::SpecificFunctionType,
