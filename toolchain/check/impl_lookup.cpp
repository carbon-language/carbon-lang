...
template <typename InstT>
  requires(
      ...
      SameAsOneOf<
          InstT, SemIR::ArrayIndex, SemIR::AssociatedEntityType,
          SemIR::AutoType, SemIR::BoundMethodType, SemIR::CharLiteralType,
          SemIR::ClassElementAccess, SemIR::CppOverloadSetType,
          SemIR::CustomLayoutType, SemIR::ErrorInst, SemIR::FacetType,
          SemIR::FunctionType, SemIR::FunctionTypeWithSelfType,
          SemIR::GenericClassType, SemIR::GenericInterfaceType,
          SemIR::GenericNamedConstraintType,
          SemIR::ImplWitnessAccessSubstituted,
          SemIR::ImplWitnessAssociatedConstant, SemIR::InstType,
          SemIR::NamespaceType, SemIR::PatternType,
          SemIR::RequireSpecificDefinitionType, SemIR::SpecificFunctionType,
          SemIR::StructAccess, SemIR::SymbolicBinding, SemIR::TupleAccess,
          SemIR::TypeOfInst, SemIR::UnboundElementType, SemIR::VtableType,
