...
static auto TypeCanDestroy(Context& context, SemIR::LocId loc_id,
  ...
  while (!work.empty()) {
    ...
    CARBON_KIND_SWITCH(inst) {
      ...
      case SemIR::AccessMemberAction::Kind:
      case SemIR::AccessOptionalMemberAction::Kind:
      case SemIR::AcquireValue::Kind:
      ...
      case SemIR::SpecificImplFunction::Kind:
      ...
      case SemIR::UninitializedValue::Kind:
