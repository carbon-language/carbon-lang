...
// only sets up the binding pattern and type; callers are expected to do the
// remaining work. This is used when generating functions, rather than
// processing a user-authored `self: Self`.
