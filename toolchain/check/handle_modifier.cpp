...
auto HandleParseNode(Context& context, Parse::ExternLibraryModifierId node_id)
    -> bool {
  return context.TODO(node_id, "extern library support");
}

auto HandleParseNode(Context& context, Parse::ExternTokenModifierId node_id)
    -> bool {
