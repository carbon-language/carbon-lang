...
auto HandleBreakStatement(Context& /*context*/, Parse::Lamp /*parse_node*/)
    -> bool {
  return true;
}

auto HandleBreakStatementStart(Context& context, Parse::Lamp parse_node)
    -> bool {
...
auto HandleContinueStatement(Context& /*context*/, Parse::Lamp /*parse_node*/)
    -> bool {
  return true;
}

auto HandleContinueStatementStart(Context& context, Parse::Lamp parse_node)
    -> bool {
  auto& stack = context.break_continue_stack();
  if (stack.empty()) {
...
auto HandleForHeader(Context& context, Parse::Lamp parse_node) -> bool {
  return context.TODO(parse_node, "HandleForHeader");
}

auto HandleForHeaderStart(Context& context, Parse::Lamp parse_node) -> bool {
  return context.TODO(parse_node, "HandleForHeaderStart");
}

auto HandleForIn(Context& context, Parse::Lamp parse_node) -> bool {
  return context.TODO(parse_node, "HandleForIn");
}

auto HandleForStatement(Context& context, Parse::Lamp parse_node) -> bool {
  return context.TODO(parse_node, "HandleForStatement");
}

auto HandleWhileConditionStart(Context& context, Parse::Lamp parse_node)
    -> bool {
  ...
  context.lamp_stack().Push(parse_node, loop_header_id);
  return true;
}

auto HandleWhileCondition(Context& context, Parse::Lamp parse_node) -> bool {
  ...
  context.lamp_stack().Push(parse_node, loop_exit_id);
  return true;
}

auto HandleWhileStatement(Context& context, Parse::Lamp parse_node) -> bool {
  auto loop_exit_id =
