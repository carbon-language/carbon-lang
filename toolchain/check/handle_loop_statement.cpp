...
auto HandleWhileCondition(Context& context, Parse::Node parse_node) -> bool {
  ...
  auto loop_header_id =
      context.lamp_stack().Peek<Parse::NodeKind::WhileConditionStart>();
...
auto HandleWhileStatement(Context& context, Parse::Node parse_node) -> bool {
  auto loop_exit_id =
      context.lamp_stack().Pop<Parse::NodeKind::WhileCondition>();
  auto loop_header_id =
      context.lamp_stack().Pop<Parse::NodeKind::WhileConditionStart>();
