...
CARBON_DEFINE_RAW_ENUM_CLASS(LampKind, uint8_t) {
...
// tree.
class LampKind : public CARBON_ENUM_BASE(LampKind) {
 public:
...
#define CARBON_PARSE_NODE_KIND(Name) \
  CARBON_ENUM_CONSTANT_DEFINITION(LampKind, Name)
#include "toolchain/parse/node_kind.def"
