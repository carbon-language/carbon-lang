...
TEST_F(TypedNodeTest, For) {
  ...
  auto for_var_name =
      tree.ExtractAs<IdentifierNameNotBeforeSuffix>(for_var_binding->name);
...
Aggregate [^:]*: success
  ...
  EXPECT_THAT(err2.message(), testing::MatchesRegex(
                                  R"Trace(Aggregate [^:]*: begin
NodeIdInCategory IntConst\|MemberExpr\|MemberName: kind IdentifierNameNotBeforeSuffix consumed
...
Optional [^:]*: found
Optional [^:]*: begin
NodeIdForKind error: wrong kind IdentifierNameBeforeSuffix, expected ImplicitParamList
Optional [^:]*: missing
NodeIdInCategory NonExprName: kind IdentifierNameBeforeSuffix consumed
Vector: begin
