...
// parameter of type `InstIdAsType`, `InstIdAsRawType`, or `InstIdAsTypeOfExpr` where possible, or of
// type `TypeId` or `TypeIdAsRawType` if you don't have an expression describing the type.
