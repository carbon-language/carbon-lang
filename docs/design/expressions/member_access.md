...
**TODO:** [p3720](/proposals/p3720.md) introduces an additional "member binding"
step, redefines simple member access in terms of compound member access, and
defines compound member access in terms of calls to user-implementable interface
methods. This document must be updated to reflect those changes.
