...
-   [Setup commands](#setup-commands)
    ...
    -   [macOS](#macos)
    -   [Configuring `clangd`](#configuring-clangd)
-   [Tools](#tools)
...
To ensure that `clangd` reports accurate diagnostics it
needs a generated file called `compile_commands.json`, this can be generated by
