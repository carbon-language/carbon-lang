                ...
                flag_groups = [
                    flag_group(
                        flags = [
                            ...
                            # Enable the use of zlib and zstd in LLVM. We do
                            # this here rather than using the custom zlib and
                            # zstd `BUILD` files shipped with LLVM and instead
                            # use the normal builds of both for Bazel.
                            "-DLLVM_ENABLE_ZLIB",
                            "-DLLVM_ENABLE_ZSTD",
                        ],
                    ),
