...
#define NODE(T1, T2) NODE_NAME(T1::T2, #T2)
  ...
  NODE(parser::OmpClause, ClFirstprivate)
  NODE(parser::OmpClause, ClPrivate)
  NODE(parser, OmpDirective)
  NODE(parser, OmpExeDir)
  NODE(parser::OmpExeDir, Parallel)
  NODE(parser::OmpExeDir, ParDo)
  NODE(parser::OmpExeDir, ParDoSimd)
  NODE(parser::OmpExeDir, ParWrkshr)
  NODE(parser::OmpExeDir, ParSections)
  NODE(parser, Only)
