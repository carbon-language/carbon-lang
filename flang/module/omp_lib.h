...
!dir$ free
  ...
  integer, parameter :: omp_pause_resource_kind = kind(0)
  integer, parameter :: omp_event_handle_kind = kind(0)
  ...
  integer, parameter :: omp_memspace_handle_kind = kind(0)
  integer, parameter :: omp_allocator_handle_kind = kind(0)
  integer, parameter :: omp_alloctrait_key_kind = kind(0)
  integer, parameter :: omp_alloctrait_val_kind = kind(0)
  ...
  interface
    ...
    subroutine omp_get_schedule (kind, modifier) bind(c)
      import
      integer(kind=omp_integer_kind) :: kind, modifier
    ...
    function omp_get_proc_bind() bind(c)
      import
      integer(kind=omp_integer_kind) :: omp_get_proc_bind
    ...
    function omp_is_initial_device() bind(c)
      import
      integer(kind=omp_logical_kind) :: omp_is_initial_device
    ...
    function omp_pause_resource(kind, device_num) bind(c)
      import
      integer(kind=omp_integer_kind), value :: kind, device_num
...
! Lock routines
    ...
    subroutine omp_init_lock_with_hint (lockvar, hint) bind(c, name="omp_init_lock_with_hint_")
      import
      integer(kind=omp_lock_kind), intent(out) :: lockvar
      integer(kind=omp_integer_kind), value :: hint
