...
class GenericBinding : public Pattern {
 public:
  ...
  GenericBinding(const GenericBinding&) = delete;
  auto operator=(const GenericBinding&) -> GenericBinding& = delete;

  //~GenericBinding() override = 0;
 ...
 protected:
  ...
  GenericBinding(AstNodeKind kind, SourceLocation source_loc, std::string name,
