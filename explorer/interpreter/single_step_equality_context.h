...
#ifndef CARBON_EXPLORER_INTERPRETER_SINGLE_STEP_EQUALITY_CONTEXT_H_
#define CARBON_EXPLORER_INTERPRETER_SINGLE_STEP_EQUALITY_CONTEXT_H_
...
#endif  // CARBON_EXPLORER_INTERPRETER_SINGLE_STEP_EQUALITY_CONTEXT_H_
