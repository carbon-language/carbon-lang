...
auto TypeChecker::TypeCheckPattern(
    Nonnull<Pattern*> p, bool require_binding,
  ...
  if (require_binding) {
    switch (p->kind()) {
      ...
      case PatternKind::ExpressionPattern:
        return ProgramError(p->source_loc()) << "Missing name to bind to.";
      default:
        break;
    }
  }
  switch (p->kind()) {
    ...
    case PatternKind::BindingPattern: {
      ...
      CARBON_RETURN_IF_ERROR(TypeCheckPattern(
          &binding.type(), /*require_binding=*/false, std::nullopt, impl_scope,
    ...
    case PatternKind::TuplePattern: {
      ...
      for (size_t i = 0; i < tuple.fields().size(); ++i) {
        ...
        CARBON_RETURN_IF_ERROR(TypeCheckPattern(field, require_binding,
    ...
    case PatternKind::AlternativePattern: {
      ...
      CARBON_ASSIGN_OR_RETURN(
          ...
          Substitute(choice_type.bindings(),
                     *(*signature)->parameters_static_type()));
      CARBON_RETURN_IF_ERROR(TypeCheckPattern(
          &alternative.arguments(), require_binding, parameter_type, impl_scope,
          enclosing_expression_category));
    ...
    case PatternKind::VarPattern: {
      ...
      CARBON_RETURN_IF_ERROR(
          TypeCheckPattern(&var_pattern.pattern(), require_binding, expected,
    ...
    case PatternKind::AddrPattern: {
      ...
      CARBON_RETURN_IF_ERROR(TypeCheckPattern(
          &addr_pattern.binding(), require_binding, expected_ptr, impl_scope,
          enclosing_expression_category));
  ...
  switch (s->kind()) {
    case StatementKind::Match: {
      ...
      for (auto& clause : match.clauses()) {
        ...
        CARBON_RETURN_IF_ERROR(
            TypeCheckPattern(&clause.pattern(), /*require_binding=*/false,
    ...
    case StatementKind::For: {
      ...
      if (rhs.kind() == Value::Kind::StaticArrayType) {
        CARBON_RETURN_IF_ERROR(TypeCheckPattern(
            &for_stmt.variable_declaration(), /*require_binding=*/true,
    ...
    case StatementKind::VariableDefinition: {
      ...
      CARBON_RETURN_IF_ERROR(
          TypeCheckPattern(&var.pattern(), /*require_binding=*/true, init_type,
                           var_scope, var.expression_category()));
...
auto TypeChecker::DeclareCallableDeclaration(Nonnull<CallableDeclaration*> f,
  ...
  for (Nonnull<GenericBinding*> deduced : f->deduced_parameters()) {
    CARBON_RETURN_IF_ERROR(TypeCheckPattern(deduced, /*require_binding=*/true,
                                            std::nullopt, function_scope,
                                            ExpressionCategory::Value));
  ...
  if (f->is_method()) {
    CARBON_RETURN_IF_ERROR(TypeCheckPattern(
        &f->self_pattern(), /*require_binding=*/true, std::nullopt,
  ...
  CARBON_RETURN_IF_ERROR(TypeCheckPattern(
      &f->param_pattern(), /*require_binding=*/true, std::nullopt,
      function_scope, ExpressionCategory::Value));
...
auto TypeChecker::DeclareClassDeclaration(Nonnull<ClassDeclaration*> class_decl,
  ...
  if (class_decl->type_params().has_value()) {
    ...
    CARBON_RETURN_IF_ERROR(
        TypeCheckPattern(type_params, /*require_binding=*/true, std::nullopt,
                         class_scope, ExpressionCategory::Value));
...
auto TypeChecker::DeclareMixinDeclaration(Nonnull<MixinDeclaration*> mixin_decl,
  ...
  if (mixin_decl->params().has_value()) {
    CARBON_RETURN_IF_ERROR(
        TypeCheckPattern(*mixin_decl->params(), /*require_binding=*/true,
  ...
  CARBON_RETURN_IF_ERROR(
      TypeCheckPattern(mixin_decl->self(), /*require_binding=*/true,
                       std::nullopt, mixin_scope, ExpressionCategory::Value));
...
auto TypeChecker::DeclareConstraintTypeDeclaration(
  ...
  if (constraint_decl->params().has_value()) {
    CARBON_RETURN_IF_ERROR(TypeCheckPattern(
        *constraint_decl->params(), /*require_binding=*/true, std::nullopt,
...
auto TypeChecker::DeclareChoiceDeclaration(Nonnull<ChoiceDeclaration*> choice,
  ...
  if (choice->type_params().has_value()) {
    ...
    CARBON_RETURN_IF_ERROR(
        TypeCheckPattern(type_params, /*require_binding=*/false, std::nullopt,
...
auto TypeChecker::DeclareDeclaration(Nonnull<Declaration*> d,
  ...
  switch (d->kind()) {
    ...
    case DeclarationKind::VariableDeclaration: {
      ...
      CARBON_RETURN_IF_ERROR(TypeCheckPattern(
          &var.binding(), /*require_binding=*/true, std::nullopt,
