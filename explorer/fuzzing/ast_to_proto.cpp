...
static auto MixinSelfToProto(const MixinSelf& binding) -> Fuzzing::MixinSelf {
  Fuzzing::MixinSelf binding_proto;
  binding_proto.set_name(binding.name());
  *binding_proto.mutable_type() = ExpressionToProto(binding.type());
...
static auto PatternToProto(const Pattern& pattern) -> Fuzzing::Pattern {
  ...
  switch (pattern.kind()) {
    ...
    case PatternKind::MixinSelf: {
      ...
      *pattern_proto.mutable_mixin_self() = MixinSelfToProto(binding);
      break;
    }
...
static auto DeclarationToProto(const Declaration& declaration)
  ...
  switch (declaration.kind()) {
    ...
    case DeclarationKind::MixinDeclaration: {
      ...
      //}
      *mixin_proto->mutable_self() = MixinSelfToProto(*mixin.self());
      break;
    }
