...
#ifndef CARBON_COMMON_TESTING_BASE_TEST_RAW_OSTREAM_H_
#define CARBON_COMMON_TESTING_BASE_TEST_RAW_OSTREAM_H_
...
#endif  // CARBON_COMMON_TESTING_BASE_TEST_RAW_OSTREAM_H_
