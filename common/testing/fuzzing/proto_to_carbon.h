...
#ifndef CARBON_COMMON_TESTING_FUZZING_PROTO_TO_CARBON_H_
#define CARBON_COMMON_TESTING_FUZZING_PROTO_TO_CARBON_H_
...
#endif  // CARBON_COMMON_TESTING_FUZZING_PROTO_TO_CARBON_H_
