...
class FileTestBase : public testing::Test {
 ...
 private:
  ...
  struct TestContext {
    ...
    // The location of the autoupdate markers for stdout and stderr, for
    // autoupdated files.
    std::optional<int> autoupdate_stdout_line_number;
    std::optional<int> autoupdate_stderr_line_number;
