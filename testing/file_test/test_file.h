...
struct TestFile {
  ...
  // Path to the minimal `prelude` library of the `Core` package to be used for
  // the test file. Only valid in `no_prelude` tests, otherwise the test will
  // include the full production prelude.
  std::optional<std::string> minimal_prelude_path;
