...
struct TestFile {
  ...
  // Paths to files to be included in the test file, and for each test split.
  // What 'included' means is up to the `FileTestBase` implementation. For the
  // toolchain/ they are added to the compile command line, making any package
  // they export available to the test.
