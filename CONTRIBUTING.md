...
[Documentation style guide](docs/project/documentation_style_guide.md), and C++
code should follow the [C++ style guide](docs/project/cpp_style_guide.md). For
other files, if you're not sure what style to use, please ask on Discourse
Forums.
