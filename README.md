...
-   [The Carbon Language: Road to 0.1](https://chandlerc.blog/slides/2024-ndc-techtown-carbon-road-to-0-dot-1),
    NDC {TechTown}
-   [How designing Carbon with C++ interop taught me about C++ variadics and overloads](https://youtu.be/8SGMy9ENGz8),
    CppNorth
-   [Generic Arity: Definition-Checked Variadics in Carbon](https://youtu.be/Y_px536l_80),
    C++Now
