...
attributes #2 = { ssp uwtable "frame-pointer"="all" "stack-protector-buffer-size"="8" "use-soft-float"="false" }
attributes #3 = { "frame-pointer"="all" "stack-protector-buffer-size"="8" "use-soft-float"="false" }
