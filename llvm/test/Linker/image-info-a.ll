; RUN: llvm-link %s %p/image-info-b.ll -S -o - | FileCheck %s
...
; CHECK: !0 = metadata !{i32 1, metadata !"Objective-C Version", i32 2}
; CHECK: !1 = metadata !{i32 1, metadata !"Objective-C Image Info Version", i32 0}
; CHECK: !2 = metadata !{i32 1, metadata !"Objective-C Image Info Section", metadata !"__DATA, __objc_imageinfo, regular, no_dead_strip"}
; CHECK: !3 = metadata !{i32 1, metadata !"Objective-C Garbage Collection", i32 2}
