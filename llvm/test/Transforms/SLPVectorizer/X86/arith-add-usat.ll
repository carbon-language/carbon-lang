...
; CHECK-NEXT:    [[R0:%.*]] = call i16 @llvm.uadd.sat.i16(i16 [[A0]], i16 [[B0]])
; CHECK-NEXT:    [[R1:%.*]] = call i16 @llvm.uadd.sat.i16(i16 [[A1]], i16 [[B1]])
; CHECK-NEXT:    [[R2:%.*]] = call i16 @llvm.uadd.sat.i16(i16 [[A2]], i16 [[B2]])
; CHECK-NEXT:    [[R3:%.*]] = call i16 @llvm.uadd.sat.i16(i16 [[A3]], i16 [[B3]])
; CHECK-NEXT:    [[R4:%.*]] = call i16 @llvm.uadd.sat.i16(i16 [[A4]], i16 [[B4]])
; CHECK-NEXT:    [[R5:%.*]] = call i16 @llvm.uadd.sat.i16(i16 [[A5]], i16 [[B5]])
; CHECK-NEXT:    [[R6:%.*]] = call i16 @llvm.uadd.sat.i16(i16 [[A6]], i16 [[B6]])
; CHECK-NEXT:    [[R7:%.*]] = call i16 @llvm.uadd.sat.i16(i16 [[A7]], i16 [[B7]])
; CHECK-NEXT:    [[R8:%.*]] = call i16 @llvm.uadd.sat.i16(i16 [[A8]], i16 [[B8]])
; CHECK-NEXT:    [[R9:%.*]] = call i16 @llvm.uadd.sat.i16(i16 [[A9]], i16 [[B9]])
; CHECK-NEXT:    [[R10:%.*]] = call i16 @llvm.uadd.sat.i16(i16 [[A10]], i16 [[B10]])
; CHECK-NEXT:    [[R11:%.*]] = call i16 @llvm.uadd.sat.i16(i16 [[A11]], i16 [[B11]])
; CHECK-NEXT:    [[R12:%.*]] = call i16 @llvm.uadd.sat.i16(i16 [[A12]], i16 [[B12]])
; CHECK-NEXT:    [[R13:%.*]] = call i16 @llvm.uadd.sat.i16(i16 [[A13]], i16 [[B13]])
; CHECK-NEXT:    [[R14:%.*]] = call i16 @llvm.uadd.sat.i16(i16 [[A14]], i16 [[B14]])
; CHECK-NEXT:    [[R15:%.*]] = call i16 @llvm.uadd.sat.i16(i16 [[A15]], i16 [[B15]])
; CHECK-NEXT:    [[R16:%.*]] = call i16 @llvm.uadd.sat.i16(i16 [[A16]], i16 [[B16]])
; CHECK-NEXT:    [[R17:%.*]] = call i16 @llvm.uadd.sat.i16(i16 [[A17]], i16 [[B17]])
; CHECK-NEXT:    [[R18:%.*]] = call i16 @llvm.uadd.sat.i16(i16 [[A18]], i16 [[B18]])
; CHECK-NEXT:    [[R19:%.*]] = call i16 @llvm.uadd.sat.i16(i16 [[A19]], i16 [[B19]])
; CHECK-NEXT:    [[R20:%.*]] = call i16 @llvm.uadd.sat.i16(i16 [[A20]], i16 [[B20]])
; CHECK-NEXT:    [[R21:%.*]] = call i16 @llvm.uadd.sat.i16(i16 [[A21]], i16 [[B21]])
; CHECK-NEXT:    [[R22:%.*]] = call i16 @llvm.uadd.sat.i16(i16 [[A22]], i16 [[B22]])
; CHECK-NEXT:    [[R23:%.*]] = call i16 @llvm.uadd.sat.i16(i16 [[A23]], i16 [[B23]])
; CHECK-NEXT:    [[R24:%.*]] = call i16 @llvm.uadd.sat.i16(i16 [[A24]], i16 [[B24]])
; CHECK-NEXT:    [[R25:%.*]] = call i16 @llvm.uadd.sat.i16(i16 [[A25]], i16 [[B25]])
; CHECK-NEXT:    [[R26:%.*]] = call i16 @llvm.uadd.sat.i16(i16 [[A26]], i16 [[B26]])
; CHECK-NEXT:    [[R27:%.*]] = call i16 @llvm.uadd.sat.i16(i16 [[A27]], i16 [[B27]])
; CHECK-NEXT:    [[R28:%.*]] = call i16 @llvm.uadd.sat.i16(i16 [[A28]], i16 [[B28]])
; CHECK-NEXT:    [[R29:%.*]] = call i16 @llvm.uadd.sat.i16(i16 [[A29]], i16 [[B29]])
; CHECK-NEXT:    [[R30:%.*]] = call i16 @llvm.uadd.sat.i16(i16 [[A30]], i16 [[B30]])
; CHECK-NEXT:    [[R31:%.*]] = call i16 @llvm.uadd.sat.i16(i16 [[A31]], i16 [[B31]])
...
; CHECK-NEXT:    [[R0:%.*]] = call i8 @llvm.uadd.sat.i8(i8 [[A0]], i8 [[B0]])
; CHECK-NEXT:    [[R1:%.*]] = call i8 @llvm.uadd.sat.i8(i8 [[A1]], i8 [[B1]])
; CHECK-NEXT:    [[R2:%.*]] = call i8 @llvm.uadd.sat.i8(i8 [[A2]], i8 [[B2]])
; CHECK-NEXT:    [[R3:%.*]] = call i8 @llvm.uadd.sat.i8(i8 [[A3]], i8 [[B3]])
; CHECK-NEXT:    [[R4:%.*]] = call i8 @llvm.uadd.sat.i8(i8 [[A4]], i8 [[B4]])
; CHECK-NEXT:    [[R5:%.*]] = call i8 @llvm.uadd.sat.i8(i8 [[A5]], i8 [[B5]])
; CHECK-NEXT:    [[R6:%.*]] = call i8 @llvm.uadd.sat.i8(i8 [[A6]], i8 [[B6]])
; CHECK-NEXT:    [[R7:%.*]] = call i8 @llvm.uadd.sat.i8(i8 [[A7]], i8 [[B7]])
; CHECK-NEXT:    [[R8:%.*]] = call i8 @llvm.uadd.sat.i8(i8 [[A8]], i8 [[B8]])
; CHECK-NEXT:    [[R9:%.*]] = call i8 @llvm.uadd.sat.i8(i8 [[A9]], i8 [[B9]])
; CHECK-NEXT:    [[R10:%.*]] = call i8 @llvm.uadd.sat.i8(i8 [[A10]], i8 [[B10]])
; CHECK-NEXT:    [[R11:%.*]] = call i8 @llvm.uadd.sat.i8(i8 [[A11]], i8 [[B11]])
; CHECK-NEXT:    [[R12:%.*]] = call i8 @llvm.uadd.sat.i8(i8 [[A12]], i8 [[B12]])
; CHECK-NEXT:    [[R13:%.*]] = call i8 @llvm.uadd.sat.i8(i8 [[A13]], i8 [[B13]])
; CHECK-NEXT:    [[R14:%.*]] = call i8 @llvm.uadd.sat.i8(i8 [[A14]], i8 [[B14]])
; CHECK-NEXT:    [[R15:%.*]] = call i8 @llvm.uadd.sat.i8(i8 [[A15]], i8 [[B15]])
; CHECK-NEXT:    [[R16:%.*]] = call i8 @llvm.uadd.sat.i8(i8 [[A16]], i8 [[B16]])
; CHECK-NEXT:    [[R17:%.*]] = call i8 @llvm.uadd.sat.i8(i8 [[A17]], i8 [[B17]])
; CHECK-NEXT:    [[R18:%.*]] = call i8 @llvm.uadd.sat.i8(i8 [[A18]], i8 [[B18]])
; CHECK-NEXT:    [[R19:%.*]] = call i8 @llvm.uadd.sat.i8(i8 [[A19]], i8 [[B19]])
; CHECK-NEXT:    [[R20:%.*]] = call i8 @llvm.uadd.sat.i8(i8 [[A20]], i8 [[B20]])
; CHECK-NEXT:    [[R21:%.*]] = call i8 @llvm.uadd.sat.i8(i8 [[A21]], i8 [[B21]])
; CHECK-NEXT:    [[R22:%.*]] = call i8 @llvm.uadd.sat.i8(i8 [[A22]], i8 [[B22]])
; CHECK-NEXT:    [[R23:%.*]] = call i8 @llvm.uadd.sat.i8(i8 [[A23]], i8 [[B23]])
; CHECK-NEXT:    [[R24:%.*]] = call i8 @llvm.uadd.sat.i8(i8 [[A24]], i8 [[B24]])
; CHECK-NEXT:    [[R25:%.*]] = call i8 @llvm.uadd.sat.i8(i8 [[A25]], i8 [[B25]])
; CHECK-NEXT:    [[R26:%.*]] = call i8 @llvm.uadd.sat.i8(i8 [[A26]], i8 [[B26]])
; CHECK-NEXT:    [[R27:%.*]] = call i8 @llvm.uadd.sat.i8(i8 [[A27]], i8 [[B27]])
; CHECK-NEXT:    [[R28:%.*]] = call i8 @llvm.uadd.sat.i8(i8 [[A28]], i8 [[B28]])
; CHECK-NEXT:    [[R29:%.*]] = call i8 @llvm.uadd.sat.i8(i8 [[A29]], i8 [[B29]])
; CHECK-NEXT:    [[R30:%.*]] = call i8 @llvm.uadd.sat.i8(i8 [[A30]], i8 [[B30]])
; CHECK-NEXT:    [[R31:%.*]] = call i8 @llvm.uadd.sat.i8(i8 [[A31]], i8 [[B31]])
; CHECK-NEXT:    [[R32:%.*]] = call i8 @llvm.uadd.sat.i8(i8 [[A32]], i8 [[B32]])
; CHECK-NEXT:    [[R33:%.*]] = call i8 @llvm.uadd.sat.i8(i8 [[A33]], i8 [[B33]])
; CHECK-NEXT:    [[R34:%.*]] = call i8 @llvm.uadd.sat.i8(i8 [[A34]], i8 [[B34]])
; CHECK-NEXT:    [[R35:%.*]] = call i8 @llvm.uadd.sat.i8(i8 [[A35]], i8 [[B35]])
; CHECK-NEXT:    [[R36:%.*]] = call i8 @llvm.uadd.sat.i8(i8 [[A36]], i8 [[B36]])
; CHECK-NEXT:    [[R37:%.*]] = call i8 @llvm.uadd.sat.i8(i8 [[A37]], i8 [[B37]])
; CHECK-NEXT:    [[R38:%.*]] = call i8 @llvm.uadd.sat.i8(i8 [[A38]], i8 [[B38]])
; CHECK-NEXT:    [[R39:%.*]] = call i8 @llvm.uadd.sat.i8(i8 [[A39]], i8 [[B39]])
; CHECK-NEXT:    [[R40:%.*]] = call i8 @llvm.uadd.sat.i8(i8 [[A40]], i8 [[B40]])
; CHECK-NEXT:    [[R41:%.*]] = call i8 @llvm.uadd.sat.i8(i8 [[A41]], i8 [[B41]])
; CHECK-NEXT:    [[R42:%.*]] = call i8 @llvm.uadd.sat.i8(i8 [[A42]], i8 [[B42]])
; CHECK-NEXT:    [[R43:%.*]] = call i8 @llvm.uadd.sat.i8(i8 [[A43]], i8 [[B43]])
; CHECK-NEXT:    [[R44:%.*]] = call i8 @llvm.uadd.sat.i8(i8 [[A44]], i8 [[B44]])
; CHECK-NEXT:    [[R45:%.*]] = call i8 @llvm.uadd.sat.i8(i8 [[A45]], i8 [[B45]])
; CHECK-NEXT:    [[R46:%.*]] = call i8 @llvm.uadd.sat.i8(i8 [[A46]], i8 [[B46]])
; CHECK-NEXT:    [[R47:%.*]] = call i8 @llvm.uadd.sat.i8(i8 [[A47]], i8 [[B47]])
; CHECK-NEXT:    [[R48:%.*]] = call i8 @llvm.uadd.sat.i8(i8 [[A48]], i8 [[B48]])
; CHECK-NEXT:    [[R49:%.*]] = call i8 @llvm.uadd.sat.i8(i8 [[A49]], i8 [[B49]])
; CHECK-NEXT:    [[R50:%.*]] = call i8 @llvm.uadd.sat.i8(i8 [[A50]], i8 [[B50]])
; CHECK-NEXT:    [[R51:%.*]] = call i8 @llvm.uadd.sat.i8(i8 [[A51]], i8 [[B51]])
; CHECK-NEXT:    [[R52:%.*]] = call i8 @llvm.uadd.sat.i8(i8 [[A52]], i8 [[B52]])
; CHECK-NEXT:    [[R53:%.*]] = call i8 @llvm.uadd.sat.i8(i8 [[A53]], i8 [[B53]])
; CHECK-NEXT:    [[R54:%.*]] = call i8 @llvm.uadd.sat.i8(i8 [[A54]], i8 [[B54]])
; CHECK-NEXT:    [[R55:%.*]] = call i8 @llvm.uadd.sat.i8(i8 [[A55]], i8 [[B55]])
; CHECK-NEXT:    [[R56:%.*]] = call i8 @llvm.uadd.sat.i8(i8 [[A56]], i8 [[B56]])
; CHECK-NEXT:    [[R57:%.*]] = call i8 @llvm.uadd.sat.i8(i8 [[A57]], i8 [[B57]])
; CHECK-NEXT:    [[R58:%.*]] = call i8 @llvm.uadd.sat.i8(i8 [[A58]], i8 [[B58]])
; CHECK-NEXT:    [[R59:%.*]] = call i8 @llvm.uadd.sat.i8(i8 [[A59]], i8 [[B59]])
; CHECK-NEXT:    [[R60:%.*]] = call i8 @llvm.uadd.sat.i8(i8 [[A60]], i8 [[B60]])
; CHECK-NEXT:    [[R61:%.*]] = call i8 @llvm.uadd.sat.i8(i8 [[A61]], i8 [[B61]])
; CHECK-NEXT:    [[R62:%.*]] = call i8 @llvm.uadd.sat.i8(i8 [[A62]], i8 [[B62]])
; CHECK-NEXT:    [[R63:%.*]] = call i8 @llvm.uadd.sat.i8(i8 [[A63]], i8 [[B63]])
