...
; CHECK-NEXT:    [[RES:%.*]] = call i1 @llvm.vector.reduce.smin.v8i1(<8 x i1> [[X:%.*]])
...
; CHECK-NEXT:    [[RES:%.*]] = call i32 @llvm.vector.reduce.smin.v4i32(<4 x i32> [[SEXT]])
...
; CHECK-NEXT:    [[RES:%.*]] = call i64 @llvm.vector.reduce.smin.v8i64(<8 x i64> [[ZEXT]])
...
; CHECK-NEXT:    [[RES:%.*]] = call i16 @llvm.vector.reduce.smin.v16i16(<16 x i16> [[SEXT]])
...
; CHECK-NEXT:    [[RES:%.*]] = call i8 @llvm.vector.reduce.smin.v128i8(<128 x i8> [[SEXT]])
