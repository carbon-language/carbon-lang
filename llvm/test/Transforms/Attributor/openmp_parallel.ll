...
; IS__TUNIT_NPM-NEXT:    ret void
;
; IS__CGSCC____: Function Attrs: alwaysinline nofree norecurse nounwind uwtable
; IS__CGSCC____-LABEL: define {{[^@]+}}@.omp_outlined.
...
; IS__CGSCC____-NEXT:  entry:
; IS__CGSCC____-NEXT:    [[DOTOMP_LB:%.*]] = alloca i32, align 4
; IS__CGSCC____-NEXT:    [[DOTOMP_UB:%.*]] = alloca i32, align 4
; IS__CGSCC____-NEXT:    [[DOTOMP_STRIDE:%.*]] = alloca i32, align 4
; IS__CGSCC____-NEXT:    [[DOTOMP_IS_LAST:%.*]] = alloca i32, align 4
; IS__CGSCC____-NEXT:    [[TMP0:%.*]] = load i32, i32* [[N]], align 4
; IS__CGSCC____-NEXT:    [[SUB2:%.*]] = add nsw i32 [[TMP0]], -2
; IS__CGSCC____-NEXT:    [[CMP:%.*]] = icmp sgt i32 [[TMP0]], 1
; IS__CGSCC____-NEXT:    br i1 [[CMP]], label [[OMP_PRECOND_THEN:%.*]], label [[OMP_PRECOND_END:%.*]]
; IS__CGSCC____:       omp.precond.then:
; IS__CGSCC____-NEXT:    [[TMP1:%.*]] = bitcast i32* [[DOTOMP_LB]] to i8*
; IS__CGSCC____-NEXT:    call void @llvm.lifetime.start.p0i8(i64 noundef 4, i8* nocapture nofree noundef nonnull align 4 dereferenceable(4) [[TMP1]])
; IS__CGSCC____-NEXT:    store i32 0, i32* [[DOTOMP_LB]], align 4
; IS__CGSCC____-NEXT:    [[TMP2:%.*]] = bitcast i32* [[DOTOMP_UB]] to i8*
; IS__CGSCC____-NEXT:    call void @llvm.lifetime.start.p0i8(i64 noundef 4, i8* nocapture nofree noundef nonnull align 4 dereferenceable(4) [[TMP2]])
; IS__CGSCC____-NEXT:    store i32 [[SUB2]], i32* [[DOTOMP_UB]], align 4
; IS__CGSCC____-NEXT:    [[TMP3:%.*]] = bitcast i32* [[DOTOMP_STRIDE]] to i8*
; IS__CGSCC____-NEXT:    call void @llvm.lifetime.start.p0i8(i64 noundef 4, i8* nocapture nofree noundef nonnull align 4 dereferenceable(4) [[TMP3]])
; IS__CGSCC____-NEXT:    store i32 1, i32* [[DOTOMP_STRIDE]], align 4
; IS__CGSCC____-NEXT:    [[TMP4:%.*]] = bitcast i32* [[DOTOMP_IS_LAST]] to i8*
; IS__CGSCC____-NEXT:    call void @llvm.lifetime.start.p0i8(i64 noundef 4, i8* nocapture nofree noundef nonnull align 4 dereferenceable(4) [[TMP4]])
; IS__CGSCC____-NEXT:    store i32 0, i32* [[DOTOMP_IS_LAST]], align 4
; IS__CGSCC____-NEXT:    [[TMP5:%.*]] = load i32, i32* [[DOTGLOBAL_TID_]], align 4
; IS__CGSCC____-NEXT:    call void @__kmpc_for_static_init_4(%struct.ident_t* noundef nonnull align 8 dereferenceable(24) @[[GLOB1]], i32 [[TMP5]], i32 noundef 34, i32* noundef nonnull align 4 dereferenceable(4) [[DOTOMP_IS_LAST]], i32* noundef nonnull align 4 dereferenceable(4) [[DOTOMP_LB]], i32* noundef nonnull align 4 dereferenceable(4) [[DOTOMP_UB]], i32* noundef nonnull align 4 dereferenceable(4) [[DOTOMP_STRIDE]], i32 noundef 1, i32 noundef 1)
; IS__CGSCC____-NEXT:    [[TMP6:%.*]] = load i32, i32* [[DOTOMP_UB]], align 4
; IS__CGSCC____-NEXT:    [[CMP4:%.*]] = icmp sgt i32 [[TMP6]], [[SUB2]]
; IS__CGSCC____-NEXT:    [[COND:%.*]] = select i1 [[CMP4]], i32 [[SUB2]], i32 [[TMP6]]
; IS__CGSCC____-NEXT:    store i32 [[COND]], i32* [[DOTOMP_UB]], align 4
; IS__CGSCC____-NEXT:    [[TMP7:%.*]] = load i32, i32* [[DOTOMP_LB]], align 4
; IS__CGSCC____-NEXT:    [[CMP513:%.*]] = icmp sgt i32 [[TMP7]], [[COND]]
; IS__CGSCC____-NEXT:    br i1 [[CMP513]], label [[OMP_LOOP_EXIT:%.*]], label [[OMP_INNER_FOR_BODY_LR_PH:%.*]]
; IS__CGSCC____:       omp.inner.for.body.lr.ph:
; IS__CGSCC____-NEXT:    [[TMP8:%.*]] = load float*, float** [[B]], align 8
; IS__CGSCC____-NEXT:    [[TMP9:%.*]] = load float*, float** [[A]], align 8
; IS__CGSCC____-NEXT:    [[TMP10:%.*]] = sext i32 [[TMP7]] to i64
; IS__CGSCC____-NEXT:    [[TMP11:%.*]] = sext i32 [[COND]] to i64
; IS__CGSCC____-NEXT:    br label [[OMP_INNER_FOR_BODY:%.*]]
; IS__CGSCC____:       omp.inner.for.body:
; IS__CGSCC____-NEXT:    [[INDVARS_IV:%.*]] = phi i64 [ [[INDVARS_IV_NEXT:%.*]], [[OMP_INNER_FOR_BODY]] ], [ [[TMP10]], [[OMP_INNER_FOR_BODY_LR_PH]] ]
; IS__CGSCC____-NEXT:    [[INDVARS_IV_NEXT]] = add nsw i64 [[INDVARS_IV]], 1
; IS__CGSCC____-NEXT:    [[ARRAYIDX:%.*]] = getelementptr inbounds float, float* [[TMP8]], i64 [[INDVARS_IV_NEXT]]
; IS__CGSCC____-NEXT:    [[TMP12:%.*]] = load float, float* [[ARRAYIDX]], align 4
; IS__CGSCC____-NEXT:    [[CONV7:%.*]] = fadd float [[TMP12]], 1.000000e+00
; IS__CGSCC____-NEXT:    [[ARRAYIDX9:%.*]] = getelementptr inbounds float, float* [[TMP9]], i64 [[INDVARS_IV_NEXT]]
; IS__CGSCC____-NEXT:    store float [[CONV7]], float* [[ARRAYIDX9]], align 4
; IS__CGSCC____-NEXT:    [[CMP5:%.*]] = icmp slt i64 [[INDVARS_IV]], [[TMP11]]
; IS__CGSCC____-NEXT:    br i1 [[CMP5]], label [[OMP_INNER_FOR_BODY]], label [[OMP_LOOP_EXIT]]
; IS__CGSCC____:       omp.loop.exit:
; IS__CGSCC____-NEXT:    call void @__kmpc_for_static_fini(%struct.ident_t* noundef nonnull align 8 dereferenceable(24) @[[GLOB1]], i32 [[TMP5]])
; IS__CGSCC____-NEXT:    call void @llvm.lifetime.end.p0i8(i64 noundef 4, i8* nocapture nofree noundef nonnull align 4 dereferenceable(4) [[TMP4]])
; IS__CGSCC____-NEXT:    call void @llvm.lifetime.end.p0i8(i64 noundef 4, i8* nocapture nofree noundef nonnull align 4 dereferenceable(4) [[TMP3]])
; IS__CGSCC____-NEXT:    call void @llvm.lifetime.end.p0i8(i64 noundef 4, i8* nocapture nofree noundef nonnull align 4 dereferenceable(4) [[TMP2]])
; IS__CGSCC____-NEXT:    call void @llvm.lifetime.end.p0i8(i64 noundef 4, i8* nocapture nofree noundef nonnull align 4 dereferenceable(4) [[TMP1]])
; IS__CGSCC____-NEXT:    br label [[OMP_PRECOND_END]]
; IS__CGSCC____:       omp.precond.end:
; IS__CGSCC____-NEXT:    ret void
;
entry:
