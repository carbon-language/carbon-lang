...
; NOT_TUNIT_NPM-NEXT:    [[LEFT:%.*]] = alloca [3 x i32], align 4
; NOT_TUNIT_NPM-NEXT:    [[ARRAYDECAY:%.*]] = getelementptr inbounds [3 x i32], [3 x i32]* [[LEFT]], i64 0, i64 0
; NOT_TUNIT_NPM-NEXT:    call void @callee(i32* noalias nocapture noundef nonnull readonly align 4 dereferenceable(12) [[ARRAYDECAY]])
...
; NOT_TUNIT_NPM-LABEL: define {{[^@]+}}@callee
; NOT_TUNIT_NPM-SAME: (i32* noalias nocapture noundef nonnull readonly align 4 dereferenceable(12) [[ARG:%.*]]) {
; NOT_TUNIT_NPM-NEXT:  entry:
; NOT_TUNIT_NPM-NEXT:    call void @use(i32* noalias nocapture noundef nonnull readonly align 4 dereferenceable(12) [[ARG]])
; NOT_TUNIT_NPM-NEXT:    ret void
;
