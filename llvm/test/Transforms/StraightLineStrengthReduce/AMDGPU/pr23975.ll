...
attributes #0 = { nounwind "disable-tail-calls"="false" "frame-pointer"="none" "no-realign-stack" "stack-protector-buffer-size"="8" "target-cpu"="tahiti" "use-soft-float"="false" }
