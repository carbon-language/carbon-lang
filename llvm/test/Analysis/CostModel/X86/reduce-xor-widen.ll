...
; SSE2-NEXT:  Cost Model: Found an estimated cost of 16 for instruction: %V4 = call i16 @llvm.experimental.vector.reduce.xor.i16.v4i16(<4 x i16> undef)
...
; SSE2-NEXT:  Cost Model: Found an estimated cost of 41 for instruction: %V8 = call i8 @llvm.experimental.vector.reduce.xor.i8.v8i8(<8 x i8> undef)
