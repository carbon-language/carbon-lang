...
; AVX1-NEXT:  Cost Model: Found an estimated cost of 28 for instruction: %v16f32s16 = call <16 x i16> @llvm.fptosi.sat.v16i16.v16f32(<16 x float> undef)
...
; AVX1-NEXT:  Cost Model: Found an estimated cost of 54 for instruction: %v16f64s16 = call <16 x i16> @llvm.fptosi.sat.v16i16.v16f64(<16 x double> undef)
...
; AVX1-NEXT:  Cost Model: Found an estimated cost of 150 for instruction: %v16f16s16 = call <16 x i16> @llvm.fptosi.sat.v16i16.v16f16(<16 x half> undef)
