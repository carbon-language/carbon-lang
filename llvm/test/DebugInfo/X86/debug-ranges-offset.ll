...
attributes #0 = { sanitize_memory uwtable "frame-pointer"="none" "stack-protector-buffer-size"="8" "use-soft-float"="false" }
attributes #1 = { nobuiltin "frame-pointer"="none" "stack-protector-buffer-size"="8" "use-soft-float"="false" }
