...
attributes #1 = { inlinehint uwtable "frame-pointer"="all" "stack-protector-buffer-size"="8" "use-soft-float"="false" }
attributes #2 = { nounwind }
attributes #3 = { nounwind readnone }
attributes #4 = { "frame-pointer"="all" "stack-protector-buffer-size"="8" "use-soft-float"="false" }
