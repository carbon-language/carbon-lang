...
# CHECK-NEXT: [0,1]     D=eER..   pxor	%xmm0, %xmm1
# CHECK-NEXT: [1,0]     D==eER.   psubusb	%xmm1, %xmm1
# CHECK-NEXT: [1,1]     D===eER   pxor	%xmm0, %xmm1
...
# CHECK:            [0]    [1]    [2]    [3]
# CHECK-NEXT: 0.     2     2.0    0.5    0.0       psubusb	%xmm1, %xmm1
...
# CHECK-NEXT: [0,1]     D=eER..   pxor	%xmm0, %xmm1
# CHECK-NEXT: [1,0]     D==eER.   psubusw	%xmm1, %xmm1
# CHECK-NEXT: [1,1]     D===eER   pxor	%xmm0, %xmm1
...
# CHECK:            [0]    [1]    [2]    [3]
# CHECK-NEXT: 0.     2     2.0    0.5    0.0       psubusw	%xmm1, %xmm1
# CHECK-NEXT: 1.     2     3.0    0.0    0.0       pxor	%xmm0, %xmm1
# CHECK-NEXT:        2     2.5    0.3    0.0       <total>
