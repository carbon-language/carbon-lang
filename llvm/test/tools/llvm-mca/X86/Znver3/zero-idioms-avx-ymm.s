...
# CHECK-NEXT:  1      1     0.25                        vxorps	%ymm0, %ymm0, %ymm0
...
# CHECK-NEXT:  -      -      -      -      -      -      -      -      -     0.50    -     0.50    -      -      -      -      -      -      -      -      -      -      -     vxorps	%ymm0, %ymm0, %ymm0
# CHECK-NEXT:  -      -      -      -      -      -      -      -     0.50    -     0.50    -      -      -      -      -      -      -      -      -      -      -      -     vxorps	%ymm1, %ymm0, %ymm0

# CHECK:      Timeline view:
# CHECK-NEXT: Index     0123456

# CHECK:      [0,0]     DeER ..   vxorps	%ymm0, %ymm0, %ymm0
# CHECK-NEXT: [0,1]     D=eER..   vxorps	%ymm1, %ymm0, %ymm0
# CHECK-NEXT: [1,0]     D==eER.   vxorps	%ymm0, %ymm0, %ymm0
...
# CHECK:            [0]    [1]    [2]    [3]
# CHECK-NEXT: 0.     2     2.0    0.5    0.0       vxorps	%ymm0, %ymm0, %ymm0
# CHECK-NEXT: 1.     2     3.0    0.0    0.0       vxorps	%ymm1, %ymm0, %ymm0
