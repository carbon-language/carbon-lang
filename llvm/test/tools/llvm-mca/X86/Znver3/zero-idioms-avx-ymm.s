...
# CHECK-NEXT: [1,0]     D==eER.   vpsubsb	%ymm0, %ymm0, %ymm0
...
# CHECK:            [0]    [1]    [2]    [3]
# CHECK-NEXT: 0.     2     2.0    0.5    0.0       vpsubsb	%ymm0, %ymm0, %ymm0
...
# CHECK-NEXT: [0,1]     D=eER..   vpxor	%ymm1, %ymm0, %ymm0
# CHECK-NEXT: [1,0]     D==eER.   vpsubsw	%ymm0, %ymm0, %ymm0
# CHECK-NEXT: [1,1]     D===eER   vpxor	%ymm1, %ymm0, %ymm0
...
# CHECK:            [0]    [1]    [2]    [3]
# CHECK-NEXT: 0.     2     2.0    0.5    0.0       vpsubsw	%ymm0, %ymm0, %ymm0
# CHECK-NEXT: 1.     2     3.0    0.0    0.0       vpxor	%ymm1, %ymm0, %ymm0
# CHECK-NEXT:        2     2.5    0.3    0.0       <total>
