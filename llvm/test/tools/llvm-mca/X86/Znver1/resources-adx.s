...
# CHECK-NEXT:  2      5     0.50    *                   adcxl	(%rbx), %ecx
# CHECK-NEXT:  1      1     0.25                        adcxq	%rbx, %rcx
# CHECK-NEXT:  2      5     0.50    *                   adcxq	(%rbx), %rcx
# CHECK-NEXT:  1      1     0.25                        adoxl	%ebx, %ecx
# CHECK-NEXT:  2      5     0.50    *                   adoxl	(%rbx), %ecx
# CHECK-NEXT:  1      1     0.25                        adoxq	%rbx, %rcx
# CHECK-NEXT:  2      5     0.50    *                   adoxq	(%rbx), %rcx
...
# CHECK-NEXT: 0.50   0.50   0.25   0.25   0.25   0.25    -      -      -      -      -      -     adcxl	(%rbx), %ecx
# CHECK-NEXT:  -      -     0.25   0.25   0.25   0.25    -      -      -      -      -      -     adcxq	%rbx, %rcx
# CHECK-NEXT: 0.50   0.50   0.25   0.25   0.25   0.25    -      -      -      -      -      -     adcxq	(%rbx), %rcx
