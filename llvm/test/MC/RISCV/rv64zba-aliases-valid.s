...
# CHECK-S-OBJ-NOALIAS: lui t1, 427
# CHECK-S-OBJ-NOALIAS-NEXT: addiw t1, t1, -1367
# CHECK-S-OBJ-NOALIAS-NEXT: slli t1, t1, 12
# CHECK-S-OBJ-NOALIAS-NEXT: addi t1, t1, 1
# CHECK-S-OBJ: lui t1, 427
# CHECK-S-OBJ-NEXT: addiw t1, t1, -1367
# CHECK-S-OBJ-NEXT: slli t1, t1, 12
# CHECK-S-OBJ-NEXT: addi t1, t1, 1
li x6, 7158272001 # 0x0000_0001_aaaa_9001

# CHECK-S-OBJ-NOALIAS: lui t1, 768
# CHECK-S-OBJ-NOALIAS-NEXT: addiw t1, t1, -3
# CHECK-S-OBJ-NOALIAS-NEXT: slli t1, t1, 12
# CHECK-S-OBJ-NOALIAS-NEXT: addi t1, t1, 1
# CHECK-S-OBJ: lui t1, 768
# CHECK-S-OBJ-NEXT: addiw t1, t1, -3
# CHECK-S-OBJ-NEXT: slli t1, t1, 12
# CHECK-S-OBJ-NEXT: addi t1, t1, 1
li x6, 12884889601 # 0x0000_0002_ffff_d001

# CHECK-S-OBJ-NOALIAS: lui t1, 1048371
# CHECK-S-OBJ-NOALIAS-NEXT: addiw t1, t1, 817
# CHECK-S-OBJ-NOALIAS-NEXT: slli t1, t1, 12
# CHECK-S-OBJ-NOALIAS-NEXT: addi t1, t1, 1
# CHECK-S-OBJ: lui t1, 1048371
# CHECK-S-OBJ-NEXT: addiw t1, t1, 817
# CHECK-S-OBJ-NEXT: slli t1, t1, 12
# CHECK-S-OBJ-NEXT: addi t1, t1, 1
li x6, -3435982847 # 0xffff_ffff_3333_1001

# CHECK-S-OBJ-NOALIAS: lui t1, 1048235
# CHECK-S-OBJ-NOALIAS-NEXT: addiw t1, t1, -1419
# CHECK-S-OBJ-NOALIAS-NEXT: slli t1, t1, 12
# CHECK-S-OBJ-NOALIAS-NEXT: addi t1, t1, 1
# CHECK-S-OBJ: lui t1, 1048235
# CHECK-S-OBJ-NEXT: addiw t1, t1, -1419
# CHECK-S-OBJ-NEXT: slli t1, t1, 12
# CHECK-S-OBJ-NEXT: addi t1, t1, 1
li x6, -5726842879 # 0xffff_fffe_aaa7_5001

# CHECK-S-OBJ-NOALIAS: lui t1, 1047962
# CHECK-S-OBJ-NOALIAS-NEXT: addiw t1, t1, -1645
# CHECK-S-OBJ-NOALIAS-NEXT: slli t1, t1, 12
# CHECK-S-OBJ-NOALIAS-NEXT: addi t1, t1, 1
# CHECK-S-OBJ: lui t1, 1047962
# CHECK-S-OBJ-NEXT: addiw t1, t1, -1645
# CHECK-S-OBJ-NEXT: slli t1, t1, 12
# CHECK-S-OBJ-NEXT: addi t1, t1, 1
