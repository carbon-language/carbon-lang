...
; GFX9-NEXT:    v_mul_f32_e32 v0, 0x4f7ffffe, v0
; GFX9-NEXT:    v_cvt_u32_f32_e32 v0, v0
; GFX9-NEXT:    v_mul_lo_u32 v1, s2, v0
; GFX9-NEXT:    s_load_dwordx4 s[0:3], s[4:5], 0x0
; GFX9-NEXT:    v_mul_hi_u32 v1, v0, v1
; GFX9-NEXT:    v_add_u32_e32 v0, v0, v1
...
; GFX8-NEXT:    s_and_b32 s1, s0, s2
; GFX8-NEXT:    s_sub_i32 s9, 0, s8
; GFX8-NEXT:    v_mul_lo_u32 v3, s9, v1
; GFX8-NEXT:    v_mul_hi_u32 v2, v0, v2
; GFX8-NEXT:    s_lshr_b32 s0, s0, 8
; GFX8-NEXT:    s_and_b32 s9, s0, s2
; GFX8-NEXT:    v_add_u32_e32 v0, vcc, v0, v2
; GFX8-NEXT:    v_mul_hi_u32 v0, s1, v0
; GFX8-NEXT:    v_mul_hi_u32 v2, v1, v3
...
; GFX8-NEXT:    v_cndmask_b32_e32 v3, v3, v4, vcc
; GFX8-NEXT:    v_add_u32_e32 v4, vcc, 1, v1
; GFX8-NEXT:    v_sub_u32_e32 v2, vcc, s9, v2
...
; GFX8-NEXT:    v_or_b32_sdwa v2, v3, v0 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:BYTE_0 src1_sel:DWORD
; GFX8-NEXT:    v_mov_b32_e32 v0, s6
; GFX8-NEXT:    v_mov_b32_e32 v1, s7
...
; GFX9-NEXT:    s_sub_i32 s1, 0, s8
; GFX9-NEXT:    v_mul_lo_u32 v3, s1, v1
; GFX9-NEXT:    s_and_b32 s9, s0, s6
; GFX9-NEXT:    v_mul_hi_u32 v2, v0, v2
; GFX9-NEXT:    s_lshr_b32 s1, s0, 8
; GFX9-NEXT:    v_mul_hi_u32 v3, v1, v3
; GFX9-NEXT:    s_and_b32 s10, s1, s6
; GFX9-NEXT:    v_add_u32_e32 v0, v0, v2
; GFX9-NEXT:    v_mul_hi_u32 v0, s9, v0
; GFX9-NEXT:    v_add_u32_e32 v1, v1, v3
; GFX9-NEXT:    v_mul_hi_u32 v1, s10, v1
; GFX9-NEXT:    s_load_dwordx4 s[0:3], s[4:5], 0x0
...
; GFX9-NEXT:    v_cndmask_b32_e32 v0, v0, v4, vcc
; GFX9-NEXT:    v_subrev_u32_e32 v4, s7, v2
; GFX9-NEXT:    v_sub_u32_e32 v3, s10, v3
; GFX9-NEXT:    v_cndmask_b32_e32 v2, v2, v4, vcc
; GFX9-NEXT:    v_add_u32_e32 v4, 1, v1
...
; GFX10-NEXT:    v_cmp_le_u32_e32 vcc_lo, s3, v2
; GFX10-NEXT:    v_subrev_nc_u32_e32 v5, s3, v2
...
; GFX10-NEXT:    v_subrev_nc_u32_e32 v4, s3, v2
; GFX10-NEXT:    v_add_nc_u32_e32 v6, 1, v1
