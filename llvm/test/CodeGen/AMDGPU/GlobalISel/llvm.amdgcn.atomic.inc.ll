...
; RUN: llc -global-isel -march=amdgcn -mcpu=bonaire -verify-machineinstrs < %s | FileCheck -enable-var-scope -check-prefixes=GCN,CI %s
; RUN: llc -global-isel -march=amdgcn -mcpu=tonga -mattr=-flat-for-global -verify-machineinstrs < %s | FileCheck -enable-var-scope -check-prefixes=GCN,VI %s
...
; CI-NEXT:    v_add_i32_e32 v1, vcc, s2, v4
; CI-NEXT:    v_addc_u32_e32 v2, vcc, v0, v3, vcc
...
; VI-NEXT:    v_add_u32_e32 v1, vcc, s2, v4
; VI-NEXT:    v_addc_u32_e32 v2, vcc, v0, v3, vcc
...
; GFX9-NEXT:    ds_inc_rtn_u32 v2, v0, v2
; GFX9-NEXT:    s_waitcnt lgkmcnt(0)
; GFX9-NEXT:    v_mov_b32_e32 v0, s2
; GFX9-NEXT:    v_mov_b32_e32 v1, s3
; GFX9-NEXT:    global_store_dword v[0:1], v3, off
...
; CI-NEXT:    v_add_i32_e32 v1, vcc, s2, v4
; CI-NEXT:    v_addc_u32_e32 v2, vcc, v0, v3, vcc
; CI-NEXT:    v_add_i32_e32 v0, vcc, 40, v1
; CI-NEXT:    v_addc_u32_e32 v1, vcc, 0, v2, vcc
; CI-NEXT:    v_mov_b32_e32 v5, s1
; CI-NEXT:    v_add_i32_e32 v2, vcc, s0, v4
; CI-NEXT:    v_addc_u32_e32 v3, vcc, v5, v3, vcc
...
; CI-NEXT:    flat_atomic_inc_x2 v[0:1], v[0:1], v[4:5] glc
; CI-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; CI-NEXT:    flat_store_dwordx2 v[2:3], v[0:1]
; CI-NEXT:    s_endpgm
;
...
; VI-NEXT:    v_add_u32_e32 v1, vcc, s2, v4
; VI-NEXT:    v_addc_u32_e32 v2, vcc, v0, v3, vcc
; VI-NEXT:    v_add_u32_e32 v0, vcc, 40, v1
; VI-NEXT:    v_addc_u32_e32 v1, vcc, 0, v2, vcc
; VI-NEXT:    v_mov_b32_e32 v5, s1
; VI-NEXT:    v_add_u32_e32 v2, vcc, s0, v4
; VI-NEXT:    v_addc_u32_e32 v3, vcc, v5, v3, vcc
...
; VI-NEXT:    flat_atomic_inc_x2 v[0:1], v[0:1], v[4:5] glc
; VI-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; VI-NEXT:    flat_store_dwordx2 v[2:3], v[0:1]
; VI-NEXT:    s_endpgm
;
...
; GFX9-NEXT:    ds_inc_rtn_u64 v[0:1], v0, v[1:2]
; GFX9-NEXT:    s_waitcnt lgkmcnt(0)
; GFX9-NEXT:    v_mov_b32_e32 v2, s2
; GFX9-NEXT:    v_mov_b32_e32 v3, s3
