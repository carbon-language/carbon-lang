...
; VI:       ; %bb.0:
; VI-NEXT:    s_load_dword s12, s[4:5], 0x60
; VI-NEXT:    s_load_dwordx2 s[0:1], s[4:5], 0x0
...
; VI-NEXT:    s_cselect_b64 s[4:5], s[8:9], s[4:5]
; VI-NEXT:    s_mov_b32 s2, -1
; VI-NEXT:    v_mov_b32_e32 v0, s4
; VI-NEXT:    v_mov_b32_e32 v1, s5
; VI-NEXT:    v_mov_b32_e32 v2, s6
...
; VI-NEXT:    s_cselect_b64 s[4:5], s[10:11], 5
; VI-NEXT:    s_cmp_lg_u32 s6, 0
; VI-NEXT:    s_cselect_b64 s[6:7], s[8:9], 5
; VI-NEXT:    v_mov_b32_e32 v0, s6
; VI-NEXT:    v_mov_b32_e32 v1, s7
...
; VI-NEXT:    s_cselect_b64 s[6:7], s[6:7], 5
; VI-NEXT:    v_mov_b32_e32 v0, s6
; VI-NEXT:    v_mov_b32_e32 v1, s7
