...
; LMULMAX2-NEXT:    vsetivli a0, 2, e32,mf2,ta,mu
...
; LMULMAX2-NEXT:    vsetvli a2, a2, e8,m2,ta,mu
; LMULMAX2-NEXT:    vle1.v v25, (a0)
; LMULMAX2-NEXT:    vsetivli a0, 1, e8,mf4,ta,mu
...
; LMULMAX1-NEXT:    vsetivli a2, 16, e8,m1,ta,mu
; LMULMAX1-NEXT:    vle1.v v25, (a0)
; LMULMAX1-NEXT:    vsetivli a0, 1, e8,mf8,ta,mu
...
; LMULMAX1-NEXT:    vsetivli a0, 2, e8,mf2,tu,mu
