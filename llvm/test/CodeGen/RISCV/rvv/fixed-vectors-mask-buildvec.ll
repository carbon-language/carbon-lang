...
; CHECK-RV32-NEXT:    vsetivli a1, 1, e16,mf4,ta,mu
...
; CHECK-RV64-NEXT:    vsetivli a1, 1, e16,mf4,ta,mu
...
; RV32-LMULMAX1-NEXT:    vsetivli a1, 1, e16,mf4,ta,mu
...
; RV64-LMULMAX1-NEXT:    vsetivli a1, 1, e16,mf4,ta,mu
...
; RV32-LMULMAX2-NEXT:    vsetivli a1, 1, e32,mf2,ta,mu
...
; RV64-LMULMAX2-NEXT:    vsetivli a1, 1, e32,mf2,ta,mu
...
; RV32-LMULMAX4-NEXT:    vsetivli a1, 1, e32,mf2,ta,mu
...
; RV64-LMULMAX4-NEXT:    vsetivli a1, 1, e32,mf2,ta,mu
...
; RV32-LMULMAX8-NEXT:    vsetivli a1, 1, e32,mf2,ta,mu
...
; RV64-LMULMAX8-NEXT:    vsetivli a1, 1, e32,mf2,ta,mu
...
; RV32-LMULMAX4-NEXT:    vsetivli a1, 2, e32,mf2,ta,mu
; RV32-LMULMAX4-NEXT:    vmv.s.x v25, a0
; RV32-LMULMAX4-NEXT:    lui a0, 748384
; RV32-LMULMAX4-NEXT:    addi a0, a0, 1776
; RV32-LMULMAX4-NEXT:    vmv.s.x v0, a0
; RV32-LMULMAX4-NEXT:    vsetivli a0, 2, e32,mf2,tu,mu
...
; RV32-LMULMAX8-NEXT:    vsetivli a1, 2, e32,mf2,ta,mu
; RV32-LMULMAX8-NEXT:    vmv.s.x v25, a0
; RV32-LMULMAX8-NEXT:    lui a0, 748384
; RV32-LMULMAX8-NEXT:    addi a0, a0, 1776
; RV32-LMULMAX8-NEXT:    vmv.s.x v0, a0
; RV32-LMULMAX8-NEXT:    vsetivli a0, 2, e32,mf2,tu,mu
