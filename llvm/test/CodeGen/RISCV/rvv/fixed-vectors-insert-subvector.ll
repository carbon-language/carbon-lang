...
; CHECK-NEXT:    vsetivli a2, 2, e16,mf4,ta,mu
; CHECK-NEXT:    vle16.v v26, (a1)
; CHECK-NEXT:    vsetivli a1, 4, e16,mf2,tu,mu
...
; LMULMAX2-NEXT:    vsetivli a3, 8, e8,mf2,ta,mu
; LMULMAX2-NEXT:    vle1.v v26, (a1)
; LMULMAX2-NEXT:    vsetivli a1, 1, e8,mf4,tu,mu
...
; LMULMAX1-NEXT:    vsetivli a1, 1, e8,mf8,tu,mu
...
; LMULMAX2-NEXT:    vsetivli a3, 8, e8,mf2,ta,mu
; LMULMAX2-NEXT:    vle1.v v26, (a1)
; LMULMAX2-NEXT:    vsetivli a1, 3, e8,mf4,tu,mu
...
; CHECK-NEXT:    vsetivli a1, 4, e8,mf2,tu,mu
; CHECK-NEXT:    vslideup.vi v25, v26, 0
; CHECK-NEXT:    vsetivli a1, 8, e8,mf2,ta,mu
...
; CHECK-NEXT:    vmv1r.v v0, v27
; CHECK-NEXT:    vmerge.vim v26, v26, 1, v0
; CHECK-NEXT:    vsetivli a1, 8, e8,mf2,tu,mu
