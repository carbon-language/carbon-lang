...
; CHECK-NEXT:    vsetivli a0, 1, e64,m1,tu,mu
...
; CHECK:       # %bb.0:
; CHECK-NEXT:    vsetivli a2, 2, e32,m2,ta,mu
; CHECK-NEXT:    vmv.v.i v26, 0
; CHECK-NEXT:    vslide1up.vx v28, v26, a1
; CHECK-NEXT:    vslide1up.vx v26, v28, a0
; CHECK-NEXT:    vsetivli a0, 1, e64,m2,tu,mu
...
; CHECK:       # %bb.0:
; CHECK-NEXT:    vsetivli a3, 2, e32,m2,ta,mu
; CHECK-NEXT:    vmv.v.i v26, 0
; CHECK-NEXT:    vslide1up.vx v28, v26, a1
; CHECK-NEXT:    vslide1up.vx v26, v28, a0
; CHECK-NEXT:    addi a0, a2, 1
...
; CHECK:       # %bb.0:
; CHECK-NEXT:    vsetivli a3, 2, e32,m4,ta,mu
; CHECK-NEXT:    vmv.v.i v28, 0
; CHECK-NEXT:    vslide1up.vx v12, v28, a1
; CHECK-NEXT:    vslide1up.vx v28, v12, a0
; CHECK-NEXT:    addi a0, a2, 1
...
; CHECK:       # %bb.0:
; CHECK-NEXT:    vsetivli a2, 2, e32,m8,ta,mu
; CHECK-NEXT:    vmv.v.i v16, 0
; CHECK-NEXT:    vslide1up.vx v24, v16, a1
; CHECK-NEXT:    vslide1up.vx v16, v24, a0
; CHECK-NEXT:    vsetivli a0, 1, e64,m8,tu,mu
...
; CHECK:       # %bb.0:
; CHECK-NEXT:    vsetivli a3, 2, e32,m8,ta,mu
; CHECK-NEXT:    vmv.v.i v16, 0
; CHECK-NEXT:    vslide1up.vx v24, v16, a1
; CHECK-NEXT:    vslide1up.vx v16, v24, a0
; CHECK-NEXT:    addi a0, a2, 1
