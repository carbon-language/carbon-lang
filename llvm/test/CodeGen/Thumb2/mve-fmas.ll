...
; CHECK-MVE-NEXT:    lsls r1, r1, #31
; CHECK-MVE-NEXT:    vmovx.f16 s18, s5
; CHECK-MVE-NEXT:    vseleq.f16 s16, s1, s16
...
; CHECK-MVE-NEXT:    vmla.f16 s16, s6, s10
; CHECK-MVE-NEXT:    lsls r1, r1, #31
; CHECK-MVE-NEXT:    vseleq.f16 s16, s2, s16
; CHECK-MVE-NEXT:    vcmp.f16 s18, #0
; CHECK-MVE-NEXT:    vmov r1, s16
; CHECK-MVE-NEXT:    vmrs APSR_nzcv, fpscr
...
; CHECK-MVE-NEXT:    lsls r1, r1, #31
; CHECK-MVE-NEXT:    vcmp.f16 s4, #0
; CHECK-MVE-NEXT:    vseleq.f16 s16, s3, s16
...
; CHECK-MVE-NEXT:    vmovx.f16 s8, s11
; CHECK-MVE-NEXT:    vmov.f32 s2, s0
; CHECK-MVE-NEXT:    lsls r0, r0, #31
; CHECK-MVE-NEXT:    vmla.f16 s2, s4, s8
; CHECK-MVE-NEXT:    vmov r1, s16
; CHECK-MVE-NEXT:    vseleq.f16 s0, s0, s2
...
; CHECK-MVE-NEXT:    vmov.f32 s2, s0
; CHECK-MVE-NEXT:    lsls r0, r0, #31
; CHECK-MVE-NEXT:    vmls.f16 s2, s4, s8
; CHECK-MVE-NEXT:    vmov r1, s16
; CHECK-MVE-NEXT:    vseleq.f16 s0, s0, s2
; CHECK-MVE-NEXT:    vmov.16 q3[6], r1
; CHECK-MVE-NEXT:    vmov r0, s0
...
; CHECK-MVE-NEXT:    lsls r2, r2, #31
; CHECK-MVE-NEXT:    vcmp.f16 s5, #0
; CHECK-MVE-NEXT:    vseleq.f16 s8, s10, s14
; CHECK-MVE-NEXT:    vmrs APSR_nzcv, fpscr
; CHECK-MVE-NEXT:    vmov r2, s8
; CHECK-MVE-NEXT:    vmov.16 q2[0], r1
; CHECK-MVE-NEXT:    mov.w r1, #0
; CHECK-MVE-NEXT:    vmov.f32 s14, s1
; CHECK-MVE-NEXT:    it mi
; CHECK-MVE-NEXT:    movmi r1, #1
...
; CHECK-MVE-NEXT:    vmla.f16 s14, s5, s12
; CHECK-MVE-NEXT:    lsls r1, r1, #31
; CHECK-MVE-NEXT:    vmov.16 q2[1], r2
; CHECK-MVE-NEXT:    vseleq.f16 s14, s1, s14
; CHECK-MVE-NEXT:    vmovx.f16 s13, s1
; CHECK-MVE-NEXT:    vmov r1, s14
; CHECK-MVE-NEXT:    vmovx.f16 s14, s5
; CHECK-MVE-NEXT:    vcmp.f16 s14, #0
; CHECK-MVE-NEXT:    vmov.16 q2[2], r1
; CHECK-MVE-NEXT:    vmrs APSR_nzcv, fpscr
; CHECK-MVE-NEXT:    mov.w r1, #0
; CHECK-MVE-NEXT:    it mi
; CHECK-MVE-NEXT:    movmi r1, #1
...
; CHECK-MVE-NEXT:    vmov r1, s14
; CHECK-MVE-NEXT:    vmrs APSR_nzcv, fpscr
; CHECK-MVE-NEXT:    vmov.16 q2[3], r1
; CHECK-MVE-NEXT:    mov.w r1, #0
; CHECK-MVE-NEXT:    it mi
; CHECK-MVE-NEXT:    movmi r1, #1
; CHECK-MVE-NEXT:    cmp r1, #0
...
; CHECK-MVE-NEXT:    vmla.f16 s14, s6, s12
; CHECK-MVE-NEXT:    lsls r1, r1, #31
; CHECK-MVE-NEXT:    vseleq.f16 s14, s2, s14
; CHECK-MVE-NEXT:    vmovx.f16 s13, s2
; CHECK-MVE-NEXT:    vmov r1, s14
; CHECK-MVE-NEXT:    vmovx.f16 s14, s6
; CHECK-MVE-NEXT:    vcmp.f16 s14, #0
; CHECK-MVE-NEXT:    vmov.16 q2[4], r1
; CHECK-MVE-NEXT:    vmrs APSR_nzcv, fpscr
; CHECK-MVE-NEXT:    mov.w r1, #0
; CHECK-MVE-NEXT:    it mi
; CHECK-MVE-NEXT:    movmi r1, #1
...
; CHECK-MVE-NEXT:    vmov r1, s14
; CHECK-MVE-NEXT:    vmrs APSR_nzcv, fpscr
; CHECK-MVE-NEXT:    vmov.16 q2[5], r1
; CHECK-MVE-NEXT:    mov.w r1, #0
; CHECK-MVE-NEXT:    it mi
; CHECK-MVE-NEXT:    movmi r1, #1
; CHECK-MVE-NEXT:    cmp r1, #0
...
; CHECK-MVE-NEXT:    lsls r1, r1, #31
; CHECK-MVE-NEXT:    vcmp.f16 s4, #0
; CHECK-MVE-NEXT:    vseleq.f16 s14, s3, s14
; CHECK-MVE-NEXT:    movs r0, #0
; CHECK-MVE-NEXT:    vmrs APSR_nzcv, fpscr
; CHECK-MVE-NEXT:    vmovx.f16 s0, s3
; CHECK-MVE-NEXT:    it mi
...
; CHECK-MVE-NEXT:    cset r0, ne
; CHECK-MVE-NEXT:    vmov.f32 s2, s0
; CHECK-MVE-NEXT:    vmla.f16 s2, s4, s12
; CHECK-MVE-NEXT:    lsls r0, r0, #31
; CHECK-MVE-NEXT:    vmov r1, s14
; CHECK-MVE-NEXT:    vseleq.f16 s0, s0, s2
; CHECK-MVE-NEXT:    vmov.16 q2[6], r1
; CHECK-MVE-NEXT:    vmov r0, s0
; CHECK-MVE-NEXT:    vmov.16 q2[7], r0
; CHECK-MVE-NEXT:    vmov q0, q2
; CHECK-MVE-NEXT:    bx lr
