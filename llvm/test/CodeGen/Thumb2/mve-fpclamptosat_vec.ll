...
; CHECK-NEXT:    vmov q1[2], q1[0], r9, r7
; CHECK-NEXT:    vldrw.u32 q0, [r2]
; CHECK-NEXT:    adr r2, .LCPI6_1
; CHECK-NEXT:    vmov q4[2], q4[0], r11, r10
; CHECK-NEXT:    vldrw.u32 q2, [r2]
; CHECK-NEXT:    vmov q1[3], q1[1], r8, r6
; CHECK-NEXT:    vmov q4[3], q4[1], r11, r10
; CHECK-NEXT:    vand q1, q1, q4
; CHECK-NEXT:    vbic q4, q2, q4
; CHECK-NEXT:    mvn r12, #-2147483648
; CHECK-NEXT:    subs.w r2, r4, r12
; CHECK-NEXT:    vorr q1, q1, q4
; CHECK-NEXT:    vmov q3[2], q3[0], r0, r4
; CHECK-NEXT:    vmov r2, r3, d2
; CHECK-NEXT:    sbcs r7, r5, #0
; CHECK-NEXT:    vmov q3[3], q3[1], r1, r5
; CHECK-NEXT:    vmov r6, r5, d3
; CHECK-NEXT:    mov.w r7, #0
; CHECK-NEXT:    it lt
; CHECK-NEXT:    movlt r7, #1
...
; CHECK-NEXT:    vmov.u16 r0, q4[1]
; CHECK-NEXT:    vand q0, q0, q1
; CHECK-NEXT:    vbic q1, q6, q1
; CHECK-NEXT:    vorr q5, q0, q1
; CHECK-NEXT:    vmov r7, r8, d11
; CHECK-NEXT:    bl __fixhfdi
; CHECK-NEXT:    mov r4, r0
; CHECK-NEXT:    vmov.u16 r0, q4[0]
; CHECK-NEXT:    mov r5, r1
...
; CHECK-NEXT:    cmp r1, #0
; CHECK-NEXT:    csetm r1, ne
; CHECK-NEXT:    vmov q2[2], q2[0], r1, r7
...
; CHECK-NEXT:    vmovx.f16 s12, s2
; CHECK-NEXT:    vmovx.f16 s10, s3
; CHECK-NEXT:    vcvt.u32.f16 s14, s3
; CHECK-NEXT:    vcvt.u32.f16 s2, s2
; CHECK-NEXT:    vcvt.u32.f16 s10, s10
; CHECK-NEXT:    vcvt.u32.f16 s12, s12
; CHECK-NEXT:    vmov r1, s14
...
; CHECK-NEXT:    vcvt.s32.f16 s9, s0
; CHECK-NEXT:    vmovx.f16 s0, s2
; CHECK-NEXT:    vcvt.s32.f16 s13, s3
; CHECK-NEXT:    vcvt.s32.f16 s15, s2
; CHECK-NEXT:    vcvt.s32.f16 s11, s0
...
; CHECK-NEXT:    vcvt.s32.f16 s12, s4
...
; CHECK-NEXT:    csel r2, r0, r5, ne
; CHECK-NEXT:    cmp.w r0, #-2147483648
; CHECK-NEXT:    csel r0, r0, r5, hi
; CHECK-NEXT:    adds r1, #1
; CHECK-NEXT:    cset r1, eq
; CHECK-NEXT:    cmp r1, #0
; CHECK-NEXT:    csel r8, r0, r2, ne
; CHECK-NEXT:    vmov.u16 r0, q4[0]
; CHECK-NEXT:    bl __fixhfdi
; CHECK-NEXT:    cmp r1, #0
; CHECK-NEXT:    cset r2, mi
