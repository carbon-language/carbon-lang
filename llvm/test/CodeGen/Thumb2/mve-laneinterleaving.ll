...
; CHECK-NEXT:    vmov.f32 s2, s3
; CHECK-NEXT:    vmov r11, r2, d5
; CHECK-NEXT:    vmov r9, lr, d3
; CHECK-NEXT:    vmov r10, s12
; CHECK-NEXT:    vmov r1, s2
; CHECK-NEXT:    vmov.f32 s2, s1
; CHECK-NEXT:    vmov r8, s2
; CHECK-NEXT:    str r1, [sp, #4] @ 4-byte Spill
; CHECK-NEXT:    adds.w r4, r1, r11
; CHECK-NEXT:    asr.w r0, r1, #31
; CHECK-NEXT:    adc.w r3, r0, r2
; CHECK-NEXT:    asrl r4, r3, r11
; CHECK-NEXT:    subs.w r0, r4, r11
; CHECK-NEXT:    sbc.w r2, r3, r2
; CHECK-NEXT:    umull r0, r4, r0, r11
; CHECK-NEXT:    adds.w r6, r8, r9
; CHECK-NEXT:    mla r7, r2, r11, r4
; CHECK-NEXT:    asr.w r3, r8, #31
; CHECK-NEXT:    adc.w r3, r3, lr
; CHECK-NEXT:    rsbs r2, r1, #0
; CHECK-NEXT:    asrl r6, r3, r9
; CHECK-NEXT:    lsll r0, r7, r2
; CHECK-NEXT:    subs.w r5, r6, r9
; CHECK-NEXT:    vmov r6, r2, d4
; CHECK-NEXT:    lsll r0, r7, r11
; CHECK-NEXT:    sbc.w r3, r3, lr
; CHECK-NEXT:    asr.w r7, r10, #31
; CHECK-NEXT:    adds.w r4, r10, r6
; CHECK-NEXT:    adcs r7, r2
; CHECK-NEXT:    asrl r4, r7, r6
; CHECK-NEXT:    subs r4, r4, r6
; CHECK-NEXT:    sbcs r7, r2
; CHECK-NEXT:    umull r2, r4, r4, r6
; CHECK-NEXT:    mla r7, r7, r6, r4
; CHECK-NEXT:    rsb.w r4, r10, #0
; CHECK-NEXT:    lsll r2, r7, r4
; CHECK-NEXT:    lsll r2, r7, r6
; CHECK-NEXT:    vmov q3[2], q3[0], r2, r0
; CHECK-NEXT:    umull r12, r0, r5, r9
; CHECK-NEXT:    mul r7, r5, lr
; CHECK-NEXT:    vmov r5, s0
; CHECK-NEXT:    orrs r0, r7
; CHECK-NEXT:    mla r7, r3, r9, r0
; CHECK-NEXT:    vmov r3, r4, d2
; CHECK-NEXT:    asr.w lr, r5, #31
; CHECK-NEXT:    adds r0, r5, r3
; CHECK-NEXT:    adc.w r1, lr, r4
; CHECK-NEXT:    asrl r0, r1, r3
; CHECK-NEXT:    subs r0, r0, r3
; CHECK-NEXT:    sbc.w lr, r1, r4
; CHECK-NEXT:    umull r2, r1, r0, r3
; CHECK-NEXT:    muls r0, r4, r0
; CHECK-NEXT:    eor.w r4, r5, r3
; CHECK-NEXT:    orr.w r4, r4, r5, asr #31
; CHECK-NEXT:    orrs r1, r0
; CHECK-NEXT:    eor.w r0, r8, r9
; CHECK-NEXT:    orr.w r0, r0, r8, asr #31
; CHECK-NEXT:    mla r1, lr, r3, r1
; CHECK-NEXT:    cmp r0, #0
...
; CHECK-NEXT:    eor.w r0, r4, r11
; CHECK-NEXT:    orr.w r0, r0, r4, asr #31
; CHECK-NEXT:    eor.w r4, r10, r6
; CHECK-NEXT:    cmp r0, #0
...
; CHECK-NEXT:    vmov q5[2], q5[0], r4, r0
; CHECK-NEXT:    rsb.w r0, r8, #0
; CHECK-NEXT:    lsll r12, r7, r0
; CHECK-NEXT:    rsbs r0, r5, #0
; CHECK-NEXT:    lsll r2, r1, r0
; CHECK-NEXT:    vbic q1, q2, q5
; CHECK-NEXT:    vand q2, q3, q5
; CHECK-NEXT:    lsll r12, r7, r9
