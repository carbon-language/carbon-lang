...
; CHECK-NEXT:    vmov r4, s1
; CHECK-NEXT:    vmov lr, s25
; CHECK-NEXT:    vmov q0[2], q0[0], r5, r2
; CHECK-NEXT:    vmov r3, s11
; CHECK-NEXT:    vmov q0[3], q0[1], lr, r0
...
; CHECK-NEXT:    vmov q0[2], q0[0], r6, r3
; CHECK-NEXT:    vmov r2, s11
; CHECK-NEXT:    vmov q0[3], q0[1], lr, r4
; CHECK-NEXT:    vmov.f32 s23, s17
; CHECK-NEXT:    vldrw.u32 q4, [r0]
; CHECK-NEXT:    vmov q1[3], q1[1], r5, r2
; CHECK-NEXT:    vadd.f16 q0, q5, q0
; CHECK-NEXT:    vadd.f16 q1, q0, q1
; CHECK-NEXT:    vldrw.u32 q0, [r0, #32]
; CHECK-NEXT:    vldrw.u32 q2, [r0, #16]
...
; CHECK-NEXT:    vmov q1[3], q1[1], r2, r5
; CHECK-NEXT:    vmov r4, s15
; CHECK-NEXT:    vmov q0[3], q0[1], r0, r4
; CHECK-NEXT:    vadd.f16 q1, q5, q1
; CHECK-NEXT:    vadd.f16 q0, q1, q0
; CHECK-NEXT:    vstrw.32 q0, [r1]
; CHECK-NEXT:    vpop {d8, d9, d10, d11, d12, d13}
