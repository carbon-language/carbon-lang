...
; CHECK: saddlp v{{[0-9]+}}.4h, v{{[0-9]+}}.8b
  %vpaddl.i = tail call <4 x i16> @llvm.arm64.neon.saddlp.v4i16.v8i8(<8 x i8> %a) #4
  ret <4 x i16> %vpaddl.i
}

define <2 x i32> @test_vpaddl_s16(<4 x i16> %a) #0 {
; CHECK: saddlp v{{[0-9]+}}.2s, v{{[0-9]+}}.4h
  %vpaddl1.i = tail call <2 x i32> @llvm.arm64.neon.saddlp.v2i32.v4i16(<4 x i16> %a) #4
  ret <2 x i32> %vpaddl1.i
}

define <1 x i64> @test_vpaddl_s32(<2 x i32> %a) #0 {
; CHECK: saddlp v{{[0-9]+}}.1d, v{{[0-9]+}}.2s
  %vpaddl1.i = tail call <1 x i64> @llvm.arm64.neon.saddlp.v1i64.v2i32(<2 x i32> %a) #4
  ret <1 x i64> %vpaddl1.i
}

define <4 x i16> @test_vpaddl_u8(<8 x i8> %a) #0 {
; CHECK: uaddlp v{{[0-9]+}}.4h, v{{[0-9]+}}.8b
  %vpaddl.i = tail call <4 x i16> @llvm.arm64.neon.uaddlp.v4i16.v8i8(<8 x i8> %a) #4
  ret <4 x i16> %vpaddl.i
}

define <2 x i32> @test_vpaddl_u16(<4 x i16> %a) #0 {
; CHECK: uaddlp v{{[0-9]+}}.2s, v{{[0-9]+}}.4h
  %vpaddl1.i = tail call <2 x i32> @llvm.arm64.neon.uaddlp.v2i32.v4i16(<4 x i16> %a) #4
  ret <2 x i32> %vpaddl1.i
}

define <1 x i64> @test_vpaddl_u32(<2 x i32> %a) #0 {
; CHECK: uaddlp v{{[0-9]+}}.1d, v{{[0-9]+}}.2s
  %vpaddl1.i = tail call <1 x i64> @llvm.arm64.neon.uaddlp.v1i64.v2i32(<2 x i32> %a) #4
  ret <1 x i64> %vpaddl1.i
}

define <8 x i16> @test_vpaddlq_s8(<16 x i8> %a) #0 {
; CHECK: saddlp v{{[0-9]+}}.8h, v{{[0-9]+}}.16b
  %vpaddl.i = tail call <8 x i16> @llvm.arm64.neon.saddlp.v8i16.v16i8(<16 x i8> %a) #4
  ret <8 x i16> %vpaddl.i
}

define <4 x i32> @test_vpaddlq_s16(<8 x i16> %a) #0 {
; CHECK: saddlp v{{[0-9]+}}.4s, v{{[0-9]+}}.8h
  %vpaddl1.i = tail call <4 x i32> @llvm.arm64.neon.saddlp.v4i32.v8i16(<8 x i16> %a) #4
  ret <4 x i32> %vpaddl1.i
}

define <2 x i64> @test_vpaddlq_s32(<4 x i32> %a) #0 {
; CHECK: saddlp v{{[0-9]+}}.2d, v{{[0-9]+}}.4s
  %vpaddl1.i = tail call <2 x i64> @llvm.arm64.neon.saddlp.v2i64.v4i32(<4 x i32> %a) #4
  ret <2 x i64> %vpaddl1.i
}

define <8 x i16> @test_vpaddlq_u8(<16 x i8> %a) #0 {
; CHECK: uaddlp v{{[0-9]+}}.8h, v{{[0-9]+}}.16b
  %vpaddl.i = tail call <8 x i16> @llvm.arm64.neon.uaddlp.v8i16.v16i8(<16 x i8> %a) #4
  ret <8 x i16> %vpaddl.i
}

define <4 x i32> @test_vpaddlq_u16(<8 x i16> %a) #0 {
; CHECK: uaddlp v{{[0-9]+}}.4s, v{{[0-9]+}}.8h
  %vpaddl1.i = tail call <4 x i32> @llvm.arm64.neon.uaddlp.v4i32.v8i16(<8 x i16> %a) #4
  ret <4 x i32> %vpaddl1.i
}

define <2 x i64> @test_vpaddlq_u32(<4 x i32> %a) #0 {
; CHECK: uaddlp v{{[0-9]+}}.2d, v{{[0-9]+}}.4s
  %vpaddl1.i = tail call <2 x i64> @llvm.arm64.neon.uaddlp.v2i64.v4i32(<4 x i32> %a) #4
  ret <2 x i64> %vpaddl1.i
}

define <4 x i16> @test_vpadal_s8(<4 x i16> %a, <8 x i8> %b) #0 {
; CHECK: sadalp v{{[0-9]+}}.4h, v{{[0-9]+}}.8b
  %vpadal1.i = tail call <4 x i16> @llvm.arm64.neon.saddlp.v4i16.v8i8(<8 x i8> %b) #4
  %sum = add <4 x i16> %a, %vpadal1.i
  ret <4 x i16> %sum
}

define <2 x i32> @test_vpadal_s16(<2 x i32> %a, <4 x i16> %b) #0 {
; CHECK: sadalp v{{[0-9]+}}.2s, v{{[0-9]+}}.4h
  %vpadal2.i = tail call <2 x i32> @llvm.arm64.neon.saddlp.v2i32.v4i16(<4 x i16> %b) #4
  %sum = add <2 x i32> %a, %vpadal2.i
  ret <2 x i32> %sum
}

define <1 x i64> @test_vpadal_s32(<1 x i64> %a, <2 x i32> %b) #0 {
; CHECK: sadalp v{{[0-9]+}}.1d, v{{[0-9]+}}.2s
  %vpadal2.i = tail call <1 x i64> @llvm.arm64.neon.saddlp.v1i64.v2i32(<2 x i32> %b) #4
  %sum = add <1 x i64> %a, %vpadal2.i
  ret <1 x i64> %sum
}

define <4 x i16> @test_vpadal_u8(<4 x i16> %a, <8 x i8> %b) #0 {
; CHECK: uadalp v{{[0-9]+}}.4h, v{{[0-9]+}}.8b
  %vpadal1.i = tail call <4 x i16> @llvm.arm64.neon.uaddlp.v4i16.v8i8(<8 x i8> %b) #4
  %sum = add <4 x i16> %a, %vpadal1.i
  ret <4 x i16> %sum
}
...
; CHECK: uadalp v{{[0-9]+}}.2s, v{{[0-9]+}}.4h
  %vpadal2.i = tail call <2 x i32> @llvm.arm64.neon.uaddlp.v2i32.v4i16(<4 x i16> %b) #4
  %sum = add <2 x i32> %a, %vpadal2.i
  ret <2 x i32> %sum
}
...
; CHECK: uadalp v{{[0-9]+}}.1d, v{{[0-9]+}}.2s
  %vpadal2.i = tail call <1 x i64> @llvm.arm64.neon.uaddlp.v1i64.v2i32(<2 x i32> %b) #4
  %sum = add <1 x i64> %a, %vpadal2.i
  ret <1 x i64> %sum
}
...
; CHECK: sadalp v{{[0-9]+}}.8h, v{{[0-9]+}}.16b
  %vpadal1.i = tail call <8 x i16> @llvm.arm64.neon.saddlp.v8i16.v16i8(<16 x i8> %b) #4
  %sum = add <8 x i16> %a, %vpadal1.i
  ret <8 x i16> %sum
}

define <4 x i32> @test_vpadalq_s16(<4 x i32> %a, <8 x i16> %b) #0 {
; CHECK: sadalp v{{[0-9]+}}.4s, v{{[0-9]+}}.8h
  %vpadal2.i = tail call <4 x i32> @llvm.arm64.neon.saddlp.v4i32.v8i16(<8 x i16> %b) #4
  %sum = add <4 x i32> %a, %vpadal2.i
  ret <4 x i32> %sum
}

define <2 x i64> @test_vpadalq_s32(<2 x i64> %a, <4 x i32> %b) #0 {
; CHECK: sadalp v{{[0-9]+}}.2d, v{{[0-9]+}}.4s
  %vpadal2.i = tail call <2 x i64> @llvm.arm64.neon.saddlp.v2i64.v4i32(<4 x i32> %b) #4
  %sum = add <2 x i64> %a, %vpadal2.i
  ret <2 x i64> %sum
}

define <8 x i16> @test_vpadalq_u8(<8 x i16> %a, <16 x i8> %b) #0 {
; CHECK: uadalp v{{[0-9]+}}.8h, v{{[0-9]+}}.16b
  %vpadal1.i = tail call <8 x i16> @llvm.arm64.neon.uaddlp.v8i16.v16i8(<16 x i8> %b) #4
  %sum = add <8 x i16> %a, %vpadal1.i
  ret <8 x i16> %sum
}
...
; CHECK: uadalp v{{[0-9]+}}.4s, v{{[0-9]+}}.8h
  %vpadal2.i = tail call <4 x i32> @llvm.arm64.neon.uaddlp.v4i32.v8i16(<8 x i16> %b) #4
  %sum = add <4 x i32> %a, %vpadal2.i
  ret <4 x i32> %sum
}
...
; CHECK: uadalp v{{[0-9]+}}.2d, v{{[0-9]+}}.4s
  %vpadal2.i = tail call <2 x i64> @llvm.arm64.neon.uaddlp.v2i64.v4i32(<4 x i32> %b) #4
  %sum = add <2 x i64> %a, %vpadal2.i
  ret <2 x i64> %sum
}
...
; CHECK: abs v{{[0-9]+}}.8b, v{{[0-9]+}}.8b
  %vabs.i = tail call <8 x i8> @llvm.arm64.neon.abs.v8i8(<8 x i8> %a) #4
  ret <8 x i8> %vabs.i
}

define <16 x i8> @test_vabsq_s8(<16 x i8> %a) #0 {
; CHECK: abs v{{[0-9]+}}.16b, v{{[0-9]+}}.16b
  %vabs.i = tail call <16 x i8> @llvm.arm64.neon.abs.v16i8(<16 x i8> %a) #4
  ret <16 x i8> %vabs.i
}

define <4 x i16> @test_vabs_s16(<4 x i16> %a) #0 {
; CHECK: abs v{{[0-9]+}}.4h, v{{[0-9]+}}.4h
  %vabs1.i = tail call <4 x i16> @llvm.arm64.neon.abs.v4i16(<4 x i16> %a) #4
  ret <4 x i16> %vabs1.i
}

define <8 x i16> @test_vabsq_s16(<8 x i16> %a) #0 {
; CHECK: abs v{{[0-9]+}}.8h, v{{[0-9]+}}.8h
  %vabs1.i = tail call <8 x i16> @llvm.arm64.neon.abs.v8i16(<8 x i16> %a) #4
  ret <8 x i16> %vabs1.i
}

define <2 x i32> @test_vabs_s32(<2 x i32> %a) #0 {
; CHECK: abs v{{[0-9]+}}.2s, v{{[0-9]+}}.2s
  %vabs1.i = tail call <2 x i32> @llvm.arm64.neon.abs.v2i32(<2 x i32> %a) #4
  ret <2 x i32> %vabs1.i
}

define <4 x i32> @test_vabsq_s32(<4 x i32> %a) #0 {
; CHECK: abs v{{[0-9]+}}.4s, v{{[0-9]+}}.4s
  %vabs1.i = tail call <4 x i32> @llvm.arm64.neon.abs.v4i32(<4 x i32> %a) #4
  ret <4 x i32> %vabs1.i
}

define <2 x i64> @test_vabsq_s64(<2 x i64> %a) #0 {
; CHECK: abs v{{[0-9]+}}.2d, v{{[0-9]+}}.2d
  %vabs1.i = tail call <2 x i64> @llvm.arm64.neon.abs.v2i64(<2 x i64> %a) #4
  ret <2 x i64> %vabs1.i
}
...
; CHECK: rbit v{{[0-9]+}}.8b, v{{[0-9]+}}.8b
  %vrbit.i = tail call <8 x i8> @llvm.arm64.neon.rbit.v8i8(<8 x i8> %a) #4
  ret <8 x i8> %vrbit.i
}

define <16 x i8> @test_vrbitq_s8(<16 x i8> %a) #0 {
; CHECK: rbit v{{[0-9]+}}.16b, v{{[0-9]+}}.16b
  %vrbit.i = tail call <16 x i8> @llvm.arm64.neon.rbit.v16i8(<16 x i8> %a) #4
  ret <16 x i8> %vrbit.i
}
...
; CHECK: sqxtun2 v{{[0-9]+}}.8h, v{{[0-9]+}}.4s
  %vqdmull1.i.i = tail call <4 x i16> @llvm.arm64.neon.sqxtun.v4i16(<4 x i32> %b) #4
...
; CHECK: sqxtun2 v{{[0-9]+}}.4s, v{{[0-9]+}}.2d
  %vqdmull1.i.i = tail call <2 x i32> @llvm.arm64.neon.sqxtun.v2i32(<2 x i64> %b) #4
...
; CHECK: test_vqmovn_high_s32
  %vqmovn1.i.i = tail call <4 x i16> @llvm.arm64.neon.sqxtn.v4i16(<4 x i32> %b) #4
...
; CHECK: test_vqmovn_high_s64
  %vqmovn1.i.i = tail call <2 x i32> @llvm.arm64.neon.sqxtn.v2i32(<2 x i64> %b) #4
...
; CHECK: uqxtn v{{[0-9]+}}.8b, v{{[0-9]+}}.8h
  %vqmovn1.i = tail call <8 x i8> @llvm.arm64.neon.uqxtn.v8i8(<8 x i16> %a) #4
  ret <8 x i8> %vqmovn1.i
}

define <4 x i16> @test_vqmovn_u32(<4 x i32> %a) #0 {
; CHECK: uqxtn v{{[0-9]+}}.4h, v{{[0-9]+}}.4s
  %vqmovn1.i = tail call <4 x i16> @llvm.arm64.neon.uqxtn.v4i16(<4 x i32> %a) #4
  ret <4 x i16> %vqmovn1.i
}

define <2 x i32> @test_vqmovn_u64(<2 x i64> %a) #0 {
; CHECK: uqxtn v{{[0-9]+}}.2s, v{{[0-9]+}}.2d
  %vqmovn1.i = tail call <2 x i32> @llvm.arm64.neon.uqxtn.v2i32(<2 x i64> %a) #4
  ret <2 x i32> %vqmovn1.i
}

define <16 x i8> @test_vqmovn_high_u16(<8 x i8> %a, <8 x i16> %b) #0 {
; CHECK: uqxtn2 v{{[0-9]+}}.16b, v{{[0-9]+}}.8h
  %vqmovn1.i.i = tail call <8 x i8> @llvm.arm64.neon.uqxtn.v8i8(<8 x i16> %b) #4
  %shuffle.i = shufflevector <8 x i8> %a, <8 x i8> %vqmovn1.i.i, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
  ret <16 x i8> %shuffle.i
}
...
; CHECK: uqxtn2 v{{[0-9]+}}.8h, v{{[0-9]+}}.4s
  %vqmovn1.i.i = tail call <4 x i16> @llvm.arm64.neon.uqxtn.v4i16(<4 x i32> %b) #4
  %shuffle.i = shufflevector <4 x i16> %a, <4 x i16> %vqmovn1.i.i, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  ret <8 x i16> %shuffle.i
}
...
; CHECK: uqxtn2 v{{[0-9]+}}.4s, v{{[0-9]+}}.2d
  %vqmovn1.i.i = tail call <2 x i32> @llvm.arm64.neon.uqxtn.v2i32(<2 x i64> %b) #4
  %shuffle.i = shufflevector <2 x i32> %a, <2 x i32> %vqmovn1.i.i, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  ret <4 x i32> %shuffle.i
}
...
; CHECK: fcvtn v{{[0-9]+}}.4h, v{{[0-9]+}}.4s
  %vcvt1.i = tail call <4 x i16> @llvm.arm64.neon.vcvtfp2hf(<4 x float> %a) #4
  ret <4 x i16> %vcvt1.i
}

define <8 x i16> @test_vcvt_high_f16_f32(<4 x i16> %a, <4 x float> %b) #0 {
; CHECK: fcvtn2 v{{[0-9]+}}.8h, v{{[0-9]+}}.4s
  %vcvt1.i.i = tail call <4 x i16> @llvm.arm64.neon.vcvtfp2hf(<4 x float> %b) #4
...
; CHECK: fcvtl v{{[0-9]+}}.4s, v{{[0-9]+}}.4h
  %vcvt1.i = tail call <4 x float> @llvm.arm64.neon.vcvthf2fp(<4 x i16> %a) #4
...
; CHECK: fcvtl2 v{{[0-9]+}}.4s, v{{[0-9]+}}.8h
  ...
  %vcvt1.i.i = tail call <4 x float> @llvm.arm64.neon.vcvthf2fp(<4 x i16> %shuffle.i.i) #4
...
; CHECK: fcvtxn v{{[0-9]+}}.2s, v{{[0-9]+}}.2d
  %vcvtx_f32_f641.i = call <2 x float> @llvm.arm64.neon.fcvtxn.v2f32.v2f64(<2 x double> %a) #4
...
; CHECK: fcvtxn2 v{{[0-9]+}}.4s, v{{[0-9]+}}.2d
  %vcvtx_f32_f641.i.i = tail call <2 x float> @llvm.arm64.neon.fcvtxn.v2f32.v2f64(<2 x double> %b) #4
...
; CHECK: frintn v{{[0-9]+}}.2s, v{{[0-9]+}}.2s
  %vrndn1.i = tail call <2 x float> @llvm.arm64.neon.frintn.v2f32(<2 x float> %a) #4
  ret <2 x float> %vrndn1.i
}

define <4 x float> @test_vrndnq_f32(<4 x float> %a) #0 {
; CHECK: frintn v{{[0-9]+}}.4s, v{{[0-9]+}}.4s
  %vrndn1.i = tail call <4 x float> @llvm.arm64.neon.frintn.v4f32(<4 x float> %a) #4
  ret <4 x float> %vrndn1.i
}

define <2 x double> @test_vrndnq_f64(<2 x double> %a) #0 {
; CHECK: frintn v{{[0-9]+}}.2d, v{{[0-9]+}}.2d
  %vrndn1.i = tail call <2 x double> @llvm.arm64.neon.frintn.v2f64(<2 x double> %a) #4
...
; CHECK: fcvtns v{{[0-9]+}}.2s, v{{[0-9]+}}.2s
  %vcvtns_f321.i = call <2 x i32> @llvm.arm64.neon.fcvtns.v2i32.v2f32(<2 x float> %a)
...
; CHECK: fcvtns v{{[0-9]+}}.4s, v{{[0-9]+}}.4s
  %vcvtns_f321.i = call <4 x i32> @llvm.arm64.neon.fcvtns.v4i32.v4f32(<4 x float> %a)
...
; CHECK: fcvtns v{{[0-9]+}}.2d, v{{[0-9]+}}.2d
  %vcvtns_f641.i = call <2 x i64> @llvm.arm64.neon.fcvtns.v2i64.v2f64(<2 x double> %a)
...
; CHECK: fcvtnu v{{[0-9]+}}.2s, v{{[0-9]+}}.2s
  %vcvtnu_f321.i = call <2 x i32> @llvm.arm64.neon.fcvtnu.v2i32.v2f32(<2 x float> %a)
...
; CHECK: fcvtnu v{{[0-9]+}}.4s, v{{[0-9]+}}.4s
  %vcvtnu_f321.i = call <4 x i32> @llvm.arm64.neon.fcvtnu.v4i32.v4f32(<4 x float> %a)
...
; CHECK: fcvtnu v{{[0-9]+}}.2d, v{{[0-9]+}}.2d
  %vcvtnu_f641.i = call <2 x i64> @llvm.arm64.neon.fcvtnu.v2i64.v2f64(<2 x double> %a)
...
; CHECK: fcvtps v{{[0-9]+}}.2s, v{{[0-9]+}}.2s
  %vcvtps_f321.i = call <2 x i32> @llvm.arm64.neon.fcvtps.v2i32.v2f32(<2 x float> %a)
...
; CHECK: fcvtps v{{[0-9]+}}.4s, v{{[0-9]+}}.4s
  %vcvtps_f321.i = call <4 x i32> @llvm.arm64.neon.fcvtps.v4i32.v4f32(<4 x float> %a)
...
; CHECK: fcvtps v{{[0-9]+}}.2d, v{{[0-9]+}}.2d
  %vcvtps_f641.i = call <2 x i64> @llvm.arm64.neon.fcvtps.v2i64.v2f64(<2 x double> %a)
...
; CHECK: fcvtpu v{{[0-9]+}}.2s, v{{[0-9]+}}.2s
  %vcvtpu_f321.i = call <2 x i32> @llvm.arm64.neon.fcvtpu.v2i32.v2f32(<2 x float> %a)
...
; CHECK: fcvtpu v{{[0-9]+}}.4s, v{{[0-9]+}}.4s
  %vcvtpu_f321.i = call <4 x i32> @llvm.arm64.neon.fcvtpu.v4i32.v4f32(<4 x float> %a)
...
; CHECK: fcvtpu v{{[0-9]+}}.2d, v{{[0-9]+}}.2d
  %vcvtpu_f641.i = call <2 x i64> @llvm.arm64.neon.fcvtpu.v2i64.v2f64(<2 x double> %a)
...
; CHECK: fcvtms v{{[0-9]+}}.2s, v{{[0-9]+}}.2s
  %vcvtms_f321.i = call <2 x i32> @llvm.arm64.neon.fcvtms.v2i32.v2f32(<2 x float> %a)
...
; CHECK: fcvtms v{{[0-9]+}}.4s, v{{[0-9]+}}.4s
  %vcvtms_f321.i = call <4 x i32> @llvm.arm64.neon.fcvtms.v4i32.v4f32(<4 x float> %a)
...
; CHECK: fcvtms v{{[0-9]+}}.2d, v{{[0-9]+}}.2d
  %vcvtms_f641.i = call <2 x i64> @llvm.arm64.neon.fcvtms.v2i64.v2f64(<2 x double> %a)
...
; CHECK: fcvtmu v{{[0-9]+}}.2s, v{{[0-9]+}}.2s
  %vcvtmu_f321.i = call <2 x i32> @llvm.arm64.neon.fcvtmu.v2i32.v2f32(<2 x float> %a)
...
; CHECK: fcvtmu v{{[0-9]+}}.4s, v{{[0-9]+}}.4s
  %vcvtmu_f321.i = call <4 x i32> @llvm.arm64.neon.fcvtmu.v4i32.v4f32(<4 x float> %a)
...
; CHECK: fcvtmu v{{[0-9]+}}.2d, v{{[0-9]+}}.2d
  %vcvtmu_f641.i = call <2 x i64> @llvm.arm64.neon.fcvtmu.v2i64.v2f64(<2 x double> %a)
...
; CHECK: fcvtas v{{[0-9]+}}.2s, v{{[0-9]+}}.2s
  %vcvtas_f321.i = call <2 x i32> @llvm.arm64.neon.fcvtas.v2i32.v2f32(<2 x float> %a)
...
; CHECK: fcvtas v{{[0-9]+}}.4s, v{{[0-9]+}}.4s
  %vcvtas_f321.i = call <4 x i32> @llvm.arm64.neon.fcvtas.v4i32.v4f32(<4 x float> %a)
...
; CHECK: fcvtas v{{[0-9]+}}.2d, v{{[0-9]+}}.2d
  %vcvtas_f641.i = call <2 x i64> @llvm.arm64.neon.fcvtas.v2i64.v2f64(<2 x double> %a)
...
; CHECK: fcvtau v{{[0-9]+}}.2s, v{{[0-9]+}}.2s
  %vcvtau_f321.i = call <2 x i32> @llvm.arm64.neon.fcvtau.v2i32.v2f32(<2 x float> %a)
...
; CHECK: fcvtau v{{[0-9]+}}.4s, v{{[0-9]+}}.4s
  %vcvtau_f321.i = call <4 x i32> @llvm.arm64.neon.fcvtau.v4i32.v4f32(<4 x float> %a)
...
; CHECK: fcvtau v{{[0-9]+}}.2d, v{{[0-9]+}}.2d
  %vcvtau_f641.i = call <2 x i64> @llvm.arm64.neon.fcvtau.v2i64.v2f64(<2 x double> %a)
  ret <2 x i64> %vcvtau_f641.i
}

define <2 x float> @test_vrsqrte_f32(<2 x float> %a) #0 {
; CHECK: frsqrte v{{[0-9]+}}.2s, v{{[0-9]+}}.2s
  %vrsqrte1.i = tail call <2 x float> @llvm.arm64.neon.frsqrte.v2f32(<2 x float> %a) #4
  ret <2 x float> %vrsqrte1.i
}

define <4 x float> @test_vrsqrteq_f32(<4 x float> %a) #0 {
; CHECK: frsqrte v{{[0-9]+}}.4s, v{{[0-9]+}}.4s
  %vrsqrte1.i = tail call <4 x float> @llvm.arm64.neon.frsqrte.v4f32(<4 x float> %a) #4
  ret <4 x float> %vrsqrte1.i
}

define <2 x double> @test_vrsqrteq_f64(<2 x double> %a) #0 {
; CHECK: frsqrte v{{[0-9]+}}.2d, v{{[0-9]+}}.2d
  %vrsqrte1.i = tail call <2 x double> @llvm.arm64.neon.frsqrte.v2f64(<2 x double> %a) #4
  ret <2 x double> %vrsqrte1.i
}

declare <2 x float> @llvm.arm64.neon.frecpe.v2f32(<2 x float>)
declare <4 x float> @llvm.arm64.neon.frecpe.v4f32(<4 x float>)
declare <2 x double> @llvm.arm64.neon.frecpe.v2f64(<2 x double>)

define <2 x float> @test_vrecpe_f32(<2 x float> %a) #0 {
; CHECK: frecpe v{{[0-9]+}}.2s, v{{[0-9]+}}.2s
  %vrecpe1.i = tail call <2 x float> @llvm.arm64.neon.frecpe.v2f32(<2 x float> %a) #4
  ret <2 x float> %vrecpe1.i
}

define <4 x float> @test_vrecpeq_f32(<4 x float> %a) #0 {
; CHECK: frecpe v{{[0-9]+}}.4s, v{{[0-9]+}}.4s
  %vrecpe1.i = tail call <4 x float> @llvm.arm64.neon.frecpe.v4f32(<4 x float> %a) #4
  ret <4 x float> %vrecpe1.i
}

define <2 x double> @test_vrecpeq_f64(<2 x double> %a) #0 {
; CHECK: frecpe v{{[0-9]+}}.2d, v{{[0-9]+}}.2d
  %vrecpe1.i = tail call <2 x double> @llvm.arm64.neon.frecpe.v2f64(<2 x double> %a) #4
  ret <2 x double> %vrecpe1.i
}

define <2 x i32> @test_vrecpe_u32(<2 x i32> %a) #0 {
; CHECK: urecpe v{{[0-9]+}}.2s, v{{[0-9]+}}.2s
  %vrecpe1.i = tail call <2 x i32> @llvm.arm64.neon.urecpe.v2i32(<2 x i32> %a) #4
  ret <2 x i32> %vrecpe1.i
}

define <4 x i32> @test_vrecpeq_u32(<4 x i32> %a) #0 {
; CHECK: urecpe v{{[0-9]+}}.4s, v{{[0-9]+}}.4s
  %vrecpe1.i = tail call <4 x i32> @llvm.arm64.neon.urecpe.v4i32(<4 x i32> %a) #4
...
declare <4 x i32> @llvm.arm64.neon.urecpe.v4i32(<4 x i32>) #2

declare <2 x i32> @llvm.arm64.neon.urecpe.v2i32(<2 x i32>) #2

declare <2 x double> @llvm.arm64.neon.urecpe.v2f64(<2 x double>) #2

declare <4 x float> @llvm.arm64.neon.urecpe.v4f32(<4 x float>) #2

declare <2 x float> @llvm.arm64.neon.urecpe.v2f32(<2 x float>) #2

declare <2 x double> @llvm.arm64.neon.frsqrte.v2f64(<2 x double>) #2

declare <4 x float> @llvm.arm64.neon.frsqrte.v4f32(<4 x float>) #2

declare <2 x float> @llvm.arm64.neon.frsqrte.v2f32(<2 x float>) #2
...
declare <2 x double> @llvm.arm64.neon.frintn.v2f64(<2 x double>) #2

declare <4 x float> @llvm.arm64.neon.frintn.v4f32(<4 x float>) #2

declare <2 x float> @llvm.arm64.neon.frintn.v2f32(<2 x float>) #2

declare <2 x float> @llvm.arm64.neon.fcvtxn.v2f32.v2f64(<2 x double>) #2

declare <2 x float> @llvm.arm64.neon.fcvtn.v2f32.v2f64(<2 x double>) #2

declare <2 x i32> @llvm.arm64.neon.uqxtn.v2i32(<2 x i64>) #2

declare <4 x i16> @llvm.arm64.neon.uqxtn.v4i16(<4 x i32>) #2

declare <8 x i8> @llvm.arm64.neon.uqxtn.v8i8(<8 x i16>) #2

declare <2 x i32> @llvm.arm64.neon.sqxtn.v2i32(<2 x i64>) #2

declare <4 x i16> @llvm.arm64.neon.sqxtn.v4i16(<4 x i32>) #2

declare <8 x i8> @llvm.arm64.neon.sqxtn.v8i8(<8 x i16>) #2

declare <2 x i32> @llvm.arm64.neon.sqxtun.v2i32(<2 x i64>) #2

declare <4 x i16> @llvm.arm64.neon.sqxtun.v4i16(<4 x i32>) #2

declare <8 x i8> @llvm.arm64.neon.sqxtun.v8i8(<8 x i16>) #2

declare <16 x i8> @llvm.arm64.neon.rbit.v16i8(<16 x i8>) #2

declare <8 x i8> @llvm.arm64.neon.rbit.v8i8(<8 x i8>) #2
...
declare <4 x i32> @llvm.arm64.neon.cls.v4i32(<4 x i32>) #2

declare <2 x i32> @llvm.arm64.neon.cls.v2i32(<2 x i32>) #2

declare <8 x i16> @llvm.arm64.neon.cls.v8i16(<8 x i16>) #2

declare <4 x i16> @llvm.arm64.neon.cls.v4i16(<4 x i16>) #2

declare <16 x i8> @llvm.arm64.neon.cls.v16i8(<16 x i8>) #2

declare <8 x i8> @llvm.arm64.neon.cls.v8i8(<8 x i8>) #2

declare <2 x i64> @llvm.arm64.neon.suqadd.v2i64(<2 x i64>, <2 x i64>) #2

declare <4 x i32> @llvm.arm64.neon.suqadd.v4i32(<4 x i32>, <4 x i32>) #2

declare <2 x i32> @llvm.arm64.neon.suqadd.v2i32(<2 x i32>, <2 x i32>) #2

declare <8 x i16> @llvm.arm64.neon.suqadd.v8i16(<8 x i16>, <8 x i16>) #2

declare <4 x i16> @llvm.arm64.neon.suqadd.v4i16(<4 x i16>, <4 x i16>) #2

declare <16 x i8> @llvm.arm64.neon.suqadd.v16i8(<16 x i8>, <16 x i8>) #2

declare <8 x i8> @llvm.arm64.neon.suqadd.v8i8(<8 x i8>, <8 x i8>) #2
...
declare <2 x i64> @llvm.arm64.neon.abs.v2i64(<2 x i64>) #2

declare <4 x i32> @llvm.arm64.neon.abs.v4i32(<4 x i32>) #2

declare <2 x i32> @llvm.arm64.neon.abs.v2i32(<2 x i32>) #2

declare <8 x i16> @llvm.arm64.neon.abs.v8i16(<8 x i16>) #2

declare <4 x i16> @llvm.arm64.neon.abs.v4i16(<4 x i16>) #2

declare <16 x i8> @llvm.arm64.neon.abs.v16i8(<16 x i8>) #2

declare <8 x i8> @llvm.arm64.neon.abs.v8i8(<8 x i8>) #2

declare <2 x i64> @llvm.arm64.neon.sqneg.v2i64(<2 x i64>) #2

declare <4 x i32> @llvm.arm64.neon.sqneg.v4i32(<4 x i32>) #2

declare <2 x i32> @llvm.arm64.neon.sqneg.v2i32(<2 x i32>) #2

declare <8 x i16> @llvm.arm64.neon.sqneg.v8i16(<8 x i16>) #2

declare <4 x i16> @llvm.arm64.neon.sqneg.v4i16(<4 x i16>) #2

declare <16 x i8> @llvm.arm64.neon.sqneg.v16i8(<16 x i8>) #2

declare <8 x i8> @llvm.arm64.neon.sqneg.v8i8(<8 x i8>) #2

declare <2 x i64> @llvm.arm64.neon.sqabs.v2i64(<2 x i64>) #2

declare <4 x i32> @llvm.arm64.neon.sqabs.v4i32(<4 x i32>) #2

declare <2 x i32> @llvm.arm64.neon.sqabs.v2i32(<2 x i32>) #2

declare <8 x i16> @llvm.arm64.neon.sqabs.v8i16(<8 x i16>) #2

declare <4 x i16> @llvm.arm64.neon.sqabs.v4i16(<4 x i16>) #2

declare <16 x i8> @llvm.arm64.neon.sqabs.v16i8(<16 x i8>) #2

declare <8 x i8> @llvm.arm64.neon.sqabs.v8i8(<8 x i8>) #2

declare <2 x i64> @llvm.arm64.neon.uaddlp.v2i64.v4i32(<4 x i32>) #2

declare <4 x i32> @llvm.arm64.neon.uaddlp.v4i32.v8i16(<8 x i16>) #2

declare <8 x i16> @llvm.arm64.neon.uaddlp.v8i16.v16i8(<16 x i8>) #2

declare <2 x i64> @llvm.arm64.neon.saddlp.v2i64.v4i32(<4 x i32>) #2

declare <4 x i32> @llvm.arm64.neon.saddlp.v4i32.v8i16(<8 x i16>) #2

declare <8 x i16> @llvm.arm64.neon.saddlp.v8i16.v16i8(<16 x i8>) #2

declare <1 x i64> @llvm.arm64.neon.uaddlp.v1i64.v2i32(<2 x i32>) #2

declare <2 x i32> @llvm.arm64.neon.uaddlp.v2i32.v4i16(<4 x i16>) #2

declare <4 x i16> @llvm.arm64.neon.uaddlp.v4i16.v8i8(<8 x i8>) #2

declare <1 x i64> @llvm.arm64.neon.saddlp.v1i64.v2i32(<2 x i32>) #2

declare <2 x i32> @llvm.arm64.neon.saddlp.v2i32.v4i16(<4 x i16>) #2

declare <4 x i16> @llvm.arm64.neon.saddlp.v4i16.v8i8(<8 x i8>) #2

declare <4 x float> @llvm.arm64.neon.vcvthf2fp(<4 x i16>) #2

declare <4 x i16> @llvm.arm64.neon.vcvtfp2hf(<4 x float>) #2
...
; CHECK: fcvtns d{{[0-9]+}}, d{{[0-9]+}}
  %1 = call <1 x i64> @llvm.arm64.neon.fcvtns.v1i64.v1f64(<1 x double> %a)
  ret <1 x i64> %1
}
...
; CHECK: fcvtnu d{{[0-9]+}}, d{{[0-9]+}}
  %1 = call <1 x i64> @llvm.arm64.neon.fcvtnu.v1i64.v1f64(<1 x double> %a)
  ret <1 x i64> %1
}
...
; CHECK: fcvtps d{{[0-9]+}}, d{{[0-9]+}}
  %1 = call <1 x i64> @llvm.arm64.neon.fcvtps.v1i64.v1f64(<1 x double> %a)
  ret <1 x i64> %1
}
...
; CHECK: fcvtpu d{{[0-9]+}}, d{{[0-9]+}}
  %1 = call <1 x i64> @llvm.arm64.neon.fcvtpu.v1i64.v1f64(<1 x double> %a)
  ret <1 x i64> %1
}
...
; CHECK: fcvtms d{{[0-9]+}}, d{{[0-9]+}}
  %1 = call <1 x i64> @llvm.arm64.neon.fcvtms.v1i64.v1f64(<1 x double> %a)
  ret <1 x i64> %1
}
...
; CHECK: fcvtmu d{{[0-9]+}}, d{{[0-9]+}}
  %1 = call <1 x i64> @llvm.arm64.neon.fcvtmu.v1i64.v1f64(<1 x double> %a)
  ret <1 x i64> %1
}
...
; CHECK: fcvtas d{{[0-9]+}}, d{{[0-9]+}}
  %1 = call <1 x i64> @llvm.arm64.neon.fcvtas.v1i64.v1f64(<1 x double> %a)
  ret <1 x i64> %1
}
...
; CHECK: fcvtau d{{[0-9]+}}, d{{[0-9]+}}
  %1 = call <1 x i64> @llvm.arm64.neon.fcvtau.v1i64.v1f64(<1 x double> %a)
  ret <1 x i64> %1
}
...
declare <1 x i64> @llvm.arm64.neon.fcvtau.v1i64.v1f64(<1 x double>)
declare <1 x i64> @llvm.arm64.neon.fcvtas.v1i64.v1f64(<1 x double>)
declare <1 x i64> @llvm.arm64.neon.fcvtmu.v1i64.v1f64(<1 x double>)
declare <1 x i64> @llvm.arm64.neon.fcvtms.v1i64.v1f64(<1 x double>)
declare <1 x i64> @llvm.arm64.neon.fcvtpu.v1i64.v1f64(<1 x double>)
declare <1 x i64> @llvm.arm64.neon.fcvtps.v1i64.v1f64(<1 x double>)
declare <1 x i64> @llvm.arm64.neon.fcvtnu.v1i64.v1f64(<1 x double>)
declare <1 x i64> @llvm.arm64.neon.fcvtns.v1i64.v1f64(<1 x double>)

define <1 x double> @test_vrndn_f64(<1 x double> %a) {
; CHECK-LABEL: test_vrndn_f64
; CHECK: frintn d{{[0-9]+}}, d{{[0-9]+}}
  %1 = tail call <1 x double> @llvm.arm64.neon.frintn.v1f64(<1 x double> %a)
  ret <1 x double> %1
}
...
declare <1 x double> @llvm.arm64.neon.frintn.v1f64(<1 x double>)

define <1 x double> @test_vrsqrte_f64(<1 x double> %a) {
; CHECK-LABEL: test_vrsqrte_f64
; CHECK: frsqrte d{{[0-9]+}}, d{{[0-9]+}}
  %1 = tail call <1 x double> @llvm.arm64.neon.frsqrte.v1f64(<1 x double> %a)
  ret <1 x double> %1
}
...
; CHECK: frecpe d{{[0-9]+}}, d{{[0-9]+}}
  %1 = tail call <1 x double> @llvm.arm64.neon.frecpe.v1f64(<1 x double> %a)
  ret <1 x double> %1
}
...
; CHECK: frecps d{{[0-9]+}}, d{{[0-9]+}}, d{{[0-9]+}}
  %1 = tail call <1 x double> @llvm.arm64.neon.frecps.v1f64(<1 x double> %a, <1 x double> %b)
  ret <1 x double> %1
}
...
; CHECK: frsqrts d{{[0-9]+}}, d{{[0-9]+}}, d{{[0-9]+}}
  %1 = tail call <1 x double> @llvm.arm64.neon.frsqrts.v1f64(<1 x double> %a, <1 x double> %b)
  ret <1 x double> %1
}

declare <1 x double> @llvm.arm64.neon.frsqrts.v1f64(<1 x double>, <1 x double>)
declare <1 x double> @llvm.arm64.neon.frecps.v1f64(<1 x double>, <1 x double>)
declare <1 x double> @llvm.sqrt.v1f64(<1 x double>)
declare <1 x double> @llvm.arm64.neon.frecpe.v1f64(<1 x double>)
declare <1 x double> @llvm.arm64.neon.frsqrte.v1f64(<1 x double>)

define i64 @test_vaddlv_s32(<2 x i32> %a) {
; CHECK-LABEL: test_vaddlv_s32
; CHECK: saddlp {{v[0-9]+}}.1d, {{v[0-9]+}}.2s
  %1 = tail call i64 @llvm.arm64.neon.saddlv.i64.v2i32(<2 x i32> %a)
  ret i64 %1
}
...
; CHECK: uaddlp {{v[0-9]+}}.1d, {{v[0-9]+}}.2s
  %1 = tail call i64 @llvm.arm64.neon.uaddlv.i64.v2i32(<2 x i32> %a)
  ret i64 %1
}

declare i64 @llvm.arm64.neon.saddlv.i64.v2i32(<2 x i32>)
declare i64 @llvm.arm64.neon.uaddlv.i64.v2i32(<2 x i32>)
