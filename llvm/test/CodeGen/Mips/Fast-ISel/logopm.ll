...
attributes #0 = { noinline nounwind "frame-pointer"="none" "stack-protector-buffer-size"="8" "use-soft-float"="false" }
attributes #1 = { nounwind "frame-pointer"="none" "stack-protector-buffer-size"="8" "use-soft-float"="false" }
