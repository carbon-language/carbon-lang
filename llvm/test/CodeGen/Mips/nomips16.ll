...
attributes #0 = { nounwind "mips16" "frame-pointer"="all" "stack-protector-buffer-size"="8" "use-soft-float"="false" }
attributes #1 = { nounwind "frame-pointer"="all" "nomips16" "stack-protector-buffer-size"="8" "use-soft-float"="false" }
