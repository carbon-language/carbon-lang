...
attributes #0 = { nounwind optsize ssp "frame-pointer"="none" "stack-protector-buffer-size"="8" "use-soft-float"="false" }
attributes #1 = { nounwind }
attributes #2 = { nounwind optsize "frame-pointer"="none" "stack-protector-buffer-size"="8" "use-soft-float"="false" }
