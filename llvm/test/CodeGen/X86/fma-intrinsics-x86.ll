...
; CHECK-NEXT:  # BB#0:
;
; CHECK-FMA-WIN-NEXT: vmovaps {{\(%rcx\), %xmm0|\(%rdx\), %xmm1}}
; CHECK-FMA-WIN-NEXT: vmovaps {{\(%rcx\), %xmm0|\(%rdx\), %xmm1}}
...
; CHECK-NEXT:  # BB#0:
;
; CHECK-FMA-WIN-NEXT: vmovaps {{\(%rdx\), %xmm0|\(%rcx\), %xmm1}}
; CHECK-FMA-WIN-NEXT: vmovaps {{\(%rdx\), %xmm0|\(%rcx\), %xmm1}}
; CHECK-FMA-WIN-NEXT: vfmadd213ss (%r8), %xmm1, %xmm0
;
...
; CHECK-NEXT:  # BB#0:
;
; CHECK-FMA-WIN-NEXT: vmovapd {{\(%rcx\), %xmm0|\(%rdx\), %xmm1}}
; CHECK-FMA-WIN-NEXT: vmovapd {{\(%rcx\), %xmm0|\(%rdx\), %xmm1}}
...
; CHECK-NEXT:  # BB#0:
;
; CHECK-FMA-WIN-NEXT: vmovapd {{\(%rdx\), %xmm0|\(%rcx\), %xmm1}}
; CHECK-FMA-WIN-NEXT: vmovapd {{\(%rdx\), %xmm0|\(%rcx\), %xmm1}}
; CHECK-FMA-WIN-NEXT: vfmadd213sd (%r8), %xmm1, %xmm0
;
