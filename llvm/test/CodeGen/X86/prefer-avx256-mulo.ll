...
; AVX256:       # %bb.0:
; AVX256-NEXT:    vpmovsxbw %xmm1, %ymm2
; AVX256-NEXT:    vpmovsxbw %xmm0, %ymm3
; AVX256-NEXT:    vpmullw %ymm2, %ymm3, %ymm2
; AVX256-NEXT:    vpsrlw $8, %ymm2, %ymm2
; AVX256-NEXT:    vextracti128 $1, %ymm2, %xmm3
; AVX256-NEXT:    vpackuswb %xmm3, %xmm2, %xmm2
...
; AVX256-NEXT:    vpcmpgtb %xmm0, %xmm1, %xmm1
