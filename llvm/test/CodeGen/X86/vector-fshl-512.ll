...
; AVX512VL-NEXT:    vpternlogq $236, %ymm6, %ymm10, %ymm9
; AVX512VL-NEXT:    vpxor %xmm8, %xmm8, %xmm8
; AVX512VL-NEXT:    vpcmpeqb %ymm8, %ymm2, %ymm2
; AVX512VL-NEXT:    vpblendvb %ymm2, %ymm4, %ymm9, %ymm4
; AVX512VL-NEXT:    vpsllw %xmm5, %ymm0, %ymm5
; AVX512VL-NEXT:    vpand %ymm7, %ymm5, %ymm5
; AVX512VL-NEXT:    vpsrlw %xmm3, %ymm1, %ymm1
; AVX512VL-NEXT:    vpternlogq $236, %ymm6, %ymm5, %ymm1
; AVX512VL-NEXT:    vpblendvb %ymm2, %ymm0, %ymm1, %ymm0
