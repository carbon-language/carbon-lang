...
; AVX512VL-NEXT:    vpsubb %xmm2, %xmm5, %xmm5
; AVX512VL-NEXT:    vpmovzxbq {{.*#+}} xmm5 = xmm5[0],zero,zero,zero,zero,zero,zero,zero,xmm5[1],zero,zero,zero,zero,zero,zero,zero
; AVX512VL-NEXT:    vpsllw %xmm5, %ymm4, %ymm4
; AVX512VL-NEXT:    vpcmpeqd %xmm8, %xmm8, %xmm8
; AVX512VL-NEXT:    vpsllw %xmm5, %xmm8, %xmm7
; AVX512VL-NEXT:    vpbroadcastb %xmm7, %ymm7
; AVX512VL-NEXT:    vpand %ymm7, %ymm4, %ymm4
; AVX512VL-NEXT:    vpmovzxbq {{.*#+}} xmm6 = xmm2[0],zero,zero,zero,zero,zero,zero,zero,xmm2[1],zero,zero,zero,zero,zero,zero,zero
; AVX512VL-NEXT:    vpsrlw %xmm6, %ymm10, %ymm9
; AVX512VL-NEXT:    vpsrlw %xmm6, %xmm8, %xmm3
; AVX512VL-NEXT:    vpsrlw $8, %xmm3, %xmm3
; AVX512VL-NEXT:    vpbroadcastb %xmm3, %ymm3
; AVX512VL-NEXT:    vpternlogq $236, %ymm3, %ymm4, %ymm9
; AVX512VL-NEXT:    vpxor %xmm4, %xmm4, %xmm4
; AVX512VL-NEXT:    vpcmpeqb %ymm4, %ymm2, %ymm2
; AVX512VL-NEXT:    vpblendvb %ymm2, %ymm10, %ymm9, %ymm4
; AVX512VL-NEXT:    vpsllw %xmm5, %ymm0, %ymm0
; AVX512VL-NEXT:    vpand %ymm7, %ymm0, %ymm0
; AVX512VL-NEXT:    vpsrlw %xmm6, %ymm1, %ymm5
; AVX512VL-NEXT:    vpternlogq $236, %ymm3, %ymm0, %ymm5
; AVX512VL-NEXT:    vpblendvb %ymm2, %ymm1, %ymm5, %ymm0
