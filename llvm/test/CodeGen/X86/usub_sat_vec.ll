...
; SSE2-NEXT:  # %bb.21:
; SSE2-NEXT:    movl %ebx, %r11d
; SSE2-NEXT:  .LBB0_22:
; SSE2-NEXT:    movzbl %al, %r14d
; SSE2-NEXT:    movzbl %cl, %r15d
; SSE2-NEXT:    movzbl %dl, %edx
; SSE2-NEXT:    movzbl %sil, %esi
; SSE2-NEXT:    movzbl %dil, %ebx
; SSE2-NEXT:    movzbl %r12b, %ebp
...
; SSSE3-NEXT:  # %bb.7:
; SSSE3-NEXT:    movl %ebx, %esi
; SSSE3-NEXT:  .LBB0_8:
; SSSE3-NEXT:    movb -{{[0-9]+}}(%rsp), %bl
; SSSE3-NEXT:    subb -{{[0-9]+}}(%rsp), %bl
; SSSE3-NEXT:    movl $0, %edi
...
; SSSE3-NEXT:    movb -{{[0-9]+}}(%rsp), %bl
; SSSE3-NEXT:    subb -{{[0-9]+}}(%rsp), %bl
; SSSE3-NEXT:    movl $0, %r12d
; SSSE3-NEXT:    jb .LBB0_12
; SSSE3-NEXT:  # %bb.11:
; SSSE3-NEXT:    movl %ebx, %r12d
; SSSE3-NEXT:  .LBB0_12:
; SSSE3-NEXT:    movb -{{[0-9]+}}(%rsp), %bl
; SSSE3-NEXT:    subb -{{[0-9]+}}(%rsp), %bl
...
; SSSE3-NEXT:  # %bb.15:
; SSSE3-NEXT:    movl %ebx, %r10d
; SSSE3-NEXT:  .LBB0_16:
; SSSE3-NEXT:    movb -{{[0-9]+}}(%rsp), %bl
; SSSE3-NEXT:    subb -{{[0-9]+}}(%rsp), %bl
; SSSE3-NEXT:    movl $0, %r13d
; SSSE3-NEXT:    jb .LBB0_18
; SSSE3-NEXT:  # %bb.17:
; SSSE3-NEXT:    movl %ebx, %r13d
; SSSE3-NEXT:  .LBB0_18:
; SSSE3-NEXT:    movb -{{[0-9]+}}(%rsp), %bl
; SSSE3-NEXT:    subb -{{[0-9]+}}(%rsp), %bl
...
; SSSE3-NEXT:  # %bb.21:
; SSSE3-NEXT:    movl %ebx, %r11d
; SSSE3-NEXT:  .LBB0_22:
; SSSE3-NEXT:    movzbl %al, %r14d
; SSSE3-NEXT:    movzbl %cl, %r15d
; SSSE3-NEXT:    movzbl %dl, %edx
; SSSE3-NEXT:    movzbl %sil, %esi
; SSSE3-NEXT:    movzbl %dil, %ebx
; SSSE3-NEXT:    movzbl %r12b, %ebp
; SSSE3-NEXT:    movzbl %r8b, %edi
...
; SSSE3-NEXT:    movd %ebp, %xmm4
; SSSE3-NEXT:    movd %edi, %xmm7
; SSSE3-NEXT:    movd %r8d, %xmm1
; SSSE3-NEXT:    movzbl %r13b, %ebp
; SSSE3-NEXT:    movzbl %r9b, %ecx
; SSSE3-NEXT:    movzbl %r11b, %edx
; SSSE3-NEXT:    movzbl %al, %esi
; SSSE3-NEXT:    movb -{{[0-9]+}}(%rsp), %al
; SSSE3-NEXT:    subb -{{[0-9]+}}(%rsp), %al
; SSSE3-NEXT:    movl $0, %edi
...
; AVX-NEXT:    subb %sil, %dl
; AVX-NEXT:    movl $0, %esi
; AVX-NEXT:    jb .LBB0_4
; AVX-NEXT:  # %bb.3:
; AVX-NEXT:    movl %edx, %esi
; AVX-NEXT:  .LBB0_4:
; AVX-NEXT:    movzbl %sil, %edx
...
; SSE2-NEXT:    movb -{{[0-9]+}}(%rsp), %cl
; SSE2-NEXT:    subb -{{[0-9]+}}(%rsp), %cl
; SSE2-NEXT:    movl $0, {{[-0-9]+}}(%r{{[sb]}}p) # 4-byte Folded Spill
; SSE2-NEXT:    jb .LBB1_30
; SSE2-NEXT:  # %bb.29:
; SSE2-NEXT:    # kill: def $cl killed $cl def $ecx
; SSE2-NEXT:    movl %ecx, {{[-0-9]+}}(%r{{[sb]}}p) # 4-byte Spill
; SSE2-NEXT:  .LBB1_30:
; SSE2-NEXT:    subb -{{[0-9]+}}(%rsp), %al
; SSE2-NEXT:    movl $0, %ecx
...
; SSE2-NEXT:    movl %eax, %ecx
; SSE2-NEXT:  .LBB1_32:
; SSE2-NEXT:    movl %ecx, (%rsp) # 4-byte Spill
; SSE2-NEXT:    movb -{{[0-9]+}}(%rsp), %al
; SSE2-NEXT:    subb -{{[0-9]+}}(%rsp), %al
; SSE2-NEXT:    movl $0, %ecx
...
; SSE2-NEXT:  # %bb.35:
; SSE2-NEXT:    # kill: def $al killed $al def $eax
...
; SSE2-NEXT:    movzbl %bpl, %ebx
; SSE2-NEXT:    movzbl %dil, %ebp
; SSE2-NEXT:    movzbl %r13b, %edi
; SSE2-NEXT:    movzbl {{[-0-9]+}}(%r{{[sb]}}p), %r15d # 1-byte Folded Reload
; SSE2-NEXT:    movzbl %r12b, %r12d
; SSE2-NEXT:    movzbl %r14b, %r13d
...
; SSE2-NEXT:    movzbl (%rsp), %eax # 1-byte Folded Reload
; SSE2-NEXT:    movl %eax, {{[-0-9]+}}(%r{{[sb]}}p) # 4-byte Spill
; SSE2-NEXT:    movb -{{[0-9]+}}(%rsp), %al
; SSE2-NEXT:    subb -{{[0-9]+}}(%rsp), %al
; SSE2-NEXT:    movl $0, {{[-0-9]+}}(%r{{[sb]}}p) # 4-byte Folded Spill
...
; SSE2-NEXT:    movd %esi, %xmm11
; SSE2-NEXT:    movd %ebx, %xmm5
; SSE2-NEXT:    movd %ebp, %xmm9
; SSE2-NEXT:    movd %edi, %xmm7
; SSE2-NEXT:    movd %r15d, %xmm1
; SSE2-NEXT:    movd %r12d, %xmm12
; SSE2-NEXT:    movd %r13d, %xmm10
...
; SSE2-NEXT:    movd %r8d, %xmm7
; SSE2-NEXT:    movd %edx, %xmm12
; SSE2-NEXT:    movd %esi, %xmm13
; SSE2-NEXT:    movd %ebx, %xmm5
...
; SSSE3-NEXT:    movb -{{[0-9]+}}(%rsp), %cl
; SSSE3-NEXT:    subb -{{[0-9]+}}(%rsp), %cl
; SSSE3-NEXT:    movl $0, {{[-0-9]+}}(%r{{[sb]}}p) # 4-byte Folded Spill
; SSSE3-NEXT:    jb .LBB1_30
; SSSE3-NEXT:  # %bb.29:
; SSSE3-NEXT:    # kill: def $cl killed $cl def $ecx
; SSSE3-NEXT:    movl %ecx, {{[-0-9]+}}(%r{{[sb]}}p) # 4-byte Spill
; SSSE3-NEXT:  .LBB1_30:
; SSSE3-NEXT:    subb -{{[0-9]+}}(%rsp), %al
; SSSE3-NEXT:    movl $0, %ecx
...
; SSSE3-NEXT:    movl %eax, %ecx
; SSSE3-NEXT:  .LBB1_32:
; SSSE3-NEXT:    movl %ecx, (%rsp) # 4-byte Spill
; SSSE3-NEXT:    movb -{{[0-9]+}}(%rsp), %al
; SSSE3-NEXT:    subb -{{[0-9]+}}(%rsp), %al
; SSSE3-NEXT:    movl $0, %ecx
...
; SSSE3-NEXT:  # %bb.35:
; SSSE3-NEXT:    # kill: def $al killed $al def $eax
...
; SSSE3-NEXT:  .LBB1_52:
; SSSE3-NEXT:    movl %ecx, {{[-0-9]+}}(%r{{[sb]}}p) # 4-byte Spill
; SSSE3-NEXT:    movzbl %dl, %eax
; SSSE3-NEXT:    movl %eax, {{[-0-9]+}}(%r{{[sb]}}p) # 4-byte Spill
; SSSE3-NEXT:    movzbl %r15b, %ecx
; SSSE3-NEXT:    movzbl %sil, %edx
; SSSE3-NEXT:    movzbl %bl, %esi
; SSSE3-NEXT:    movzbl %bpl, %ebx
; SSSE3-NEXT:    movzbl %dil, %ebp
; SSSE3-NEXT:    movzbl %r13b, %edi
; SSSE3-NEXT:    movzbl {{[-0-9]+}}(%r{{[sb]}}p), %r15d # 1-byte Folded Reload
; SSSE3-NEXT:    movzbl %r12b, %r12d
; SSSE3-NEXT:    movzbl %r14b, %r13d
...
; SSSE3-NEXT:    movzbl (%rsp), %eax # 1-byte Folded Reload
; SSSE3-NEXT:    movl %eax, {{[-0-9]+}}(%r{{[sb]}}p) # 4-byte Spill
; SSSE3-NEXT:    movb -{{[0-9]+}}(%rsp), %al
; SSSE3-NEXT:    subb -{{[0-9]+}}(%rsp), %al
; SSSE3-NEXT:    movl $0, {{[-0-9]+}}(%r{{[sb]}}p) # 4-byte Folded Spill
...
; SSSE3-NEXT:    movd %esi, %xmm11
; SSSE3-NEXT:    movd %ebx, %xmm5
; SSSE3-NEXT:    movd %ebp, %xmm9
; SSSE3-NEXT:    movd %edi, %xmm7
; SSSE3-NEXT:    movd %r15d, %xmm1
; SSSE3-NEXT:    movd %r12d, %xmm12
; SSSE3-NEXT:    movd %r13d, %xmm10
...
; SSSE3-NEXT:    movd %r8d, %xmm7
; SSSE3-NEXT:    movd %edx, %xmm12
; SSSE3-NEXT:    movd %esi, %xmm13
; SSSE3-NEXT:    movd %ebx, %xmm5
...
; SSE41-NEXT:  .LBB1_2:
; SSE41-NEXT:    pextrb $0, %xmm2, %edx
; SSE41-NEXT:    pextrb $0, %xmm0, %eax
; SSE41-NEXT:    subb %dl, %al
; SSE41-NEXT:    movl $0, %esi
...
; SSE41-NEXT:    subb %al, %dil
; SSE41-NEXT:    movl $0, %eax
; SSE41-NEXT:    jb .LBB1_10
; SSE41-NEXT:  # %bb.9:
; SSE41-NEXT:    movl %edi, %eax
; SSE41-NEXT:  .LBB1_10:
; SSE41-NEXT:    pextrb $5, %xmm2, %ebp
; SSE41-NEXT:    pextrb $5, %xmm0, %edi
; SSE41-NEXT:    subb %bpl, %dil
; SSE41-NEXT:    movl $0, %ebx
; SSE41-NEXT:    jb .LBB1_12
; SSE41-NEXT:  # %bb.11:
; SSE41-NEXT:    movl %edi, %ebx
; SSE41-NEXT:  .LBB1_12:
; SSE41-NEXT:    pextrb $6, %xmm2, %ebp
; SSE41-NEXT:    pextrb $6, %xmm0, %edi
; SSE41-NEXT:    subb %bpl, %dil
; SSE41-NEXT:    movl $0, %ebp
...
; SSE41-NEXT:    pextrb $7, %xmm2, %ebx
; SSE41-NEXT:    pextrb $7, %xmm0, %edi
; SSE41-NEXT:    subb %bl, %dil
; SSE41-NEXT:    movl $0, %ebp
...
; SSE41-NEXT:  .LBB1_16:
; SSE41-NEXT:    movl %ebp, {{[-0-9]+}}(%r{{[sb]}}p) # 4-byte Spill
; SSE41-NEXT:    pextrb $8, %xmm2, %ebx
; SSE41-NEXT:    pextrb $8, %xmm0, %edi
; SSE41-NEXT:    subb %bl, %dil
...
; SSE41-NEXT:  .LBB1_18:
; SSE41-NEXT:    pextrb $9, %xmm2, %ebx
; SSE41-NEXT:    pextrb $9, %xmm0, %edi
; SSE41-NEXT:    subb %bl, %dil
; SSE41-NEXT:    movl $0, %r14d
; SSE41-NEXT:    jb .LBB1_20
; SSE41-NEXT:  # %bb.19:
; SSE41-NEXT:    movl %edi, %r14d
; SSE41-NEXT:  .LBB1_20:
; SSE41-NEXT:    pextrb $10, %xmm2, %ebx
; SSE41-NEXT:    pextrb $10, %xmm0, %edi
; SSE41-NEXT:    subb %bl, %dil
; SSE41-NEXT:    movl $0, %ebp
...
; SSE41-NEXT:  .LBB1_26:
; SSE41-NEXT:    pextrb $13, %xmm2, %ebx
; SSE41-NEXT:    pextrb $13, %xmm0, %edi
; SSE41-NEXT:    subb %bl, %dil
; SSE41-NEXT:    movl $0, %r13d
; SSE41-NEXT:    jb .LBB1_28
; SSE41-NEXT:  # %bb.27:
; SSE41-NEXT:    movl %edi, %r13d
; SSE41-NEXT:  .LBB1_28:
; SSE41-NEXT:    pextrb $14, %xmm2, %ebx
; SSE41-NEXT:    pextrb $14, %xmm0, %edi
; SSE41-NEXT:    subb %bl, %dil
; SSE41-NEXT:    movl $0, %r12d
; SSE41-NEXT:    jb .LBB1_30
; SSE41-NEXT:  # %bb.29:
; SSE41-NEXT:    movl %edi, %r12d
; SSE41-NEXT:  .LBB1_30:
; SSE41-NEXT:    movzbl %sil, %esi
; SSE41-NEXT:    pextrb $15, %xmm2, %ebx
; SSE41-NEXT:    pextrb $15, %xmm0, %edi
; SSE41-NEXT:    subb %bl, %dil
; SSE41-NEXT:    movl $0, %r15d
...
; SSE41-NEXT:    subb %dil, %sil
; SSE41-NEXT:    movl $0, %r10d
; SSE41-NEXT:    jb .LBB1_34
; SSE41-NEXT:  # %bb.33:
; SSE41-NEXT:    movl %esi, %r10d
; SSE41-NEXT:  .LBB1_34:
; SSE41-NEXT:    pinsrb $1, %ecx, %xmm0
; SSE41-NEXT:    movzbl {{[-0-9]+}}(%r{{[sb]}}p), %esi # 1-byte Folded Reload
; SSE41-NEXT:    movzbl %r10b, %ecx
; SSE41-NEXT:    pextrb $0, %xmm3, %ebx
; SSE41-NEXT:    pextrb $0, %xmm1, %edi
; SSE41-NEXT:    subb %bl, %dil
; SSE41-NEXT:    movl $0, %ebx
...
; AVX1-NEXT:  .LBB1_26:
; AVX1-NEXT:    movl %ebx, {{[-0-9]+}}(%r{{[sb]}}p) # 4-byte Spill
; AVX1-NEXT:    vpextrb $13, %xmm2, %ebx
; AVX1-NEXT:    vpextrb $13, %xmm3, %edi
; AVX1-NEXT:    subb %bl, %dil
...
; AVX1-NEXT:  .LBB1_28:
; AVX1-NEXT:    vpextrb $14, %xmm2, %ebx
; AVX1-NEXT:    vpextrb $14, %xmm3, %edi
; AVX1-NEXT:    subb %bl, %dil
...
; AVX1-NEXT:    vpextrb $15, %xmm2, %ebx
; AVX1-NEXT:    vpextrb $15, %xmm3, %edi
; AVX1-NEXT:    subb %bl, %dil
...
; AVX1-NEXT:    movzbl %dil, %ecx
; AVX1-NEXT:    vpextrb $0, %xmm1, %ebx
; AVX1-NEXT:    vpextrb $0, %xmm0, %edi
; AVX1-NEXT:    subb %bl, %dil
; AVX1-NEXT:    movl $0, %ebx
...
; AVX1-NEXT:    movl %edi, %ebx
; AVX1-NEXT:  .LBB1_36:
; AVX1-NEXT:    vpinsrb $2, %esi, %xmm2, %xmm2
...
; AVX2-NEXT:  .LBB1_14:
; AVX2-NEXT:    vpextrb $7, %xmm2, %ebx
; AVX2-NEXT:    vpextrb $7, %xmm3, %edi
; AVX2-NEXT:    subb %bl, %dil
...
; AVX2-NEXT:  .LBB1_26:
; AVX2-NEXT:    movl %ebx, {{[-0-9]+}}(%r{{[sb]}}p) # 4-byte Spill
; AVX2-NEXT:    vpextrb $13, %xmm2, %ebx
; AVX2-NEXT:    vpextrb $13, %xmm3, %edi
; AVX2-NEXT:    subb %bl, %dil
...
; AVX2-NEXT:  .LBB1_28:
; AVX2-NEXT:    vpextrb $14, %xmm2, %ebx
; AVX2-NEXT:    vpextrb $14, %xmm3, %edi
; AVX2-NEXT:    subb %bl, %dil
...
; AVX2-NEXT:    vpextrb $15, %xmm2, %ebx
; AVX2-NEXT:    vpextrb $15, %xmm3, %edi
; AVX2-NEXT:    subb %bl, %dil
...
; AVX2-NEXT:    movl %edi, %ebx
; AVX2-NEXT:  .LBB1_36:
; AVX2-NEXT:    vpinsrb $2, %esi, %xmm2, %xmm2
...
; AVX512-NEXT:  .LBB1_6:
; AVX512-NEXT:    vpextrb $3, %xmm2, %edx
...
; AVX512-NEXT:    subb %bpl, %dil
; AVX512-NEXT:    movl $0, %r10d
; AVX512-NEXT:    jb .LBB1_12
; AVX512-NEXT:  # %bb.11:
; AVX512-NEXT:    movl %edi, %r10d
; AVX512-NEXT:  .LBB1_12:
...
; AVX512-NEXT:    subb %bl, %dil
; AVX512-NEXT:    movl $0, %r11d
; AVX512-NEXT:    jb .LBB1_16
; AVX512-NEXT:  # %bb.15:
; AVX512-NEXT:    movl %edi, %r11d
; AVX512-NEXT:  .LBB1_16:
; AVX512-NEXT:    vpextrb $8, %xmm2, %ebx
; AVX512-NEXT:    vpextrb $8, %xmm3, %edi
; AVX512-NEXT:    subb %bl, %dil
...
; AVX512-NEXT:    movzbl %dil, %ecx
; AVX512-NEXT:    vpextrb $0, %xmm1, %ebx
; AVX512-NEXT:    vpextrb $0, %xmm0, %edi
; AVX512-NEXT:    subb %bl, %dil
; AVX512-NEXT:    movl $0, %ebx
...
; AVX512-NEXT:    movl %edi, %ebx
; AVX512-NEXT:  .LBB1_36:
; AVX512-NEXT:    vpinsrb $2, %esi, %xmm2, %xmm2
...
; SSE2-NEXT:    movzbl %r10b, %r10d
; SSE2-NEXT:    movzbl %r11b, %r11d
; SSE2-NEXT:    movzbl %r14b, %r14d
; SSE2-NEXT:    movzbl %r15b, %r15d
; SSE2-NEXT:    movzbl %r12b, %r12d
...
; SSE2-NEXT:    movdqa %xmm3, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; SSE2-NEXT:    punpcklbw {{.*#+}} xmm14 = xmm14[0],xmm11[0],xmm14[1],xmm11[1],xmm14[2],xmm11[2],xmm14[3],xmm11[3],xmm14[4],xmm11[4],xmm14[5],xmm11[5],xmm14[6],xmm11[6],xmm14[7],xmm11[7]
; SSE2-NEXT:    movdqa {{[-0-9]+}}(%r{{[sb]}}p), %xmm3 # 16-byte Reload
; SSE2-NEXT:    punpcklbw {{[-0-9]+}}(%r{{[sb]}}p), %xmm3 # 16-byte Folded Reload
; SSE2-NEXT:    # xmm3 = xmm3[0],mem[0],xmm3[1],mem[1],xmm3[2],mem[2],xmm3[3],mem[3],xmm3[4],mem[4],xmm3[5],mem[5],xmm3[6],mem[6],xmm3[7],mem[7]
; SSE2-NEXT:    movdqa %xmm3, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; SSE2-NEXT:    punpcklbw {{[-0-9]+}}(%r{{[sb]}}p), %xmm13 # 16-byte Folded Reload
; SSE2-NEXT:    # xmm13 = xmm13[0],mem[0],xmm13[1],mem[1],xmm13[2],mem[2],xmm13[3],mem[3],xmm13[4],mem[4],xmm13[5],mem[5],xmm13[6],mem[6],xmm13[7],mem[7]
; SSE2-NEXT:    movdqa {{[-0-9]+}}(%r{{[sb]}}p), %xmm3 # 16-byte Reload
; SSE2-NEXT:    punpcklbw {{[-0-9]+}}(%r{{[sb]}}p), %xmm3 # 16-byte Folded Reload
; SSE2-NEXT:    # xmm3 = xmm3[0],mem[0],xmm3[1],mem[1],xmm3[2],mem[2],xmm3[3],mem[3],xmm3[4],mem[4],xmm3[5],mem[5],xmm3[6],mem[6],xmm3[7],mem[7]
; SSE2-NEXT:    movdqa %xmm3, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
...
; SSE2-NEXT:    movdqa %xmm3, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; SSE2-NEXT:    movd %r11d, %xmm10
; SSE2-NEXT:    movd %r14d, %xmm3
; SSE2-NEXT:    movdqa %xmm3, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; SSE2-NEXT:    movd %eax, %xmm9
; SSE2-NEXT:    movd %r15d, %xmm3
; SSE2-NEXT:    movdqa %xmm3, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; SSE2-NEXT:    movd %r12d, %xmm11
; SSE2-NEXT:    movd %r13d, %xmm3
; SSE2-NEXT:    movdqa %xmm3, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
...
; SSE2-NEXT:    punpcklwd {{[-0-9]+}}(%r{{[sb]}}p), %xmm13 # 16-byte Folded Reload
; SSE2-NEXT:    # xmm13 = xmm13[0],mem[0],xmm13[1],mem[1],xmm13[2],mem[2],xmm13[3],mem[3]
; SSE2-NEXT:    punpcklwd {{[-0-9]+}}(%r{{[sb]}}p), %xmm1 # 16-byte Folded Reload
; SSE2-NEXT:    # xmm1 = xmm1[0],mem[0],xmm1[1],mem[1],xmm1[2],mem[2],xmm1[3],mem[3]
...
; SSSE3-NEXT:    movzbl %r10b, %r10d
; SSSE3-NEXT:    movzbl %r11b, %r11d
; SSSE3-NEXT:    movzbl %r14b, %r14d
; SSSE3-NEXT:    movzbl %r15b, %r15d
; SSSE3-NEXT:    movzbl %r12b, %r12d
...
; SSSE3-NEXT:  .LBB2_120:
; SSSE3-NEXT:    punpcklbw {{.*#+}} xmm4 = xmm4[0],xmm10[0],xmm4[1],xmm10[1],xmm4[2],xmm10[2],xmm4[3],xmm10[3],xmm4[4],xmm10[4],xmm4[5],xmm10[5],xmm4[6],xmm10[6],xmm4[7],xmm10[7]
...
; SSSE3-NEXT:    movdqa {{[-0-9]+}}(%r{{[sb]}}p), %xmm10 # 16-byte Reload
...
; SSSE3-NEXT:    movdqa %xmm10, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
...
; SSSE3-NEXT:    movdqa %xmm3, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; SSSE3-NEXT:    punpcklbw {{.*#+}} xmm14 = xmm14[0],xmm11[0],xmm14[1],xmm11[1],xmm14[2],xmm11[2],xmm14[3],xmm11[3],xmm14[4],xmm11[4],xmm14[5],xmm11[5],xmm14[6],xmm11[6],xmm14[7],xmm11[7]
; SSSE3-NEXT:    movdqa {{[-0-9]+}}(%r{{[sb]}}p), %xmm3 # 16-byte Reload
; SSSE3-NEXT:    punpcklbw {{[-0-9]+}}(%r{{[sb]}}p), %xmm3 # 16-byte Folded Reload
; SSSE3-NEXT:    # xmm3 = xmm3[0],mem[0],xmm3[1],mem[1],xmm3[2],mem[2],xmm3[3],mem[3],xmm3[4],mem[4],xmm3[5],mem[5],xmm3[6],mem[6],xmm3[7],mem[7]
; SSSE3-NEXT:    movdqa %xmm3, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; SSSE3-NEXT:    punpcklbw {{[-0-9]+}}(%r{{[sb]}}p), %xmm13 # 16-byte Folded Reload
; SSSE3-NEXT:    # xmm13 = xmm13[0],mem[0],xmm13[1],mem[1],xmm13[2],mem[2],xmm13[3],mem[3],xmm13[4],mem[4],xmm13[5],mem[5],xmm13[6],mem[6],xmm13[7],mem[7]
; SSSE3-NEXT:    movdqa {{[-0-9]+}}(%r{{[sb]}}p), %xmm3 # 16-byte Reload
; SSSE3-NEXT:    punpcklbw {{[-0-9]+}}(%r{{[sb]}}p), %xmm3 # 16-byte Folded Reload
; SSSE3-NEXT:    # xmm3 = xmm3[0],mem[0],xmm3[1],mem[1],xmm3[2],mem[2],xmm3[3],mem[3],xmm3[4],mem[4],xmm3[5],mem[5],xmm3[6],mem[6],xmm3[7],mem[7]
; SSSE3-NEXT:    movdqa %xmm3, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
...
; SSSE3-NEXT:    movdqa %xmm3, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; SSSE3-NEXT:    movd %r11d, %xmm10
; SSSE3-NEXT:    movd %r14d, %xmm3
; SSSE3-NEXT:    movdqa %xmm3, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; SSSE3-NEXT:    movd %eax, %xmm9
; SSSE3-NEXT:    movd %r15d, %xmm3
; SSSE3-NEXT:    movdqa %xmm3, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; SSSE3-NEXT:    movd %r12d, %xmm11
; SSSE3-NEXT:    movd %r13d, %xmm3
; SSSE3-NEXT:    movdqa %xmm3, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
...
; SSSE3-NEXT:    punpcklwd {{.*#+}} xmm15 = xmm15[0],xmm6[0],xmm15[1],xmm6[1],xmm15[2],xmm6[2],xmm15[3],xmm6[3]
...
; SSSE3-NEXT:    punpcklwd {{[-0-9]+}}(%r{{[sb]}}p), %xmm13 # 16-byte Folded Reload
; SSSE3-NEXT:    # xmm13 = xmm13[0],mem[0],xmm13[1],mem[1],xmm13[2],mem[2],xmm13[3],mem[3]
; SSSE3-NEXT:    punpcklwd {{[-0-9]+}}(%r{{[sb]}}p), %xmm1 # 16-byte Folded Reload
; SSSE3-NEXT:    # xmm1 = xmm1[0],mem[0],xmm1[1],mem[1],xmm1[2],mem[2],xmm1[3],mem[3]
...
; SSSE3-NEXT:    punpcklwd {{.*#+}} xmm5 = xmm5[0],xmm11[0],xmm5[1],xmm11[1],xmm5[2],xmm11[2],xmm5[3],xmm11[3]
; SSSE3-NEXT:    punpcklbw {{[-0-9]+}}(%r{{[sb]}}p), %xmm3 # 16-byte Folded Reload
; SSSE3-NEXT:    # xmm3 = xmm3[0],mem[0],xmm3[1],mem[1],xmm3[2],mem[2],xmm3[3],mem[3],xmm3[4],mem[4],xmm3[5],mem[5],xmm3[6],mem[6],xmm3[7],mem[7]
...
; SSE41-NEXT:    movl %ecx, {{[-0-9]+}}(%r{{[sb]}}p) # 4-byte Spill
...
; SSE41-NEXT:    movl %eax, %ecx
; SSE41-NEXT:  .LBB2_26:
; SSE41-NEXT:    movl %ecx, (%rsp) # 4-byte Spill
...
; SSE41-NEXT:    movzbl {{[-0-9]+}}(%r{{[sb]}}p), %eax # 1-byte Folded Reload
; SSE41-NEXT:    movd %ebp, %xmm1
; SSE41-NEXT:    movzbl %r9b, %esi
; SSE41-NEXT:    movd %ebx, %xmm2
; SSE41-NEXT:    pextrb $1, %xmm7, %edx
...
; SSE41-NEXT:    movzbl {{[-0-9]+}}(%r{{[sb]}}p), %ebx # 1-byte Folded Reload
; SSE41-NEXT:    pinsrb $2, %ebp, %xmm1
; SSE41-NEXT:    movzbl {{[-0-9]+}}(%r{{[sb]}}p), %ebp # 1-byte Folded Reload
; SSE41-NEXT:    pinsrb $2, %eax, %xmm2
; SSE41-NEXT:    movzbl %r8b, %edi
; SSE41-NEXT:    movzbl %dl, %eax
; SSE41-NEXT:    movd %eax, %xmm4
; SSE41-NEXT:    pinsrb $1, %esi, %xmm4
; SSE41-NEXT:    pextrb $2, %xmm7, %eax
; SSE41-NEXT:    pextrb $2, %xmm3, %ecx
...
; SSE41-NEXT:    movl %ecx, %eax
; SSE41-NEXT:  .LBB2_102:
; SSE41-NEXT:    pinsrb $3, %ebx, %xmm0
; SSE41-NEXT:    movzbl {{[-0-9]+}}(%r{{[sb]}}p), %esi # 1-byte Folded Reload
; SSE41-NEXT:    pinsrb $3, %ebp, %xmm1
; SSE41-NEXT:    movzbl {{[-0-9]+}}(%r{{[sb]}}p), %ebp # 1-byte Folded Reload
; SSE41-NEXT:    pinsrb $3, %edi, %xmm2
; SSE41-NEXT:    movzbl %r14b, %edi
; SSE41-NEXT:    movzbl %al, %eax
; SSE41-NEXT:    pinsrb $2, %eax, %xmm4
; SSE41-NEXT:    pextrb $3, %xmm7, %eax
; SSE41-NEXT:    pextrb $3, %xmm3, %ecx
; SSE41-NEXT:    subb %al, %cl
; SSE41-NEXT:    movl $0, %eax
...
; SSE41-NEXT:    pinsrb $4, %ebp, %xmm1
; SSE41-NEXT:    movzbl {{[-0-9]+}}(%r{{[sb]}}p), %esi # 1-byte Folded Reload
; SSE41-NEXT:    pinsrb $4, %edi, %xmm2
; SSE41-NEXT:    movzbl %r11b, %edi
; SSE41-NEXT:    movzbl %al, %eax
; SSE41-NEXT:    pinsrb $3, %eax, %xmm4
; SSE41-NEXT:    pextrb $4, %xmm7, %eax
; SSE41-NEXT:    pextrb $4, %xmm3, %ecx
; SSE41-NEXT:    subb %al, %cl
; SSE41-NEXT:    movl $0, %eax
...
; SSE41-NEXT:    pinsrb $5, %esi, %xmm1
; SSE41-NEXT:    movzbl {{[-0-9]+}}(%r{{[sb]}}p), %edx # 1-byte Folded Reload
; SSE41-NEXT:    pinsrb $5, %edi, %xmm2
; SSE41-NEXT:    movzbl %r13b, %esi
; SSE41-NEXT:    movzbl %al, %eax
; SSE41-NEXT:    pinsrb $4, %eax, %xmm4
; SSE41-NEXT:    pextrb $5, %xmm7, %edi
; SSE41-NEXT:    pextrb $5, %xmm3, %eax
...
; SSE41-NEXT:    movzbl {{[-0-9]+}}(%r{{[sb]}}p), %ecx # 1-byte Folded Reload
; SSE41-NEXT:    pinsrb $6, %esi, %xmm2
; SSE41-NEXT:    movzbl %r12b, %edx
; SSE41-NEXT:    movzbl %dil, %esi
; SSE41-NEXT:    pinsrb $5, %esi, %xmm4
; SSE41-NEXT:    pextrb $6, %xmm7, %esi
; SSE41-NEXT:    pextrb $6, %xmm3, %edi
; SSE41-NEXT:    subb %sil, %dil
; SSE41-NEXT:    movl $0, %esi
; SSE41-NEXT:    jb .LBB2_110
; SSE41-NEXT:  # %bb.109:
; SSE41-NEXT:    movl %edi, %esi
; SSE41-NEXT:  .LBB2_110:
; SSE41-NEXT:    pinsrb $7, %eax, %xmm0
; SSE41-NEXT:    movzbl {{[-0-9]+}}(%r{{[sb]}}p), %eax # 1-byte Folded Reload
...
; SSE41-NEXT:    movzbl %r15b, %edx
; SSE41-NEXT:    movzbl %sil, %esi
; SSE41-NEXT:    pinsrb $6, %esi, %xmm4
; SSE41-NEXT:    pextrb $7, %xmm7, %esi
; SSE41-NEXT:    pextrb $7, %xmm3, %edi
; SSE41-NEXT:    subb %sil, %dil
; SSE41-NEXT:    movl $0, %esi
...
; SSE41-NEXT:    pextrb $8, %xmm7, %esi
; SSE41-NEXT:    pextrb $8, %xmm3, %edi
; SSE41-NEXT:    subb %sil, %dil
; SSE41-NEXT:    movl $0, %esi
...
; SSE41-NEXT:    pextrb $9, %xmm7, %esi
; SSE41-NEXT:    pextrb $9, %xmm3, %edi
; SSE41-NEXT:    subb %sil, %dil
; SSE41-NEXT:    movl $0, %esi
...
; SSE41-NEXT:    pextrb $10, %xmm7, %esi
; SSE41-NEXT:    pextrb $10, %xmm3, %edi
; SSE41-NEXT:    subb %sil, %dil
; SSE41-NEXT:    movl $0, %esi
...
; SSE41-NEXT:    pextrb $11, %xmm7, %esi
; SSE41-NEXT:    pextrb $11, %xmm3, %edi
; SSE41-NEXT:    subb %sil, %dil
; SSE41-NEXT:    movl $0, %esi
...
; SSE41-NEXT:    pextrb $12, %xmm7, %esi
; SSE41-NEXT:    pextrb $12, %xmm3, %edi
; SSE41-NEXT:    subb %sil, %dil
; SSE41-NEXT:    movl $0, %esi
...
; SSE41-NEXT:    pextrb $14, %xmm7, %esi
; SSE41-NEXT:    pextrb $14, %xmm3, %edi
; SSE41-NEXT:    subb %sil, %dil
; SSE41-NEXT:    movl $0, %esi
; SSE41-NEXT:    leaq {{[0-9]+}}(%rsp), %rsp
; SSE41-NEXT:    popq %rbx
; SSE41-NEXT:    popq %r12
; SSE41-NEXT:    popq %r13
; SSE41-NEXT:    popq %r14
...
; AVX1-NEXT:    movl %eax, %ecx
; AVX1-NEXT:  .LBB2_28:
; AVX1-NEXT:    movl %ecx, (%rsp) # 4-byte Spill
...
; AVX1-NEXT:  .LBB2_94:
; AVX1-NEXT:    movl %ecx, {{[-0-9]+}}(%r{{[sb]}}p) # 4-byte Spill
; AVX1-NEXT:    movzbl {{[-0-9]+}}(%r{{[sb]}}p), %esi # 1-byte Folded Reload
; AVX1-NEXT:    vmovd %edi, %xmm5
; AVX1-NEXT:    vpinsrb $1, %ebx, %xmm4, %xmm4
; AVX1-NEXT:    movzbl {{[-0-9]+}}(%r{{[sb]}}p), %edi # 1-byte Folded Reload
; AVX1-NEXT:    movzbl %dl, %ebp
...
; AVX1-NEXT:  .LBB2_96:
; AVX1-NEXT:    movl %ecx, {{[-0-9]+}}(%r{{[sb]}}p) # 4-byte Spill
; AVX1-NEXT:    vpinsrb $1, %esi, %xmm5, %xmm0
; AVX1-NEXT:    movzbl {{[-0-9]+}}(%r{{[sb]}}p), %esi # 1-byte Folded Reload
; AVX1-NEXT:    vpinsrb $2, %edi, %xmm4, %xmm2
; AVX1-NEXT:    movzbl {{[-0-9]+}}(%r{{[sb]}}p), %ebx # 1-byte Folded Reload
...
; AVX1-NEXT:    subb %al, %dil
; AVX1-NEXT:    movl $0, %eax
; AVX1-NEXT:    movl {{[-0-9]+}}(%r{{[sb]}}p), %ecx # 4-byte Reload
...
; AVX1-NEXT:    vpinsrb $3, %ebx, %xmm2, %xmm2
; AVX1-NEXT:    movzbl {{[-0-9]+}}(%r{{[sb]}}p), %ebp # 1-byte Folded Reload
; AVX1-NEXT:    vpinsrb $1, %edx, %xmm4, %xmm4
; AVX1-NEXT:    movzbl %r10b, %edi
; AVX1-NEXT:    movzbl %al, %edx
...
; AVX1-NEXT:    movzbl {{[-0-9]+}}(%r{{[sb]}}p), %esi # 1-byte Folded Reload
; AVX1-NEXT:    vpinsrb $4, %ebp, %xmm2, %xmm2
; AVX1-NEXT:    movzbl {{[-0-9]+}}(%r{{[sb]}}p), %ebx # 1-byte Folded Reload
; AVX1-NEXT:    vpinsrb $2, %edi, %xmm4, %xmm4
; AVX1-NEXT:    movzbl %r8b, %ebp
; AVX1-NEXT:    movzbl %cl, %eax
; AVX1-NEXT:    vmovd %eax, %xmm5
; AVX1-NEXT:    vpinsrb $1, %edx, %xmm5, %xmm5
; AVX1-NEXT:    vpextrb $2, %xmm3, %eax
...
; AVX1-NEXT:    vpinsrb $5, %ebx, %xmm2, %xmm2
; AVX1-NEXT:    movzbl {{[-0-9]+}}(%r{{[sb]}}p), %esi # 1-byte Folded Reload
; AVX1-NEXT:    vpinsrb $3, %ebp, %xmm4, %xmm4
; AVX1-NEXT:    movzbl %r11b, %ebp
; AVX1-NEXT:    movzbl %al, %eax
; AVX1-NEXT:    vpinsrb $2, %eax, %xmm5, %xmm5
; AVX1-NEXT:    vpextrb $3, %xmm3, %eax
...
; AVX1-NEXT:    vpinsrb $6, %esi, %xmm2, %xmm2
; AVX1-NEXT:    movzbl {{[-0-9]+}}(%r{{[sb]}}p), %edx # 1-byte Folded Reload
; AVX1-NEXT:    vpinsrb $4, %ebp, %xmm4, %xmm4
; AVX1-NEXT:    movzbl %r13b, %esi
; AVX1-NEXT:    movzbl %al, %eax
; AVX1-NEXT:    vpinsrb $3, %eax, %xmm5, %xmm5
; AVX1-NEXT:    vpextrb $4, %xmm3, %edi
...
; AVX1-NEXT:    movzbl {{[-0-9]+}}(%r{{[sb]}}p), %ecx # 1-byte Folded Reload
; AVX1-NEXT:    vpinsrb $5, %esi, %xmm4, %xmm4
; AVX1-NEXT:    movzbl %r12b, %edx
; AVX1-NEXT:    movzbl %dil, %esi
; AVX1-NEXT:    vpinsrb $4, %esi, %xmm5, %xmm5
; AVX1-NEXT:    vpextrb $5, %xmm3, %esi
; AVX1-NEXT:    vpextrb $5, %xmm1, %edi
; AVX1-NEXT:    subb %sil, %dil
; AVX1-NEXT:    movl $0, %esi
...
; AVX1-NEXT:    vpextrb $8, %xmm3, %esi
; AVX1-NEXT:    vpextrb $8, %xmm1, %edi
; AVX1-NEXT:    subb %sil, %dil
; AVX1-NEXT:    movl $0, %esi
...
; AVX1-NEXT:    vpextrb $12, %xmm3, %esi
; AVX1-NEXT:    vpextrb $12, %xmm1, %edi
; AVX1-NEXT:    subb %sil, %dil
; AVX1-NEXT:    movl $0, %esi
...
; AVX2-NEXT:    movl %eax, %ecx
; AVX2-NEXT:  .LBB2_28:
; AVX2-NEXT:    movl %ecx, (%rsp) # 4-byte Spill
...
; AVX2-NEXT:    movzbl %sil, %ebx
; AVX2-NEXT:    vmovd %ebp, %xmm4
; AVX2-NEXT:    vpextrb $14, %xmm0, %ecx
...
; AVX2-NEXT:    vpinsrb $1, %ebx, %xmm4, %xmm4
; AVX2-NEXT:    movzbl {{[-0-9]+}}(%r{{[sb]}}p), %edi # 1-byte Folded Reload
; AVX2-NEXT:    movzbl %dl, %ebp
...
; AVX2-NEXT:  .LBB2_96:
; AVX2-NEXT:    movl %ecx, {{[-0-9]+}}(%r{{[sb]}}p) # 4-byte Spill
; AVX2-NEXT:    vpinsrb $1, %esi, %xmm5, %xmm0
; AVX2-NEXT:    movzbl {{[-0-9]+}}(%r{{[sb]}}p), %esi # 1-byte Folded Reload
; AVX2-NEXT:    vpinsrb $2, %edi, %xmm4, %xmm2
; AVX2-NEXT:    movzbl {{[-0-9]+}}(%r{{[sb]}}p), %ebx # 1-byte Folded Reload
...
; AVX2-NEXT:    vpinsrb $3, %ebx, %xmm2, %xmm2
; AVX2-NEXT:    movzbl {{[-0-9]+}}(%r{{[sb]}}p), %ebp # 1-byte Folded Reload
; AVX2-NEXT:    vpinsrb $1, %edx, %xmm4, %xmm4
...
; AVX2-NEXT:    movzbl {{[-0-9]+}}(%r{{[sb]}}p), %esi # 1-byte Folded Reload
; AVX2-NEXT:    vpinsrb $4, %ebp, %xmm2, %xmm2
; AVX2-NEXT:    movzbl {{[-0-9]+}}(%r{{[sb]}}p), %ebx # 1-byte Folded Reload
; AVX2-NEXT:    vpinsrb $2, %edi, %xmm4, %xmm4
; AVX2-NEXT:    movzbl %r8b, %ebp
; AVX2-NEXT:    movzbl %cl, %eax
; AVX2-NEXT:    vmovd %eax, %xmm5
; AVX2-NEXT:    vpinsrb $1, %edx, %xmm5, %xmm5
; AVX2-NEXT:    vpextrb $2, %xmm3, %eax
...
; AVX2-NEXT:    vpinsrb $5, %ebx, %xmm2, %xmm2
; AVX2-NEXT:    movzbl {{[-0-9]+}}(%r{{[sb]}}p), %esi # 1-byte Folded Reload
...
; AVX2-NEXT:    vpinsrb $6, %esi, %xmm2, %xmm2
; AVX2-NEXT:    movzbl {{[-0-9]+}}(%r{{[sb]}}p), %edx # 1-byte Folded Reload
; AVX2-NEXT:    vpinsrb $4, %ebp, %xmm4, %xmm4
; AVX2-NEXT:    movzbl %r13b, %esi
; AVX2-NEXT:    movzbl %al, %eax
...
; AVX2-NEXT:    movzbl {{[-0-9]+}}(%r{{[sb]}}p), %ecx # 1-byte Folded Reload
; AVX2-NEXT:    vpinsrb $5, %esi, %xmm4, %xmm4
...
; AVX2-NEXT:    vpextrb $8, %xmm3, %esi
; AVX2-NEXT:    vpextrb $8, %xmm1, %edi
; AVX2-NEXT:    subb %sil, %dil
; AVX2-NEXT:    movl $0, %esi
...
; AVX512-NEXT:    pushq %r12
; AVX512-NEXT:    pushq %rbx
; AVX512-NEXT:    subq $12, %rsp
; AVX512-NEXT:    movl %ecx, {{[-0-9]+}}(%r{{[sb]}}p) # 4-byte Spill
...
; AVX512-NEXT:    movl %eax, %ecx
; AVX512-NEXT:  .LBB2_28:
; AVX512-NEXT:    movl %ecx, (%rsp) # 4-byte Spill
...
; AVX512-NEXT:    movzbl %sil, %ebx
; AVX512-NEXT:    vmovd %ebp, %xmm4
; AVX512-NEXT:    vpextrb $14, %xmm2, %ecx
; AVX512-NEXT:    vpextrb $14, %xmm3, %eax
; AVX512-NEXT:    subb %cl, %al
; AVX512-NEXT:    movl $0, %ecx
...
; AVX512-NEXT:    vpinsrb $1, %ebx, %xmm4, %xmm4
; AVX512-NEXT:    movzbl {{[-0-9]+}}(%r{{[sb]}}p), %edi # 1-byte Folded Reload
; AVX512-NEXT:    movzbl %dl, %ebp
; AVX512-NEXT:    vpextrb $15, %xmm2, %ecx
; AVX512-NEXT:    vpextrb $15, %xmm3, %eax
; AVX512-NEXT:    subb %cl, %al
; AVX512-NEXT:    movl $0, %ecx
...
; AVX512-NEXT:  .LBB2_96:
; AVX512-NEXT:    movl %ecx, {{[-0-9]+}}(%r{{[sb]}}p) # 4-byte Spill
; AVX512-NEXT:    vpinsrb $1, %esi, %xmm5, %xmm2
; AVX512-NEXT:    movzbl {{[-0-9]+}}(%r{{[sb]}}p), %esi # 1-byte Folded Reload
; AVX512-NEXT:    vpinsrb $2, %edi, %xmm4, %xmm3
; AVX512-NEXT:    movzbl {{[-0-9]+}}(%r{{[sb]}}p), %ebx # 1-byte Folded Reload
...
; AVX512-NEXT:    subb %al, %dil
; AVX512-NEXT:    movl $0, %eax
; AVX512-NEXT:    movl {{[-0-9]+}}(%r{{[sb]}}p), %ecx # 4-byte Reload
; AVX512-NEXT:    jb .LBB2_98
; AVX512-NEXT:  # %bb.97:
; AVX512-NEXT:    movl %edi, %eax
; AVX512-NEXT:  .LBB2_98:
; AVX512-NEXT:    vpinsrb $2, %esi, %xmm2, %xmm2
; AVX512-NEXT:    movzbl %cl, %esi
; AVX512-NEXT:    vpinsrb $3, %ebx, %xmm3, %xmm3
; AVX512-NEXT:    movzbl {{[-0-9]+}}(%r{{[sb]}}p), %ebp # 1-byte Folded Reload
; AVX512-NEXT:    vpinsrb $1, %edx, %xmm4, %xmm4
; AVX512-NEXT:    movzbl %r10b, %edi
...
; AVX512-NEXT:    vpinsrb $3, %esi, %xmm2, %xmm2
; AVX512-NEXT:    movzbl {{[-0-9]+}}(%r{{[sb]}}p), %esi # 1-byte Folded Reload
; AVX512-NEXT:    vpinsrb $4, %ebp, %xmm3, %xmm3
; AVX512-NEXT:    movzbl {{[-0-9]+}}(%r{{[sb]}}p), %ebx # 1-byte Folded Reload
; AVX512-NEXT:    vpinsrb $2, %edi, %xmm4, %xmm4
; AVX512-NEXT:    movzbl %r8b, %ebp
; AVX512-NEXT:    movzbl %cl, %eax
; AVX512-NEXT:    vmovd %eax, %xmm5
; AVX512-NEXT:    vpinsrb $1, %edx, %xmm5, %xmm5
...
; AVX512-NEXT:    vpinsrb $4, %esi, %xmm2, %xmm2
; AVX512-NEXT:    movzbl {{[-0-9]+}}(%r{{[sb]}}p), %edx # 1-byte Folded Reload
; AVX512-NEXT:    vpinsrb $5, %ebx, %xmm3, %xmm3
; AVX512-NEXT:    movzbl {{[-0-9]+}}(%r{{[sb]}}p), %esi # 1-byte Folded Reload
; AVX512-NEXT:    vpinsrb $3, %ebp, %xmm4, %xmm4
...
; AVX512-NEXT:    vpinsrb $5, %edx, %xmm2, %xmm2
; AVX512-NEXT:    movzbl {{[-0-9]+}}(%r{{[sb]}}p), %ecx # 1-byte Folded Reload
; AVX512-NEXT:    vpinsrb $6, %esi, %xmm3, %xmm3
; AVX512-NEXT:    movzbl {{[-0-9]+}}(%r{{[sb]}}p), %edx # 1-byte Folded Reload
; AVX512-NEXT:    vpinsrb $4, %ebp, %xmm4, %xmm4
; AVX512-NEXT:    movzbl %r13b, %esi
; AVX512-NEXT:    movzbl %al, %eax
; AVX512-NEXT:    vpinsrb $3, %eax, %xmm5, %xmm5
; AVX512-NEXT:    vpextrb $4, %xmm1, %edi
; AVX512-NEXT:    vpextrb $4, %xmm0, %eax
; AVX512-NEXT:    subb %dil, %al
; AVX512-NEXT:    movl $0, %edi
...
; AVX512-NEXT:    movzbl {{[-0-9]+}}(%r{{[sb]}}p), %eax # 1-byte Folded Reload
; AVX512-NEXT:    vpinsrb $7, %edx, %xmm3, %xmm3
; AVX512-NEXT:    movzbl {{[-0-9]+}}(%r{{[sb]}}p), %ecx # 1-byte Folded Reload
; AVX512-NEXT:    vpinsrb $5, %esi, %xmm4, %xmm4
; AVX512-NEXT:    movzbl %r12b, %edx
; AVX512-NEXT:    movzbl %dil, %esi
; AVX512-NEXT:    vpinsrb $4, %esi, %xmm5, %xmm5
; AVX512-NEXT:    vpextrb $5, %xmm1, %esi
; AVX512-NEXT:    vpextrb $5, %xmm0, %edi
; AVX512-NEXT:    subb %sil, %dil
; AVX512-NEXT:    movl $0, %esi
...
; AVX512-NEXT:    movzbl %r15b, %edx
; AVX512-NEXT:    movzbl %sil, %esi
; AVX512-NEXT:    vpinsrb $5, %esi, %xmm5, %xmm5
; AVX512-NEXT:    vpextrb $6, %xmm1, %esi
...
; AVX512-NEXT:    vpextrb $7, %xmm1, %esi
...
; AVX512-NEXT:    vpextrb $8, %xmm1, %esi
...
; AVX512-NEXT:    vpextrb $9, %xmm1, %esi
...
; AVX512-NEXT:    vpextrb $10, %xmm1, %esi
...
; AVX512-NEXT:    vpextrb $11, %xmm1, %esi
...
; AVX512-NEXT:    vpextrb $12, %xmm1, %esi
...
; AVX-NEXT:    vpinsrw $1, %edx, %xmm2, %xmm2
...
; AVX1:       # %bb.0:
; AVX1-NEXT:    vextractf128 $1, %ymm2, %xmm4
; AVX1-NEXT:    vpextrw $1, %xmm4, %ecx
; AVX1-NEXT:    vextractf128 $1, %ymm0, %xmm5
; AVX1-NEXT:    vpextrw $1, %xmm5, %edx
; AVX1-NEXT:    xorl %eax, %eax
; AVX1-NEXT:    subw %cx, %dx
; AVX1-NEXT:    cmovbl %eax, %edx
...
; AVX1-NEXT:    vpinsrw $1, %edx, %xmm6, %xmm6
...
; AVX2:       # %bb.0:
; AVX2-NEXT:    vextracti128 $1, %ymm2, %xmm4
; AVX2-NEXT:    vpextrw $1, %xmm4, %ecx
; AVX2-NEXT:    vextracti128 $1, %ymm0, %xmm5
; AVX2-NEXT:    vpextrw $1, %xmm5, %edx
; AVX2-NEXT:    xorl %eax, %eax
; AVX2-NEXT:    subw %cx, %dx
; AVX2-NEXT:    cmovbl %eax, %edx
...
; AVX2-NEXT:    vpinsrw $1, %edx, %xmm6, %xmm6
...
; SSE41-NEXT:    subw %cx, %di
; SSE41-NEXT:    cmovbl %eax, %edi
; SSE41-NEXT:    movd %edi, %xmm2
; SSE41-NEXT:    pinsrw $1, %esi, %xmm2
; SSE41-NEXT:    pextrw $2, %xmm1, %ecx
...
; AVX1-NEXT:    subw %cx, %di
; AVX1-NEXT:    cmovbl %eax, %edi
; AVX1-NEXT:    vmovd %edi, %xmm2
; AVX1-NEXT:    vpinsrw $1, %esi, %xmm2, %xmm2
...
; AVX2-NEXT:    subw %cx, %di
; AVX2-NEXT:    cmovbl %eax, %edi
; AVX2-NEXT:    vmovd %edi, %xmm2
; AVX2-NEXT:    vpinsrw $1, %esi, %xmm2, %xmm2
...
; AVX512-NEXT:    subw %cx, %di
; AVX512-NEXT:    cmovbl %eax, %edi
; AVX512-NEXT:    vmovd %edi, %xmm2
; AVX512-NEXT:    vpinsrw $1, %esi, %xmm2, %xmm2
...
; SSE41-NEXT:    cmovbl %esi, %ecx
; SSE41-NEXT:    movd %xmm1, %eax
; SSE41-NEXT:    movd %xmm0, %edi
; SSE41-NEXT:    subl %eax, %edi
; SSE41-NEXT:    cmovbl %esi, %edi
; SSE41-NEXT:    movd %edi, %xmm2
...
; AVX1-NEXT:    subl %eax, %ecx
; AVX1-NEXT:    cmovbl %esi, %ecx
; AVX1-NEXT:    vmovd %xmm1, %eax
; AVX1-NEXT:    vmovd %xmm0, %edi
; AVX1-NEXT:    subl %eax, %edi
; AVX1-NEXT:    cmovbl %esi, %edi
; AVX1-NEXT:    vmovd %edi, %xmm2
...
; AVX512-NEXT:    cmovbl %esi, %ecx
; AVX512-NEXT:    vmovd %xmm1, %eax
; AVX512-NEXT:    vmovd %xmm0, %edi
; AVX512-NEXT:    subl %eax, %edi
; AVX512-NEXT:    cmovbl %esi, %edi
; AVX512-NEXT:    vmovd %edi, %xmm2
...
; AVX512-NEXT:    subl %eax, %ecx
; AVX512-NEXT:    cmovbl %esi, %ecx
; AVX512-NEXT:    vpinsrd $3, %ecx, %xmm2, %xmm0
