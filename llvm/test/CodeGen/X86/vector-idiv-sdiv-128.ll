...
; SSE2:       # %bb.0:
; SSE2-NEXT:    movdqa {{.*#+}} xmm2 = [1,1,0,0,1,0,0,1,1,0,0,1,0,0,0,1]
...
; SSE2-NEXT:    movdqa {{.*#+}} xmm0 = [147,129,57,103,187,43,79,147,147,79,43,187,103,57,57,147]
; SSE2-NEXT:    punpckhbw {{.*#+}} xmm2 = xmm2[8],xmm0[8],xmm2[9],xmm0[9],xmm2[10],xmm0[10],xmm2[11],xmm0[11],xmm2[12],xmm0[12],xmm2[13],xmm0[13],xmm2[14],xmm0[14],xmm2[15],xmm0[15]
; SSE2-NEXT:    psraw $8, %xmm2
...
; SSE41-NEXT:    movdqa {{.*#+}} xmm2 = [1,1,0,0,1,0,0,1,1,0,0,1,0,0,0,1]
...
; AVX1:       # %bb.0:
; AVX1-NEXT:    vmovdqa {{.*#+}} xmm1 = [1,1,0,0,1,0,0,1,1,0,0,1,0,0,0,1]
...
; SSE2-NEXT:    movdqa {{.*#+}} xmm2 = [147,129,57,103,187,43,79,147,147,79,43,187,103,57,57,147]
...
; SSE2-NEXT:    movdqa %xmm2, %xmm3
; SSE2-NEXT:    punpckhbw {{.*#+}} xmm3 = xmm3[8],xmm0[8],xmm3[9],xmm0[9],xmm3[10],xmm0[10],xmm3[11],xmm0[11],xmm3[12],xmm0[12],xmm3[13],xmm0[13],xmm3[14],xmm0[14],xmm3[15],xmm0[15]
; SSE2-NEXT:    movdqa {{.*#+}} xmm4 = [7,8,9,10,11,12,13,14,14,13,12,11,10,9,9,7]
...
; SSE41:       # %bb.0:
; SSE41-NEXT:    movdqa {{.*#+}} xmm1 = [1,1,0,0,1,0,0,1,1,0,0,1,0,0,0,1]
; SSE41-NEXT:    punpckhbw {{.*#+}} xmm1 = xmm1[8],xmm0[8],xmm1[9],xmm0[9],xmm1[10],xmm0[10],xmm1[11],xmm0[11],xmm1[12],xmm0[12],xmm1[13],xmm0[13],xmm1[14],xmm0[14],xmm1[15],xmm0[15]
; SSE41-NEXT:    movdqa %xmm0, %xmm2
; SSE41-NEXT:    punpckhbw {{.*#+}} xmm2 = xmm2[8],xmm0[8],xmm2[9],xmm0[9],xmm2[10],xmm0[10],xmm2[11],xmm0[11],xmm2[12],xmm0[12],xmm2[13],xmm0[13],xmm2[14],xmm0[14],xmm2[15],xmm0[15]
...
; SSE41-NEXT:    punpckhbw {{.*#+}} xmm2 = xmm2[8],xmm0[8],xmm2[9],xmm0[9],xmm2[10],xmm0[10],xmm2[11],xmm0[11],xmm2[12],xmm0[12],xmm2[13],xmm0[13],xmm2[14],xmm0[14],xmm2[15],xmm0[15]
; SSE41-NEXT:    movdqa {{.*#+}} xmm4 = [7,8,9,10,11,12,13,14,14,13,12,11,10,9,9,7]
...
; AVX1-NEXT:    vmovdqa {{.*#+}} xmm4 = [7,8,9,10,11,12,13,14,14,13,12,11,10,9,9,7]
