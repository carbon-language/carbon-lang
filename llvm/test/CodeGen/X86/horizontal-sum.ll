...
; AVX2-SLOW-NEXT:    retq
;
; AVX2-FAST-LABEL: pair_sum_v4f32_v4f32:
; AVX2-FAST:       # %bb.0:
; AVX2-FAST-NEXT:    vhaddps %xmm0, %xmm0, %xmm0
; AVX2-FAST-NEXT:    vhaddps %xmm1, %xmm1, %xmm1
; AVX2-FAST-NEXT:    vhaddps %xmm1, %xmm0, %xmm0
; AVX2-FAST-NEXT:    vhaddps %xmm2, %xmm2, %xmm1
; AVX2-FAST-NEXT:    vhaddps %xmm1, %xmm1, %xmm1
; AVX2-FAST-NEXT:    vshufps {{.*#+}} xmm0 = xmm0[0,2],xmm1[0,3]
; AVX2-FAST-NEXT:    vhaddps %xmm3, %xmm3, %xmm1
; AVX2-FAST-NEXT:    vhaddps %xmm1, %xmm1, %xmm1
; AVX2-FAST-NEXT:    vinsertps {{.*#+}} xmm0 = xmm0[0,1,2],xmm1[0]
; AVX2-FAST-NEXT:    retq
...
; AVX1-FAST-NEXT:    vpshufd {{.*#+}} xmm0 = xmm0[0,2,1,3]
...
; SSSE3-FAST-NEXT:    haddps %xmm1, %xmm1
; SSSE3-FAST-NEXT:    haddps %xmm1, %xmm0
; SSSE3-FAST-NEXT:    shufps {{.*#+}} xmm0 = xmm0[0,2,1,3]
...
; AVX1-FAST-NEXT:    vhaddps %xmm6, %xmm6, %xmm2
; AVX1-FAST-NEXT:    vhaddps %xmm7, %xmm7, %xmm3
; AVX1-FAST-NEXT:    vhaddps %xmm3, %xmm2, %xmm2
; AVX1-FAST-NEXT:    vpermilps {{.*#+}} xmm2 = xmm2[0,2,2,3]
...
; AVX2-FAST-NEXT:    vshufps {{.*#+}} xmm0 = xmm0[0,2],xmm1[0,1]
; AVX2-FAST-NEXT:    vpermilpd {{.*#+}} xmm1 = xmm1[1,0]
; AVX2-FAST-NEXT:    vinsertf128 $1, %xmm1, %ymm0, %ymm1
; AVX2-FAST-NEXT:    vhaddps %xmm6, %xmm6, %xmm2
; AVX2-FAST-NEXT:    vhaddps %xmm7, %xmm7, %xmm3
; AVX2-FAST-NEXT:    vhaddps %xmm3, %xmm2, %xmm2
; AVX2-FAST-NEXT:    vpermilps {{.*#+}} xmm2 = xmm2[0,2,2,3]
...
; SSSE3-FAST-NEXT:    phaddd %xmm1, %xmm1
; SSSE3-FAST-NEXT:    phaddd %xmm1, %xmm0
; SSSE3-FAST-NEXT:    pshufd {{.*#+}} xmm0 = xmm0[0,2,1,3]
...
; AVX1-FAST-NEXT:    vphaddd %xmm1, %xmm1, %xmm1
; AVX1-FAST-NEXT:    vphaddd %xmm1, %xmm0, %xmm0
; AVX1-FAST-NEXT:    vpshufd {{.*#+}} xmm8 = xmm0[0,2,1,3]
...
; AVX1-FAST-NEXT:    vphaddd %xmm6, %xmm6, %xmm2
; AVX1-FAST-NEXT:    vphaddd %xmm7, %xmm7, %xmm3
; AVX1-FAST-NEXT:    vphaddd %xmm3, %xmm2, %xmm2
; AVX1-FAST-NEXT:    vpshufd {{.*#+}} xmm2 = xmm2[0,2,2,3]
...
; AVX2-FAST-NEXT:    vphaddd %xmm1, %xmm1, %xmm1
; AVX2-FAST-NEXT:    vphaddd %xmm1, %xmm0, %xmm0
; AVX2-FAST-NEXT:    vpshufd {{.*#+}} xmm0 = xmm0[0,2,1,3]
...
; AVX2-FAST-NEXT:    vphaddd %xmm6, %xmm6, %xmm1
; AVX2-FAST-NEXT:    vphaddd %xmm7, %xmm7, %xmm2
; AVX2-FAST-NEXT:    vphaddd %xmm2, %xmm1, %xmm1
; AVX2-FAST-NEXT:    vpshufd {{.*#+}} xmm1 = xmm1[0,2,2,3]
