...
; SSE41-NEXT:    subb %bl, %dl
; SSE41-NEXT:    setns %dl
; SSE41-NEXT:    subb %bl, %cl
...
; AVX1-NEXT:    subb %bl, %dl
; AVX1-NEXT:    setns %dl
; AVX1-NEXT:    subb %bl, %cl
...
; AVX2-NEXT:    subb %bl, %dl
; AVX2-NEXT:    setns %dl
; AVX2-NEXT:    subb %bl, %cl
...
; AVX512-NEXT:    subb %bl, %dl
; AVX512-NEXT:    setns %dl
; AVX512-NEXT:    subb %bl, %cl
...
; AVX512-NEXT:    subb %sil, %bl
; AVX512-NEXT:    setns %bl
; AVX512-NEXT:    subb %sil, %dl
...
; SSE2-NEXT:    movl %r8d, %edx
; SSE2-NEXT:    subw %ax, %dx
; SSE2-NEXT:    setns %cl
; SSE2-NEXT:    addl $32767, %ecx # imm = 0x7FFF
; SSE2-NEXT:    subw %ax, %r8w
...
; SSE2-NEXT:    subw %dx, %bx
; SSE2-NEXT:    setns %sil
; SSE2-NEXT:    addl $32767, %esi # imm = 0x7FFF
; SSE2-NEXT:    subw %dx, %cx
...
; SSSE3-NEXT:    movl %r8d, %edx
; SSSE3-NEXT:    subw %ax, %dx
; SSSE3-NEXT:    setns %cl
; SSSE3-NEXT:    addl $32767, %ecx # imm = 0x7FFF
; SSSE3-NEXT:    subw %ax, %r8w
...
; SSE41-NEXT:    subw %ax, %dx
; SSE41-NEXT:    setns %cl
; SSE41-NEXT:    addl $32767, %ecx # imm = 0x7FFF
; SSE41-NEXT:    subw %ax, %r8w
...
; SSE41-NEXT:    subw %ax, %si
; SSE41-NEXT:    setns %dl
; SSE41-NEXT:    addl $32767, %edx # imm = 0x7FFF
; SSE41-NEXT:    subw %ax, %r9w
...
; AVX1-NEXT:    subw %ax, %dx
; AVX1-NEXT:    setns %cl
; AVX1-NEXT:    addl $32767, %ecx # imm = 0x7FFF
; AVX1-NEXT:    subw %ax, %si
...
; AVX2-NEXT:    subw %ax, %dx
; AVX2-NEXT:    setns %cl
; AVX2-NEXT:    addl $32767, %ecx # imm = 0x7FFF
; AVX2-NEXT:    subw %ax, %si
...
; AVX512-NEXT:    subw %ax, %dx
; AVX512-NEXT:    setns %cl
; AVX512-NEXT:    addl $32767, %ecx # imm = 0x7FFF
; AVX512-NEXT:    subw %ax, %si
...
; SSE2-NEXT:    subl %esi, %ecx
; SSE2-NEXT:    setns %dil
; SSE2-NEXT:    addl $2147483647, %edi # imm = 0x7FFFFFFF
; SSE2-NEXT:    subl %esi, %r10d
...
; SSE2-NEXT:    xorl %esi, %esi
; SSE2-NEXT:    movl %eax, %edi
; SSE2-NEXT:    subl %r9d, %edi
; SSE2-NEXT:    setns %sil
; SSE2-NEXT:    addl $2147483647, %esi # imm = 0x7FFFFFFF
; SSE2-NEXT:    subl %r9d, %eax
...
; SSSE3-NEXT:    subl %esi, %ecx
; SSSE3-NEXT:    setns %dil
; SSSE3-NEXT:    addl $2147483647, %edi # imm = 0x7FFFFFFF
; SSSE3-NEXT:    subl %esi, %r10d
...
; SSSE3-NEXT:    xorl %esi, %esi
; SSSE3-NEXT:    movl %eax, %edi
; SSSE3-NEXT:    subl %r9d, %edi
; SSSE3-NEXT:    setns %sil
; SSSE3-NEXT:    addl $2147483647, %esi # imm = 0x7FFFFFFF
; SSSE3-NEXT:    subl %r9d, %eax
...
; SSE41-NEXT:    subl %esi, %ecx
; SSE41-NEXT:    setns %dil
; SSE41-NEXT:    addl $2147483647, %edi # imm = 0x7FFFFFFF
; SSE41-NEXT:    subl %esi, %r10d
...
; SSE41-NEXT:    setns %dil
; SSE41-NEXT:    addl $2147483647, %edi # imm = 0x7FFFFFFF
; SSE41-NEXT:    subl %r9d, %ecx
; SSE41-NEXT:    cmovol %edi, %ecx
; SSE41-NEXT:    pextrd $1, %xmm1, %r9d
; SSE41-NEXT:    pextrd $1, %xmm0, %eax
; SSE41-NEXT:    xorl %esi, %esi
; SSE41-NEXT:    movl %eax, %edi
; SSE41-NEXT:    subl %r9d, %edi
; SSE41-NEXT:    setns %sil
; SSE41-NEXT:    addl $2147483647, %esi # imm = 0x7FFFFFFF
; SSE41-NEXT:    subl %r9d, %eax
...
; SSSE3-NEXT:    subq %r9, %rsi
; SSSE3-NEXT:    setns %dil
; SSSE3-NEXT:    addq %r8, %rdi
; SSSE3-NEXT:    subq %r9, %rax
...
; SSE41-NEXT:    subq %r9, %rsi
; SSE41-NEXT:    setns %dil
; SSE41-NEXT:    addq %r8, %rdi
; SSE41-NEXT:    subq %r9, %rax
...
; AVX1-NEXT:    subq %r9, %rsi
; AVX1-NEXT:    setns %dil
; AVX1-NEXT:    addq %r8, %rdi
; AVX1-NEXT:    subq %r9, %rax
...
; AVX2-NEXT:    subq %r9, %rsi
; AVX2-NEXT:    setns %dil
; AVX2-NEXT:    addq %r8, %rdi
; AVX2-NEXT:    subq %r9, %rax
...
; AVX-NEXT:    subw %r9w, %r10w
; AVX-NEXT:    setns %dl
; AVX-NEXT:    addl $32767, %edx # imm = 0x7FFF
; AVX-NEXT:    subw %r9w, %si
...
; AVX-NEXT:    subw %r9w, %r11w
; AVX-NEXT:    setns %r10b
; AVX-NEXT:    addl $32767, %r10d # imm = 0x7FFF
; AVX-NEXT:    subw %r9w, %dx
