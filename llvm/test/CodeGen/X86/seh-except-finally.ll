...
attributes #0 = { noinline nounwind uwtable "frame-pointer"="none" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "use-soft-float"="false" }
attributes #1 = { nounwind uwtable "frame-pointer"="none" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "use-soft-float"="false" }
attributes #2 = { noinline nounwind "frame-pointer"="none" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "use-soft-float"="false" }
attributes #3 = { "frame-pointer"="none" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "use-soft-float"="false" }
