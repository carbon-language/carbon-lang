...
entry:
  ...
  store i32 %i, i32* %i.addr, align 4
  %call = call %0 @foobar()
  call void @llvm.dbg.declare(metadata !{i32 %i}, metadata !24), !dbg !2
  %call2 = call %0 @foobar()
...
!1 = metadata !{i32 524329, metadata !"arg.c", metadata !"/private/tmp", metadata !2} ; [ DW_TAG_file_type ]
!2 = metadata !{i32 524305, i32 0, i32 12, metadata !"arg.c", metadata !"/private/tmp", metadata !"clang version 2.8 (trunk 112967)", i1 true, i1 false, metadata !"", i32 0} ; [ DW_TAG_compile_unit ]
