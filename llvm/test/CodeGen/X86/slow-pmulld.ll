...
; SSE4-32-NEXT:    pmaddwd %xmm1, %xmm2
; SSE4-32-NEXT:    pmaddwd %xmm0, %xmm1
...
; SSE4-64-NEXT:    pmaddwd %xmm1, %xmm2
; SSE4-64-NEXT:    pmaddwd %xmm0, %xmm1
...
; CHECK32-NEXT:    pmaddwd %xmm1, %xmm2
; CHECK32-NEXT:    pmaddwd %xmm0, %xmm1
...
; CHECK64-NEXT:    pmaddwd %xmm1, %xmm2
; CHECK64-NEXT:    pmaddwd %xmm0, %xmm1
