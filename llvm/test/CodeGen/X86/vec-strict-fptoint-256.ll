...
; AVX512VL-NEXT:    vcvttss2usi %xmm1, %ecx
; AVX512VL-NEXT:    vmovd %ecx, %xmm2
; AVX512VL-NEXT:    vpinsrd $1, %eax, %xmm2, %xmm2
; AVX512VL-NEXT:    vpermilpd {{.*#+}} xmm3 = xmm1[1,0]
; AVX512VL-NEXT:    vcvttss2usi %xmm3, %eax
; AVX512VL-NEXT:    vpinsrd $2, %eax, %xmm2, %xmm2
; AVX512VL-NEXT:    vpermilps {{.*#+}} xmm1 = xmm1[3,1,2,3]
; AVX512VL-NEXT:    vcvttss2usi %xmm1, %eax
; AVX512VL-NEXT:    vpinsrd $3, %eax, %xmm2, %xmm1
...
; AVX512VL-NEXT:    vpinsrd $3, %eax, %xmm2, %xmm0
...
; AVX512DQ-NEXT:    vcvttss2usi %xmm1, %ecx
; AVX512DQ-NEXT:    vmovd %ecx, %xmm2
; AVX512DQ-NEXT:    vpinsrd $1, %eax, %xmm2, %xmm2
; AVX512DQ-NEXT:    vpermilpd {{.*#+}} xmm3 = xmm1[1,0]
; AVX512DQ-NEXT:    vcvttss2usi %xmm3, %eax
; AVX512DQ-NEXT:    vpinsrd $2, %eax, %xmm2, %xmm2
; AVX512DQ-NEXT:    vpermilps {{.*#+}} xmm1 = xmm1[3,1,2,3]
; AVX512DQ-NEXT:    vcvttss2usi %xmm1, %eax
; AVX512DQ-NEXT:    vpinsrd $3, %eax, %xmm2, %xmm1
; AVX512DQ-NEXT:    vmovshdup {{.*#+}} xmm2 = xmm0[1,1,3,3]
; AVX512DQ-NEXT:    vcvttss2usi %xmm2, %eax
; AVX512DQ-NEXT:    vcvttss2usi %xmm0, %ecx
; AVX512DQ-NEXT:    vmovd %ecx, %xmm2
; AVX512DQ-NEXT:    vpinsrd $1, %eax, %xmm2, %xmm2
; AVX512DQ-NEXT:    vpermilpd {{.*#+}} xmm3 = xmm0[1,0]
; AVX512DQ-NEXT:    vcvttss2usi %xmm3, %eax
; AVX512DQ-NEXT:    vpinsrd $2, %eax, %xmm2, %xmm2
; AVX512DQ-NEXT:    vpermilps {{.*#+}} xmm0 = xmm0[3,1,2,3]
; AVX512DQ-NEXT:    vcvttss2usi %xmm0, %eax
; AVX512DQ-NEXT:    vpinsrd $3, %eax, %xmm2, %xmm0
