...
; SSE-NEXT:    packssdw %xmm0, %xmm0
; SSE-NEXT:    pblendw {{.*#+}} xmm0 = xmm0[0,1,2,3],xmm3[4,5,6,7]
; SSE-NEXT:    pcmpgtq {{[0-9]+}}(%rsp), %xmm2
; SSE-NEXT:    packssdw %xmm2, %xmm2
; SSE-NEXT:    packssdw %xmm2, %xmm2
; SSE-NEXT:    pcmpgtq {{[0-9]+}}(%rsp), %xmm1
...
; SSE-NEXT:    pblendw {{.*#+}} xmm4 = xmm4[0,1,2,3],xmm3[4,5,6,7]
; SSE-NEXT:    cmpltps {{[0-9]+}}(%rsp), %xmm2
; SSE-NEXT:    packssdw %xmm2, %xmm0
; SSE-NEXT:    packsswb %xmm0, %xmm0
; SSE-NEXT:    cmpltps {{[0-9]+}}(%rsp), %xmm1
; SSE-NEXT:    packssdw %xmm0, %xmm1
; SSE-NEXT:    packsswb %xmm0, %xmm1
; SSE-NEXT:    pblendw {{.*#+}} xmm1 = xmm1[0,1,2,3],xmm0[4,5,6,7]
; SSE-NEXT:    pand %xmm4, %xmm1
