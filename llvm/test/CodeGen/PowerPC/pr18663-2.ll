...
attributes #1 = { noreturn "frame-pointer"="all" "stack-protector-buffer-size"="8" "use-soft-float"="false" }
attributes #2 = { inlinehint "frame-pointer"="all" "stack-protector-buffer-size"="8" "use-soft-float"="false" }
