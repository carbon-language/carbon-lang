...
attributes #0 = { optsize "frame-pointer"="all" "stack-protector-buffer-size"="8" "use-soft-float"="false" }
attributes #1 = { nounwind optsize "frame-pointer"="all" "stack-protector-buffer-size"="8" "use-soft-float"="false" }
attributes #2 = { noreturn optsize "frame-pointer"="all" "stack-protector-buffer-size"="8" "use-soft-float"="false" }
