...
attributes #2 = { inlinehint nounwind "frame-pointer"="none" "stack-protector-buffer-size"="8" "use-soft-float"="false" }
attributes #3 = { nounwind }
attributes #4 = { noreturn nounwind "frame-pointer"="none" "stack-protector-buffer-size"="8" "use-soft-float"="false" }
attributes #5 = { nounwind readonly "frame-pointer"="none" "stack-protector-buffer-size"="8" "use-soft-float"="false" }
attributes #6 = { nobuiltin nounwind "frame-pointer"="none" "stack-protector-buffer-size"="8" "use-soft-float"="false" }
