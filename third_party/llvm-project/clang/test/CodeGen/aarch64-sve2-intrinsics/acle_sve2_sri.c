...
svint8_t test_svsri_n_s8(svint8_t op1, svint8_t op2)
{
  ...
  // CHECK: %[[INTRINSIC:.*]] = call <vscale x 16 x i8> @llvm.aarch64.sve.sri.nxv16i8(<vscale x 16 x i8> %op1, <vscale x 16 x i8> %op2, i32 1)
  // CHECK: ret <vscale x 16 x i8> %[[INTRINSIC]]
  // overload-warning@+2 {{implicit declaration of function 'svsri'}}
  // expected-warning@+1 {{implicit declaration of function 'svsri_n_s8'}}
  return SVE_ACLE_FUNC(svsri,_n_s8,,)(op1, op2, 1);
}

svint8_t test_svsri_n_s8_1(svint8_t op1, svint8_t op2)
{
  // CHECK-LABEL: test_svsri_n_s8_1
  // CHECK: %[[INTRINSIC:.*]] = call <vscale x 16 x i8> @llvm.aarch64.sve.sri.nxv16i8(<vscale x 16 x i8> %op1, <vscale x 16 x i8> %op2, i32 8)
  // CHECK: ret <vscale x 16 x i8> %[[INTRINSIC]]
  // overload-warning@+2 {{implicit declaration of function 'svsri'}}
  // expected-warning@+1 {{implicit declaration of function 'svsri_n_s8'}}
...
svint16_t test_svsri_n_s16(svint16_t op1, svint16_t op2)
{
  ...
  // CHECK: %[[INTRINSIC:.*]] = call <vscale x 8 x i16> @llvm.aarch64.sve.sri.nxv8i16(<vscale x 8 x i16> %op1, <vscale x 8 x i16> %op2, i32 1)
  // CHECK: ret <vscale x 8 x i16> %[[INTRINSIC]]
  // overload-warning@+2 {{implicit declaration of function 'svsri'}}
  // expected-warning@+1 {{implicit declaration of function 'svsri_n_s16'}}
  return SVE_ACLE_FUNC(svsri,_n_s16,,)(op1, op2, 1);
}

svint16_t test_svsri_n_s16_1(svint16_t op1, svint16_t op2)
{
  // CHECK-LABEL: test_svsri_n_s16_1
  // CHECK: %[[INTRINSIC:.*]] = call <vscale x 8 x i16> @llvm.aarch64.sve.sri.nxv8i16(<vscale x 8 x i16> %op1, <vscale x 8 x i16> %op2, i32 16)
  // CHECK: ret <vscale x 8 x i16> %[[INTRINSIC]]
  // overload-warning@+2 {{implicit declaration of function 'svsri'}}
  // expected-warning@+1 {{implicit declaration of function 'svsri_n_s16'}}
...
svint32_t test_svsri_n_s32(svint32_t op1, svint32_t op2)
{
  ...
  // CHECK: %[[INTRINSIC:.*]] = call <vscale x 4 x i32> @llvm.aarch64.sve.sri.nxv4i32(<vscale x 4 x i32> %op1, <vscale x 4 x i32> %op2, i32 1)
  // CHECK: ret <vscale x 4 x i32> %[[INTRINSIC]]
  // overload-warning@+2 {{implicit declaration of function 'svsri'}}
  // expected-warning@+1 {{implicit declaration of function 'svsri_n_s32'}}
  return SVE_ACLE_FUNC(svsri,_n_s32,,)(op1, op2, 1);
}

svint32_t test_svsri_n_s32_1(svint32_t op1, svint32_t op2)
{
  // CHECK-LABEL: test_svsri_n_s32_1
  // CHECK: %[[INTRINSIC:.*]] = call <vscale x 4 x i32> @llvm.aarch64.sve.sri.nxv4i32(<vscale x 4 x i32> %op1, <vscale x 4 x i32> %op2, i32 32)
  // CHECK: ret <vscale x 4 x i32> %[[INTRINSIC]]
  // overload-warning@+2 {{implicit declaration of function 'svsri'}}
  // expected-warning@+1 {{implicit declaration of function 'svsri_n_s32'}}
...
svint64_t test_svsri_n_s64(svint64_t op1, svint64_t op2)
{
  ...
  // CHECK: %[[INTRINSIC:.*]] = call <vscale x 2 x i64> @llvm.aarch64.sve.sri.nxv2i64(<vscale x 2 x i64> %op1, <vscale x 2 x i64> %op2, i32 1)
  // CHECK: ret <vscale x 2 x i64> %[[INTRINSIC]]
  // overload-warning@+2 {{implicit declaration of function 'svsri'}}
  // expected-warning@+1 {{implicit declaration of function 'svsri_n_s64'}}
  return SVE_ACLE_FUNC(svsri,_n_s64,,)(op1, op2, 1);
}

svint64_t test_svsri_n_s64_1(svint64_t op1, svint64_t op2)
{
  // CHECK-LABEL: test_svsri_n_s64_1
  // CHECK: %[[INTRINSIC:.*]] = call <vscale x 2 x i64> @llvm.aarch64.sve.sri.nxv2i64(<vscale x 2 x i64> %op1, <vscale x 2 x i64> %op2, i32 64)
  // CHECK: ret <vscale x 2 x i64> %[[INTRINSIC]]
  // overload-warning@+2 {{implicit declaration of function 'svsri'}}
  // expected-warning@+1 {{implicit declaration of function 'svsri_n_s64'}}
