...
; AVX512VBMI2-NEXT:    vpsrlw %xmm2, %xmm3, %xmm3
; AVX512VBMI2-NEXT:    vmovdqa {{.*#+}} xmm4 = [255,255,255,255,255,255,255,255]
; AVX512VBMI2-NEXT:    vpand %xmm4, %xmm3, %xmm3
...
; AVX512VBMI2-NEXT:    vpand %xmm4, %xmm0, %xmm0
